...
(assert (let ((a!1 (>= (+ (+ it2573 (* it540 (- 1))) (- 2)) 0))
      (a!2 (+ (* (+ it716 (- 1)) it540 (- 1))
              it2573
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!4 (+ it2573 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!5 (>= (+ (+ it2573 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!7 (+ (+ (+ it2573 (* it540 (- 1))) (* it2572 (- 2))) (- 1)))
      (a!8 (>= (+ (+ it2573 (* it540 (- 1))) (- 3)) 0))
      (a!10 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      (a!11 (>= (+ (+ it2573 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2572 (- 2))
                   (- 1))
                0))
      (a!13 (>= (+ (+ it2573 (* it2572 (- 2))) (- 1)) 0))
      (a!15 (>= (+ (+ it2573 (* it2572 (- 2))) (- 2)) 0))
      (a!16 (+ (+ (+ it2573 (* it540 (- 1))) (* it2572 (- 2))) (- 2))))
(let ((a!3 (+ (+ (+ a!2 (* it540 (- 1))) (* it2572 (- 2))) (- 1)))
      (a!6 (>= (+ (+ a!2 (* it540 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ a!2 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!12 (>= (+ (+ a!2 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2572 (- 2))
                   (- 1))
                0))
      (a!14 (>= (+ (+ a!2 (* it540 (- 1))) (- 3)) 0))
      (a!17 (+ (+ (+ a!2 (* it540 (- 1))) (* it2572 (- 2))) (- 2))))
  (and a!1
       (>= (+ (* it2570 (- 1)) 3) 0)
       (>= (+ a!2 (- 3)) 0)
       (>= (+ a!2 (* it2572 (- 2)) (- 2)) 0)
