...
(assert (let ((a!1 (>= (+ (+ it2526 (* it2525 (- 2))) (- 2)) 0))
      (a!2 (>= (+ (+ it2526 (* it706 (- 1))) (- 3)) 0))
      (a!3 (+ (+ (+ it2526 (* it706 (- 1))) (* it540 (- 1))) (- 2)))
      (a!4 (>= (+ (+ it2526 (* it2525 (- 2))) (- 1)) 0))
      (a!5 (+ (+ (+ it2526 (* it706 (- 1))) (* it2525 (- 2))) (- 2)))
      (a!6 (+ (+ (+ it2526 (* it706 (- 1))) (* it540 (- 1)))
              (* it2525 (- 2))
              (- 1)))
      (a!7 (+ (+ (+ it2526 (* it706 (- 1))) (* it2525 (- 2))) (- 1)))
      (a!8 (>= (+ (+ it2526 (* it706 (- 1))) (- 2)) 0)))
  (and (>= (+ it540 (- 1)) 0)
       (>= (+ it2523 (- 4)) 0)
       (= 0 0)
       (<= (+ it706 it540) 0)
