...
(assert (let ((a!1 (>= (+ (+ (* it706 (- 1)) it2563) (- 3)) 0))
      (a!2 (+ (+ (+ (* it706 (- 1)) (* it2562 (- 2))) it2563) (- 1)))
      (a!3 (+ (+ (+ (* it706 (- 1)) (* it2562 (- 2))) it2563) (- 2)))
      (a!4 (>= (+ (+ (* it706 (- 1)) (* it2562 (- 2)))
                  (* it2537 (- 1))
                  it2563
                  (- 1))
               0))
      (a!5 (>= (+ (+ (* it706 (- 1)) it2563) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2562 (- 2)) it2563) (- 2)) 0))
      (a!7 (>= (+ (+ (* it2562 (- 2)) it2563) (- 1)) 0)))
  (and (<= (+ it706 it2537) 0)
       a!1
       (>= a!2 0)
       (>= a!3 0)
