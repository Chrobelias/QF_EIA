...
(assert (let ((a!1 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                 (+ 0 it745)
                 (* (exp it744 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it744 2)))
      (a!3 (* (* (exp 9 (+ it152 (- 1))) (exp it746 3)) (+ 0 (- 1))))
      (a!5 (* (* (+ 0 it745) (exp 9 (+ it152 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp 9 (+ it152 (- 1))) (exp it746 3)) (+ 0 (- 3))))
      (a!8 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                 (+ 0 (* it745 3))
                 (* (exp it744 2) (+ 0 (- 4)))
                 (* (exp it746 3) (+ 0 (- 2))))
