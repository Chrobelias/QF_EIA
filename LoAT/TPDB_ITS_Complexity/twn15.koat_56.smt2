...
(assert (let ((a!1 (* (* (exp it688 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it687) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it686 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!5 (> (+ (+ 0 (* it687 3))
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it688 3) (+ 0 (- 2)))
                 (* (exp it686 2) (+ 0 (- 4))))
              (+ 0 0)))
      (a!6 (* (* (exp it688 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!8 (> (+ (+ 0 it687)
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it686 2) (+ 0 (- 1))))
              (+ 0 0))))
