...
(assert (let ((a!1 (* (* (exp it263 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it261 2)))
      (a!4 (> (+ (* (exp it263 5) (+ 0 (- 1)))
                 (* (exp it263 3) (+ 0 (- 2)))
                 (* (exp it261 2) (+ 0 (- 4)))
                 (+ 0 (* it262 3)))
      ...
      (a!5 (> (+ (* (exp it263 5) (+ 0 (- 1)))
                 ...
                 (+ 0 it262))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it107 (- 1))) (+ 0 it262)) (+ 0 3)))
      (a!7 (* (* (exp it263 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (* (exp 9 (+ it107 (- 1))) (+ 0 it262))
              (* (exp it263 5) (+ 0 (- 1)))
              a!1
              (* a!2 (+ 0 (- 1)))
              (exp it263 3)))
