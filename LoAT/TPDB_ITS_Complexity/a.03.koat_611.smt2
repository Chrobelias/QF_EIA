...
(assert (let ((a!1 (>= (+ (+ (* it706 (- 1)) it2581) (* it540 (- 1)) (- 2)) 0))
      (a!2 (>= (+ (+ (* it706 (- 1)) it2581) (- 3)) 0))
      (a!3 (>= (+ (+ (* it2580 (- 2)) (* it706 (- 1)) it2581) (- 1)) 0))
      (a!4 (>= (+ (+ (* it2580 (- 2)) (* it706 (- 1)) it2581)
                  (* it540 (- 1))
                  (- 1))
               0))
      (a!5 (>= (+ (+ (* it2580 (- 2)) it2581) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2580 (- 2)) (* it706 (- 1)) it2581) (- 2)) 0))
      (a!7 (>= (+ (+ (* it2580 (- 2)) it2581) (- 1)) 0))
      (a!8 (>= (+ (+ (* it706 (- 1)) it2581) (- 2)) 0)))
  (and a!1
       (>= (+ it2581 (- 2)) 0)
       (>= (+ it540 (- 1)) 0)
       (= 0 0)
