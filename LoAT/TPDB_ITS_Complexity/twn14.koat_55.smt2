...
(assert (let ((a!1 (> (+ (* (exp it644 2) (+ 0 (- 16)))
                 (* (exp it646 5) (+ 0 (- 1)))
                 (+ 0 (* it645 9))
                 (* (exp it646 3) (+ 0 (- 8))))
              (+ 0 0)))
      ...
      (a!3 (> (+ (* (exp it644 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it645))
              (+ 0 0)))
      (a!4 (* (* (exp it646 3) (exp 81 (+ it495 (- 1)))) (+ 0 (- 27))))
      (a!5 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it645)) (+ 0 27)))
      (a!6 (* (exp it644 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!8 (* (* (exp it646 3) (exp 81 (+ it495 (- 1)))) (+ 0 (- 3))))
      (a!9 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it645)) (+ 0 3)))
      (a!11 (* (* (exp it646 3) (exp 81 (+ it495 (- 1)))) (+ 0 (- 9))))
      (a!12 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it645)) (+ 0 9)))
      (a!14 (* (* (exp it646 3) (exp 81 (+ it495 (- 1)))) (+ 0 (- 1)))))
(let ((a!7 (> (+ (* (exp it646 5) (+ 0 (- 1)))
                 a!4
                 a!5
                 (* a!6 (+ 0 (- 64)))
                 (exp it646 3))
              (+ 0 0)))
      (a!10 (> (+ (* (exp it646 5) (+ 0 (- 1)))
                  a!8
                  a!9
                  (* a!6 (+ 0 (- 4)))
                  (exp it646 3))
