...
(assert (= (+ (+ 0 it884) (* (+ 0 it814) (exp 2 it635) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (>= (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882) (- 1)) 0))
      (a!2 (>= (+ (+ (* it881 (- 2)) it882) (- 2)) 0))
      (a!3 (+ (* it795 (+ it766 (- 1)) it784 (- 1))
              (* it881 (- 2))
              (* it766 (- 1))
              it882))
      (a!5 (+ (* it795 (- 1)) (* it795 (+ it766 (- 1)) it784 (- 1))))
      (a!7 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it882) (- 2)))
      (a!9 (+ (* (* it785 it784) (- 1)) it882 (* (* it795 it784) (- 1))))
      (a!10 (+ (* it795 (+ it766 (- 1)) it784 (- 1)) (* it766 (- 1))))
      (a!12 (>= (+ it882
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 3))
                0))
      (a!13 (+ (+ (* it785 (- 1)) (* it795 (- 1))) (* it881 (- 2)) it882))
      (a!15 (>= (+ (+ (* it795 (- 1)) it882) (- 3)) 0))
      (a!18 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it882)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))
               (- 2)))
      (a!19 (>= (+ (+ (* it881 (- 2)) it882)
                   ...
                   (- 2))
                0))
      (a!20 (>= (+ (+ (* it795 (- 1)) it882) (- 2)) 0))
      (a!21 (+ (+ (* it795 (- 1)) it882)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!22 (+ (+ (* it785 (- 1)) (* it795 (- 1)))
               (* it795 (+ it766 (- 1)) it784 (- 1))))
      (a!27 (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!28 (>= (+ (+ (* it881 (- 2)) it882) (- 1)) 0))
      (a!31 (>= (+ (+ (* it884 (- 1)) it882) (- 1)) 0))
      (a!33 (>= (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882) (- 2)) 0)))
(let ((a!4 (+ (+ a!3 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 1)))
      (a!6 (+ (+ a!5 (* it766 (- 1)) it882)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it766 (- 1)) it784 (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!8 (+ (+ a!5 (* it881 (- 2)) (* it766 (- 1)) it882)
              (* it785 (+ it766 (- 1)) it784 (- 1))))
      (a!11 (+ (+ a!10 it882) (* it785 (+ it766 (- 1)) it784 (- 1))))
      (a!14 (>= (+ a!13
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 1))
                0))
      (a!16 (+ (+ a!5 (* it881 (- 2)) (* it766 (- 1)) it882)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it766 (- 1)) it784 (- 1))
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!17 (+ (+ a!5 (* it766 (- 1)) it882)
               (* it785 (+ it766 (- 1)) it784 (- 1))))
      (a!23 (>= (+ (+ a!22 (* it766 (- 1)) it882)
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 1))
      ...
      (a!24 (+ a!10
               ...
               (* it785 (+ it766 (- 1)) it784 (- 1))
               (* (* it795 it784) (- 1))))
      (a!25 (>= (+ (+ a!22 (* it881 (- 2)) (* it766 (- 1)) it882)
                   (* it785 (+ it766 (- 1)) it784 (- 1)))
                0))
      (a!26 (>= (+ a!3
                   (* it795 (+ it784 (- 1)) (- 1))
                   ...
                   (- 1))
                0))
      (a!29 (>= (+ a!3 (* it785 (+ it766 (- 1)) it784 (- 1))) 0))
      (a!30 (>= (+ (+ a!22 (* it881 (- 2)) (* it766 (- 1)) it882)
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (* it785 (+ it784 (- 1)) (- 1)))
                0))
      (a!32 (>= (+ (+ a!22 (* it766 (- 1)) it882)
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (- 1))
                0))
      (a!34 (>= (+ (+ a!10 it882)
