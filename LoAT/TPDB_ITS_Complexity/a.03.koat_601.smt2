...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
              ...
              it2573
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!3 (>= (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it2573) (- 3)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) (- 2)))
      (a!7 (+ (+ (* it88 (- 1)) it2573) (* it706 (- 1)) (* it540 (- 1))))
      (a!8 (+ (+ (* it88 (- 1)) it2573)
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))))
      (a!11 (+ (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 1))
      (a!13 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ (* it88 (- 1)) it2573) (- 2)) 0))
      (a!16 (+ (+ (+ (* it88 (- 1)) it2573) (* it540 (- 1))) (- 2)))
      (a!17 (+ (+ (+ (* it88 (- 1)) it2573) (* it540 (- 1))) (* it2572 (- 2))))
      (a!18 (+ (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) (- 1)))
      (a!19 (+ (+ (+ (* it88 (- 1)) it2573) (* it540 (- 1))) (- 3))))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1))) (- 3)) 0))
      (a!6 (>= (+ (+ a!1 (* it540 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2572 (- 2))
                   (- 1))
                0))
      (a!12 (+ (+ (+ a!1 (* it540 (- 1))) (* it2572 (- 2))) (- 1)))
      (a!15 (+ (+ (+ a!1 (* it540 (- 1))) (* it2572 (- 2))) (- 2))))
  (and (>= (+ it2573 (- 2)) 0)
       (= (+ it2575 (* it2572 (- 2))) 0)
       (>= (+ it540 (- 1)) 0)
       (= 0 0)
