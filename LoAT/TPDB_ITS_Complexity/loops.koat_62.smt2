...
(assert (= (+ (* it180 (- 1)) it188 (* it157 (- 2))) 0))
(assert (= (+ (* it181 (- 1)) it189) 0))
(assert (= (+ (* (exp 2 it157) (+ 0 it182) (+ 0 (- 1))) (+ 0 it190))
   (+ 0 0)))
(assert (and (= (+ it187 (- 6)) 0) (>= (+ (* it190 (- 1)) it189 (- 1)) 0)))
(assert (= (+ it196 (- 6)) 0))
(assert (= (+ it197 (* it188 (- 1)) (- 2)) 0))
(assert (= (+ it198 (* it189 (- 1))) 0))
(assert (= (+ it199 (* it190 (- 2))) 0))
(assert (and (>= (+ (* it199 (- 1)) it198 (- 1)) 0)
     (<= it199 0)
     (>= (+ (* it196 (- 1)) 6) 0)
     (>= (+ it196 (- 6)) 0)))
(check-sat)
