...
(assert (let ((a!1 (* (exp it573 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp 81 (+ it495 (- 1))) (exp it575 3)) (+ 0 (- 1))))
      (a!4 (> (+ (* (exp it575 3) (+ 0 (- 8)))
                 (* (exp it575 5) (+ 0 (- 1)))
                 (* (exp it573 2) (+ 0 (- 16)))
                 (+ 0 (* it574 9)))
              (+ 0 0)))
      (a!5 (* (* (exp 81 (+ it495 (- 1))) (exp it575 3)) (+ 0 (- 3))))
      (a!6 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it574)) (+ 0 3)))
      (a!8 (* (* (exp 81 (+ it495 (- 1))) (exp it575 3)) (+ 0 (- 9))))
      (a!9 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it574)) (+ 0 9)))
      (a!11 (> (+ (* (exp it575 3) (+ 0 (- 2)))
                  (* (exp it575 5) (+ 0 (- 1)))
                  (* (exp it573 2) (+ 0 (- 4)))
                  (+ 0 (* it574 3)))
               (+ 0 0)))
      (a!12 (* (* (exp 81 (+ it495 (- 1))) (exp it575 3)) (+ 0 (- 27))))
      (a!13 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it574)) (+ 0 27)))
      (a!15 (> (+ (* (exp it575 5) (+ 0 (- 1)))
                  (* (exp it573 2) (+ 0 (- 1)))
                  (+ 0 it574))
               (+ 0 0))))
(let ((a!3 (+ (exp it575 3)
