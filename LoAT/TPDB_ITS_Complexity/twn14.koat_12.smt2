...
(assert (let ((a!1 (* (* (exp 9 (+ it107 (- 1))) (exp it204 3)) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it203) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it202 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!5 (> (+ (* (exp it204 3) (+ 0 (- 2)))
                 (* (exp it202 2) (+ 0 (- 4)))
                 (+ 0 (* it203 3))
                 (* (exp it204 5) (+ 0 (- 1))))
      ...
      (a!6 (> (+ (* (exp it202 2) (+ 0 (- 1)))
                 ...
                 (* (exp it204 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp 9 (+ it107 (- 1))) (exp it204 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (exp it204 3)
                 a!1
                 a!2
                 (* (exp it204 5) (+ 0 (- 1)))
