...
(assert (= (+ it690 (- 3)) 0))
(assert (= (+ (* it684 (- 1)) it691 (- 2)) 0))
(assert (= (+ (* it685 (- 1)) it692) 0))
(assert (= (+ (* it686 2) it693) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it687 (- 3)) it694)) (* (exp it688 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it688 (- 1)) it695) 0))
(assert (= (+ it696 (* it689 (- 1))) 0))
(assert (let ((a!1 (> (+ (* (exp it695 3) (+ 0 (- 8)))
                 (+ 0 (* it694 9))
                 (* (exp it693 2) (+ 0 (- 16)))
                 (* (exp it695 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (> (+ (+ 0 it694)
                 ...
                 (* (exp it695 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (* (exp 81 (+ it494 (- 1))) (exp it695 3)) (+ 0 (- 9))))
      (a!4 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it694)) (+ 0 9)))
      (a!5 (* (exp it693 2) (exp (exp 16 (+ it494 (- 1))) (+ 0 2))))
      (a!7 (* (* (exp 81 (+ it494 (- 1))) (exp it695 3)) (+ 0 (- 3))))
      (a!8 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it694)) (+ 0 3)))
      (a!10 (* (* (exp 81 (+ it494 (- 1))) (exp it695 3)) (+ 0 (- 1))))
      (a!12 (> (+ (* (exp it695 3) (+ 0 (- 2)))
                  (+ 0 (* it694 3))
                  (* (exp it693 2) (+ 0 (- 4)))
                  (* (exp it695 5) (+ 0 (- 1))))
               (+ 0 0)))
      (a!13 (* (* (exp 81 (+ it494 (- 1))) (exp it695 3)) (+ 0 (- 27))))
      (a!14 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it694)) (+ 0 27))))
(let ((a!6 (> (+ a!3
                 (exp it695 3)
                 a!4
                 (* (exp it695 5) (+ 0 (- 1)))
