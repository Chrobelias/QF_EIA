...
(assert (= (+ it105 (- 4)) 0))
(assert (= (+ (* it90 (- 1)) it106 (- 1)) 0))
(assert (= (+ (* it91 (- 1)) it107) 0))
(assert (= (+ (* it92 (- 1)) it108) 0))
(assert (= (+ it109 (* it93 (- 1))) 0))
(assert (= (+ (* it94 (- 1)) it110) 0))
(assert (and (>= (+ it108 (- 3)) 0)
     (>= (+ it108 (- 2)) 0)
     (= (+ it107 (- 1)) 0)
     (= (+ it105 (- 4)) 0)))
(assert (= (+ it113 (- 3)) 0))
(assert (= (+ (* it106 (- 1)) it114 (- 2)) 0))
(assert (= (+ (* it107 (- 1)) it115) 0))
(assert (= (+ it116 (* it108 (- 1)) 1) 0))
(assert (= (+ (* it107 (- 1)) it117) 0))
(assert (= (+ (* it107 (- 2)) it118) 0))
(assert (let ((a!1 (>= (+ (+ it116 (* it118 (- 1))) (- 1)) 0)))
  (and (= 0 0)
       (>= (+ it116 (* it118 (- 1))) 0)
       (>= (+ (* it113 (- 1)) 3) 0)
       (>= (+ it113 (- 3)) 0)
