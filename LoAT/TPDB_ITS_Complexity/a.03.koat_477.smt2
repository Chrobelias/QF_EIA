...
(assert (let ((a!1 (+ (* it1024 (- 1))
              (* (+ it716 (- 1)) it540 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!4 (+ (+ (+ (* it1024 (- 1)) (* it1071 (- 2))) it1072) 1))
      (a!5 (>= (+ (+ (* it1074 (- 1)) it1072) (- 1)) 0))
      (a!6 (+ (+ (+ (* it1024 (- 1)) it1072) (* it540 (- 1))) (- 2)))
      (a!7 (>= (+ (+ (* it1024 (- 1)) (* it1071 (- 2)))
                  (* it706 (- 1))
                  it1072
                  (* it540 (- 1))
                  (- 1))
      ...
      (a!8 (+ (* it1024 (- 1))
              ...
              it1072
              (* (* it706 it716) (- 1))))
      (a!9 (+ (+ (+ (* it1024 (- 1)) (* it1071 (- 2))) it1072) (- 1)))
      (a!10 (+ (+ (+ (* it1024 (- 1)) (* it1071 (- 2))) it1072) (* it540 (- 1))))
      (a!11 (>= (+ (+ (* it1024 (- 1)) it1072) (- 2)) 0))
      (a!12 (+ (+ (+ (* it1024 (- 1)) (* it1071 (- 2))) it1072) (- 2)))
      (a!13 (>= (+ (+ (* it1024 (- 1)) (* it1071 (- 2))) it1072) 0))
      (a!15 (>= (+ (+ (* it1024 (- 1)) it1072) (- 3)) 0))
      (a!17 (+ (+ (+ (* it1024 (- 1)) it1072) (* it540 (- 1))) (- 3))))
(let ((a!2 (+ (+ (+ a!1 (* it1071 (- 2))) it1072) (- 2)))
      (a!3 (+ (+ (+ a!1 (* it1071 (- 2))) it1072) (* it540 (- 1))))
      (a!14 (>= (+ (+ (+ a!1 it1072) (* it540 (- 1))) (- 3)) 0))
      (a!16 (>= (+ (+ (+ a!1 it1072) (* it540 (- 1))) (- 2)) 0))
      (a!18 (>= (+ (+ a!1 (* it1071 (- 2)))
                   (* it706 (- 1))
                   it1072
                   (* it540 (- 1))
                ...
                0)))
  (and (>= a!2 0)
       (<= (+ it1024 (* it540 it716) (* it706 it716) 1) 0)
       (>= (+ it540 (- 1)) 0)
       (>= (+ a!3 (- 2)) 0)
       (>= a!4 0)
       a!5
       (>= a!6 0)
       (>= (+ (* it1069 (- 1)) 3) 0)
       (>= (+ (* it1024 (- 1)) (* it706 (- 1)) it1072 (* it540 (- 1)) (- 2)) 0)
       (>= (+ a!1 (* it706 (- 1)) it1072 (* it540 (- 1)) (- 2)) 0)
       a!7
       (>= (+ a!8 (- 3)) 0)
       (>= (+ a!3 (- 1)) 0)
       (>= a!9 0)
