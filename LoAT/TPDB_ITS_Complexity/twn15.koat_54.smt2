...
(assert (let ((a!1 (> (+ (+ 0 (* it687 3))
      ...
      (a!2 (> (+ (+ 0 it687)
                 ...
                 (* (exp it686 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it686 2)))
      (a!4 (* (* (+ 0 it687) (exp 9 (+ it117 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it117 (- 1))) (exp it688 3)) (+ 0 (- 3))))
      (a!7 (* (* (exp 9 (+ it117 (- 1))) (exp it688 3)) (+ 0 (- 1)))))
(let ((a!6 (> (+ (* a!3 (+ 0 (- 4)))
                 a!4
                 (* (exp it688 5) (+ 0 (- 1)))
                 (exp it688 3)
