...
(assert (let ((a!1 (>= (+ (+ it632 (* it634 (- 1))) (- 1)) 0)))
  (and (>= (+ it634 (- 1)) 0)
       ...
       (= (+ it629 (- 3)) 0))))
(assert (= (+ it642 (- 3)) 0))
(assert (= (+ (* it630 (- 1)) it643 (- 1)) 0))
(assert (= (+ (* it631 (- 1)) it644) 0))
(assert (= (+ (* it632 (- 1)) it645) 0))
(assert (= (+ it646 (* it634 (- 1))) 0))
(assert (= (+ (* it634 (- 2)) it647) 0))
(assert (let ((a!1 (+ (+ (+ (* it572 (- 1)) it645) (* it19 (- 1))) (* it644 (- 2))))
      (a!2 (+ (+ (+ (* it572 (- 1)) it645) (* it644 (- 2))) (- 1)))
      (a!3 (>= (+ (+ (* it572 (- 1)) it645) (- 2)) 0))
      (a!4 (>= (+ (+ it645 (* it647 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (+ (* it572 (- 1)) it645) (* it19 (- 1))) (- 2)))
      (a!6 (>= (+ (+ (* it572 (- 1)) it645) (* it644 (- 2))) 0))
      (a!7 (+ (+ (+ (* it572 (- 1)) it645) (* it644 (- 2))) 1))
      (a!8 (>= (+ (+ (* it572 (- 1)) it645) (- 3)) 0)))
  (and (>= (+ a!1 1) 0)
       (>= a!2 0)
       (>= (+ it642 (- 3)) 0)
       (>= (+ (* it642 (- 1)) 3) 0)
