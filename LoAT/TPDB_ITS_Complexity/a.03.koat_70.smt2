...
(assert (= (+ (* (exp 2 it57) (+ 0 it184) (+ 0 (- 1))) (+ 0 it493))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ (+ (* it88 (- 1)) it491) (* it490 (- 2))) (- 1)))
      (a!2 (+ (+ (+ (* it88 (- 1)) it491) (* it19 (- 1))) (* it490 (- 2))))
      (a!3 (+ (+ (+ (* it88 (- 1)) it491) (* it19 (- 1))) (- 2)))
      (a!4 (+ (+ (+ (* it88 (- 1)) it491) (* it490 (- 2))) 1))
      (a!5 (>= (+ (+ (* it88 (- 1)) it491) (- 2)) 0))
      (a!6 (>= (+ (+ it491 (* it493 (- 1))) (- 1)) 0))
      (a!7 (>= (+ (+ (* it88 (- 1)) it491) (- 3)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) it491) (* it490 (- 2))) 0)))
  (and (>= a!1 0)
       (>= (+ it488 (- 3)) 0)
       (>= (+ it490 (- 1)) 0)
       (>= (+ it491 (- 3)) 0)
