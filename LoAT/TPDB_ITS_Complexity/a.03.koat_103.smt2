...
(assert (let ((a!1 (>= (+ (+ (* it523 (- 1)) it521) (- 1)) 0)))
  (and a!1 (= (+ it518 (- 3)) 0) (>= (+ (* it523 (- 1)) it521) 0))))
(assert (= (+ it532 (- 4)) 0))
(assert (= (+ (* it519 (- 1)) it533 (- 1)) 0))
(assert (= (+ (* it520 (- 1)) it534) 0))
(assert (= (+ it535 (* it521 (- 1))) 0))
(assert (= (+ (* it522 (- 1)) it536) 0))
(assert (= (+ (* it523 (- 1)) it537 (- 1)) 0))
(check-sat)
