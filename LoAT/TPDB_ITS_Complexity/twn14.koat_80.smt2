...
(assert (let ((a!1 (> (+ (* (exp it806 3) (+ 0 (- 2)))
                 ...
                 (* (exp it806 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp 9 (+ it117 (- 1))) (exp it806 3)) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it804 2)))
      (a!5 (> (+ (* (exp it804 2) (+ 0 (- 1)))
                 (+ 0 it805)
                 (* (exp it806 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it117 (- 1))) (exp it806 3)) (+ 0 (- 3))))
      (a!7 (* (* (exp 9 (+ it117 (- 1))) (+ 0 it805)) (+ 0 3))))
(let ((a!4 (+ (exp it806 3)
              a!2
              (* a!3 (+ 0 (- 1)))
              (* (exp 9 (+ it117 (- 1))) (+ 0 it805))
              (* (exp it806 5) (+ 0 (- 1)))))
      (a!8 (> (+ (exp it806 3)
                 a!6
                 (* a!3 (+ 0 (- 4)))
