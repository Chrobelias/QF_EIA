...
(assert (let ((a!1 (>= (+ (+ it2757 (* it2760 (- 1)) (* it706 (- 1)))
                  (* it2756 (- 2))
                  (- 1))
               0))
      (a!2 (+ (+ it2757 (* it706 (- 1)))
      ...
      (a!5 (+ it2757
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2760 (+ it1243 (- 1)) (- 1))))
      (a!6 (>= (+ (+ it2757 (* it2760 (- 1)) (* it706 (- 1))) (- 2)) 0))
      (a!7 (>= (+ (+ it2757 (* it2756 (- 2))) (- 2)) 0))
      (a!9 (>= (+ (+ it2757 (* it706 (- 1))) (- 2)) 0))
      (a!10 (+ (+ it2757 (* it2760 (- 1)) (* it706 (- 1)))
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it2760 (+ it1243 (- 1)) (- 1))))
      (a!11 (>= (+ (+ it2757 (* it706 (- 1))) (- 3)) 0))
      (a!12 (+ (+ (+ it2757 (* it706 (- 1))) (* it2756 (- 2))) (- 1)))
      (a!13 (+ (+ (+ it2757 (* it706 (- 1))) (* it2756 (- 2))) (- 2))))
(let ((a!3 (>= (+ (+ a!2 (* it2756 (- 2))) (- 2)) 0))
      (a!8 (>= (+ (+ a!2 (* it2756 (- 2))) (- 1)) 0)))
  (and (>= (+ it2754 (- 4)) 0)
       a!1
       a!3
       a!4
