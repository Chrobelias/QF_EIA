...
(assert (let ((a!1 (+ (+ (* it811 (- 2)) (* it795 (- 1)))
              (* it795 (+ it766 (- 1)) it784 (- 1))
              (* it766 (- 1))
              it812))
      (a!3 (+ (+ (* it795 (- 1)) it812)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!4 (+ (+ (+ (* it811 (- 2)) (* it795 (- 1))) it812)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!5 (+ it812 (* (* it785 it784) (- 1)) (* (* it795 it784) (- 1))))
      (a!6 (+ (* it795 (+ it766 (- 1)) it784 (- 1)) (* it766 (- 1)) it812))
      (a!8 (+ (* it795 (- 1))
              (* it795 (+ it766 (- 1)) it784 (- 1))
              (* it766 (- 1))
              it812))
      (a!10 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it812) (- 2)))
      (a!12 (>= (+ (+ (* it811 (- 2)) it812) (- 1)) 0))
      (a!13 (+ (* it785 (- 1)) (* it811 (- 2)) (* it795 (- 1))))
      (a!16 (>= (+ (+ (* it795 (- 1)) it812) (- 2)) 0))
      (a!17 (+ (* it811 (- 2))
               (* it795 (+ it766 (- 1)) it784 (- 1))
               (* it766 (- 1))
               it812))
      (a!19 (+ (+ (+ (* it811 (- 2)) (* it795 (- 1))) it812) (- 2)))
      (a!21 (>= (+ (+ (* it814 (- 1)) it812) (- 1)) 0))
      (a!22 (>= (+ (+ (* it811 (- 2)) it812) (- 2)) 0))
      (a!23 (>= (+ (+ (* it795 (- 1)) it812) (- 3)) 0))
      (a!26 (+ (+ (+ (* it811 (- 2)) (* it795 (- 1))) it812) (- 1)))
      (a!28 (>= (+ it812
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 3))
                0))
      (a!29 (+ (+ (* it785 (- 1)) (* it795 (- 1)))
               (* it795 (+ it766 (- 1)) it784 (- 1))
               (* it766 (- 1))
               it812))
      (a!34 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it812)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))
               (- 2)))
      (a!36 (>= (+ (+ (* it811 (- 2)) it812)
...
(let ((a!2 (+ a!1
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it766 (- 1)) it784 (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!7 (+ (+ a!6 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 1)))
      (a!9 (+ (+ a!8 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 2)))
      (a!11 (+ (+ a!6 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 2)))
      (a!14 (+ a!13 (* it795 (+ it766 (- 1)) it784 (- 1)) (* it766 (- 1)) it812))
      (a!18 (>= (+ a!17 (* it785 (+ it766 (- 1)) it784 (- 1))) 0))
      (a!20 (>= (+ a!1 (* it785 (+ it766 (- 1)) it784 (- 1))) 0))
      (a!24 (+ (+ a!8 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 1)))
      (a!25 (+ a!6
               (* (* it785 it784) (- 1))
               (* it785 (+ it766 (- 1)) it784 (- 1))
               (* (* it795 it784) (- 1))))
      (a!27 (+ a!8
               ...
               (* it785 (+ it766 (- 1)) it784 (- 1))
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!30 (>= (+ a!29 (* it785 (+ it766 (- 1)) it784 (- 1)) (- 1)) 0))
      (a!31 (>= (+ a!17
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
      ...
      (a!35 (>= (+ (+ a!13 it812)
                   ...
                   (- 1))
                0))
      (a!37 (+ (+ a!1 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 1)))
      (a!38 (>= (+ a!29
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 1))
                0))
      (a!39 (+ (+ a!17 (* it785 (+ it766 (- 1)) it784 (- 1))) (- 1))))
(let ((a!15 (>= (+ a!14
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it766 (- 1)) it784 (- 1))
                   (* it785 (+ it784 (- 1)) (- 1)))
                0))
      (a!32 (>= (+ a!14 (* it785 (+ it766 (- 1)) it784 (- 1))) 0)))
  (and (>= a!2 0)
       (>= (+ a!3 (- 2)) 0)
       (= (+ (* it809 (- 1)) 3) 0)
       (>= (+ a!4 (- 2)) 0)
       (>= (+ (* it811 (- 1)) 1) 0)
       (= (+ (* it785 it784) (* it795 it784) 1) 0)
       (>= (+ it812 (- 3)) 0)
       (>= (+ a!5 (- 3)) 0)
       (>= a!7 0)
       (>= a!9 0)
