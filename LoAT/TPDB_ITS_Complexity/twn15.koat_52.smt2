...
(assert (let ((a!1 (> (+ (+ 0 (* it687 9))
                 ...
                 (* (exp it686 2) (+ 0 (- 16))))
              (+ 0 0)))
      (a!2 (* (* (+ 0 it687) (exp 81 (+ it729 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it686 2) (exp (exp 16 (+ it729 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 81 (+ it729 (- 1))) (exp it688 3)) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it687) (exp 81 (+ it729 (- 1)))) (+ 0 9)))
      (a!7 (* (* (exp 81 (+ it729 (- 1))) (exp it688 3)) (+ 0 (- 9))))
      (a!9 (> (+ (+ 0 (* it687 3))
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it688 3) (+ 0 (- 2)))
                 (* (exp it686 2) (+ 0 (- 4))))
      ...
      (a!13 (* (* (+ 0 it687) (exp 81 (+ it729 (- 1)))) (+ 0 27)))
      (a!14 (* (* (exp 81 (+ it729 (- 1))) (exp it688 3)) (+ 0 (- 27)))))
(let ((a!5 (> (+ a!2
                 (* (exp it688 5) (+ 0 (- 1)))
                 (exp it688 3)
                 (* a!3 (+ 0 (- 4)))
