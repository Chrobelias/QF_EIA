...
(assert (let ((a!1 (> (+ (* (exp it644 2) (+ 0 (- 4)))
                 ...
                 (* (exp it646 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!2 (* (* (exp it646 3) (exp 81 (+ it494 (- 1)))) (+ 0 (- 27))))
      (a!3 (* (exp it644 2) (exp (exp 16 (+ it494 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it645)) (+ 0 27)))
      (a!6 (* (* (exp it646 3) (exp 81 (+ it494 (- 1)))) (+ 0 (- 3))))
      (a!7 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it645)) (+ 0 3)))
      (a!9 (> (+ (* (exp it644 2) (+ 0 (- 16)))
                 (* (exp it646 5) (+ 0 (- 1)))
                 (+ 0 (* it645 9))
                 (* (exp it646 3) (+ 0 (- 8))))
              (+ 0 0)))
      (a!10 (> (+ (* (exp it644 2) (+ 0 (- 1)))
                  (* (exp it646 5) (+ 0 (- 1)))
                  (+ 0 it645))
               (+ 0 0)))
      (a!11 (* (* (exp it646 3) (exp 81 (+ it494 (- 1)))) (+ 0 (- 9))))
      (a!12 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it645)) (+ 0 9)))
      (a!14 (* (* (exp it646 3) (exp 81 (+ it494 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* (exp it646 5) (+ 0 (- 1)))
                 a!2
                 (* a!3 (+ 0 (- 64)))
                 (exp it646 3)
                 a!4)
