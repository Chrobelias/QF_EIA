...
(assert (let ((a!1 (>= (+ (+ (* it785 (- 1)) it912 (* it795 (- 1))) (- 2)) 0))
      (a!2 (+ (+ (+ it912 (* it795 (- 1))) (* it911 (- 2))) (- 2)))
      (a!3 (>= (+ (+ it912 (* it911 (- 2))) (- 2)) 0))
      (a!4 (+ (+ (+ it912 (* it795 (- 1))) (* it911 (- 2))) (- 1)))
      (a!5 (>= (+ (+ (* it785 (- 1)) it912 (* it795 (- 1)))
                  (* it911 (- 2))
                  (- 1))
               0))
      (a!6 (>= (+ (+ it912 (* it795 (- 1))) (- 2)) 0))
      (a!7 (>= (+ (+ it912 (* it795 (- 1))) (- 3)) 0))
      (a!8 (>= (+ (+ it912 (* it911 (- 2))) (- 1)) 0)))
  (and (>= (+ (* it909 (- 1)) 4) 0)
       a!1
       (>= a!2 0)
       (= 0 0)
