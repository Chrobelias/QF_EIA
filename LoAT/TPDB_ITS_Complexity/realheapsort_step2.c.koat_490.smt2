...
(declare-fun it2086 () Int)
(declare-fun it2087 () Int)
(declare-fun it2088 () Int)
(declare-fun it2089 () Int)
(declare-fun it2090 () Int)
(declare-fun it2091 () Int)
(declare-fun it2092 () Int)
(declare-fun it2093 () Int)
(declare-fun it2094 () Int)
...
(assert (and (= (+ it2077 (- 20)) 0) (> (+ (* it2080 (- 1)) (* it2081 2) it2082 3) 0)))
(assert (= (+ it2086 (- 18)) 0))
(assert (= (+ it2087 (* it2078 (- 1)) (- 4)) 0))
(assert (= (+ it2088 (* it2082 (- 1)) (- 1)) 0))
(assert (= (+ (* it2080 (- 1)) it2089) 0))
(assert (= (+ it2090 (* it2081 (- 1))) 0))
(assert (= (+ it2091 (* it2082 (- 1)) (- 1)) 0))
(assert (= (+ (* it2083 (- 1)) it2092) 0))
(assert (and (= (+ it2086 (- 18)) 0) (<= (+ it2091 (* it2089 (- 1)) 2) 0)))
(assert (= (+ it2093 (- 20)) 0))
(assert (= (+ (* it2087 (- 1)) it2094 (- 2)) 0))
(assert (= (+ (* it2088 (- 1)) it2095) 0))
(assert (= (+ it2096 (* it2089 (- 1))) 0))
(assert (= it2097 0))
(assert (= (+ (* it2091 (- 1)) it2098) 0))
(assert (= (+ it2099 (* it2092 (- 1))) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it2097)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it2097)) (+ 0 2))))
(let ((a!2 (+ (+ 0 it2096)
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              a!1
              (+ 0 (* it2098 (- 1)))
  ...
  (and (>= (+ (* it2093 (- 1)) 20) 0)
       (>= (+ it2093 (- 20)) 0)
       (>= (+ it2096 (* it2097 (- 2)) (* it2098 (- 1)) (- 3)) 0)
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))
       (>= (+ (* it2096 (- 1)) (* it2097 2) it2098 3) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
