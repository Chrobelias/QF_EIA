...
(assert (let ((a!1 (>= (+ (+ (* it668 (- 2)) it669) (- 1)) 0))
      (a!2 (>= (+ (+ (* it668 (- 2)) it669) (- 2)) 0)))
  (and (>= (+ (* it706 (- 1)) it669 (- 2)) 0)
       a!1
       (>= (+ it668 (- 1)) 0)
       (>= (+ it669 (- 2)) 0)
       (>= (+ it666 (- 4)) 0)
       (>= (+ (* it668 (- 2)) (* it706 (- 1)) it669 (- 1)) 0)
       a!2
       (>= (+ (* it666 (- 1)) 4) 0)
       (>= (+ (* it668 (- 1)) 1) 0)
       (>= (+ it706 (- 1)) 0)
       (>= (+ it669 (- 3)) 0))))
(assert (= (+ it707 (* it666 (- 1))) 0))
(assert (= (+ (* it667 (- 1)) it708 (* it706 (- 3))) 0))
(assert (= (+ (* it668 (- 1)) it709) 0))
(assert (= (+ it710 it706 (* it669 (- 1))) 0))
(assert (= (+ it711 (* it668 (- 1))) 0))
(assert (= (+ (* it668 (- 2)) it712) 0))
(assert (let ((a!1 (>= (+ (+ it710 (* it709 (- 2))) (- 1)) 0))
      (a!2 (>= (+ (+ it710 (* it709 (- 2))) (- 2)) 0)))
  (and a!1
       a!2
       (>= (+ it707 (- 4)) 0)
       (= 0 0)
