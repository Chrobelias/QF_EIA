...
(assert (and (= (+ it564 (- 7)) 0) (>= (+ it567 (* it568 2) (* it566 (- 1)) 2) 0)))
(assert (= (+ it576 (- 5)) 0))
(assert (= (+ it577 (* it565 (- 1)) (- 2)) 0))
(assert (= (+ it578 (* it566 (- 1))) 0))
(assert (= (+ (* it567 (- 1)) it579 (- 1)) 0))
(assert (= (+ it580 (* it568 (- 1))) 0))
(assert (= (+ it581 (* it569 (- 1))) 0))
(assert (and (= (+ it576 (- 5)) 0) (>= (+ (* it578 (- 1)) it579 1) 0)))
(assert (= (+ it584 (- 15)) 0))
(assert (= (+ (* it577 (- 1)) it585 (- 2)) 0))
(assert (= (+ it586 (* it578 (- 1))) 0))
(assert (= (+ it587 (* it579 (- 1))) 0))
(assert (= (+ (* it580 (- 1)) it588) 0))
(assert (= (+ it589 (* it581 (- 1))) 0))
(check-sat)
