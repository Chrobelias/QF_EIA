...
(assert (and (= (+ (* it142 (- 1)) it147) 0)
     ...
     (>= (+ (* it145 (- 1)) it143 (- 1)) 0)))
(assert (= (+ it152 (- 5)) 0))
(assert (= (+ it153 (* it141 (- 1)) (- 1)) 0))
(assert (= (+ (* it142 (- 1)) it154) 0))
(assert (= (+ it155 (- 2)) 0))
(assert (= (+ it156 (* it144 (- 1))) 0))
(assert (= (+ (* it145 (- 1)) it157) 0))
(assert (= (+ it158 (* it146 (- 1))) 0))
(assert (= (+ it159 (* it147 (- 1))) 0))
