...
(assert (let ((a!1 (>= (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882) (- 1)) 0))
      (a!2 (>= (+ it882
                  ...
                  (- 3))
               0))
      (a!3 (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!4 (>= (+ (+ (* it795 (- 1)) it882) (- 3)) 0))
      (a!5 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it882) (- 2)))
      (a!6 (+ (* (* it785 it784) (- 1)) it882 (* (* it795 it784) (- 1))))
      (a!7 (>= (+ (+ (* it881 (- 2)) it882)
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!8 (>= (+ (+ (* it884 (- 1)) it882) (- 1)) 0))
      (a!9 (+ (+ (* it795 (- 1)) it882)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!10 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it882)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))
               (- 2)))
      (a!11 (>= (+ (+ (* it881 (- 2)) it882) (- 2)) 0))
      (a!12 (>= (+ (+ (* it795 (- 1)) (* it881 (- 2)) it882) (- 2)) 0))
      (a!13 (+ (+ (* it785 (- 1)) (* it795 (- 1))) (* it881 (- 2)) it882))
      (a!15 (>= (+ (+ (* it795 (- 1)) it882) (- 2)) 0))
      (a!16 (>= (+ (+ (* it881 (- 2)) it882) (- 1)) 0)))
(let ((a!14 (>= (+ a!13
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 1))
