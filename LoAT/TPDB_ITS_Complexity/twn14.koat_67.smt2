...
(assert (let ((a!1 (> (+ (+ 0 it711)
      ...
      (a!2 (> (+ (+ 0 (* it711 3))
                 ...
                 (* (exp it710 2) (+ 0 (- 4))))
              (+ 0 0)))
      (a!3 (* (* (exp 81 (+ it495 (- 1))) (exp it712 3)) (+ 0 (- 1))))
      (a!4 (* (exp it710 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!6 (* (* (exp 81 (+ it495 (- 1))) (exp it712 3)) (+ 0 (- 3))))
      (a!7 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it711)) (+ 0 3)))
      (a!9 (* (* (exp 81 (+ it495 (- 1))) (exp it712 3)) (+ 0 (- 27))))
      (a!10 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it711)) (+ 0 27)))
      (a!12 (> (+ (+ 0 (* it711 9))
                  (* (exp it712 5) (+ 0 (- 1)))
                  (* (exp it712 3) (+ 0 (- 8)))
                  (* (exp it710 2) (+ 0 (- 16))))
               (+ 0 0)))
      (a!13 (* (* (exp 81 (+ it495 (- 1))) (exp it712 3)) (+ 0 (- 9))))
      (a!14 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it711)) (+ 0 9))))
(let ((a!5 (+ a!3
              (* (exp it712 5) (+ 0 (- 1)))
              (exp it712 3)
              (* (exp 81 (+ it495 (- 1))) (+ 0 it711))
              (* a!4 (+ 0 (- 1)))))
      (a!8 (> (+ a!6
                 (* (exp it712 5) (+ 0 (- 1)))
                 (exp it712 3)
