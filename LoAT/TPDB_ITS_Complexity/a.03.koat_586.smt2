...
(assert (let ((a!1 (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543)
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!2 (+ (* (+ it1552 (- 1)) it2537 it1243 (- 1))
              (* it1552 (- 1))
              (* (+ it1552 (- 1)) it706 it1243 (- 1))))
      (a!4 (>= (+ (+ (* it2542 (- 2)) it2543) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2545 (- 1)) it2543) (- 1)) 0))
      (a!8 (+ it2543 (* (* it2537 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!9 (>= (+ (+ (* it2542 (- 2)) it2543)
                  (* it706 (+ it1243 (- 1)) (- 1))
                  (* it2537 (+ it1243 (- 1)) (- 1))
                  (- 2))
               0))
      (a!15 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543) (- 1)) 0))
      (a!16 (+ (+ (* it706 (- 1)) it2543)
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!19 (>= (+ (+ (* it706 (- 1)) it2543) (* it2537 (- 1)) (- 2)) 0))
      (a!20 (>= (+ (+ (* it706 (- 1)) it2543) (- 2)) 0))
      (a!22 (>= (+ (+ (* it706 (- 1)) it2543) (- 3)) 0))
      (a!23 (>= (+ it2543
                   (* it706 (+ it1243 (- 1)) (- 1))
                   (* it2537 (+ it1243 (- 1)) (- 1))
                   (- 3))
                0))
      (a!24 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543) (- 2)) 0))
      (a!25 (>= (+ (+ (* it2542 (- 2)) it2543) (- 1)) 0))
      (a!26 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543)
                   (* it2537 (- 1))
                   (- 1))
                0)))
(let ((a!3 (+ (+ a!2 it2543)
      ...
      (a!5 (>= (+ (+ a!2 it2543)
                  ...
                  (- 2))
               0))
      (a!7 (>= (+ (+ a!2 (* it2542 (- 2))) it2543) 0))
      (a!10 (+ (+ a!2 (* it2542 (- 2))) (* it706 (- 1)) it2543))
      (a!12 (+ (+ a!2 (* it706 (- 1)) it2543)
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!13 (>= (+ (+ a!2 (* it706 (- 1)) it2543) (* it2537 (- 1)) (- 1)) 0))
      (a!14 (>= (+ (+ a!2 (* it706 (- 1)) it2543) (- 2)) 0))
      (a!17 (+ (+ (+ a!2 (* it2542 (- 2))) it2543) (- 1)))
      (a!18 (>= (+ (+ a!2 (* it706 (- 1)) it2543) (- 1)) 0))
      (a!21 (+ (+ (+ a!2 (* it2542 (- 2))) it2543)
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it2537 (+ it1243 (- 1)) (- 1))
               (- 1))))
(let ((a!11 (+ a!10
  ...
  (and (>= (+ (* it2545 (- 1)) it2543) 0)
       ...
       a!18
       a!19
       (= (+ (* it2537 it1243) (* it706 it1243) 1) 0)
       (>= (+ a!16 (- 2)) 0)
       (>= a!11 0)
       a!20
       (>= a!21 0)
