...
(assert (let ((a!1 (>= (+ (+ (* it814 (- 1)) it812) (- 1)) 0)))
  (and (>= (+ (* it814 (- 1)) it812) 0) a!1 (= (+ it809 (- 3)) 0))))
(assert (= (+ it853 (- 4)) 0))
(assert (= (+ it854 (* it810 (- 1)) (- 1)) 0))
(assert (= (+ it855 (* it811 (- 1))) 0))
(assert (= (+ it856 (* it812 (- 1))) 0))
(assert (= (+ it857 (* it813 (- 1))) 0))
(assert (= (+ it858 (* it814 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it855 (- 2)) (* it795 (- 1)) it856) (- 1)) 0))
      (a!2 (>= (+ (+ (* it855 (- 2)) it856) (- 2)) 0))
      (a!3 (>= (+ (+ (* it855 (- 2)) it856) (- 1)) 0))
      (a!4 (>= (+ (+ (* it855 (- 2)) (* it795 (- 1)) it856) (- 2)) 0))
      (a!5 (>= (+ (+ (* it795 (- 1)) it856) (- 2)) 0))
      (a!6 (>= (+ (+ (* it795 (- 1)) it856) (- 3)) 0)))
  (and (>= (+ it853 (- 4)) 0)
       (>= (+ it855 (- 1)) 0)
       (= 0 0)
       a!1
       (>= (+ (* it855 (- 2)) (* it785 (- 1)) (* it795 (- 1)) it856 (- 1)) 0)
       (<= (+ it785 it795) 0)
       (>= (+ (* it853 (- 1)) 4) 0)
       (>= (+ it785 (- 1)) 0)
       (>= (+ it795 (- 1)) 0)
