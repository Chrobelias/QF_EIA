...
(assert (let ((a!1 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it617 2)))
      (a!2 (* (* (exp 9 (+ it82 (- 1))) (exp it619 3)) (+ 0 (- 1))))
      (a!4 (* (* (+ 0 it618) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it82 (- 1))) (exp it619 3)) (+ 0 (- 3))))
      (a!7 (> (+ (* (exp it617 2) (+ 0 (- 1)))
                 (* (exp it619 5) (+ 0 (- 1)))
                 (+ 0 it618))
              (+ 0 0)))
      (a!8 (> (+ (* (exp it617 2) (+ 0 (- 4)))
                 ...
                 (* (exp it619 3) (+ 0 (- 2))))
              (+ 0 0))))
(let ((a!3 (+ (* (exp it619 5) (+ 0 (- 1)))
              (* (+ 0 it618) (exp 9 (+ it82 (- 1))))
              (* a!1 (+ 0 (- 1)))
              (exp it619 3)
              a!2))
      (a!6 (> (+ (* (exp it619 5) (+ 0 (- 1)))
