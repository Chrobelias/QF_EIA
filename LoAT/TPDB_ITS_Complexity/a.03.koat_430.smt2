...
(assert (and (= (+ (* it1083 (- 1)) it1081) 0)
     (= (+ it1078 (- 3)) 0)
     (>= (+ it1083 (- 1)) 0)))
(assert (= (+ it1099 (- 3)) 0))
(assert (= (+ it1100 (* it1079 (- 1)) (- 1)) 0))
(assert (= (+ (* it1080 (- 1)) it1101) 0))
(assert (= (+ it1102 (* it1081 (- 1))) 0))
(assert (= (+ (* it1083 (- 1)) it1103) 0))
(assert (= (+ (* it1083 (- 2)) it1104) 0))
(check-sat)
