...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
      ...
      (a!4 (+ (* (+ it716 (- 1)) it540 (- 1))
              it2573
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!5 (>= (+ (+ it2573 (* it540 (- 1))) (- 3)) 0))
      (a!6 (>= (+ (+ it2573 (* it2572 (- 2))) (- 2)) 0))
      (a!7 (>= (+ (+ it2573 (* it2572 (- 2))) (- 1)) 0))
      (a!8 (+ (* it706 (+ it766 (- 1)) it716 (- 1)) it2573 (* it766 (- 1))))
      (a!13 (+ (+ (+ it2573 (* it540 (- 1))) (* it2572 (- 2))) (- 2)))
      (a!16 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      (a!18 (>= (+ (+ it2573 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2572 (- 2))
                   (- 1))
                0))
      (a!19 (+ it2573 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!29 (>= (+ (+ it2573 (* it540 (- 1))) (- 2)) 0))
      (a!30 (>= (+ (+ it2573 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!31 (+ (+ (+ it2573 (* it540 (- 1))) (* it2572 (- 2))) (- 1))))
(let ((a!2 (+ (+ a!1 (* (+ it766 (- 1)) it540 it716 (- 1)))
              (* it2572 (- 2))
              (- 1)))
      (a!3 (+ a!1 (* it540 (- 1)) (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!9 (+ a!8
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))
      ...
      (a!10 (+ a!1
               ...
               (* it540 (- 1))
               (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!11 (+ a!8 (* it540 (- 1)) (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!12 (+ a!8
               (* it706 (- 1))
               (* it540 (- 1))
               (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!14 (>= (+ (+ a!4 (* it540 (- 1))) (- 3)) 0))
      (a!15 (+ (+ a!8 (* (+ it766 (- 1)) it540 it716 (- 1))) (* it2572 (- 2))))
      (a!17 (>= (+ (+ a!4 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!20 (+ (+ a!8 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 1)))
      (a!21 (+ (+ a!1 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 2)))
      (a!23 (>= (+ (+ a!4 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2572 (- 2))
                   (- 1))
                0))
      (a!24 (+ (+ a!8 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 2)))
      (a!25 (+ (+ (+ a!4 (* it540 (- 1))) (* it2572 (- 2))) (- 2)))
      (a!26 (+ (+ (+ a!4 (* it540 (- 1))) (* it2572 (- 2))) (- 1)))
      (a!28 (>= (+ (+ a!4 (* it540 (- 1))) (- 2)) 0)))
(let ((a!22 (>= (+ (+ a!11 (* it2572 (- 2))) (- 1)) 0))
      (a!27 (>= (+ (+ a!3 (* it2572 (- 2))) (- 1)) 0)))
  (and (>= (+ (* it2570 (- 1)) 3) 0)
       (>= a!2 0)
       (>= (+ it540 (- 1)) 0)
       (>= (+ a!3 (- 2)) 0)
