...
(assert (let ((a!1 (> (+ (* (exp it844 3) (+ 0 (- 2)))
                 (* (exp it842 2) (+ 0 (- 4)))
                 (+ 0 (* it843 3))
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (> (+ (* (exp it844 3) (+ 0 (- 8)))
                 ...
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it843)) (+ 0 27)))
      (a!4 (* (exp it842 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!5 (* (* (exp 81 (+ it495 (- 1))) (exp it844 3)) (+ 0 (- 27))))
      (a!7 (> (+ (* (exp it842 2) (+ 0 (- 1)))
                 (+ 0 it843)
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!8 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it843)) (+ 0 3)))
      (a!9 (* (* (exp 81 (+ it495 (- 1))) (exp it844 3)) (+ 0 (- 3))))
      (a!11 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it843)) (+ 0 9)))
      (a!12 (* (* (exp 81 (+ it495 (- 1))) (exp it844 3)) (+ 0 (- 9))))
      (a!14 (* (* (exp 81 (+ it495 (- 1))) (exp it844 3)) (+ 0 (- 1)))))
(let ((a!6 (> (+ (exp it844 3)
                 a!3
                 (* a!4 (+ 0 (- 64)))
                 a!5
