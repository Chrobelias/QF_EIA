...
(assert (let ((a!1 (> (+ (+ 0 (* it854 3))
      ...
      (a!2 (> (+ (+ 0 it854)
                 ...
                 (* (exp it855 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (* (exp it855 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (+ 0 it854) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!5 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it853 2)))
      (a!7 (* (* (exp it855 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1)))))
(let ((a!6 (> (+ (exp it855 3)
                 a!3
                 a!4
                 (* (exp it855 5) (+ 0 (- 1)))
