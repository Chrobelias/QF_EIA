...
(assert (let ((a!1 (>= (+ (+ (* it1037 (- 1)) it1035) (- 1)) 0))
      (a!2 (>= (+ (+ (* it1024 (- 1)) (* it1034 (- 2)) it1035) 1) 0)))
  (and (>= (+ (* it1034 (- 1)) 1) 0)
       (>= (+ it1035 (- 2)) 0)
       (>= (+ it1032 (- 3)) 0)
       (>= (+ (* it1032 (- 1)) 3) 0)
       ...
       (>= (+ it1034 (- 1)) 0)
       a!1
       (>= (+ (* it1024 (- 1)) (* it1034 (- 2)) it1035) 0)
       a!2)))
(assert (= (+ it1056 (* it1032 (- 1))) 0))
(assert (= (+ (* it1024 (- 3)) it1057 (* it1033 (- 1))) 0))
(assert (= (+ (* it1034 (- 1)) it1058) 0))
(assert (= (+ it1024 (* it1035 (- 1)) it1059) 0))
(assert (= (+ (* it1034 (- 1)) it1060) 0))
(assert (= (+ (* it1034 (- 2)) it1061) 0))
(assert (let ((a!1 (+ (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1)) it1059))
      (a!2 (>= (+ (+ (* it1058 (- 2)) it1059) (- 2)) 0))
      (a!3 (+ (* (+ it716 (- 1)) it540 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      (a!5 (>= (+ (+ (* it1058 (- 2)) (* it540 (- 1)) it1059) (- 2)) 0))
      (a!7 (>= (+ (+ (* it540 (- 1)) it1059) (- 3)) 0))
      (a!8 (>= (+ (+ (* it1061 (- 1)) it1059) (- 1)) 0))
      (a!12 (>= (+ (+ (* it540 (- 1)) it1059) (- 2)) 0))
      (a!13 (>= (+ (+ (* it1058 (- 2)) (* it540 (- 1)) it1059) (- 1)) 0))
      (a!15 (>= (+ (+ (* it1058 (- 2)) it1059) (- 1)) 0)))
(let ((a!4 (>= (+ (+ a!3 (* it706 (- 1)))
                  (* it1058 (- 2))
                  (* it540 (- 1))
                  it1059
                  (- 1))
               0))
      (a!6 (>= (+ (+ a!3 (* it706 (- 1))) (* it540 (- 1)) it1059 (- 2)) 0))
      (a!9 (>= (+ (+ a!3 (* it540 (- 1)) it1059) (- 2)) 0))
      (a!10 (+ (+ a!3 (* it1058 (- 2))) (* it540 (- 1)) it1059))
      (a!11 (>= (+ (+ a!3 (* it1058 (- 2))) it1059 (- 2)) 0))
      (a!14 (>= (+ (+ a!3 (* it540 (- 1)) it1059) (- 3)) 0)))
  (and (= (+ it1061 (* it1058 (- 2))) 0)
       (>= (+ it540 (- 1)) 0)
       (>= (+ a!1 (- 2)) 0)
       (>= (+ it1059 (- 2)) 0)
       a!2
       (>= (+ (* it706 (- 1)) (* it540 (- 1)) it1059 (- 2)) 0)
       (>= (+ it1056 (- 3)) 0)
       a!4
       a!5
       (>= (+ it1059 (- 3)) 0)
       ...
       a!8
       (= 0 0)
       (>= (+ (* it706 (- 1)) (* it1058 (- 2)) (* it540 (- 1)) it1059 (- 1)) 0)
       a!9
       (>= (+ a!10 (- 2)) 0)
       a!11
       a!12
