...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
      ...
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it706 (- 1)))
                  ...
                  (- 1))
               0))
      (a!5 (>= (+ (+ (* it88 (- 1)) (* it540 (- 1)) it2709) (- 3)) 0))
      (a!7 (+ (* it88 (- 1))
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))
              it2709))
      (a!8 (>= (+ (+ (* it88 (- 1)) it2709) (- 3)) 0))
      (a!9 (+ (+ (* it88 (- 1)) (* it2708 (- 2))) (* it540 (- 1)) it2709))
      (a!10 (+ (+ (+ (* it88 (- 1)) (* it2708 (- 2))) it2709) (- 1)))
      (a!11 (+ (+ (+ (* it88 (- 1)) (* it2708 (- 2))) it2709) 1))
      (a!12 (>= (+ (+ (* it88 (- 1)) (* it540 (- 1)) it2709) (- 2)) 0))
      (a!15 (>= (+ (+ (* it2711 (- 1)) it2709) (- 1)) 0))
      (a!16 (+ (+ (+ (* it88 (- 1)) (* it2708 (- 2))) it2709) (- 2)))
      (a!17 (>= (+ (+ (* it88 (- 1)) it2709) (- 2)) 0))
      (a!19 (>= (+ (+ (* it88 (- 1)) (* it706 (- 1)))
                   (* it540 (- 1))
                   it2709
                   (- 2))
                0))
      (a!20 (>= (+ (+ (* it88 (- 1)) (* it2708 (- 2))) it2709) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it706 (- 1))) (* it540 (- 1)) it2709 (- 2)) 0))
      (a!3 (+ (+ a!1 (* it2708 (- 2))) (* it540 (- 1)) it2709))
      (a!6 (>= (+ (+ a!1 (* it540 (- 1)) it2709) (- 3)) 0))
      (a!13 (>= (+ (+ a!1 (* it2708 (- 2))) it2709 (- 2)) 0))
      (a!14 (>= (+ (+ a!1 (* it706 (- 1)))
                   (* it2708 (- 2))
                   (* it540 (- 1))
                   it2709
