...
(assert (let ((a!1 (* (exp it686 2) (exp (exp 4 (+ it150 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp 9 (+ it150 (- 1))) (exp it688 3)) (+ 0 (- 1))))
      (a!4 (* (* (exp 9 (+ it150 (- 1))) (exp it688 3)) (+ 0 (- 3))))
      (a!5 (* (* (+ 0 it687) (exp 9 (+ it150 (- 1)))) (+ 0 3)))
      (a!7 (> (+ (+ 0 it687)
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it686 2) (+ 0 (- 1))))
              (+ 0 0)))
