...
(assert (= (+ it288 (- 13)) 0))
(assert (= (+ it304 (- 7)) 0))
(assert (= (+ (* it289 (- 1)) it305 (- 1)) 0))
(assert (= (+ (* it290 (- 1)) it306) 0))
(assert (= (+ (* it291 (- 1)) it307) 0))
(assert (= (+ it308 (* it290 (- 1))) 0))
(assert (= (+ (* it293 (- 1)) it309) 0))
(assert (let ((a!1 (>= (+ (+ (* it308 (- 2)) it306 (* it307 (- 1))) (- 4)) 0))
      (a!2 (>= (+ (+ (* it306 (- 1)) (* it307 (- 1))) (- 4)) 0))
      (a!3 (>= (+ (+ (* it306 (- 1)) (* it307 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ (* it308 (- 2)) it306 (* it307 (- 1))) (- 3)) 0)))
  (and a!1
       a!2
       (>= (+ (* it304 (- 1)) 7) 0)
       (>= (+ it304 (- 7)) 0)
