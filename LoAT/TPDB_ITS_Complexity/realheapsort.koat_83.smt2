...
(assert (let ((a!1 (>= (+ (+ (* it8515 (- 1)) it8516) (* it8517 2) 3) 0))
      (a!2 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it8517)) (+ 0 2)))
      (a!4 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it8517)) (+ 0 (- 2))))
      (a!6 (>= (+ (+ it8515 (* it8516 (- 1))) (* it8517 (- 2)) (- 3)) 0)))
(let ((a!3 (+ (+ 0 (+ (* it8515 (- 1)) it8516))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 2))
              a!2
              (+ 0 1)))
      (a!5 (+ (+ 0 (+ it8515 (* it8516 (- 1))))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 (- 2)))
              a!4
              (+ 0 (- 1)))))
  (and a!1
