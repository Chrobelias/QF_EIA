...
(assert (let ((a!1 (* (exp (exp 16 (+ it452 (- 1))) (+ 0 2)) (exp it635 2)))
      (a!2 (* (* (+ 0 it636) (exp 81 (+ it452 (- 1)))) (+ 0 3)))
      (a!3 (* (* (exp it637 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 3))))
      (a!5 (* (* (exp it637 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it635 2) (+ 0 (- 4)))
                 (* (exp it637 5) (+ 0 (- 1)))
                 (+ 0 (* it636 3))
                 (* (exp it637 3) (+ 0 (- 2))))
      ...
      (a!8 (> (+ (* (exp it635 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it636))
              (+ 0 0)))
      (a!9 (* (* (+ 0 it636) (exp 81 (+ it452 (- 1)))) (+ 0 27)))
      (a!10 (* (* (exp it637 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 27))))
      (a!12 (> (+ (* (exp it635 2) (+ 0 (- 16)))
                  (* (exp it637 5) (+ 0 (- 1)))
                  (+ 0 (* it636 9))
                  (* (exp it637 3) (+ 0 (- 8))))
               (+ 0 0)))
      (a!13 (* (* (+ 0 it636) (exp 81 (+ it452 (- 1)))) (+ 0 9)))
      (a!14 (* (* (exp it637 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 9)))))
(let ((a!4 (> (+ (* (exp it637 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
                 a!2
                 a!3
                 (exp it637 3))
      ...
      (a!6 (+ (* (exp it637 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (* (+ 0 it636) (exp 81 (+ it452 (- 1))))
              a!5
              (exp it637 3)))
      (a!11 (> (+ (* (exp it637 5) (+ 0 (- 1)))
                  (* a!1 (+ 0 (- 64)))
                  a!9
                  a!10
                  (exp it637 3))
               (+ 0 0)))
      (a!15 (> (+ (* (exp it637 5) (+ 0 (- 1)))
                  (* a!1 (+ 0 (- 16)))
                  a!13
                  a!14
                  (exp it637 3))
