...
(assert (let ((a!1 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it824 2)))
      (a!2 (* (* (exp it826 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!4 (> (+ (* (exp it826 3) (+ 0 (- 2)))
                 (* (exp it824 2) (+ 0 (- 4)))
                 (* (exp it826 5) (+ 0 (- 1)))
                 (+ 0 (* it825 3)))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it107 (- 1))) (+ 0 it825)) (+ 0 3)))
      (a!6 (* (* (exp it826 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!8 (> (+ (* (exp it824 2) (+ 0 (- 1)))
                 (* (exp it826 5) (+ 0 (- 1)))
                 (+ 0 it825))
              (+ 0 0))))
