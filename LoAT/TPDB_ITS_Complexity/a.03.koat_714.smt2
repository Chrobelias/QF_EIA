...
(assert (let ((a!1 (+ (* it706 (- 1)) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!3 (>= (+ (+ (* it706 (- 1)) (* it2708 (- 2)))
                  (* it540 (- 1))
                  it2709
                  (- 1))
               0))
      (a!4 (>= (+ (+ (* it2711 (- 1)) it2709) (- 1)) 0))
      (a!5 (>= (+ (* it706 (+ it1243 (- 1)) (- 1))
                  (* it540 (+ it1243 (- 1)) (- 1))
                  it2709
                  (- 3))
               0))
      (a!6 (>= (+ (+ (* it2708 (- 2)) it2709) (- 1)) 0))
      (a!7 (+ (* (* it540 it1243) (- 1)) it2709 (* (* it706 it1243) (- 1))))
      (a!8 (+ (+ (+ (* it706 (- 1)) (* it2708 (- 2))) it2709) (- 2)))
      (a!9 (>= (+ (* it706 (+ it1243 (- 1)) (- 1))
                  (* it2708 (- 2))
                  (* it540 (+ it1243 (- 1)) (- 1))
                  it2709
                  (- 2))
               0))
      (a!10 (>= (+ (+ (* it2708 (- 2)) it2709) (- 2)) 0))
      (a!11 (+ (+ (+ (* it706 (- 1)) (* it2708 (- 2))) it2709) (- 1)))
      (a!16 (>= (+ (+ (* it706 (- 1)) it2709) (- 3)) 0))
      (a!17 (>= (+ (+ (* it706 (- 1)) it2709) (- 2)) 0)))
(let ((a!2 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1)) it2709) (- 2)))
      (a!12 (+ (+ a!1 (* it2708 (- 2))) (* it540 (+ it1243 (- 1)) (- 1)) it2709))
      (a!13 (>= (+ (+ a!1 (* it2708 (- 2)))
                   (* it540 (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   it2709
                   (- 1))
                0))
      (a!14 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1)) it2709) (- 3)))
      (a!15 (>= (+ a!1
                   (* it540 (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   it2709
