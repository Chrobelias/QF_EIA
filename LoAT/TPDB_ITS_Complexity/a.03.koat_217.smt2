...
(assert (let ((a!1 (>= (+ (+ (* it772 (- 2)) it773)
      ...
      (a!2 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))
              it773))
      (a!3 (>= (+ (+ (* it772 (- 2)) it773) (- 2)) 0))
      (a!4 (+ (+ (+ (* it772 (- 2)) it773) (* it540 (- 1))) (- 1)))
      (a!5 (+ (* it772 (- 2))
              (* (+ it716 (- 1)) it540 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))
              it773))
      (a!6 (+ (+ (+ (* it772 (- 2)) it773) (* it540 (- 1))) (- 2)))
      (a!8 (>= (+ (+ it773 (* it540 (- 1))) (- 3)) 0))
      (a!11 (>= (+ (+ (* it772 (- 2)) it773) (- 1)) 0))
      (a!12 (>= (+ (+ it773 (* it540 (- 1))) (- 2)) 0)))
(let ((a!7 (>= (+ (+ a!2 (* it540 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ a!2 (* it540 (- 1))) (- 3)) 0))
      (a!10 (>= (+ (+ a!5 (* it540 (- 1))) (- 2)) 0))
      (a!13 (>= (+ (+ a!5 (* it540 (- 1))) (- 1)) 0)))
  (and a!1
       (>= (+ a!2 (* it706 (- 1)) (* it540 (- 1)) (- 2)) 0)
