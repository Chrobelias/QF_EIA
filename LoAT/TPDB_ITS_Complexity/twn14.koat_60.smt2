...
(assert (let ((a!1 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it681 2)))
      (a!2 (* (* (exp it683 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (* (+ 0 it682) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp it683 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it682)
                 (* (exp it681 2) (+ 0 (- 1)))
                 (* (exp it683 5) (+ 0 (- 1))))
              (+ 0 0)))
