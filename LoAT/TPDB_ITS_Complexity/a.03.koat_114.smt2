...
(assert (let ((a!1 (>= (+ (+ it513 (* it540 (- 1))) (* it512 (- 2)) (- 1)) 0))
      (a!2 (>= (+ (+ it513 (* it512 (- 2))) (- 2)) 0))
      (a!3 (>= (+ (+ it513 (* it512 (- 2))) (- 1)) 0))
      (a!4 (>= (+ (+ it513 (* it540 (- 1))) (- 2)) 0)))
  (and a!1
       (>= (+ it513 (- 2)) 0)
       a!2
       (>= (+ it513 (- 3)) 0)
       ...
       (>= (+ (* it512 (- 1)) 1) 0)
       a!4)))
(assert (= (+ (* it510 (- 1)) it541) 0))
(assert (= (+ (* it511 (- 1)) it542 (* it540 (- 3))) 0))
(assert (= (+ (* it512 (- 1)) it543) 0))
(assert (= (+ (* it513 (- 1)) it544 it540) 0))
(assert (= (+ (* it512 (- 1)) it545) 0))
(assert (= (+ it546 (* it512 (- 2)) (- 1)) 0))
(assert (and (>= (+ it544 (- 3)) 0)
     (= (+ it543 (- 1)) 0)
     (>= (+ it544 (- 2)) 0)
     (= (+ it541 (- 4)) 0)))
(assert (= (+ it550 (- 3)) 0))
(assert (= (+ it551 (* it542 (- 1)) (- 2)) 0))
(assert (= (+ it552 (* it543 (- 1))) 0))
(assert (= (+ it553 (* it544 (- 1)) 1) 0))
(assert (= (+ it554 (* it543 (- 1))) 0))
(assert (= (+ it555 (* it543 (- 2))) 0))
(assert (let ((a!1 (+ (+ (+ (* it88 (- 1)) it553) (* it552 (- 2))) (- 1)))
      (a!2 (+ (+ (+ (* it88 (- 1)) it553) (* it19 (- 1))) (* it552 (- 2))))
      (a!3 (>= (+ (+ (* it88 (- 1)) it553) (- 3)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it553) (- 2)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) it553) (* it19 (- 1))) (- 2)))
      (a!6 (>= (+ (+ (* it88 (- 1)) it553) (* it552 (- 2))) 0))
      (a!7 (+ (+ (+ (* it88 (- 1)) it553) (* it552 (- 2))) 1))
      (a!8 (>= (+ (+ it553 (* it555 (- 1))) (- 1)) 0)))
  (and (>= (+ it552 (- 1)) 0)
       (>= a!1 0)
       (>= (+ a!2 1) 0)
       (>= a!2 0)
