...
(assert (= (+ (* it374 (- 1)) it430 (* it326 (- 6))) 0))
(assert (= (+ it431 (* it375 (- 1))) 0))
(assert (= (+ it432 (* it376 (- 1))) 0))
(assert (let ((a!1 (+ (* (exp 2 (+ it326 1)) (+ 0 (- 1)))
              (+ 0 it433)
              (* (+ 0 it377) (exp 2 it326) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (= (+ it434 (* it378 (- 1))) 0))
(assert (let ((a!1 (+ (+ 0 it435)
              (* (+ 0 it377) (exp 2 (+ it326 (- 1))) (+ 0 (- 2)))
              (* (exp 2 it326) (+ 0 (- 2)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ it434 it432 3) 0)
     (>= (+ (* it434 (- 1)) (* it432 (- 1)) (- 3)) 0)
     (>= (+ it50 (- 1)) 0)
     (>= (+ it429 (- 20)) 0)
     (>= (+ (* it429 (- 1)) 20) 0)
     (>= (+ it434 (* it432 (- 1)) (* it433 2) 3) 0)
     (>= (+ (* it434 (- 1)) it432 (* it433 (- 2)) (- 3)) 0)))
(check-sat)
