...
(assert (let ((a!1 (>= (+ (+ (* it2562 (- 2)) it2563) (- 2)) 0))
      ...
      (a!3 (+ (* it706 (- 1))
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!4 (>= (+ (+ (* it2562 (- 2)) it2563) (- 1)) 0))
      (a!5 (+ (+ (+ (* it706 (- 1)) (* it2562 (- 2))) it2563) (- 1)))
      (a!6 (>= (+ (+ (* it706 (- 1)) it2563) (- 2)) 0))
      (a!7 (>= (+ (* it2562 (- 2))
                  (* it706 (+ it1243 (- 1)) (- 1))
                  (* it2537 (+ it1243 (- 1)) (- 1))
                  it2563
                  (- 2))
               0))
      (a!8 (+ (+ (* it706 (- 1)) (* it2562 (- 2)))
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!9 (>= (+ (+ (* it706 (- 1)) it2563) (- 3)) 0))
      (a!10 (+ (+ (+ (* it706 (- 1)) (* it2562 (- 2))) it2563) (- 2)))
      (a!11 (>= (+ (* it706 (+ it1243 (- 1)) (- 1))
                   (* it2537 (+ it1243 (- 1)) (- 1))
                   it2563
                   (- 3))
                0)))
  (and (>= (+ (* it706 (- 1)) (* it2537 (- 1)) it2563 (- 2)) 0)
       (>= (+ it1243 (- 1)) 0)
       a!1
       a!2
       (>= (+ it2563 (- 3)) 0)
