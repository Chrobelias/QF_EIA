...
(assert (= (+ it117 (- 13)) 0))
(assert (= (+ it125 (- 7)) 0))
(assert (= (+ (* it118 (- 1)) it126 (- 2)) 0))
(assert (= (+ it127 (* it119 (- 1))) 0))
(assert (= (+ it128 (* it120 (- 1))) 0))
(assert (= (+ (* it122 (- 1)) it129) 0))
(assert (= (+ it130 (* it122 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it127 (* it128 (- 1)) (* it129 (- 2))) (- 3)) 0))
      (a!2 (>= (+ (+ it127 (* it128 (- 1)) (* it129 (- 2))) (- 4)) 0)))
  (and (>= (+ it125 (- 7)) 0)
       a!1
       a!2
       (>= (+ (* it125 (- 1)) 7) 0)
