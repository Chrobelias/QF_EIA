...
(assert (let ((a!1 (* (* (exp it584 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it582 2)))
      (a!4 (> (+ (* (exp it584 5) (+ 0 (- 1)))
                 (+ 0 it583)
                 (* (exp it582 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp it584 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (exp 9 (+ it107 (- 1))) (+ 0 it583)) (+ 0 3)))
      (a!8 (> (+ (* (exp it584 5) (+ 0 (- 1)))
                 (* (exp it584 3) (+ 0 (- 2)))
                 (+ 0 (* it583 3))
                 (* (exp it582 2) (+ 0 (- 4))))
