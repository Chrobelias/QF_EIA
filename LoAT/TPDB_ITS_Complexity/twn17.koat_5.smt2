...
(assert (let ((a!1 (< (+ (* (exp it158 3) (+ 0 2))
                 (+ 0 (* it157 (- 3)))
                 (* (exp it156 2) (+ 0 4))
                 (exp it158 5))
              (+ 0 0)))
      (a!2 (< (+ (+ 0 (* it157 (- 1))) (exp it156 2) (exp it158 5)) (+ 0 0))))
  (and a!1 a!2 (> it156 0) (= (+ it153 (- 3)) 0) (< (* it156 (- 2)) 0))))
(assert (= (+ it180 (- 3)) 0))
(assert (= (+ (* it154 (- 1)) it181 (- 2)) 0))
(assert (= (+ it182 (* it155 (- 1))) 0))
(assert (= (+ (* it156 (- 4)) it183) 0))
(assert (= (+ (* (exp it158 3) (+ 0 8)) (+ 0 (* it157 (- 9))) (+ 0 it184))
   (+ 0 0)))
(assert (= (+ (* it158 (- 1)) it185) 0))
(assert (= (+ (* it159 (- 1)) it186) 0))
(assert (let ((a!1 (> (+ (* (exp it185 3) (+ 0 (- 2)))
                 (* (exp it183 2) (+ 0 (- 4)))
                 (+ 0 (* it184 3))
                 (* (exp it185 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (> (+ (* (exp it183 2) (+ 0 (- 1)))
                 ...
                 (* (exp it185 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (exp (exp 4 (+ it177 (- 1))) (+ 0 2)) (exp it183 2)))
      (a!4 (* (* (exp 9 (+ it177 (- 1))) (exp it185 3)) (+ 0 (- 1))))
      (a!6 (* (* (+ 0 it184) (exp 9 (+ it177 (- 1)))) (+ 0 3)))
      (a!7 (* (* (exp 9 (+ it177 (- 1))) (exp it185 3)) (+ 0 (- 3)))))
(let ((a!5 (+ (* a!3 (+ 0 (- 1)))
              (exp it185 3)
              (* (+ 0 it184) (exp 9 (+ it177 (- 1))))
              (* (exp it185 5) (+ 0 (- 1)))
              a!4))
      (a!8 (> (+ (* a!3 (+ 0 (- 4)))
                 (exp it185 3)
