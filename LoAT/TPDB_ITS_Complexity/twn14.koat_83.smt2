...
(assert (let ((a!1 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it805)) (+ 0 9)))
      (a!2 (* (exp it804 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!3 (* (* (exp 81 (+ it495 (- 1))) (exp it806 3)) (+ 0 (- 9))))
      (a!5 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it805)) (+ 0 3)))
      (a!6 (* (* (exp 81 (+ it495 (- 1))) (exp it806 3)) (+ 0 (- 3))))
      (a!8 (> (+ (* (exp it806 3) (+ 0 (- 8)))
                 (* (exp it804 2) (+ 0 (- 16)))
                 (+ 0 (* it805 9))
                 (* (exp it806 5) (+ 0 (- 1))))
      ...
      (a!9 (> (+ (* (exp it804 2) (+ 0 (- 1)))
                 ...
                 (* (exp it806 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!10 (* (* (exp 81 (+ it495 (- 1))) (+ 0 it805)) (+ 0 27)))
      (a!11 (* (* (exp 81 (+ it495 (- 1))) (exp it806 3)) (+ 0 (- 27))))
      (a!13 (* (* (exp 81 (+ it495 (- 1))) (exp it806 3)) (+ 0 (- 1))))
      (a!15 (> (+ (* (exp it806 3) (+ 0 (- 2)))
                  (* (exp it804 2) (+ 0 (- 4)))
                  (+ 0 (* it805 3))
                  (* (exp it806 5) (+ 0 (- 1))))
               (+ 0 0))))
