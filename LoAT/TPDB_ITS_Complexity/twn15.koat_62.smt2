...
(assert (let ((a!1 (* (* (exp it788 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (exp (exp 16 (+ it452 (- 1))) (+ 0 2)) (exp it786 2)))
      (a!4 (* (* (+ 0 it787) (exp 81 (+ it452 (- 1)))) (+ 0 9)))
      (a!5 (* (* (exp it788 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 9))))
      (a!7 (> (+ (+ 0 (* it787 3))
                 (* (exp it788 3) (+ 0 (- 2)))
                 (* (exp it786 2) (+ 0 (- 4)))
                 (* (exp it788 5) (+ 0 (- 1))))
      ...
      (a!8 (> (+ (+ 0 (* it787 9))
                 ...
                 (* (exp it788 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!9 (* (* (+ 0 it787) (exp 81 (+ it452 (- 1)))) (+ 0 27)))
      (a!10 (* (* (exp it788 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 27))))
      (a!12 (> (+ (+ 0 it787)
                  (* (exp it786 2) (+ 0 (- 1)))
                  (* (exp it788 5) (+ 0 (- 1))))
               (+ 0 0)))
      (a!13 (* (* (+ 0 it787) (exp 81 (+ it452 (- 1)))) (+ 0 3)))
      (a!14 (* (* (exp it788 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (exp it788 3)
              (* (+ 0 it787) (exp 81 (+ it452 (- 1))))
              a!1
              (* a!2 (+ 0 (- 1)))
              (* (exp it788 5) (+ 0 (- 1)))))
      (a!6 (> (+ (exp it788 3)
