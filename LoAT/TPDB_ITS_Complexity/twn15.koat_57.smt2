...
(assert (let ((a!1 (> (+ (+ 0 (* it687 9))
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it688 3) (+ 0 (- 8)))
                 (* (exp it686 2) (+ 0 (- 16))))
              (+ 0 0)))
      (a!2 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it687)) (+ 0 3)))
      (a!3 (* (exp it686 2) (exp (exp 16 (+ it494 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 81 (+ it494 (- 1))) (exp it688 3)) (+ 0 (- 3))))
      (a!6 (> (+ (+ 0 it687)
                 (* (exp it688 5) (+ 0 (- 1)))
                 (* (exp it686 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it687)) (+ 0 9)))
      (a!8 (* (* (exp 81 (+ it494 (- 1))) (exp it688 3)) (+ 0 (- 9))))
      (a!10 (* (* (exp 81 (+ it494 (- 1))) (exp it688 3)) (+ 0 (- 1))))
      (a!12 (* (* (exp 81 (+ it494 (- 1))) (+ 0 it687)) (+ 0 27)))
      (a!13 (* (* (exp 81 (+ it494 (- 1))) (exp it688 3)) (+ 0 (- 27))))
      (a!15 (> (+ (+ 0 (* it687 3))
                  (* (exp it688 5) (+ 0 (- 1)))
                  (* (exp it688 3) (+ 0 (- 2)))
                  (* (exp it686 2) (+ 0 (- 4))))
