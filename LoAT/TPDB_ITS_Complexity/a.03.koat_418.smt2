...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
      ...
      (a!3 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))
              it1081))
      (a!5 (>= (+ (+ (* it1080 (- 2)) it1081) (- 1)) 0))
      (a!7 (>= (+ (+ (* it1080 (- 2)) it1081) (- 2)) 0))
      (a!8 (+ (+ (+ (* it1080 (- 2)) it1081) (* it540 (- 1))) (- 2)))
      (a!9 (+ it1081 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!11 (+ (+ (+ (* it1080 (- 2)) it1081) (* it540 (- 1))) (- 1)))
      (a!12 (>= (+ (+ it1081 (* it540 (- 1))) (- 2)) 0))
      (a!13 (>= (+ (+ (* it1083 (- 1)) it1081) (- 1)) 0))
      (a!14 (>= (+ (+ it1081 (* it540 (- 1))) (- 3)) 0))
      (a!15 (>= (+ (+ (* it1080 (- 2)) it1081)
                   (* it706 (- 1))
                   (* it540 (- 1))
                   (- 1))
                0)))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1))) (- 2)) 0))
      (a!4 (>= (+ (+ a!3 (* it540 (- 1))) (- 2)) 0))
      (a!6 (>= (+ (+ a!3 (* it540 (- 1))) (- 3)) 0))
      (a!10 (>= (+ (+ a!1 (* it540 (- 1))) (- 1)) 0)))
  (and (>= (+ a!1 (* it706 (- 1)) (* it540 (- 1)) (- 1)) 0)
       a!2
       (>= (+ (* it1080 (- 1)) 1) 0)
       (>= (+ it540 (- 1)) 0)
       a!4
