...
(assert (= (+ it539 (- 13)) 0))
(assert (= (+ it595 (- 7)) 0))
(assert (= (+ it596 (* it540 (- 1)) (- 1)) 0))
(assert (= (+ it597 (* it541 (- 1))) 0))
(assert (= (+ (* it542 (- 1)) it598) 0))
(assert (= (+ it599 (* it541 (- 1))) 0))
(assert (= (+ it600 (* it544 (- 1))) 0))
(assert (and (= (+ it595 (- 7)) 0) (>= (+ (* it599 2) (* it597 (- 1)) it598 2) 0)))
(assert (= (+ it610 (- 5)) 0))
(assert (= (+ it611 (* it596 (- 1)) (- 2)) 0))
(assert (= (+ it612 (* it597 (- 1))) 0))
(assert (= (+ it613 (* it598 (- 1)) (- 1)) 0))
(assert (= (+ (* it599 (- 1)) it614) 0))
(assert (= (+ it615 (* it600 (- 1))) 0))
(assert (and (>= (+ it612 (* it613 (- 1)) (- 2)) 0) (= (+ it610 (- 5)) 0)))
(assert (= (+ it621 (- 7)) 0))
(assert (= (+ (* it611 (- 1)) it622 (- 2)) 0))
(assert (= (+ (* it612 (- 1)) it623) 0))
(assert (= (+ it624 (* it613 (- 1))) 0))
(assert (= it625 0))
(assert (= (+ (* it615 (- 1)) it626) 0))
(assert (let ((a!1 (>= (+ (+ (* it624 (- 1)) (* it623 (- 1))) (- 4)) 0))
      (a!2 (>= (+ (+ (* it624 (- 1)) (* it625 (- 2)) it623) (- 3)) 0))
      (a!3 (>= (+ (+ (* it624 (- 1)) (* it623 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ (* it624 (- 1)) (* it625 (- 2)) it623) (- 4)) 0)))
  (and (>= (+ (* it621 (- 1)) 7) 0)
       a!1
       a!2
       a!3
