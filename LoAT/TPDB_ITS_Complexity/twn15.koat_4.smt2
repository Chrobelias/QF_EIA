...
(assert (let ((a!1 (> (+ (* (exp it71 2) (+ 0 (- 4)))
      ...
      (a!2 (> (+ (* (exp it71 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it72))
              (+ 0 0)))
      (a!3 (* (* (exp it73 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it71 2)))
      (a!6 (* (* (exp it73 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!7 (* (* (+ 0 it72) (exp 9 (+ it117 (- 1)))) (+ 0 3))))
(let ((a!5 (+ a!3
              (* (exp it73 5) (+ 0 (- 1)))
              (* (+ 0 it72) (exp 9 (+ it117 (- 1))))
              (exp it73 3)
              (* a!4 (+ 0 (- 1)))))
      (a!8 (> (+ a!6
                 (* (exp it73 5) (+ 0 (- 1)))
