...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      ...
      (a!5 (>= (+ (+ it1110 (* it540 (- 1))) (- 2)) 0))
      (a!7 (+ (+ (+ (* it1109 (- 2)) it1110) (* it540 (- 1))) (- 1)))
      (a!8 (+ (+ (+ (* it1109 (- 2)) it1110) (* it540 (- 1))) (- 2)))
      (a!10 (>= (+ (+ it1110 (* it540 (- 1))) (- 3)) 0))
      (a!12 (>= (+ (+ (* it1109 (- 2)) it1110) (- 1)) 0)))
(let ((a!2 (>= (+ (+ (+ a!1 it1110) (* it540 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ a!1 (* it1109 (- 2)))
                  (* it706 (- 1))
                  it1110
                  (* it540 (- 1))
                  (- 1))
               0))
      (a!6 (+ (+ (+ a!1 (* it1109 (- 2))) it1110) (* it540 (- 1))))
      (a!9 (>= (+ (+ (+ a!1 it1110) (* it540 (- 1))) (- 2)) 0))
      (a!11 (+ (+ (+ a!1 (* it1109 (- 2))) it1110) (- 2))))
  (and a!2
       (>= (+ it540 (- 1)) 0)
       (>= (+ it1110 (- 3)) 0)
       a!3
       ...
       (>= (+ it716 (- 1)) 0)
       (>= (+ (+ a!1 it1110) (- 3)) 0)
       (>= (+ a!1 (* it706 (- 1)) it1110 (* it540 (- 1)) (- 2)) 0)
       (>= (+ it1109 (- 1)) 0)
