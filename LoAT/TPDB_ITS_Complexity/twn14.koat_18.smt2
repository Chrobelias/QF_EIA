...
(assert (let ((a!1 (* (* (exp it296 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it295) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it294 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!5 (> (+ (+ 0 (* it295 3))
                 (* (exp it296 5) (+ 0 (- 1)))
                 (* (exp it296 3) (+ 0 (- 2)))
                 (* (exp it294 2) (+ 0 (- 4))))
      ...
      (a!6 (> (+ (+ 0 it295)
                 ...
                 (* (exp it294 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp it296 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1)))))
(let ((a!4 (> (+ a!1
                 a!2
                 (* (exp it296 5) (+ 0 (- 1)))
                 (exp it296 3)
