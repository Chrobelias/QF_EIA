...
(assert (let ((a!1 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it786 2)))
      (a!2 (* (* (exp it788 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!4 (> (+ (+ 0 it787)
                 (* (exp it786 2) (+ 0 (- 1)))
                 (* (exp it788 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (+ 0 it787) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp it788 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!8 (> (+ (+ 0 (* it787 3))
                 (* (exp it788 3) (+ 0 (- 2)))
                 (* (exp it786 2) (+ 0 (- 4)))
                 (* (exp it788 5) (+ 0 (- 1))))
