...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))
              it2589))
      (a!4 (>= (+ (+ it2589 (* it2591 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (+ it2589 (* it540 (- 1))) (* it2588 (- 2))) (- 1)))
      (a!6 (>= (+ (+ it2589 (* it706 (- 1)) (* it540 (- 1)))
                  (* it2588 (- 2))
                  (- 1))
               0))
      (a!9 (+ (+ (+ it2589 (* it540 (- 1))) (* it2588 (- 2))) (- 2)))
      (a!10 (>= (+ (+ it2589 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!11 (+ it2589 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!12 (>= (+ (+ it2589 (* it2588 (- 2))) (- 1)) 0))
      (a!13 (>= (+ (+ it2589 (* it540 (- 1))) (- 2)) 0))
      (a!14 (>= (+ (+ it2589 (* it2588 (- 2))) (- 2)) 0))
      (a!16 (>= (+ (+ it2589 (* it540 (- 1))) (- 3)) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1))) (- 2)) 0))
      (a!3 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1)))
                  (* it2588 (- 2))
                  (- 1))
               0))
      (a!7 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!8 (+ (+ (+ a!1 (* it540 (- 1))) (* it2588 (- 2))) (- 1)))
      (a!15 (>= (+ (+ a!1 (* it540 (- 1))) (- 3)) 0))
      (a!17 (+ (+ (+ a!1 (* it540 (- 1))) (* it2588 (- 2))) (- 2))))
  (and a!2
       a!3
       (>= (+ it540 (- 1)) 0)
       a!4
