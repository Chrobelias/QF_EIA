...
(assert (let ((a!1 (> (+ (* (exp it824 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it825))
              (+ 0 0)))
      (a!2 (* (* (exp it826 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it824 2)))
      (a!5 (* (* (exp it826 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (exp 9 (+ it152 (- 1))) (+ 0 it825)) (+ 0 3)))
      (a!8 (> (+ (* (exp it826 3) (+ 0 (- 2)))
                 (* (exp it824 2) (+ 0 (- 4)))
                 (* (exp it826 5) (+ 0 (- 1)))
                 (+ 0 (* it825 3)))
