...
(assert (let ((a!1 (+ (+ (+ it661 (* it540 (- 1))) (* it660 (- 2))) (- 2)))
      (a!2 (>= (+ (+ it661 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!3 (+ (+ (+ it661 (* it540 (- 1))) (* it660 (- 2))) (- 1)))
      (a!4 (>= (+ (+ it661 (* it540 (- 1))) (- 2)) 0))
      (a!5 (>= (+ (+ it661 (* it706 (- 1)) (* it540 (- 1)))
                  (* it660 (- 2))
                  (- 1))
               0))
      (a!6 (>= (+ (+ it661 (* it660 (- 2))) (- 1)) 0))
      (a!7 (>= (+ (+ it661 (* it660 (- 2))) (- 2)) 0))
      (a!8 (>= (+ (+ it661 (* it540 (- 1))) (- 3)) 0)))
  (and (>= (+ it658 (- 4)) 0)
       (>= a!1 0)
       (>= (+ it540 (- 1)) 0)
       a!2
