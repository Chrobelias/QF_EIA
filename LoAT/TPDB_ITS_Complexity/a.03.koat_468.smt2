...
(assert (and (= (+ it1115 (- 4)) 0)
     (= (+ it1117 (- 1)) 0)
     (>= (+ it1118 (- 2)) 0)
     (>= (+ it1118 (- 3)) 0)))
(assert (= (+ it1154 (- 3)) 0))
(assert (= (+ (* it1116 (- 1)) it1155 (- 2)) 0))
(assert (= (+ it1156 (* it1117 (- 1))) 0))
(assert (= (+ (* it1118 (- 1)) it1157 1) 0))
(assert (= (+ (* it1117 (- 1)) it1158) 0))
(assert (= (+ it1159 (* it1117 (- 2))) 0))
(assert (let ((a!1 (+ (* (+ it1121 (- 1)) it1122 (- 1))
              (* (+ it1121 (- 1)) it1123 (- 1))))
      (a!3 (>= (+ (+ it1157 (* it1123 (- 1))) (- 3)) 0))
      (a!4 (+ (+ (+ (* it1156 (- 2)) it1157) (* it1123 (- 1))) (- 2)))
      (a!5 (+ (* (* it1121 it1123) (- 1)) (* (* it1121 it1122) (- 1)) it1157))
      (a!7 (>= (+ (+ (* it1156 (- 2)) it1157) (- 1)) 0))
      (a!8 (>= (+ (+ (* it1159 (- 1)) it1157) (- 1)) 0))
      (a!10 (+ (+ (+ (* it1156 (- 2)) it1157) (* it1123 (- 1))) (- 1)))
      (a!11 (>= (+ (+ (* it1156 (- 2)) it1157) (- 2)) 0))
      (a!13 (>= (+ (+ it1157 (* it1123 (- 1))) (- 2)) 0)))
(let ((a!2 (>= (+ (+ (+ a!1 it1157) (* it1123 (- 1))) (- 2)) 0))
      (a!6 (+ (+ (+ a!1 (* it1156 (- 2))) it1157) (* it1123 (- 1))))
      (a!9 (+ (+ (+ a!1 (* it1156 (- 2))) it1157) (- 2)))
      (a!12 (>= (+ (+ a!1 (* it1156 (- 2)))
                   (* it1122 (- 1))
                   it1157
                   (* it1123 (- 1))
                   (- 1))
                0))
      (a!14 (>= (+ (+ (+ a!1 it1157) (* it1123 (- 1))) (- 3)) 0)))
  (and (= (+ (* it1121 it1123) (* it1121 it1122) 1) 0)
       a!2
       a!3
       (>= (+ it1122 (- 1)) 0)
       (>= (+ a!1 (* it1122 (- 1)) it1157 (* it1123 (- 1)) (- 2)) 0)
       (>= (+ (* it1156 (- 2)) (* it1122 (- 1)) it1157 (* it1123 (- 1)) (- 1))
           0)
       (>= (+ (* it1156 (- 1)) 1) 0)
       (>= (+ it1121 (- 1)) 0)
       (>= (+ it1157 (- 3)) 0)
       (>= a!4 0)
       (<= (+ (* it1121 it1123) (* it1121 it1122) 1) 0)
       (>= (+ a!5 (- 3)) 0)
       (= (+ it1159 (* it1156 (- 2))) 0)
       (>= (+ it1156 (- 1)) 0)
       (>= (+ (* it1122 (- 1)) it1157 (* it1123 (- 1)) (- 2)) 0)
       (= 0 0)
       (>= (+ a!6 (- 2)) 0)
       (>= (+ it1157 (- 2)) 0)
       a!7
