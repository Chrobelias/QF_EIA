...
(assert (and (> (+ it526 (* it524 (- 1)) (* it525 2) 3) 0) (= (+ it521 (- 20)) 0)))
(assert (= (+ it529 (- 18)) 0))
(assert (= (+ it530 (* it522 (- 1)) (- 4)) 0))
(assert (= (+ (* it526 (- 1)) it531 (- 1)) 0))
(assert (= (+ it532 (* it524 (- 1))) 0))
(assert (= (+ it533 (* it525 (- 1))) 0))
(assert (= (+ (* it526 (- 1)) it534 (- 1)) 0))
(assert (= (+ it535 (* it527 (- 1))) 0))
(assert (and (<= (+ (* it532 (- 1)) it534 2) 0) (= (+ it529 (- 18)) 0)))
(assert (= (+ it536 (- 20)) 0))
(assert (= (+ (* it530 (- 1)) it537 (- 2)) 0))
(assert (= (+ it538 (* it531 (- 1))) 0))
(assert (= (+ (* it532 (- 1)) it539) 0))
(assert (= it540 0))
(assert (= (+ (* it534 (- 1)) it541) 0))
(assert (= (+ (* it535 (- 1)) it542) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it540)) (+ 0 2)))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it540)) (+ 0 (- 2)))))
(let ((a!2 (+ a!1
              (* (exp 2 (+ it101 (- 1))) (+ 0 2))
              (+ 0 (* it539 (- 1)))
              (+ 0 it541)
  ...
  (and (>= (+ (* it536 (- 1)) 20) 0)
       ...
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))
       (>= (+ it539 (* it540 (- 2)) (* it541 (- 1)) (- 3)) 0)
       (>= (+ (* it539 (- 1)) (* it540 2) it541 3) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
