...
(assert (let ((a!1 (>= (+ (+ (* it727 (- 1)) it722) (- 2)) 0))
      (a!2 (>= (+ (+ (* it727 (- 1)) it722) (- 3)) 0))
      (a!3 (>= (+ (+ (* it727 (- 1)) (* it721 (- 2)) it722)
                  (* it726 (- 1))
                  (- 1))
               0))
      (a!4 (>= (+ (+ (* it727 (- 1)) (* it721 (- 2)) it722) (- 1)) 0))
      (a!5 (>= (+ (+ (* it727 (- 1)) (* it721 (- 2)) it722) (- 2)) 0))
      (a!6 (>= (+ (+ (* it721 (- 2)) it722) (- 2)) 0))
      (a!7 (>= (+ (+ (* it721 (- 2)) it722) (- 1)) 0))
      (a!8 (>= (+ (+ (* it727 (- 1)) it722) (* it726 (- 1)) (- 2)) 0)))
  (and (>= (+ it722 (- 3)) 0)
       (>= (+ it727 (- 1)) 0)
       (>= (+ it719 (- 4)) 0)
       a!1
