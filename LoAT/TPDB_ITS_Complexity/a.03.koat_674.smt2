...
(assert (let ((a!1 (+ (+ (* it706 (- 1)) (* it2625 (- 2)))
              (* it706 (+ it1243 (- 1)) (- 1))))
      (a!3 (>= (+ (* it706 (+ it1243 (- 1)) (- 1))
                  (* it540 (+ it1243 (- 1)) (- 1))
                  it2626
                  (- 3))
               0))
      (a!4 (>= (+ (* it2625 (- 2))
                  ...
                  (- 2))
               0))
      (a!5 (>= (+ (+ (* it2625 (- 2)) it2626) (- 2)) 0))
      (a!6 (>= (+ (+ (* it706 (- 1)) it2626) (- 2)) 0))
      (a!7 (>= (+ (+ (* it706 (- 1)) (* it2625 (- 2)))
                  (* it540 (- 1))
                  it2626
                  (- 1))
               0))
      (a!8 (>= (+ (+ (* it2625 (- 2)) it2626) (- 1)) 0))
      (a!9 (+ (+ (+ (* it706 (- 1)) (* it2625 (- 2))) it2626) (- 2)))
      (a!10 (+ (* it706 (- 1)) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!14 (+ (+ (+ (* it706 (- 1)) (* it2625 (- 2))) it2626) (- 1)))
      (a!16 (>= (+ (+ (* it706 (- 1)) it2626) (- 3)) 0)))
(let ((a!2 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1)) it2626) (- 1)))
      (a!11 (+ (+ a!10 (* it540 (+ it1243 (- 1)) (- 1)) it2626) (- 3)))
      (a!12 (>= (+ a!1
                   (* it540 (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   it2626
                   (- 1))
                0))
      (a!13 (+ (+ a!10 (* it540 (+ it1243 (- 1)) (- 1)) it2626) (- 2)))
      (a!15 (>= (+ a!10
                   (* it540 (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   it2626
                   (- 2))
                0))
      (a!17 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1)) it2626) (- 2))))
  (and (>= (+ (* it2625 (- 1)) 1) 0)
       (>= (+ it1243 (- 1)) 0)
       (>= a!2 0)
       a!3
