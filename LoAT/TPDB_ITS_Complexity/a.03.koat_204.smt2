...
(assert (and (>= (+ it722 (- 2)) 0)
     ...
     (= (+ it719 (- 4)) 0)))
(assert (= (+ it758 (- 3)) 0))
(assert (= (+ it759 (* it720 (- 1)) (- 2)) 0))
(assert (= (+ (* it721 (- 1)) it760) 0))
(assert (= (+ (* it722 (- 1)) it761 1) 0))
(assert (= (+ (* it721 (- 1)) it762) 0))
(assert (= (+ (* it721 (- 2)) it763) 0))
(assert (let ((a!1 (+ (+ (* it572 (- 1)) (* it19 (- 1))) (* it760 (- 2)) it761))
      (a!2 (>= (+ (+ (* it572 (- 1)) (* it19 (- 1))) it761 (- 2)) 0))
      (a!3 (>= (+ (+ (* it572 (- 1)) (* it760 (- 2)) it761) (- 1)) 0))
      (a!4 (>= (+ (+ (* it572 (- 1)) it761) (- 2)) 0))
      (a!5 (>= (+ (+ (* it572 (- 1)) (* it760 (- 2)) it761) 1) 0))
      (a!6 (>= (+ (+ (* it572 (- 1)) it761) (- 3)) 0))
      (a!7 (>= (+ (+ (* it763 (- 1)) it761) (- 1)) 0)))
  (and (= (+ it763 (* it760 (- 2))) 0)
       (>= (+ it761 (- 2)) 0)
       (>= a!1 0)
       (>= (+ it758 (- 3)) 0)
