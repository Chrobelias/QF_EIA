...
(assert (let ((a!1 (+ (+ (+ (* it871 (- 2)) (* it572 (- 1))) it872) 1))
      (a!2 (>= (+ (+ (* it572 (- 1)) it872) (- 3)) 0))
      (a!3 (+ (+ (* it871 (- 2)) (* it572 (- 1))) (* it19 (- 1)) it872))
      (a!4 (>= (+ (+ (* it874 (- 1)) it872) (- 1)) 0))
      (a!5 (+ (+ (+ (* it871 (- 2)) (* it572 (- 1))) it872) (- 1)))
      (a!6 (>= (+ (+ (* it871 (- 2)) (* it572 (- 1))) it872) 0))
      (a!7 (>= (+ (+ (* it572 (- 1)) it872) (- 2)) 0)))
  (and (>= a!1 0)
       a!2
       (>= a!3 0)
       (>= (+ (* it869 (- 1)) 3) 0)
