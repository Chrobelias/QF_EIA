...
(assert (and (>= (+ it476 (* it477 (- 1)) (- 2)) 0) (= (+ it474 (- 5)) 0)))
(assert (= (+ it485 (- 7)) 0))
(assert (= (+ it486 (* it475 (- 1)) (- 2)) 0))
(assert (= (+ (* it476 (- 1)) it487) 0))
(assert (= (+ (* it477 (- 1)) it488) 0))
(assert (= it489 0))
(assert (= (+ (* it479 (- 1)) it490) 0))
(assert (and (= (+ it485 (- 7)) 0) (>= (+ (* it489 2) (* it487 (- 1)) it488 2) 0)))
(assert (= (+ it498 (- 5)) 0))
(assert (= (+ (* it486 (- 1)) it499 (- 2)) 0))
(assert (= (+ (* it487 (- 1)) it500) 0))
(assert (= (+ it501 (* it488 (- 1)) (- 1)) 0))
(assert (= (+ (* it489 (- 1)) it502) 0))
(assert (= (+ (* it490 (- 1)) it503) 0))
(assert (and (= (+ it498 (- 5)) 0) (>= (+ it501 (* it500 (- 1)) 1) 0)))
(assert (= (+ it510 (- 15)) 0))
(assert (= (+ it511 (* it499 (- 1)) (- 2)) 0))
(assert (= (+ it512 (* it500 (- 1))) 0))
(assert (= (+ (* it501 (- 1)) it513) 0))
