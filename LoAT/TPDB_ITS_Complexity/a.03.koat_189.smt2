...
(assert (and (= (+ it732 (- 1)) 0)
     (= (+ it730 (- 4)) 0)
     (>= (+ it733 (- 3)) 0)
     (>= (+ it733 (- 2)) 0)))
(assert (= (+ it740 (- 3)) 0))
(assert (= (+ (* it731 (- 1)) it741 (- 2)) 0))
(assert (= (+ (* it732 (- 1)) it742) 0))
(assert (= (+ it743 (* it733 (- 1)) 1) 0))
(assert (= (+ it744 (* it732 (- 1))) 0))
(assert (= (+ (* it732 (- 2)) it745) 0))
(assert (let ((a!1 (>= (+ (+ it743 (* it572 (- 1))) (- 2)) 0))
      (a!2 (>= (+ (+ it743 (* it572 (- 1))) (* it742 (- 2))) 0))
      (a!3 (+ (+ (+ it743 (* it572 (- 1))) (* it742 (- 2))) 1))
      (a!4 (>= (+ (+ it743 (* it572 (- 1))) (- 3)) 0))
      (a!5 (+ (+ (+ it743 (* it572 (- 1))) (* it19 (- 1))) (* it742 (- 2))))
      (a!6 (+ (+ (+ it743 (* it572 (- 1))) (* it742 (- 2))) (- 1)))
      (a!7 (>= (+ (+ it743 (* it745 (- 1))) (- 1)) 0))
      (a!8 (+ (+ (+ it743 (* it572 (- 1))) (* it19 (- 1))) (- 2))))
  (and (>= (+ (* it742 (- 1)) 1) 0)
       (= 0 0)
       (>= (+ it19 (- 1)) 0)
       (= (+ it745 (* it742 (- 2))) 0)
