...
(assert (let ((a!1 (>= (+ (+ it912 (* it911 (- 2))) (- 2)) 0))
      ...
      (a!3 (>= (+ (+ it912 (* it795 (- 1))) (* it911 (- 2)) (- 1)) 0))
      (a!4 (>= (+ (+ it912 (* it795 (- 1))) (- 2)) 0)))
  (and a!1
       (>= (+ it912 (- 3)) 0)
       a!2
       (>= (+ (* it911 (- 1)) 1) 0)
       ...
       (>= (+ it909 (- 4)) 0)
       a!4)))
(assert (= (+ (* it909 (- 1)) it929) 0))
(assert (= (+ (* it795 (- 3)) (* it910 (- 1)) it930) 0))
(assert (= (+ it931 (* it911 (- 1))) 0))
(assert (= (+ (* it912 (- 1)) it795 it932) 0))
(assert (= (+ (* it911 (- 1)) it933) 0))
(assert (= (+ it934 (* it911 (- 2)) (- 1)) 0))
(assert (and (= (+ it931 (- 1)) 0)
     (= (+ it929 (- 4)) 0)
     (>= (+ it932 (- 2)) 0)
     (>= (+ it932 (- 3)) 0)))
(assert (= (+ it942 (- 3)) 0))
(assert (= (+ it943 (* it930 (- 1)) (- 2)) 0))
(assert (= (+ (* it931 (- 1)) it944) 0))
(assert (= (+ (* it932 (- 1)) it945 1) 0))
(assert (= (+ it946 (* it931 (- 1))) 0))
(assert (= (+ (* it931 (- 2)) it947) 0))
(assert (let ((a!1 (>= (+ (+ (* it944 (- 2)) it945) (- 1)) 0))
      (a!2 (>= (+ (* it935 (+ it784 (- 1)) (- 1))
                  it945
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 3))
               0))
      (a!3 (>= (+ (+ (* it944 (- 2)) (* it935 (- 1)) it945) (- 2)) 0))
      (a!4 (+ (* it935 (+ it784 (- 1)) (- 1)) (* it944 (- 2))))
      (a!6 (>= (+ (+ (* it935 (- 1)) it945) (- 2)) 0))
      (a!7 (>= (+ (+ (* it947 (- 1)) it945) (- 1)) 0))
      (a!8 (+ (* it785 (- 1)) (* it935 (+ it784 (- 1)) (- 1))))
      (a!10 (+ (* it935 (+ it784 (- 1)) (- 1))
               (* it935 (- 1))
               it945
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!12 (>= (+ (+ (* it944 (- 2)) it945) (- 2)) 0))
      (a!13 (+ (* (* it935 it784) (- 1)) (* (* it785 it784) (- 1)) it945))
      (a!14 (>= (+ (+ (* it944 (- 2)) (* it935 (- 1)) it945) (- 1)) 0))
      (a!16 (>= (+ (+ (* it935 (- 1)) it945) (- 3)) 0)))
(let ((a!5 (>= (+ a!4 it945 (* it785 (+ it784 (- 1)) (- 1)) (- 2)) 0))
      (a!9 (>= (+ a!8
                  (* it935 (- 1))
                  it945
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!11 (+ a!4 (* it935 (- 1)) it945 (* it785 (+ it784 (- 1)) (- 1))))
      (a!15 (>= (+ a!8
                   (* it944 (- 2))
                   (* it935 (- 1))
                   it945
  ...
  (and a!1
       ...
       (>= (+ it785 (- 1)) 0)
       (>= (+ (* it947 (- 1)) it945) 0)
       (<= (+ (* it935 it784) (* it785 it784) 1) 0)
       (= (+ it947 (* it944 (- 2))) 0)
       (>= (+ it944 (- 1)) 0)
       (>= (+ (* it785 (- 1)) (* it935 (- 1)) it945 (- 2)) 0)
       a!9
       (>= (+ a!10 (- 2)) 0)
       (>= (+ a!11 (- 1)) 0)
       (>= (+ it784 (- 1)) 0)
       a!12
       (>= (+ (* it785 (- 1)) (* it944 (- 2)) (* it935 (- 1)) it945 (- 1)) 0)
       (>= (+ a!11 (- 2)) 0)
       (>= (+ a!13 (- 2)) 0)
       (>= (+ a!13 (- 3)) 0)
       (>= (+ (* it944 (- 1)) 1) 0)
