...
(assert (let ((a!1 (* (exp (exp 16 (+ it876 (- 1))) (+ 0 2)) (exp it834 2)))
      (a!2 (* (* (exp it836 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (+ 0 it835) (exp 81 (+ it876 (- 1)))) (+ 0 9)))
      (a!5 (* (* (exp it836 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 9))))
      (a!7 (> (+ (+ 0 (* it835 9))
                 (* (exp it836 3) (+ 0 (- 8)))
                 (* (exp it834 2) (+ 0 (- 16)))
                 (* (exp it836 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!8 (* (* (+ 0 it835) (exp 81 (+ it876 (- 1)))) (+ 0 3)))
      (a!9 (* (* (exp it836 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 3))))
      (a!11 (* (* (+ 0 it835) (exp 81 (+ it876 (- 1)))) (+ 0 27)))
      (a!12 (* (* (exp it836 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 27))))
      (a!14 (> (+ (+ 0 (* it835 3))
                  (* (exp it836 3) (+ 0 (- 2)))
                  (* (exp it834 2) (+ 0 (- 4)))
                  (* (exp it836 5) (+ 0 (- 1))))
