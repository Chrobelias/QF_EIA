...
(assert (let ((a!1 (> (+ (+ 0 (* it692 3))
      ...
      (a!2 (> (+ (+ 0 it692)
                 ...
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (* (+ 0 it692) (exp 9 (+ it117 (- 1)))) (+ 0 3)))
      (a!4 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it691 2)))
      (a!5 (* (* (exp it693 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!7 (* (* (exp it693 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1)))))
(let ((a!6 (> (+ a!3
                 (exp it693 3)
                 (* a!4 (+ 0 (- 4)))
                 (* (exp it693 5) (+ 0 (- 1)))
