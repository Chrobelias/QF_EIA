...
(assert (let ((a!1 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it472 2)))
      (a!2 (* (* (+ 0 it473) (exp 9 (+ it117 (- 1)))) (+ 0 3)))
      (a!3 (* (* (exp 9 (+ it117 (- 1))) (exp it474 3)) (+ 0 (- 3))))
      (a!5 (> (+ (+ 0 it473)
                 (* (exp it474 5) (+ 0 (- 1)))
                 (* (exp it472 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (> (+ (+ 0 (* it473 3))
                 ...
                 (* (exp it472 2) (+ 0 (- 4))))
              (+ 0 0)))
      (a!7 (* (* (exp 9 (+ it117 (- 1))) (exp it474 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (* a!1 (+ 0 (- 4)))
                 (* (exp it474 5) (+ 0 (- 1)))
                 (exp it474 3)
                 a!2
