...
(assert (let ((a!1 (* (exp it744 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp it746 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (* (+ 0 it745) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!5 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                 (+ 0 it745)
                 (* (exp it744 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                 ...
                 (* (exp it746 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!7 (* (* (exp it746 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1)))))
(let ((a!4 (> (+ (* a!1 (+ 0 (- 4)))
                 (* (exp it746 5) (+ 0 (- 1)))
                 a!2
                 (exp it746 3)
