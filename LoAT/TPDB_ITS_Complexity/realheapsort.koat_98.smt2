...
(declare-fun it8555 () Int)
(declare-fun it8556 () Int)
(declare-fun it8557 () Int)
(declare-fun it8558 () Int)
(declare-fun it8559 () Int)
(declare-fun it8560 () Int)
...
(assert (= (+ it8546 (- 18)) 0))
(assert (= (+ it8555 (- 12)) 0))
(assert (= (+ (* it8547 (- 1)) it8556 (- 2)) 0))
(assert (= (+ it8557 (* it8548 (- 1))) 0))
(assert (= (+ it8558 (* it8549 (- 1))) 0))
(assert (= (+ (* it8551 (- 1)) it8559) 0))
(assert (= (+ it8560 (* it8551 (- 1))) 0))
(assert (and (>= (+ (* it8557 (- 1)) (* it8558 (- 1)) (- 3)) 0)
     (>= (+ it8557 it8558 3) 0)
     (>= (+ it8555 (- 12)) 0)
     (>= (+ (* it8557 (- 1)) it8558 (* it8559 2) 3) 0)
     (>= (+ it8557 (* it8558 (- 1)) (* it8559 (- 2)) (- 3)) 0)
     (>= (+ (* it8555 (- 1)) 12) 0)
     (>= (+ it6259 (- 1)) 0)))
(check-sat)
