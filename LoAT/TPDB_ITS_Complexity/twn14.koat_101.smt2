...
(assert (let ((a!1 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it882 2)))
      (a!2 (* (* (exp it884 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (exp 9 (+ it82 (- 1))) (+ 0 it883)) (+ 0 3)))
      (a!5 (* (* (exp it884 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 3))))
      (a!7 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 (* (exp it884 3) (+ 0 (- 2)))
                 (* (exp it882 2) (+ 0 (- 4)))
                 (+ 0 (* it883 3)))
