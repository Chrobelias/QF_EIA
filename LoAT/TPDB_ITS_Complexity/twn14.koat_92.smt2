...
(assert (let ((a!1 (* (* (exp 9 (+ it107 (- 1))) (exp it844 3)) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it843) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it842 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!5 (> (+ (* (exp it842 2) (+ 0 (- 1)))
                 (+ 0 it843)
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (> (+ (* (exp it844 3) (+ 0 (- 2)))
                 ...
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp 9 (+ it107 (- 1))) (exp it844 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (exp it844 3)
                 a!1
                 a!2
                 (* (exp it844 5) (+ 0 (- 1)))
