...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      (a!3 (+ (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1)) it2709))
      (a!4 (>= (+ (+ (* it2708 (- 2)) (* it540 (- 1)) it2709) (- 1)) 0))
      (a!5 (>= (+ (+ (* it540 (- 1)) it2709) (- 2)) 0))
      (a!7 (>= (+ (+ (* it2708 (- 2)) it2709) (- 1)) 0))
      (a!8 (>= (+ (+ (* it2708 (- 2)) (* it540 (- 1)) it2709) (- 2)) 0))
      (a!9 (>= (+ (+ (* it540 (- 1)) it2709) (- 3)) 0))
      (a!10 (>= (+ (+ (* it2711 (- 1)) it2709) (- 1)) 0))
      (a!13 (>= (+ (+ (* it2708 (- 2)) it2709) (- 2)) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1)) it2709) (- 2)) 0))
      (a!6 (+ (+ a!1 (* it2708 (- 2))) (* it540 (- 1)) it2709))
      (a!11 (>= (+ (+ a!1 (* it2708 (- 2))) it2709 (- 2)) 0))
      (a!12 (>= (+ (+ a!1 (* it706 (- 1)))
                   (* it2708 (- 2))
                   (* it540 (- 1))
                   it2709
                   (- 1))
                0))
      (a!14 (>= (+ (+ a!1 (* it706 (- 1))) (* it540 (- 1)) it2709 (- 2)) 0))
      (a!15 (>= (+ (+ a!1 (* it540 (- 1)) it2709) (- 3)) 0)))
  (and (>= (+ (* it2711 (- 1)) it2709) 0)
       ...
       a!4
       a!5
       (>= (+ (* it706 (- 1)) (* it2708 (- 2)) (* it540 (- 1)) it2709 (- 1)) 0)
       (>= (+ a!6 (- 2)) 0)
       a!7
       a!8
       a!9
