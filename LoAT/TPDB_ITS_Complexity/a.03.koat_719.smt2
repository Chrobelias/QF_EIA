...
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) (* it2708 (- 2)) it2709) (- 1)) 0))
      (a!2 (+ (+ (* it2712 (- 1)) (* it88 (- 1))) (* it2708 (- 2)) it2709))
      (a!3 (>= (+ (+ (* it2712 (- 1)) (* it88 (- 1))) it2709 (- 2)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it2709) (- 3)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it2709) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2711 (- 1)) it2709) (- 1)) 0))
      (a!7 (>= (+ (+ (* it88 (- 1)) (* it2708 (- 2)) it2709) 1) 0)))
  (and a!1
       (>= (+ it2712 (- 1)) 0)
       (>= (+ it2709 (- 3)) 0)
       (>= (+ it2709 (- 2)) 0)
