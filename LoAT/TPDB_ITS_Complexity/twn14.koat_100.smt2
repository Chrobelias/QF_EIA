...
(assert (let ((a!1 (* (exp (exp 16 (+ it876 (- 1))) (+ 0 2)) (exp it882 2)))
      (a!2 (* (* (exp it884 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (exp 81 (+ it876 (- 1))) (+ 0 it883)) (+ 0 9)))
      (a!5 (* (* (exp it884 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 9))))
      (a!7 (* (* (exp 81 (+ it876 (- 1))) (+ 0 it883)) (+ 0 3)))
      (a!8 (* (* (exp it884 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 3))))
      (a!10 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                  (* (exp it884 3) (+ 0 (- 8)))
                  (* (exp it882 2) (+ 0 (- 16)))
                  (+ 0 (* it883 9)))
               (+ 0 0)))
      (a!11 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                  (* (exp it884 3) (+ 0 (- 2)))
                  (* (exp it882 2) (+ 0 (- 4)))
                  (+ 0 (* it883 3)))
               (+ 0 0)))
      (a!12 (* (* (exp 81 (+ it876 (- 1))) (+ 0 it883)) (+ 0 27)))
      (a!13 (* (* (exp it884 3) (exp 81 (+ it876 (- 1)))) (+ 0 (- 27))))
      (a!15 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                  (* (exp it882 2) (+ 0 (- 1)))
                  (+ 0 it883))
               (+ 0 0))))
(let ((a!3 (+ (* (exp 81 (+ it876 (- 1))) (+ 0 it883))
              (* (exp it884 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (exp it884 3)
              a!2))
