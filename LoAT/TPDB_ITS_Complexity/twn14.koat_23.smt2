...
(assert (let ((a!1 (* (* (exp 9 (+ it152 (- 1))) (exp it373 3)) (+ 0 (- 3))))
      (a!2 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it371 2)))
      (a!3 (* (* (+ 0 it372) (exp 9 (+ it152 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it152 (- 1))) (exp it373 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it373 3) (+ 0 (- 2)))
                 (+ 0 (* it372 3))
                 (* (exp it371 2) (+ 0 (- 4)))
                 (* (exp it373 5) (+ 0 (- 1))))
