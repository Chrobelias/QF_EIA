...
(assert (let ((a!1 (>= (+ (+ (* it706 (- 1)) it2534) (- 2)) 0))
      (a!2 (>= (+ (+ (* it2533 (- 2)) it2534) (- 2)) 0))
      (a!3 (>= (+ (+ (* it2533 (- 2)) it2534) (- 1)) 0))
      (a!4 (>= (+ (+ (* it706 (- 1)) it2534) (- 3)) 0))
      (a!5 (+ (+ (+ (* it2533 (- 2)) (* it706 (- 1))) it2534) (- 1)))
      (a!6 (>= (+ (+ (* it2533 (- 2)) (* it706 (- 1)))
                  (* it2537 (- 1))
                  it2534
                  (- 1))
               0))
      (a!7 (+ (+ (+ (* it2533 (- 2)) (* it706 (- 1))) it2534) (- 2))))
  (and (>= (+ it2534 (- 3)) 0)
       (>= (+ it2534 (- 2)) 0)
       (= 0 0)
       (<= (+ it706 it2537) 0)
