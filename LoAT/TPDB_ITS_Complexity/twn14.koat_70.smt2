...
(assert (let ((a!1 (* (* (+ 0 it735) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!2 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it734 2)))
      (a!3 (* (* (exp 9 (+ it82 (- 1))) (exp it736 3)) (+ 0 (- 3))))
      (a!5 (> (+ (* (exp it734 2) (+ 0 (- 4)))
                 (* (exp it736 5) (+ 0 (- 1)))
                 (+ 0 (* it735 3))
                 (* (exp it736 3) (+ 0 (- 2))))
      ...
      (a!6 (> (+ (* (exp it734 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it735))
              (+ 0 0)))
      (a!7 (* (* (exp 9 (+ it82 (- 1))) (exp it736 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (* (exp it736 5) (+ 0 (- 1)))
                 a!1
                 (* a!2 (+ 0 (- 4)))
                 (exp it736 3)
                 a!3)
