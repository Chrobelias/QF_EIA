...
(assert (= (+ it1144 (- 26)) 0))
(assert (= (+ it1214 (- 20)) 0))
(assert (= (+ it1215 (* it1145 (- 1)) (- 2)) 0))
(assert (= (+ (* it1146 (- 1)) it1216) 0))
(assert (= (+ (* it1147 (- 1)) it1217) 0))
(assert (= (+ it1218 (* it1150 (- 1))) 0))
(assert (= (+ (* it1149 (- 1)) it1219) 0))
(assert (= (+ (* it1150 (- 1)) it1220) 0))
(assert (and (> (+ (* it1218 2) it1219 (* it1217 (- 1)) 3) 0) (= (+ it1214 (- 20)) 0)))
(assert (= (+ it1227 (- 18)) 0))
(assert (= (+ (* it1215 (- 1)) it1228 (- 4)) 0))
(assert (= (+ (* it1219 (- 1)) it1229 (- 1)) 0))
(assert (= (+ (* it1217 (- 1)) it1230) 0))
(assert (= (+ (* it1218 (- 1)) it1231) 0))
(assert (= (+ (* it1219 (- 1)) it1232 (- 1)) 0))
(assert (= (+ (* it1220 (- 1)) it1233) 0))
(assert (let ((a!1 (>= (+ (+ (* it1232 (- 1)) it1230) (- 3)) 0))
      (a!2 (> (+ (+ (* it1232 (- 1)) it1230) (- 3)) 0))
      (a!3 (>= (+ (+ (* it1232 (- 1)) it1230) (- 2)) 0)))
  (and (= 0 0)
       a!1
       (> (+ it1232 it1230 3) 0)
       (= (- 1) 0)
