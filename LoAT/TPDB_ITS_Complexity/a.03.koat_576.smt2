...
(assert (let ((a!1 (>= (+ (+ (* it2537 (- 1)) it2563) (- 2)) 0))
      (a!2 (>= (+ (+ (* it2537 (- 1)) it2563) (- 3)) 0))
      (a!3 (>= (+ (+ (* it2562 (- 2)) (* it2537 (- 1)) it2563) (- 2)) 0))
      (a!4 (>= (+ (+ (* it2562 (- 2)) it2563) (- 2)) 0))
      (a!5 (>= (+ (+ (* it2562 (- 2)) (* it2537 (- 1)) it2563) (- 1)) 0))
      (a!6 (>= (+ (+ (* it2562 (- 2)) it2563) (- 1)) 0)))
  (and a!1
       (>= (+ it2537 (- 1)) 0)
       (>= (+ it2560 (- 4)) 0)
       (<= (+ it706 it2537) 0)
