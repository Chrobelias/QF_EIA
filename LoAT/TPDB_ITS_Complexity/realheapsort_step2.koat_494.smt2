...
(assert (and (>= (+ (* it798 2) (* it796 (- 1)) it797 2) 0) (= (+ it794 (- 7)) 0)))
(assert (= (+ it812 (- 5)) 0))
(assert (= (+ (* it795 (- 1)) it813 (- 2)) 0))
(assert (= (+ it814 (* it796 (- 1))) 0))
(assert (= (+ it815 (* it797 (- 1)) (- 1)) 0))
(assert (= (+ (* it798 (- 1)) it816) 0))
(assert (= (+ it817 (* it799 (- 1))) 0))
(check-sat)
