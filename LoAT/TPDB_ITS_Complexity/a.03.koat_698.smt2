...
(assert (let ((a!1 (+ (* (exp 2 it129) (+ 0 it2667) (+ 0 (- 1)))
              ...
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ (* it2695 (- 2)) (* it540 (- 1)) it2696) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2695 (- 2)) it2696) (- 2)) 0))
      (a!3 (+ (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1)) it2696))
      (a!4 (>= (+ (+ (* it2695 (- 2)) it2696) (- 1)) 0))
      (a!5 (+ (* (+ it716 (- 1)) it540 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      (a!11 (>= (+ (+ (* it540 (- 1)) it2696) (- 3)) 0))
      (a!12 (>= (+ (+ (* it2695 (- 2)) (* it540 (- 1)) it2696) (- 2)) 0))
      (a!14 (>= (+ (+ (* it2698 (- 1)) it2696) (- 1)) 0))
      (a!15 (>= (+ (+ (* it540 (- 1)) it2696) (- 2)) 0)))
(let ((a!6 (>= (+ (+ a!5 (* it2695 (- 2))) it2696 (- 2)) 0))
      (a!7 (+ (+ a!5 (* it2695 (- 2))) (* it540 (- 1)) it2696))
      (a!8 (>= (+ (+ a!5 (* it706 (- 1))) (* it540 (- 1)) it2696 (- 2)) 0))
      (a!9 (>= (+ (+ a!5 (* it540 (- 1)) it2696) (- 3)) 0))
      (a!10 (>= (+ (+ a!5 (* it540 (- 1)) it2696) (- 2)) 0))
      (a!13 (>= (+ (+ a!5 (* it706 (- 1)))
                   (* it2695 (- 2))
                   (* it540 (- 1))
                   it2696
                   (- 1))
                0)))
  (and (>= (+ (* it706 (- 1)) (* it2695 (- 2)) (* it540 (- 1)) it2696 (- 1)) 0)
       (>= (+ it2693 (- 3)) 0)
       (>= (+ it540 (- 1)) 0)
       a!1
       (>= (+ (* it2693 (- 1)) 3) 0)
