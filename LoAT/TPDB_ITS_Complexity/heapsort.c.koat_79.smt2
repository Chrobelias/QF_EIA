...
(assert (and (>= (+ it429 (- 1)) 0)
     (= (+ it423 (- 26)) 0)
     (<= (+ (* it432 (- 1)) it429) 0)))
(assert (= (+ it435 (- 27)) 0))
(assert (= (+ it436 (* it424 (- 1)) (- 1)) 0))
(assert (= (+ (* it425 (- 1)) it437) 0))
(assert (= (+ it438 (* it426 (- 1))) 0))
(assert (= (+ it439 (* it427 (- 1))) 0))
(assert (= (+ it440 (* it428 (- 1))) 0))
(assert (= (+ it441 (* it429 (- 1))) 0))
(assert (= (+ it442 (* it430 (- 1))) 0))
(assert (= (+ it443 (* it431 (- 1))) 0))
(assert (= (+ it444 (* it432 (- 1))) 0))
(assert (and (= (+ it435 (- 27)) 0)
     (>= (+ it443 (- 1)) 0)
     (<= (+ (* it444 (- 1)) it443) 0)))
(assert (= (+ it447 (- 13)) 0))
(assert (= (+ it448 (* it436 (- 1)) (- 1)) 0))
(assert (= (+ it449 (* it437 (- 1))) 0))
(assert (= (+ it450 (* it438 (- 1))) 0))
(assert (= (+ it451 (* it439 (- 1))) 0))
(assert (= (+ it452 (* it440 (- 1))) 0))
(assert (= (+ (* it443 (- 1)) it453) 0))
(assert (= (+ it454 (* it442 (- 1))) 0))
(assert (= (+ it455 (* it443 (- 1))) 0))
(assert (= (+ (* it444 (- 1)) it456) 0))
(assert (let ((a!1 (>= (+ (+ it456 (* it453 (- 2))) (- 1)) 0)))
  (and (> it456 0)
       (= 0 0)
       (>= (+ it453 (- 1)) 0)
       (>= (* it407 (- 1)) 0)
