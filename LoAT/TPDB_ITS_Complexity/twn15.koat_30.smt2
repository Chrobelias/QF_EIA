...
(assert (let ((a!1 (* (exp it472 2) (exp (exp 4 (+ it82 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp 9 (+ it82 (- 1))) (exp it474 3)) (+ 0 (- 1))))
      (a!4 (* (* (exp 9 (+ it82 (- 1))) (exp it474 3)) (+ 0 (- 3))))
      (a!5 (* (* (+ 0 it473) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!7 (> (+ (+ 0 it473)
                 (* (exp it474 5) (+ 0 (- 1)))
                 (* (exp it472 2) (+ 0 (- 1))))
              (+ 0 0)))
