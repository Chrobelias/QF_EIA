...
(assert (and (= (+ (* it2545 (- 1)) it2543) 0) (= (+ it2540 (- 3)) 0)))
(assert (= (+ it2560 (- 4)) 0))
(assert (= (+ it2561 (* it2541 (- 1)) (- 1)) 0))
(assert (= (+ (* it2542 (- 1)) it2562) 0))
(assert (= (+ (* it2543 (- 1)) it2563) 0))
(assert (= (+ it2564 (* it2544 (- 1))) 0))
(assert (= (+ (* it2545 (- 1)) it2565) 0))
(assert (let ((a!1 (>= (+ (+ (* it2562 (- 2)) it2563) (- 2)) 0))
      (a!2 (+ (* (+ it716 (- 1)) it2537 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      (a!6 (>= (+ (+ (* it2562 (- 2)) (* it2537 (- 1)) it2563) (- 2)) 0))
      (a!8 (>= (+ (+ (* it2562 (- 2)) it2563) (- 1)) 0))
      (a!9 (>= (+ (+ (* it2537 (- 1)) it2563) (- 3)) 0))
      (a!11 (>= (+ (+ (* it2537 (- 1)) it2563) (- 2)) 0))
      (a!12 (>= (+ (+ (* it2562 (- 2)) (* it2537 (- 1)) it2563) (- 1)) 0)))
(let ((a!3 (>= (+ (+ a!2 (* it706 (- 1)))
                  (* it2562 (- 2))
                  (* it2537 (- 1))
                  it2563
                  (- 1))
               0))
      (a!4 (>= (+ (+ a!2 (* it2562 (- 2))) it2563 (- 2)) 0))
      (a!5 (>= (+ (+ a!2 (* it2537 (- 1)) it2563) (- 3)) 0))
      (a!7 (>= (+ (+ a!2 (* it2537 (- 1)) it2563) (- 2)) 0))
      (a!10 (+ (+ a!2 (* it2562 (- 2))) (* it2537 (- 1)) it2563))
      (a!13 (>= (+ (+ a!2 (* it706 (- 1))) (* it2537 (- 1)) it2563 (- 2)) 0)))
  (and a!1
       (>= (+ it2537 (- 1)) 0)
       a!3
       a!4
       ...
       a!8
       a!9
       (>= (+ (* it706 (- 1)) (* it2562 (- 2)) (* it2537 (- 1)) it2563 (- 1)) 0)
       (>= (+ it716 (- 1)) 0)
       (>= (+ a!10 (- 1)) 0)
       (>= (+ (* it706 (- 1)) (* it2537 (- 1)) it2563 (- 2)) 0)
       a!11
       (>= (+ it2560 (- 4)) 0)
       (>= (+ a!2 it2563 (- 3)) 0)
       (>= (+ a!10 (- 2)) 0)
