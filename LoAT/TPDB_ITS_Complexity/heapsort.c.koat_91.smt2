...
(assert (and (> it472 0) (>= (+ it469 (- 1)) 0) (= (+ it463 (- 13)) 0)))
(assert (= (+ it489 (- 14)) 0))
(assert (= (+ it490 (* it464 (- 1)) (- 1)) 0))
(assert (= (+ (* it465 (- 1)) it491) 0))
(assert (= (+ (* it466 (- 1)) it492) 0))
(assert (= (+ it493 (* it467 (- 1))) 0))
(assert (= (+ (* it468 (- 1)) it494) 0))
(assert (= (+ (* it469 (- 1)) it495) 0))
(assert (= (+ (* it470 (- 1)) it496) 0))
(assert (= (+ (* it471 (- 1)) it497) 0))
(assert (= (+ (* it472 (- 1)) it498) 0))
(assert (and (= (+ it489 (- 14)) 0) (<= (+ (* it498 (- 1)) (* it495 2)) 0)))
(check-sat)
