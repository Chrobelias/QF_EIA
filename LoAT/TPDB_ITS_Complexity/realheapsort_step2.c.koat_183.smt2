...
(assert (and (> (+ (* it796 (- 1)) (* it797 2) it798 3) 0) (= (+ it793 (- 20)) 0)))
(assert (= (+ it808 (- 18)) 0))
(assert (= (+ it809 (* it794 (- 1)) (- 4)) 0))
(assert (= (+ it810 (* it798 (- 1)) (- 1)) 0))
(assert (= (+ it811 (* it796 (- 1))) 0))
(assert (= (+ it812 (* it797 (- 1))) 0))
(assert (= (+ it813 (* it798 (- 1)) (- 1)) 0))
(assert (= (+ it814 (* it799 (- 1))) 0))
(assert (and (<= (+ (* it811 (- 1)) it813 2) 0) (= (+ it808 (- 18)) 0)))
(assert (= (+ it819 (- 20)) 0))
(assert (= (+ (* it809 (- 1)) it820 (- 2)) 0))
(assert (= (+ it821 (* it810 (- 1))) 0))
(assert (= (+ (* it811 (- 1)) it822) 0))
(assert (= it823 0))
(assert (= (+ it824 (* it813 (- 1))) 0))
(assert (= (+ (* it814 (- 1)) it825) 0))
(assert (and (> (+ it824 (* it822 (- 1)) (* it823 2) 3) 0) (= (+ it819 (- 20)) 0)))
(assert (= (+ it833 (- 18)) 0))
(assert (= (+ it834 (* it820 (- 1)) (- 4)) 0))
(assert (= (+ (* it824 (- 1)) it835 (- 1)) 0))
(assert (= (+ (* it822 (- 1)) it836) 0))
(assert (= (+ it837 (* it823 (- 1))) 0))
(assert (= (+ (* it824 (- 1)) it838 (- 1)) 0))
(assert (= (+ (* it825 (- 1)) it839) 0))
(assert (and (> (+ it838 (* it836 (- 1)) 2) 0) (= (+ it833 (- 18)) 0)))
(assert (= (+ it844 (- 30)) 0))
(assert (= (+ (* it834 (- 1)) it845 (- 2)) 0))
(assert (= (+ it846 (* it835 (- 1))) 0))
(assert (= (+ it847 (* it836 (- 1))) 0))
(assert (= (+ (* it837 (- 1)) it848) 0))
(assert (= (+ it849 (* it838 (- 1))) 0))
(assert (= (+ it850 (* it839 (- 1))) 0))
(check-sat)
