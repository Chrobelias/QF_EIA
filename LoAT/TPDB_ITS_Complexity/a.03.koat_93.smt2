...
(assert (and (>= (+ it513 (- 2)) 0)
     (= (+ it512 (- 1)) 0)
     (= (+ it510 (- 4)) 0)
     (>= (+ it513 (- 3)) 0)))
(assert (= (+ it518 (- 3)) 0))
(assert (= (+ it519 (* it511 (- 1)) (- 2)) 0))
(assert (= (+ it520 (* it512 (- 1))) 0))
(assert (= (+ (* it513 (- 1)) it521 1) 0))
(assert (= (+ it522 (* it512 (- 1))) 0))
(assert (= (+ it523 (* it512 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) (* it520 (- 2)) it521) 1) 0))
      (a!2 (>= (+ (+ (* it88 (- 1)) it521) (- 3)) 0))
      (a!3 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1))) it521 (- 2)) 0))
      (a!4 (+ (+ (* it88 (- 1)) (* it19 (- 1))) (* it520 (- 2)) it521))
      (a!5 (>= (+ (+ (* it88 (- 1)) it521) (- 2)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it520 (- 2)) it521) (- 1)) 0))
      (a!7 (>= (+ (+ (* it523 (- 1)) it521) (- 1)) 0)))
  (and (>= (+ it521 (- 3)) 0)
       (>= (+ (* it523 (- 1)) it521) 0)
       a!1
       a!2
