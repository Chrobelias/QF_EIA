...
(assert (let ((a!1 (+ (+ (+ it2741 (* it706 (- 1))) (* it540 (- 1)))
              (* it2740 (- 2))
              (- 1)))
      (a!2 (+ it2741 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!3 (+ (+ it2741 (* it706 (- 1))) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!5 (>= (+ (+ it2741 (* it706 (- 1))) (- 3)) 0))
      (a!6 (+ (+ (+ it2741 (* it706 (- 1))) (* it540 (- 1))) (- 2)))
      (a!8 (>= (+ (+ it2741 (* it2743 (- 1))) (- 1)) 0))
      (a!9 (+ (+ (+ it2741 (* it706 (- 1))) (* it2740 (- 2))) (- 2)))
      (a!10 (+ (+ (+ it2741 (* it706 (- 1))) (* it2740 (- 2))) (- 1)))
      (a!11 (+ it2741
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it540 (+ it1243 (- 1)) (- 1))))
      (a!12 (>= (+ (+ it2741 (* it2740 (- 2))) (- 2)) 0))
      (a!13 (>= (+ (+ it2741 (* it706 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it2741 (* it2740 (- 2))) (- 1)) 0)))
(let ((a!4 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!7 (+ a!3 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1))))
      (a!14 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!16 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (* it2740 (- 2)))))
  (and (>= a!1 0)
       (>= (+ a!2 (- 3)) 0)
       (>= (+ a!2 (- 2)) 0)
       (>= (+ it1243 (- 1)) 0)
