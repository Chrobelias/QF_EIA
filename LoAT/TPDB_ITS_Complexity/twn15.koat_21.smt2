...
(assert (let ((a!1 (> (+ (* (exp it371 5) (+ 0 (- 1)))
                 (* (exp it369 2) (+ 0 (- 1)))
                 (+ 0 it370))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it369 2)))
      (a!3 (* (* (exp 9 (+ it117 (- 1))) (+ 0 it370)) (+ 0 3)))
      (a!4 (* (* (exp it371 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!6 (> (+ (* (exp it371 5) (+ 0 (- 1)))
                 (* (exp it371 3) (+ 0 (- 2)))
                 (* (exp it369 2) (+ 0 (- 4)))
                 (+ 0 (* it370 3)))
              (+ 0 0)))
      (a!7 (* (* (exp it371 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* a!2 (+ 0 (- 4)))
                 a!3
                 (* (exp it371 5) (+ 0 (- 1)))
                 (exp it371 3)
