...
(assert (let ((a!1 (> (+ (+ 0 it692)
                 ...
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (+ 0 it692) (exp 81 (+ it495 (- 1)))) (+ 0 3)))
      (a!3 (* (exp it691 2) (exp (exp 16 (+ it495 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 81 (+ it495 (- 1))) (exp it693 3)) (+ 0 (- 3))))
      (a!6 (> (+ (+ 0 (* it692 9))
                 (* (exp it693 3) (+ 0 (- 8)))
                 (* (exp it691 2) (+ 0 (- 16)))
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp 81 (+ it495 (- 1))) (exp it693 3)) (+ 0 (- 1))))
      (a!9 (* (* (+ 0 it692) (exp 81 (+ it495 (- 1)))) (+ 0 9)))
      (a!10 (* (* (exp 81 (+ it495 (- 1))) (exp it693 3)) (+ 0 (- 9))))
      (a!12 (* (* (+ 0 it692) (exp 81 (+ it495 (- 1)))) (+ 0 27)))
      (a!13 (* (* (exp 81 (+ it495 (- 1))) (exp it693 3)) (+ 0 (- 27))))
      (a!15 (> (+ (+ 0 (* it692 3))
                  (* (exp it693 3) (+ 0 (- 2)))
                  (* (exp it691 2) (+ 0 (- 4)))
                  (* (exp it693 5) (+ 0 (- 1))))
