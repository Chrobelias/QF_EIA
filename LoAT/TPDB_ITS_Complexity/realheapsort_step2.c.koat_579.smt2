...
(assert (and (> (+ (* it2252 (- 1)) (* it2253 2) it2254 3) 0) (= (+ it2249 (- 20)) 0)))
(assert (= (+ it2262 (- 18)) 0))
(assert (= (+ (* it2250 (- 1)) it2263 (- 4)) 0))
(assert (= (+ it2264 (* it2254 (- 1)) (- 1)) 0))
(assert (= (+ (* it2252 (- 1)) it2265) 0))
(assert (= (+ (* it2253 (- 1)) it2266) 0))
(assert (= (+ it2267 (* it2254 (- 1)) (- 1)) 0))
(assert (= (+ (* it2255 (- 1)) it2268) 0))
(assert (and (> (+ it2267 (* it2265 (- 1)) 2) 0) (= (+ it2262 (- 18)) 0)))
(assert (= (+ it2271 (- 30)) 0))
(assert (= (+ it2272 (* it2263 (- 1)) (- 2)) 0))
(assert (= (+ it2273 (* it2264 (- 1))) 0))
(assert (= (+ it2274 (* it2265 (- 1))) 0))
(assert (= (+ it2275 (* it2266 (- 1))) 0))
(assert (= (+ (* it2267 (- 1)) it2276) 0))
(assert (= (+ it2277 (* it2268 (- 1))) 0))
(check-sat)
