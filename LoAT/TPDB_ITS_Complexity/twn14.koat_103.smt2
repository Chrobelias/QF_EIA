...
(assert (let ((a!1 (< (+ (+ 0 (* it835 (- 1))) (exp it834 2) (exp it836 5)) (+ 0 0))))
  (and a!1 (= (+ it831 (- 3)) 0) (< it834 0))))
(assert (= (+ it879 (- 3)) 0))
(assert (= (+ (* it832 (- 1)) it880 (- 1)) 0))
(assert (= (+ it881 (* it833 (- 1))) 0))
(assert (= (+ it882 (* it834 2)) 0))
(assert (= (+ (+ 0 (* it835 (- 3))) (* (exp it836 3) (+ 0 2)) (+ 0 it883))
   (+ 0 0)))
(assert (= (+ it884 (* it836 (- 1))) 0))
(assert (= (+ it885 (* it837 (- 1))) 0))
(assert (let ((a!1 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 (* (exp it884 3) (+ 0 (- 2)))
                 (* (exp it882 2) (+ 0 (- 4)))
                 (+ 0 (* it883 3)))
              (+ 0 0)))
      (a!2 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 ...
                 (+ 0 it883))
              (+ 0 0)))
      (a!3 (* (* (exp 81 (+ it676 (- 1))) (+ 0 it883)) (+ 0 9)))
      (a!4 (* (* (exp it884 3) (exp 81 (+ it676 (- 1)))) (+ 0 (- 9))))
      (a!5 (* (exp (exp 16 (+ it676 (- 1))) (+ 0 2)) (exp it882 2)))
      (a!7 (* (* (exp 81 (+ it676 (- 1))) (+ 0 it883)) (+ 0 27)))
      (a!8 (* (* (exp it884 3) (exp 81 (+ it676 (- 1)))) (+ 0 (- 27))))
      (a!10 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                  (* (exp it884 3) (+ 0 (- 8)))
                  (* (exp it882 2) (+ 0 (- 16)))
                  (+ 0 (* it883 9)))
               (+ 0 0)))
      (a!11 (* (* (exp 81 (+ it676 (- 1))) (+ 0 it883)) (+ 0 3)))
      (a!12 (* (* (exp it884 3) (exp 81 (+ it676 (- 1)))) (+ 0 (- 3))))
      (a!14 (* (* (exp it884 3) (exp 81 (+ it676 (- 1)))) (+ 0 (- 1)))))
(let ((a!6 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 a!3
                 a!4
                 (exp it884 3)
                 (* a!5 (+ 0 (- 16))))
      ...
      (a!9 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 ...
                 (* a!5 (+ 0 (- 64))))
              (+ 0 0)))
      (a!13 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                  a!11
                  a!12
                  (exp it884 3)
                  (* a!5 (+ 0 (- 4))))
               (+ 0 0)))
      (a!15 (+ (* (exp it884 5) (+ 0 (- 1)))
               (* (exp 81 (+ it676 (- 1))) (+ 0 it883))
               a!14
               (exp it884 3)
               (* a!5 (+ 0 (- 1))))))
  (and (>= (+ it879 (- 3)) 0)
