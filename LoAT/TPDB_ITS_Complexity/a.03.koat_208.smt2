...
(assert (= (+ (* (exp 2 it57) (+ 0 it571) (+ 0 (- 1))) (+ 0 it634))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ (+ it632 (* it540 (- 1))) (* it631 (- 2))) (- 2)))
      (a!2 (+ it632 (* it706 (+ it766 (- 1)) it716 (- 1)) (* it766 (- 1))))
      (a!4 (+ (+ (* (+ it716 (- 1)) it540 (- 1)) it632)
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!6 (>= (+ (+ it632 (* it634 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it632 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!12 (>= (+ (+ it632 (* it706 (- 1)) (* it540 (- 1)))
                   (* it631 (- 2))
                   (- 1))
                0))
      (a!13 (+ (+ (* (+ it716 (- 1)) it540 (- 1)) it632)
               (* it706 (+ it766 (- 1)) it716 (- 1))
               (* it706 (+ it716 (- 1)) (- 1))
               (* it766 (- 1))))
      (a!20 (>= (+ (+ it632 (* it540 (- 1))) (- 3)) 0))
      (a!22 (+ it632 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!23 (+ (+ (+ it632 (* it540 (- 1))) (* it631 (- 2))) (- 1)))
      (a!27 (>= (+ (+ it632 (* it631 (- 2))) (- 2)) 0))
      (a!28 (>= (+ (+ it632 (* it540 (- 1))) (- 2)) 0))
      (a!30 (>= (+ (+ it632 (* it631 (- 2))) (- 1)) 0)))
(let ((a!3 (+ (+ a!2 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 2)))
      (a!5 (>= (+ (+ a!4 (* it540 (- 1))) (- 2)) 0))
      (a!7 (+ a!2 (* it540 (- 1)) (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!9 (+ (+ (+ a!4 (* it540 (- 1))) (* it631 (- 2))) (- 1)))
      (a!10 (+ (+ a!2 (* (+ it766 (- 1)) it540 it716 (- 1))) (* it631 (- 2))))
      (a!11 (>= (+ (+ a!4 (* it540 (- 1))) (- 3)) 0))
      (a!14 (+ a!13 (* it540 (- 1)) (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!17 (>= (+ (+ a!4 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!18 (+ (+ a!2 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 1)))
      (a!19 (+ a!2
               (* it706 (- 1))
               (* it540 (- 1))
      ...
      (a!24 (+ a!13
               ...
               (* it540 (- 1))
               (* (+ it766 (- 1)) it540 it716 (- 1))))
      (a!25 (+ (+ (+ a!4 (* it540 (- 1))) (* it631 (- 2))) (- 2)))
      (a!26 (+ (+ a!13 (* (+ it766 (- 1)) it540 it716 (- 1)))
               (* it631 (- 2))
               (- 1)))
      (a!29 (+ (+ a!13 (* (+ it766 (- 1)) it540 it716 (- 1))) (- 2)))
      (a!31 (>= (+ (+ a!4 (* it706 (- 1)) (* it540 (- 1)))
                   (* it631 (- 2))
                   (- 1))
                0)))
(let ((a!15 (>= (+ (+ a!14 (* it631 (- 2))) (- 1)) 0))
      (a!16 (>= (+ (+ a!7 (* it631 (- 2))) (- 1)) 0)))
  (and (>= a!1 0)
       (>= a!3 0)
       (= (+ (* it629 (- 1)) 3) 0)
       (>= (+ (* it629 (- 1)) 3) 0)
