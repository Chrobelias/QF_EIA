...
(assert (and (> (+ it485 (* it483 (- 1)) (* it484 2) 3) 0) (= (+ it480 (- 20)) 0)))
(assert (= (+ it490 (- 18)) 0))
(assert (= (+ it491 (* it481 (- 1)) (- 4)) 0))
(assert (= (+ (* it485 (- 1)) it492 (- 1)) 0))
(assert (= (+ (* it483 (- 1)) it493) 0))
(assert (= (+ it494 (* it484 (- 1))) 0))
(assert (= (+ (* it485 (- 1)) it495 (- 1)) 0))
(assert (= (+ (* it486 (- 1)) it496) 0))
(assert (and (= (+ it490 (- 18)) 0) (<= (+ it495 (* it493 (- 1)) 2) 0)))
(assert (= (+ it497 (- 20)) 0))
(assert (= (+ (* it491 (- 1)) it498 (- 2)) 0))
(assert (= (+ (* it492 (- 1)) it499) 0))
(assert (= (+ (* it493 (- 1)) it500) 0))
(assert (= it501 0))
(assert (= (+ (* it495 (- 1)) it502) 0))
(assert (= (+ (* it496 (- 1)) it503) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it501)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it501)) (+ 0 2))))
(let ((a!2 (+ a!1
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              (+ 0 (* it502 (- 1)))
              (+ 0 it500)
      ...
      (a!4 (+ a!3
              ...
              (+ 0 (* it500 (- 1)))
              (+ 0 1))))
  (and (>= (+ (* it501 (- 2)) (* it502 (- 1)) it500 (- 3)) 0)
       (>= (+ it497 (- 20)) 0)
       (>= (+ (* it501 2) it502 (* it500 (- 1)) 3) 0)
       (>= (+ it101 (- 1)) 0)
       (>= (+ (* it497 (- 1)) 20) 0)
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))))))
