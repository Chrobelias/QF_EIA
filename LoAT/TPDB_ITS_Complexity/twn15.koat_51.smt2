...
(assert (let ((a!1 (* (* (+ 0 it694) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!2 (* (* (exp 9 (+ it107 (- 1))) (exp it695 3)) (+ 0 (- 3))))
      (a!3 (* (exp it693 2) (exp (exp 4 (+ it107 (- 1))) (+ 0 2))))
      (a!5 (> (+ (+ 0 it694)
                 (* (exp it693 2) (+ 0 (- 1)))
                 (* (exp it695 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it107 (- 1))) (exp it695 3)) (+ 0 (- 1))))
      (a!8 (> (+ (* (exp it695 3) (+ 0 (- 2)))
                 (+ 0 (* it694 3))
                 (* (exp it693 2) (+ 0 (- 4)))
                 (* (exp it695 5) (+ 0 (- 1))))
