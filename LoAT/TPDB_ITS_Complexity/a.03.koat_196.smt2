...
(assert (let ((a!1 (>= (+ (+ (* it721 (- 2)) it722) (- 2)) 0))
      (a!2 (>= (+ (+ (* it721 (- 2)) it722) (- 1)) 0)))
  (and (>= (+ (* it727 (- 1)) (* it721 (- 2)) it722 (- 1)) 0)
       a!1
       (>= (+ it722 (- 3)) 0)
       (>= (+ it719 (- 4)) 0)
       a!2
...
(assert (= (+ (* it727 (- 3)) it731 (* it720 (- 1))) 0))
(assert (= (+ (* it721 (- 1)) it732) 0))
(assert (= (+ it727 (* it722 (- 1)) it733) 0))
(assert (= (+ (* it721 (- 1)) it734) 0))
(assert (= (+ (* it721 (- 2)) it735 (- 1)) 0))
(assert (let ((a!1 (>= (+ (+ (* it732 (- 2)) it733) (- 1)) 0))
      (a!2 (>= (+ (+ (* it732 (- 2)) it733) (- 2)) 0)))
  (and a!1
       (>= (+ (* it732 (- 1)) 1) 0)
       (>= (+ (* it732 (- 2)) (* it726 (- 1)) it733 (- 1)) 0)
       (>= (+ it733 (- 3)) 0)
       (>= (+ it732 (- 1)) 0)
       (>= (+ it730 (- 4)) 0)
       (>= (+ (* it730 (- 1)) 4) 0)
       ...
       (>= (+ (* it726 (- 1)) it733 (- 2)) 0)
       a!2)))
(assert (= (+ (* it730 (- 1)) it748) 0))
(assert (= (+ it749 (* it731 (- 1)) (* it726 (- 3))) 0))
(assert (= (+ it750 (* it732 (- 1))) 0))
(assert (= (+ it751 it726 (* it733 (- 1))) 0))
(assert (= (+ (* it732 (- 1)) it752) 0))
(assert (= (+ it753 (* it732 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ it751 (* it736 (- 1))) (- 2)) 0))
      (a!2 (+ (+ (+ (* it750 (- 2)) it751) (* it736 (- 1))) (- 1)))
      (a!3 (>= (+ (+ (* it750 (- 2)) it751) (- 2)) 0))
      (a!4 (+ (+ (+ (* it750 (- 2)) it751) (* it736 (- 1))) (- 2)))
      (a!5 (>= (+ (+ (* it750 (- 2)) it751) (- 1)) 0))
      (a!6 (>= (+ (+ it751 (* it736 (- 1))) (- 3)) 0)))
  (and a!1
       (>= a!2 0)
       a!3
       (>= a!4 0)
       ...
       (>= (+ it750 (- 1)) 0)
       (>= (+ it751 (- 3)) 0)
       (>= (+ (* it750 (- 2)) (* it754 (- 1)) it751 (* it736 (- 1)) (- 1)) 0)
       a!5
       (<= (+ it754 it736) 0)
       a!6)))
(check-sat)
