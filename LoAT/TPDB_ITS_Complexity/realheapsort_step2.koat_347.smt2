...
(assert (let ((a!1 (* (* (+ 0 it599) (exp 2 (+ it216 (- 1)))) (+ 0 2)))
      (a!3 (* (* (+ 0 it599) (exp 2 (+ it216 (- 1)))) (+ 0 (- 2)))))
(let ((a!2 (+ (* (exp 2 (+ it216 (- 1))) (+ 0 2))
              a!1
              (+ 0 (* it597 (- 1)))
              (+ 0 it598)
              (+ 0 1)))
      (a!4 (+ (* (exp 2 (+ it216 (- 1))) (+ 0 (- 2)))
              a!3
              (+ 0 it597)
              (+ 0 (* it598 (- 1)))
              (+ 0 (- 1)))))
  (and (>= (+ (* it595 (- 1)) 7) 0)
       (>= a!2 (+ 0 0))
       (>= (+ (* it599 (- 2)) it597 (* it598 (- 1)) (- 3)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ it595 (- 7)) 0)
       (>= (+ (* it599 2) (* it597 (- 1)) it598 3) 0)
       (>= (+ it216 (- 1)) 0)))))
(check-sat)
