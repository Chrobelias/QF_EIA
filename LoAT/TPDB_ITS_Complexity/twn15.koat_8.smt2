...
(assert (let ((a!1 (> (+ (* (exp it130 2) (+ 0 (- 4)))
                 ...
                 (* (exp it132 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it150 (- 1))) (+ 0 2)) (exp it130 2)))
      (a!3 (* (* (exp it132 3) (exp 9 (+ it150 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (exp 9 (+ it150 (- 1))) (+ 0 it131)) (+ 0 3)))
      (a!6 (> (+ (* (exp it130 2) (+ 0 (- 1)))
                 (* (exp it132 5) (+ 0 (- 1)))
                 (+ 0 it131))
              (+ 0 0)))
      (a!7 (* (* (exp it132 3) (exp 9 (+ it150 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* (exp it132 5) (+ 0 (- 1)))
                 (* a!2 (+ 0 (- 4)))
                 a!3
                 a!4
                 (exp it132 3))
