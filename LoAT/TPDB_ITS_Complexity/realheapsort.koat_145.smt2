...
(assert (let ((a!1 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it17591)) (+ 0 2)))
      (a!3 (>= (+ (+ it17589 (* it17590 (- 1))) (* it17591 (- 2)) (- 3)) 0))
      (a!4 (>= (+ (+ (* it17589 (- 1)) it17590) (* it17591 2) 3) 0))
      (a!5 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it17591)) (+ 0 (- 2)))))
(let ((a!2 (+ (+ 0 (+ (* it17589 (- 1)) it17590))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 2))
              a!1
              (+ 0 1)))
      (a!6 (+ (+ 0 (+ it17589 (* it17590 (- 1))))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 (- 2)))
              a!5
              (+ 0 (- 1)))))
  (and (>= (+ it6284 (- 1)) 0)
