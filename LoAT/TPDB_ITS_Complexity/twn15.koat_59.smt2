...
(assert (let ((a!1 (> (+ (* (exp it756 3) (+ 0 (- 2)))
                 (* (exp it756 5) (+ 0 (- 1)))
                 (+ 0 (* it755 3))
                 (* (exp it754 2) (+ 0 (- 4))))
              (+ 0 0)))
      (a!2 (* (* (exp 81 (+ it729 (- 1))) (exp it756 3)) (+ 0 (- 27))))
      (a!3 (* (exp it754 2) (exp (exp 16 (+ it729 (- 1))) (+ 0 2))))
      (a!4 (* (* (+ 0 it755) (exp 81 (+ it729 (- 1)))) (+ 0 27)))
      (a!6 (> (+ (* (exp it756 3) (+ 0 (- 8)))
                 (* (exp it756 5) (+ 0 (- 1)))
                 (+ 0 (* it755 9))
                 (* (exp it754 2) (+ 0 (- 16))))
              (+ 0 0)))
      (a!7 (* (* (exp 81 (+ it729 (- 1))) (exp it756 3)) (+ 0 (- 9))))
      (a!8 (* (* (+ 0 it755) (exp 81 (+ it729 (- 1)))) (+ 0 9)))
      (a!10 (> (+ (* (exp it756 5) (+ 0 (- 1)))
                  (+ 0 it755)
                  (* (exp it754 2) (+ 0 (- 1))))
               (+ 0 0)))
      (a!11 (* (* (exp 81 (+ it729 (- 1))) (exp it756 3)) (+ 0 (- 3))))
      (a!12 (* (* (+ 0 it755) (exp 81 (+ it729 (- 1)))) (+ 0 3)))
      (a!14 (* (* (exp 81 (+ it729 (- 1))) (exp it756 3)) (+ 0 (- 1)))))
(let ((a!5 (> (+ a!2
                 (* a!3 (+ 0 (- 64)))
                 (exp it756 3)
                 (* (exp it756 5) (+ 0 (- 1)))
