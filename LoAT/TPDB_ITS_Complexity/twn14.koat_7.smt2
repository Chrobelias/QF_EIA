...
(assert (let ((a!1 (> (+ (+ 0 it132)
                 ...
                 (* (exp it133 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp it133 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it131 2)))
      (a!5 (* (* (exp it133 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it132) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!8 (> (+ (* (exp it133 3) (+ 0 (- 2)))
                 (+ 0 (* it132 3))
                 (* (exp it131 2) (+ 0 (- 4)))
                 (* (exp it133 5) (+ 0 (- 1))))
