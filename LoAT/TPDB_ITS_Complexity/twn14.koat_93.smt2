...
(assert (let ((a!1 (> (+ (* (exp it844 3) (+ 0 (- 2)))
      ...
      (a!2 (> (+ (* (exp it842 2) (+ 0 (- 1)))
                 ...
                 (* (exp it844 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (* (exp 9 (+ it117 (- 1))) (exp it844 3)) (+ 0 (- 3))))
      (a!4 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it842 2)))
      (a!5 (* (* (exp 9 (+ it117 (- 1))) (+ 0 it843)) (+ 0 3)))
      (a!7 (* (* (exp 9 (+ it117 (- 1))) (exp it844 3)) (+ 0 (- 1)))))
(let ((a!6 (> (+ (exp it844 3)
                 a!3
                 (* a!4 (+ 0 (- 4)))
                 a!5
