...
(assert (and (= (+ it95 (- 6)) 0) (>= it98 0)))
(assert (= (+ it104 (- 8)) 0))
(assert (= (+ it105 (* it96 (- 1)) (- 1)) 0))
(assert (= (+ it106 (* it97 (- 1))) 0))
(assert (= (+ it107 (* it98 (- 1))) 0))
(assert (= (+ it108 (* it99 (- 1))) 0))
(assert (and (= (+ it104 (- 8)) 0) (< (+ (* it107 (- 1)) 1) 0)))
(assert (= (+ it113 (- 9)) 0))
(assert (= (+ it114 (* it105 (- 1)) (- 1)) 0))
(assert (= (+ (* it106 (- 1)) it115) 0))
(assert (= (+ it116 (* it107 (- 1))) 0))
(assert (= (+ it117 (- 1)) 0))
(assert (let ((a!1 (+ (+ 0 it116)
              (* (+ 0 it117) (exp 2 (+ it91 (- 1))) (+ 0 (- 1))))))
  (and (> a!1 (+ 0 0))
       (>= (+ (* it113 (- 1)) 9) 0)
       (>= (+ it91 (- 1)) 0)
       (>= (+ it113 (- 9)) 0)
       (> (+ it116 (* it117 (- 1))) 0))))
(assert (= (+ (* it113 (- 1)) it124) 0))
(assert (= (+ it125 (* it91 (- 2)) (* it114 (- 1))) 0))
(assert (= (+ it126 (* it115 (- 1))) 0))
(assert (= (+ (* it116 (- 1)) it127) 0))
(assert (= (+ (* (exp 2 it91) (+ 0 it117) (+ 0 (- 1))) (+ 0 it128))
   (+ 0 0)))
(assert (and (>= (+ (* it127 (- 1)) it128) 0) (= (+ it124 (- 9)) 0)))
(assert (= (+ it136 (- 6)) 0))
(assert (= (+ (* it125 (- 1)) it137 (- 2)) 0))
(assert (= (+ it138 (* it126 (- 1))) 0))
(assert (= (+ it139 (* it127 (- 1)) 1) 0))
(assert (= (+ it140 (* it128 (- 1))) 0))
(assert (and (>= it139 0)
     (= 1 0)
     (>= (+ (* it136 (- 1)) 6) 0)
     (>= (+ (* it139 (- 1)) 1) 0)
