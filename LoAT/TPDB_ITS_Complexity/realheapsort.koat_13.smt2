...
(declare-fun it6251 () Int)
(declare-fun it6252 () Int)
(declare-fun it6253 () Int)
...
(assert (= (+ it6243 (- 18)) 0))
(assert (= (+ it6251 (- 12)) 0))
(assert (= (+ (* it6244 (- 1)) it6252 (- 1)) 0))
(assert (= (+ it6253 (* it6245 (- 1))) 0))
(assert (= (+ it6254 (* it6246 (- 1))) 0))
(assert (= (+ (* it6245 (- 1)) it6255) 0))
(assert (= (+ (* it6248 (- 1)) it6256) 0))
(assert (let ((a!1 (>= (+ (+ it6253 (* it6254 (- 1)) (* it6255 (- 2))) (- 4)) 0))
      (a!2 (>= (+ (+ it6253 (* it6254 (- 1)) (* it6255 (- 2))) (- 3)) 0)))
  (and (>= (+ it6251 (- 12)) 0)
       (>= (+ (* it6251 (- 1)) 12) 0)
       a!1
       (<= (+ (* it6255 2) 2) 0)
