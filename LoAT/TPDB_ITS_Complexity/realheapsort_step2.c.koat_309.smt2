...
(assert (and (= (+ it1191 (- 18)) 0) (> (+ it1196 (* it1194 (- 1)) 2) 0)))
(assert (= (+ it1202 (- 30)) 0))
(assert (= (+ it1203 (* it1192 (- 1)) (- 2)) 0))
(assert (= (+ (* it1193 (- 1)) it1204) 0))
(assert (= (+ it1205 (* it1194 (- 1))) 0))
(assert (= (+ it1206 (* it1195 (- 1))) 0))
(assert (= (+ (* it1196 (- 1)) it1207) 0))
(assert (= (+ it1208 (* it1197 (- 1))) 0))
(check-sat)
