...
(assert (= (+ (* (exp 2 it57) (+ 0 it571) (+ 0 (- 1))) (+ 0 it634))
   (+ 0 0)))
(assert (let ((a!1 (+ it632 (* (* it540 it716) (- 1)) (* (* it706 it716) (- 1))))
      (a!2 (+ (* (+ it716 (- 1)) it540 (- 1))
              it632
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!5 (>= (+ (+ it632 (* it634 (- 1))) (- 1)) 0))
      (a!6 (+ (+ (+ it632 (* it540 (- 1))) (* it631 (- 2))) (- 2)))
      (a!7 (>= (+ (+ it632 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ it632 (* it631 (- 2))) (- 2)) 0))
      (a!9 (>= (+ (+ it632 (* it540 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it632 (* it540 (- 1))) (- 3)) 0))
      (a!14 (>= (+ (+ it632 (* it706 (- 1)) (* it540 (- 1)))
                   (* it631 (- 2))
                   (- 1))
                0))
      (a!15 (+ (+ (+ it632 (* it540 (- 1))) (* it631 (- 2))) (- 1)))
      (a!17 (>= (+ (+ it632 (* it631 (- 2))) (- 1)) 0)))
(let ((a!3 (>= (+ (+ a!2 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!4 (>= (+ (+ a!2 (* it540 (- 1))) (- 3)) 0))
      (a!11 (>= (+ (+ a!2 (* it540 (- 1))) (- 2)) 0))
      (a!12 (>= (+ (+ a!2 (* it706 (- 1)) (* it540 (- 1)))
                   (* it631 (- 2))
                   (- 1))
                0))
      (a!13 (+ (+ (+ a!2 (* it540 (- 1))) (* it631 (- 2))) (- 1)))
      (a!16 (+ (+ (+ a!2 (* it540 (- 1))) (* it631 (- 2))) (- 2))))
  (and (>= (+ a!1 (- 3)) 0)
       a!3
       (>= (+ it540 (- 1)) 0)
       (>= (+ a!1 (- 2)) 0)
