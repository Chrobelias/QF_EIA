...
(assert (let ((a!1 (> (+ (+ 0 it692)
                 ...
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp it693 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it691 2)))
      (a!5 (> (+ (+ 0 (* it692 3))
                 (* (exp it693 3) (+ 0 (- 2)))
                 (* (exp it691 2) (+ 0 (- 4)))
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp it693 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!7 (* (* (+ 0 it692) (exp 9 (+ it107 (- 1)))) (+ 0 3))))
(let ((a!4 (+ (exp it693 3)
              a!2
              (* (+ 0 it692) (exp 9 (+ it107 (- 1))))
              (* (exp it693 5) (+ 0 (- 1)))
              (* a!3 (+ 0 (- 1)))))
      (a!8 (> (+ (exp it693 3)
                 a!6
