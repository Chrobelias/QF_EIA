...
(assert (let ((a!1 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it131 2)))
      (a!2 (* (* (exp it133 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (exp it133 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 3))))
      (a!5 (* (* (+ 0 it132) (exp 9 (+ it152 (- 1)))) (+ 0 3)))
      (a!7 (> (+ (+ 0 it132)
                 (* (exp it131 2) (+ 0 (- 1)))
                 (* (exp it133 5) (+ 0 (- 1))))
              (+ 0 0)))
