...
(assert (and (= (+ it80 (- 4)) 0) (> it84 0)))
(assert (= (+ it85 (- 4)) 0))
(assert (= (+ it86 (* it81 (- 1)) (- 1)) 0))
(assert (= (+ it87 (* it82 (- 1))) 0))
(assert (= (+ (* it83 (- 1)) it88) 0))
(assert (= (+ it89 (* it84 (- 1)) 1) 0))
(assert (and (> it89 0) (>= (+ (* it85 (- 1)) 4) 0) (= 1 0) (>= (+ it85 (- 4)) 0)))
(check-sat)
