...
(assert (let ((a!1 (* (* (exp 9 (+ it117 (- 1))) (exp it695 3)) (+ 0 (- 1))))
      (a!2 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it693 2)))
      (a!4 (> (+ (+ 0 it694)
                 (* (exp it693 2) (+ 0 (- 1)))
                 (* (exp it695 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (> (+ (* (exp it695 3) (+ 0 (- 2)))
                 ...
                 (* (exp it695 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it117 (- 1))) (exp it695 3)) (+ 0 (- 3))))
      (a!7 (* (* (+ 0 it694) (exp 9 (+ it117 (- 1)))) (+ 0 3))))
(let ((a!3 (+ a!1
              (* a!2 (+ 0 (- 1)))
              (exp it695 3)
              (* (exp it695 5) (+ 0 (- 1)))
              (* (+ 0 it694) (exp 9 (+ it117 (- 1))))))
      (a!8 (> (+ a!6
                 (* a!2 (+ 0 (- 4)))
                 (exp it695 3)
                 (* (exp it695 5) (+ 0 (- 1)))
