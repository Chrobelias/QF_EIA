...
(declare-fun it8563 () Int)
(declare-fun it8564 () Int)
(declare-fun it8565 () Int)
(declare-fun it8566 () Int)
(declare-fun it8567 () Int)
(declare-fun it8568 () Int)
...
(assert (= (+ it8546 (- 18)) 0))
(assert (= (+ it8563 (- 12)) 0))
(assert (= (+ (* it8547 (- 1)) it8564 (- 1)) 0))
(assert (= (+ (* it8548 (- 1)) it8565) 0))
(assert (= (+ (* it8549 (- 1)) it8566) 0))
(assert (= (+ it8567 (* it8548 (- 1))) 0))
(assert (= (+ (* it8551 (- 1)) it8568) 0))
(assert (and (>= (+ (* it8565 (- 1)) (* it8566 (- 1)) (- 3)) 0)
     (>= (+ it6259 (- 1)) 0)
     (>= (+ (* it8567 2) (* it8565 (- 1)) it8566 3) 0)
     (>= (+ (* it8563 (- 1)) 12) 0)
     (>= (+ it8563 (- 12)) 0)
     (>= (+ (* it8567 (- 2)) it8565 (* it8566 (- 1)) (- 3)) 0)
     (>= (+ it8565 it8566 3) 0)))
(check-sat)
