...
(assert (let ((a!1 (> (+ (* (exp it644 2) (+ 0 (- 1)))
                 (* (exp it646 5) (+ 0 (- 1)))
                 (+ 0 it645))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it644 2)))
      (a!3 (* (* (exp it646 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (+ 0 it645) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!6 (> (+ (* (exp it644 2) (+ 0 (- 4)))
                 (* (exp it646 5) (+ 0 (- 1)))
                 (+ 0 (* it645 3))
                 (* (exp it646 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!7 (* (* (exp it646 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1)))))
