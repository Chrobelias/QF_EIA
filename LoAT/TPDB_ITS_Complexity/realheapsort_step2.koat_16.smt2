...
(assert (let ((a!1 (+ (* (exp 2 (+ it51 (- 1))) (+ 0 (- 2)))
              (+ 0 it67)
              (+ 0 (* it68 (- 1)))
              (* (exp 2 (+ it51 (- 1))) (+ 0 it69) (+ 0 (- 2)))))
      (a!2 (>= (+ (+ it67 (* it68 (- 1)) (* it69 (- 2))) (- 4)) 0))
      (a!3 (>= (+ (+ it67 (* it68 (- 1)) (* it69 (- 2))) (- 3)) 0)))
  (and (>= (+ a!1 (+ 0 (- 1))) (+ 0 0))
       a!2
       (>= (+ a!1 (+ 0 (- 2))) (+ 0 0))
       (>= (+ it51 (- 1)) 0)
       ...
       a!3
       (>= (+ (* it65 (- 1)) 7) 0))))
(assert (= (+ it80 (* it65 (- 1))) 0))
(assert (= (+ (* it51 (- 6)) it81 (* it66 (- 1))) 0))
(assert (= (+ (* it67 (- 1)) it82) 0))
(assert (= (+ it83 (* it68 (- 1))) 0))
(assert (= (+ (* (exp 2 it51) (+ 0 it69) (+ 0 (- 1)))
      (* (exp 2 it51) (+ 0 (- 1)))
      (+ 0 it84)
      (+ 0 1))
   (+ 0 0)))
(assert (let ((a!1 (+ (* (exp 2 (+ it51 (- 1))) (+ 0 (- 2)))
              ...
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ (* it83 (- 1)) (* it84 (- 2)) it82) (- 3)) 0))
      (a!2 (>= (+ (+ (* it83 (- 1)) (* it84 (- 2)) it82) (- 4)) 0)))
  (and (>= (+ (* it80 (- 1)) 7) 0)
       a!1
       a!2
       (>= (+ it80 (- 7)) 0)
