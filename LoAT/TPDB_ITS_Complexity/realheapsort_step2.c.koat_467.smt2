...
(declare-fun it1898 () Int)
(declare-fun it1899 () Int)
(declare-fun it1900 () Int)
(declare-fun it1901 () Int)
(declare-fun it1902 () Int)
(declare-fun it1903 () Int)
...
(assert (and (> (+ (* it1877 (- 1)) (* it1878 2) it1879 3) 0) (= (+ it1874 (- 20)) 0)))
(assert (= (+ it1886 (- 18)) 0))
(assert (= (+ it1887 (* it1875 (- 1)) (- 4)) 0))
(assert (= (+ it1888 (* it1879 (- 1)) (- 1)) 0))
(assert (= (+ it1889 (* it1877 (- 1))) 0))
(assert (= (+ it1890 (* it1878 (- 1))) 0))
(assert (= (+ it1891 (* it1879 (- 1)) (- 1)) 0))
(assert (= (+ it1892 (* it1880 (- 1))) 0))
(assert (and (= (+ it1886 (- 18)) 0) (<= (+ (* it1889 (- 1)) it1891 2) 0)))
(assert (= (+ it1897 (- 20)) 0))
(assert (= (+ (* it1887 (- 1)) it1898 (- 2)) 0))
(assert (= (+ it1899 (* it1888 (- 1))) 0))
(assert (= (+ (* it1889 (- 1)) it1900) 0))
(assert (= it1901 0))
(assert (= (+ it1902 (* it1891 (- 1))) 0))
(assert (= (+ (* it1892 (- 1)) it1903) 0))
(assert (and (>= (+ it1897 (- 20)) 0)
     (>= (+ (* it1897 (- 1)) 20) 0)
     (>= (+ (* it1902 (- 1)) it1900 (* it1901 (- 2)) (- 3)) 0)
     (>= (+ it1902 it1900 3) 0)
     (>= (+ (* it1902 (- 1)) (* it1900 (- 1)) (- 3)) 0)
     (>= (+ it50 (- 1)) 0)
     (>= (+ it1902 (* it1900 (- 1)) (* it1901 2) 3) 0)))
(check-sat)
