...
(assert (let ((a!1 (+ (* (exp 2 it129) (+ 0 it2667) (+ 0 (- 1)))
              ...
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) (* it2695 (- 2)) it2696) 1) 0))
      (a!2 (+ (+ (* it88 (- 1)) (* it2668 (- 1))) (* it2695 (- 2)) it2696))
      (a!3 (>= (+ (+ (* it88 (- 1)) (* it2695 (- 2)) it2696) (- 1)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it2696) (- 3)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it2696) (- 2)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it2668 (- 1))) it2696 (- 2)) 0))
      (a!7 (>= (+ (+ (* it2698 (- 1)) it2696) (- 1)) 0)))
  (and (>= (+ it2693 (- 3)) 0)
       a!1
       (>= (+ it2668 (- 1)) 0)
       (>= (+ a!2 1) 0)
