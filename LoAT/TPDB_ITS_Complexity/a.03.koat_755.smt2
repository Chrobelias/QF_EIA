...
(assert (let ((a!1 (>= (+ (+ (* it706 (- 1)) it2749) (- 3)) 0))
      (a!2 (>= (+ (+ (* it706 (- 1)) it2749) (- 2)) 0))
      (a!3 (>= (+ (+ (* it2748 (- 2)) (* it706 (- 1)) it2749) (- 1)) 0))
      (a!4 (>= (+ (+ (* it2748 (- 2)) (* it706 (- 1)) it2749) (- 2)) 0))
      (a!5 (>= (+ (+ (* it2748 (- 2)) it2749) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2748 (- 2)) (* it706 (- 1)) it2749)
                  (* it540 (- 1))
                  (- 1))
               0))
      (a!7 (>= (+ (+ (* it2748 (- 2)) it2749) (- 1)) 0))
      (a!8 (>= (+ (+ (* it706 (- 1)) it2749) (* it540 (- 1)) (- 2)) 0)))
  (and (>= (+ it2749 (- 3)) 0)
       (>= (+ it540 (- 1)) 0)
       (>= (+ (* it2746 (- 1)) 4) 0)
       (>= (+ it2746 (- 4)) 0)
