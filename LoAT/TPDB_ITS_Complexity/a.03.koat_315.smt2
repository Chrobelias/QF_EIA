...
(assert (let ((a!1 (+ (+ (* it572 (- 1)) (* it19 (- 1))) (* it944 (- 2)) it945))
      (a!2 (>= (+ (+ (* it947 (- 1)) it945) (- 1)) 0))
      (a!3 (>= (+ (+ (* it572 (- 1)) (* it944 (- 2)) it945) (- 1)) 0))
      (a!4 (>= (+ (+ (* it572 (- 1)) (* it19 (- 1))) it945 (- 2)) 0))
      (a!5 (>= (+ (+ (* it572 (- 1)) it945) (- 2)) 0))
      (a!6 (>= (+ (+ (* it572 (- 1)) (* it944 (- 2)) it945) 1) 0))
      (a!7 (>= (+ (+ (* it572 (- 1)) it945) (- 3)) 0)))
  (and (>= (+ it942 (- 3)) 0)
       (>= (+ a!1 1) 0)
       (= 0 0)
       (>= (+ it19 (- 1)) 0)
