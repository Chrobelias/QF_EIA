...
(declare-fun it6287 () Int)
(declare-fun it6288 () Int)
(declare-fun it6289 () Int)
(declare-fun it6290 () Int)
(declare-fun it6291 () Int)
(declare-fun it6292 () Int)
(declare-fun it6295 () Int)
(declare-fun it6296 () Int)
(declare-fun it6297 () Int)
(declare-fun it6298 () Int)
(declare-fun it6299 () Int)
(declare-fun it6300 () Int)
(declare-fun it6303 () Int)
(declare-fun it6304 () Int)
(declare-fun it6305 () Int)
(declare-fun it6306 () Int)
(declare-fun it6307 () Int)
(declare-fun it6308 () Int)
...
(assert (let ((a!1 (+ (* (+ 0 it4207) (exp 2 (+ it6223 (- 1))) (+ 0 (- 2)))
              ...
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (and (= (+ it6225 (- 12)) 0)
     (>= (+ (* it6228 (- 1)) (* it6229 (- 2)) it6227 (- 3)) 0)))
(assert (= (+ it6287 (- 13)) 0))
(assert (= (+ (* it6226 (- 1)) it6288 (- 1)) 0))
(assert (= (+ (* it6227 (- 1)) it6289) 0))
(assert (= (+ (* it6228 (- 1)) it6290) 0))
(assert (= (+ (* it6229 (- 1)) it6291) 0))
(assert (= (+ (* it6230 (- 1)) it6292) 0))
(assert (and (= (+ it6287 (- 13)) 0)
     (= (+ (* it6290 (- 1)) (* it6291 (- 2)) it6289 (- 3)) 0)))
(assert (= (+ it6295 (- 18)) 0))
(assert (= (+ it6296 (* it6288 (- 1)) (- 2)) 0))
(assert (= (+ it6297 (* it6289 (- 1))) 0))
(assert (= (+ (* it6290 (- 1)) it6298) 0))
(assert (= (+ it6299 (* it6291 (- 1))) 0))
(assert (= (+ it6300 (* it6291 (- 2)) (- 1)) 0))
(assert (= (+ it6295 (- 18)) 0))
(assert (= (+ it6303 (- 12)) 0))
(assert (= (+ (* it6296 (- 1)) it6304 (- 2)) 0))
(assert (= (+ it6305 (* it6297 (- 1))) 0))
(assert (= (+ it6306 (* it6298 (- 1))) 0))
(assert (= (+ (* it6300 (- 1)) it6307) 0))
(assert (= (+ (* it6300 (- 1)) it6308) 0))
(assert (and (>= (+ it6259 (- 1)) 0)
     (>= (+ it6305 (* it6306 (- 1)) (* it6307 (- 2)) (- 3)) 0)
     (>= (+ it6303 (- 12)) 0)
     (>= (+ (* it6303 (- 1)) 12) 0)
     (>= (+ (* it6305 (- 1)) it6306 (* it6307 2) 3) 0)
     (>= (+ (* it6305 (- 1)) (* it6306 (- 1)) (- 3)) 0)
     (>= (+ it6305 it6306 3) 0)))
(check-sat)
