...
(assert (and (= (+ (* it814 (- 1)) it812) 0) (= (+ it809 (- 3)) 0)))
(assert (= (+ it838 (- 4)) 0))
(assert (= (+ it839 (* it810 (- 1)) (- 1)) 0))
(assert (= (+ (* it811 (- 1)) it840) 0))
(assert (= (+ (* it812 (- 1)) it841) 0))
(assert (= (+ (* it813 (- 1)) it842) 0))
(assert (= (+ (* it814 (- 1)) it843) 0))
(assert (let ((a!1 (+ (+ (* it785 (- 1)) (* it795 (- 1))) (* it840 (- 2)) it841))
      (a!3 (>= (+ (+ (* it795 (- 1)) (* it840 (- 2)) it841) (- 2)) 0))
      (a!4 (+ (+ (* it795 (- 1)) it841)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!5 (>= (+ (+ (* it795 (- 1)) it841) (- 3)) 0))
      (a!6 (+ (+ (* it795 (- 1)) (* it840 (- 2)) it841)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!7 (>= (+ (+ (* it840 (- 2)) it841) (- 2)) 0))
      (a!8 (>= (+ (+ (* it795 (- 1)) it841) (- 2)) 0))
      (a!9 (>= (+ it841
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 3))
      ...
      (a!10 (>= (+ (+ (* it840 (- 2)) it841)
                   ...
                   (- 2))
                0))
      (a!11 (>= (+ (+ (* it795 (- 1)) (* it840 (- 2)) it841) (- 1)) 0))
      (a!12 (>= (+ (+ (* it840 (- 2)) it841) (- 1)) 0))
      (a!13 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it841) (- 2)))
      (a!14 (+ (+ (+ (* it785 (- 1)) (* it795 (- 1))) it841)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))
               (- 2))))
(let ((a!2 (>= (+ a!1
