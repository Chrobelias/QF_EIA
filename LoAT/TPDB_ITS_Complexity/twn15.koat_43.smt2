...
(assert (let ((a!1 (> (+ (* (exp it635 2) (+ 0 (- 4)))
      ...
      (a!2 (> (+ (* (exp it635 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it636))
              (+ 0 0)))
      (a!3 (* (* (exp it637 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (exp 9 (+ it117 (- 1))) (+ 0 it636)) (+ 0 3)))
      (a!5 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it635 2)))
      (a!7 (* (* (exp it637 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1)))))
(let ((a!6 (> (+ (* (exp it637 5) (+ 0 (- 1)))
                 a!3
                 a!4
                 (* a!5 (+ 0 (- 4)))
                 (exp it637 3))
