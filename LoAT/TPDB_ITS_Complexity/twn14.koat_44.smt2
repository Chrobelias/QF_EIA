...
(assert (let ((a!1 (> (+ (* (exp it575 3) (+ 0 (- 2)))
                 (* (exp it575 5) (+ 0 (- 1)))
                 (* (exp it573 2) (+ 0 (- 4)))
                 (+ 0 (* it574 3)))
              (+ 0 0)))
      (a!2 (* (* (exp 9 (+ it152 (- 1))) (+ 0 it574)) (+ 0 3)))
      (a!3 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it573 2)))
      (a!4 (* (* (exp it575 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (exp it575 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 1))))
      (a!8 (> (+ (* (exp it575 5) (+ 0 (- 1)))
                 (* (exp it573 2) (+ 0 (- 1)))
                 (+ 0 it574))
              (+ 0 0))))
