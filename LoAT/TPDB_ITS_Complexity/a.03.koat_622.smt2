...
(assert (let ((a!1 (+ (+ (+ (* it88 (- 1)) it2589) (* it2588 (- 2))) 1))
      (a!2 (+ (+ (+ (* it88 (- 1)) it2589) (* it540 (- 1))) (- 3)))
      (a!3 (+ (+ (* it88 (- 1)) it2589)
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))))
      (a!4 (+ (+ (* it88 (- 1)) it2589) (* it706 (- 1)) (* it540 (- 1))))
      (a!5 (+ (+ (+ (* it88 (- 1)) it2589) (* it540 (- 1))) (- 2)))
      (a!6 (+ (+ (+ (* it88 (- 1)) it2589) (* it540 (- 1))) (* it2588 (- 2))))
      (a!7 (>= (+ (+ (* it88 (- 1)) it2589) (- 2)) 0))
      (a!8 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it88 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))
              it2589))
      (a!12 (>= (+ (+ it2589 (* it2591 (- 1))) (- 1)) 0))
      (a!14 (+ (+ (+ (* it88 (- 1)) it2589) (* it2588 (- 2))) (- 2)))
      (a!16 (>= (+ (+ (* it88 (- 1)) it2589) (* it2588 (- 2))) 0))
      (a!17 (>= (+ (+ (* it88 (- 1)) it2589) (- 3)) 0))
      (a!18 (+ (+ (+ (* it88 (- 1)) it2589) (* it2588 (- 2))) (- 1))))
(let ((a!9 (>= (+ (+ a!8 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ a!8 (* it540 (- 1))) (- 2)) 0))
      (a!11 (>= (+ (+ a!8 (* it706 (- 1)) (* it540 (- 1)))
                   (* it2588 (- 2))
                   (- 1))
                0))
      (a!13 (>= (+ (+ a!8 (* it540 (- 1))) (- 3)) 0))
      (a!15 (+ (+ (+ a!8 (* it540 (- 1))) (* it2588 (- 2))) (- 1)))
      (a!19 (+ (+ (+ a!8 (* it540 (- 1))) (* it2588 (- 2))) (- 2))))
  (and (>= a!1 0)
       (>= a!2 0)
       (>= (+ a!3 (- 2)) 0)
       (>= (+ it540 (- 1)) 0)
