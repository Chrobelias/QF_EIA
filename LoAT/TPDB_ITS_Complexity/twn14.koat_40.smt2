...
(assert (let ((a!1 (> (+ (* (exp it547 2) (+ 0 (- 4)))
                 ...
                 (* (exp it549 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!2 (* (* (exp it549 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (* (exp 9 (+ it117 (- 1))) (+ 0 it548)) (+ 0 3)))
      (a!4 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it547 2)))
      (a!6 (> (+ (* (exp it547 2) (+ 0 (- 1)))
                 (* (exp it549 5) (+ 0 (- 1)))
                 (+ 0 it548))
              (+ 0 0)))
      (a!7 (* (* (exp it549 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1)))))
