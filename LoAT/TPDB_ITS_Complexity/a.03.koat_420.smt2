...
(assert (let ((a!1 (>= (+ (+ (* it1080 (- 2)) it1081 (* it1075 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it1081 (* it1075 (- 1))) (- 2)) 0))
      (a!3 (+ (* it1080 (- 2)) (* it1084 (- 1)) it1081 (* it1075 (- 1))))
      (a!4 (>= (+ (+ it1081 (* it1075 (- 1))) (- 3)) 0))
      (a!5 (>= (+ (+ (* it1083 (- 1)) it1081) (- 1)) 0))
      (a!6 (>= (+ (+ (* it1080 (- 2)) it1081 (* it1075 (- 1))) 1) 0)))
  (and (>= (+ (* it1083 (- 1)) it1081) 0)
       a!1
       (>= (+ (* it1084 (- 1)) it1081 (* it1075 (- 1)) (- 2)) 0)
       a!2
       (>= (+ (* it1078 (- 1)) 3) 0)
       (>= (+ it1080 (- 1)) 0)
       (<= (+ it1084 it1075) 0)
       (>= (+ (* it1080 (- 2)) it1081 (* it1075 (- 1))) 0)
       (= 0 0)
       (= (+ it1084 it1075) 0)
       (>= (+ a!3 1) 0)
       (>= (+ it1081 (- 2)) 0)
