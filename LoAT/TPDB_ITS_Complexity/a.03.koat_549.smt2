...
(assert (let ((a!1 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543)
                  ...
                  (- 1))
               0))
      (a!2 (+ it2543 (* (* it2537 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!3 (>= (+ (+ (* it706 (- 1)) it2543) (* it2537 (- 1)) (- 2)) 0))
      (a!4 (>= (+ (+ (* it2542 (- 2)) it2543) (- 2)) 0))
      (a!5 (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543)
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!6 (+ (+ (* it706 (- 1)) it2543)
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!7 (>= (+ (+ (* it706 (- 1)) it2543) (- 2)) 0))
      (a!8 (>= (+ (+ (* it706 (- 1)) it2543) (- 3)) 0))
      (a!9 (>= (+ (+ (* it2542 (- 2)) it2543)
                  (* it706 (+ it1243 (- 1)) (- 1))
                  (* it2537 (+ it1243 (- 1)) (- 1))
                  (- 2))
               0))
      (a!10 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543) (- 1)) 0))
      (a!11 (>= (+ (+ (* it2542 (- 2)) (* it706 (- 1)) it2543) (- 2)) 0))
      (a!12 (>= (+ it2543
                   (* it706 (+ it1243 (- 1)) (- 1))
                   (* it2537 (+ it1243 (- 1)) (- 1))
                   (- 3))
                0))
      (a!13 (>= (+ (+ (* it2542 (- 2)) it2543) (- 1)) 0))
      (a!14 (>= (+ (+ (* it2545 (- 1)) it2543) (- 1)) 0)))
  (and a!1
       (>= (+ it2540 (- 3)) 0)
       (>= (+ it1243 (- 1)) 0)
