...
(declare-fun it2776 () Int)
(declare-fun it2777 () Int)
...
(assert (let ((a!1 (>= (+ (+ it2766 (* it2770 (- 1))) (* it2765 (- 2)) (- 1)) 0))
      (a!2 (>= (+ (+ it2766 (* it2770 (- 1))) (- 2)) 0))
      (a!3 (>= (+ (+ it2766 (* it2765 (- 2))) (- 2)) 0))
      (a!4 (>= (+ (+ it2766 (* it2765 (- 2))) (- 1)) 0)))
  (and (>= (+ (* it2763 (- 1)) 4) 0)
       (>= (+ it2766 (- 3)) 0)
       a!1
       a!2
       ...
       (>= (+ it2765 (- 1)) 0)
       (>= (+ it2766 (- 2)) 0))))
(assert (= (+ (* it2763 (- 1)) it2775) 0))
(assert (= (+ it2776 (* it2770 (- 3)) (* it2764 (- 1))) 0))
(assert (= (+ it2777 (* it2765 (- 1))) 0))
(assert (= (+ (* it2766 (- 1)) it2770 it2778) 0))
(assert (= (+ it2779 (* it2765 (- 1))) 0))
(assert (= (+ it2780 (* it2765 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it2777 (- 2)) (* it2771 (- 1)))
                  (* it2781 (- 1))
                  it2778
                  (- 1))
               0))
      (a!2 (>= (+ (+ (* it2771 (- 1)) it2778) (- 2)) 0))
      (a!3 (+ (+ (+ (* it2777 (- 2)) (* it2771 (- 1))) it2778) (- 1)))
      (a!4 (>= (+ (+ (* it2771 (- 1)) it2778) (- 3)) 0))
      (a!5 (+ (+ (+ (* it2777 (- 2)) (* it2771 (- 1))) it2778) (- 2)))
      (a!6 (>= (+ (+ (* it2777 (- 2)) it2778) (- 2)) 0))
      (a!7 (>= (+ (+ (* it2777 (- 2)) it2778) (- 1)) 0)))
  (and (>= (+ it2771 (- 1)) 0)
       a!1
       (>= (+ (* it2771 (- 1)) (* it2781 (- 1)) it2778 (- 2)) 0)
       (>= (+ (* it2777 (- 1)) 1) 0)
       a!2
       (>= (+ it2778 (- 3)) 0)
       (>= (+ it2778 (- 2)) 0)
