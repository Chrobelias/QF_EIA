...
(assert (let ((a!1 (> (+ (+ 0 it355)
                 (* (exp it354 2) (+ 0 (- 1)))
                 (* (exp it356 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (+ 0 it355) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!3 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it354 2)))
      (a!4 (* (* (exp it356 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 3))))
      (a!6 (> (+ (+ 0 (* it355 3))
                 (* (exp it356 3) (+ 0 (- 2)))
                 (* (exp it354 2) (+ 0 (- 4)))
                 (* (exp it356 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!7 (* (* (exp it356 3) (exp 9 (+ it82 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ a!2
                 (exp it356 3)
                 (* a!3 (+ 0 (- 4)))
                 (* (exp it356 5) (+ 0 (- 1)))
