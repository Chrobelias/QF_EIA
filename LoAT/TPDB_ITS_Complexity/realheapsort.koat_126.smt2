...
(declare-fun it8572 () Int)
(declare-fun it8573 () Int)
(declare-fun it8574 () Int)
(declare-fun it8575 () Int)
(declare-fun it8576 () Int)
(declare-fun it8577 () Int)
(declare-fun it8580 () Int)
(declare-fun it8581 () Int)
(declare-fun it8582 () Int)
(declare-fun it8583 () Int)
(declare-fun it8584 () Int)
(declare-fun it8585 () Int)
(declare-fun it8588 () Int)
(declare-fun it8589 () Int)
(declare-fun it8590 () Int)
(declare-fun it8591 () Int)
(declare-fun it8592 () Int)
(declare-fun it8593 () Int)
(declare-fun it8596 () Int)
(declare-fun it8597 () Int)
(declare-fun it8598 () Int)
(declare-fun it8599 () Int)
(declare-fun it8600 () Int)
(declare-fun it8601 () Int)
...
(assert (and (= (+ it8513 (- 12)) 0)
     (>= (+ it8515 (* it8516 (- 1)) (* it8517 (- 2)) (- 3)) 0)))
(assert (= (+ it8572 (- 13)) 0))
(assert (= (+ it8573 (* it8514 (- 1)) (- 1)) 0))
(assert (= (+ (* it8515 (- 1)) it8574) 0))
(assert (= (+ (* it8516 (- 1)) it8575) 0))
(assert (= (+ it8576 (* it8517 (- 1))) 0))
(assert (= (+ it8577 (* it8518 (- 1))) 0))
(assert (and (= (+ it8572 (- 13)) 0)
     (>= (+ (* it8576 (- 2)) it8574 (* it8575 (- 1)) (- 4)) 0)))
(assert (= (+ it8580 (- 16)) 0))
(assert (= (+ (* it8573 (- 1)) it8581 (- 1)) 0))
(assert (= (+ it8582 (* it8574 (- 1))) 0))
(assert (= (+ it8583 (* it8575 (- 1))) 0))
(assert (= (+ (* it8576 (- 1)) it8584) 0))
(assert (= (+ it8585 (* it8577 (- 1))) 0))
(assert (= (+ it8580 (- 16)) 0))
(assert (= (+ it8588 (- 18)) 0))
(assert (= (+ it8589 (* it8581 (- 1)) (- 2)) 0))
(assert (= (+ (* it8582 (- 1)) it8590) 0))
(assert (= (+ it8591 (* it8583 (- 1))) 0))
(assert (= (+ it8592 (* it8584 (- 1))) 0))
(assert (= (+ it8593 (* it8584 (- 2)) (- 1)) 0))
(assert (= (+ it8588 (- 18)) 0))
(assert (= (+ it8596 (- 12)) 0))
(assert (= (+ (* it8589 (- 1)) it8597 (- 2)) 0))
(assert (= (+ it8598 (* it8590 (- 1))) 0))
(assert (= (+ (* it8591 (- 1)) it8599) 0))
(assert (= (+ (* it8593 (- 1)) it8600) 0))
(assert (= (+ it8601 (* it8593 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it8598 (- 1)) (* it8599 (- 1))) (- 4)) 0))
      (a!2 (>= (+ (+ it8598 (* it8599 (- 1)) (* it8600 (- 2))) (- 4)) 0))
      (a!3 (>= (+ (+ (* it8598 (- 1)) (* it8599 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ it8598 (* it8599 (- 1)) (* it8600 (- 2))) (- 3)) 0)))
  (and a!1
       (>= (+ it8571 (- 1)) 0)
       (>= (+ (* it8596 (- 1)) 12) 0)
       a!2
