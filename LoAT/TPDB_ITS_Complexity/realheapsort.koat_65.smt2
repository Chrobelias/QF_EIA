...
(assert (let ((a!1 (>= (+ (+ it8496 (* it8497 (- 1))) (* it8498 (- 2)) (- 3)) 0))
      (a!2 (>= (+ (+ (* it8496 (- 1)) it8497) (* it8498 2) 3) 0))
      (a!3 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it8498)) (+ 0 2)))
      (a!5 (* (* (exp 2 (+ it6284 (- 1))) (+ 0 it8498)) (+ 0 (- 2)))))
(let ((a!4 (+ (+ 0 (+ (* it8496 (- 1)) it8497))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 2))
              a!3
              (+ 0 1)))
      (a!6 (+ (+ 0 (+ it8496 (* it8497 (- 1))))
              (* (exp 2 (+ it6284 (- 1))) (+ 0 (- 2)))
              a!5
              (+ 0 (- 1)))))
  (and a!1
