...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
              ...
              it1569
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!3 (>= (+ (+ it1569 (* it1571 (- 1))) (- 1)) 0))
      (a!4 (+ (+ (+ (* it88 (- 1)) it1569) (* it540 (- 1))) (- 2)))
      (a!5 (+ (+ (+ (* it88 (- 1)) it1569) (* it540 (- 1))) (* it1568 (- 2))))
      (a!7 (>= (+ (+ (* it88 (- 1)) it1569) (- 3)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) it1569) (- 2)) 0))
      (a!9 (+ (+ (+ (* it88 (- 1)) it1569) (* it1568 (- 2))) (- 1)))
      (a!10 (+ (+ (* it88 (- 1)) it1569) (* it706 (- 1)) (* it540 (- 1))))
      (a!11 (+ (+ (* it88 (- 1)) it1569)
               (* (* it540 it716) (- 1))
               (* (* it706 it716) (- 1))))
      (a!15 (+ (+ (+ (* it88 (- 1)) it1569) (* it1568 (- 2))) 1))
      (a!16 (+ (+ (+ (* it88 (- 1)) it1569) (* it540 (- 1))) (- 3)))
      (a!17 (+ (+ (+ (* it88 (- 1)) it1569) (* it1568 (- 2))) (- 2)))
      (a!19 (>= (+ (+ (* it88 (- 1)) it1569) (* it1568 (- 2))) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1))) (- 3)) 0))
      (a!6 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1)))
                  (* it1568 (- 2))
                  (- 1))
               0))
      (a!12 (+ (+ (+ a!1 (* it540 (- 1))) (* it1568 (- 2))) (- 1)))
      (a!13 (>= (+ (+ a!1 (* it540 (- 1))) (- 2)) 0))
      (a!14 (+ (+ (+ a!1 (* it540 (- 1))) (* it1568 (- 2))) (- 2)))
      (a!18 (>= (+ (+ a!1 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0)))
  (and (>= (+ it1569 (- 3)) 0)
       a!2
       a!3
       (>= a!4 0)
