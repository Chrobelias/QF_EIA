...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it88 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it540 (- 1)) it2696) (- 2)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) (* it2695 (- 2))) it2696) (- 1)))
      (a!6 (+ (* it88 (- 1))
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))
              it2696))
      (a!7 (+ (+ (+ (* it88 (- 1)) (* it2695 (- 2))) it2696) (- 2)))
      (a!8 (>= (+ (+ (* it88 (- 1)) (* it706 (- 1)))
                  (* it540 (- 1))
                  it2696
                  (- 2))
      ...
      (a!10 (>= (+ (+ (* it88 (- 1)) (* it706 (- 1)))
                   ...
                   (- 1))
                0))
      (a!11 (>= (+ (+ (* it88 (- 1)) (* it540 (- 1)) it2696) (- 3)) 0))
      (a!14 (+ (+ (* it88 (- 1)) (* it2695 (- 2))) (* it540 (- 1)) it2696))
      (a!15 (>= (+ (+ (* it88 (- 1)) it2696) (- 3)) 0))
      (a!17 (>= (+ (+ (* it88 (- 1)) (* it2695 (- 2))) it2696) 0))
      (a!18 (>= (+ (+ (* it88 (- 1)) it2696) (- 2)) 0))
      (a!19 (+ (+ (+ (* it88 (- 1)) (* it2695 (- 2))) it2696) 1))
      (a!20 (>= (+ (+ (* it2698 (- 1)) it2696) (- 1)) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it540 (- 1)) it2696) (- 2)) 0))
      (a!3 (>= (+ (+ a!1 (* it540 (- 1)) it2696) (- 3)) 0))
      (a!9 (+ (+ a!1 (* it2695 (- 2))) (* it540 (- 1)) it2696))
      (a!12 (>= (+ (+ a!1 (* it2695 (- 2))) it2696 (- 2)) 0))
      (a!13 (>= (+ (+ a!1 (* it706 (- 1)))
                   (* it2695 (- 2))
                   (* it540 (- 1))
                   it2696
                   (- 1))
                0))
      (a!16 (>= (+ (+ a!1 (* it706 (- 1))) (* it540 (- 1)) it2696 (- 2)) 0)))
  (and a!2
       a!3
       a!4
       (>= (+ it2693 (- 3)) 0)
