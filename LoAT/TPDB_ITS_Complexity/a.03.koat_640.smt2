...
(assert (let ((a!1 (>= (+ (+ (* it706 (- 1)) it2606) (- 3)) 0))
      (a!2 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606) (- 2)) 0))
      (a!3 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606)
                  (* it540 (- 1))
                  (- 1))
               0))
      (a!4 (>= (+ (+ (* it706 (- 1)) it2606) (- 2)) 0))
      (a!5 (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606)
              (* it706 (+ it1243 (- 1)) (- 1))))
      (a!7 (+ (+ (* it706 (- 1)) it2606) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!9 (+ it2606 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!10 (>= (+ (+ (* it2608 (- 1)) it2606) (- 1)) 0))
      (a!12 (>= (+ (+ (* it2605 (- 2)) it2606)
                   (* it706 (+ it1243 (- 1)) (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   (- 2))
                0))
      (a!13 (>= (+ it2606
                   ...
                   (- 3))
                0))
      (a!15 (>= (+ (+ (* it706 (- 1)) it2606) (* it540 (- 1)) (- 2)) 0))
      (a!18 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606) (- 1)) 0))
      (a!19 (>= (+ (+ (* it2605 (- 2)) it2606) (- 1)) 0))
      (a!20 (>= (+ (+ (* it2605 (- 2)) it2606) (- 2)) 0)))
(let ((a!6 (+ (+ a!5 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!8 (+ (+ a!7 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!11 (+ (+ a!5 (* it540 (+ it1243 (- 1)) (- 1))) (- 1)))
      (a!14 (+ (+ a!7 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!16 (>= (+ a!7 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1)) (- 2))
                0))
      (a!17 (>= (+ a!5 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1)) (- 1))
                0)))
  (and (>= (+ it2606 (- 2)) 0)
       (>= (+ it1243 (- 1)) 0)
       a!1
