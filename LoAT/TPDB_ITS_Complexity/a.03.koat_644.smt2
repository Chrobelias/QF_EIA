...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it540 (- 1))
              (* it88 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!3 (>= (+ (+ (* it2608 (- 1)) it2606) (- 1)) 0))
      (a!4 (+ (+ (+ (* it88 (- 1)) it2606) (* it540 (- 1))) (- 3)))
      (a!5 (+ (+ (+ (* it88 (- 1)) it2606) (* it540 (- 1))) (- 2)))
      (a!6 (>= (+ (+ (* it88 (- 1)) it2606) (- 3)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) it2606) (- 2)) 0))
      (a!9 (+ (+ (+ (* it88 (- 1)) (* it2605 (- 2))) it2606) (* it540 (- 1))))
      (a!10 (+ (+ (+ (* it88 (- 1)) (* it2605 (- 2))) it2606) 1))
      (a!11 (+ (+ (+ (* it88 (- 1)) (* it2605 (- 2))) it2606) (- 1)))
      (a!13 (>= (+ (+ (* it88 (- 1)) (* it2605 (- 2)))
                   (* it706 (- 1))
                   it2606
                   (* it540 (- 1))
                   (- 1))
                0))
      (a!14 (+ (+ (+ (* it88 (- 1)) (* it2605 (- 2))) it2606) (- 2)))
      (a!16 (+ (* it88 (- 1))
               (* (* it540 it716) (- 1))
               it2606
               (* (* it706 it716) (- 1))))
      (a!18 (>= (+ (+ (* it88 (- 1)) (* it2605 (- 2))) it2606) 0)))
(let ((a!2 (+ (+ (+ a!1 (* it2605 (- 2))) it2606) (- 2)))
      (a!7 (>= (+ (+ a!1 (* it2605 (- 2)))
                  (* it706 (- 1))
                  it2606
                  (* it540 (- 1))
                  (- 1))
               0))
      (a!12 (>= (+ (+ (+ a!1 it2606) (* it540 (- 1))) (- 3)) 0))
      (a!15 (+ (+ (+ a!1 (* it2605 (- 2))) it2606) (* it540 (- 1))))
      (a!17 (>= (+ (+ (+ a!1 it2606) (* it540 (- 1))) (- 2)) 0)))
  (and (>= a!2 0)
       (>= (+ a!1 (* it706 (- 1)) it2606 (* it540 (- 1)) (- 2)) 0)
       (>= (+ it2603 (- 3)) 0)
       (>= (+ it540 (- 1)) 0)
       a!3
       (= 0 0)
       ...
       (>= (+ (+ a!1 it2606) (- 3)) 0)
       a!18
       (>= (+ (* it88 (- 1)) (* it706 (- 1)) it2606 (* it540 (- 1)) (- 2)) 0)
       (<= (+ it88 (* it540 it716) (* it706 it716) 1) 0)
       (>= (+ a!9 (- 2)) 0)
       (>= (+ a!16 (- 3)) 0)
       (>= (+ (* it2605 (- 1)) 1) 0)))))
