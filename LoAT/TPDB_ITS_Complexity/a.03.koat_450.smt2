...
(assert (let ((a!1 (>= (+ (+ (* it1128 (- 2)) it1129) (- 1)) 0))
      (a!2 (>= (+ (+ (* it1128 (- 2)) it1129) (- 2)) 0)))
  (and a!1
       (>= (+ (* it1128 (- 2)) (* it1122 (- 1)) it1129 (- 1)) 0)
       (>= (+ (* it1128 (- 1)) 1) 0)
       (>= (+ it1128 (- 1)) 0)
       (>= (+ it1126 (- 4)) 0)
       (>= (+ it1129 (- 2)) 0)
       ...
       (>= (+ (* it1122 (- 1)) it1129 (- 2)) 0)
       (>= (+ it1129 (- 3)) 0))))
(assert (= (+ (* it1126 (- 1)) it1136) 0))
(assert (= (+ it1137 (* it1122 (- 3)) (* it1127 (- 1))) 0))
(assert (= (+ (* it1128 (- 1)) it1138) 0))
(assert (= (+ it1122 (* it1129 (- 1)) it1139) 0))
(assert (= (+ it1140 (* it1128 (- 1))) 0))
(assert (= (+ (* it1128 (- 2)) it1141) 0))
(assert (let ((a!1 (>= (+ (+ (* it1138 (- 2)) (* it1132 (- 1)))
                  (* it1142 (- 1))
                  it1139
                  (- 1))
               0))
      (a!2 (>= (+ (+ (* it1138 (- 2)) it1139) (- 1)) 0))
      (a!3 (+ (+ (+ (* it1138 (- 2)) (* it1132 (- 1))) it1139) (- 1)))
      (a!4 (>= (+ (+ (* it1132 (- 1)) it1139) (- 3)) 0))
      (a!5 (>= (+ (+ (* it1132 (- 1)) it1139) (- 2)) 0))
      (a!6 (>= (+ (+ (* it1138 (- 2)) it1139) (- 2)) 0))
      (a!7 (+ (+ (+ (* it1138 (- 2)) (* it1132 (- 1))) it1139) (- 2))))
  (and (>= (+ it1136 (- 4)) 0)
       a!1
       a!2
       (<= (+ it1132 it1142) 0)
