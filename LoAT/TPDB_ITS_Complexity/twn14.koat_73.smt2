...
(assert (let ((a!1 (* (* (exp 81 (+ it453 (- 1))) (exp it746 3)) (+ 0 (- 1))))
      (a!2 (* (exp it744 2) (exp (exp 16 (+ it453 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 81 (+ it453 (- 1))) (+ 0 it745)) (+ 0 27)))
      (a!5 (* (* (exp 81 (+ it453 (- 1))) (exp it746 3)) (+ 0 (- 27))))
      (a!7 (* (* (exp 81 (+ it453 (- 1))) (+ 0 it745)) (+ 0 9)))
      (a!8 (* (* (exp 81 (+ it453 (- 1))) (exp it746 3)) (+ 0 (- 9))))
      (a!10 (* (* (exp 81 (+ it453 (- 1))) (+ 0 it745)) (+ 0 3)))
      (a!11 (* (* (exp 81 (+ it453 (- 1))) (exp it746 3)) (+ 0 (- 3))))
      (a!13 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                  (+ 0 (* it745 3))
                  (* (exp it744 2) (+ 0 (- 4)))
                  (* (exp it746 3) (+ 0 (- 2))))
               (+ 0 0)))
      ...
      (a!15 (> (+ (* (exp it746 5) (+ 0 (- 1)))
                  ...
                  (* (exp it746 3) (+ 0 (- 8))))
               (+ 0 0))))
(let ((a!3 (+ (* (exp it746 5) (+ 0 (- 1)))
              (* (exp 81 (+ it453 (- 1))) (+ 0 it745))
              a!1
              (* a!2 (+ 0 (- 1)))
              (exp it746 3)))
      (a!6 (> (+ (* (exp it746 5) (+ 0 (- 1)))
