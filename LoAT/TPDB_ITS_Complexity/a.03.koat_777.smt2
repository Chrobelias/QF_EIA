...
(assert (let ((a!1 (>= (+ (+ (* it2787 (- 2)) it2788) (- 1)) 0))
      (a!2 (+ (* it2770 (- 1))
              (* it2771 (+ it2769 (- 1)) (- 1))
              (* it2770 (+ it2769 (- 1)) (- 1))
              it2788))
      (a!3 (>= (+ (* it2787 (- 2))
                  ...
                  (- 2))
               0))
      (a!4 (+ (+ (* it2770 (- 1)) (* it2771 (- 1))) (* it2787 (- 2))))
      (a!6 (+ (* (* it2771 it2769) (- 1)) (* (* it2770 it2769) (- 1)) it2788))
      (a!7 (>= (+ (+ (* it2787 (- 2)) it2788) (- 2)) 0))
      (a!8 (>= (+ (* it2771 (+ it2769 (- 1)) (- 1))
                  (* it2770 (+ it2769 (- 1)) (- 1))
                  it2788
                  (- 3))
               0))
      (a!9 (>= (+ (+ (* it2790 (- 1)) it2788) (- 1)) 0))
      (a!10 (+ (+ (+ (* it2770 (- 1)) (* it2787 (- 2))) it2788) (- 1)))
      (a!11 (>= (+ (+ (* it2770 (- 1)) it2788) (- 2)) 0))
      (a!12 (>= (+ (+ (* it2770 (- 1)) it2788) (- 3)) 0))
      (a!13 (>= (+ (+ (* it2770 (- 1)) (* it2771 (- 1))) it2788 (- 2)) 0))
      (a!14 (+ (+ (* it2770 (- 1)) (* it2787 (- 2)))
               (* it2771 (+ it2769 (- 1)) (- 1))
               (* it2770 (+ it2769 (- 1)) (- 1))
               it2788))
      (a!15 (+ (+ (+ (* it2770 (- 1)) (* it2787 (- 2))) it2788) (- 2)))
      (a!16 (>= (+ (+ (* it2770 (- 1)) (* it2771 (- 1)))
                   (* it2771 (+ it2769 (- 1)) (- 1))
                   (* it2770 (+ it2769 (- 1)) (- 1))
                   it2788
                   (- 2))
...
(let ((a!5 (>= (+ a!4
  ...
  (and a!1
       (>= (+ it2785 (- 3)) 0)
       (<= (+ (* it2771 it2769) (* it2770 it2769) 1) 0)
       (>= (+ a!2 (- 3)) 0)
       a!3
       (>= (+ it2787 (- 1)) 0)
       a!5
