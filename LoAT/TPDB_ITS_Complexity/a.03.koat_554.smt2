...
(assert (let ((a!1 (>= (+ (+ (* it2545 (- 1)) it2543) (- 1)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) (* it2542 (- 2))) it2543) (* it2537 (- 1))))
      (a!3 (+ (* it88 (- 1))
              (* (* it2537 it716) (- 1))
              it2543
              (* (* it706 it716) (- 1))))
      (a!4 (+ (+ (+ (* it88 (- 1)) it2543) (* it2537 (- 1))) (- 2)))
      (a!5 (>= (+ (+ (* it88 (- 1)) (* it2542 (- 2)))
                  (* it706 (- 1))
                  it2543
                  (* it2537 (- 1))
                  (- 1))
               0))
      (a!6 (+ (+ (+ (* it88 (- 1)) (* it2542 (- 2))) it2543) 1))
      (a!7 (+ (* (+ it716 (- 1)) it2537 (- 1))
              (* it88 (- 1))
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!10 (+ (+ (+ (* it88 (- 1)) it2543) (* it2537 (- 1))) (- 3)))
      (a!11 (>= (+ (+ (* it88 (- 1)) it2543) (- 2)) 0))
      (a!13 (+ (+ (+ (* it88 (- 1)) (* it2542 (- 2))) it2543) (- 2)))
      (a!14 (>= (+ (+ (* it88 (- 1)) it2543) (- 3)) 0))
      (a!15 (>= (+ (+ (* it88 (- 1)) (* it2542 (- 2))) it2543) 0))
      (a!17 (+ (+ (+ (* it88 (- 1)) (* it2542 (- 2))) it2543) (- 1))))
(let ((a!8 (>= (+ (+ a!7 (* it2542 (- 2)))
                  (* it706 (- 1))
                  it2543
                  (* it2537 (- 1))
                  (- 1))
               0))
      (a!9 (>= (+ (+ (+ a!7 it2543) (* it2537 (- 1))) (- 3)) 0))
      (a!12 (>= (+ (+ (+ a!7 it2543) (* it2537 (- 1))) (- 2)) 0))
      (a!16 (+ (+ (+ a!7 (* it2542 (- 2))) it2543) (* it2537 (- 1))))
      (a!18 (+ (+ (+ a!7 (* it2542 (- 2))) it2543) (- 2))))
  (and (>= (+ (* it2542 (- 1)) 1) 0)
       a!1
       (>= (+ a!2 (- 2)) 0)
       (= 0 0)
       ...
       a!9
       (>= a!10 0)
       (>= (+ (* it88 (- 1)) (* it706 (- 1)) it2543 (* it2537 (- 1)) (- 2)) 0)
       (>= (+ it88 (- 1)) 0)
       (>= (+ it706 (- 1)) 0)
       (>= (+ it2540 (- 3)) 0)
       a!11
       ...
       (>= a!13 0)
       a!14
       (= (+ it88 (* it2537 it716) (* it706 it716) 1) 0)
       a!15
       (>= (+ (* it2545 (- 1)) it2543) 0)
       (>= (+ a!16 (- 1)) 0)
       (>= a!17 0)
