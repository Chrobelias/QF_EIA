...
(assert (let ((a!1 (>= (+ (+ (* it94 (- 1)) it92) (- 1)) 0))
  ...
  (and a!1
       ...
       (>= (+ (* it94 (- 1)) it92) 0)
       (>= (+ it129 (- 1)) 0))))
(assert (= (+ (* it89 (- 1)) it132) 0))
(assert (= (+ (* it90 (- 1)) it133 (* it129 (- 1))) 0))
(assert (= (+ (* it91 (- 1)) it134) 0))
(assert (= (+ (* it92 (- 1)) it135) 0))
(assert (let ((a!1 (+ (* (exp 2 it129) (+ 0 (- 1)))
              (+ 0 it136)
              (* (+ 0 it94) (exp 2 (+ it129 (- 1))) (+ 0 (- 1)))
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (exp 2 it129) (+ 0 it94) (+ 0 (- 1)))
              (+ 0 it137)
              (* (exp 2 (+ it129 1)) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ (* it137 (- 1)) it135) (- 1)) 0)))
  (and (= 0 0)
       (>= (+ (* it132 (- 1)) 3) 0)
       (>= (+ it132 (- 3)) 0)
       (>= (+ (* it137 (- 1)) it135) 0)
