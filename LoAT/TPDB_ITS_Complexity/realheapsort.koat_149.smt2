...
(declare-fun it18666 () Int)
(declare-fun it18667 () Int)
(declare-fun it18668 () Int)
(declare-fun it18669 () Int)
(declare-fun it18670 () Int)
(declare-fun it18671 () Int)
(declare-fun it18935 () Int)
(declare-fun it18936 () Int)
(declare-fun it18937 () Int)
(declare-fun it18938 () Int)
(declare-fun it18939 () Int)
(declare-fun it18940 () Int)
...
(assert (and (>= (+ (* it18400 (- 1)) it18401 (* it18402 2) 2) 0)
     (= (+ it18398 (- 12)) 0)))
(assert (= (+ it18666 (- 10)) 0))
(assert (= (+ it18667 (* it18399 (- 1)) (- 2)) 0))
(assert (= (+ (* it18400 (- 1)) it18668) 0))
(assert (= (+ it18669 (* it18401 (- 1)) (- 1)) 0))
(assert (= (+ it18670 (* it18402 (- 1))) 0))
(assert (= (+ (* it18403 (- 1)) it18671) 0))
(assert (and (= (+ it18666 (- 10)) 0) (>= (+ (* it18669 (- 1)) it18668 (- 2)) 0)))
(assert (= (+ it18935 (- 12)) 0))
(assert (= (+ (* it18667 (- 1)) it18936 (- 2)) 0))
(assert (= (+ (* it18668 (- 1)) it18937) 0))
(assert (= (+ (* it18669 (- 1)) it18938) 0))
(assert (= it18939 0))
(assert (= (+ (* it18671 (- 1)) it18940) 0))
(assert (let ((a!1 (* (* (+ 0 it18939) (exp 2 (+ it6284 (- 1)))) (+ 0 2)))
      (a!3 (* (* (+ 0 it18939) (exp 2 (+ it6284 (- 1)))) (+ 0 (- 2)))))
(let ((a!2 (+ (+ 0 it18938)
              a!1
              (* (exp 2 (+ it6284 (- 1))) (+ 0 2))
              (+ 0 (* it18937 (- 1)))
      ...
      (a!4 (+ (+ 0 (* it18938 (- 1)))
              ...
              (+ 0 (- 1)))))
  (and (>= (+ it6284 (- 1)) 0)
       (>= (+ it18938 (* it18939 2) (* it18937 (- 1)) 3) 0)
       (>= a!2 (+ 0 0))
       (>= (+ it18935 (- 12)) 0)
       (>= (+ (* it18935 (- 1)) 12) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it18938 (- 1)) (* it18939 (- 2)) it18937 (- 3)) 0)))))
(check-sat)
