...
(assert (let ((a!1 (> (+ (* (exp it418 2) (+ 0 (- 1)))
      ...
      (a!2 (> (+ (* (exp it418 2) (+ 0 (- 4)))
                 ...
                 (* (exp it420 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!3 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it418 2)))
      (a!4 (* (* (exp it420 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!6 (* (* (+ 0 it419) (exp 9 (+ it107 (- 1)))) (+ 0 3)))
      (a!7 (* (* (exp it420 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3)))))
(let ((a!5 (+ (* (exp it420 5) (+ 0 (- 1)))
              (* (+ 0 it419) (exp 9 (+ it107 (- 1))))
              (* a!3 (+ 0 (- 1)))
              a!4
              (exp it420 3)))
      (a!8 (> (+ (* (exp it420 5) (+ 0 (- 1)))
