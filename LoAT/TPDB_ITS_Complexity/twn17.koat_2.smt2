...
(assert (let ((a!1 (< (+ (+ 0 (* it157 (- 1))) (exp it156 2) (exp it158 5)) (+ 0 0))))
  (and (> it156 0) (= (+ it153 (- 3)) 0) a!1)))
(assert (= (+ it160 (- 3)) 0))
(assert (= (+ (* it154 (- 1)) it161 (- 1)) 0))
(assert (= (+ it162 (* it155 (- 1))) 0))
(assert (= (+ (* it156 2) it163) 0))
(assert (= (+ (* (exp it158 3) (+ 0 2)) (+ 0 (* it157 (- 3))) (+ 0 it164))
   (+ 0 0)))
(assert (= (+ (* it158 (- 1)) it165) 0))
(assert (= (+ (* it159 (- 1)) it166) 0))
(assert (let ((a!1 (> (+ (* (exp it163 2) (+ 0 (- 1)))
                 (+ 0 it164)
                 (* (exp it165 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (> (+ (* (exp it165 3) (+ 0 (- 2)))
                 ...
                 (* (exp it165 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!3 (* (exp it163 2) (exp (exp 4 (+ it57 (- 1))) (+ 0 2))))
      (a!4 (* (* (exp 9 (+ it57 (- 1))) (+ 0 it164)) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it57 (- 1))) (exp it165 3)) (+ 0 (- 3))))
      (a!7 (* (* (exp 9 (+ it57 (- 1))) (exp it165 3)) (+ 0 (- 1)))))
(let ((a!6 (> (+ (* a!3 (+ 0 (- 4)))
                 (exp it165 3)
                 a!4
                 a!5
