...
(assert (= (+ it405 (- 26)) 0))
(assert (= (+ it415 (- 20)) 0))
(assert (= (+ (* it406 (- 1)) it416 (- 1)) 0))
(assert (= (+ (* it407 (- 1)) it417) 0))
(assert (= (+ it418 (* it408 (- 1))) 0))
(assert (= (+ it419 (* it408 (- 1))) 0))
(assert (= (+ (* it410 (- 1)) it420) 0))
(assert (= (+ (* it411 (- 1)) it421) 0))
(assert (and (>= (+ it418 (* it419 (- 2)) (* it420 (- 1)) (- 3)) 0)
     (>= (+ it415 (- 20)) 0)
     (>= (+ it418 it420 3) 0)
     (>= (+ (* it415 (- 1)) 20) 0)
     (>= (+ it50 (- 1)) 0)
     (>= (+ (* it418 (- 1)) (* it420 (- 1)) (- 3)) 0)
     (>= (+ (* it418 (- 1)) (* it419 2) it420 3) 0)))
(check-sat)
