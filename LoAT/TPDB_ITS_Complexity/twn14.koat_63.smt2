...
(assert (let ((a!1 (* (* (exp 81 (+ it453 (- 1))) (exp it693 3)) (+ 0 (- 1))))
      (a!2 (* (exp (exp 16 (+ it453 (- 1))) (+ 0 2)) (exp it691 2)))
      (a!4 (> (+ (+ 0 it692)
                 (* (exp it691 2) (+ 0 (- 1)))
                 (* (exp it693 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 81 (+ it453 (- 1))) (exp it693 3)) (+ 0 (- 27))))
      (a!6 (* (* (+ 0 it692) (exp 81 (+ it453 (- 1)))) (+ 0 27)))
      (a!8 (* (* (exp 81 (+ it453 (- 1))) (exp it693 3)) (+ 0 (- 3))))
      (a!9 (* (* (+ 0 it692) (exp 81 (+ it453 (- 1)))) (+ 0 3)))
      (a!11 (* (* (exp 81 (+ it453 (- 1))) (exp it693 3)) (+ 0 (- 9))))
      (a!12 (* (* (+ 0 it692) (exp 81 (+ it453 (- 1)))) (+ 0 9)))
      (a!14 (> (+ (+ 0 (* it692 3))
                  (* (exp it693 3) (+ 0 (- 2)))
                  (* (exp it691 2) (+ 0 (- 4)))
                  (* (exp it693 5) (+ 0 (- 1))))
