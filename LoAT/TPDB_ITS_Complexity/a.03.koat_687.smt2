...
(assert (let ((a!1 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 1))
      (a!3 (>= (+ (+ (* it88 (- 1)) it2573) (- 2)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 0)))
  (and a!1
       (>= (+ it2572 (- 1)) 0)
       (>= (+ (* it2570 (- 1)) 3) 0)
       (>= a!2 0)
       ...
       (>= (+ it2573 (- 3)) 0)
       (>= (+ it2570 (- 3)) 0))))
(assert (= (+ it2633 (* it2570 (- 1))) 0))
(assert (= (+ (* it88 (- 3)) it2634 (* it2571 (- 1))) 0))
(assert (= (+ it2635 (* it2572 (- 1))) 0))
(assert (= (+ it88 it2636 (* it2573 (- 1))) 0))
(assert (= (+ it2637 (* it2572 (- 1))) 0))
(assert (= (+ it2638 (* it2572 (- 2))) 0))
(assert (let ((a!1 (+ (+ (+ it2636 (* it706 (- 1))) (* it540 (- 1))) (- 2)))
      (a!2 (>= (+ (+ it2636 (* it706 (- 1))) (- 3)) 0))
      (a!3 (+ it2636 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!4 (+ it2636
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it540 (+ it1243 (- 1)) (- 1))))
      (a!5 (+ (+ it2636 (* it706 (- 1))) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!7 (>= (+ (+ it2636 (* it2635 (- 2))) (- 1)) 0))
      (a!8 (+ (+ (+ it2636 (* it706 (- 1))) (* it540 (- 1)))
              (* it2635 (- 2))
              (- 1)))
      (a!9 (>= (+ (+ it2636 (* it706 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it2636 (* it2638 (- 1))) (- 1)) 0))
      (a!12 (+ (+ (+ it2636 (* it706 (- 1))) (* it2635 (- 2))) (- 1)))
      (a!14 (+ (+ (+ it2636 (* it706 (- 1))) (* it2635 (- 2))) (- 2)))
      (a!16 (>= (+ (+ it2636 (* it2635 (- 2))) (- 2)) 0)))
(let ((a!6 (+ (+ a!5 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!11 (+ (+ a!5 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!13 (+ a!5 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1))))
      (a!15 (+ (+ a!5 (* it540 (+ it1243 (- 1)) (- 1))) (* it2635 (- 2)))))
  (and (>= (+ it1243 (- 1)) 0)
       (>= a!1 0)
       a!2
       (>= (+ a!3 (- 2)) 0)
