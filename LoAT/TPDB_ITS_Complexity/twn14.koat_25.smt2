...
(assert (let ((a!1 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it371 2)))
      (a!2 (* (* (exp 9 (+ it82 (- 1))) (exp it373 3)) (+ 0 (- 3))))
      (a!3 (* (* (exp 9 (+ it82 (- 1))) (+ 0 it372)) (+ 0 3)))
      (a!5 (> (+ (+ 0 it372)
                 (* (exp it371 2) (+ 0 (- 1)))
                 (* (exp it373 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it82 (- 1))) (exp it373 3)) (+ 0 (- 1))))
      (a!8 (> (+ (* (exp it373 3) (+ 0 (- 2)))
                 (+ 0 (* it372 3))
                 (* (exp it371 2) (+ 0 (- 4)))
                 (* (exp it373 5) (+ 0 (- 1))))
