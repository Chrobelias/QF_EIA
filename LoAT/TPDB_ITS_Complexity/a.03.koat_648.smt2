...
(assert (let ((a!1 (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606)
              (* it706 (+ it1243 (- 1)) (- 1))))
      (a!3 (>= (+ (+ (* it706 (- 1)) it2606) (* it540 (- 1)) (- 2)) 0))
      (a!4 (+ (* it1552 (- 1))
              (* (+ it1552 (- 1)) it540 it1243 (- 1))
              (* (+ it1552 (- 1)) it706 it1243 (- 1))))
      (a!9 (>= (+ (+ (* it706 (- 1)) it2606) (- 2)) 0))
      (a!12 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606) (- 2)) 0))
      (a!13 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606) (- 1)) 0))
      (a!17 (>= (+ (+ (* it2605 (- 2)) it2606)
                   (* it706 (+ it1243 (- 1)) (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   (- 2))
                0))
      (a!19 (>= (+ (+ (* it2608 (- 1)) it2606) (- 1)) 0))
      (a!21 (>= (+ it2606
                   (* it706 (+ it1243 (- 1)) (- 1))
                   (* it540 (+ it1243 (- 1)) (- 1))
                   (- 3))
                0))
      (a!22 (+ (+ (* it706 (- 1)) it2606) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!24 (+ it2606 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!31 (>= (+ (+ (* it2605 (- 2)) (* it706 (- 1)) it2606)
                   (* it540 (- 1))
                   (- 1))
                0))
      (a!32 (>= (+ (+ (* it2605 (- 2)) it2606) (- 2)) 0))
      (a!33 (>= (+ (+ (* it2605 (- 2)) it2606) (- 1)) 0))
      (a!35 (>= (+ (+ (* it706 (- 1)) it2606) (- 3)) 0)))
(let ((a!2 (>= (+ a!1 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1)) (- 1)) 0))
      (a!5 (+ (+ a!4 (* it2605 (- 2))) (* it706 (- 1)) it2606))
      (a!7 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1))) (- 1)))
      (a!8 (>= (+ (+ a!4 (* it706 (- 1)) it2606) (* it540 (- 1)) (- 1)) 0))
      (a!10 (+ (+ a!4 (* it706 (- 1)) it2606) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!14 (+ (+ (+ a!4 (* it2605 (- 2))) it2606)
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it540 (+ it1243 (- 1)) (- 1))
               (- 1)))
      (a!15 (>= (+ (+ a!4 it2606)
      ...
      (a!16 (+ (+ a!4 it2606)
               (* (* it540 it1243) (- 1))
               (* (* it706 it1243) (- 1))))
      (a!18 (>= (+ (+ a!4 (* it706 (- 1)) it2606) (- 2)) 0))
      (a!23 (+ (+ a!22 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!25 (+ (+ a!1 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!27 (+ (+ (+ a!4 (* it2605 (- 2))) it2606) (- 1)))
      (a!29 (>= (+ (+ a!4 (* it2605 (- 2))) it2606) 0))
      (a!30 (+ (+ a!22 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!34 (>= (+ (+ a!4 (* it706 (- 1)) it2606) (- 1)) 0))
      (a!36 (>= (+ a!22 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1)) (- 2))
                0)))
(let ((a!6 (+ (+ a!5 (* it706 (+ it1243 (- 1)) (- 1)))
              (* it540 (+ it1243 (- 1)) (- 1))))
      (a!11 (>= (+ a!10 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1)) (- 1))
                0))
      (a!20 (+ (+ a!5 (* it706 (+ it1243 (- 1)) (- 1)))
               (* it540 (- 1))
               (* it540 (+ it1243 (- 1)) (- 1))))
      (a!26 (+ (+ a!10 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!28 (+ (+ a!10 (* it540 (+ it1243 (- 1)) (- 1))) (- 1))))
  (and (= (+ it2605 (- 1)) 0)
       a!2
       a!3
       (>= (+ it1243 (- 1)) 0)
