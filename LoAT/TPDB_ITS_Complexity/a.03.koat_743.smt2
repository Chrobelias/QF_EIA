...
(assert (let ((a!1 (+ (+ (+ (* it2712 (- 1)) it2741) (* it2740 (- 2))) 1))
      (a!2 (+ (+ (+ (* it2712 (- 1)) it2741) (* it2740 (- 2))) (- 1)))
      (a!3 (>= (+ (+ (* it2712 (- 1)) it2741) (- 3)) 0))
      (a!4 (+ (+ (* it2712 (- 1)) (* it2725 (- 1)) it2741) (* it2740 (- 2))))
      (a!5 (>= (+ (+ it2741 (* it2743 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ (* it2712 (- 1)) it2741) (* it2740 (- 2))) 0))
      (a!7 (>= (+ (+ (* it2712 (- 1)) it2741) (- 2)) 0))
      (a!8 (>= (+ (+ (* it2712 (- 1)) (* it2725 (- 1)) it2741) (- 2)) 0)))
  (and (>= (+ it2725 (- 1)) 0)
       (>= (+ (* it2740 (- 1)) 1) 0)
       (= (+ it2712 it2725) 0)
       (>= a!1 0)
