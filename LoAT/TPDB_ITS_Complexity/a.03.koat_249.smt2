...
(assert (let ((a!1 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1))) it841 (- 2)) 0))
      (a!2 (>= (+ (+ (* it840 (- 2)) it841) (- 2)) 0))
      (a!3 (>= (+ (+ (* it795 (- 1)) (* it840 (- 2)) it841) (- 2)) 0))
      (a!4 (>= (+ (+ (* it795 (- 1)) (* it840 (- 2)) it841) (- 1)) 0))
      (a!5 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1)))
                  (* it840 (- 2))
                  it841
                  (- 1))
               0))
      (a!6 (>= (+ (+ (* it795 (- 1)) it841) (- 3)) 0))
      (a!7 (>= (+ (+ (* it795 (- 1)) it841) (- 2)) 0))
      (a!8 (>= (+ (+ (* it840 (- 2)) it841) (- 1)) 0)))
  (and a!1
       (= 0 0)
       a!2
       a!3
