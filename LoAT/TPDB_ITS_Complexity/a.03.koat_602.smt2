...
(assert (let ((a!1 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      ...
      (a!3 (>= (+ (+ (* it88 (- 1)) it2573) (- 3)) 0))
      (a!4 (+ (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 1))
      (a!5 (>= (+ (+ (* it88 (- 1)) it2573) (* it2572 (- 2))) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) it2573) (- 2)) 0))
      (a!7 (+ (+ (+ (* it88 (- 1)) it2573) (* it19 (- 1))) (- 2)))
      (a!8 (+ (+ (+ (* it88 (- 1)) it2573) (* it19 (- 1))) (* it2572 (- 2)))))
  (and (>= (+ it2573 (- 3)) 0)
       (= 0 0)
       (>= (+ it19 (- 1)) 0)
       (= (+ it88 it19) 0)
