...
(assert (let ((a!1 (>= (+ (+ (* it871 (- 2)) it872)
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!2 (>= (+ (+ (* it871 (- 2)) (* it795 (- 1)) it872) (- 2)) 0))
      (a!3 (>= (+ (+ (* it871 (- 2)) (* it795 (- 1)) it872) (- 1)) 0))
      (a!4 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1)) it872)
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!5 (+ (* it785 (- 1)) (* it871 (- 2)) (* it795 (- 1)) it872))
      (a!7 (+ (+ (* it871 (- 2)) (* it795 (- 1)) it872)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!8 (+ (+ (* it795 (- 1)) it872)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!9 (>= (+ (+ (* it874 (- 1)) it872) (- 1)) 0))
      (a!10 (>= (+ (+ (* it795 (- 1)) it872) (- 3)) 0))
      (a!11 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1)) it872) (- 2)) 0))
      (a!12 (>= (+ it872
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 3))
                0))
      (a!13 (>= (+ (+ (* it871 (- 2)) it872) (- 1)) 0))
      (a!14 (>= (+ (+ (* it871 (- 2)) it872) (- 2)) 0))
      (a!15 (+ it872 (* (* it785 it784) (- 1)) (* (* it795 it784) (- 1))))
      (a!16 (>= (+ (+ (* it795 (- 1)) it872) (- 2)) 0)))
(let ((a!6 (>= (+ a!5
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 1))
