...
(assert (and (= (+ (* it2608 (- 1)) it2606) 0)
     (= (+ it2603 (- 3)) 0)
     (>= (+ it2608 (- 1)) 0)))
(assert (= (+ it2614 (- 3)) 0))
(assert (= (+ it2615 (* it2604 (- 1)) (- 1)) 0))
(assert (= (+ (* it2605 (- 1)) it2616) 0))
(assert (= (+ it2617 (* it2606 (- 1))) 0))
(assert (= (+ (* it2608 (- 1)) it2618) 0))
(assert (= (+ (* it2608 (- 2)) it2619) 0))
(check-sat)
