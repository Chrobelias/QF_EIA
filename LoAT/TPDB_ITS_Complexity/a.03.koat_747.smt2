...
(assert (let ((a!1 (+ (+ (* it2725 (- 1)) it2741)
              (* (* it540 it716) (- 1))
              (* (* it706 it716) (- 1))))
      (a!2 (>= (+ (+ (* it2725 (- 1)) it2741) (* it2740 (- 2))) 0))
      (a!3 (+ (* it2725 (- 1))
              (* (+ it716 (- 1)) it540 (- 1))
              it2741
              (* it706 (+ it716 (- 1)) (- 1))))
      (a!5 (+ (+ (* it2725 (- 1)) it2741) (* it706 (- 1)) (* it540 (- 1))))
      (a!6 (+ (+ (+ (* it2725 (- 1)) it2741) (* it2740 (- 2))) (- 1)))
      (a!7 (>= (+ (+ (* it2725 (- 1)) it2741) (- 2)) 0))
      (a!8 (+ (+ (+ (* it2725 (- 1)) it2741) (* it540 (- 1))) (- 3)))
      (a!9 (+ (+ (+ (* it2725 (- 1)) it2741) (* it540 (- 1))) (* it2740 (- 2))))
      (a!11 (+ (+ (+ (* it2725 (- 1)) it2741) (* it2740 (- 2))) (- 2)))
      (a!15 (>= (+ (+ (* it2725 (- 1)) it2741) (- 3)) 0))
      (a!16 (>= (+ (+ it2741 (* it2743 (- 1))) (- 1)) 0))
      (a!17 (+ (+ (+ (* it2725 (- 1)) it2741) (* it2740 (- 2))) 1))
      (a!19 (+ (+ (+ (* it2725 (- 1)) it2741) (* it540 (- 1))) (- 2))))
(let ((a!4 (>= (+ (+ a!3 (* it706 (- 1)) (* it540 (- 1)))
                  (* it2740 (- 2))
                  (- 1))
               0))
      (a!10 (+ (+ (+ a!3 (* it540 (- 1))) (* it2740 (- 2))) (- 2)))
      (a!12 (>= (+ (+ a!3 (* it706 (- 1)) (* it540 (- 1))) (- 2)) 0))
      (a!13 (+ (+ (+ a!3 (* it540 (- 1))) (* it2740 (- 2))) (- 1)))
      (a!14 (>= (+ (+ a!3 (* it540 (- 1))) (- 2)) 0))
      (a!18 (>= (+ (+ a!3 (* it540 (- 1))) (- 3)) 0)))
  (and (= (+ (* it2740 (- 2)) it2743) 0)
       (>= (+ a!1 (- 3)) 0)
       a!2
       (>= (+ (* it2738 (- 1)) 3) 0)
       (<= (+ it2725 (* it540 it716) (* it706 it716) 1) 0)
       (>= (+ it540 (- 1)) 0)
       a!4
       (= (+ it2725 (* it540 it716) (* it706 it716) 1) 0)
       (>= (+ a!5 (- 2)) 0)
