...
(assert (let ((a!1 (* (* (exp 9 (+ it107 (- 1))) (+ 0 it370)) (+ 0 3)))
      (a!2 (* (exp (exp 4 (+ it107 (- 1))) (+ 0 2)) (exp it369 2)))
      (a!3 (* (* (exp it371 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 3))))
      (a!5 (* (* (exp it371 3) (exp 9 (+ it107 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it371 5) (+ 0 (- 1)))
                 (* (exp it369 2) (+ 0 (- 1)))
                 (+ 0 it370))
              (+ 0 0)))
