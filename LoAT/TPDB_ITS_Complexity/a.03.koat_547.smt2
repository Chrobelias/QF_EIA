...
(assert (let ((a!1 (+ (* (+ it716 (- 1)) it2537 (- 1)) (* it706 (+ it716 (- 1)) (- 1))))
      (a!3 (+ (+ (+ (* it2542 (- 2)) it2543) (* it2537 (- 1))) (- 1)))
      (a!4 (+ (* (* it2537 it716) (- 1)) it2543 (* (* it706 it716) (- 1))))
      (a!5 (>= (+ (+ it2543 (* it2537 (- 1))) (- 3)) 0))
      (a!6 (+ (+ (+ (* it2542 (- 2)) it2543) (* it2537 (- 1))) (- 2)))
      (a!9 (>= (+ (+ (* it2545 (- 1)) it2543) (- 1)) 0))
      (a!10 (>= (+ (+ it2543 (* it2537 (- 1))) (- 2)) 0))
      (a!12 (>= (+ (+ (* it2542 (- 2)) it2543) (- 1)) 0))
      (a!13 (>= (+ (+ (* it2542 (- 2)) it2543) (- 2)) 0)))
(let ((a!2 (+ (+ (+ a!1 (* it2542 (- 2))) it2543) (- 2)))
      (a!7 (+ (+ (+ a!1 (* it2542 (- 2))) it2543) (* it2537 (- 1))))
      (a!8 (>= (+ (+ a!1 (* it2542 (- 2)))
                  (* it706 (- 1))
                  it2543
                  (* it2537 (- 1))
                  (- 1))
               0))
      (a!11 (>= (+ (+ (+ a!1 it2543) (* it2537 (- 1))) (- 3)) 0))
      (a!14 (>= (+ (+ (+ a!1 it2543) (* it2537 (- 1))) (- 2)) 0)))
  (and (>= (+ (* it2540 (- 1)) 3) 0)
       (>= a!2 0)
       (= 0 0)
       (>= (+ it2540 (- 3)) 0)
       ...
       a!9
       a!10
       (>= (+ a!1 (* it706 (- 1)) it2543 (* it2537 (- 1)) (- 2)) 0)
       a!11
       a!12
       a!13
       a!14
