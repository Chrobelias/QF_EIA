...
(assert (let ((a!1 (* (exp (exp 16 (+ it452 (- 1))) (+ 0 2)) (exp it644 2)))
      (a!2 (* (* (exp it646 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (+ 0 it645) (exp 81 (+ it452 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp it646 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 3))))
      (a!7 (> (+ (* (exp it644 2) (+ 0 (- 4)))
                 (* (exp it646 5) (+ 0 (- 1)))
                 (+ 0 (* it645 3))
                 (* (exp it646 3) (+ 0 (- 2))))
      ...
      (a!8 (> (+ (* (exp it644 2) (+ 0 (- 1)))
                 ...
                 (+ 0 it645))
              (+ 0 0)))
      (a!9 (* (* (+ 0 it645) (exp 81 (+ it452 (- 1)))) (+ 0 9)))
      (a!10 (* (* (exp it646 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 9))))
      (a!12 (> (+ (* (exp it644 2) (+ 0 (- 16)))
                  (* (exp it646 5) (+ 0 (- 1)))
                  (+ 0 (* it645 9))
                  (* (exp it646 3) (+ 0 (- 8))))
               (+ 0 0)))
      (a!13 (* (* (+ 0 it645) (exp 81 (+ it452 (- 1)))) (+ 0 27)))
      (a!14 (* (* (exp it646 3) (exp 81 (+ it452 (- 1)))) (+ 0 (- 27)))))
(let ((a!3 (+ (* (exp it646 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (* (+ 0 it645) (exp 81 (+ it452 (- 1))))
              a!2
              (exp it646 3)))
      (a!6 (> (+ (* (exp it646 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
