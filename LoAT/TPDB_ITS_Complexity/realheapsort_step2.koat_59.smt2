...
(assert (and (>= (+ it67 (* it68 (- 1)) (* it69 (- 2)) (- 3)) 0) (= (+ it65 (- 7)) 0)))
(assert (= (+ it142 (- 8)) 0))
(assert (= (+ it143 (* it66 (- 1)) (- 1)) 0))
(assert (= (+ (* it67 (- 1)) it144) 0))
(assert (= (+ it145 (* it68 (- 1))) 0))
(assert (= (+ it146 (* it69 (- 1))) 0))
(assert (= (+ (* it70 (- 1)) it147) 0))
(assert (and (>= (+ (* it145 (- 1)) (* it146 (- 2)) it144 (- 4)) 0)
     (= (+ it142 (- 8)) 0)))
(assert (= (+ it150 (- 11)) 0))
(assert (= (+ (* it143 (- 1)) it151 (- 1)) 0))
(assert (= (+ it152 (* it144 (- 1))) 0))
(assert (= (+ (* it145 (- 1)) it153) 0))
(assert (= (+ (* it146 (- 1)) it154) 0))
(assert (= (+ it155 (* it147 (- 1))) 0))
(assert (= (+ it150 (- 11)) 0))
(assert (= (+ it158 (- 13)) 0))
(assert (= (+ it159 (* it151 (- 1)) (- 2)) 0))
(assert (= (+ (* it152 (- 1)) it160) 0))
(assert (= (+ it161 (* it153 (- 1))) 0))
(assert (= (+ it162 (* it154 (- 1))) 0))
(assert (= (+ it163 (* it154 (- 2)) (- 2)) 0))
(assert (= (+ it158 (- 13)) 0))
(assert (= (+ it166 (- 7)) 0))
(assert (= (+ it167 (* it159 (- 1)) (- 2)) 0))
(assert (= (+ it168 (* it160 (- 1))) 0))
(assert (= (+ (* it161 (- 1)) it169) 0))
(assert (= (+ (* it163 (- 1)) it170) 0))
(assert (= (+ it171 (* it163 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it168 (* it169 (- 1)) (* it170 (- 2))) (- 4)) 0))
      (a!2 (>= (+ (+ (* it168 (- 1)) (* it169 (- 1))) (- 3)) 0))
      (a!3 (>= (+ (+ (* it168 (- 1)) (* it169 (- 1))) (- 4)) 0))
      (a!4 (>= (+ (+ it168 (* it169 (- 1)) (* it170 (- 2))) (- 3)) 0)))
  (and a!1
       a!2
       a!3
       a!4
