...
(assert (= (+ it784 (- 26)) 0))
(assert (= (+ it854 (- 20)) 0))
(assert (= (+ (* it785 (- 1)) it855 (- 1)) 0))
(assert (= (+ (* it786 (- 1)) it856) 0))
(assert (= (+ (* it787 (- 1)) it857) 0))
(assert (= (+ (* it787 (- 1)) it858) 0))
(assert (= (+ it859 (* it789 (- 1))) 0))
(assert (= (+ (* it790 (- 1)) it860) 0))
(assert (and (= (+ it854 (- 20)) 0) (> (+ it859 (* it857 (- 1)) (* it858 2) 3) 0)))
(assert (= (+ it866 (- 18)) 0))
(assert (= (+ it867 (* it855 (- 1)) (- 4)) 0))
(assert (= (+ it868 (* it859 (- 1)) (- 1)) 0))
(assert (= (+ it869 (* it857 (- 1))) 0))
(assert (= (+ it870 (* it858 (- 1))) 0))
(assert (= (+ it871 (* it859 (- 1)) (- 1)) 0))
(assert (= (+ it872 (* it860 (- 1))) 0))
(assert (and (<= (+ it871 (* it869 (- 1)) 2) 0) (= (+ it866 (- 18)) 0)))
(assert (= (+ it877 (- 20)) 0))
(assert (= (+ it878 (* it867 (- 1)) (- 2)) 0))
(assert (= (+ (* it868 (- 1)) it879) 0))
(assert (= (+ (* it869 (- 1)) it880) 0))
(assert (= it881 0))
(assert (= (+ (* it871 (- 1)) it882) 0))
(assert (= (+ (* it872 (- 1)) it883) 0))
(assert (and (>= (+ (* it877 (- 1)) 20) 0)
     (>= (+ it50 (- 1)) 0)
     (>= (+ (* it882 (- 1)) (* it880 (- 1)) (- 3)) 0)
     (>= (+ (* it881 (- 2)) (* it882 (- 1)) it880 (- 3)) 0)
     (>= (+ (* it881 2) it882 (* it880 (- 1)) 3) 0)
     (>= (+ it882 it880 3) 0)
     (>= (+ it877 (- 20)) 0)))
(check-sat)
