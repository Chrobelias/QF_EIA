...
(declare-fun it6264 () Int)
(declare-fun it6265 () Int)
(declare-fun it6268 () Int)
(declare-fun it6269 () Int)
(declare-fun it6270 () Int)
(declare-fun it6271 () Int)
(declare-fun it6272 () Int)
(declare-fun it6273 () Int)
(declare-fun it6276 () Int)
(declare-fun it6277 () Int)
(declare-fun it6278 () Int)
(declare-fun it6279 () Int)
(declare-fun it6280 () Int)
(declare-fun it6281 () Int)
...
(assert (= (+ it6260 (- 13)) 0))
(assert (= (+ (* it6226 (- 1)) it6261 (- 1)) 0))
(assert (= (+ it6262 (* it6227 (- 1))) 0))
(assert (= (+ (* it6228 (- 1)) it6263) 0))
(assert (= (+ (* it6229 (- 1)) it6264) 0))
(assert (= (+ (* it6230 (- 1)) it6265) 0))
(assert (and (= (+ it6262 (* it6263 (- 1)) (* it6264 (- 2)) (- 3)) 0)
     (= (+ it6260 (- 13)) 0)))
(assert (= (+ it6268 (- 18)) 0))
(assert (= (+ it6269 (* it6261 (- 1)) (- 2)) 0))
(assert (= (+ (* it6262 (- 1)) it6270) 0))
(assert (= (+ (* it6263 (- 1)) it6271) 0))
(assert (= (+ it6272 (* it6264 (- 1))) 0))
(assert (= (+ it6273 (* it6264 (- 2)) (- 1)) 0))
(assert (= (+ it6268 (- 18)) 0))
(assert (= (+ it6276 (- 12)) 0))
(assert (= (+ (* it6269 (- 1)) it6277 (- 2)) 0))
(assert (= (+ (* it6270 (- 1)) it6278) 0))
(assert (= (+ it6279 (* it6271 (- 1))) 0))
(assert (= (+ (* it6273 (- 1)) it6280) 0))
(assert (= (+ (* it6273 (- 1)) it6281) 0))
(assert (and (>= (+ it6279 (* it6280 2) (* it6278 (- 1)) 3) 0)
     (>= (+ it6259 (- 1)) 0)
     (>= (+ (* it6279 (- 1)) (* it6280 (- 2)) it6278 (- 3)) 0)
     (>= (+ (* it6279 (- 1)) (* it6278 (- 1)) (- 3)) 0)
     (>= (+ it6279 it6278 3) 0)
     (>= (+ it6276 (- 12)) 0)
     (>= (+ (* it6276 (- 1)) 12) 0)))
(check-sat)
