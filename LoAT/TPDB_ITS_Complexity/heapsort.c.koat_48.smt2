...
(assert (and (> (+ (* it357 (- 1)) it352) 0) (= (+ it348 (- 17)) 0)))
(assert (= (+ it360 (- 22)) 0))
(assert (= (+ it361 (* it349 (- 1)) (- 1)) 0))
(assert (= (+ it362 (* it350 (- 1))) 0))
(assert (= (+ it363 (* it351 (- 1))) 0))
(assert (= (+ it364 (* it352 (- 1))) 0))
(assert (= (+ it365 (* it353 (- 1))) 0))
(assert (= (+ it366 (* it354 (- 1))) 0))
(assert (= (+ it367 (* it355 (- 1))) 0))
(assert (= (+ (* it355 (- 1)) it368) 0))
(assert (= (+ it369 (* it357 (- 1))) 0))
(assert (and (= (+ it360 (- 22)) 0) (= (+ it366 (* it368 (- 1))) 0)))
(assert (= (+ it372 (- 28)) 0))
(assert (= (+ it373 (* it361 (- 1)) (- 2)) 0))
(assert (= (+ (* it362 (- 1)) it374) 0))
(assert (= (+ it375 (* it363 (- 1))) 0))
(assert (= (+ it376 (* it364 (- 1))) 0))
(assert (= (+ (* it365 (- 1)) it377) 0))
(assert (= (+ it378 (* it366 (- 1))) 0))
(assert (= (+ it379 (* it367 (- 1))) 0))
(assert (= (+ it380 (* it368 (- 1))) 0))
(assert (= (+ it381 (* it369 (- 1))) 0))
(check-sat)
