...
(assert (and (= (+ it110 (- 5)) 0)
     ...
     (>= (+ it113 (- 2)) 0)))
(assert (= (+ it164 (- 5)) 0))
(assert (= (+ (* it111 (- 1)) it165 (- 1)) 0))
(assert (= (+ (* it112 (- 1)) it166) 0))
(assert (= (+ it167 (* it113 (- 2))) 0))
(assert (= (+ (* it114 (- 1)) it168) 0))
(assert (= (+ (* it115 (- 1)) it169) 0))
(assert (= (+ (* it116 (- 1)) it170) 0))
(assert (= (+ (* it117 (- 1)) it171) 0))
(assert (and (<= it167 0)
     (>= (+ (* it171 (- 1)) it166) 0)
     (>= (+ (* it167 (- 1)) it169 (- 1)) 0)
     (>= (+ it171 (* it166 (- 1))) 0)
