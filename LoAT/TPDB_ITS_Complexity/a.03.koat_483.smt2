...
(assert (let ((a!1 (+ (* (exp 2 (+ it129 1)) (+ 0 (- 1)))
              ...
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ it1569 (* it1568 (- 2))) (- 1)) 0))
      (a!2 (+ (+ (+ it1569 (* it706 (- 1))) (* it1568 (- 2))) (- 1)))
      (a!3 (+ (+ it1569 (* it706 (- 1))) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!5 (+ it1569
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it540 (+ it1243 (- 1)) (- 1))))
      (a!6 (>= (+ (+ it1569 (* it1571 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it1569 (* it1568 (- 2))) (- 2)) 0))
      (a!9 (+ it1569 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!10 (+ (+ (+ it1569 (* it706 (- 1))) (* it540 (- 1))) (- 2)))
      (a!11 (>= (+ (+ it1569 (* it706 (- 1))) (- 3)) 0))
      (a!13 (+ (+ (+ it1569 (* it706 (- 1))) (* it540 (- 1)))
               (* it1568 (- 2))
               (- 1)))
      (a!14 (>= (+ (+ it1569 (* it706 (- 1))) (- 2)) 0))
      (a!16 (+ (+ (+ it1569 (* it706 (- 1))) (* it1568 (- 2))) (- 2))))
(let ((a!4 (+ a!3 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1))))
      (a!7 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (* it1568 (- 2))))
      (a!12 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!15 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 2))))
  (and a!1
       (= (+ it1571 (* it1568 (- 2))) 0)
       (>= a!2 0)
       (>= (+ it1569 (- 2)) 0)
