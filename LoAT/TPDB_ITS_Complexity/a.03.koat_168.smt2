...
(assert (let ((a!1 (>= (+ (+ (* it680 (- 1)) it678) (- 1)) 0)))
  (and (= (+ it675 (- 3)) 0) (>= (+ (* it680 (- 1)) it678) 0) a!1)))
(assert (= (+ it698 (- 4)) 0))
(assert (= (+ it699 (* it676 (- 1)) (- 1)) 0))
(assert (= (+ (* it677 (- 1)) it700) 0))
(assert (= (+ (* it678 (- 1)) it701) 0))
(assert (= (+ it702 (* it679 (- 1))) 0))
(assert (= (+ (* it680 (- 1)) it703) 0))
(assert (let ((a!1 (>= (+ (+ (* it700 (- 2)) it701) (- 2)) 0))
      (a!2 (>= (+ (+ (* it700 (- 2)) it701) (- 1)) 0)))
  (and (>= (+ it701 (- 2)) 0)
       (>= (+ (* it698 (- 1)) 4) 0)
       (>= (+ it698 (- 4)) 0)
       (= 0 0)
