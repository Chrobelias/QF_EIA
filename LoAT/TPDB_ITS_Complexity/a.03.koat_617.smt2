...
(assert (let ((a!1 (>= (+ (+ it2589 (* it2591 (- 1))) (- 1)) 0))
      (a!2 (+ it2589 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!3 (+ (+ it2589 (* it706 (- 1))) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!5 (>= (+ (+ it2589 (* it706 (- 1))) (- 3)) 0))
      (a!6 (+ (+ (+ it2589 (* it706 (- 1))) (* it2588 (- 2))) (- 1)))
      (a!8 (>= (+ (+ it2589 (* it2588 (- 2))) (- 2)) 0))
      (a!10 (+ (+ (+ it2589 (* it706 (- 1))) (* it2588 (- 2))) (- 2)))
      (a!11 (+ it2589
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it540 (+ it1243 (- 1)) (- 1))))
      (a!13 (+ (+ (+ it2589 (* it706 (- 1))) (* it540 (- 1)))
               (* it2588 (- 2))
               (- 1)))
      (a!14 (>= (+ (+ it2589 (* it706 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it2589 (* it2588 (- 2))) (- 1)) 0))
      (a!16 (+ (+ (+ it2589 (* it706 (- 1))) (* it540 (- 1))) (- 2))))
(let ((a!4 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 3)))
      (a!7 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (* it2588 (- 2))))
      (a!9 (+ a!3 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1))))
      (a!12 (+ (+ a!3 (* it540 (+ it1243 (- 1)) (- 1))) (- 2))))
  (and a!1
       (>= (+ a!2 (- 2)) 0)
       (>= (+ it1243 (- 1)) 0)
       (>= (+ (* it2586 (- 1)) 3) 0)
