...
(assert (let ((a!1 (>= (+ (+ it2573 (* it2572 (- 2))) (- 2)) 0))
      (a!2 (+ (+ (+ it2573 (* it706 (- 1))) (* it540 (- 1)))
              (* it2572 (- 2))
              (- 1)))
      (a!3 (+ it2573 (* (* it540 it1243) (- 1)) (* (* it706 it1243) (- 1))))
      (a!4 (+ (+ it2573 (* it706 (- 1))) (* it706 (+ it1243 (- 1)) (- 1))))
      (a!6 (>= (+ (+ it2573 (* it706 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ it2573 (* it2575 (- 1))) (- 1)) 0))
      (a!9 (+ (+ (+ it2573 (* it706 (- 1))) (* it2572 (- 2))) (- 2)))
      (a!10 (+ (+ (+ it2573 (* it706 (- 1))) (* it2572 (- 2))) (- 1)))
      (a!11 (+ (+ (+ it2573 (* it706 (- 1))) (* it540 (- 1))) (- 2)))
      (a!12 (>= (+ (+ it2573 (* it706 (- 1))) (- 3)) 0))
      (a!13 (>= (+ (+ it2573 (* it2572 (- 2))) (- 1)) 0))
      (a!14 (+ it2573
               (* it706 (+ it1243 (- 1)) (- 1))
               (* it540 (+ it1243 (- 1)) (- 1)))))
(let ((a!5 (+ a!4 (* it540 (- 1)) (* it540 (+ it1243 (- 1)) (- 1))))
      (a!7 (+ (+ a!4 (* it540 (+ it1243 (- 1)) (- 1))) (* it2572 (- 2))))
      (a!15 (+ (+ a!4 (* it540 (+ it1243 (- 1)) (- 1))) (- 2)))
      (a!16 (+ (+ a!4 (* it540 (+ it1243 (- 1)) (- 1))) (- 3))))
  (and a!1
       (>= a!2 0)
       (>= (+ a!3 (- 3)) 0)
       (>= (+ it1243 (- 1)) 0)
