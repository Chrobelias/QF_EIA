...
(assert (let ((a!1 (> (+ (* (exp it418 2) (+ 0 (- 4)))
                 ...
                 (* (exp it420 3) (+ 0 (- 2))))
              (+ 0 0)))
      (a!2 (* (* (exp it420 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it418 2)))
      (a!5 (* (* (exp 9 (+ it152 (- 1))) (+ 0 it419)) (+ 0 3)))
      (a!6 (* (* (exp it420 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 3))))
      (a!8 (> (+ (* (exp it418 2) (+ 0 (- 1)))
                 (* (exp it420 5) (+ 0 (- 1)))
                 (+ 0 it419))
              (+ 0 0))))
(let ((a!4 (+ (* (exp it420 5) (+ 0 (- 1)))
              (* (exp 9 (+ it152 (- 1))) (+ 0 it419))
              a!2
              (exp it420 3)
              (* a!3 (+ 0 (- 1)))))
      (a!7 (> (+ (* (exp it420 5) (+ 0 (- 1)))
