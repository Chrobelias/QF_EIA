...
(assert (and (> 1 0)
     ...
     (>= (+ it1 (- 2)) 0)))
(assert (= (+ (* it1 (- 1)) it27) 0))
(assert (= (+ (* it2 (- 1)) (* it3 (- 1)) it28) 0))
(assert (= it29 0))
(assert (= (+ (* (+ 0 it4) (exp 2 it3) (+ 0 (- 1))) (+ 0 it30)) (+ 0 0)))
(assert (and (<= it29 0) (= (+ it27 (- 2)) 0)))
(assert (= (+ it38 (- 3)) 0))
(assert (= (+ it39 (* it28 (- 1)) (- 1)) 0))
(assert (= (+ (* it29 (- 1)) it40) 0))
(assert (= (+ it41 (* it30 (- 1))) 0))
(assert (and (= (+ it38 (- 3)) 0) (> it41 0)))
(assert (= (+ it48 (- 3)) 0))
(assert (= (+ (* it39 (- 1)) it49 (- 1)) 0))
(assert (= (+ (* it40 (- 1)) it50) 0))
(assert (= (+ (* it41 (- 1)) it51 1) 0))
(assert (and (= 1 0) (>= (+ (* it48 (- 1)) 3) 0) (> it51 0) (>= (+ it48 (- 3)) 0)))
(check-sat)
