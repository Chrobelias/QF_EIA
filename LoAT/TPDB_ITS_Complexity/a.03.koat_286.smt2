...
(assert (let ((a!1 (>= (+ (+ (* it884 (- 1)) it882) (- 1)) 0))
      (a!2 (>= (+ (+ (* it572 (- 1)) it882) (- 3)) 0))
      (a!3 (>= (+ (+ (* it572 (- 1)) (* it881 (- 2)) it882) (- 1)) 0))
      (a!4 (+ (+ (* it572 (- 1)) (* it19 (- 1))) (* it881 (- 2)) it882))
      (a!5 (>= (+ (+ (* it572 (- 1)) it882) (- 2)) 0))
      (a!6 (>= (+ (+ (* it572 (- 1)) (* it19 (- 1))) it882 (- 2)) 0))
      (a!7 (>= (+ (+ (* it572 (- 1)) (* it881 (- 2)) it882) 1) 0)))
  (and (>= (+ it879 (- 3)) 0)
       a!1
       (= 0 0)
       (>= (+ it19 (- 1)) 0)
