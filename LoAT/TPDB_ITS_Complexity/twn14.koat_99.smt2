...
(assert (let ((a!1 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 ...
                 (+ 0 (* it883 3)))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it152 (- 1))) (+ 0 2)) (exp it882 2)))
      (a!3 (* (* (exp it884 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 1))))
      (a!5 (* (* (exp 9 (+ it152 (- 1))) (+ 0 it883)) (+ 0 3)))
      (a!6 (* (* (exp it884 3) (exp 9 (+ it152 (- 1)))) (+ 0 (- 3))))
      (a!8 (> (+ (* (exp it884 5) (+ 0 (- 1)))
                 (* (exp it882 2) (+ 0 (- 1)))
                 (+ 0 it883))
              (+ 0 0))))
(let ((a!4 (+ (* (exp 9 (+ it152 (- 1))) (+ 0 it883))
              (* a!2 (+ 0 (- 1)))
              (* (exp it884 5) (+ 0 (- 1)))
              (exp it884 3)
              a!3))
