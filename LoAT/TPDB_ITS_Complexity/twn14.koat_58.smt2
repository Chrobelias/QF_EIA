...
(assert (let ((a!1 (> (+ (+ 0 it682)
                 (* (exp it681 2) (+ 0 (- 1)))
                 (* (exp it683 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp it683 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it681 2)))
      (a!5 (* (* (exp it683 3) (exp 9 (+ it117 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it682) (exp 9 (+ it117 (- 1)))) (+ 0 3)))
      (a!8 (> (+ (+ 0 (* it682 3))
                 (* (exp it683 3) (+ 0 (- 2)))
                 (* (exp it681 2) (+ 0 (- 4)))
                 (* (exp it683 5) (+ 0 (- 1))))
