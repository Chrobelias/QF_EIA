...
(assert (let ((a!1 (+ (* it706 (- 1))
      ...
      (a!2 (>= (+ (* it2533 (- 2))
                  ...
                  (- 2))
               0))
      (a!3 (+ (+ (+ (* it2533 (- 2)) (* it706 (- 1))) it2534) (- 1)))
      (a!4 (>= (+ (+ (* it2533 (- 2)) (* it706 (- 1)))
                  (* it2537 (- 1))
                  it2534
                  (- 1))
               0))
      (a!5 (>= (+ (+ (* it2533 (- 2)) it2534) (- 2)) 0))
      (a!6 (+ (+ (* it2533 (- 2)) (* it706 (- 1)))
              (* it706 (+ it1243 (- 1)) (- 1))
              (* it2537 (+ it1243 (- 1)) (- 1))))
      (a!7 (>= (+ (+ (* it706 (- 1)) it2534) (- 3)) 0))
      (a!8 (>= (+ (+ (* it2533 (- 2)) it2534) (- 1)) 0))
      (a!9 (>= (+ (+ (* it706 (- 1)) it2534) (- 2)) 0))
      (a!10 (>= (+ (* it706 (+ it1243 (- 1)) (- 1))
                   (* it2537 (+ it1243 (- 1)) (- 1))
                   it2534
                   (- 3))
                0))
      (a!11 (+ (+ (+ (* it2533 (- 2)) (* it706 (- 1))) it2534) (- 2))))
  (and (>= (+ it1243 (- 1)) 0)
       (>= (+ (+ a!1 it2534) (- 2)) 0)
       a!2
       (>= (+ (+ a!1 it2534) (- 3)) 0)
       ...
       (>= (+ (+ a!6 it2534) (- 2)) 0)
       (>= (+ it2533 (- 1)) 0)
       (>= (+ a!6 (* it2537 (- 1)) it2534 (- 1)) 0)
       a!7
       a!8
       (>= (+ (+ a!6 it2534) (- 1)) 0)
       (>= (+ (* it2533 (- 1)) 1) 0)
       a!9
       (>= (+ (* it706 (- 1)) (* it2537 (- 1)) it2534 (- 2)) 0)
       (>= (+ it2537 (- 1)) 0)
       a!10
       (>= (+ it2531 (- 4)) 0)
       (>= (+ it2534 (- 3)) 0)
