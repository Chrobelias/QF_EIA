...
(assert (let ((a!1 (* (* (+ 0 it89) (exp 9 (+ it82 (- 1)))) (+ 0 3)))
      (a!2 (* (exp (exp 4 (+ it82 (- 1))) (+ 0 2)) (exp it88 2)))
      (a!3 (* (* (exp 9 (+ it82 (- 1))) (exp it90 3)) (+ 0 (- 3))))
      (a!5 (* (* (exp 9 (+ it82 (- 1))) (exp it90 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it88 2) (+ 0 (- 1)))
                 (* (exp it90 5) (+ 0 (- 1)))
                 (+ 0 it89))
              (+ 0 0)))
