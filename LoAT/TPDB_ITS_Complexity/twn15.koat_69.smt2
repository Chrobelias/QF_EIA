...
(assert (let ((a!1 (* (* (exp 9 (+ it117 (- 1))) (exp it815 3)) (+ 0 (- 1))))
      (a!2 (* (exp (exp 4 (+ it117 (- 1))) (+ 0 2)) (exp it813 2)))
      (a!4 (> (+ (* (exp it815 3) (+ 0 (- 2)))
                 (+ 0 (* it814 3))
                 (* (exp it813 2) (+ 0 (- 4)))
                 (* (exp it815 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it117 (- 1))) (exp it815 3)) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it814) (exp 9 (+ it117 (- 1)))) (+ 0 3)))
      (a!8 (> (+ (+ 0 it814)
                 (* (exp it813 2) (+ 0 (- 1)))
                 (* (exp it815 5) (+ 0 (- 1))))
              (+ 0 0))))
