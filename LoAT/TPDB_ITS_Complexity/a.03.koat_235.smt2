...
(assert (let ((a!1 (>= (+ (+ (* it795 (- 1)) it812) (- 2)) 0))
      (a!2 (>= (+ (+ (* it811 (- 2)) (* it795 (- 1)) it812) (- 1)) 0))
      (a!3 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1)) it812)
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!4 (>= (+ (+ (* it811 (- 2)) (* it795 (- 1)) it812) (- 2)) 0))
      (a!5 (>= (+ (+ (* it814 (- 1)) it812) (- 1)) 0))
      (a!6 (+ (+ (* it795 (- 1)) it812)
              (* it795 (+ it784 (- 1)) (- 1))
              (* it785 (+ it784 (- 1)) (- 1))))
      (a!7 (+ (* it785 (- 1)) (* it811 (- 2)) (* it795 (- 1)) it812))
      (a!9 (>= (+ (+ (* it811 (- 2)) it812)
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 2))
               0))
      (a!10 (+ it812 (* (* it785 it784) (- 1)) (* (* it795 it784) (- 1))))
      (a!11 (+ (+ (* it811 (- 2)) (* it795 (- 1)) it812)
               (* it795 (+ it784 (- 1)) (- 1))
               (* it785 (+ it784 (- 1)) (- 1))))
      (a!12 (>= (+ (+ (* it785 (- 1)) (* it795 (- 1)) it812) (- 2)) 0))
      (a!13 (>= (+ (+ (* it795 (- 1)) it812) (- 3)) 0))
      (a!14 (>= (+ it812
                   (* it795 (+ it784 (- 1)) (- 1))
                   (* it785 (+ it784 (- 1)) (- 1))
                   (- 3))
                0))
      (a!15 (>= (+ (+ (* it811 (- 2)) it812) (- 1)) 0))
      (a!16 (>= (+ (+ (* it811 (- 2)) it812) (- 2)) 0)))
(let ((a!8 (>= (+ a!7
                  (* it795 (+ it784 (- 1)) (- 1))
                  (* it785 (+ it784 (- 1)) (- 1))
                  (- 1))
