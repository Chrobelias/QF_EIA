...
(assert (let ((a!1 (+ it817 (* it1032 (- 1)) (* it909 (- 1)) (* it673 (- 1))))
      (a!2 (> (+ (+ it1034 (* it1032 (- 1))) (* it909 (- 1))) 0))
      (a!3 (> (+ (+ (+ it1032 it909) it673) 1) 0))
      (a!5 (+ (+ (+ it1034 (* it1032 (- 1))) (* it909 (- 1))) (- 1)))
      (a!6 (> (+ (+ it1034 (* it1032 (- 1))) (- 1)) 0))
      (a!7 (+ it817
              (* it803 (- 1))
              (* it1032 (- 1))
              (* it909 (- 1))
      ...
      (a!8 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!10 (+ (+ (+ it1034 (* it1032 (- 1))) (* it909 (- 1))) (- 2)))
      (a!11 (> (+ (+ (+ it1032 it909) it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
