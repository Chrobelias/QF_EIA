...
(assert (let ((a!1 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!4 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!5 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1679 (- 1))))
      (a!6 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 2)))
      (a!7 (> (+ it673
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 it1679
      ...
      (a!9 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 4)))
      (a!11 (> (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) 0))
      (a!12 (<= (+ (+ (* it803 it819) (* it673 it819)) it359) 0))
      (a!15 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 3)))
      (a!16 (>= (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!17 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1679 1)
               0))
      (a!18 (>= (+ (+ it1681 (* it1679 (- 1))) (- 2)) 0))
      (a!19 (> (+ (+ (* it803 it819) (* it673 it819)) it1679 1) 0)))
(let ((a!3 (+ (+ a!2 it817) (* it359 (- 1)) (* it1679 (- 1))))
      (a!10 (>= (+ (+ (+ a!2 it817) (* it1679 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ (+ a!2 it817) (* it1679 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ (+ a!2 it817) (* it1679 (- 1))) (- 1)) 0)))
  (and (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       (>= (+ a!1 (- 1)) 0)
