...
(assert (let ((a!1 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1337 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (+ (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) (- 3)))
      (a!4 (> (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) 0))
      (a!5 (> (+ (+ (* it803 it819) (* it673 it819)) it1337 1) 0))
      (a!6 (> (+ it673
                 (* (+ it819 (- 1)) it673)
                 it1337
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!7 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1337 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!8 (+ (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) (- 4)))
      (a!9 (> (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!10 (+ (+ it817 (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* it1337 (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (> (+ (* (+ it819 (- 1)) it673) it1337 (* it803 (+ it819 (- 1))) 1)
               0))
      (a!12 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!13 (+ (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) (- 2)))
      (a!15 (>= (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!16 (>= (+ (+ it1339 (* it1337 (- 1))) (- 2)) 0)))
(let ((a!14 (> (+ (+ (+ a!2 it817) (* it1337 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       (>= (+ it1338 (* it102 (- 1))) 0)
       (>= (+ a!1 (- 3)) 0)
       (> (+ (+ a!2 it817) (* it909 (- 1)) (* it1337 (- 1))) 0)
       (>= a!3 0)
       a!4
       (<= (+ (* it102 (- 1)) it1335) 0)
       a!5
