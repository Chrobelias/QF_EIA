...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) it817)
      ...
      (a!5 (+ it1352
              ...
              (* it1350 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!7 (> (+ (* (+ it1045 (- 1)) it359) it1350 (* (+ it1045 (- 1)) it909) 1)
              0))
      (a!8 (+ it1352
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* it1350 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!9 (+ (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) (- 1)))
      (a!10 (> (+ (+ it1352 (* it1350 (- 1))) (* it909 (- 1)) (* it359 (- 1)))
               0))
      (a!12 (+ (+ (* it1045 it359) it1350) it673 (* it1045 it909)))
      (a!13 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!14 (>= (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!15 (> (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!16 (+ (+ (+ (* it1045 it359) it1350) (* it1045 it909)) 1))
      (a!18 (+ (+ (+ (* it1045 it359) it1350) (* it1045 it909))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!19 (> (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (>= (+ (+ a!8 (* it359 (- 1))) (- 1)) 0))
      (a!17 (> (+ (+ a!8 (* it359 (- 1))) (- 1)) 0))
      (a!20 (> (+ a!12 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0)))
  (and (>= (+ a!2 (- 1)) 0)
       (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
