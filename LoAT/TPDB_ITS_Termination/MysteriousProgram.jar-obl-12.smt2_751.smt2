...
(declare-fun it1628 () Int)
(declare-fun it1629 () Int)
...
(assert (and (> it64 0)
     ...
     (<= (+ (* it1622 (- 1)) it64) 0)))
(assert (= (+ it1628 (- 7)) 0))
(assert (= (+ (* it1621 (- 1)) it1629) 0))
(assert (= (+ it1630 (* it64 (- 1))) 0))
(assert (= (+ it1631 (* it1623 (- 1)) (- 1)) 0))
(assert (= (+ it1632 (* it1624 (- 1))) 0))
(assert (= (+ it1633 (* it61 (- 1))) 0))
(assert (and (= (- 1) 0)
     (> (+ (* it1631 (- 1)) it1632) 0)
     (= 0 0)
     (> it1634 0)
