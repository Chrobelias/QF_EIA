...
(assert (let ((a!1 (+ (+ (* it1479 (- 1)) it817) (* it803 (- 1)) (* it673 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (>= (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!4 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!5 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 4)))
      (a!6 (> (+ (+ it1479 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!8 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!10 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!11 (> (+ (+ (* it803 it819) (* it673 it819)) it1479 1) 0))
      (a!13 (> (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) 0))
      (a!14 (> (+ it1479 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!15 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 3)))
      (a!16 (> (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!17 (>= (+ (+ (* it1479 (- 1)) it1481) (- 2)) 0)))
(let ((a!7 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (> (+ (+ a!2 (* it1479 (- 1)) it817) (* it909 (- 1))) 0))
      (a!12 (> (+ (+ a!2 (* it1479 (- 1)) it817) (- 1)) 0)))
  (and (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       (>= (+ it1477 (* it1484 (- 1))) 0)
