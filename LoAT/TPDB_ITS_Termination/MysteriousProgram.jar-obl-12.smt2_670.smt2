...
(assert (let ((a!1 (+ (* it1045 it359) (* (* (+ it1045 (- 1)) it359) (- 1)) it999))
      (a!2 (* (* (* it1045 (+ it1579 (- 1))) it909) (- 1)))
      (a!3 (* (+ (* it1045 it359) (* it1045 it909)) (+ it1579 (- 1))))
      (a!5 (* (* (* it1045 (+ it1579 (- 1))) it359) (- 1)))
      (a!10 (+ (* (* it1045 it359) (- 1)) it997 (* (* it1045 it909) (- 1))))
      (a!11 (+ (+ (* it1045 it359) it999) (* it997 (- 1)) (* it1045 it909)))
      (a!12 (> (+ (* (* it1045 it359) (- 1))
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it997
                  ...
                  1)
               0))
      (a!14 (> (+ (+ (* it1045 it359) it999)
                  (* it909 (- 1))
                  (* it997 (- 1))
                  (* it1045 it909)
                  (* it359 (- 1)))
               0))
      (a!17 (>= (+ (+ it999 (* it997 (- 1))) (- 3)) 0))
      (a!22 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!23 (>= (+ (* (* it1045 it359) (- 1)) (* (* it1045 it909) (- 1)) (- 1))
                0))
      (a!25 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!27 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!4 (+ a!1 a!2 (* (* (+ it1045 (- 1)) it909) (- 1)) a!3))
      (a!7 (+ a!1 (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!9 (+ (+ (+ (* it1045 it359) it999) a!2 a!3)
              (* it997 (- 1))
              (* it1045 it909)))
      (a!13 (+ (+ (+ (* it1045 it359) it999) a!2 a!3)
               (* it909 (- 1))
               (* it997 (- 1))
               (* it1045 it909)
               (* it359 (- 1))
               a!5))
      (a!19 (>= (+ (+ it999 a!2 a!3 (* it997 (- 1)) a!5) (- 3)) 0))
      (a!20 (+ (* (* it1045 it359) (- 1))
               (* (* it1045 (+ it1579 (- 1))) it909)
               (* a!3 (- 1))
               it997
               (* (* it1045 it909) (- 1))))
      (a!26 (>= (+ (+ it999 a!2 a!3 (* it997 (- 1)) a!5) (- 2)) 0))
      (a!28 (+ (* (* it1045 (+ it1579 (- 1))) it909)
               (* a!3 (- 1))
               it997
               (* (* it1045 (+ it1579 (- 1))) it359)
               1))
      (a!29 (>= (+ (+ a!11 (* it359 (- 1))) (- 1)) 0))
      (a!30 (>= (+ (+ it999 a!2 a!3 (* it997 (- 1)) a!5) (- 1)) 0))
      (a!33 (> (+ (+ a!11 (* it359 (- 1))) (- 1)) 0)))
(let ((a!6 (+ (+ a!4 (* it997 (- 1)) (* it1045 it909)) a!5))
      (a!8 (>= (+ (+ a!7 (* it997 (- 1)) (* it1045 it909)) (- 2)) 0))
      (a!15 (> (+ (+ a!7 (* it997 (- 1)) (* it1045 it909)) (- 1)) 0))
      (a!16 (+ (+ a!7 (* it997 (- 1)) (* it1045 it909)) (* it359 (- 1))))
      (a!18 (+ (+ a!4 (* it997 (- 1)) (* it1045 it909)) (* it359 (- 1)) a!5))
      (a!21 (+ a!20 (* (* it1045 (+ it1579 (- 1))) it359) 1))
      (a!24 (> (+ (+ a!9 (* it359 (- 1)) a!5) (- 1)) 0))
      (a!31 (+ a!20 it359 (* (* it1045 (+ it1579 (- 1))) it359) 1))
      (a!32 (>= (+ (+ a!9 (* it359 (- 1)) a!5) (- 1)) 0)))
  (and (> it102 0)
       (>= (+ a!6 (- 2)) 0)
       a!8
       (> (+ a!9 (* it359 (- 1)) a!5) 0)
