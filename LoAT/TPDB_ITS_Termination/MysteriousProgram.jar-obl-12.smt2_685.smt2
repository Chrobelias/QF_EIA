...
(assert (let ((a!1 (>= (+ (+ (* it1589 (- 1)) (* it1596 (- 1)) it1594) (- 4)) 0))
      (a!2 (+ (* it1595 (- 1)) (* it1589 (- 1)) (* it1596 (- 1)) it1594))
      (a!3 (>= (+ (+ (* it1589 (- 1)) it1591) (- 2)) 0))
      (a!4 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!5 (>= (+ (+ (* it1589 (- 1)) (* it1596 (- 1)) it1594) (- 3)) 0))
      (a!6 (>= (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!7 (>= (+ (+ (* it1589 (- 1)) (* it1596 (- 1)) it1594) (- 2)) 0)))
  (and (<= (+ (* it1594 (- 1)) it1591) 0)
       (> it1591 0)
       (>= (+ it1590 (* it1593 (- 1))) 0)
       (>= (+ it1588 (- 1)) 0)
       (> (+ it1589 1) 0)
