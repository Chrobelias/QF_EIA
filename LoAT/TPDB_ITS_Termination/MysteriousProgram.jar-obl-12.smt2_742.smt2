...
(assert (let ((a!1 (+ (+ (* it1615 (- 1)) (* it1555 (- 1)))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!2 (+ (+ (+ (* it1615 (- 1)) (* it1555 (- 1))) it127) (- 2)))
      (a!4 (> (+ (+ (* it1615 (- 1)) (* it1555 (- 1))) it127) 0))
      (a!5 (>= (+ (+ (* it1615 (- 1)) it127) (- 1)) 0))
      (a!6 (> (+ (+ (* it1615 (- 1)) (* it1555 (- 1)))
                 (* it909 (- 1))
                 (* it359 (- 1))
                 it127)
              0))
      (a!7 (+ (+ (+ (* it1615 (- 1)) (* it1555 (- 1))) it127) (- 1)))
      (a!8 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!9 (+ (* (* it1045 it359) (- 1))
              (* it1555 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!10 (+ (+ (* it1615 (- 1)) (* it1555 (- 1))) (* it359 (- 1)) it127))
      (a!11 (>= (+ (+ (* it1615 (- 1)) it127) (- 3)) 0))
      (a!12 (> (+ (+ it1615 it1555)
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
               0))
      (a!13 (>= (+ (+ (* it1615 (- 1)) it127) (- 2)) 0)))
(let ((a!3 (> (+ (+ a!1 (* it359 (- 1)) it127) (- 1)) 0))
      (a!14 (>= (+ (+ a!1 (* it359 (- 1)) it127) (- 1)) 0)))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (> (+ (+ a!1 it127) (- 1)) 0)
       (>= a!2 0)
