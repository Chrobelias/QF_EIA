...
(assert (let ((a!1 (+ it1400
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!3 (+ (+ (* (* it1045 it359) (- 1)) it1400) (* it1398 (- 1))))
      (a!5 (* (* (* (+ it1303 (- 1)) it1045) it359) (- 1)))
      (a!7 (* (* (* (+ it1303 (- 1)) it1045) it909) (- 1)))
      (a!10 (+ (* (+ it1303 (- 1)) it673 it819)
               (* (* (+ it1303 (- 1)) it1045) it359)
               (* (+ it1303 (- 1)) it803 it819)))
      (a!12 (+ (+ (* it1045 it359) it1398) it673 (* it1045 it909)))
      (a!13 (+ (+ (* (* it1045 it359) (- 1)) it1400)
               (* it803 (- 1))
               (* it1398 (- 1))
               (* it673 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!14 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0))
      (a!19 (> (+ (+ it1400 (* it1398 (- 1))) (* it359 (- 1))) 0))
      (a!20 (= (+ (* it803 it819 (- 1))
                  (* (* it1045 it359) (- 1))
                  (* it673 it819 (- 1))
                  (* (* it1045 it909) (- 1)))
               0))
      (a!21 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!24 (+ (+ (+ it1400 (* it1398 (- 1))) (* it359 (- 1))) (- 1)))
      (a!26 (+ (* it1045 it359)
               (* (+ it1303 (- 1)) it673 it819)
               (* (* (+ it1303 (- 1)) it1045) it359)
               (* (+ it1303 (- 1)) it803 it819)
               (* (* (+ it1303 (- 1)) it1045) it909)
               it1398))
      (a!29 (+ (+ (+ (* it1045 it359) it1398) (* it1045 it909))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!30 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!32 (+ (+ (+ (* it1045 it359) it1398) (* it1045 it909)) 1))
      (a!35 (> (+ (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it1398
                  1)
               0)))
(let ((a!2 (+ (+ (+ a!1 (* it1398 (- 1))) (* it359 (- 1))) (- 1)))
      (a!4 (+ (+ a!3 (* (* it1045 it909) (- 1))) (- 1)))
      (a!6 (+ (* (* it1045 it359) (- 1))
              (* (* (+ it1303 (- 1)) it673 it819) (- 1))
              it1400
              a!5
              (* (* (+ it1303 (- 1)) it803 it819) (- 1))))
      (a!11 (+ a!10 (* (* (+ it1303 (- 1)) it1045) it909) it1398))
      (a!15 (+ a!13
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!16 (+ a!3 (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!22 (+ a!10
               (* (+ it1045 (- 1)) it359)
               (* (+ it1045 (- 1)) it909)
               (* (* (+ it1303 (- 1)) it1045) it909)
               it1398
               1))
      (a!25 (> (+ (+ a!1 (* it1398 (- 1))) (- 1)) 0))
      (a!27 (> (+ (+ a!26 (* it1045 it909)) 1) 0))
      (a!28 (> (+ (+ a!26 it673 (* it1045 it909)) 1) 0))
      (a!31 (+ (+ a!3 (* (* it1045 it909) (- 1))) (- 2)))
      (a!33 (> (+ (+ a!1 (* it1398 (- 1))) (* it359 (- 1))) 0))
      (a!34 (> (+ (+ a!26 it673 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!36 (>= (+ (+ a!1 (* it1398 (- 1))) (- 2)) 0))
      (a!37 (> (+ (+ a!26 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!38 (> (+ a!12 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!39 (> (+ a!3 (* (* it1045 it909) (- 1))) 0)))
(let ((a!8 (+ a!6
              a!7
              (* it1398 (- 1))
              (* it673 (- 1))
...
(let ((a!9 (+ a!8
  ...
  (and (>= (+ it1303 (- 1)) 0)
       ...
       (>= (+ it818 (- 1)) 0)
       (>= (+ it673 (- 1)) 0)
       (> (+ it1400 (* it909 (- 1)) (* it1398 (- 1)) (* it359 (- 1))) 0)
       (>= a!4 0)
       (> it1400 0)
       (>= (+ a!8 (- 2)) 0)
       (>= (+ it359 (- 1)) 0)
       ...
       (> a!16 0)
       (> a!4 0)
       (> (+ a!1 (* it909 (- 1)) (* it1398 (- 1)) (* it359 (- 1))) 0)
       (>= (+ (* it818 (- 1)) it1396) 0)
       (> (+ a!11 it359 1) 0)
       (>= (+ a!18 (- 3)) 0)
       (>= (+ a!8 (- 4)) 0)
