...
(assert (let ((a!1 (+ it817
              ...
              (* it673 (- 1))
              (* it1716 (- 1))))
      (a!3 (+ it817 (* it909 (- 1)) (* it673 (- 1)) (* it1716 (- 1))))
      (a!5 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!6 (> (+ (+ it909 it1716)
                 ...
                 1)
              0))
      (a!7 (> (+ (+ it909 it673 it1716)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!8 (>= (+ (+ it1718 (* it909 (- 1)) (* it1716 (- 1))) (- 2)) 0))
      (a!9 (+ (+ it1718 (* it909 (- 1)) (* it1716 (- 1))) (- 1)))
...
(let ((a!2 (+ a!1
  ...
  (and (>= (+ (* it1713 (- 1)) 6) 0)
       ...
       (>= (+ it1717 (- 1)) 0)
       (> (+ it1716 1) 0)
       (> (+ (+ it909 it673 it1716) 1) 0)
       a!10
       (>= (+ a!3 (- 3)) 0)
       (>= (+ a!1 (- 2)) 0)
       (= (+ it1718 (* it817 (- 1))) 0)
       (> (+ it1718 (* it909 (- 1)) (* it1716 (- 1))) 0)
       (>= (+ a!1 (- 1)) 0)
       (> (+ (+ it909 it1716) 1) 0)
       (>= (+ a!4 (- 4)) 0)
       (> (+ it1718 (- 1)) 0)
