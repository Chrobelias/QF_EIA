...
(assert (let ((a!1 (>= (+ (+ it1105 (* it1103 (- 1))) (- 2)) 0))
      (a!2 (> (+ (+ it673 it1103)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!3 (> (+ it1103 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!4 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1103 (- 1))))
      (a!5 (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!9 (> (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 3)) 0))
      (a!11 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 4)) 0)))
(let ((a!7 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (>= (+ (* it1100 (- 1)) 6) 0)
