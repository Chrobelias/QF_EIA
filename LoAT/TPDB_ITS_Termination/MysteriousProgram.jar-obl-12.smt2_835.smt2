...
(assert (let ((a!1 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1716 (- 1))))
      (a!3 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!4 (> (+ (+ (* it803 it819) (* it673 it819)) it1716 1) 0))
      (a!5 (>= (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!6 (> (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 2)) 0))
      (a!8 (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!11 (> (+ it1716 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!12 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 4)) 0))
      (a!13 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 3)) 0))
      (a!14 (>= (+ (+ it1718 (* it1716 (- 1))) (- 2)) 0))
      (a!15 (> (+ (+ it673 it1716)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
