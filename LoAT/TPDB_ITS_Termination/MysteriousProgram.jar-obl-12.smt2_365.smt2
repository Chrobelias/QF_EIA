...
(assert (let ((a!1 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!2 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              it999
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!5 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!7 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
              0))
      (a!8 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!10 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!11 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!3 (+ (+ (+ a!2 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!4 (> (+ (+ a!2 (* it997 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ a!2 (* it997 (- 1))) (- 2)) 0))
      (a!9 (> (+ (+ a!2 (* it997 (- 1))) (* it359 (- 1))) 0)))
  (and (> it102 0)
       (> (+ it999 (- 1)) 0)
       a!1
       (> (+ it997 it359 1) 0)
       ...
       (>= a!8 0)))))
(assert (= (+ (* it994 (- 1)) it1260) 0))
(assert (= (+ it1261 (* it102 (- 1))) 0))
(assert (= (+ it1262 (* it102 (- 1))) 0))
(assert (= (+ (* it1045 it359 (- 1)) (* it997 (- 1)) (* it1045 it909 (- 1)) it1263) 0))
(assert (= (+ it1264 (* it102 (- 1))) 0))
(assert (= (+ (* it999 (- 1)) it1265) 0))
(assert (let ((a!1 (>= (+ (+ (* it1263 (- 1)) it127) (- 2)) 0))
      (a!2 (>= (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!3 (> (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ (* it1263 (- 1)) it127) (- 3)) 0))
      (a!5 (>= (+ (+ (* it803 (- 1)) (* it1263 (- 1)) it127) (- 2)) 0))
      (a!6 (>= (+ (+ it1265 (* it1263 (- 1))) (- 2)) 0))
      (a!7 (>= (+ (+ (* it1263 (- 1)) it127) (- 4)) 0))
      (a!8 (>= (+ (+ (* it803 (- 1)) (* it1263 (- 1)) it127) (- 1)) 0))
      (a!9 (>= (+ (+ (* it803 (- 1)) (* it1263 (- 1)) it127) (- 3)) 0)))
  (and (> it107 0)
       (> (+ it127 1) 0)
       (>= (+ it1264 (- 1)) 0)
       a!1
       ...
       a!9
       (> (+ it1265 (* it1263 (- 1))) 0))))
(assert (= (+ it1270 (* it1260 (- 1))) 0))
(assert (= (+ it1271 (* it107 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it1272) 0))
(assert (= (+ it1273 (* it803 (- 1)) (* it1263 (- 1))) 0))
(assert (= (+ it1274 (* it107 (- 1))) 0))
(assert (= (+ it1275 (* it127 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0)))
  (and (>= (+ it1270 (- 6)) 0)
       (>= (+ it1267 (- 1)) 0)
       (>= (+ it1271 (* it1269 (- 1))) 0)
       (> (+ it1275 (- 1)) 0)
       ...
       (> (+ (* it1273 (- 1)) it1275) 0)
       (>= (+ it1274 (- 1)) 0)
       (> (+ (* it1273 (- 1)) (* it1267 (- 1)) it1275) 0))))
(assert (= (+ (* it1270 (- 1)) it1279) 0))
(assert (= (+ it1280 (* it1269 (- 1))) 0))
(assert (= (+ it1281 (* it1269 (- 1))) 0))
(assert (= (+ (* it1273 (- 1)) (* it1267 (- 1)) it1282) 0))
(assert (= (+ it1283 (* it1269 (- 1))) 0))
(assert (= (+ it1284 (* it1275 (- 1))) 0))
(assert (let ((a!1 (+ (* (* it673 it819) (- 1))
              (* (* it1137 (+ it1266 (- 1))) (- 1))
              it817))
      (a!3 (+ (* (* (+ it819 (- 1)) it1276) (- 1))
              it817
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1282 (- 1))))
      (a!4 (+ (+ (* (* it673 it819) (- 1)) it817)
              (* it1268 (- 1))
              (* (* it819 it1276) (- 1))
              (* it1285 (- 1))
              (* it1282 (- 1))))
      (a!5 (> (+ (* it673 it819)
                 ...
                 1)
              0))
      (a!6 (> (+ (+ (* it673 it819) (* it819 it1276)) it1282 1) 0))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 2)) 0))
      (a!8 (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (* it1276 (- 1))))
      (a!9 (+ (* (* it673 it819) (- 1))
              (* (* it1137 it1266) (- 1))
              (* (* it819 it1276) (- 1))
              (* it1285 (- 1))
              (* (* it1268 it1266) (- 1))))
      (a!10 (> (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ it1284 (* it1282 (- 1))) (- 2)) 0))
      (a!13 (+ (+ (* (* it673 it819) (- 1)) it817) (* (* it819 it1276) (- 1))))
      (a!19 (> (+ (* (+ it819 (- 1)) it1276) (* (+ it819 (- 1)) it673) it1282 1)
               0))
      (a!20 (+ (+ (* (* it673 it819) (- 1)) it817)
               (* it1137 (- 1))
               (* it1268 (- 1))
               (* (* it819 it1276) (- 1))
               (* it1285 (- 1))
               (* it1282 (- 1))))
      (a!22 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 3)) 0))
      (a!23 (> (+ (* (+ it819 (- 1)) it1276)
                  it673
                  (* (+ it819 (- 1)) it673)
                  it1282
                  1)
               0))
      (a!24 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 4)) 0))
      (a!26 (>= (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!27 (> (+ (+ (* it673 it819) (* it819 it1276)) it1285 it1282 1) 0)))
(let ((a!2 (+ a!1
              (* it1268 (- 1))
              (* (* it1268 (+ it1266 (- 1))) (- 1))
              (* (* it819 it1276) (- 1))
      ...
      (a!11 (+ a!1
               ...
               (* it1285 (- 1))
               (* it1282 (- 1))))
      (a!14 (+ (+ a!13 (* it1285 (- 1)) (* it1282 (- 1))) (- 1)))
      (a!15 (>= (+ (+ a!3 (* it1276 (- 1))) (- 1)) 0))
      (a!16 (+ a!1
               (* it1137 (- 1))
               (* it1268 (- 1))
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               ...
               (* it1285 (- 1))
               (* it1282 (- 1))))
      (a!17 (> (+ (+ a!13 (* it1282 (- 1))) (- 1)) 0))
      (a!18 (>= (+ (+ a!13 (* it1285 (- 1)) (* it1282 (- 1))) (- 2)) 0))
      (a!21 (>= (+ (+ a!3 (* it1276 (- 1))) (- 2)) 0))
      (a!25 (>= (+ (+ a!3 (* it1276 (- 1))) (- 3)) 0)))
  (and (>= (+ a!2 (- 1)) 0)
       (> (+ (* it673 it819) it1268 (* it819 it1276) it1285 it1282 1) 0)
       (>= (+ a!3 (- 3)) 0)
       (>= (+ it1285 (- 1)) 0)
       (>= (+ it1281 (* it1138 (- 1))) 0)
       (>= (+ it1283 (- 1)) 0)
       (> (+ it817 (* it673 (- 1)) (* it1282 (- 1))) 0)
       (> it1284 0)
       (>= (+ it1283 (* it1138 (- 1))) 0)
       (> it817 0)
       (> (+ it817 1) 0)
