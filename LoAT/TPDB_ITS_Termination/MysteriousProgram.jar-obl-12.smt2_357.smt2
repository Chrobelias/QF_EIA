...
(assert (let ((a!1 (+ (+ (+ (* it1268 (- 1)) it1284) (* it1282 (- 1))) (- 1)))
      (a!2 (> (+ (+ (* it1268 (- 1)) it1284) (* it1282 (- 1))) 0))
      (a!3 (>= (+ (+ it1284 (* it1282 (- 1))) (- 2)) 0))
      (a!4 (>= (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ (* it1268 (- 1)) it1284) (* it1285 (- 1)) (* it1282 (- 1)))
              0))
      (a!6 (> (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0)))
  (and (>= (+ it1283 (- 1)) 0)
       (>= (+ (* it1286 (- 1)) it1283) 0)
       (> a!1 0)
       (> it1280 0)
