...
(assert (and (> it105 0)
     ...
     (> (+ it401 1) 0)))
(assert (= (+ it406 (- 6)) 0))
(assert (= (+ it407 (* it105 (- 1))) 0))
(assert (= (+ it408 (* it104 (- 1))) 0))
(assert (= (+ (* it401 (- 1)) it409 (- 1)) 0))
(assert (= (+ it410 (* it102 (- 1))) 0))
(assert (= (+ (* it404 (- 1)) it411) 0))
(assert (let ((a!1 (> (+ (+ it411 (* it409 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it411 (* it409 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ it411 (* it409 (- 1))) (- 2)) 0)))
  (and (> it110 0)
       (> it109 0)
       (= (- 1) 0)
       (> it370 0)
