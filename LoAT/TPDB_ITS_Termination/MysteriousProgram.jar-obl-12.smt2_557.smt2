...
(assert (and (<= (+ (* it1453 (- 1)) 1) 0)
     ...
     (<= (+ it1459 (* it1453 (- 1))) 0)))
(assert (= (+ it1461 (- 9)) 0))
(assert (= (+ (* it1459 (- 1)) it1462) 0))
(assert (= (+ it1463 (* it1454 (- 1))) 0))
(assert (= (+ it1464 (* it1455 (- 1)) (- 1)) 0))
(assert (= (+ (* it1455 (- 1)) it1465 (- 1)) 0))
(assert (= (+ it1466 (* it1457 (- 1))) 0))
(assert (let ((a!1 (+ (+ (+ it1466 (* it1464 (- 1))) (* it849 (- 1))) 1))
      (a!2 (> (+ (+ it1466 (* it1464 (- 1))) (* it849 (- 1))) 0))
      (a!3 (> (+ (+ it1460 (* it1464 (- 1))) (* it849 (- 1))) 0))
      (a!4 (> (+ (+ it1460 (* it1464 (- 1))) (* it1458 (- 1)) (* it849 (- 1)) 1)
              0)))
  (and (>= (+ it849 (- 1)) 0)
       (> (+ it1466 (* it1464 (- 1))) 0)
       (>= (+ (* it1461 (- 1)) 9) 0)
