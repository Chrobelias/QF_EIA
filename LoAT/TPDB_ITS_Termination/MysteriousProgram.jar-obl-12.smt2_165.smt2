...
(assert (let ((a!1 (> (+ it673
                 ...
                 1)
              0))
      (a!2 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1052 (- 1))))
      (a!3 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1052 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!4 (+ (+ (+ it817 (* it673 (- 1))) (* it1052 (- 1))) (- 2)))
      (a!5 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1052 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (+ (+ (+ it817 (* it673 (- 1))) (* it1052 (- 1))) (- 4)))
      (a!7 (> (+ (+ it817 (* it673 (- 1))) (* it1052 (- 1))) 0))
      (a!8 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              it817
              (* it1052 (- 1))))
      (a!9 (+ (* (* it803 it819) (- 1))
              (* it1056 (- 1))
              (* (* it673 it819) (- 1))))
      (a!10 (>= (+ (+ it1054 (* it1052 (- 1))) (- 2)) 0))
      (a!11 (> (+ (+ it1054 (* it1052 (- 1))) (- 1)) 0))
      (a!12 (> (+ (* (+ it819 (- 1)) it673) it1052 (* it803 (+ it819 (- 1))) 1)
               0))
      (a!13 (+ (+ (+ it817 (* it673 (- 1))) (* it1052 (- 1))) (- 3)))
      (a!14 (>= (+ (+ it1054 (* it1052 (- 1))) (- 1)) 0)))
  (and a!1
       (<= (+ it1053 (* it1058 (- 1))) 0)
       (= (+ (* it817 (- 1)) it1054) 0)
       (>= (+ a!2 (- 3)) 0)
       ...
       (> (+ it817 1) 0)
       (> (+ it673 it1052 1) 0)
       (<= (+ (* it803 it819) it1056 (* it673 it819)) 0)
       a!7
       (> a!8 0)
       (>= (+ it1056 (- 1)) 0)
       (> (+ a!9 it817 (* it1052 (- 1))) 0)
       a!10
       (>= (+ a!2 (- 2)) 0)
       (> (+ it1054 (- 1)) 0)
       (> it1058 0)
       (> (+ (* it803 it819) (* it673 it819) it1052 1) 0)
       (>= (+ a!5 (- 3)) 0)
       (>= (+ it673 (- 1)) 0)
       (> (+ a!8 (- 1)) 0)
       (>= (+ a!5 (- 2)) 0)
