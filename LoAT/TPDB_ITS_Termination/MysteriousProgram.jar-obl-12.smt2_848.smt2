...
(assert (let ((a!1 (+ (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) (- 1)))
      (a!2 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!3 (> (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) 0))
      (a!4 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!5 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0)))
  (and (>= (+ it1616 (- 1)) 0)
       (>= (+ (* it1612 (- 1)) 6) 0)
       (>= a!1 0)
       (>= (+ it1612 (- 6)) 0)
       ...
       (>= (+ (* it1619 (- 1)) it1616) 0)
       a!5)))
(assert (= (+ (* it1612 (- 1)) it1713) 0))
(assert (= (+ it1714 (* it1619 (- 1))) 0))
(assert (= (+ it1715 (* it1619 (- 1))) 0))
(assert (= (+ (* it1615 (- 1)) it1716 (* it359 (- 1))) 0))
(assert (= (+ (* it1619 (- 1)) it1717) 0))
(assert (= (+ it1718 (* it1617 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it1718 (- 1)) it117) (- 2)) 0))
      (a!2 (+ it1702 (* (* (+ it1699 (- 1)) it1700) (- 1))))
      (a!5 (> (+ (+ it1702 (* it117 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ it1702 (* it117 (- 1))) (- 2)) 0))
      (a!7 (> (+ (+ it1702 (* it117 (- 1))) 1) 0))
      (a!8 (+ (* it1718 (- 1)) (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!10 (+ (+ (+ (* it1718 (- 1)) (* it1719 (- 1))) it117) (- 1)))
      (a!11 (<= (+ (+ it1718 (* it1702 (- 1)))
                   (* it1699 it1700)
                   (* it1699 it1701)
                   (* it1716 (- 1))
                   it117)
                0))
      (a!12 (>= (+ (+ (* it1718 (- 1)) it117) (- 1)) 0))
      (a!15 (> (+ it1718
                  (* (+ it1045 (- 1)) it909)
                  (* (+ it1045 (- 1)) it1719)
                  1)
               0))
      (a!16 (> (+ (+ (* it1718 (- 1)) (* it1719 (- 1))) it117) 0))
      (a!17 (<= (+ (+ (* it1718 (- 1)) it1702)
                   (* (* it1699 it1700) (- 1))
                   (* (* it1699 it1701) (- 1))
                   it1716
                   (* it117 (- 1)))
                0))
      (a!18 (> (+ (+ (* it1718 (- 1)) it117) 1) 0))
      (a!19 (> (+ (+ (* it1718 (- 1)) (* it1719 (- 1))) (* it909 (- 1)) it117)
               0))
      (a!20 (> (+ (+ it1702 (* it117 (- 1))) (* it1701 (- 1))) 0))
      (a!21 (+ (+ (+ it1702 (* it117 (- 1))) (* it1701 (- 1))) (- 1)))
      (a!23 (> (+ (+ (* it1718 (- 1)) it117) (- 1)) 0))
      (a!24 (>= (+ (+ it1702 (* it117 (- 1))) (- 1)) 0))
      (a!26 (> (+ (* (+ it1699 (- 1)) it1700)
                  it117
                  (* (+ it1699 (- 1)) it1701)
                  1)
               0))
      (a!27 (>= (+ (* it1718 (- 1))
                   ...
                   (- 1))
                0)))
(let ((a!3 (+ a!2 (* it117 (- 1)) (* (* (+ it1699 (- 1)) it1701) (- 1))))
      (a!9 (+ (+ a!8 (* it1719 (- 1)))
              it117
              (* (* (+ it1045 (- 1)) it1719) (- 1))))
      (a!13 (+ (+ a!8 (* it1719 (- 1)))
               ...
               it117
               (* (* (+ it1045 (- 1)) it1719) (- 1))))
      (a!14 (+ a!8 it117 (* (* (+ it1045 (- 1)) it1719) (- 1))))
      (a!25 (+ a!2
               (* it1700 (- 1))
               (* it117 (- 1))
               (* (* (+ it1699 (- 1)) it1701) (- 1))
               (* it1701 (- 1)))))
(let ((a!4 (> (+ (+ a!3 (* it1701 (- 1))) (- 1)) 0))
      (a!22 (>= (+ (+ a!3 (* it1701 (- 1))) (- 1)) 0)))
  (and (> (+ it117 1) 0)
       a!1
       (>= (+ it1714 (- 1)) 0)
       (<= (+ (* it1718 (- 1)) it1702) 0)
       ...
       (<= (+ it1718 (* it1702 (- 1))) 0)
       (> (+ a!3 (- 1)) 0)
       (> (+ it1702 (* it1700 (- 1)) (* it117 (- 1)) (* it1701 (- 1))) 0)
       (>= (+ it1715 (* it1695 (- 1))) 0)
       (>= (+ it1717 (* it1695 (- 1))) 0)
       (> (+ it117 (- 1)) 0)
       (>= (+ a!9 (- 1)) 0)
       ...
       (>= (+ (* it1713 (- 1)) 6) 0)
       (>= (+ it1045 (- 1)) 0)
       (>= (+ it1718 (* it1045 it1719) (* it117 (- 1)) (* it1045 it909) 1) 0)
       (<= (+ it1714 (* it1698 (- 1))) 0)
       (> it117 0)
       (<= (+ it1715 (* it1698 (- 1))) 0)
       (= 0 0)
