...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1))
      ...
      (a!3 (> (+ (* it803 it819)
                 ...
                 1)
              0))
      (a!4 (+ (+ (* it1615 (- 1)) it817) (* it803 (- 1)) (* it673 (- 1))))
      (a!6 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!7 (+ (* (* it803 it819) (- 1))
              (* (* (+ it1045 (- 1)) it1137) (- 1))
              (* it1615 (- 1))
              (* (* it673 it819) (- 1))
      ...
      (a!10 (+ (* (* it803 it819) (- 1))
               ...
               (* it909 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!12 (> (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) 0))
      (a!14 (+ (+ (* it803 it819) it1615 (* it673 it819)) it909))
      ...
      (a!17 (> (+ (+ it1615 it673)
                  ...
                  1)
               0))
      (a!18 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!19 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!20 (> (+ it1615 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!23 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 3)))
      (a!24 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 4)))
      (a!25 (> (+ (+ (* it803 it819) it1615 (* it673 it819)) 1) 0))
      (a!27 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0)))
(let ((a!2 (> (+ (+ a!1 (* it909 (- 1))) (- 1)) 0))
      (a!5 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!8 (> (+ (+ a!7 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!9 (+ (+ (+ a!7 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!11 (>= (+ (+ a!7 (* it909 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!15 (+ (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!21 (> (+ (+ a!7 (* it909 (- 1))) (- 1)) 0))
      (a!22 (>= (+ (+ a!1 (* it909 (- 1))) (- 2)) 0))
      (a!26 (>= (+ (+ a!1 (* it909 (- 1))) (- 1)) 0)))
  (and (>= (+ (* it1612 (- 1)) 6) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it1138 (- 1)) 0)
