...
(assert (let ((a!1 (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!4 (+ it817 (* it803 (- 1)) (* it1350 (- 1)) (* it673 (- 1))))
      (a!7 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!9 (+ (* (* it803 it819) (- 1))
              (* (* (+ it1045 (- 1)) it1137) (- 1))
              (* (* it673 it819) (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!11 (> (+ (+ (* it803 it819) (* it673 it819) it1350) 1) 0))
      (a!13 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* it909 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!14 (> (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!15 (> (+ (+ it1350 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (>= (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!21 (>= (+ (+ it1352 (* it1350 (- 1))) (- 2)) 0))
      (a!22 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  (* (+ it1045 (- 1)) it359)
                  ...
                  1)
               0))
      (a!23 (> (+ it1350 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!25 (+ (+ (* it803 it819) (* it673 it819) it1350) it909)))
(let ((a!3 (> (+ (+ a!2 (* it1350 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ a!2 (* it1350 (- 1))) (* it909 (- 1))) 0))
      (a!6 (+ (+ (+ a!2 (* it1350 (- 1))) (* it909 (- 1))) (* it359 (- 1))))
      (a!10 (+ (+ a!9 (* it1350 (- 1)) (* it909 (- 1))) (* it359 (- 1))))
      (a!12 (> (+ (+ a!9 (* it1350 (- 1)) (* it909 (- 1))) (- 1)) 0))
      (a!16 (+ a!4
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!17 (>= (+ (+ a!9 (* it1350 (- 1)) (* it909 (- 1))) (- 2)) 0))
      (a!18 (+ (+ (+ a!2 (* it1350 (- 1))) (* it909 (- 1))) (- 1)))
      (a!24 (+ (+ (+ a!2 (* it1350 (- 1))) (* it909 (- 1))) (- 2))))
  (and (> it1351 0)
       (<= (+ (* it1138 (- 1)) it1348) 0)
       (> it817 0)
       (> (+ it1350 1) 0)
