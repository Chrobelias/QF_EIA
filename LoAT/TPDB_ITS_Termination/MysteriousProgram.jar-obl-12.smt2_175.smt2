...
(assert (let ((a!1 (> (+ (+ it1064 (* it1062 (- 1))) (- 1)) 0))
      ...
      (a!3 (+ (+ (* it1056 (- 1)) it817)
              ...
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!8 (+ (+ (* it1056 (- 1)) it1064 (* it1062 (- 1))) (- 1)))
      (a!10 (+ (+ (+ (* it1056 (- 1)) it817) (* it673 (- 1))) (* it1062 (- 1))))
      (a!11 (+ (* it1056 (- 1))
               (* (* it1065 it819) (- 1))
               (* (* it673 it819) (- 1))))
      (a!13 (+ (+ it1056 (* (+ it819 (- 1)) it1065))
               (* (+ it819 (- 1)) it673)
               it1062
               1))
      (a!14 (>= (+ (+ (* it1056 (- 1)) it1064 (* it1062 (- 1))) (- 2)) 0))
      (a!15 (+ (+ it1056 (* (+ it819 (- 1)) it1065))
               it673
               (* (+ it819 (- 1)) it673)
               it1062
               1)))
(let ((a!4 (>= (+ (+ a!3 (* it1062 (- 1))) (- 4)) 0))
      (a!5 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 2)) 0))
      (a!6 (>= (+ (+ a!3 (* it1062 (- 1))) (- 2)) 0))
      (a!7 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 1)) 0))
      (a!9 (>= (+ (+ a!3 (* it1062 (- 1))) (- 3)) 0))
      (a!12 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 3)) 0)))
  (and (> (+ it1064 1) 0)
       (> it1061 0)
       (> (+ it1064 (* it1062 (- 1))) 0)
       (> (+ it1064 (- 1)) 0)
