...
(assert (let ((a!1 (+ (* it1555 (- 1)) (* it1603 (- 1)) (* it1600 (- 1)) it127))
      (a!2 (+ (* it1555 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))
              (* (* (+ it1045 (- 1)) it1603) (- 1))))
      (a!3 (> (+ it1555
      ...
      (a!4 (+ (* it1555 (- 1))
              (* (* it1045 it909) (- 1))
              (* (* it1045 it1603) (- 1))))
      (a!7 (>= (+ (+ (* it1600 (- 1)) it127) (- 2)) 0))
      (a!8 (>= (+ (+ (* it1600 (- 1)) it127) (- 3)) 0))
      (a!9 (+ (+ (* it1555 (- 1)) (* it1600 (- 1)) it127) (- 1)))
      (a!11 (> (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ (* it1600 (- 1)) it127) (- 1)) 0))
      (a!13 (>= (+ (+ (* it1555 (- 1)) (* it1600 (- 1)) it127) (- 2)) 0)))
(let ((a!5 (+ (+ a!2 (* it1603 (- 1)) (* it1600 (- 1)) it127) (- 1)))
      (a!6 (>= (+ (+ a!2 (* it1600 (- 1)) it127) (- 2)) 0))
      (a!10 (> (+ (+ a!2 (* it1600 (- 1)) it127) (- 1)) 0)))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (> (+ (* it1600 (- 1)) it127) 0)
       (> (+ it1555 it1603 it1600 1) 0)
       (> (+ a!1 (- 1)) 0)
       (> (+ it127 (- 1)) 0)
       (>= (+ it1598 (* it102 (- 1))) 0)
       (> (+ a!2 (* it909 (- 1)) (* it1603 (- 1)) (* it1600 (- 1)) it127) 0)
       (> (+ a!2 (* it1603 (- 1)) (* it1600 (- 1)) it127) 0)
       (> it1599 0)
       (> it1601 0)
       (>= (+ it1045 (- 1)) 0)
       (<= (+ (* it102 (- 1)) it1601) 0)
       ...
       (>= (+ (* it102 (- 1)) it1601) 0)
       (<= (+ it1602 (* it127 (- 1))) 0)
       (<= (+ it1555 (* it1045 it909) (* it1045 it1603)) 0)
       (> (+ (* it1555 (- 1))
             (* it909 (- 1))
             (* it1603 (- 1))
             (* it1600 (- 1))
