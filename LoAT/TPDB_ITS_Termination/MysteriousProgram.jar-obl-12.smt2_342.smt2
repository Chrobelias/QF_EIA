...
(assert (let ((a!1 (> (+ (+ it1246 (* it1275 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it1246 (* it1275 (- 1))) (- 3)) 0))
      (a!3 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!4 (>= (+ (+ (* it1273 (- 1)) it1275) (- 2)) 0))
      (a!5 (> (+ (+ it1248 (* it1246 (- 1))) 1) 0))
      (a!6 (> (+ (+ it1246 (* it1275 (- 1))) 1) 0))
      (a!7 (>= (+ (+ it1248 (* it1246 (- 1))) (- 3)) 0))
      (a!8 (>= (+ (+ it1248 (* it1246 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ it1246 (* it1275 (- 1))) (- 2)) 0)))
  (and (> it110 0)
       (> it109 0)
       (> it1278 0)
       (> (+ it1246 (- 1)) 0)
       ...
       (>= (+ it110 (- 1)) 0)
       (>= (+ it1271 (* it1278 (- 1))) 0)
       (<= (+ (* it1273 (- 1)) (* it1248 (- 1)) it1246 it1275) 0)
       a!6
       (> it1246 0)
       (= 0 0)
       (> (+ it1246 1) 0)
