...
(assert (let ((a!1 (+ (+ it817 (* it673 (- 1))) (* it1065 (- 1)) (* it1062 (- 1))))
      (a!2 (>= (+ (+ it1064 (* it1062 (- 1))) (- 1)) 0))
      (a!3 (+ it817
              (* (* (+ it819 (- 1)) it1065) (- 1))
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!5 (+ (+ (+ it817 (* it673 (- 1))) (* it1062 (- 1))) (- 2)))
      (a!6 (+ (* it1056 (- 1))
              (* (* it1065 it819) (- 1))
              (* (* it673 it819) (- 1))))
      (a!7 (+ (+ (+ it817 (* it673 (- 1))) (* it1062 (- 1))) (- 4)))
      (a!10 (> (+ (+ it817 (* it673 (- 1))) (* it1062 (- 1))) 0))
      (a!11 (>= (+ (+ it1064 (* it1062 (- 1))) (- 2)) 0))
      (a!12 (+ (* (* it1065 it819) (- 1))
               (* (* it673 it819) (- 1))
               it817
               (* it1062 (- 1))))
      (a!15 (> (+ (+ it1064 (* it1062 (- 1))) (- 1)) 0))
      (a!16 (> (+ (* (+ it819 (- 1)) it1065) (* (+ it819 (- 1)) it673) it1062 1)
               0))
      (a!18 (+ (+ (+ it817 (* it673 (- 1))) (* it1062 (- 1))) (- 3)))
      (a!19 (> (+ (* (+ it819 (- 1)) it1065)
                  it673
                  (* (+ it819 (- 1)) it673)
                  it1062
                  1)
               0)))
(let ((a!4 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 3)) 0))
      (a!8 (>= (+ (+ a!3 (* it1062 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ a!3 (* it1062 (- 1))) (- 3)) 0))
      (a!13 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 2)) 0))
      (a!14 (>= (+ (+ a!3 (* it1062 (- 1))) (- 4)) 0))
      (a!17 (>= (+ (+ a!3 (* it1065 (- 1)) (* it1062 (- 1))) (- 1)) 0)))
  (and (>= (+ it1059 (- 6)) 0)
       (>= (+ a!1 (- 2)) 0)
       (>= (+ a!1 (- 3)) 0)
       a!2
       ...
       (>= (+ it1065 (- 1)) 0)
       (> (+ it1064 (- 1)) 0)
       (> (+ (* it1065 it819) (* it673 it819) it1062 1) 0)
       (>= (+ (* it1059 (- 1)) 6) 0)
       (>= (+ it1058 (- 1)) 0)
       (<= (+ it1063 (* it1058 (- 1))) 0)
       (<= (+ it1056 (* it1065 it819) (* it673 it819)) 0)
       (>= (+ it1056 (- 1)) 0)
       (> a!12 0)
       (>= (+ it1063 (* it1058 (- 1))) 0)
       (>= (+ it1061 (* it1058 (- 1))) 0)
