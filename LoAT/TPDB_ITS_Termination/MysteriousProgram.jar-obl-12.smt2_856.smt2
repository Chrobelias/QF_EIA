...
(assert (let ((a!1 (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1729 (- 1))))
      (a!4 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!5 (>= (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!7 (<= (+ (+ (* it803 it819) (* it673 it819)) it1735) 0))
      (a!8 (> (+ it1729 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!9 (> (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!11 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 2)) 0))
      (a!13 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 3)) 0))
      (a!14 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 4)) 0))
      (a!15 (> (+ (+ it673 it1729)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!16 (> (+ (+ (* it803 it819) (* it673 it819)) it1729 1) 0))
      (a!17 (>= (+ (+ it1731 (* it1729 (- 1))) (- 2)) 0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (+ (+ a!4 it817) (* it1735 (- 1)) (* it1729 (- 1))))
      (a!10 (>= (+ (+ (+ a!4 it817) (* it1729 (- 1))) (- 2)) 0))
      (a!12 (> (+ (+ (+ a!4 it817) (* it1729 (- 1))) (- 1)) 0))
      (a!18 (>= (+ (+ (+ a!4 it817) (* it1729 (- 1))) (- 1)) 0)))
  (and (> it107 0)
       (> (+ (+ it673 it1729) 1) 0)
       (> a!1 0)
       (> it817 0)
