...
(assert (let ((a!1 (+ (* (* it673 it819) (- 1))
      ...
      (a!2 (+ (* it1273 (- 1))
              ...
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!4 (+ (+ it1273 (* (+ it819 (- 1)) it1276))
              it673
              (* (+ it819 (- 1)) it673)
              1))
      (a!5 (+ (+ (* it1273 (- 1)) (* (* it673 it819) (- 1)))
              it817
              (* (* it819 it1276) (- 1))))
      (a!6 (>= (+ (+ (* it1273 (- 1)) it1275) (- 2)) 0))
      (a!7 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 2)) 0))
      (a!8 (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (* it1276 (- 1))))
      (a!9 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 3)) 0))
      (a!10 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 4)) 0))
      (a!11 (>= (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!12 (+ (+ it1273 (* (+ it819 (- 1)) it1276))
               (* (+ it819 (- 1)) it673)
               1))
      (a!13 (+ (+ (* it1273 (- 1)) (* (* it673 it819) (- 1)))
               (* it1267 (- 1))
               it817
               (* (* it819 it1276) (- 1))))
      (a!15 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0)))
(let ((a!3 (>= (+ (+ a!2 (* it1276 (- 1))) (- 2)) 0))
      (a!14 (>= (+ (+ a!2 (* it1276 (- 1))) (- 1)) 0))
      (a!16 (>= (+ (+ a!2 (* it1276 (- 1))) (- 3)) 0)))
  (and (<= a!1 0)
       a!3
       (>= (+ it1274 (* it1269 (- 1))) 0)
       (>= (+ a!2 (- 2)) 0)
       ...
       (> (+ it1275 1) 0)
       (> (+ it1273 1) 0)
       (<= (+ (* it673 it819) it1267 (* it819 it1276)) 0)
       (> a!2 0)
       a!10
       (> it1269 0)
       (>= (+ a!8 (- 3)) 0)
       ...
       (>= (+ it1272 (* it1269 (- 1))) 0)
       (> it1271 0)
       (> (+ it1273 (* it673 it819) (* it819 it1276) 1) 0)
       a!16))))
(check-sat)
