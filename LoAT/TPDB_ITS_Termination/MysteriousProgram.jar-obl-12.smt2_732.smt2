...
(assert (let ((a!1 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!2 (+ (+ (+ (* it1615 (- 1)) (* it803 (- 1))) it127) (- 1)))
      (a!3 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!4 (>= (+ (+ (* it1615 (- 1)) it127) (- 4)) 0))
      (a!5 (+ (+ (+ (* it1615 (- 1)) (* it803 (- 1))) it127) (- 2)))
      (a!6 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!7 (> (+ (+ (* it1615 (- 1)) (* it803 (- 1))) (* it909 (- 1)) it127) 0))
      (a!8 (>= (+ (+ (* it1615 (- 1)) it127) (- 3)) 0))
      (a!9 (+ (+ (+ (* it1615 (- 1)) (* it803 (- 1))) it127) (- 3)))
      (a!10 (>= (+ (+ (* it1615 (- 1)) it127) (- 2)) 0))
      (a!11 (> (+ (+ (* it1615 (- 1)) (* it803 (- 1))) it127) 0)))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (<= (+ it1616 (* it102 (- 1))) 0)
       a!1
