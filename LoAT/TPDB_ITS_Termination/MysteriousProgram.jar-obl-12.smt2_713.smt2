...
(assert (let ((a!1 (* (+ (* it803 it819) (* it673 it819)) (+ it1022 (- 1))))
      (a!3 (+ (+ (+ (* it803 it819) (* it673 it819)) it999)
              (* it673 (- 1))
              (* it997 (- 1))))
      (a!4 (+ (+ (+ (* it803 it819) (* it673 it819)) it999)
              (* it803 (- 1))
              (* it673 (- 1))
              (* it997 (- 1))))
      (a!5 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!8 (+ (+ (* it803 it819) (* it673 it819))
              (* (* (+ it1022 (- 1)) it803 it819) (- 1))
              (* (* (+ it1022 (- 1)) it673 it819) (- 1))
              it999))
      (a!11 (+ (+ (+ (* it803 it819) (* it673 it819)) it999) (* it997 (- 1))))
      (a!17 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!2 (> (+ (* (+ it1022 (- 1)) it803 it819)
      ...
      (a!6 (+ a!5
              ...
              (* (+ it1022 (- 1)) it673 it819)))
      (a!9 (+ a!8 (* it803 (- 1)) (* it673 (- 1)) a!1 (* it997 (- 1))))
      (a!13 (+ a!3
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (> (+ (+ a!5 it997)
      ...
      (a!16 (+ a!4
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!18 (+ (+ a!8 (* it673 (- 1)) a!1 (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!19 (>= (+ (+ a!8 (* it673 (- 1)) a!1 (* it997 (- 1))) (- 4)) 0))
      (a!20 (>= (+ (+ a!8 (* it673 (- 1)) a!1 (* it997 (- 1))) (- 3)) 0))
      (a!22 (> (+ (+ a!5 it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!23 (>= (+ (+ a!8 (* it673 (- 1)) a!1 (* it997 (- 1))) (- 2)) 0)))
(let ((a!7 (> (+ (+ a!6 (* a!1 (- 1)) it997)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!10 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (> (+ (+ a!6 (* a!1 (- 1)) it997) 1) 0))
      (a!14 (> (+ (+ a!6 it673 (* a!1 (- 1)) it997) 1) 0))
      (a!21 (> (+ (+ a!6 it673 (* a!1 (- 1)) it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0)))
