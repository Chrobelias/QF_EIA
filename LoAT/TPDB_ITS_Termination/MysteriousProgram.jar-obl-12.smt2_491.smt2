...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) it817)
              ...
              (* it673 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!3 (+ (+ (+ (* it1045 it359) it1398) (* it1045 it909))
              (* (+ it819 (- 1)) it673)
              (* it803 (+ it819 (- 1)))
              1))
      (a!4 (+ (* (* it1045 it359) (- 1))
              ...
              (* it1398 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!5 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it1398 1)
              0))
      (a!6 (+ (+ (* (* it1045 it359) (- 1)) it817)
              (* it803 (- 1))
              (* it1398 (- 1))
              (* it673 (- 1))
              (* (* it1045 it909) (- 1))))
      ...
      (a!10 (+ (* (* it803 it819) (- 1))
               ...
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!11 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!12 (+ (+ (+ it1400 (* it1398 (- 1))) (* it359 (- 1))) (- 1)))
      (a!13 (+ (+ (+ (* it1045 it359) it1398) (* it1045 it909)) 1))
      (a!14 (+ (+ (* it1045 it359) it1398) it673 (* it1045 it909)))
      (a!16 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!18 (> (+ (+ it1400 (* it1398 (- 1))) (* it359 (- 1))) 0))
      (a!20 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!7 (+ a!6
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (+ (+ (+ a!8 (* it1398 (- 1))) (* it359 (- 1))) (- 1)))
      (a!15 (> (+ a!14 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!17 (> (+ (+ a!8 (* it1398 (- 1))) (* it359 (- 1))) 0))
      (a!19 (> (+ (+ a!8 (* it1398 (- 1))) (- 1)) 0))
      (a!21 (>= (+ (+ a!8 (* it1398 (- 1))) (- 2)) 0)))
  (and (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       ...
       (>= (+ it1399 (- 1)) 0)
       (>= (+ a!7 (- 1)) 0)
       (> (+ a!8 (* it909 (- 1)) (* it1398 (- 1)) (* it359 (- 1))) 0)
       (> it1399 0)
       (> (+ it1398 it359 1) 0)
       a!18
       (>= (+ (* it818 (- 1)) it1399) 0)
