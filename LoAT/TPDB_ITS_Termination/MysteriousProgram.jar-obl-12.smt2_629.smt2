...
(assert (and (> it140 0)
     ...
     (> (+ it1518 (* it1516 (- 1))) 0)
     (>= (+ it1514 (- 1)) 0)
     (> (+ (* it310 (- 1)) (* it1516 (- 1)) it127 1) 0)
     (> (+ (* it1516 (- 1)) it127) 0)
     (> it1514 0)
     (> (+ it1518 (- 1)) 0)
     (> (+ it1518 (* it1515 (- 1))) 0)))
(assert (= (+ it1528 (* it1513 (- 1))) 0))
(assert (= (+ (* it140 (- 1)) it1529) 0))
(assert (= (+ it1530 (* it1515 (- 1))) 0))
(assert (= (+ it1531 (* it310 (- 1)) (* it1516 (- 1))) 0))
(assert (= (+ (* it310 (- 1)) (* it1516 (- 1)) it1532) 0))
(assert (= (+ it1533 (* it127 (- 1))) 0))
(assert (and (>= (+ it1529 (- 1)) 0)
     (> it1529 0)
     (>= (+ it292 (- 1)) 0)
     (> (+ it1533 (* it1531 (- 1))) 0)
     (>= (+ it1531 (* it1532 (- 1))) 0)
     (> (+ it1533 1) 0)
     (> (+ it1533 (* it292 (- 1)) (* it1531 (- 1)) 1) 0)
     (>= (+ (* it1535 (- 1)) it1529) 0)
     (>= (+ (* it1531 (- 1)) it1532) 0)
     (>= (+ it1528 (- 10)) 0)
     (> (+ it1530 1) 0)
     ...
     (> (+ it1533 (- 1)) 0)
     (> (+ it1533 (* it1530 (- 1))) 0)))
(assert (= (+ it1537 (* it1528 (- 1))) 0))
(assert (= (+ (* it1535 (- 1)) it1538) 0))
(assert (= (+ it1539 (* it1530 (- 1))) 0))
(assert (= (+ (* it292 (- 1)) it1540 (* it1531 (- 1))) 0))
(assert (= (+ (* it292 (- 1)) (* it1531 (- 1)) it1541) 0))
...
(assert (and (> it110 0)
     ...
     (> it1538 0)))
(assert (= (+ it1545 (- 6)) 0))
(assert (= (+ it1546 (* it110 (- 1))) 0))
(assert (= (+ (* it109 (- 1)) it1547) 0))
(assert (= (+ (* it1539 (- 1)) it1548 (- 1)) 0))
(assert (= (+ it1549 (* it107 (- 1))) 0))
(assert (= (+ (* it1542 (- 1)) it1550) 0))
(assert (let ((a!1 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
      ...
      (a!2 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!3 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 2)))
      (a!4 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 4)))
      (a!7 (> (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) 0))
      (a!8 (> (+ (+ it1550 (* it1548 (- 1))) (- 1)) 0))
      (a!9 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1548 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!10 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it1548 1))
      (a!11 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  (* (+ it1045 (- 1)) it359)
      ...
      (a!12 (+ (* (* it803 it819) (- 1))
               ...
               (* it909 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!13 (> (+ (+ (* it803 it819) (* it673 it819)) it1548 1) 0))
      (a!14 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!16 (>= (+ (+ it1550 (* it1548 (- 1))) (- 1)) 0))
      (a!18 (>= (+ (+ it1550 (* it1548 (- 1))) (- 2)) 0))
      (a!20 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1548 (- 1))))
      (a!21 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it359 it1548 1))
      (a!22 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 3)))
      (a!24 (> (+ it673
                  (* (+ it819 (- 1)) it673)
                  it1548
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!25 (> (+ (* (+ it819 (- 1)) it673) it1548 (* it803 (+ it819 (- 1))) 1)
               0)))
(let ((a!5 (+ (+ (+ a!2 (* it909 (- 1))) (* it1548 (- 1))) (- 2)))
      (a!6 (+ (+ a!2 (* it909 (- 1))) (* it359 (- 1)) (* it1548 (- 1))))
      (a!15 (+ (+ (+ a!14 (* it909 (- 1))) (* it1548 (- 1))) (- 1)))
      (a!17 (+ (+ a!14 (* it909 (- 1))) (* it359 (- 1)) (* it1548 (- 1))))
      (a!19 (+ (+ (+ a!14 (* it909 (- 1))) (* it1548 (- 1))) (- 2)))
      (a!23 (> (+ (+ a!14 (* it1548 (- 1))) (- 1)) 0))
      (a!26 (+ (+ (+ a!2 (* it909 (- 1))) (* it1548 (- 1))) (- 1)))
      (a!27 (> (+ (+ a!14 (* it909 (- 1))) (* it1548 (- 1))) 0)))
  (and (> (+ it1550 (* it1548 (- 1))) 0)
       (>= (+ a!1 (- 3)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (<= (+ it1546 (* it1138 (- 1))) 0)
