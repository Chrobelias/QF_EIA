...
(assert (let ((a!1 (+ (+ (+ it1089 (* it1087 (- 1))) (* it359 (- 1))) (- 1)))
      (a!2 (+ (+ (* (* it1045 it359) (- 1)) (* it1087 (- 1)))
              (* (* it1045 it909) (- 1))
              it1091))
      (a!3 (>= (+ (+ it1089 (* it1087 (- 1))) (- 1)) 0))
      (a!4 (+ (* (* it1045 it359) (- 1))
              it1089
              (* it1087 (- 1))
              (* (* it1045 it909) (- 1))))
      ...
      (a!7 (+ (* (* it1045 it359) (- 1))
              (* it1081 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!8 (> (+ (+ it1089 (* it1087 (- 1))) (- 1)) 0))
      (a!9 (+ (+ (* (* it1045 it359) (- 1)) (* it1087 (- 1)))
              (* it1081 (- 1))
              (* (* it1045 it909) (- 1))
              it1091))
      (a!11 (> (+ (+ it1089 (* it1087 (- 1))) (* it359 (- 1))) 0))
      (a!12 (> (+ (+ it1089 (* it1087 (- 1))) (* it909 (- 1)) (* it359 (- 1)))
               0))
      (a!13 (>= (+ (+ it1089 (* it1087 (- 1))) (- 2)) 0))
      (a!14 (> (+ (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it1087
                  1)
               0)))
(let ((a!6 (> (+ (+ a!5 (* it359 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ a!5 (* it359 (- 1))) (- 1)) 0)))
  (and (> (+ it1091 (- 1)) 0)
       (> a!1 0)
       (<= (+ (* it1045 it359) it1081 (* it1045 it909)) 0)
       (> a!2 0)
       a!3
       (>= (+ it1084 (- 6)) 0)
       (> (+ it1089 (* it1087 (- 1))) 0)
       (>= (+ it1085 (- 1)) 0)
       (> it1091 0)
       (> (+ (* it1045 it359) it1087 (* it1045 it909) 1) 0)
       (>= (+ a!4 (- 1)) 0)
       (> (+ it1089 1) 0)
       (>= (+ it1086 (- 1)) 0)
       (>= (+ it1081 (- 1)) 0)
