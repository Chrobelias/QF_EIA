...
(assert (let ((a!1 (> (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (>= (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!4 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1729 (- 1))))
      (a!5 (>= (+ (+ it1731 (* it1729 (- 1))) (- 2)) 0))
      (a!6 (> (+ (+ it673 it1729)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!7 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!8 (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (> (+ (+ (* it803 it819) (* it673 it819)) it1729 1) 0))
      (a!12 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 4)) 0))
      (a!13 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 2)) 0))
      (a!14 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 3)) 0))
      (a!15 (> (+ it1729 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0)))
(let ((a!9 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!10 (> (+ (+ (+ a!2 it817) (* it1729 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       a!1
       (>= (+ it1730 (- 1)) 0)
       (> it817 0)
