...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1))
              ...
              (* (* it673 it819) (- 1))
              it817))
      (a!2 (+ (+ (* it1572 (- 1)) it817) (* it803 (- 1)) (* it673 (- 1))))
      (a!4 (+ (+ (+ (* it1572 (- 1)) it817) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!5 (> (+ (+ (* it1572 (- 1)) it817) (* it673 (- 1))) 0))
      (a!6 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it1576 (- 1))))
      (a!7 (+ (+ (+ (* it1572 (- 1)) it817) (* it673 (- 1))) (- 4)))
      (a!8 (>= (+ (+ (* it1572 (- 1)) it1574) (- 1)) 0))
      (a!9 (+ (+ (+ (* it1572 (- 1)) it817) (* it673 (- 1))) (- 3)))
      (a!10 (> (+ (+ (* it1572 (- 1)) it1574) (- 1)) 0))
      (a!11 (> (+ it1572 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!12 (> (+ (+ it1572 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!13 (+ (+ (+ (* it1572 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!14 (>= (+ (+ (* it1572 (- 1)) it1574) (- 2)) 0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (> it817 0)
       ...
       a!12
       (>= a!13 0)
       (> (+ (* it803 it819) it1572 (* it673 it819) 1) 0)
       (<= (+ (* it817 (- 1)) it1574) 0)
       (>= (+ (* it1569 (- 1)) 6) 0)
       (> a!4 0)
       (> it1571 0)
       ...
       (>= (+ a!4 (- 2)) 0)
       (= (+ (* it817 (- 1)) it1574) 0)
       (<= (+ (* it803 it819) (* it673 it819) it1576) 0)))))
(check-sat)
