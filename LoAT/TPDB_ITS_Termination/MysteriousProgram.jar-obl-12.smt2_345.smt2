...
(assert (let ((a!1 (+ (+ (+ (* it1273 (- 1)) (* it1268 (- 1))) it1275) (- 1)))
      (a!2 (+ (* it1273 (- 1))
              it1277
              (* (* it1267 it1266) (- 1))
              (* (* it1268 it1266) (- 1))))
      (a!3 (+ (* it1273 (- 1))
              ...
              it1275
              (* (* it1267 (+ it1266 (- 1))) (- 1))))
      (a!4 (> (+ (+ (* it1273 (- 1)) (* it1268 (- 1))) it1275) 0))
      (a!5 (+ (+ (* it1273 (- 1)) it1275)
              (* (* it1267 it1266) (- 1))
              (* (* it1268 it1266) (- 1))))
      (a!6 (+ (+ (* it1273 (- 1)) (* it1268 (- 1)))
              (* (* it1268 (+ it1266 (- 1))) (- 1))
              it1275
              (* (* it1267 (+ it1266 (- 1))) (- 1))))
      (a!7 (+ (* it1273 (- 1)) (* it1267 (- 1)) (* it1268 (- 1))))
      (a!8 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!9 (+ (* (* it1267 it1266) (- 1))
              (* (* it1268 it1266) (- 1))
              (* it1276 (- 1))))
      (a!13 (>= (+ (+ (* it1273 (- 1)) it1275) (- 2)) 0))
      (a!14 (>= (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!15 (> (+ it1273
                  (* it1268 (+ it1266 (- 1)))
                  (* it1267 (+ it1266 (- 1)))
                  1)
               0)))
(let ((a!10 (>= (+ (+ a!2 (* it1276 (- 1))) (- 3)) 0))
      (a!11 (>= (+ (+ a!2 (* it1276 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ a!2 (* it1276 (- 1))) (- 2)) 0))
      (a!16 (+ a!7
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               it1275
               (* (* it1267 (+ it1266 (- 1))) (- 1)))))
  (and (> a!1 0)
       ...
       (> it1278 0)
       (> (+ a!7 it1275) 0)
       (> (+ it1273 (* it1267 it1266) (* it1268 it1266) 1) 0)
       (<= (+ it1274 (* it1278 (- 1))) 0)
       (> a!6 0)
       (> a!2 0)
       (>= (+ it1266 (- 1)) 0)
       ...
       (> (+ a!5 (- 1)) 0)
       (>= (+ it1271 (* it1278 (- 1))) 0)
       (<= (+ (* it1267 it1266) (* it1268 it1266) it1276) 0)
       (>= (+ it1271 (- 1)) 0)
       (> (+ it1277 1) 0)
       a!11
       (> it1275 0)
