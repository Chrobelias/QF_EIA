...
(assert (let ((a!1 (> (+ (+ (* it999 (- 1)) it1246) 1) 0))
      (a!2 (> (+ (+ it1248 (* it1246 (- 1))) 1) 0))
      (a!3 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ (* it999 (- 1)) it1246) (- 2)) 0))
      (a!5 (>= (+ (+ it1248 (* it1246 (- 1))) (- 3)) 0))
      (a!6 (>= (+ (+ it1248 (* it1246 (- 1))) (- 2)) 0))
      (a!7 (<= (+ (+ (* it1248 (- 1)) it999) it1246 (* it997 (- 1))) 0))
      (a!8 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ (* it999 (- 1)) it1246) (- 3)) 0))
      (a!10 (> (+ (+ (* it999 (- 1)) it1246) (- 1)) 0)))
  (and (> it110 0)
       (> it107 0)
       (> it109 0)
       (> (+ it999 1) 0)
