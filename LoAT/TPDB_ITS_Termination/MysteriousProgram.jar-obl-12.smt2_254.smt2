...
(assert (let ((a!1 (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1103 (- 1))))
      (a!4 (>= (+ (+ it1105 (* it1103 (- 1))) (- 2)) 0))
      (a!5 (> (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!6 (> (+ (+ it673 it1103)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 4)) 0))
      (a!8 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 3)) 0))
      (a!9 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!11 (> (+ it1103 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (> (+ it1103 1) 0)
       ...
       a!11
       (> it1101 0)))))
(assert (= (+ it1108 (* it1100 (- 1))) 0))
(assert (= (+ it1109 (* it818 (- 1))) 0))
(assert (= (+ (* it818 (- 1)) it1110) 0))
(assert (= (+ (* it803 it819 (- 1)) (* it673 it819 (- 1)) it1111 (* it1103 (- 1))) 0))
(assert (= (+ it1112 (* it818 (- 1))) 0))
(assert (= (+ (* it817 (- 1)) it1113) 0))
(assert (let ((a!1 (> (+ (+ (* it1111 (- 1)) it1113) (- 1)) 0)))
  (and (>= (+ it1107 (- 1)) 0)
       (>= (+ it1106 (- 1)) 0)
       (> it1113 0)
       (> (+ (* it1111 (- 1)) it1113) 0)
       ...
       (>= (+ it1108 (- 6)) 0)
       (> it1109 0))))
(assert (= (+ (* it1108 (- 1)) it1119) 0))
(assert (= (+ (* it1107 (- 1)) it1120) 0))
(assert (= (+ it1121 (* it1107 (- 1))) 0))
(assert (= (+ (* it1111 (- 1)) (* it1106 (- 1)) it1122) 0))
(assert (= (+ it1123 (* it1107 (- 1))) 0))
(assert (= (+ it1124 (* it1113 (- 1))) 0))
(assert (let ((a!1 (+ (+ (+ it1124 (* it1122 (- 1))) (* it359 (- 1))) (- 1)))
      (a!2 (+ (* (* (+ it1045 (- 1)) it359) (- 1)) it1124))
      (a!5 (> (+ (+ it1124 (* it1122 (- 1))) (* it359 (- 1))) 0))
      (a!6 (>= (+ (+ it1124 (* it1122 (- 1))) (- 2)) 0))
      (a!7 (> (+ (* (+ it1045 (- 1)) it359)
                 it1122
                 (* (+ it1045 (- 1)) it1125)
                 1)
              0))
      (a!9 (> (+ (+ it1124 (* it1122 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it1124 (* it1122 (- 1))) (- 1)) 0)))
(let ((a!3 (+ (+ a!2 (* it1122 (- 1)))
              (* it359 (- 1))
              (* (* (+ it1045 (- 1)) it1125) (- 1))))
      (a!4 (+ a!2
              (* it1125 (- 1))
              ...
              (* it359 (- 1))
              (* (* (+ it1045 (- 1)) it1125) (- 1))))
      (a!8 (+ (+ a!2 (* it1122 (- 1))) (* (* (+ it1045 (- 1)) it1125) (- 1)))))
  (and (>= (+ (* it1119 (- 1)) 6) 0)
       (>= a!1 0)
       (> (+ it1124 1) 0)
       (>= (+ it1125 (- 1)) 0)
       (> (+ it1124 (* it1125 (- 1)) (* it1122 (- 1)) (* it359 (- 1))) 0)
       (> it1126 0)
       (> a!1 0)
       (>= (+ it1121 (- 1)) 0)
       (> (+ a!3 (- 1)) 0)
       ...
       a!9
       a!10))))
(assert (= (+ it1127 (* it1119 (- 1))) 0))
(assert (= (+ it1128 (* it1126 (- 1))) 0))
(assert (= (+ it1129 (* it1126 (- 1))) 0))
(assert (= (+ (* it1045 it359 (- 1)) it1130 (* it1122 (- 1)) (* it1045 it1125 (- 1))) 0))
(assert (= (+ it1131 (* it1126 (- 1))) 0))
(assert (= (+ (* it1124 (- 1)) it1132) 0))
(assert (let ((a!1 (>= (+ (+ (* it1130 (- 1)) it1132) (- 2)) 0))
      (a!2 (>= (+ (+ (* it1130 (- 1)) (* it1118 (- 1)) it1116) (- 4)) 0))
      (a!3 (+ (* it1130 (- 1))
              (* (* it1114 it1118) (- 1))
              (* (* it1117 it1114) (- 1))
              it1116))
      ...
      (a!6 (+ (* it1117 (- 1))
              ...
              (* it1118 (- 1))
              it1116))
      (a!7 (>= (+ (+ (* it1130 (- 1)) (* it1118 (- 1)) it1116) (- 3)) 0))
      (a!8 (+ (* it1117 (- 1)) (* it1130 (- 1)) (* it1118 (- 1)) it1116))
      (a!9 (> (+ (* it1130 (- 1))
                 (* it1134 (- 1))
                 (* (* it1114 it1118) (- 1))
                 (* (* it1117 it1114) (- 1))
                 it1116)
              0))
      (a!10 (> (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0))
      (a!11 (+ (* it1118 (+ it1114 (- 1))) it1130 (* it1117 (+ it1114 (- 1)))))
      (a!12 (>= (+ (+ (* it1130 (- 1)) (* it1118 (- 1)) it1116) (- 2)) 0))
      (a!13 (>= (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0)))
  (and (>= (+ it1129 (- 1)) 0)
       (>= (+ it1117 (- 1)) 0)
       a!1
       (>= (+ it1131 (- 1)) 0)
       ...
       (>= (+ a!6 (- 3)) 0)
       (> (+ a!11 1) 0)
       (<= (+ it1134 (* it1114 it1118) (* it1117 it1114)) 0)
       (>= (+ it1134 (- 1)) 0)
       (>= (+ it1136 (- 1)) 0)
       (<= (+ (* it1136 (- 1)) it1131) 0)
       (= (+ (* it1116 (- 1)) it1132) 0)
       ...
       (>= (+ a!6 (- 1)) 0)
       (> (+ a!11 it1118 1) 0)
       (> (+ it1130 (* it1114 it1118) (* it1117 it1114) 1) 0)
       (>= (+ (* it1127 (- 1)) 6) 0)
       (>= (+ it1128 (- 1)) 0)
       (> (+ (* it1130 (- 1)) (* it1118 (- 1)) it1116) 0)
       (<= (+ (* it1116 (- 1)) it1132) 0)
       a!12
       (> it1129 0)
       a!13)))
