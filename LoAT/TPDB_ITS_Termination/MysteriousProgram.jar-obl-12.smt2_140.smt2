...
(assert (let ((a!1 (> (+ (+ it909 it997)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!2 (> (+ (+ it909 it673 it997)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!3 (>= (+ (+ it999 (* it909 (- 1)) (* it997 (- 1))) (- 2)) 0))
      ...
      (a!5 (+ it817
              ...
              (* it673 (- 1))
              (* it997 (- 1))))
      (a!6 (+ it817 (* it909 (- 1)) (* it673 (- 1)) (* it997 (- 1))))
      (a!9 (+ (+ it999 (* it909 (- 1)) (* it997 (- 1))) (- 1)))
      (a!10 (+ (* (* it803 it819) (- 1))
               (* (* it673 it819) (- 1))
               (* it909 (- 1)))))
(let ((a!7 (+ a!6
