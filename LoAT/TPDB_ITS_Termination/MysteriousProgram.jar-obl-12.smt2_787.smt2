...
(assert (let ((a!1 (>= (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!2 (+ (+ (* it803 (- 1)) it1093) (* it673 (- 1)) (* it1679 (- 1))))
      (a!3 (+ (+ (+ (* it803 (- 1)) it1093) (* it1679 (- 1))) (- 3)))
      (a!4 (>= (+ (+ it1681 (* it1679 (- 1))) (- 2)) 0))
      (a!5 (> (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!6 (> (+ (+ (* it803 (- 1)) it1093) (* it1679 (- 1))) 0))
      (a!7 (+ (+ (+ (* it803 (- 1)) it1093) (* it1679 (- 1))) (- 2))))
  (and (> it1093 0)
       (>= (+ it673 (- 1)) 0)
       (> (+ it1681 1) 0)
       (<= (+ it1677 (* it1094 (- 1))) 0)
