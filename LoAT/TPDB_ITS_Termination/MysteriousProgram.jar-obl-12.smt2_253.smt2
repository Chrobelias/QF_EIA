...
(assert (let ((a!1 (>= (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0))
      (a!2 (+ (+ (* it1130 (- 1)) (* it1135 (- 1)) it1132) (- 1)))
      (a!3 (>= (+ (+ (* it1130 (- 1)) it1132) (- 2)) 0))
      (a!4 (> (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0)))
  (and a!1
       (<= (+ it1134 it1135) 0)
       (> (+ it1130 it1135 1) 0)
       (> (+ (* it1130 (- 1)) (* it1134 (- 1)) (* it1135 (- 1)) it1132) 0)
       (> it1129 0)
       (> (+ it1130 1) 0)
       (> (+ it1132 (- 1)) 0)
       (>= (+ (* it1136 (- 1)) it1131) 0)
