...
(assert (let ((a!1 (+ it1352
              (* (* it1045 it359) (- 1))
              (* it1350 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!2 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
              (* it1350 (- 1))
              (* (* it1045 it909) (- 1))
              it127))
      (a!3 (+ (* (* it1045 it359) (- 1))
              ...
              (* (* it1045 it909) (- 1))
              it127))
      (a!4 (>= (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!5 (+ it1352
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* it1350 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!7 (+ (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) (- 1)))
      (a!8 (> (+ (+ it1352 (* it1350 (- 1))) (* it909 (- 1)) (* it359 (- 1))) 0))
      (a!9 (> (+ (* (+ it1045 (- 1)) it359) it1350 (* (+ it1045 (- 1)) it909) 1)
              0))
      (a!10 (> (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) 0))
      (a!11 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
               (* (* it1045 it909) (- 1))))
      (a!12 (> (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ it1352 (* it1350 (- 1))) (- 2)) 0)))
(let ((a!6 (>= (+ (+ a!5 (* it359 (- 1))) (- 1)) 0))
      (a!13 (> (+ (+ a!5 (* it359 (- 1))) (- 1)) 0)))
  (and (> (+ it127 1) 0)
       (> (+ a!1 (- 1)) 0)
       (>= (+ a!1 (- 2)) 0)
       (> a!1 0)
       ...
       (> it1348 0)
       a!13
       (> (+ (* it1045 it359) it1350 (* it1045 it909) 1) 0)
       (>= a!7 0)
       (= a!11 0)
       (>= (+ a!2 (- 3)) 0)
       (> (+ it1352 1) 0)
