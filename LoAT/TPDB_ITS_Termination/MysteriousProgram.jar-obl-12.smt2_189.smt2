...
(assert (let ((a!1 (+ it817 (* it909 (- 1)) (* it673 (- 1)) (* it1078 (- 1))))
      (a!3 (+ it817
              (* it1081 (- 1))
              (* it909 (- 1))
              (* it673 (- 1))
      ...
      (a!4 (> (+ (+ it909 it1078)
                 ...
                 1)
              0))
      (a!6 (> (+ (+ it1080 (* it1078 (- 1))) (- 1)) 0))
      (a!7 (> (+ (+ it909 it673 it1078)
                 (* (+ it819 (- 1)) it673)
                 (* (+ it819 (- 1)) it1081)
                 1)
              0))
      (a!8 (+ (+ it1080 (* it909 (- 1)) (* it1078 (- 1))) (- 1)))
      (a!9 (+ (* (* it673 it819) (- 1))
              (* (* it1081 it819) (- 1))
              (* it909 (- 1))))
      (a!10 (>= (+ (+ it1080 (* it909 (- 1)) (* it1078 (- 1))) (- 2)) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* (+ it819 (- 1)) it1081) (- 1))))
      (a!5 (+ a!3
  ...
  (and (> (+ it1078 1) 0)
       ...
       (>= (+ a!5 (- 2)) 0)
       a!10
       (> (+ (+ it909 it673 it1078) 1) 0)
       (> a!8 0)
       (> a!1 0)
       (>= (+ it909 (- 1)) 0)
       (<= (+ it1076 (* it818 (- 1))) 0)
       (<= (+ (* it673 it819) (* it1081 it819) it909) 0)
       (> it1079 0)
       (>= (+ (* it1075 (- 1)) 6) 0)))))
(check-sat)
