...
(assert (let ((a!1 (>= (+ (+ it1602 (* it1600 (- 1))) (- 2)) 0))
      (a!2 (+ (* it1595 (- 1)) (* it1596 (- 1)) (* it1600 (- 1)) it1594))
      (a!3 (> (+ (* (+ it1592 (- 1)) it1596)
                 (* (+ it1592 (- 1)) it1595)
                 it1600
                 1)
      ...
      (a!4 (> (+ (* (+ it1045 (- 1)) it1137)
                 ...
                 1)
              0))
      (a!5 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 4)) 0))
      (a!6 (+ (* it1595 (- 1))
              (* (* (+ it1592 (- 1)) it1596) (- 1))
              (* it1596 (- 1))
              (* (* (+ it1592 (- 1)) it1595) (- 1))
      ...
      (a!7 (> (+ (* it1137 (- 1))
                 ...
                 (* (* it1592 it1596) (- 1)))
              0))
      (a!8 (+ (* (* (+ it1045 (- 1)) it1137) (- 1))
              (* (* (+ it1045 (- 1)) it1603) (- 1))
              (* it909 (- 1))))
      (a!10 (>= (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!11 (+ (* (* (+ it1592 (- 1)) it1596) (- 1))
               (* it1596 (- 1))
               (* (* (+ it1592 (- 1)) it1595) (- 1))
               (* it1600 (- 1))
               it1594))
      (a!12 (> (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!13 (+ (+ (* it909 (- 1)) (* (* it1595 it1592) (- 1)))
               (* (* it1045 it1603) (- 1))
               (* (* it1592 it1596) (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!14 (+ (* (* it1595 it1592) (- 1))
               (* it1600 (- 1))
               it1594
               (* (* it1592 it1596) (- 1))))
      (a!15 (> (+ (* (+ it1592 (- 1)) it1596)
                  it1596
                  (* (+ it1592 (- 1)) it1595)
                  it1600
                  1)
               0))
      (a!16 (+ (+ (* it909 (- 1)) (* (* it1595 it1592) (- 1)))
               (* it1600 (- 1))
               it1594
               (* (* it1592 it1596) (- 1))))
      (a!17 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 3)) 0))
      (a!18 (+ (* it909 (- 1))
               (* it1603 (- 1))
               (* (* it1595 it1592) (- 1))
               (* it1600 (- 1))
               it1594
               (* (* it1592 it1596) (- 1))))
      (a!20 (> (+ (+ it909 (* it1595 it1592)) it1600 (* it1592 it1596) 1) 0))
      (a!21 (<= (+ (+ it909 (* it1595 it1592))
                   (* it1045 it1603)
                   (* it1592 it1596)
                   (* it1137 it1045))
                0))
      (a!22 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 2)) 0))
      (a!23 (+ (* (* (+ it1045 (- 1)) it1137) (- 1))
               (* it1137 (- 1))
               (* (* (+ it1045 (- 1)) it1603) (- 1))
               (* it909 (- 1))
               (* it1603 (- 1))
...
(let ((a!9 (+ a!8
  ...
  (and (> (+ it1594 1) 0)
       ...
       (>= (+ a!6 (- 3)) 0)
       (> a!18 0)
       (> (+ (* it1595 it1592) it1600 (* it1592 it1596) 1) 0)
       (> it1594 0)
       (> a!11 0)
       (>= (+ a!19 (- 2)) 0)
       (> a!9 0)
       ...
       (>= (+ a!16 (- 2)) 0)
       a!21
       (> (+ it909 it1603 (* it1595 it1592) it1600 (* it1592 it1596) 1) 0)
       (> (+ it1602 (* it1600 (- 1))) 0)
       (> (+ a!19 (- 1)) 0)
       (>= (+ a!16 (- 1)) 0)
       (>= (+ a!11 (- 2)) 0)
