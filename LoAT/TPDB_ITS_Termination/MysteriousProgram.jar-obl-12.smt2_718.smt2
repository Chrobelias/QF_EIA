...
(assert (let ((a!1 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909))
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!2 (+ (* (+ it1303 (- 1)) it673 it819)
              (* (* (+ it1303 (- 1)) it1045) it359)
              (* (+ it1303 (- 1)) it803 it819)))
      (a!4 (* (* (* (+ it1303 (- 1)) it1045) it359) (- 1)))
      (a!6 (* (* (* (+ it1303 (- 1)) it1045) it909) (- 1)))
      (a!8 (+ (* it1045 it359)
              (* (+ it1303 (- 1)) it673 it819)
              (* (* (+ it1303 (- 1)) it1045) it359)
              (* (+ it1303 (- 1)) it803 it819)
              (* (* (+ it1303 (- 1)) it1045) it909)))
      (a!10 (+ (+ (* (* it1045 it359) (- 1)) it999)
               (* it803 (- 1))
               (* it673 (- 1))
               (* it997 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!12 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!13 (+ (+ (* (* it1045 it359) (- 1)) it999)
               (* it673 (- 1))
               (* it997 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!17 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!20 (+ (+ (* (* it1045 it359) (- 1)) it999)
               (* it997 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!21 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!22 (= (+ (* it803 it819 (- 1))
                  (* (* it1045 it359) (- 1))
                  (* it673 it819 (- 1))
                  (* (* it1045 it909) (- 1)))
               0))
      (a!23 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909)) 1) 0))
      (a!24 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
               it999
               (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!27 (> (+ (+ (* it1045 it359) it997 (* it1045 it909)) 1) 0))
      (a!30 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!32 (> (+ (+ (* it1045 it359) it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!33 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!34 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0)))
(let ((a!3 (+ a!2
              (* (+ it1045 (- 1)) it359)
              (* (+ it1045 (- 1)) it909)
      ...
      (a!5 (+ (* (* it1045 it359) (- 1))
              ...
              it999))
      (a!9 (> (+ (+ a!8 it997 (* it1045 it909)) 1) 0))
      (a!11 (+ a!10
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (+ a!13
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!18 (+ a!2 (* (* (+ it1303 (- 1)) it1045) it909) it997))
      (a!25 (> (+ (+ a!24 (* it997 (- 1))) (- 1)) 0))
      (a!26 (+ (+ (+ a!24 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!28 (> (+ (+ a!8 it673 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!29 (> (+ (+ a!8 it673 it997 (* it1045 it909)) 1) 0))
      (a!31 (> (+ (+ a!24 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!35 (>= (+ (+ a!24 (* it997 (- 1))) (- 2)) 0))
      (a!36 (> (+ (+ a!8 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0)))
...
(let ((a!16 (+ a!15
  ...
  (and (>= (+ it1303 (- 1)) 0)
       ...
       (>= (+ (* it994 (- 1)) 6) 0)
       (> a!15 0)
       (> (+ a!24 (* it909 (- 1)) (* it997 (- 1)) (* it359 (- 1))) 0)
       (>= (+ a!13 (- 4)) 0)
       a!36
       (>= (+ a!15 (- 2)) 0)
       (>= (+ a!15 (- 4)) 0)
