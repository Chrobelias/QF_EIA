...
(assert (let ((a!1 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 3)) 0))
      (a!2 (>= (+ (+ (* it1273 (- 1)) it1275) (- 2)) 0))
      (a!3 (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (* it1276 (- 1))))
      (a!4 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!5 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 2)) 0))
      (a!6 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 4)) 0))
      (a!7 (>= (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0)))
  (and (<= (+ it1271 (* it818 (- 1))) 0)
       (>= (+ (* it818 (- 1)) it1272) 0)
       (>= (+ it1271 (- 1)) 0)
       (>= (+ (* it1270 (- 1)) 6) 0)
       (> it817 0)
