...
(assert (let ((a!1 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!2 (* (+ (* it803 it819) (* it673 it819)) (+ it921 (- 1))))
      (a!4 (+ (+ it1615 (* (+ it819 (- 1)) it673)) (* it803 (+ it819 (- 1))) 1))
      (a!5 (>= (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) (- 1)) 0))
      (a!7 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 4)) 0))
      (a!8 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 3)) 0))
      (a!10 (+ (* it1615 (- 1)) (* it803 (- 1)) (* it673 (- 1)) it1617))
      (a!15 (> (+ (+ (* it803 it819) it1615 (* it673 it819)) 1) 0))
      (a!16 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!17 (+ (* (* it803 it819) (- 1))
               (* it1615 (- 1))
               (* (* it673 it819) (- 1))
               it1617))
      (a!20 (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617)
               (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!22 (+ (+ (+ it1615 it673) (* (+ it819 (- 1)) it673))
               (* it803 (+ it819 (- 1)))
               1))
      (a!23 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!26 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 2)) 0)))
(let ((a!3 (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617)
              a!2
              (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
              (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!6 (> (+ (+ (* it803 it819) it1615 (* it673 it819))
                 (* a!2 (- 1))
                 (* (* it673 it819) (+ it921 (- 1)))
                 (* (* it803 it819) (+ it921 (- 1)))
                 1)
              0))
      (a!9 (+ (+ it1615 (* (+ it819 (- 1)) it673))
              (* a!2 (- 1))
              (* (* it673 it819) (+ it921 (- 1)))
              (* it803 (+ it819 (- 1)))
              (* (* it803 it819) (+ it921 (- 1)))
              1))
      (a!11 (+ a!10 (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!13 (+ a!10
               a!2
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!18 (+ a!17
               ...
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!19 (+ (+ (* it1615 (- 1)) it1617)
               a!2
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!21 (+ a!20 (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!24 (+ a!20
               a!2
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!25 (+ (+ (+ it1615 it673) (* (+ it819 (- 1)) it673))
               (* a!2 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* it803 (+ it819 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
