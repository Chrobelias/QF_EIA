...
(assert (let ((a!1 (+ (+ (* it803 (- 1)) (* it997 (- 1)) it127) (- 1)))
      (a!2 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it997 (- 1)) it127) (- 4)) 0))
      (a!4 (>= (+ (+ (* it997 (- 1)) it127) (- 2)) 0))
      (a!5 (> (+ (+ (* it803 (- 1)) (* it909 (- 1))) (* it997 (- 1)) it127) 0))
      (a!6 (>= (+ (+ (* it803 (- 1)) (* it997 (- 1)) it127) (- 3)) 0))
      (a!7 (>= (+ (+ (* it803 (- 1)) (* it997 (- 1)) it127) (- 2)) 0))
      (a!8 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!9 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ (* it997 (- 1)) it127) (- 3)) 0)))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (>= a!1 0)
       (= (+ it999 (* it127 (- 1))) 0)
