...
(assert (let ((a!1 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 2)) 0))
      (a!2 (> (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ it1718 (* it1716 (- 1))) (- 2)) 0))
      (a!4 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 4)) 0))
      (a!5 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1716 (- 1))))
      (a!6 (>= (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 3)) 0)))
  (and (<= (+ (* it818 (- 1)) it1717) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       (> (+ it1718 (* it1716 (- 1))) 0)
