...
(assert (let ((a!1 (+ (* (* it1118 (+ it1114 (- 1))) (- 1))
              (* it1111 (- 1))
              (* (* it1117 (+ it1114 (- 1))) (- 1))
              (* it1118 (- 1))
              (* it1106 (- 1))
              it1116))
      (a!2 (> (+ (+ (* it1111 (- 1)) it1113) (- 1)) 0))
      (a!3 (+ (* it1117 (- 1))
              (* it1111 (- 1))
              (* it1118 (- 1))
              (* it1106 (- 1))
              it1116))
      (a!4 (+ (+ (* it1111 (- 1)) (* it1106 (- 1)) it1113) (- 1)))
      (a!5 (+ (* it1111 (- 1)) (* it1118 (- 1)) (* it1106 (- 1)) it1116))
      (a!6 (+ (* (* it1114 it1118) (- 1))
              (* it1106 (- 1))
              (* (* it1117 it1114) (- 1))))
      (a!7 (+ (* it1118 (+ it1114 (- 1))) it1111 (* it1117 (+ it1114 (- 1)))))
      (a!8 (+ (* it1117 (- 1))
              (* (* it1118 (+ it1114 (- 1))) (- 1))
              (* it1111 (- 1))
              (* (* it1117 (+ it1114 (- 1))) (- 1))
              ...
              (* it1106 (- 1))
              it1116))
      (a!9 (>= (+ (+ (* it1111 (- 1)) (* it1106 (- 1)) it1113) (- 2)) 0)))
  (and (> (+ it1111 1) 0)
       (>= (+ a!1 (- 3)) 0)
       a!2
       (> it1110 0)
       ...
       (>= (+ (* it1115 (- 1)) it1109) 0)
       (>= (+ it1118 (- 1)) 0)
       (> (+ it1111 it1118 it1106 1) 0)
       (>= (+ it1115 (- 1)) 0)
       (> (+ it1116 1) 0)
       (> (+ a!7 it1118 it1106 1) 0)
       (>= (+ it1109 (- 1)) 0)
       (>= (+ it1108 (- 6)) 0)
       (>= (+ it1117 (- 1)) 0)
       (<= a!6 0)
       ...
       (>= (+ a!3 (- 2)) 0)
       (>= (+ a!1 (- 4)) 0)
       (<= (+ (* it1114 it1118) it1106 (* it1117 it1114)) 0)
       (>= (+ it1106 (- 1)) 0)
       (= (+ (* it1116 (- 1)) it1113) 0)
       (> it1109 0))))
(check-sat)
