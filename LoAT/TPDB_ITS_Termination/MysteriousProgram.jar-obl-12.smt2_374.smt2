...
(assert (let ((a!1 (+ (+ (* it1301 (- 1)) (* it1295 (- 1)))
              (* (* it1302 (+ it1298 (- 1))) (- 1))
              (* it1267 (- 1))
              (* (* it1301 (+ it1298 (- 1))) (- 1))
              (* it1302 (- 1))
      ...
      (a!2 (+ (* it1267 (- 1))
              (* (* it1298 it1302) (- 1))
              (* (* it1301 it1298) (- 1))))
      (a!3 (+ (+ (* it1295 (- 1)) (* it1267 (- 1))) (* it1302 (- 1)) it1300))
      (a!4 (+ (+ (+ (* it1295 (- 1)) (* it1267 (- 1))) it1297) (- 1)))
      (a!5 (+ it1295
              (* it1302 (+ it1298 (- 1)))
              it1267
              (* it1301 (+ it1298 (- 1)))))
      (a!6 (+ (* it1295 (- 1))
              ...
              (* it1302 (- 1))
              it1300))
      (a!7 (+ (+ (* it1301 (- 1)) (* it1295 (- 1)))
              (* it1267 (- 1))
              (* it1302 (- 1))
              it1300))
      (a!8 (> (+ (+ (* it1295 (- 1)) it1297) (- 1)) 0))
      (a!9 (> (+ (+ (* it1295 (- 1)) (* it1267 (- 1))) it1297) 0))
      (a!10 (+ (+ (+ (* it1295 (- 1)) (* it1267 (- 1))) it1297) (- 2))))
  (and (>= (+ it1293 (- 1)) 0)
       (>= (+ (* it1292 (- 1)) 6) 0)
       (>= (+ a!1 (- 1)) 0)
       (<= (+ it1267 (* it1298 it1302) (* it1301 it1298)) 0)
       (>= (+ it1301 (- 1)) 0)
       (> (+ (+ it1295 it1267) it1302 1) 0)
       (= a!2 0)
       (>= (+ a!1 (- 3)) 0)
       (> (+ it1300 (- 1)) 0)
       (> a!3 0)
