...
(assert (let ((a!1 (+ (+ it817 (* it909 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!2 (> (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!3 (+ (+ it817 (* it909 (- 1)) (* it673 (- 1))) (* it1679 (- 1))))
      (a!4 (> (+ (+ it909 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 it1679
                 1)
              0))
      (a!5 (+ it817 (* it803 (- 1)) (* it909 (- 1)) (* it673 (- 1))))
      (a!7 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!8 (>= (+ (+ it1681 (* it909 (- 1)) (* it1679 (- 1))) (- 2)) 0))
      (a!9 (+ (+ it1681 (* it909 (- 1)) (* it1679 (- 1))) (- 1)))
      (a!10 (> (+ it909
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  it1679
...
(let ((a!6 (+ a!5
              ...
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!11 (>= (+ (+ a!5 (* it1679 (- 1))) (- 2)) 0))
      (a!12 (>= (+ (+ a!5 (* it1679 (- 1))) (- 1)) 0))
      (a!13 (>= (+ (+ a!5 (* it1679 (- 1))) (- 3)) 0)))
  (and (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       (>= (+ (* it1676 (- 1)) 6) 0)
       (> (+ (+ it909 it673) it1679 1) 0)
       (>= (+ a!1 (- 3)) 0)
       a!2
       (>= (+ a!3 (- 4)) 0)
       (>= (+ it1677 (* it818 (- 1))) 0)
       ...
       (> (+ it817 (- 1)) 0)
       (>= (+ it819 (- 1)) 0)
       (<= (+ (* it803 it819) (* it673 it819) it909) 0)
       (>= (+ it909 (- 1)) 0)
       (> (+ it1681 (- 1)) 0)
       (> (+ it1681 (* it1679 (- 1))) 0)
       (> it1680 0)
