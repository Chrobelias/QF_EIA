...
(assert (let ((a!1 (> (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) 0))
      (a!2 (+ (* (* it803 it819) (- 1))
              (* it1615 (- 1))
              (* (* it673 it819) (- 1))
              it817))
      ...
      (a!6 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!7 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!8 (> (+ it1615 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!10 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!11 (+ (* (* it803 it819) (- 1))
               (* (* it673 it819) (- 1))
               (* it359 (- 1))))
      (a!12 (> (+ (+ it1615 it673)
      ...
      (a!14 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!15 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 3))))
(let ((a!5 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (>= (+ (+ a!2 (* it359 (- 1))) (- 1)) 0)))
  (and (> it817 0)
       ...
       a!3
       (>= (+ a!5 (- 2)) 0)
       (<= (+ (* it803 it819) (* it673 it819) it359) 0)
       (> it1616 0)
       (>= (+ a!6 (- 3)) 0)
       (<= (+ (* it1619 (- 1)) it1616) 0)
       (= 0 0)
