...
(assert (let ((a!1 (+ (+ it999 (* it1343 (- 1)) (* it997 (- 1))) (- 1)))
      ...
      (a!3 (> (+ (* (+ it1722 (- 1)) it1343)
                 ...
                 1)
              0))
      (a!4 (+ it999 (* (* (+ it1722 (- 1)) it1343) (- 1))))
      (a!6 (>= (+ (+ it999 (* it1343 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!8 (+ (+ it999 (* it1343 (- 1)) (* it997 (- 1))) (* it359 (- 1))))
      (a!10 (> (+ (* (+ it1722 (- 1)) it1343)
                  it997
                  (* (+ it1722 (- 1)) it359)
                  1)
               0)))
(let ((a!5 (+ a!4 (* it997 (- 1)) (* (* (+ it1722 (- 1)) it359) (- 1)) (- 1)))
      (a!7 (+ a!4
              (* it1343 (- 1))
              (* it997 (- 1))
              (* (* (+ it1722 (- 1)) it359) (- 1)))))
(let ((a!9 (>= (+ (+ a!7 (* it359 (- 1))) (- 1)) 0)))
  (and (> a!1 0)
       (>= (+ it995 (* it1721 (- 1))) 0)
       (>= (+ it1722 (- 1)) 0)
       (> it1721 0)
       ...
       (> it999 0)
       (>= (+ it994 (- 6)) 0))))))
(assert (= (+ (* it994 (- 1)) it1726) 0))
(assert (= (+ it1727 (* it1721 (- 1))) 0))
(assert (= (+ (* it1721 (- 1)) it1728) 0))
(assert (= (+ (* it1722 it1343 (- 1)) (* it997 (- 1)) it1729 (* it1722 it359 (- 1))) 0))
(assert (= (+ it1730 (* it1721 (- 1))) 0))
(assert (= (+ (* it999 (- 1)) it1731) 0))
(assert (let ((a!1 (>= (+ (+ (* it1731 (- 1)) it117) (- 2)) 0))
      ...
      (a!8 (>= (+ (+ (* it1731 (- 1)) it117)
                  ...
                  (- 1))
               0))
      (a!9 (> (+ (+ (* it1731 (- 1)) it117) (- 1)) 0))
      (a!10 (+ (* it1731 (- 1)) (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!12 (<= (+ (+ it1702 (* it1731 (- 1)))
                   (* (* it1699 it1700) (- 1))
                   (* (* it1699 it1701) (- 1))
                   (* it117 (- 1))
                   it1729)
      ...
      (a!14 (> (+ it1731
                  ...
                  1)
               0))
      (a!15 (<= (+ (+ (* it1702 (- 1)) it1731)
                   (* it1699 it1700)
                   (* it1699 it1701)
                   it117
                   (* it1729 (- 1)))
                0))
      (a!16 (> (+ (+ (* it1731 (- 1)) it117) 1) 0))
      (a!17 (> (+ (+ (* it1731 (- 1)) it117) (* it1735 (- 1))) 0))
      (a!18 (+ (+ (+ (* it1731 (- 1)) it117) (* it1735 (- 1))) (- 1)))
      (a!20 (> (+ (+ it1702 (* it117 (- 1))) (* it1701 (- 1))) 0))
      (a!21 (+ (+ (+ it1702 (* it117 (- 1))) (* it1701 (- 1))) (- 1)))
      (a!23 (>= (+ (+ it1702 (* it117 (- 1))) (- 1)) 0))
      (a!25 (> (+ (* (+ it1699 (- 1)) it1700)
                  it117
                  (* (+ it1699 (- 1)) it1701)
                  1)
               0))
      (a!26 (>= (+ (+ (* it1731 (- 1)) it117) (- 1)) 0)))
(let ((a!3 (+ a!2 (* it117 (- 1)) (* (* (+ it1699 (- 1)) it1701) (- 1))))
      (a!11 (+ (+ a!10 it117)
               (* it1735 (- 1))
               (* (* (+ it1045 (- 1)) it1735) (- 1))))
      (a!13 (+ (+ a!10 it117) (* (* (+ it1045 (- 1)) it1735) (- 1))))
      (a!19 (+ a!10
               (* it909 (- 1))
               it117
               (* it1735 (- 1))
...
(let ((a!4 (> (+ (+ a!3 (* it1701 (- 1))) (- 1)) 0))
  ...
  (and (> (+ it117 1) 0)
       ...
       (> (+ it1731 1) 0)
       (> it117 0)
       (> (+ (* it1731 (- 1)) (* it909 (- 1)) it117 (* it1735 (- 1))) 0)
       a!14
       (= 0 0)
       (>= (+ it909 (- 1)) 0)
       (> (+ a!13 (- 1)) 0)
       ...
       (> (+ it1731 (- 1)) 0)
       (>= (+ a!11 (- 1)) 0)
       (>= (+ it1731 (* it117 (- 1)) (* it1045 it909) (* it1045 it1735) 1) 0)
       a!20
       (>= a!21 0)
       (> a!21 0)
       (> it1698 0)
