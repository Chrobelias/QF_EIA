...
(assert (and (> it135 0)
     ...
     (<= (+ (* it1373 (- 1)) 1) 0)))
(assert (= (+ it1422 (- 9)) 0))
(assert (= (+ it1423 (* it135 (- 1))) 0))
(assert (= (+ it1424 (* it1374 (- 1))) 0))
(assert (= (+ it1425 (* it1375 (- 1)) (- 1)) 0))
(assert (= (+ (* it1375 (- 1)) it1426 (- 1)) 0))
(assert (= (+ it1427 (* it1377 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it1425 (- 1)) (* it849 (- 1))) it1427) 0))
      (a!2 (> (+ (+ (* it1425 (- 1)) (* it849 (- 1))) it117) 0))
      (a!3 (+ (+ (+ (* it1425 (- 1)) (* it849 (- 1))) it1427) 1))
      (a!4 (+ (+ (+ (* it1425 (- 1)) (* it849 (- 1))) it117) (* it867 (- 1)) 1)))
  (and (> (+ it117 1) 0)
       (> (+ (* it1425 (- 1)) it1427) 0)
       a!1
       (>= (+ it849 (- 1)) 0)
