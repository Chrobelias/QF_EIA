...
(assert (and (> it140 0)
     ...
     (>= (+ it279 (- 1)) 0)
     (> it279 0)
     (> (+ (* it292 (- 1)) it283 (* it281 (- 1)) 1) 0)
     (> (+ it280 1) 0)
     (>= (+ it278 (- 10)) 0)
     (>= (+ it292 (- 1)) 0)))
(assert (= (+ (* it278 (- 1)) it335) 0))
(assert (= (+ (* it140 (- 1)) it336) 0))
(assert (= (+ (* it280 (- 1)) it337) 0))
(assert (= (+ it338 (* it292 (- 1)) (* it281 (- 1))) 0))
(assert (= (+ (* it292 (- 1)) it339 (* it281 (- 1))) 0))
(assert (= (+ (* it283 (- 1)) it340) 0))
(assert (and (> it342 0)
     (> (+ it340 (- 1)) 0)
     (<= (+ it342 (* it336 (- 1))) 0)
     (<= (+ (* it336 (- 1)) 1) 0)
     ...
     (> (+ (* it338 (- 1)) it340) 0)))
(assert (= (+ it343 (- 10)) 0))
(assert (= (+ it344 (* it342 (- 1))) 0))
(assert (= (+ it345 (* it337 (- 1))) 0))
(assert (= (+ (* it338 (- 1)) it346 (- 1)) 0))
(assert (= (+ it347 (* it338 (- 1)) (- 1)) 0))
(assert (= (+ it348 (* it340 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it341 (- 1)) it348 (* it346 (- 1))) 1) 0))
      (a!2 (> (+ (+ (* it341 (- 1)) (* it310 (- 1))) (* it346 (- 1)) it127 1) 0)))
  (and (> (+ it127 1) 0)
       (> it344 0)
       (<= (+ it341 it310) 0)
       (>= (+ (* it343 (- 1)) 10) 0)
       (>= (+ (* it347 (- 1)) it346) 0)
       (> (+ (* it341 (- 1)) (* it346 (- 1)) it127) 0)
       a!1
       (= (+ (* it341 (- 1)) (* it310 (- 1))) 0)
       (> (+ it348 (* it346 (- 1))) 0)
       (> (+ it348 1) 0)
