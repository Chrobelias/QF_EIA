...
(assert (let ((a!1 (> (+ (+ it1536 (* it292 (- 1))) (* it1534 (- 1)) (* it1531 (- 1)) 1)
              0))
      (a!2 (> (+ (+ it1533 (* it292 (- 1)) (* it1531 (- 1))) 1) 0))
      (a!3 (> (+ (+ it1536 (* it292 (- 1))) (* it1531 (- 1))) 0)))
  (and (<= (+ (* it1536 (- 1)) it1533) 0)
       (>= (+ it1531 (* it1532 (- 1))) 0)
       a!1
       (>= (+ it292 (- 1)) 0)
       (>= (+ it1529 (- 1)) 0)
