...
(assert (and (> (+ it117 1) 0)
     ...
     (> (+ it117 (* it1374 (- 1))) 0)))
(assert (= (+ it1379 (- 9)) 0))
(assert (= (+ (* it135 (- 1)) it1380) 0))
(assert (= (+ it1381 (* it1374 (- 1))) 0))
(assert (= (+ (* it1375 (- 1)) it1382 (- 1)) 0))
(assert (= (+ (* it1375 (- 1)) it1383 (- 1)) 0))
(assert (= (+ it1384 (* it117 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ it1384 (* it849 (- 1)) (* it1382 (- 1))) 1) 0))
      (a!2 (> (+ (+ (* it849 (- 1)) (* it1382 (- 1)) it1386) (* it867 (- 1)) 1)
              0)))
  (and (>= (+ it849 (- 1)) 0)
       (> (+ it1384 (- 1)) 0)
       (> (+ it1384 1) 0)
       ...
       (> (+ it1384 (* it1382 (- 1))) 0)
       (>= (+ it1379 (- 9)) 0)
       (> (+ it1384 (* it849 (- 1)) (* it1382 (- 1))) 0)
       (<= (+ it1380 (* it879 (- 1))) 0)
       (>= (+ it1380 (* it879 (- 1))) 0)
       a!2
       (<= (+ it1384 (* it1386 (- 1))) 0)
       (> (+ (* it849 (- 1)) (* it1382 (- 1)) it1386) 0)
       (>= (+ (* it1379 (- 1)) 9) 0))))
(check-sat)
