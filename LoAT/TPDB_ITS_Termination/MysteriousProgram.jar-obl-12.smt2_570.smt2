...
(assert (let ((a!1 (+ (+ (* it1479 (- 1)) (* it909 (- 1)) it1481) (- 1)))
      (a!2 (> (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!3 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!4 (> (+ (+ (+ it1479 it909) it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!5 (+ (+ (* it1479 (- 1)) it817) (* it909 (- 1)) (* it673 (- 1))))
      (a!6 (+ (+ (* it1479 (- 1)) it817)
              (* it803 (- 1))
              (* it909 (- 1))
              (* it673 (- 1))))
      (a!7 (> (+ (+ (+ it1479 it909) it673) 1) 0))
      (a!10 (>= (+ (+ (* it1479 (- 1)) (* it909 (- 1)) it1481) (- 2)) 0))
      (a!11 (> (+ (+ it1479 it909)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
