...
(assert (and (> it105 0)
     ...
     (<= (+ it104 (* it1373 (- 1))) 0)))
(assert (= (+ it1395 (- 6)) 0))
(assert (= (+ (* it105 (- 1)) it1396) 0))
(assert (= (+ it1397 (* it104 (- 1))) 0))
(assert (= (+ it1398 (* it1374 (- 1)) (- 1)) 0))
(assert (= (+ (* it102 (- 1)) it1399) 0))
(assert (= (+ it1400 (* it1377 (- 1))) 0))
(assert (let ((a!1 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (> (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) 0))
      (a!3 (+ (+ (* (* it1045 it359) (- 1)) it1398)
              it359
              (* (* it1137 it1045) (- 1))
              1))
      (a!4 (+ (* (* (+ it1045 (- 1)) it1137) (- 1)) (* it1045 it359)))
      (a!7 (+ (* (* it1137 (+ it1139 (- 1)) it1045) (- 1)) it1400))
      (a!8 (* (+ it1139 (- 1))
              (+ (* it803 it819)
                 (* it1045 it359)
                 (* it673 it819)
                 (* it1137 it1045))))
      (a!14 (+ it1400 (* it803 (- 1)) (* it1398 (- 1)) (* it673 (- 1))))
      (a!16 (>= (+ (* (* it803 it819) (- 1))
                   (* (* it1045 it359) (- 1))
                   (* (* it673 it819) (- 1))
                   (* (* it1137 it1045) (- 1))
                   (- 1))
                0))
      (a!19 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!20 (+ (* it1045 it359)
               (* (* it1137 (+ it1139 (- 1)) it1045) (- 1))
               it1400))
      (a!25 (+ (* (+ it1045 (- 1)) it1137) (* (* it1045 it359) (- 1))))
      (a!27 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!28 (+ (+ (+ (* it1045 it359) it1400) (* it1398 (- 1)))
               (* it359 (- 1))
               (* it1137 it1045)))
      (a!30 (+ (+ (+ (* it1045 it359) it1400) (* it1398 (- 1)))
               (* it1137 it1045)))
      (a!36 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!40 (> (+ (+ (* it1045 it359) it1400)
                  (* it1137 (- 1))
                  (* it1398 (- 1))
                  (* it359 (- 1))
                  (* it1137 it1045))
               0))
      (a!41 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 3)))
      (a!42 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 2)))
      (a!45 (> (+ (+ it1398 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!46 (> (+ it1398 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!50 (> (+ (+ (* it803 it819) (* it673 it819)) it1398 1) 0))
      (a!54 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0))
      (a!57 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 4)))
      (a!58 (+ (+ (* (* it1045 it359) (- 1)) it1398)
               (* (* it1137 it1045) (- 1))
               1)))
(let ((a!5 (+ a!4 it1400 (* (* (+ it1045 (- 1)) it359) (- 1))))
      (a!9 (+ a!7
              (* it803 (- 1))
              a!8
      ...
      (a!56 (> (+ a!25
                  ...
                  1)
               0)))
(let ((a!6 (+ (+ a!5 (* it1398 (- 1))) (* it359 (- 1)) (* it1137 it1045)))
      (a!10 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (+ a!11
               ...
               (* it1398 (- 1))
               (* (* it803 (+ it1139 (- 1)) it819) (- 1))))
      (a!18 (> (+ a!17 (* (* it1137 it1045) (- 1)) 1) 0))
      (a!22 (+ (+ a!21 (* it359 (- 1)) (* it1137 it1045)) (- 1)))
      (a!24 (+ (+ a!23 it673 (* it803 (+ it1139 (- 1)) it819))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!29 (>= (+ (+ a!21 (* it1137 it1045)) (- 1)) 0))
      (a!31 (> (+ a!17 it359 (* (* it1137 it1045) (- 1)) 1) 0))
      (a!34 (+ a!33
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!35 (+ (+ a!23 (* it803 (+ it1139 (- 1)) it819))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!39 (+ a!11
               ...
               (* it359 (- 1))
               (* it1137 it1045)))
      (a!47 (+ (+ (+ a!5 (* it1398 (- 1))) (* it1137 it1045)) (- 1)))
      (a!48 (+ (+ (+ a!5 (* it1398 (- 1))) (* it1137 it1045)) (- 2)))
      (a!51 (>= (+ (+ a!21 (* it1137 it1045)) (- 2)) 0))
      (a!52 (+ (+ a!23 (* it803 (+ it1139 (- 1)) it819)) 1))
      (a!53 (> (+ (+ a!21 (* it1137 it1045)) (- 1)) 0))
      (a!55 (+ (+ a!23 it673 (* it803 (+ it1139 (- 1)) it819)) 1)))
(let ((a!13 (> (+ (+ a!12 (* it1137 it1045)) (- 1)) 0))
      (a!43 (+ (+ a!12 (* it359 (- 1)) (* it1137 it1045)) (- 1)))
      (a!44 (>= (+ (+ a!12 (* it1137 it1045)) (- 2)) 0)))
  (and (>= (+ a!1 (- 4)) 0)
       a!2
       (> a!3 0)
       (>= (+ it1138 (- 1)) 0)
