...
(assert (let ((a!1 (>= (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!2 (> (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 3)) 0))
      (a!4 (+ (+ (* it1595 (- 1)) (* it1596 (- 1))) (* it1600 (- 1)) it1594))
      (a!5 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 2)) 0))
      (a!6 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 4)) 0))
      (a!7 (>= (+ (+ it1602 (* it1600 (- 1))) (- 2)) 0)))
  (and (>= (+ it1598 (* it1593 (- 1))) 0)
       (<= (+ it1595 it1596) 0)
       (<= (+ (* it1593 (- 1)) it1601) 0)
       (> (+ it1594 (- 1)) 0)
       (>= (+ it1601 (- 1)) 0)
