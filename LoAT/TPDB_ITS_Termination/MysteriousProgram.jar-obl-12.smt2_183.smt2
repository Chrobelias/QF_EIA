...
(assert (let ((a!1 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!2 (+ (* (* it1045 it359) (- 1))
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))
              it127))
      ...
      (a!6 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              it999
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!9 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!10 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
               (* it997 (- 1))
               (* (* it1045 it909) (- 1))
               it127))
      (a!12 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!14 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
               (* (* it1045 it909) (- 1))))
      (a!15 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0)))
(let ((a!7 (> (+ (+ a!6 (* it997 (- 1))) (- 1)) 0))
      (a!8 (+ (+ (+ a!6 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!11 (>= (+ (+ a!6 (* it997 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ a!6 (* it997 (- 1))) (* it359 (- 1))) 0)))
  (and (> it107 0)
       (> (+ it127 1) 0)
       (>= (+ it995 (* it107 (- 1))) 0)
       (>= (+ it996 (* it107 (- 1))) 0)
