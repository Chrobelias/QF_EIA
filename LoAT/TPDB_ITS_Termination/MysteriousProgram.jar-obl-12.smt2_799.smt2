...
(assert (let ((a!1 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
      ...
      (a!6 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it1679 1)
              0))
      (a!8 (+ (+ (* (* it1045 it359) (- 1)) it817)
              (* it803 (- 1))
              (* it673 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!13 (> (+ (+ (* it1045 it359) it673 (* it1045 it909)) it1679 1) 0))
      (a!15 (+ (+ it1681 (* it359 (- 1)) (* it1679 (- 1))) (- 1)))
      (a!16 (>= (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!17 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!18 (>= (+ (+ it1681 (* it1679 (- 1))) (- 2)) 0))
      (a!19 (> (+ (+ (* it1045 it359) it673 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  it1679
                  1)
               0))
      (a!23 (> (+ (+ (* it1045 it359) (* it1045 it909)) it1679 1) 0))
      (a!24 (> (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!25 (> (+ (+ (* it1045 it359) (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  it1679
                  1)
               0)))
(let ((a!2 (+ (+ a!1 (* it359 (- 1)) (* it1679 (- 1))) (- 1)))
      (a!4 (+ a!3
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!7 (>= (+ (+ a!3 (* it1679 (- 1))) (- 2)) 0))
      (a!9 (+ a!8
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!10 (>= (+ (+ a!8 (* it1679 (- 1))) (- 2)) 0))
      (a!11 (>= (+ (+ a!3 (* it1679 (- 1))) (- 3)) 0))
      (a!12 (> (+ (+ a!1 (* it1679 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ a!1 (* it1679 (- 1))) (- 2)) 0))
      (a!20 (>= (+ (+ a!8 (* it1679 (- 1))) (- 3)) 0))
      (a!21 (>= (+ (+ a!8 (* it1679 (- 1))) (- 1)) 0))
      (a!22 (>= (+ (+ a!3 (* it1679 (- 1))) (- 4)) 0)))
  (and (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       ...
       (= 0 0)
       (> (+ it1679 1) 0)
       (<= (+ (* it803 it819) (* it1045 it359) (* it673 it819) (* it1045 it909))
           0)
       (<= a!17 0)
       (> it818 0)
       (> (+ it817 (- 1)) 0)
