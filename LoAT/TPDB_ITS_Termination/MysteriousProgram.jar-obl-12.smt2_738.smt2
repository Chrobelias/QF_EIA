...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1615 (- 1))) it817))
      (a!3 (+ (* it1615 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!4 (> (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) 0))
      (a!5 (+ (+ (* it1045 it359) it1615) it673 (* it1045 it909)))
      (a!6 (+ (+ (* (* it1045 it359) (- 1)) (* it1615 (- 1)))
              it1617
              (* (* it1045 it909) (- 1))))
      (a!9 (+ (* (* it803 it819) (- 1))
              (* (* it1045 it359) (- 1))
              (* (* it673 it819) (- 1))
              (* (* it1045 it909) (- 1))))
      (a!10 (+ (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) (- 1)))
      (a!11 (+ (+ (+ (* it1045 it359) it1615) (* it1045 it909))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!12 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!14 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!15 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!18 (+ (+ (+ (* it1045 it359) it1615) (* it1045 it909)) 1))
      (a!19 (> (+ it1615
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
...
(let ((a!2 (+ a!1 (* it803 (- 1)) (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!7 (+ a!1 (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!13 (> (+ a!5 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!16 (> (+ (+ (+ a!3 it1617) (* it359 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (+ (+ a!3 it1617) (* it359 (- 1))) (- 1)) 0)))
(let ((a!8 (+ a!7
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!17 (+ a!2
  ...
  (and (>= (+ a!2 (- 3)) 0)
       ...
       (>= (+ a!2 (- 1)) 0)
       (>= (+ it359 (- 1)) 0)
       (> (+ (* it1615 (- 1)) (* it909 (- 1)) it1617 (* it359 (- 1))) 0)
       (>= (+ it803 (- 1)) 0)
       a!4
       (> (+ a!5 1) 0)
       (>= (+ it1616 (- 1)) 0)
