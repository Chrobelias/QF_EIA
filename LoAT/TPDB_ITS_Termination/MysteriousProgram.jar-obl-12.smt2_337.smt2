...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (+ (+ it817 (* it673 (- 1)))
              ...
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1263 (- 1))))
      (a!4 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 3)))
      (a!6 (> (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!7 (+ (+ (+ (* it803 it819) (* it673 it819)) it1267) it1268 it1263 1))
      (a!8 (>= (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!9 (+ (+ (+ (* it803 it819) (* it673 it819)) it1267) it1263 1))
      (a!12 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1263 (- 1))))
      (a!15 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 2)))
      (a!16 (>= (+ (+ it1265 (* it1263 (- 1))) (- 2)) 0))
      (a!17 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))
               (* it1263 (- 1))))
      (a!19 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1263 1)
               0))
      (a!20 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 4)))
      (a!21 (> (+ it673
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  it1263
                  1)
               0))
      (a!23 (+ (+ (+ (* it803 it819) (* it673 it819)) it1267)
               (* it1137 (+ it1266 (- 1)))
               (* it1268 (+ it1266 (- 1)))
               it1263
               1))
      (a!24 (+ (+ (+ (* it803 it819) (* it673 it819)) it1267)
               (* it1137 it1266)
               (* it1268 it1266)))
      (a!25 (> (+ (+ (* it803 it819) (* it673 it819)) it1263 1) 0))
      (a!27 (> (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) 0)))
(let ((a!2 (+ (+ (+ a!1 (* it1267 (- 1))) it817)
              (* it1268 (- 1))
              (* it1263 (- 1))))
      (a!5 (+ (+ a!1 (* it1267 (- 1)))
              (* (* it1137 it1266) (- 1))
      ...
      (a!10 (+ (+ a!1 (* it1267 (- 1)))
               (* (* it1137 (+ it1266 (- 1))) (- 1))
               it817))
      (a!14 (+ (+ (+ a!1 (* it1267 (- 1))) it817) (* it1263 (- 1))))
      (a!22 (+ (+ (+ a!1 (* it1267 (- 1))) it817)
               (* it1137 (- 1))
               (* it1268 (- 1))
               (* it1263 (- 1))))
      (a!26 (> (+ (+ a!1 it817 (* it1263 (- 1))) (- 1)) 0)))
(let ((a!11 (+ a!10
               (* it1137 (- 1))
               (* it1268 (- 1))
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               (* it1263 (- 1))))
      (a!13 (+ a!10 (* (* it1268 (+ it1266 (- 1))) (- 1)) (* it1263 (- 1))))
      (a!18 (+ a!10
               (* it1268 (- 1))
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               (* it1263 (- 1)))))
  (and (>= (+ it1261 (* it1138 (- 1))) 0)
       (>= (+ a!2 (- 1)) 0)
       (>= (+ (* it1260 (- 1)) 6) 0)
       (>= (+ a!3 (- 3)) 0)
       (>= a!4 0)
