...
(assert (= (+ (* it140 (- 1)) it295) 0))
(assert (= (+ it296 (* it280 (- 1))) 0))
(assert (= (+ (* it292 (- 1)) it297 (* it281 (- 1))) 0))
(assert (= (+ (* it292 (- 1)) it298 (* it281 (- 1))) 0))
...
(assert (= (+ it316 (* it297 (- 1)) (* it310 (- 1))) 0))
(assert (= (+ it317 (* it297 (- 1)) (* it310 (- 1))) 0))
(assert (= (+ it318 (* it127 (- 1))) 0))
(assert (and (> (+ (* it316 (- 1)) it318) 0)
     (>= (+ (* it313 (- 1)) 10) 0)
     (= (- 1) 0)
     (> (+ it318 (- 1)) 0)
     (> it314 0)
