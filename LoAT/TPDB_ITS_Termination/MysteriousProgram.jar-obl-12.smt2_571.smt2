...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1479 (- 1)))
              (* it803 (- 1))
              (* (* it1045 it909) (- 1))
              it127))
      (a!2 (>= (+ (+ (* it1479 (- 1)) it1481) (- 2)) 0))
      (a!3 (+ (* it1479 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!5 (+ (+ (* (* it1045 it359) (- 1)) (* it1479 (- 1)))
              (* (* it1045 it909) (- 1))))
      (a!7 (+ (* (* it1045 it359) (- 1))
              (* it803 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!8 (>= (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!9 (> (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!10 (> (+ it1479
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
               0))
      (a!11 (+ (+ (* it1479 (- 1)) (* it359 (- 1)) it1481) (- 1))))
(let ((a!4 (> (+ (+ a!3 (* it359 (- 1)) it1481) (- 1)) 0))
      (a!6 (>= (+ (+ a!3 (* it359 (- 1)) it1481) (- 1)) 0)))
  (and (> (+ it127 1) 0)
       (> (+ it127 (- 1)) 0)
       (>= (+ it359 (- 1)) 0)
       (>= (+ a!1 (- 3)) 0)
       ...
       (>= (+ it1480 (- 1)) 0)
       (= 0 0)
       (> (+ a!3 (* it909 (- 1)) (* it359 (- 1)) it1481) 0)
       (> (+ a!3 (* it359 (- 1)) it1481) 0)
       (> (+ (* it1479 (- 1)) it1481) 0)
       (>= (+ (+ a!5 it127) (- 3)) 0)
       a!6
       (> it127 0)
       ...
       (>= (+ (+ a!5 it127) (- 4)) 0)
       (>= (+ a!1 (- 2)) 0)
       (> (+ (* it1045 it359) it1479 (* it1045 it909) 1) 0)
       a!8
       a!9
       (= a!7 0)
       (<= (+ it1480 (* it1354 (- 1))) 0)
