...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (+ (* (* it803 it819) (- 1))
              ...
              (* (* it673 it819) (- 1))
              it817))
      (a!5 (> (+ (+ (* it803 it819) (* it673 it819)) it909 it1716 1) 0))
      (a!6 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 4)) 0))
      (a!7 (> (+ (+ (* it803 it819) (* it673 it819)) it1719 it909 it1716 1) 0))
      (a!8 (> (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!10 (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1716 (- 1))))
      (a!14 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 3)) 0))
      (a!16 (<= (+ (+ (* it803 it819) (* it673 it819))
                   (* it1045 it1719)
                   it909
                   (* it1137 it1045))
                0))
      ...
      (a!19 (> (+ (* it803 it819)
                  ...
                  1)
               0))
      (a!20 (> (+ it1716 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!22 (>= (+ (+ it1718 (* it1716 (- 1))) (- 2)) 0))
      (a!23 (>= (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!24 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 2)) 0))
      (a!25 (> (+ (+ (* it803 it819) (* it673 it819)) it1716 1) 0)))
(let ((a!2 (+ (+ a!1 it817) (* it909 (- 1)) (* it1716 (- 1))))
      (a!4 (+ a!3
              (* it909 (- 1))
              (* it1716 (- 1))
              (* (* (+ it1045 (- 1)) it1719) (- 1))))
      (a!9 (+ (+ a!1 it817) (* it1719 (- 1)) (* it909 (- 1)) (* it1716 (- 1))))
      (a!11 (+ a!3
               (* it1719 (- 1))
               (* it909 (- 1))
               (* it1716 (- 1))
