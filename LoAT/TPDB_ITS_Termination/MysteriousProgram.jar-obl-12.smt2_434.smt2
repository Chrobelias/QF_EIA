...
(assert (let ((a!1 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!2 (> (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!3 (> (+ (+ it1350 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!4 (> (+ it1350 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!5 (+ it817 (* it803 (- 1)) (* it1350 (- 1)) (* it673 (- 1))))
      (a!7 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!8 (>= (+ (+ it1352 (* it1350 (- 1))) (- 2)) 0))
      (a!9 (> (+ (+ (* it803 it819) (* it673 it819)) it1350 1) 0))
      (a!10 (>= (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!12 (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!14 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!15 (>= (+ (+ it817 (* it1350 (- 1)) (* it673 (- 1))) (- 2)) 0)))
(let ((a!6 (+ a!5
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (> (+ (+ a!7 it817 (* it1350 (- 1))) (- 1)) 0))
      (a!16 (> (+ (+ a!7 it817 (* it1350 (- 1))) (* it909 (- 1))) 0)))
  (and (> it102 0)
       a!1
       (>= (+ it1351 (- 1)) 0)
       (> it817 0)
