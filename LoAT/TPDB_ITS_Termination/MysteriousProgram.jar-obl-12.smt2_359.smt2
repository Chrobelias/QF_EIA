...
(assert (let ((a!1 (+ (* (* (+ it819 (- 1)) it1276) (- 1))
              it817
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1282 (- 1))))
      (a!4 (+ (* (* it673 it819) (- 1)) it817 (* (* it819 it1276) (- 1))))
      (a!6 (<= (+ (+ (* it673 it819) (* it819 it1276)) it1285) 0))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 4)) 0))
      (a!8 (>= (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!9 (+ (* (* it673 it819) (- 1))
              (* (* it819 it1276) (- 1))
              (* it1285 (- 1))))
      (a!10 (>= (+ (+ it1284 (* it1282 (- 1))) (- 2)) 0))
      (a!11 (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (* it1276 (- 1))))
      (a!12 (> (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!13 (> (+ (* (+ it819 (- 1)) it1276)
                  it673
                  (* (+ it819 (- 1)) it673)
                  it1282
                  1)
               0))
      (a!14 (> (+ (* (+ it819 (- 1)) it1276) (* (+ it819 (- 1)) it673) it1282 1)
               0))
      (a!15 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 3)) 0))
      (a!17 (>= (+ (+ it817 (* it673 (- 1)) (* it1282 (- 1))) (- 2)) 0))
      (a!18 (> (+ (+ (* it673 it819) (* it819 it1276)) it1282 1) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it1276 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ a!1 (* it1276 (- 1))) (- 2)) 0))
      (a!5 (> (+ (+ a!4 (* it1282 (- 1))) (- 1)) 0))
      (a!16 (>= (+ (+ a!1 (* it1276 (- 1))) (- 3)) 0)))
  (and (>= (+ (* it1286 (- 1)) it1281) 0)
       (> it1284 0)
       (>= (+ it1286 (- 1)) 0)
       a!2
       (>= (+ a!1 (- 4)) 0)
