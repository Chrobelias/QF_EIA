...
(assert (and (> it135 0)
     ...
     (>= (+ (* it135 (- 1)) it1373) 0)
     (>= (+ (* it1372 (- 1)) 9) 0)))
(assert (= (+ it1387 (* it1372 (- 1))) 0))
(assert (= (+ it1388 (* it135 (- 1))) 0))
(assert (= (+ it1389 (* it1374 (- 1))) 0))
(assert (= (+ it1390 (* it1375 (- 1)) (* it849 (- 1))) 0))
(assert (= (+ (* it1375 (- 1)) it1391 (* it849 (- 1))) 0))
(assert (= (+ it1392 (* it1377 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it1390 (- 1)) it117) (* it867 (- 1)) 1) 0)))
  (and (> (+ it117 1) 0)
       (>= (+ it1387 (- 9)) 0)
       a!1
       (> (+ it117 (- 1)) 0)
