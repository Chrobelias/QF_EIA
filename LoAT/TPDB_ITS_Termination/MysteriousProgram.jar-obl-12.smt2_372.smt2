...
(assert (let ((a!1 (> (+ (+ it1246 (* it1297 (- 1))) (- 1)) 0))
      (a!2 (> (+ (+ it1248 (* it1246 (- 1))) 1) 0))
      (a!3 (>= (+ (+ (* it1295 (- 1)) it1297) (- 2)) 0))
      (a!4 (>= (+ (+ it1248 (* it1246 (- 1))) (- 3)) 0))
      (a!5 (>= (+ (+ it1248 (* it1246 (- 1))) (- 2)) 0))
      (a!6 (> (+ (+ (* it1295 (- 1)) it1297) (- 1)) 0))
      (a!7 (>= (+ (+ it1246 (* it1297 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ it1246 (* it1297 (- 1))) (- 3)) 0))
      (a!9 (> (+ (+ it1246 (* it1297 (- 1))) 1) 0)))
  (and (> it110 0)
       (> it107 0)
       (> it109 0)
       (> (+ (* it1295 (- 1)) it1297) 0)
       ...
       (>= (+ it110 (- 1)) 0)
       (>= (+ it107 (* it1250 (- 1))) 0)
       (<= (+ (* it1295 (- 1)) (* it1248 (- 1)) it1246 it1297) 0)
       (<= (+ it1294 (* it1250 (- 1))) 0)
       (>= (+ (* it107 (- 1)) it1294) 0)
       (> it1246 0)
       (= 0 0)
