...
(assert (let ((a!1 (+ it817 (* it909 (- 1)) (* it673 (- 1)) (* it1729 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!3 (+ it817
      ...
      (a!8 (>= (+ (+ it1731 (* it909 (- 1)) (* it1729 (- 1))) (- 2)) 0))
      (a!9 (+ (+ it1731 (* it909 (- 1)) (* it1729 (- 1))) (- 1)))
      (a!10 (> (+ (+ it909 it673 it1729)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0)))
