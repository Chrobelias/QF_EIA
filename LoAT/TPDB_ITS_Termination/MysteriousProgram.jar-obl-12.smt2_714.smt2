...
(assert (let ((a!1 (+ it999 (* it803 (- 1)) (* it673 (- 1)) (* it997 (- 1))))
      (a!2 (+ (+ it999 (* it673 (- 1)) (* it997 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!3 (* (+ (* it803 it819) (* it673 it819)) (+ it921 (- 1))))
      (a!5 (+ (+ (+ it673 it997) (* (+ it819 (- 1)) it673))
              (* it803 (+ it819 (- 1)))
              1))
      (a!6 (+ (+ (+ (* it803 it819) (* it673 it819)) it997) 1))
      (a!7 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!11 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!16 (+ (+ it997 (* (+ it819 (- 1)) it673)) (* it803 (+ it819 (- 1))) 1))
      (a!20 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!21 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!23 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
...
(let ((a!4 (+ a!2
      ...
      (a!8 (> (+ (+ a!7 it999 (* it997 (- 1))) (- 1)) 0))
      (a!9 (+ (+ it999 (* it673 (- 1)) (* it997 (- 1)))
              a!3
              (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
              (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!10 (+ a!2 (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (+ (+ it999 (* it997 (- 1)))
               a!3
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!13 (+ a!1
               ...
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!14 (+ (+ it997 (* (+ it819 (- 1)) it673))
               (* a!3 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* it803 (+ it819 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
               1))
      (a!17 (+ a!1 (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!19 (+ (+ a!7 it999 (* it997 (- 1)))
               a!3
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!25 (+ (+ (+ (* it803 it819) (* it673 it819)) it997)
               (* a!3 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
               1))
      (a!26 (+ (+ (+ it673 it997) (* (+ it819 (- 1)) it673))
               (* a!3 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* it803 (+ it819 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
