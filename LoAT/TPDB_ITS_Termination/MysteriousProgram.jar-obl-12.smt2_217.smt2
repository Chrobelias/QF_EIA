...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
              (* it1103 (- 1))
              (* (* it1045 it1106) (- 1))
              it127))
      (a!2 (+ it1105 (* (* (+ it1045 (- 1)) it359) (- 1)) (* it1103 (- 1))))
      (a!4 (+ (* (* it1045 it359) (- 1))
              it1105
              (* it1103 (- 1))
              (* (* it1045 it1106) (- 1))))
      (a!5 (+ (* (* it1045 it359) (- 1))
              ...
              (* (* it1045 it1106) (- 1))
              it127))
      (a!6 (+ (+ (+ it1105 (* it1103 (- 1))) (* it359 (- 1))) (- 1)))
      (a!8 (+ (+ (* (* it1045 it359) (- 1)) (* it803 (- 1)))
              (* (* it1045 it1106) (- 1))))
      (a!9 (> (+ (* (+ it1045 (- 1)) it359)
                 it1103
                 (* (+ it1045 (- 1)) it1106)
                 1)
              0))
      (a!11 (> (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!12 (> (+ (+ it1105 (* it1103 (- 1))) (* it359 (- 1))) 0))
      (a!13 (> (+ (+ it1105 (* it1103 (- 1))) (* it1106 (- 1)) (* it359 (- 1)))
               0))
      (a!14 (>= (+ (+ it1105 (* it1103 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0)))
(let ((a!3 (+ a!2 (* it359 (- 1)) (* (* (+ it1045 (- 1)) it1106) (- 1))))
      (a!7 (+ a!2 (* (* (+ it1045 (- 1)) it1106) (- 1))))
      (a!10 (+ a!2
               (* it1106 (- 1))
               (* it359 (- 1))
               (* (* (+ it1045 (- 1)) it1106) (- 1)))))
