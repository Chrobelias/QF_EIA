...
(assert (let ((a!1 (+ (* it1589 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!4 (>= (+ (+ (* it1589 (- 1)) it1591) (- 2)) 0))
      (a!5 (+ (* (* it1045 it359) (- 1)) (* it1595 (- 1)) (* it1589 (- 1))))
      (a!8 (+ (+ (* it1589 (- 1)) (* it359 (- 1)) it1591) (- 1)))
      (a!9 (+ (+ (* (* it1045 it359) (- 1)) (* it1589 (- 1)))
              (* (* it1045 it909) (- 1))
              it1591))
      (a!10 (+ (+ (* it1045 it359) it1589) (* (+ it1592 (- 1)) it1596)))
      (a!12 (+ (* (* it1045 it359) (- 1))
               (* (* it1595 it1592) (- 1))
               (* (* it1045 it909) (- 1))
               (* (* it1592 it1596) (- 1))))
      (a!13 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!14 (+ (+ (* (* it1045 it359) (- 1)) (* it1589 (- 1)))
               (* it1596 (- 1))
               (* (* it1045 it909) (- 1))
               it1594))
      (a!15 (+ (+ (* (* it1045 it359) (- 1)) (* it1589 (- 1)))
               (* (* (+ it1592 (- 1)) it1596) (- 1))
               (* it1596 (- 1))
               (* (* (+ it1592 (- 1)) it1595) (- 1))
               (* (* it1045 it909) (- 1))
               it1594))
      (a!16 (>= (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!17 (> (+ it1589
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
               0))
      (a!18 (> (+ (+ (* it1045 it359) it1589) (* it1045 it909) 1) 0))
      (a!20 (> (+ (+ (* it1045 it359) it1589) it1596 (* it1045 it909) 1) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it359 (- 1)) it1591) (- 1)) 0))
      (a!3 (> (+ (+ a!1 (* it359 (- 1)) it1591) (- 1)) 0))
      (a!6 (+ a!5 (* it1596 (- 1)) (* (* it1045 it909) (- 1)) it1594))
      (a!7 (+ a!5
              (* (* (+ it1592 (- 1)) it1596) (- 1))
              (* it1596 (- 1))
              (* (* (+ it1592 (- 1)) it1595) (- 1))
              (* (* it1045 it909) (- 1))
              it1594))
      (a!11 (> (+ a!10 it1596 (* (+ it1592 (- 1)) it1595) (* it1045 it909) 1) 0))
      (a!19 (> (+ a!10 (* (+ it1592 (- 1)) it1595) (* it1045 it909) 1) 0)))
  (and a!2
       a!3
       (>= (+ it1595 (- 1)) 0)
       a!4
       ...
       (>= (+ (* it1593 (- 1)) it1588) 0)
       (> (+ (* it1589 (- 1)) it1591) 0)
       (> (+ (* it1589 (- 1)) (* it909 (- 1)) (* it359 (- 1)) it1591) 0)
       (> (+ (+ a!1 it1591) (- 1)) 0)
       (>= (+ a!15 (- 4)) 0)
       (> (+ it1591 (- 1)) 0)
       (= 0 0)
