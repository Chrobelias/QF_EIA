...
(assert (let ((a!1 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!2 (>= (+ (+ it1246 (* it1591 (- 1))) (- 3)) 0))
      (a!3 (>= (+ (+ it1246 (* it1591 (- 1))) (- 2)) 0))
      (a!4 (> (+ (+ it1248 (* it1246 (- 1))) 1) 0))
      (a!5 (> (+ (+ it1246 (* it1591 (- 1))) 1) 0))
      (a!6 (>= (+ (+ it1248 (* it1246 (- 1))) (- 3)) 0))
      (a!7 (>= (+ (+ it1248 (* it1246 (- 1))) (- 2)) 0))
      (a!8 (> (+ (+ it1246 (* it1591 (- 1))) (- 1)) 0))
      (a!9 (>= (+ (+ (* it1589 (- 1)) it1591) (- 2)) 0)))
  (and (> it110 0)
       (> it107 0)
       (> it109 0)
       (>= (+ it1587 (- 1)) 0)
       ...
       (>= (+ it107 (* it1250 (- 1))) 0)
       (> it1588 0)
       (<= (+ (* it1589 (- 1)) (* it1248 (- 1)) it1246 it1591) 0)
       (> it1590 0)
       (> (+ it1591 1) 0)
       a!5
       (> it1246 0)
