...
(assert (let ((a!1 (+ (* (* (+ it1592 (- 1)) it1596) (- 1))
              (* it1596 (- 1))
              (* (* (+ it1592 (- 1)) it1595) (- 1))
              (* it1600 (- 1))
              it1594))
      (a!2 (+ (* it1595 (- 1)) (* it1596 (- 1)) (* it1600 (- 1)) it1594))
      (a!3 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 4)) 0))
      (a!4 (+ (+ (* it909 (- 1)) (* (* it1595 it1592) (- 1)))
              (* it1600 (- 1))
              it1594
              (* (* it1592 it1596) (- 1))))
      (a!5 (+ (* it1595 (- 1))
      ...
      (a!6 (+ (* (* it1595 it1592) (- 1))
              ...
              it1594
              (* (* it1592 it1596) (- 1))))
      (a!7 (>= (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!8 (+ (+ (* it909 (- 1)) (* (* it1595 it1592) (- 1)))
              (* (* it1592 it1596) (- 1))))
      (a!9 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 2)) 0))
      (a!10 (>= (+ (+ it1602 (* it1600 (- 1))) (- 2)) 0))
      (a!11 (> (+ (+ it1602 (* it1600 (- 1))) (- 1)) 0))
      (a!12 (> (+ (* (+ it1592 (- 1)) it1596)
                  it1596
                  (* (+ it1592 (- 1)) it1595)
                  it1600
                  1)
               0))
      (a!13 (> (+ (* (+ it1592 (- 1)) it1596)
                  (* (+ it1592 (- 1)) it1595)
                  it1600
                  1)
               0))
      (a!14 (>= (+ (+ (* it1596 (- 1)) (* it1600 (- 1)) it1594) (- 3)) 0)))
  (and (> it102 0)
       (>= (+ a!1 (- 2)) 0)
       (> (+ it1602 (- 1)) 0)
