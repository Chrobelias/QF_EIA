...
(assert (let ((a!1 (+ (* (* it673 it819) (- 1))
              (* it1267 (- 1))
              (* (* it819 it1276) (- 1))))
      (a!2 (+ (+ (* it1273 (- 1)) (* it1267 (- 1))) it817 (* it673 (- 1))))
      (a!3 (+ (* it1273 (- 1))
              (* (* (+ it819 (- 1)) it1276) (- 1))
              (* it1267 (- 1))
              it817
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!6 (+ (+ (+ (* it1273 (- 1)) (* it1267 (- 1))) it1275) (- 2)))
      (a!7 (+ (+ it1273 (* (+ it819 (- 1)) it1276) it1267)
              it673
              (* (+ it819 (- 1)) it673)
              1))
      (a!8 (+ (+ it1273 (* (+ it819 (- 1)) it1276) it1267)
              (* (+ it819 (- 1)) it673)
              1))
      (a!9 (+ (+ (+ (* it1273 (- 1)) (* it1267 (- 1))) it1275) (- 1)))
      (a!11 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!13 (> (+ (+ (* it1273 (- 1)) (* it1267 (- 1))) it1275) 0)))
(let ((a!4 (>= (+ (+ a!3 (* it1276 (- 1))) (- 3)) 0))
      (a!5 (>= (+ (+ a!3 (* it1276 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ a!2 (* it1276 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ a!3 (* it1276 (- 1))) (- 2)) 0))
      (a!14 (>= (+ (+ a!2 (* it1276 (- 1))) (- 3)) 0))
      (a!15 (>= (+ (+ a!2 (* it1276 (- 1))) (- 2)) 0)))
  (and (> it1271 0)
       (<= a!1 0)
       (>= (+ a!2 (- 2)) 0)
       a!4
       (<= (+ (* it817 (- 1)) it1275) 0)
       (> (+ (+ it1273 it1267) it673 1) 0)
       (>= (+ a!3 (- 4)) 0)
       (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
