...
(assert (let ((a!1 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!2 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it997 (- 1))))
      (a!3 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!4 (> (+ (+ (* it803 it819) (* it673 it819)) it997 1) 0))
      (a!5 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!6 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!7 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!9 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!11 (+ (+ it817 (* it673 (- 1)) (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (> (+ (+ it673 it997)
                  (* (+ it819 (- 1)) it673)
                  ...
                  1)
               0))
      (a!14 (> (+ it997 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!15 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0)))
(let ((a!8 (> (+ (+ (+ a!7 it817) (* it997 (- 1))) (- 1)) 0))
      (a!12 (+ a!2
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (> it102 0)
