...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1595 (- 1)))
              (* it1589 (- 1))
              (* (* it1045 it909) (- 1))
              it127))
      (a!2 (+ (+ (* it1589 (- 1)) (* it359 (- 1)) it1591) (- 1)))
      (a!3 (+ (* (* it1045 it359) (- 1))
              (* it1589 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!4 (+ (* it1589 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!6 (+ (+ (* (* it1045 it359) (- 1)) (* it1595 (- 1)))
              (* (* it1045 it909) (- 1))))
      (a!7 (>= (+ (+ (* it1589 (- 1)) it1591) (- 2)) 0))
      (a!8 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!10 (>= (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!11 (> (+ it1589
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
               0)))
(let ((a!5 (>= (+ (+ a!4 (* it359 (- 1)) it1591) (- 1)) 0))
      (a!9 (> (+ (+ a!4 (* it359 (- 1)) it1591) (- 1)) 0)))
  (and (> it107 0)
       (> (+ it127 1) 0)
       (>= (+ a!1 (- 2)) 0)
       (>= a!2 0)
       ...
       (> (+ it127 (- 1)) 0)
       (>= (+ it359 (- 1)) 0)
       (> (+ (* it1045 it359) it1589 (* it1045 it909) 1) 0)
       (>= (+ (* it107 (- 1)) it1588) 0)
       (> (+ (* it1589 (- 1)) it1591) 0)
       (>= (+ it1045 (- 1)) 0)
       (> (+ it1589 it359 1) 0)
       ...
       (>= (+ (+ a!3 it127) (- 2)) 0)
       (>= (+ a!1 (- 1)) 0)
       (> (+ a!4 (* it909 (- 1)) (* it359 (- 1)) it1591) 0)
       (= a!6 0)
       (> (+ a!3 it127) 0)
       (>= (+ it1590 (- 1)) 0)
       (> a!2 0)
       (<= (+ (* it1045 it359) it1595 (* it1045 it909)) 0)))))
(check-sat)
