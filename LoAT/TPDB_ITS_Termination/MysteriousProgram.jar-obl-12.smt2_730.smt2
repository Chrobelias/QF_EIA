...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1))
      ...
      (a!2 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!3 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!4 (> (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) 0))
      (a!5 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!7 (+ (+ (* it1615 (- 1)) it817) (* it803 (- 1)) (* it673 (- 1))))
      (a!9 (> (+ (+ it1615 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!10 (> (+ it1615 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!11 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!12 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 3)))
      (a!13 (+ (+ (+ (* it1615 (- 1)) it817) (* it673 (- 1))) (- 4)))
...
(let ((a!8 (+ a!7
  ...
  (and (> it102 0)
       ...
       a!4
       (> a!5 0)
       (> (+ (* it803 it819) it1615 (* it673 it819) 1) 0)
       (<= (+ it1616 (* it102 (- 1))) 0)
       (= 0 0)
       (> (+ it817 (- 1)) 0)
       (>= (+ it819 (- 1)) 0)
