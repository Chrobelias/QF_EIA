...
(assert (let ((a!1 (+ (* it1555 (- 1)) (* it1735 (- 1)) (* it1729 (- 1)) it127))
      (a!2 (+ (* it1555 (- 1)) (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!4 (+ (* it1555 (- 1))
              (* (* it1045 it909) (- 1))
              (* (* it1045 it1735) (- 1))))
      (a!5 (>= (+ (+ (* it1729 (- 1)) it127) (- 2)) 0))
      (a!6 (> (+ it1555
                 (* (+ it1045 (- 1)) it909)
                 it1729
                 (* (+ it1045 (- 1)) it1735)
                 1)
              0))
      (a!8 (>= (+ (+ (* it1729 (- 1)) it127) (- 1)) 0))
      (a!9 (>= (+ (+ (* it1729 (- 1)) it127) (- 3)) 0))
      (a!10 (> (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ (* it1555 (- 1)) (* it1729 (- 1)) it127) (- 2)) 0))
      (a!13 (+ (+ (* it1555 (- 1)) (* it1729 (- 1)) it127) (- 1))))
(let ((a!3 (+ a!2 (* it1729 (- 1)) (* (* (+ it1045 (- 1)) it1735) (- 1)) it127))
      (a!7 (+ a!2
              (* it1735 (- 1))
              (* it1729 (- 1))
              (* (* (+ it1045 (- 1)) it1735) (- 1))
  ...
  (and (> it102 0)
       ...
       (> a!7 0)
       (>= (+ it1555 (- 1)) 0)
       (<= (+ it1555 (* it1045 it909) (* it1045 it1735)) 0)
       (> it1728 0)
       a!8
       a!9
       (>= (+ a!3 (- 2)) 0)
