...
(assert (let ((a!1 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       ...
       (>= (+ it909 (- 1)) 0)
       (>= (+ it102 (- 1)) 0))))
(assert (= (+ it1003 (* it994 (- 1))) 0))
(assert (= (+ it1004 (* it102 (- 1))) 0))
(assert (= (+ it1005 (* it102 (- 1))) 0))
(assert (= (+ it1006 (* it909 (- 1)) (* it997 (- 1))) 0))
(assert (= (+ it1007 (* it102 (- 1))) 0))
(assert (= (+ it1008 (* it999 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it817 (* it1006 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!2 (>= (+ (+ it1008 (* it1006 (- 1))) (- 1)) 0))
      (a!3 (+ it817 (* it803 (- 1)) (* it1006 (- 1)) (* it673 (- 1))))
      (a!5 (+ (+ it817 (* it1006 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (> (+ it1006 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!7 (>= (+ (+ it817 (* it1006 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!8 (>= (+ (+ it817 (* it1006 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ it1008 (* it1006 (- 1))) (- 2)) 0))
      (a!10 (> (+ (+ it1006 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!11 (> (+ (+ it1008 (* it1006 (- 1))) (- 1)) 0)))
(let ((a!4 (+ a!3
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and a!1
       ...
       (>= (+ it819 (- 1)) 0)
       (>= (+ a!3 (- 1)) 0)))))
(assert (= (+ it1011 (* it1003 (- 1))) 0))
(assert (= (+ it1012 (* it818 (- 1))) 0))
(assert (= (+ (* it818 (- 1)) it1013) 0))
(assert (= (+ (* it803 it819 (- 1)) it1014 (* it673 it819 (- 1)) (* it1006 (- 1))) 0))
(assert (= (+ it1015 (* it818 (- 1))) 0))
(assert (= (+ (* it817 (- 1)) it1016) 0))
(assert (let ((a!1 (> (+ (+ (* it1014 (- 1)) it1016) (- 1)) 0))
      (a!2 (+ (+ (* it1014 (- 1)) (* it1021 (- 1)) it1019) (* it1020 (- 1))))
      (a!3 (>= (+ (+ (* it1014 (- 1)) it1016) (- 1)) 0))
      (a!4 (>= (+ (+ (* it1014 (- 1)) (* it1021 (- 1)) it1019) (- 3)) 0))
      (a!5 (>= (+ (+ (* it1014 (- 1)) (* it1021 (- 1)) it1019) (- 4)) 0))
      (a!6 (>= (+ (+ (* it1014 (- 1)) it1016) (- 2)) 0))
      (a!7 (>= (+ (+ (* it1014 (- 1)) (* it1021 (- 1)) it1019) (- 2)) 0)))
  (and (> it1019 0)
       (> it1015 0)
       (> it1016 0)
       (> it1013 0)
