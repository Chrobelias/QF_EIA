...
(assert (let ((a!1 (> (+ (+ it1032 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!2 (+ (+ it817 (* it1032 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!3 (>= (+ (+ it817 (* it1032 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!4 (+ it817 (* it803 (- 1)) (* it1032 (- 1)) (* it673 (- 1))))
      (a!6 (> (+ it1032 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!7 (>= (+ (+ it817 (* it1032 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!8 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!9 (>= (+ (+ it1034 (* it1032 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it1034 (* it1032 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ (* it803 it819) (* it673 it819)) it1032 1) 0))
      (a!14 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!15 (>= (+ (+ it817 (* it1032 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!16 (> (+ (+ it1034 (* it1032 (- 1))) (- 1)) 0)))
(let ((a!5 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (> (+ (+ a!8 it817 (* it1032 (- 1))) (* it909 (- 1))) 0))
      (a!12 (> (+ (+ a!8 it817 (* it1032 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       (>= (+ it1030 (* it102 (- 1))) 0)
       (> (+ it817 (* it1032 (- 1)) (* it673 (- 1))) 0)
       a!1
       (>= (+ it1030 (- 1)) 0)
       (> it1031 0)
       (> it817 0)
