...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1563 (- 1)))
              (* it803 (- 1))
              it1567
              (* (* it1045 it909) (- 1))))
      (a!2 (>= (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!3 (+ (+ (* it1563 (- 1)) (* it359 (- 1)) it1565) (- 1)))
      (a!4 (+ (+ (* (* it1045 it359) (- 1)) (* it1563 (- 1)))
              (* (* it1045 it909) (- 1))
              it1565))
      (a!5 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              (* it1563 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!6 (> (+ (* (+ it1045 (- 1)) it359) it1563 (* (+ it1045 (- 1)) it909) 1)
              0))
      (a!7 (+ (+ (* (* it1045 it359) (- 1)) (* it1563 (- 1)))
              it1567
              (* (* it1045 it909) (- 1))))
      (a!8 (+ (* (* it1045 it359) (- 1))
              (* it803 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!9 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!11 (>= (+ (+ (* it1563 (- 1)) it1565) (- 2)) 0)))
(let ((a!10 (>= (+ (+ a!5 (* it359 (- 1)) it1565) (- 1)) 0))
      (a!12 (> (+ (+ a!5 (* it359 (- 1)) it1565) (- 1)) 0)))
  (and (> it1564 0)
       (>= (+ a!1 (- 1)) 0)
       a!2
       (>= (+ it1564 (* it1568 (- 1))) 0)
       ...
       (>= (+ it1561 (- 1)) 0)
       (> a!7 0)
       (> (+ (* it1045 it359) it1563 (* it1045 it909) 1) 0)
       (> a!3 0)
       (> (+ (* it1563 (- 1)) it1565) 0)
       (<= (+ (* it1567 (- 1)) it1565) 0)
       (>= (+ it1560 (- 6)) 0)
