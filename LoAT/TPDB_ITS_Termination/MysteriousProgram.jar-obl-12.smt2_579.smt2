...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1479 (- 1))) it817))
      (a!3 (+ (+ (* it1045 it359) it1479) it673 (* it1045 it909)))
      (a!4 (>= (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!5 (+ (* it1479 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!7 (> (+ it1479 (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) 1)
              0))
      (a!8 (+ (+ (+ (* it1045 it359) it1479) (* it1045 it909))
              (* (+ it819 (- 1)) it673)
              (* it803 (+ it819 (- 1)))
              1))
      (a!9 (+ (+ (* it1479 (- 1)) (* it359 (- 1)) it1481) (- 1)))
      (a!10 (> (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!13 (+ (+ (+ (* it1045 it359) it1479) (* it1045 it909)) 1))
      (a!15 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!18 (+ (+ (* (* it1045 it359) (- 1)) (* it1479 (- 1)))
               (* (* it1045 it909) (- 1))
               it1481))
      (a!19 (>= (+ (+ (* it1479 (- 1)) it1481) (- 2)) 0)))
(let ((a!2 (+ a!1 (* it803 (- 1)) (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!6 (>= (+ (+ a!5 (* it359 (- 1)) it1481) (- 1)) 0))
      (a!11 (+ a!1 (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!16 (> (+ (+ a!5 (* it359 (- 1)) it1481) (- 1)) 0))
      (a!17 (> (+ a!3 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0)))
(let ((a!12 (+ a!11
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (+ a!2
