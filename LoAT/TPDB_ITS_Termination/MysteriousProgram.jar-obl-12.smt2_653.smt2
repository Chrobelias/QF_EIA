...
(assert (let ((a!1 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!2 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              (* it1563 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!3 (>= (+ (+ (* it1563 (- 1)) it1565) (- 2)) 0))
      (a!4 (+ (+ (* it1563 (- 1)) (* it359 (- 1)) it1565) (- 1)))
      (a!5 (>= (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!7 (> (+ (* (+ it1045 (- 1)) it359) it1563 (* (+ it1045 (- 1)) it909) 1)
              0)))
(let ((a!6 (>= (+ (+ a!2 (* it359 (- 1)) it1565) (- 1)) 0))
      (a!8 (> (+ (+ a!2 (* it359 (- 1)) it1565) (- 1)) 0)))
  (and (> it102 0)
       (> (+ it1563 it359 1) 0)
       (>= (+ it1561 (* it102 (- 1))) 0)
       a!1
