...
(assert (let ((a!1 (+ (* it1111 (- 1)) (* (* (+ it1045 (- 1)) it359) (- 1))))
      (a!3 (+ (+ (* (* it1045 it359) (- 1)) (* it1111 (- 1)))
              it1113
              (* (* it1045 it1106) (- 1))))
      (a!5 (+ (+ (* (* it1045 it359) (- 1)) (* it1117 (- 1)))
              (* it1111 (- 1))
              (* (* it1045 it1106) (- 1))
              it127))
      (a!6 (+ (+ (* it1111 (- 1)) (* it359 (- 1)) it1113) (- 1)))
      (a!7 (+ (+ (* (* it1045 it359) (- 1)) (* it1111 (- 1)))
              (* (* it1045 it1106) (- 1))
              it127))
      (a!8 (>= (+ (+ (* it1111 (- 1)) it1113) (- 2)) 0))
      (a!9 (+ (+ (* (* it1045 it359) (- 1)) (* it1117 (- 1)))
              (* (* it1045 it1106) (- 1))))
      (a!10 (> (+ (+ (* it1111 (- 1)) it1113) (- 1)) 0))
      (a!12 (> (+ it1111
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it1106)
                  1)
               0))
      (a!13 (>= (+ (+ (* it1111 (- 1)) it1113) (- 1)) 0)))
(let ((a!2 (+ a!1
              (* it1106 (- 1))
              (* it359 (- 1))
              it1113
              (* (* (+ it1045 (- 1)) it1106) (- 1))))
      (a!4 (+ a!1 (* it359 (- 1)) it1113 (* (* (+ it1045 (- 1)) it1106) (- 1))))
      (a!11 (+ a!1 it1113 (* (* (+ it1045 (- 1)) it1106) (- 1)))))
  (and (> it107 0)
       (> (+ it127 1) 0)
       (>= (+ (* it107 (- 1)) it1109) 0)
       (<= (+ it1112 (* it107 (- 1))) 0)
       ...
       (> a!7 0)
       (<= (+ it1113 (* it127 (- 1))) 0)
       (> (+ (* it1111 (- 1)) (* it1106 (- 1)) (* it359 (- 1)) it1113) 0)
       a!8
       (> it127 0)
       (>= (+ (* it1108 (- 1)) 6) 0)
       (> (+ it1111 it359 1) 0)
       (<= (+ (* it1045 it359) it1117 (* it1045 it1106)) 0)
       (<= a!9 0)
       (>= (+ it1108 (- 6)) 0)
       (= a!9 0)
       (> (+ a!3 (- 1)) 0)
       ...
       (>= (+ a!7 (- 3)) 0)
       (>= (+ a!7 (- 4)) 0)
       (> (+ (* it1045 it359) it1111 (* it1045 it1106) 1) 0)
       (>= (+ it1117 (- 1)) 0)
       (> (+ it1113 1) 0)
       (> a!6 0)))))
(check-sat)
