...
(assert (let ((a!1 (>= (+ (+ it1690 (* it1688 (- 1))) (- 2)) 0))
      (a!2 (> (+ (+ (* it803 (- 1)) it1093) (* it1688 (- 1))) 0))
      (a!3 (+ (+ (* it803 (- 1)) it1093) (* it673 (- 1)) (* it1688 (- 1))))
      (a!4 (+ (+ (+ (* it803 (- 1)) it1093) (* it1688 (- 1))) (- 2)))
      (a!5 (> (+ (+ it1690 (* it1688 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ it1690 (* it1688 (- 1))) (- 1)) 0))
      (a!7 (+ (+ (+ (* it803 (- 1)) it1093) (* it1688 (- 1))) (- 3))))
  (and (> it1093 0)
       (>= (+ it673 (- 1)) 0)
       (<= (+ it1686 (* it1094 (- 1))) 0)
       (<= (+ it1689 (* it1094 (- 1))) 0)
