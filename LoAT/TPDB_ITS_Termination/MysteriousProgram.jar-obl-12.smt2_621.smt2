...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!2 (> (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) 0))
      (a!3 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1548 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!4 (> (+ (+ it1550 (* it1548 (- 1))) (- 1)) 0))
      (a!5 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1548 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (>= (+ (+ it1550 (* it1548 (- 1))) (- 2)) 0))
      (a!7 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 2)))
      (a!8 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1548 (- 1))))
      (a!9 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!10 (>= (+ (+ it1550 (* it1548 (- 1))) (- 1)) 0))
      (a!11 (> (+ (* (+ it819 (- 1)) it673) it1548 (* it803 (+ it819 (- 1))) 1)
               0))
      (a!13 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 4)))
      (a!14 (> (+ it673
                  (* (+ it819 (- 1)) it673)
                  it1548
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!15 (> (+ (+ (* it803 it819) (* it673 it819)) it1548 1) 0))
      (a!16 (+ (+ (+ it817 (* it673 (- 1))) (* it1548 (- 1))) (- 3))))
(let ((a!12 (> (+ (+ (+ a!1 it817) (* it1548 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       (> (+ it1550 (* it1548 (- 1))) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       (> (+ (+ a!1 it817) (* it1548 (- 1))) 0)
       (>= (+ it673 (- 1)) 0)
       a!2
       (>= (+ a!3 (- 3)) 0)
       (>= (+ it803 (- 1)) 0)
