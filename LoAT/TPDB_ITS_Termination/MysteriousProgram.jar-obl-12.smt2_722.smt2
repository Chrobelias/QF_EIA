...
(assert (let ((a!1 (> (+ (+ (* it999 (- 1)) it117) (- 1)) 0))
      (a!2 (>= (+ (+ (* it999 (- 1)) it117) (- 2)) 0))
      (a!3 (>= (+ (+ (* it999 (- 1)) it117) (- 1)) 0))
      (a!4 (>= (+ (+ it1501 (* it117 (- 1))) (- 2)) 0))
      (a!5 (<= (+ (+ (* it1501 (- 1)) it999) it117 (* it997 (- 1))) 0))
      (a!6 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!7 (>= (+ (+ it1501 (* it117 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!9 (> (+ (+ it1501 (* it117 (- 1))) 1) 0))
      (a!10 (> (+ (+ (* it999 (- 1)) it117) 1) 0)))
  (and (> (+ it117 1) 0)
       (> it105 0)
       (> it104 0)
       (> it102 0)
