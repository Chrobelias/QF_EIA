...
(assert (let ((a!1 (+ (+ (* it1615 (- 1)) it817) (* it909 (- 1)) (* it673 (- 1))))
      (a!2 (+ (+ (* it1615 (- 1)) it817)
              (* it803 (- 1))
              (* it909 (- 1))
              (* it673 (- 1))))
      (a!4 (>= (+ (+ (* it1615 (- 1)) (* it909 (- 1)) it1617) (- 2)) 0))
      (a!5 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!6 (+ (+ (* it1615 (- 1)) (* it909 (- 1)) it1617) (- 1)))
      (a!7 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!9 (> (+ (+ (+ it1615 it909) it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
