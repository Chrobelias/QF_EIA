...
(assert (let ((a!1 (> (+ (+ it909 it1398)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!2 (> (+ (+ (+ it909 it1398) it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!3 (+ (+ it1400 (* it909 (- 1)) (* it1398 (- 1))) (- 1)))
      (a!4 (+ it817 (* it909 (- 1)) (* it1398 (- 1)) (* it673 (- 1))))
      (a!5 (+ it817
              (* it803 (- 1))
              (* it909 (- 1))
              (* it1398 (- 1))
      ...
      (a!7 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!9 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it1400 (* it909 (- 1)) (* it1398 (- 1))) (- 2)) 0))
      (a!11 (> (+ (+ (+ it909 it1398) it673) 1) 0)))
(let ((a!6 (+ a!5
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!8 (+ a!4
