...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      ...
      (a!4 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!7 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!9 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it997 (- 1))))
      (a!10 (+ (+ it817 (* it673 (- 1)) (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!12 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* it909 (- 1))
      ...
      (a!16 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!18 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!19 (+ (+ (* it803 it819) (* it673 it819)) it909 it997))
      (a!21 (> (+ (+ (* it803 it819) (* it673 it819)) it997 1) 0))
      (a!22 (> (+ it997 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0)))
(let ((a!5 (> (+ (+ a!4 (* it909 (- 1)) (* it997 (- 1))) (- 1)) 0))
      (a!6 (+ (+ a!1 (* it909 (- 1)) (* it997 (- 1))) (* it359 (- 1))))
      (a!8 (>= (+ (+ a!1 (* it909 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!13 (+ (+ a!4 (* it909 (- 1)) (* it997 (- 1))) (* it359 (- 1))))
      (a!17 (+ (+ a!1 (* it909 (- 1)) (* it997 (- 1))) (- 1)))
      (a!20 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!23 (>= (+ (+ a!4 (* it909 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!24 (> (+ (+ a!1 (* it997 (- 1))) (- 1)) 0)))
  (and (> (+ a!1
             (* it1137 (- 1))
             (* it909 (- 1))
             (* it997 (- 1))
