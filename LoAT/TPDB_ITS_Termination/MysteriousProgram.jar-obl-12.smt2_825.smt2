...
(assert (let ((a!1 (+ it1702 (* (* (+ it1699 (- 1)) it1700) (- 1))))
      (a!4 (> (+ (+ it1702 (* it117 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it1702 (* it117 (- 1))) (- 2)) 0))
      (a!6 (> (+ (+ it1702 (* it117 (- 1))) 1) 0))
      (a!7 (+ (+ (+ it117 (* it1617 (- 1))) (* it359 (- 1))) (- 1)))
      (a!8 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it1617 1)
              0))
      (a!9 (>= (+ (* (* it1045 it359) (- 1))
                  it117
                  (* it1617 (- 1))
      ...
      (a!10 (<= (+ it1615
                   ...
                   (* it1617 (- 1)))
                0))
      (a!11 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
               (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!13 (>= (+ (+ it117 (* it1617 (- 1))) (- 1)) 0))
      (a!14 (> (+ (+ it117 (* it1617 (- 1))) (- 1)) 0))
      (a!15 (> (+ (+ it117 (* it1617 (- 1))) (* it359 (- 1))) 0))
      (a!17 (>= (+ (+ it117 (* it1617 (- 1))) (- 2)) 0))
      (a!18 (> (+ (+ it117 (* it1617 (- 1))) 1) 0))
      ...
      (a!25 (> (+ (* (+ it1699 (- 1)) it1700)
                  ...
                  1)
               0)))
(let ((a!2 (+ a!1 (* it117 (- 1)) (* (* (+ it1699 (- 1)) it1701) (- 1))))
      (a!12 (+ (+ a!11 it117 (* it1617 (- 1))) (* it359 (- 1))))
      (a!16 (> (+ (+ a!11 it117 (* it1617 (- 1))) (- 1)) 0))
      (a!19 (>= (+ (+ a!11 it117 (* it1617 (- 1))) (- 2)) 0))
      (a!24 (+ a!1
               (* it1700 (- 1))
               (* it117 (- 1))
               (* (* (+ it1699 (- 1)) it1701) (- 1))
               (* it1701 (- 1)))))
(let ((a!3 (> (+ (+ a!2 (* it1701 (- 1))) (- 1)) 0))
      (a!22 (>= (+ (+ a!2 (* it1701 (- 1))) (- 1)) 0)))
  (and (> (+ it117 1) 0)
       a!3
       (>= (+ it1699 (- 1)) 0)
       a!4
       ...
       (= 0 0)
       (>= (+ it117 (* it1617 (- 1))) 0)
       (>= (+ (* it1045 it359) (* it117 (- 1)) it1617 (* it1045 it909) 1) 0)
       a!15
       a!16
       (>= (+ a!12 (- 1)) 0)
       (>= (+ it909 (- 1)) 0)
       ...
       (>= (+ (* it1612 (- 1)) 6) 0)
       (>= (+ it1702 (* it117 (- 1))) 0)
       (> (+ a!11 (* it909 (- 1)) it117 (* it1617 (- 1)) (* it359 (- 1))) 0)
       (<= (+ it1613 (* it1698 (- 1))) 0)
       (> it1616 0)
       (>= a!7 0)
       (<= (+ (* it1702 (- 1)) it1617) 0)
       ...
       (<= (+ it1614 (* it1698 (- 1))) 0)
       (> it1613 0)
       (> (+ (* it909 (- 1)) it117 (* it1617 (- 1)) (* it359 (- 1))) 0)
       (>= (+ (* it1698 (- 1)) it1695) 0)
       (> it1617 0)
       a!18
       a!19
