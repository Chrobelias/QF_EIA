...
(assert (and (<= (+ it190 (* it191 (- 1)) 1) 0)
     (<= (+ (* it190 (- 1)) 3) 0)
     (= (+ it185 (- 4)) 0)))
(assert (= (+ it194 (- 4)) 0))
(assert (= (+ it195 (* it190 (- 1))) 0))
(assert (= (+ it196 (* it191 (- 1))) 0))
(assert (= (+ it197 (* it188 (- 1))) 0))
(assert (= (+ it198 (* it189 (- 1))) 0))
(assert (= (+ it199 (* it190 (- 2))) 0))
(assert (= (+ it200 (* it191 (- 1)) (- 1)) 0))
(assert (and (>= (+ it194 (- 4)) 0)
     (>= (+ (* it194 (- 1)) 4) 0)
     (>= (+ it199 (- 3)) 0)
     (>= (+ (* it199 (- 1)) it200 (- 1)) 0)
     (< (+ it199 (- 1)) 0)))
