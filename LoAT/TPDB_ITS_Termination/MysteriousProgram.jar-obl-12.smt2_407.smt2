...
(assert (and (> it140 0)
     ...
     (> (+ it1317 (* it1315 (- 1))) 0)))
(assert (= (+ it1326 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it1327) 0))
(assert (= (+ (* it1314 (- 1)) it1328) 0))
(assert (= (+ it1329 (* it1315 (- 1)) (- 1)) 0))
(assert (= (+ it1330 (* it1315 (- 1)) (- 1)) 0))
(assert (= (+ it1331 (* it127 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it1329 (- 1)) (* it292 (- 1))) it1331) 0))
      (a!2 (> (+ (+ (* it1329 (- 1)) (* it292 (- 1))) it1333) 0))
      (a!3 (+ (+ (+ (* it1329 (- 1)) (* it292 (- 1))) it1333) (* it310 (- 1)) 1))
      (a!4 (+ (+ (+ (* it1329 (- 1)) (* it292 (- 1))) it1331) 1)))
  (and (> it1327 0)
       (<= (+ it1327 (* it322 (- 1))) 0)
       (>= (+ it1329 (* it1330 (- 1))) 0)
       (> (+ it1333 (- 1)) 0)
