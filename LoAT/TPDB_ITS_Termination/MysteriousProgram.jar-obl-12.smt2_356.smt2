...
(assert (let ((a!1 (>= (+ (+ it1284 (* it1282 (- 1))) (- 2)) 0))
      (a!2 (>= (+ (+ it1093 (* it1282 (- 1)) (* it1276 (- 1))) (- 3)) 0))
      (a!3 (+ it1093 (* it673 (- 1)) (* it1282 (- 1)) (* it1276 (- 1))))
      (a!4 (>= (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ it1284 (* it1282 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ it1093 (* it1282 (- 1)) (* it1276 (- 1))) (- 2)) 0)))
  (and (> it1283 0)
       (>= (+ (* it1279 (- 1)) 6) 0)
       (<= (+ it673 it1276) 0)
       (> it1284 0)
