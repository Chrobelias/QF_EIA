...
(assert (and (> it90 0)
     ...
     (> (+ it999 (* it997 (- 1)) (- 1)) 0)))
(assert (= (+ it1312 (- 10)) 0))
(assert (= (+ it1313 (* it90 (- 1))) 0))
(assert (= (+ it1314 (* it997 (- 1))) 0))
(assert (= (+ it1315 (* it997 (- 1))) 0))
(assert (= (+ (* it997 (- 1)) it1316) 0))
(assert (= (+ it1317 (* it999 (- 1))) 0))
(assert (and (> it110 0)
     (> it107 0)
     (> it109 0)
     (<= (+ (* it1313 (- 1)) it107) 0)
     ...
     (> (+ it1314 1) 0)))
(assert (= (+ it1334 (- 6)) 0))
(assert (= (+ (* it110 (- 1)) it1335) 0))
(assert (= (+ (* it109 (- 1)) it1336) 0))
(assert (= (+ (* it1314 (- 1)) it1337 (- 1)) 0))
(assert (= (+ it1338 (* it107 (- 1))) 0))
(assert (= (+ (* it1317 (- 1)) it1339) 0))
(assert (let ((a!1 (> (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      ...
      (a!4 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!7 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it359 it1337 1))
      (a!8 (> (+ (* (+ it819 (- 1)) it673) it1337 (* it803 (+ it819 (- 1))) 1)
              0))
      (a!9 (+ (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) (- 2)))
      (a!11 (> (+ it673
                  (* (+ it819 (- 1)) it673)
                  it1337
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!12 (>= (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!13 (+ (+ it817 (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* it1337 (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* it1337 (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (+ (* (* it803 it819) (- 1))
      ...
      (a!19 (> (+ (* it803 it819)
                  ...
                  1)
               0))
      (a!20 (> (+ (+ (* it803 it819) (* it673 it819)) it1337 1) 0))
      (a!21 (+ (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) (- 4)))
      (a!22 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1337 (- 1))))
      (a!24 (>= (+ (+ it1339 (* it1337 (- 1))) (- 2)) 0))
      (a!26 (> (+ (+ it817 (* it673 (- 1))) (* it1337 (- 1))) 0))
      (a!27 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it1337 1)))
(let ((a!3 (+ (+ a!2 (* it909 (- 1))) (* it359 (- 1)) (* it1337 (- 1))))
      (a!5 (+ (+ a!4 (* it909 (- 1))) (* it359 (- 1)) (* it1337 (- 1))))
      (a!6 (+ (+ (+ a!2 (* it909 (- 1))) (* it1337 (- 1))) (- 1)))
      (a!10 (> (+ (+ a!2 (* it1337 (- 1))) (- 1)) 0))
      (a!17 (+ (+ (+ a!4 (* it909 (- 1))) (* it1337 (- 1))) (- 1)))
      (a!18 (+ (+ (+ a!4 (* it909 (- 1))) (* it1337 (- 1))) (- 2)))
      (a!23 (> (+ (+ a!2 (* it909 (- 1))) (* it1337 (- 1))) 0))
      (a!25 (+ (+ (+ a!2 (* it909 (- 1))) (* it1337 (- 1))) (- 2))))
  (and (>= (+ it1336 (* it1138 (- 1))) 0)
       a!1
       (>= (+ a!3 (- 1)) 0)
       (>= (+ a!5 (- 1)) 0)
       (> a!3 0)
