...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!3 (+ (* (* it803 it819) (- 1))
              ...
              (* (* it673 it819) (- 1))
              it817))
      (a!5 (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 3)) 0))
      (a!7 (> (+ it1729 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!9 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1729 (- 1))))
      (a!12 (> (+ (+ it673 it1729)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!13 (> (+ (+ (* it803 it819) (* it673 it819)) it1729 1) 0))
      (a!15 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it1729 1))
      (a!17 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it1735 it1729 1))
      (a!18 (+ (+ (+ (* it803 it819) (* it673 it819)) it909)
               (* it1045 it1735)
               (* it1137 it1045)))
      (a!19 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  ...
                  1)
               0))
      (a!20 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 4)) 0))
      (a!21 (>= (+ (+ it1731 (* it1729 (- 1))) (- 2)) 0))
      (a!23 (> (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!24 (>= (+ (+ it1731 (* it1729 (- 1))) (- 1)) 0))
      (a!25 (>= (+ (+ it817 (* it673 (- 1)) (* it1729 (- 1))) (- 2)) 0)))
(let ((a!2 (+ (+ (+ a!1 it817) (* it909 (- 1)))
              (* it1735 (- 1))
              (* it1729 (- 1))))
      (a!4 (+ (+ a!3 (* it909 (- 1)))
              (* it1729 (- 1))
              (* (* (+ it1045 (- 1)) it1735) (- 1))))
      (a!8 (> (+ (+ (+ a!1 it817) (* it1729 (- 1))) (- 1)) 0))
      (a!10 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (+ (+ (+ a!1 it817) (* it909 (- 1))) (* it1729 (- 1))))
      (a!14 (+ (+ a!3 (* it909 (- 1)))
               (* it1735 (- 1))
               (* it1729 (- 1))
               (* (* (+ it1045 (- 1)) it1735) (- 1))))
