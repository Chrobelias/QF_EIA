...
(assert (let ((a!1 (+ (+ (* it1057 (- 1)) it1064 (* it1062 (- 1))) (- 1)))
      (a!2 (> (+ (+ (* it1056 (- 1)) (* it1057 (- 1))) it1064 (* it1062 (- 1)))
              0))
      (a!3 (> (+ (+ it1064 (* it1062 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ it1064 (* it1062 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it1064 (* it1062 (- 1))) (- 2)) 0)))
  (and (> it1064 0)
       (> (+ it1064 (- 1)) 0)
       (> it1060 0)
       (> it1063 0)
