...
(assert (let ((a!1 (+ (* (* it1045 it359) (- 1))
      ...
      (a!2 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              it999
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!4 (* (+ (* it1045 it359) (* it1045 it909)) (+ it1068 (- 1))))
      (a!7 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!8 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!10 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0))
      (a!11 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!12 (>= (+ (+ it999 (* it997 (- 1))) (- 3)) 0))
      (a!13 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!19 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (* (* it1045 it359) (- 1)) (* (* it1045 it909) (- 1)) (- 1))
                0)))
(let ((a!3 (+ (+ (+ a!2 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!5 (+ (* a!4 (- 1)) (* (* it1045 it359) (+ it1068 (- 1))) it997))
      (a!9 (+ (* (* it1045 it359) (- 1))
              a!4
              it999
      ...
      (a!17 (+ a!4
               ...
               (* it997 (- 1))
               (* (* (* it1045 it909) (+ it1068 (- 1))) (- 1))))
      (a!21 (>= (+ (+ a!2 (* it997 (- 1))) (- 2)) 0))
      (a!22 (> (+ (+ a!2 (* it997 (- 1))) (* it359 (- 1))) 0)))
(let ((a!6 (> (+ a!5 it359 (* (* it1045 it909) (+ it1068 (- 1))) 1) 0))
      (a!18 (> (+ a!5 (* (* it1045 it909) (+ it1068 (- 1))) 1) 0)))
  (and (> it107 0)
       (>= (+ a!1 (- 4)) 0)
       (> a!3 0)
       (> (+ it997 it359 1) 0)
       ...
       (>= (+ a!17 (- 2)) 0)
       a!20
       (> (+ (* it1045 it359) it997 (* it1045 it909) 1) 0)
       (> (+ it997 1) 0)
       a!21
       a!22)))))
(check-sat)
