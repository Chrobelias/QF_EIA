...
(assert (let ((a!1 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!2 (+ it1400 (* it803 (- 1)) (* it1398 (- 1)) (* it673 (- 1))))
      (a!4 (* (+ (* it803 it819) (* it673 it819)) (+ it921 (- 1))))
      (a!7 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!9 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!11 (+ (+ it1398 (* (+ it819 (- 1)) it673)) (* it803 (+ it819 (- 1))) 1))
      (a!13 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!16 (> (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) 0))
      (a!18 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 3)))
      (a!20 (+ (+ (+ it1398 it673) (* (+ it819 (- 1)) it673))
               (* it803 (+ it819 (- 1)))
               1))
      (a!21 (+ (+ (+ (* it803 it819) (* it673 it819)) it1398) 1))
      (a!23 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0))
      (a!26 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 2)))
      (a!27 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1))) (- 4))))
(let ((a!3 (+ a!2 (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!6 (+ a!2
              a!4
              (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
              (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!8 (+ (+ it1398 (* (+ it819 (- 1)) it673))
              (* a!4 (- 1))
              (* (* it673 it819) (+ it921 (- 1)))
              (* it803 (+ it819 (- 1)))
              (* (* it803 it819) (+ it921 (- 1)))
      ...
      (a!10 (+ a!9
               ...
               (* (* it803 (+ it819 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!14 (> (+ (+ a!13 it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!15 (+ a!9 (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!17 (+ (+ (+ it1400 (* it1398 (- 1))) (* it673 (- 1)))
               a!4
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!19 (+ (+ a!13 it1400 (* it1398 (- 1)))
               a!4
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!22 (+ (+ (+ it1398 it673) (* (+ it819 (- 1)) it673))
               (* a!4 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* it803 (+ it819 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
               1))
      (a!24 (+ (+ it1400 (* it1398 (- 1)))
               a!4
               (* (* (* it673 it819) (+ it921 (- 1))) (- 1))
               (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!25 (+ (+ (+ (* it803 it819) (* it673 it819)) it1398)
               (* a!4 (- 1))
               (* (* it673 it819) (+ it921 (- 1)))
               (* (* it803 it819) (+ it921 (- 1)))
               1)))
(let ((a!5 (+ a!3
              ...
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* (* (* it803 it819) (+ it921 (- 1))) (- 1))))
      (a!12 (+ a!3 (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (>= (+ (* it1403 (- 1)) it1399) 0)
       a!1
       (>= (+ it673 (- 1)) 0)
       (>= (+ a!5 (- 1)) 0)
       (>= (+ it1399 (- 1)) 0)
