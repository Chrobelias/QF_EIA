...
(assert (let ((a!1 (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1716 (- 1))))
      (a!4 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!7 (>= (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 3)) 0))
      (a!10 (<= (+ (+ (* it803 it819) (* it673 it819)) it1719) 0))
      (a!11 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 4)) 0))
      (a!12 (> (+ (+ it673 it1716)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!13 (> (+ (+ it1718 (* it1716 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ it817 (* it673 (- 1)) (* it1716 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it1718 (* it1716 (- 1))) (- 2)) 0))
      (a!16 (> (+ (+ (* it803 it819) (* it673 it819)) it1716 1) 0))
      (a!17 (> (+ it1716 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!5 (>= (+ (+ (+ a!4 it817) (* it1716 (- 1))) (- 1)) 0))
      (a!6 (+ (+ a!4 it817) (* it1719 (- 1)) (* it1716 (- 1))))
      (a!9 (>= (+ (+ (+ a!4 it817) (* it1716 (- 1))) (- 2)) 0))
      (a!18 (> (+ (+ (+ a!4 it817) (* it1716 (- 1))) (- 1)) 0)))
  (and (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it673 (- 1)) 0)
       (>= (+ a!1 (- 4)) 0)
