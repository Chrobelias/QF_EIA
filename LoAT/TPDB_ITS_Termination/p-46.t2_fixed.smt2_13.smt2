...
(assert (and (= (+ (* it149 (- 1)) it148) 0)
     ...
     (= (+ it147 (- 5)) 0)))
(assert (= (+ it157 (- 7)) 0))
(assert (= (+ (* it149 (- 3)) it158 (- 1)) 0))
(assert (= (+ (* it149 (- 1)) it159) 0))
(assert (= (+ (* it150 (- 1)) it160) 0))
(assert (= (+ (* it151 (- 1)) it161) 0))
(assert (= (+ (* it152 (- 1)) it162) 0))
(assert (= (+ (* it153 (- 1)) it163) 0))
(assert (and (<= (+ (* it159 (- 1)) 1) 0)
     (<= (+ (* it159 (- 1)) (* it163 2) 1) 0)
     (= (+ it157 (- 7)) 0)))
(assert (= (+ it164 (- 2)) 0))
(assert (= (+ it165 (* it158 (- 1))) 0))
(assert (= (+ (* it159 (- 1)) it166) 0))
(assert (= (+ (* it160 (- 1)) it167) 0))
(assert (= (+ it168 (* it161 (- 1))) 0))
(assert (= (+ (* it162 (- 1)) it169) 0))
(assert (= (+ (* it163 (- 1)) it170) 0))
(assert (and (>= (+ (* it156 2) (- 1)) 0)
     (<= (+ it165 (* it156 (- 1))) 0)
     (>= (+ it164 (- 2)) 0)
     (>= (+ it165 (- 1)) 0)
     (>= (+ (* it164 (- 1)) 2) 0)
