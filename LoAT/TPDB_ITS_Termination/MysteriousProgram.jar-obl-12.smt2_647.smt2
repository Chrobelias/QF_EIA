...
(assert (let ((a!1 (+ (+ (* it1563 (- 1)) (* it359 (- 1)) it1565) (- 1)))
      (a!2 (+ (* (* it1045 it359) (- 1)) it817 (* it1563 (- 1))))
      (a!4 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!5 (>= (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!6 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              (* it1563 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!9 (>= (+ (+ (* it1563 (- 1)) it1565) (- 2)) 0))
      (a!13 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!14 (+ (+ (+ (* it1045 it359) it1563) (* it1045 it909)) 1))
      (a!15 (+ (* (* it1045 it359) (- 1))
               (* it1563 (- 1))
               (* (* it1045 it909) (- 1))
               it1565))
      (a!16 (+ (+ (+ (* it1045 it359) it1563) (* it1045 it909))
               (* (+ it819 (- 1)) it673)
               (* it803 (+ it819 (- 1)))
               1))
      (a!17 (+ (+ (* it1045 it359) it1563) it673 (* it1045 it909)))
      (a!18 (> (+ (* (+ it1045 (- 1)) it359)
                  it1563
                  (* (+ it1045 (- 1)) it909)
                  1)
               0)))
(let ((a!3 (+ a!2 (* it803 (- 1)) (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!7 (>= (+ (+ a!6 (* it359 (- 1)) it1565) (- 1)) 0))
      (a!10 (> (+ (+ a!6 (* it359 (- 1)) it1565) (- 1)) 0))
      (a!11 (+ a!2 (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!19 (> (+ a!17 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0)))
(let ((a!8 (+ a!3
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (+ a!11
