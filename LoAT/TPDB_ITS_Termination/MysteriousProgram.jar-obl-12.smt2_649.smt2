...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1))
              ...
              it817
              (* it1563 (- 1))))
      (a!3 (+ (+ it817 (* it1563 (- 1))) (* it803 (- 1)) (* it673 (- 1))))
      (a!4 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 3)))
      (a!6 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 4)))
      (a!7 (+ (* (* it803 it819) (- 1))
              (* (* (+ it1045 (- 1)) it1137) (- 1))
              (* (* it673 it819) (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817
              (* it1563 (- 1))))
      (a!9 (> (+ (+ (* it803 it819) (* it673 it819) it1563) 1) 0))
      (a!11 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               ...
               (* it909 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!14 (+ (+ (* it803 it819) (* it673 it819) it1563) it909))
      (a!15 (>= (+ (+ (* it1563 (- 1)) it1565) (- 2)) 0))
      (a!18 (> (+ (+ it1563 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (>= (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!20 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!22 (> (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) 0))
      (a!25 (> (+ it1563 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!26 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  ...
                  1)
               0))
      (a!27 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 2))))
(let ((a!2 (> (+ (+ a!1 (* it909 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!8 (+ (+ (+ a!7 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!10 (>= (+ (+ a!1 (* it909 (- 1))) (- 1)) 0))
      (a!12 (> (+ (+ a!7 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!16 (+ (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!17 (+ a!3
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!21 (>= (+ (+ a!1 (* it909 (- 1))) (- 2)) 0))
      (a!23 (> (+ (+ a!7 (* it909 (- 1))) (- 1)) 0))
      (a!24 (>= (+ (+ a!7 (* it909 (- 1))) (- 2)) 0)))
  (and (> (+ (+ it1563 it673) 1) 0)
       a!2
       (<= (+ it1561 (* it1138 (- 1))) 0)
       (>= (+ a!3 (- 1)) 0)
       (>= a!4 0)
       ...
       (>= a!6 0)
       (> it817 0)
       (> (+ a!7 (* it1137 (- 1)) (* it909 (- 1)) (* it359 (- 1))) 0)
       (> (+ it817 1) 0)
       (>= (+ it1138 (- 1)) 0)
       (> a!8 0)
       a!9
