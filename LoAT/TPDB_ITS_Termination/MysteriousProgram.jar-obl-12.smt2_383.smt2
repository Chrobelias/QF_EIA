...
(assert (let ((a!1 (* (* (* (+ it1303 (- 1)) it1045) it359) (- 1)))
      (a!3 (* (* (* (+ it1303 (- 1)) it1045) it909) (- 1)))
      (a!5 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              it999
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!7 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!8 (+ (+ (* (* it1045 it359) (- 1)) it999)
              (* it673 (- 1))
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!9 (+ (+ (* (* it1045 it359) (- 1)) it999)
              (* it803 (- 1))
              (* it673 (- 1))
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!10 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ (* it1045 it359) it997 (* it1045 it909)) 1) 0))
      (a!14 (+ (+ (* (* it1045 it359) (- 1)) it999)
               (* it997 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!15 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909)) 1) 0))
      (a!22 (+ (* (+ it1303 (- 1)) it673 it819)
      ...
      (a!27 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!28 (> (+ (+ (* it1045 it359) it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!30 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0))
      (a!32 (= (+ (* it803 it819 (- 1))
                  (* (* it1045 it359) (- 1))
                  (* it673 it819 (- 1))
                  (* (* it1045 it909) (- 1)))
               0))
      (a!34 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!36 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!2 (+ (* (* it1045 it359) (- 1))
              (* (* (+ it1303 (- 1)) it673 it819) (- 1))
              a!1
              (* (* (+ it1303 (- 1)) it803 it819) (- 1))
              it999))
      (a!6 (> (+ (+ a!5 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!16 (+ (+ (+ a!5 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!17 (> (+ (+ a!5 (* it997 (- 1))) (- 1)) 0))
      (a!18 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!21 (+ a!8
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!23 (+ a!22 (* (* (+ it1303 (- 1)) it1045) it909) it997))
      (a!24 (>= (+ (+ a!5 (* it997 (- 1))) (- 2)) 0))
      (a!26 (> (+ (+ a!25 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!29 (+ a!22
               ...
               it997
               1))
      (a!31 (> (+ (+ a!25 it997 (* it1045 it909)) 1) 0))
      (a!33 (> (+ (+ a!25 it673 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!35 (> (+ (+ a!25 it673 it997 (* it1045 it909)) 1) 0)))
(let ((a!4 (+ a!2
              a!3
              (* it673 (- 1))
              (* it997 (- 1))
