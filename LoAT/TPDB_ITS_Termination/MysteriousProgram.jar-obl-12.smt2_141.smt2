...
(assert (let ((a!1 (+ (+ (* it803 it819) (* it673 it819))
              (* (* (+ it1022 (- 1)) it803 it819) (- 1))
              (* (* (+ it1022 (- 1)) it673 it819) (- 1))
              it999))
      (a!2 (* (+ (* it803 it819) (* it673 it819)) (+ it1022 (- 1))))
      (a!4 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!12 (+ (+ (+ (* it803 it819) (* it673 it819)) it999)
               (* it803 (- 1))
               (* it673 (- 1))
               (* it997 (- 1))))
      (a!14 (+ (+ (+ (* it803 it819) (* it673 it819)) it999) (* it997 (- 1))))
      (a!15 (+ (+ (+ (* it803 it819) (* it673 it819)) it999)
               (* it673 (- 1))
               (* it997 (- 1))))
      (a!23 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!3 (+ a!1 (* it803 (- 1)) (* it673 (- 1)) a!2 (* it997 (- 1))))
      (a!5 (+ a!4
              (* (+ it1022 (- 1)) it803 it819)
              (* (+ it1022 (- 1)) it673 it819)))
      (a!8 (> (+ (* (+ it1022 (- 1)) it803 it819)
                 (* (+ it1022 (- 1)) it673 it819)
                 (* a!2 (- 1))
                 it997
                 1)
              0))
      (a!10 (>= (+ (+ a!1 (* it673 (- 1)) a!2 (* it997 (- 1))) (- 4)) 0))
      (a!11 (+ (+ a!1 (* it673 (- 1)) a!2 (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (+ a!12
               (* (* (+ it819 (- 1)) it673) (- 1))
      ...
      (a!18 (> (+ (+ a!4 it997)
                  ...
                  1)
               0))
      (a!19 (>= (+ (+ a!1 (* it673 (- 1)) a!2 (* it997 (- 1))) (- 3)) 0))
      (a!20 (> (+ (+ a!4 it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!21 (>= (+ (+ a!1 (* it673 (- 1)) a!2 (* it997 (- 1))) (- 2)) 0)))
(let ((a!6 (> (+ (+ a!5 it673 (* a!2 (- 1)) it997) 1) 0))
      (a!7 (> (+ (+ a!5 (* a!2 (- 1)) it997)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
      ...
      (a!9 (+ a!3
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!17 (> (+ (+ a!5 (* a!2 (- 1)) it997) 1) 0))
      (a!22 (> (+ (+ a!5 it673 (* a!2 (- 1)) it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0)))
