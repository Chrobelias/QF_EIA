...
(assert (let ((a!1 (> (+ (+ (* it1375 (- 1)) it117) (* it867 (- 1)) 1) 0)))
  (and (> (+ it117 1) 0)
       ...
       (>= (+ it1372 (- 9)) 0)
       (>= (+ it1375 (* it1376 (- 1))) 0))))
(assert (= (+ (* it1372 (- 1)) it1429) 0))
(assert (= (+ (* it135 (- 1)) it1430) 0))
(assert (= (+ it1431 (* it1374 (- 1))) 0))
(assert (= (+ (* it1375 (- 1)) it1432 (* it867 (- 1))) 0))
(assert (= (+ (* it1375 (- 1)) it1433 (* it867 (- 1))) 0))
(assert (= (+ (* it117 (- 1)) it1434) 0))
(assert (and (>= (+ (* it1429 (- 1)) 9) 0)
     (>= (+ it849 (- 1)) 0)
     (> (+ (* it1432 (- 1)) it1434) 0)
     (>= (+ (* it1436 (- 1)) it1430) 0)
     (> it1430 0)
     ...
     (> (+ it1434 (- 1)) 0)
     (>= (+ it1429 (- 9)) 0)))
(assert (= (+ it1438 (* it1429 (- 1))) 0))
(assert (= (+ it1439 (* it1436 (- 1))) 0))
(assert (= (+ (* it1431 (- 1)) it1440) 0))
(assert (= (+ it1441 (* it1432 (- 1)) (* it849 (- 1))) 0))
(assert (= (+ (* it1432 (- 1)) (* it849 (- 1)) it1442) 0))
(assert (= (+ it1443 (* it1434 (- 1))) 0))
(assert (and (= (+ it1443 (* it1437 (- 1))) 0)
     (= (- 1) 0)
     (> (+ (* it1441 (- 1)) it1443) 0)
     (> it1439 0)
     (> (+ (* it1440 (- 1)) it1437) 0)
