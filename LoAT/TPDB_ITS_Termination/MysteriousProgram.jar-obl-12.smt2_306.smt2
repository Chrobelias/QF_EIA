...
(assert (and (> (+ it1206 (* it1203 (- 1))) 0)
     ...
     (> (+ it1206 1) 0)))
(assert (= (+ it1210 (- 10)) 0))
(assert (= (+ it1211 (* it1208 (- 1))) 0))
(assert (= (+ (* it1203 (- 1)) it1212) 0))
(assert (= (+ it1213 (* it1204 (- 1)) (- 1)) 0))
(assert (= (+ (* it1204 (- 1)) it1214 (- 1)) 0))
(assert (= (+ (* it1206 (- 1)) it1215) 0))
(assert (let ((a!1 (> (+ (+ (* it1213 (- 1)) (* it1199 (- 1))) it1209) 0))
      (a!2 (> (+ (+ (* it1213 (- 1)) (* it1199 (- 1))) it1215) 0))
      (a!3 (+ (+ (+ (* it1213 (- 1)) (* it1199 (- 1))) it1215) 1)))
  (and (>= (+ it1213 (* it1214 (- 1))) 0)
       a!1
       a!2
       (>= (+ it1210 (- 10)) 0)
       (>= (+ (* it1213 (- 1)) it1214) 0)
       ...
       (> (+ it1209 1) 0)
       (> (+ (* it1212 (- 1)) it1209) 0)
       (> (+ (* it1213 (- 1)) (* it1207 (- 1)) (* it1199 (- 1)) it1209 1) 0)
       (>= (+ (* it1210 (- 1)) 10) 0))))
(check-sat)
