...
(assert (let ((a!1 (* (+ (* it803 it819) (* it673 it819)) (+ it1605 (- 1))))
      (a!4 (+ (* (* it803 it819) (- 1))
              (* it1615 (- 1))
              (* (* it673 it819) (- 1))))
      (a!6 (> (+ (+ (* it803 it819) it1615 (* it673 it819)) 1) 0))
      (a!7 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 4)) 0))
      (a!8 (>= (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) (- 1)) 0))
      (a!9 (+ (+ (* it1615 (- 1)) (* it803 (- 1))) (* it673 (- 1)) it1617))
      (a!10 (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617)
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!17 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 3)) 0))
      (a!20 (>= (+ (+ (* it1615 (- 1)) (* it673 (- 1)) it1617) (- 2)) 0))
      (a!23 (> (+ it1615 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!24 (> (+ (+ it1615 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!26 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!27 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0)))
(let ((a!2 (+ (+ (* it1615 (- 1)) (* it803 (- 1)))
              (* (* (+ it1605 (- 1)) it803 it819) (- 1))
              a!1
              (* (* (+ it1605 (- 1)) it673 it819) (- 1))
              (* it673 (- 1))
              it1617))
      (a!5 (+ a!4
              (* (* (+ it1605 (- 1)) it803 it819) (- 1))
      ...
      (a!12 (+ a!9
               ...
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (+ it1615
               (* (+ it1605 (- 1)) it803 it819)
               (* a!1 (- 1))
               (* (+ it1605 (- 1)) it673 it819)))
      (a!18 (> (+ (+ (* it803 it819) it1615 (* it673 it819))
                  (* (+ it1605 (- 1)) it803 it819)
                  (* a!1 (- 1))
                  (* (+ it1605 (- 1)) it673 it819)
                  1)
...
(let ((a!3 (+ a!2
      ...
      (a!15 (> (+ (+ a!14 it673)
                  ...
                  1)
               0))
      (a!16 (>= (+ (+ a!11 (* it673 (- 1)) it1617) (- 3)) 0))
      (a!19 (+ (+ a!11 (* it673 (- 1)) it1617)
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!21 (> (+ a!14 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!22 (>= (+ (+ a!11 (* it673 (- 1)) it1617) (- 2)) 0))
      (a!25 (>= (+ (+ a!11 (* it673 (- 1)) it1617) (- 4)) 0)))
  (and (> (+ it1617 1) 0)
       (>= (+ a!2 (- 3)) 0)
       (>= (+ a!3 (- 1)) 0)
       (> (+ a!5 (- 1)) 0)
