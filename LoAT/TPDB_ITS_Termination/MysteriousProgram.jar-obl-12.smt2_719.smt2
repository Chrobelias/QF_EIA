...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) it817)
      ...
      (a!4 (+ (+ (* (* it1045 it359) (- 1)) it817)
              ...
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!6 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!7 (> (+ (+ (* it1045 it359) it997 (* it1045 it909))
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!8 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
              it999
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!10 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!11 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0))
      (a!12 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!13 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!14 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!15 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!17 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909)) 1) 0))
      (a!19 (> (+ (+ (* it1045 it359) it997 (* it1045 it909)) 1) 0))
      (a!20 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!5 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (> (+ (+ a!8 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!16 (+ (+ (+ a!8 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!18 (>= (+ (+ a!8 (* it997 (- 1))) (- 2)) 0))
      (a!21 (> (+ (+ a!8 (* it997 (- 1))) (- 1)) 0)))
  (and (>= (+ it994 (- 6)) 0)
       (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
