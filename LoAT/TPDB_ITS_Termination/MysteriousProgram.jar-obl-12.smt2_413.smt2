...
(assert (let ((a!1 (> (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!2 (+ (+ (+ (* it803 (- 1)) it1093) (* it1337 (- 1))) (- 2)))
      (a!3 (+ (+ (+ (* it803 (- 1)) it1093) (* it1337 (- 1))) (- 3)))
      (a!4 (> (+ (+ (* it803 (- 1)) it1093) (* it1337 (- 1))) 0))
      (a!5 (+ (+ (* it803 (- 1)) it1093) (* it673 (- 1)) (* it1337 (- 1))))
      (a!6 (>= (+ (+ it1339 (* it1337 (- 1))) (- 2)) 0))
      (a!7 (>= (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0)))
  (and (= (+ (* it1093 (- 1)) it1339) 0)
       a!1
       (>= (+ it1334 (- 6)) 0)
       (> it1093 0)
       (>= (+ it673 (- 1)) 0)
