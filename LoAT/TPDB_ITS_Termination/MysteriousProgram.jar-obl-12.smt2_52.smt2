...
(assert (and (> it140 0)
     ...
     (> it279 0)))
(assert (= (+ it328 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it329) 0))
(assert (= (+ (* it280 (- 1)) it330) 0))
(assert (= (+ it331 (* it281 (- 1)) (- 1)) 0))
(assert (= (+ it332 (* it281 (- 1)) (- 1)) 0))
(assert (= (+ (* it283 (- 1)) it333) 0))
(assert (let ((a!1 (+ (+ (+ (* it331 (- 1)) (* it292 (- 1))) it333) 1))
      (a!2 (> (+ (+ (* it331 (- 1)) (* it292 (- 1))) it333) 0))
      (a!3 (> (+ (+ (* it331 (- 1)) (* it292 (- 1))) it127) 0))
      (a!4 (> (+ (+ (* it331 (- 1)) (* it292 (- 1))) (* it310 (- 1)) it127 1) 0)))
  (and (> (+ it127 1) 0)
       (>= (+ it329 (* it322 (- 1))) 0)
       (> it329 0)
       (> a!1 0)
