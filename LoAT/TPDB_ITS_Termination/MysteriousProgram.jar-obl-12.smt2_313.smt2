...
(assert (let ((a!1 (+ it817
              (* it803 (- 1))
              (* it1220 (- 1))
              (* it673 (- 1))
              (* it1106 (- 1))))
      (a!2 (+ it817 (* it1220 (- 1)) (* it673 (- 1)) (* it1106 (- 1))))
      (a!4 (> (+ (+ it1222 (* it1220 (- 1))) (* it1106 (- 1))) 0))
      (a!5 (+ (+ (+ it1222 (* it1220 (- 1))) (* it1106 (- 1))) (- 1)))
      (a!7 (> (+ (+ it1220 it673 it1106)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!8 (+ (+ (+ it1222 (* it1220 (- 1))) (* it1106 (- 1))) (- 2)))
      (a!9 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it1106 (- 1))))
      (a!10 (> (+ (+ it1222 (* it1220 (- 1))) (- 1)) 0))
      (a!11 (> (+ (+ it1220 it1106)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
...
(let ((a!3 (+ a!2
  ...
  (and (>= (+ a!1 (- 3)) 0)
       ...
       (>= (+ a!6 (- 3)) 0)
       (>= (+ a!3 (- 4)) 0)
       (<= (+ (* it803 it819) (* it673 it819) it1106) 0)
       (>= (+ it1106 (- 1)) 0)
       (> it818 0)
       (> (+ it817 (- 1)) 0)
       (>= (+ it819 (- 1)) 0)
