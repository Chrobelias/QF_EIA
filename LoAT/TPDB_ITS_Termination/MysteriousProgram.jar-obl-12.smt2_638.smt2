...
(assert (let ((a!1 (> (+ (+ (+ it1563 it909) it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!2 (+ (+ (* it1563 (- 1)) (* it909 (- 1)) it1565) (- 1)))
      (a!3 (+ (+ it817 (* it1563 (- 1))) (* it909 (- 1)) (* it673 (- 1))))
      (a!5 (> (+ (+ (+ it1563 it909) it673) 1) 0))
      (a!6 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))))
      (a!7 (>= (+ (+ (* it1563 (- 1)) (* it909 (- 1)) it1565) (- 2)) 0))
      (a!8 (+ (+ it817 (* it1563 (- 1)))
              (* it803 (- 1))
              (* it909 (- 1))
              (* it673 (- 1))))
      (a!10 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!11 (> (+ (+ it1563 it909)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
