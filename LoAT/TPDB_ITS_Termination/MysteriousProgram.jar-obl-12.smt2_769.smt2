...
(assert (and (> it135 0)
     ...
     (> (+ it1650 (- 1)) 0)))
(assert (= (+ it1652 (- 9)) 0))
(assert (= (+ (* it135 (- 1)) it1653) 0))
(assert (= (+ it1654 (* it1647 (- 1))) 0))
(assert (= (+ it1655 (* it1648 (- 1)) (- 1)) 0))
(assert (= (+ (* it1648 (- 1)) it1656 (- 1)) 0))
(assert (= (+ it1657 (* it1650 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ it1657 (* it1655 (- 1))) (* it849 (- 1))) 0))
      (a!2 (> (+ (+ (* it1655 (- 1)) (* it849 (- 1)) it117) (* it867 (- 1)) 1)
              0))
      (a!3 (+ (+ (+ it1657 (* it1655 (- 1))) (* it849 (- 1))) 1)))
  (and (> (+ it117 1) 0)
       (>= (+ it849 (- 1)) 0)
       (> (+ it117 (- 1)) 0)
       (<= (+ it1657 (* it117 (- 1))) 0)
