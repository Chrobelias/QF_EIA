...
(assert (let ((a!1 (* (+ (* it803 it819) (* it673 it819)) (+ it1605 (- 1))))
      (a!5 (> (+ it997 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!6 (+ (+ it999 (* it673 (- 1)) (* it997 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!7 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!12 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!16 (+ (+ it999 (* it803 (- 1))) (* it673 (- 1)) (* it997 (- 1))))
      (a!17 (> (+ (+ (* it803 it819) (* it673 it819)) it997 1) 0))
      (a!18 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!20 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!21 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!25 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!29 (> (+ (+ it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
...
(let ((a!2 (+ (* (+ it1605 (- 1)) it803 it819)
      ...
      (a!10 (+ (+ it999 (* it803 (- 1)))
               ...
               (* it673 (- 1))
               (* it997 (- 1))))
      (a!13 (>= (+ (+ (+ a!12 it999) (* it997 (- 1))) (- 2)) 0))
      (a!14 (> (+ (+ (+ a!12 it999) (* it997 (- 1))) (- 1)) 0))
      (a!22 (> (+ (+ (* it803 it819) (* it673 it819))
      ...
      (a!23 (+ (+ a!12 it999)
               ...
               (* (* (+ it1605 (- 1)) it673 it819) (- 1))
               (* it997 (- 1))))
      (a!24 (>= (+ (+ (+ a!12 it999) (* it997 (- 1))) (- 1)) 0))
      (a!27 (+ a!16
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1)))))
(let ((a!4 (>= (+ (+ a!3 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!8 (>= (+ (+ a!3 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!9 (+ (+ a!3 (* it673 (- 1)) (* it997 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (+ a!10
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (> (+ (+ a!2 it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (>= (+ (+ a!3 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!26 (> (+ (+ a!2 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!28 (>= (+ (+ a!3 (* it997 (- 1))) (- 1)) 0)))
  (and (> it107 0)
       (> (+ (+ a!2 it673 it997) 1) 0)
       (>= (+ it996 (- 1)) 0)
       a!4
       ...
       a!15
       (>= (+ a!6 (- 3)) 0)
       (> (+ a!3 (* it673 (- 1)) (* it997 (- 1))) 0)
       (> (+ it999 (* it673 (- 1)) (* it997 (- 1))) 0)
       (>= (+ a!11 (- 2)) 0)
       (>= (+ a!11 (- 1)) 0)
       (>= (+ a!16 (- 3)) 0)
       (>= (+ a!16 (- 1)) 0)
