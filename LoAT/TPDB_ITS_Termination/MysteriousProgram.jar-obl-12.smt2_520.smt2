...
(assert (let ((a!1 (+ (+ (+ (* it803 it819) (* it673 it819)) it1400) (* it1398 (- 1))))
      (a!4 (+ (+ (* it803 it819) (* it673 it819))
              (* (* (+ it1022 (- 1)) it803 it819) (- 1))
              (* (* (+ it1022 (- 1)) it673 it819) (- 1))
              it1400))
      (a!5 (* (+ (* it803 it819) (* it673 it819)) (+ it1022 (- 1))))
      (a!8 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!11 (+ (+ (+ (* it803 it819) (* it673 it819)) it1400)
               (* it803 (- 1))
               (* it1398 (- 1))
               (* it673 (- 1))))
      (a!19 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it673 (- 1))) (- 2)) 0))
      (a!3 (+ (+ a!1 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (+ a!4 (* it803 (- 1)) (* it1398 (- 1)) (* it673 (- 1)) a!5))
      (a!9 (> (+ (+ (+ a!8 it1398) it673) 1) 0))
      (a!10 (+ (+ a!4 (* it1398 (- 1)) (* it673 (- 1)) a!5)
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!12 (+ a!11
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (>= (+ (+ a!1 (* it673 (- 1))) (- 3)) 0))
      (a!14 (+ a!8
               (* (+ it1022 (- 1)) it803 it819)
               (* (+ it1022 (- 1)) it673 it819)
               it1398))
      (a!16 (> (+ (+ (+ a!8 it1398) it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!18 (>= (+ (+ a!4 (* it1398 (- 1)) (* it673 (- 1)) a!5) (- 3)) 0))
      (a!20 (>= (+ (+ a!4 (* it1398 (- 1)) (* it673 (- 1)) a!5) (- 4)) 0))
      (a!22 (> (+ (+ a!8 it1398)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!23 (> (+ (* (+ it1022 (- 1)) it803 it819)
                  (* (+ it1022 (- 1)) it673 it819)
                  it1398
                  (* a!5 (- 1))
                  1)
               0))
      (a!24 (>= (+ (+ a!4 (* it1398 (- 1)) (* it673 (- 1)) a!5) (- 2)) 0))
      (a!25 (>= (+ (+ a!1 (* it673 (- 1))) (- 4)) 0)))
(let ((a!7 (+ a!6
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (> (+ (+ a!14 (* a!5 (- 1))) 1) 0))
      (a!17 (> (+ (+ a!14 (* a!5 (- 1)))
                  ...
                  1)
               0))
      (a!21 (> (+ (+ a!14 it673 (* a!5 (- 1)))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!26 (> (+ (+ a!14 it673 (* a!5 (- 1))) 1) 0)))
  (and (> (+ it1400 (* it1398 (- 1))) 0)
       a!2
       (>= (+ it818 (- 1)) 0)
       (>= (+ it673 (- 1)) 0)
       (>= (+ a!3 (- 3)) 0)
