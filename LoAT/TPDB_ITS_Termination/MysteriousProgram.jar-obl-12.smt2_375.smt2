...
(assert (let ((a!1 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 4)))
      (a!2 (> (+ it673
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 it1263
      ...
      (a!4 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1263 (- 1))))
      (a!5 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1263 (- 1))))
      (a!6 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 3)))
      (a!7 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1263 1)
              0))
      (a!8 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1263 (- 1))))
      (a!9 (> (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it1265 (* it1263 (- 1))) (- 2)) 0))
      (a!11 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 2)))
      (a!12 (> (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) 0)))
  (and (>= a!1 0)
       (>= (+ it818 (- 1)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
       ...
       (> it1261 0)
       (> a!5 0))))
(assert (= (+ it1292 (* it1260 (- 1))) 0))
(assert (= (+ it1293 (* it818 (- 1))) 0))
(assert (= (+ (* it818 (- 1)) it1294) 0))
(assert (= (+ (* it803 it819 (- 1)) it1295 (* it673 it819 (- 1)) (* it1263 (- 1))) 0))
(assert (= (+ it1296 (* it818 (- 1))) 0))
(assert (= (+ (* it817 (- 1)) it1297) 0))
(assert (let ((a!1 (+ (* it1301 (- 1))
              (* (* it1267 it1266) (- 1))
              (* (* it1268 it1266) (- 1))))
      (a!2 (>= (+ (+ (* it1295 (- 1)) it1297) (- 2)) 0))
      (a!3 (+ (+ (* it1295 (- 1)) (* (* it1267 it1266) (- 1)))
              it1297
              (* (* it1268 it1266) (- 1))))
      (a!4 (+ (* it1301 (- 1))
              (* it1295 (- 1))
              ...
              (* (* it1268 it1266) (- 1))
              it127))
      (a!5 (+ (+ (+ (* it1295 (- 1)) (* it1268 (- 1))) it1297) (- 1)))
      (a!6 (+ (+ (* it1295 (- 1)) (* (* it1267 it1266) (- 1)))
              (* (* it1268 it1266) (- 1))
              it127))
      (a!7 (>= (+ (+ (* it1295 (- 1)) it1297) (- 1)) 0))
      (a!8 (> (+ it1295
                 (* it1268 (+ it1266 (- 1)))
                 (* it1267 (+ it1266 (- 1)))
                 1)
              0))
      (a!9 (> (+ (+ (* it1295 (- 1)) (* it1268 (- 1))) it1297) 0))
      (a!10 (+ (* it1295 (- 1)) (* it1267 (- 1)) (* it1268 (- 1))))
      (a!12 (+ (* it1295 (- 1))
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               it1297
               (* (* it1267 (+ it1266 (- 1))) (- 1))))
      (a!13 (+ (+ (* it1295 (- 1)) (* it1268 (- 1)))
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               it1297
               (* (* it1267 (+ it1266 (- 1))) (- 1))))
      (a!14 (> (+ (+ (* it1295 (- 1)) it1297) (- 1)) 0)))
(let ((a!11 (+ a!10
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               it1297
               (* (* it1267 (+ it1266 (- 1))) (- 1)))))
  (and (> it107 0)
       ...
       (>= (+ (* it107 (- 1)) it1294) 0)
       (>= (+ a!4 (- 3)) 0)
       (> (+ it1295 (* it1267 it1266) (* it1268 it1266) 1) 0)
       (>= (+ it1292 (- 6)) 0)
       (>= (+ it1268 (- 1)) 0)
       (>= (+ it1296 (* it107 (- 1))) 0)
       (<= (+ it1301 (* it1267 it1266) (* it1268 it1266)) 0)
       a!14
       (>= (+ (* it1292 (- 1)) 6) 0)
       (> it1296 0)
       (<= (+ it1297 (* it127 (- 1))) 0)
