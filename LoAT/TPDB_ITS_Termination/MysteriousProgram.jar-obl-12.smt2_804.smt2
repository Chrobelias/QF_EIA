...
(assert (let ((a!1 (+ (* it1555 (- 1)) (* it359 (- 1)) (* it1679 (- 1)) it127))
      (a!2 (+ (* it1555 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!4 (> (+ (+ it1681 (* it1679 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ (* it1555 (- 1)) (* it1679 (- 1)) it127) (- 2)) 0))
      (a!7 (>= (+ (+ (* it1679 (- 1)) it127) (- 2)) 0))
      (a!8 (+ (+ (* it1555 (- 1)) (* it1679 (- 1)) it127) (- 1)))
      (a!9 (+ (* (* it1045 it359) (- 1))
              (* it1555 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!10 (>= (+ (+ (* it1679 (- 1)) it127) (- 1)) 0))
      (a!12 (>= (+ (+ (* it1679 (- 1)) it127) (- 3)) 0))
      (a!13 (> (+ it1555
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it1679
                  1)
               0)))
(let ((a!3 (+ (+ a!2 (* it359 (- 1)) (* it1679 (- 1)) it127) (- 1)))
      (a!5 (>= (+ (+ a!2 (* it1679 (- 1)) it127) (- 2)) 0))
      (a!11 (> (+ (+ a!2 (* it1679 (- 1)) it127) (- 1)) 0)))
  (and (> (+ it127 1) 0)
       (>= (+ it1677 (- 1)) 0)
       (> it1684 0)
       (>= (+ (* it1684 (- 1)) it1678) 0)
       ...
       (>= a!3 0)
       a!6
       (> (+ a!2 (* it359 (- 1)) (* it1679 (- 1)) it127) 0)
       (> it1677 0)
       (>= (+ it1677 (* it1684 (- 1))) 0)
       (> a!1 0)
       (> (+ it1681 (- 1)) 0)
       (> it1681 0)
       (> (+ it1555 it359 it1679 1) 0)
       a!7
       (>= (+ it1045 (- 1)) 0)
       (= 0 0)
       ...
       (<= (+ it1680 (* it1684 (- 1))) 0)
       a!10
       (> (+ a!2 (* it909 (- 1)) (* it359 (- 1)) (* it1679 (- 1)) it127) 0)
       (>= (+ it1680 (- 1)) 0)
       (= a!9 0)
       a!11
       (> (+ it1681 (* it1679 (- 1))) 0)
