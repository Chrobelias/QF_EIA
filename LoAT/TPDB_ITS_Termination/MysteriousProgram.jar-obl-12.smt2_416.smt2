...
(assert (let ((a!1 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
      ...
      (a!2 (+ (* (* it1045 it359) (- 1))
              ...
              (* (* it1045 it909) (- 1))
              (* it1337 (- 1))))
      (a!3 (> (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!4 (+ (* (* it1045 it359) (- 1))
              (* (* it1045 it909) (- 1))
              (* it1337 (- 1))
              it127))
      (a!5 (>= (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!7 (+ (* (* it1045 it359) (- 1))
              (* it803 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!10 (>= (+ (+ it1339 (* it1337 (- 1))) (- 2)) 0))
      (a!12 (+ (+ it1339 (* it359 (- 1)) (* it1337 (- 1))) (- 1)))
      (a!15 (> (+ (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it1337
                  1)
               0)))
(let ((a!6 (> (+ (+ a!1 (* it1337 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ a!7 (* it1337 (- 1)) it127) (- 1)) 0))
      (a!9 (>= (+ (+ a!7 (* it1337 (- 1)) it127) (- 2)) 0))
      (a!11 (>= (+ (+ a!7 (* it1337 (- 1)) it127) (- 3)) 0))
      (a!13 (+ (+ a!1 (* it359 (- 1)) (* it1337 (- 1))) (- 1)))
      (a!14 (>= (+ (+ a!1 (* it1337 (- 1))) (- 2)) 0)))
  (and (> (+ it127 1) 0)
       (> it1338 0)
       (> (+ a!1 (* it359 (- 1)) (* it1337 (- 1))) 0)
       ...
       (>= (+ it1338 (- 1)) 0)
       (> it127 0)
       (> (+ a!1 (* it909 (- 1)) (* it359 (- 1)) (* it1337 (- 1))) 0)
       (> it1339 0)
       (> it1342 0)
       (>= (+ a!4 (- 4)) 0)
       (> (+ it1337 1) 0)
       ...
       (> a!2 0)
       (> (+ it1339 (- 1)) 0)
       (> (+ (* it1045 it359) (* it1045 it909) it1337 1) 0)))))
(check-sat)
