...
(assert (let ((a!1 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it997 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!4 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!6 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!7 (> (+ it997 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!9 (+ (+ it817 (* it673 (- 1)) (* it997 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!10 (> (+ (+ (* it803 it819) (* it673 it819)) it997 1) 0))
      (a!11 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!12 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!13 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!14 (<= (+ (+ (* it803 it819) (* it673 it819)) it359) 0))
      (a!15 (>= (+ (+ it817 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!18 (> (+ (+ it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0)))
(let ((a!3 (>= (+ (+ a!2 it817 (* it997 (- 1))) (- 2)) 0))
      (a!5 (>= (+ (+ a!2 it817 (* it997 (- 1))) (- 1)) 0))
      (a!8 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!16 (> (+ (+ a!2 it817 (* it997 (- 1))) (- 1)) 0))
      (a!17 (+ (+ a!2 it817 (* it997 (- 1))) (* it359 (- 1)))))
  (and (> it107 0)
       (>= (+ a!1 (- 2)) 0)
       (> it817 0)
       (> (+ it817 1) 0)
