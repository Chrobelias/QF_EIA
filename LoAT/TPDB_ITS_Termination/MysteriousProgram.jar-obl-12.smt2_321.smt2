...
(assert (and (> it59 0)
     ...
     (> it1105 0)))
(assert (= (+ it1149 (- 8)) 0))
(assert (= (+ (* it1105 (- 1)) it1150 1) 0))
(assert (= (+ it1151 (* it59 (- 1))) 0))
(assert (= it1152 0))
(assert (= (+ (* it1105 (- 1)) it1153) 0))
(assert (= (+ it1154 (* it56 (- 1))) 0))
(assert (and (> it69 0)
     (>= (+ it1151 (* it69 (- 1))) 0)
     (> (+ (* it1152 (- 1)) (* it1165 (- 1)) it1153 1) 0)
     (> it1151 0)
     (>= (+ it1165 (- 1)) 0)
     (>= (+ (* it1149 (- 1)) 8) 0)
     (> (+ it1153 1) 0)
     (>= (+ it1149 (- 8)) 0)
     (> (+ (* it1152 (- 1)) it1153) 0)))
(assert (= (+ it1168 (* it1149 (- 1))) 0))
(assert (= (+ it1169 (* it1150 (- 1))) 0))
(assert (= (+ (* it69 (- 1)) it1170) 0))
(assert (= (+ it1171 (* it1152 (- 1)) (* it1165 (- 1))) 0))
(assert (= (+ it1172 (* it1153 (- 1))) 0))
(assert (= (+ (* it66 (- 1)) it1173) 0))
(assert (and (> it100 0)
     (<= (+ it100 (* it1170 (- 1))) 0)
     (> (+ it1172 1) 0)
     (> it1170 0)
     ...
     (<= (+ (* it1171 (- 1)) it1172) 0)))
(assert (= (+ it1177 (- 10)) 0))
(assert (= (+ it1178 (* it100 (- 1))) 0))
(assert (= (+ (* it1169 (- 1)) it1179) 0))
(assert (= (+ (* it1169 (- 1)) it1180) 0))
(assert (= (+ it1181 (* it1169 (- 1))) 0))
(assert (= (+ (* it1172 (- 1)) it1182) 0))
(assert (and (> it140 0)
     (> (+ it127 1) 0)
     (>= (+ it1178 (- 1)) 0)
     (> (+ it1182 (- 1)) 0)
     ...
     (> (+ it1179 1) 0)
     (> (+ it1182 (* it1179 (- 1))) 0)))
(assert (= (+ it1184 (* it1177 (- 1))) 0))
(assert (= (+ (* it140 (- 1)) it1185) 0))
(assert (= (+ (* it1179 (- 1)) it1186) 0))
(assert (= (+ it1187 (* it310 (- 1)) (* it1180 (- 1))) 0))
(assert (= (+ it1188 (* it310 (- 1)) (* it1180 (- 1))) 0))
(assert (= (+ it1189 (* it127 (- 1))) 0))
(assert (and (> it1191 0)
     (> (+ it1189 (* it1186 (- 1))) 0)
     (>= (+ it1187 (* it1188 (- 1))) 0)
     (> (+ (* it1187 (- 1)) it1189) 0)
     ...
     (>= (+ (* it1191 (- 1)) it1185) 0)
     (> it1185 0)
     (> (+ (* it1187 (- 1)) (* it292 (- 1)) it1189 1) 0)
     (> (+ it1186 1) 0)
     (>= (+ it1185 (- 1)) 0)
     (>= (+ it1184 (- 10)) 0)))
(assert (= (+ (* it1184 (- 1)) it1193) 0))
(assert (= (+ it1194 (* it1191 (- 1))) 0))
(assert (= (+ it1195 (* it1186 (- 1))) 0))
(assert (= (+ (* it1187 (- 1)) (* it292 (- 1)) it1196) 0))
(assert (= (+ (* it1187 (- 1)) it1197 (* it292 (- 1))) 0))
(assert (= (+ it1198 (* it1189 (- 1))) 0))
(assert (and (> (+ it1198 (* it1195 (- 1))) 0)
     (>= (+ (* it1197 (- 1)) it1196) 0)
     (>= (+ it1193 (- 10)) 0)
     (> (+ (* it1190 (- 1)) it1192 (* it1196 (- 1)) 1) 0)
     (> (+ it1192 (- 1)) 0)
     (>= (+ (* it1193 (- 1)) 10) 0)
     (> (+ it1192 1) 0)
     (>= (+ it1197 (* it1196 (- 1))) 0)
     ...
     (> it1194 0)
     (>= (+ it1190 (- 1)) 0)))
(assert (= (+ it1201 (* it1193 (- 1))) 0))
(assert (= (+ (* it1200 (- 1)) it1202) 0))
(assert (= (+ it1203 (* it1195 (- 1))) 0))
(assert (= (+ (* it1190 (- 1)) it1204 (* it1196 (- 1))) 0))
(assert (= (+ (* it1190 (- 1)) it1205 (* it1196 (- 1))) 0))
(assert (= (+ it1206 (* it1192 (- 1))) 0))
(assert (and (> it110 0)
     (> it107 0)
     (> it109 0)
     (> (+ it1203 1) 0)
     ...
     (<= (+ it110 (* it1202 (- 1))) 0)))
(assert (= (+ it1217 (- 6)) 0))
(assert (= (+ (* it110 (- 1)) it1218) 0))
(assert (= (+ (* it109 (- 1)) it1219) 0))
(assert (= (+ (* it1203 (- 1)) it1220 (- 1)) 0))
(assert (= (+ (* it107 (- 1)) it1221) 0))
(assert (= (+ (* it1206 (- 1)) it1222) 0))
(assert (let ((a!1 (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (> (+ (+ it1220 it673)
                 (* (+ it819 (- 1)) it673)
                 ...
                 1)
              0))
      (a!3 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!4 (> (+ (+ it1222 (* it1220 (- 1))) (- 1)) 0))
      (a!5 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!7 (+ (* (* it803 it819) (- 1))
              (* (* (+ it1045 (- 1)) it1137) (- 1))
              (* (* it673 it819) (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!9 (>= (+ (+ it1222 (* it1220 (- 1))) (- 2)) 0))
      (a!12 (+ it817 (* it803 (- 1)) (* it1220 (- 1)) (* it673 (- 1))))
      (a!14 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* it1106 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!15 (> (+ it1220 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!16 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  ...
                  1)
               0))
      (a!17 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!19 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!20 (+ (+ (* it803 it819) (* it673 it819) it1220) it1106))
      (a!23 (> (+ (+ (* it803 it819) (* it673 it819) it1220) 1) 0))
      (a!25 (>= (+ (+ it1222 (* it1220 (- 1))) (- 1)) 0)))
(let ((a!6 (+ (+ (+ a!5 (* it1220 (- 1))) (* it1106 (- 1))) (* it359 (- 1))))
      (a!8 (>= (+ (+ a!7 (* it1220 (- 1)) (* it1106 (- 1))) (- 2)) 0))
      (a!10 (+ (+ a!7 (* it1220 (- 1)) (* it1106 (- 1))) (* it359 (- 1))))
      (a!11 (> (+ (+ a!5 (* it1220 (- 1))) (* it1106 (- 1))) 0))
      (a!13 (+ a!12
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!18 (> (+ (+ a!5 (* it1220 (- 1))) (- 1)) 0))
      (a!21 (+ (+ (+ a!5 (* it1220 (- 1))) (* it1106 (- 1))) (- 1)))
      (a!22 (+ (+ (+ a!5 (* it1220 (- 1))) (* it1106 (- 1))) (- 2)))
      (a!24 (> (+ (+ a!7 (* it1220 (- 1)) (* it1106 (- 1))) (- 1)) 0)))
  (and (> a!1 0)
       a!2
       a!3
       (>= (+ it1219 (* it1138 (- 1))) 0)
