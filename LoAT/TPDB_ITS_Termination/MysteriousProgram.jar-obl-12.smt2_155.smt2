...
(assert (let ((a!1 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!3 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!4 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) (- 1))))
  (and (> it107 0)
       (>= (+ it996 (* it107 (- 1))) 0)
       (>= (+ it994 (- 6)) 0)
       (> (+ it997 1) 0)
       ...
       (>= (+ it998 (- 1)) 0)
       (> it998 0))))
(assert (= (+ it1029 (* it994 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it1030) 0))
(assert (= (+ it1031 (* it107 (- 1))) 0))
(assert (= (+ it1032 (* it997 (- 1)) (* it359 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it1033) 0))
(assert (= (+ it1034 (* it999 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ it1034 (* it1032 (- 1))) (- 1)) 0))
      (a!2 (> (+ (+ it1034 (* it1032 (- 1))) (* it909 (- 1))) 0)))
  (and (> it102 0)
       (>= (+ it1030 (- 1)) 0)
       (>= (+ it1031 (- 1)) 0)
       (> (+ it1034 (- 1)) 0)
       ...
       (> it1030 0)
       (>= (+ it1030 (* it102 (- 1))) 0))))
(assert (= (+ (* it1029 (- 1)) it1037) 0))
(assert (= (+ it1038 (* it102 (- 1))) 0))
(assert (= (+ it1039 (* it102 (- 1))) 0))
(assert (= (+ (* it1032 (- 1)) (* it909 (- 1)) it1040) 0))
(assert (= (+ it1041 (* it102 (- 1))) 0))
(assert (= (+ (* it1034 (- 1)) it1042) 0))
(assert (let ((a!1 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1040 1)
              0))
      (a!2 (<= (+ (+ (* it803 it819) (* it673 it819)) it1043) 0))
      (a!3 (> (+ (+ it1042 (* it1040 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ it1042 (* it1040 (- 1))) (- 2)) 0))
      (a!5 (+ (+ (+ it817 (* it673 (- 1))) (* it1040 (- 1))) (- 2)))
      (a!6 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1040 (- 1))))
      (a!7 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!8 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1040 (- 1))))
      (a!9 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1040 (- 1))))
      (a!10 (> (+ (+ (* it803 it819) (* it673 it819)) it1040 1) 0))
      (a!11 (+ (+ (+ it817 (* it673 (- 1))) (* it1040 (- 1))) (- 3)))
      (a!12 (+ (+ (+ it817 (* it673 (- 1))) (* it1040 (- 1))) (- 4)))
      (a!14 (> (+ (+ it817 (* it673 (- 1))) (* it1040 (- 1))) 0))
      (a!15 (> (+ it673
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  it1040
                  1)
               0))
      (a!16 (>= (+ (+ it1042 (* it1040 (- 1))) (- 1)) 0)))
(let ((a!13 (> (+ (+ (+ a!7 it817) (* it1040 (- 1))) (- 1)) 0)))
  (and a!1
       a!2
       (>= (+ it1043 (- 1)) 0)
       (>= (+ it1044 (- 1)) 0)
