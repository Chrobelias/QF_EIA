...
(assert (let ((a!1 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!2 (+ it817 (* it803 (- 1)) (* it1398 (- 1)) (* it673 (- 1))))
      (a!4 (> (+ (+ it1398 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!5 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!6 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!7 (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!8 (> (+ it1398 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!9 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0))
      (a!11 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 4)) 0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1)))))
  (and (>= (+ it1396 (- 1)) 0)
