...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) it817)
              ...
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!3 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909)) 1) 0))
      (a!4 (+ (* (* it1045 it359) (- 1))
              it999
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      ...
      (a!9 (+ (+ (* (* it1045 it359) (- 1)) it817)
              (* it803 (- 1))
              (* it673 (- 1))
              (* it997 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!11 (> (+ (+ it999 (* it997 (- 1))) (* it359 (- 1))) 0))
      (a!12 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!14 (> (+ (+ (* it1045 it359) it997 (* it1045 it909)) 1) 0))
      (a!15 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!16 (> (+ (+ (* it1045 it359) it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!18 (> (+ (+ (* it1045 it359) it673 it997 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (> (+ (* (+ it1045 (- 1)) it359) (* (+ it1045 (- 1)) it909) it997 1)
               0))
      (a!20 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!7 (+ (+ (+ a!6 (* it997 (- 1))) (* it359 (- 1))) (- 1)))
      (a!10 (+ a!9
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!13 (>= (+ (+ a!6 (* it997 (- 1))) (- 2)) 0))
      (a!17 (> (+ (+ a!6 (* it997 (- 1))) (- 1)) 0))
      (a!21 (> (+ (+ a!6 (* it997 (- 1))) (* it359 (- 1))) 0)))
  (and (>= (+ a!2 (- 2)) 0)
       (>= (+ it996 (* it818 (- 1))) 0)
       a!3
       (>= (+ (* it994 (- 1)) 6) 0)
