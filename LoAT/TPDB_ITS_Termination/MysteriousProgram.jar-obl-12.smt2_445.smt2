...
(assert (let ((a!1 (+ (* it1045 it359)
              (* (+ it1303 (- 1)) it673 it819)
              (* (* (+ it1303 (- 1)) it1045) it359)
              (* (+ it1303 (- 1)) it803 it819)
              it1350
              (* (* (+ it1303 (- 1)) it1045) it909)))
      (a!3 (+ (* (+ it1303 (- 1)) it673 it819)
              (* (* (+ it1303 (- 1)) it1045) it359)
              (* (+ it1303 (- 1)) it803 it819)))
      (a!5 (+ (+ (+ (* it1045 it359) it1350) (* it1045 it909))
              (* (+ it819 (- 1)) it673)
              (* it803 (+ it819 (- 1)))
              1))
      (a!6 (+ it1352
              ...
              (* it1350 (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!8 (+ (+ it1352 (* (* it1045 it359) (- 1))) (* it1350 (- 1))))
      (a!10 (>= (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0))
      (a!11 (> (+ (* (+ it1045 (- 1)) it359)
                  it1350
                  (* (+ it1045 (- 1)) it909)
                  1)
               0))
      (a!12 (+ (+ it1352 (* (* it1045 it359) (- 1)))
               (* it803 (- 1))
               (* it1350 (- 1))
               (* it673 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!14 (* (* (* (+ it1303 (- 1)) it1045) it359) (- 1)))
      (a!16 (* (* (* (+ it1303 (- 1)) it1045) it909) (- 1)))
      (a!20 (+ (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) (- 1)))
      (a!21 (> (+ (+ it1352 (* it1350 (- 1))) (* it909 (- 1)) (* it359 (- 1)))
               0))
      (a!24 (> (+ (+ it1352 (* it1350 (- 1))) (* it359 (- 1))) 0))
      (a!29 (= (+ (* it803 it819 (- 1))
                  (* (* it1045 it359) (- 1))
                  (* it673 it819 (- 1))
                  (* (* it1045 it909) (- 1)))
               0))
      (a!30 (>= (+ (+ it1352 (* it1350 (- 1))) (- 2)) 0))
      (a!31 (+ (+ (+ (* it1045 it359) it1350) (* it1045 it909)) 1))
      (a!34 (+ (+ (* it1045 it359) it1350) it673 (* it1045 it909)))
      (a!36 (> (+ (+ it1352 (* it1350 (- 1))) (- 1)) 0)))
(let ((a!2 (> (+ (+ a!1 it673 (* it1045 it909))
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!4 (+ a!3 it1350 (* (* (+ it1303 (- 1)) it1045) it909)))
      (a!7 (> (+ (+ a!6 (* it359 (- 1))) (- 1)) 0))
      (a!9 (+ (+ a!8 (* (* it1045 it909) (- 1))) (- 2)))
      (a!13 (+ a!12
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (+ (+ it1352 (* (* it1045 it359) (- 1)))
               (* (* (+ it1303 (- 1)) it673 it819) (- 1))
               a!14
               (* (* (+ it1303 (- 1)) it803 it819) (- 1))))
      (a!22 (+ a!8 (* it673 (- 1)) (* (* it1045 it909) (- 1))))
      (a!25 (>= (+ (+ a!6 (* it359 (- 1))) (- 1)) 0))
      (a!27 (> (+ (+ a!1 (* it1045 it909)) 1) 0))
      (a!28 (> (+ a!8 (* (* it1045 it909) (- 1))) 0))
      (a!32 (+ a!3
               (* (+ it1045 (- 1)) it359)
               it1350
               (* (+ it1045 (- 1)) it909)
               (* (* (+ it1303 (- 1)) it1045) it909)
               1))
      (a!33 (> (+ (+ a!1 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!35 (+ (+ a!8 (* (* it1045 it909) (- 1))) (- 1)))
      (a!37 (> (+ a!34 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1) 0))
      (a!38 (> (+ (+ a!1 it673 (* it1045 it909)) 1) 0)))
(let ((a!17 (+ a!15
               (* it803 (- 1))
               (* it1350 (- 1))
               a!16
