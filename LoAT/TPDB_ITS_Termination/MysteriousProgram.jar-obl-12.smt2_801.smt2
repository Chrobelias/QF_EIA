...
(assert (let ((a!1 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1679 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!4 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1679 (- 1))))
      (a!6 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it359 it1679 1))
      (a!7 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 4)))
      ...
      (a!16 (+ (* (* it803 it819) (- 1))
               ...
               (* it909 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!17 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1679 1)
               0))
      (a!18 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  ...
                  1)
               0))
      (a!19 (> (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) 0))
      (a!20 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 3)))
      (a!21 (+ (+ (+ it817 (* it673 (- 1))) (* it1679 (- 1))) (- 2)))
      (a!23 (+ (+ (+ (* it803 it819) (* it673 it819)) it909) it1679 1))
      (a!24 (> (+ (+ (* it803 it819) (* it673 it819)) it1679 1) 0))
      (a!26 (>= (+ (+ it1681 (* it1679 (- 1))) (- 2)) 0)))
(let ((a!3 (> (+ (+ a!2 (* it1679 (- 1))) (- 1)) 0))
      (a!5 (+ (+ a!2 (* it909 (- 1))) (* it359 (- 1)) (* it1679 (- 1))))
      (a!9 (+ (+ (+ a!2 (* it909 (- 1))) (* it1679 (- 1))) (- 1)))
      (a!11 (+ (+ a!10 (* it909 (- 1))) (* it359 (- 1)) (* it1679 (- 1))))
      (a!14 (> (+ (+ a!2 (* it909 (- 1))) (* it1679 (- 1))) 0))
      (a!22 (+ (+ (+ a!10 (* it909 (- 1))) (* it1679 (- 1))) (- 2)))
      (a!25 (+ (+ (+ a!2 (* it909 (- 1))) (* it1679 (- 1))) (- 2)))
      (a!27 (+ (+ (+ a!10 (* it909 (- 1))) (* it1679 (- 1))) (- 1))))
  (and (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it1138 (- 1)) 0)
       (>= (+ it1137 (- 1)) 0)
