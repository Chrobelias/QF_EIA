...
(assert (let ((a!1 (+ (* it1555 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!3 (>= (+ (+ (* it997 (- 1)) it127) (- 3)) 0))
      (a!5 (+ (+ (* it1555 (- 1)) (* it997 (- 1))) (* it359 (- 1)) it127))
      (a!7 (> (+ (+ (* it1555 (- 1)) (* it997 (- 1))) it127) 0))
      (a!8 (+ (+ (+ (* it1555 (- 1)) (* it997 (- 1))) it127) (- 2)))
      (a!9 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!10 (+ (+ (+ (* it1555 (- 1)) (* it997 (- 1))) it127) (- 1)))
      (a!11 (>= (+ (+ (* it997 (- 1)) it127) (- 1)) 0))
      (a!12 (> (+ it1555
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  it997
      ...
      (a!13 (+ (* (* it1045 it359) (- 1))
               (* it1555 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!14 (>= (+ (+ (* it997 (- 1)) it127) (- 2)) 0)))
(let ((a!2 (+ (+ a!1 (* it997 (- 1))) (* it359 (- 1)) it127))
      (a!4 (+ (+ (+ a!1 (* it997 (- 1))) it127) (- 2)))
      (a!6 (+ (+ (+ a!1 (* it997 (- 1))) it127) (- 1))))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (> (+ a!2 (- 1)) 0)
       (> it999 0)
