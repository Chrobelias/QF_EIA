...
(assert (let ((a!1 (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!2 (+ it817 (* it803 (- 1)) (* it1220 (- 1)) (* it673 (- 1))))
      (a!4 (>= (+ (+ it1222 (* it1220 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ it1222 (* it1220 (- 1))) (- 1)) 0))
      (a!6 (> (+ (+ it1220 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!7 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!8 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!10 (>= (+ (+ it1222 (* it1220 (- 1))) (- 2)) 0))
      (a!11 (> (+ (+ (* it803 it819) (* it673 it819)) it1220 1) 0))
      (a!12 (<= (+ (+ (* it803 it819) (* it673 it819)) it1106) 0))
      (a!14 (> (+ it1220 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!15 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!16 (>= (+ (+ it817 (* it1220 (- 1)) (* it673 (- 1))) (- 4)) 0)))
(let ((a!3 (+ a!2
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (> (+ (+ a!8 it817 (* it1220 (- 1))) (* it1106 (- 1))) 0))
      (a!13 (> (+ (+ a!8 it817 (* it1220 (- 1))) (- 1)) 0)))
  (and (>= (+ a!1 (- 3)) 0)
       (> a!1 0)
       (>= (+ a!3 (- 2)) 0)
