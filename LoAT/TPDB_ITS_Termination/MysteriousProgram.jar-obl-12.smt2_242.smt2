...
(assert (let ((a!1 (+ (* (* it1114 it1118) (- 1))
              (* it1122 (- 1))
              (* (* it1117 it1114) (- 1))
              it1116))
      (a!2 (>= (+ (+ (* it1118 (- 1)) (* it1122 (- 1)) it1116) (- 3)) 0))
      (a!3 (+ (* it1117 (- 1))
              (* (* it1118 (+ it1114 (- 1))) (- 1))
              (* (* it1117 (+ it1114 (- 1))) (- 1))
              (* it1118 (- 1))
              (* it1122 (- 1))
              it1116))
      (a!4 (+ (+ (* (* it1114 it1118) (- 1)) (* it1125 (- 1)))
              (* it1122 (- 1))
              (* (* it1117 it1114) (- 1))
              it1116))
      (a!5 (+ (* it1117 (- 1)) (* it1118 (- 1)) (* it1122 (- 1)) it1116))
      (a!6 (> (+ (+ it1124 (* it1122 (- 1))) (- 1)) 0))
      (a!7 (+ (* (* it1118 (+ it1114 (- 1))) (- 1))
              (* (* it1117 (+ it1114 (- 1))) (- 1))
              (* it1118 (- 1))
              (* it1122 (- 1))
              it1116))
      (a!8 (>= (+ (+ (* it1118 (- 1)) (* it1122 (- 1)) it1116) (- 4)) 0))
      (a!9 (+ (+ (* (* it1114 it1118) (- 1)) (* it1125 (- 1)))
              (* (* it1117 it1114) (- 1))))
      (a!10 (+ (* it1118 (+ it1114 (- 1))) (* it1117 (+ it1114 (- 1)))))
      (a!11 (>= (+ (+ (* it1118 (- 1)) (* it1122 (- 1)) it1116) (- 2)) 0))
      (a!12 (>= (+ (+ it1124 (* it1122 (- 1))) (- 1)) 0))
      (a!13 (>= (+ (+ it1124 (* it1122 (- 1))) (- 2)) 0)))
  (and (> (+ a!1 (- 1)) 0)
       a!2
       (> (+ it1116 (- 1)) 0)
       (>= (+ a!3 (- 1)) 0)
       ...
       (>= (+ a!5 (- 1)) 0)
       (> (+ it1124 1) 0)
       (<= (+ (* it1114 it1118) it1125 (* it1117 it1114)) 0)
       (>= (+ it1125 (- 1)) 0)
       (> it1121 0)
       (> (+ it1124 (* it1122 (- 1))) 0)
       (> (+ it1118 it1122 1) 0)
       ...
       (= a!9 0)
       (= (+ it1124 (* it1116 (- 1))) 0)
       (> (+ a!10 it1118 it1122 1) 0)
       (>= (+ it1126 (- 1)) 0)
       (<= (+ it1123 (* it1126 (- 1))) 0)
       (= 0 0)
       (<= a!9 0)
       (>= (+ (* it1126 (- 1)) it1120) 0)
       (> (+ (* it1114 it1118) it1122 (* it1117 it1114) 1) 0)
       (>= (+ it1123 (* it1126 (- 1))) 0)
       (>= (+ it1121 (* it1126 (- 1))) 0)
       (>= (+ (* it1119 (- 1)) 6) 0)
       (> (+ it1116 1) 0)
