...
(assert (let ((a!1 (+ (+ (* it1117 (- 1)) (* it1130 (- 1))) (* it1118 (- 1)) it1093))
      (a!2 (+ (+ (+ (* it1117 (- 1)) (* it1130 (- 1))) it1093) (- 2)))
      (a!3 (> (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0))
      (a!4 (+ (+ (+ (* it1117 (- 1)) (* it1130 (- 1))) it1093) (- 3)))
      (a!5 (>= (+ (+ (* it1130 (- 1)) it1132) (- 1)) 0))
      (a!6 (>= (+ (+ (* it1130 (- 1)) it1132) (- 2)) 0))
      (a!7 (> (+ (+ (* it1117 (- 1)) (* it1130 (- 1))) it1093) 0)))
  (and (= (+ (* it1093 (- 1)) it1132) 0)
       (<= (+ (* it1117 (- 1)) (* it1118 (- 1))) 0)
       (<= (+ it1117 it1118) 0)
       (>= (+ a!1 (- 2)) 0)
       (>= (+ it1131 (* it1094 (- 1))) 0)
