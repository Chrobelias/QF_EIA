...
(assert (and (= (+ it250 (- 4)) 0)
     (<= (+ (* it256 (- 1)) it255 1) 0)
     (<= (+ (* it255 (- 1)) 3) 0)))
(assert (= (+ it268 (- 4)) 0))
(assert (= (+ it269 (* it255 (- 1))) 0))
(assert (= (+ (* it256 (- 1)) it270) 0))
(assert (= (+ it271 (* it253 (- 1))) 0))
(assert (= (+ it272 (* it254 (- 1))) 0))
(assert (= (+ it273 (* it255 (- 2))) 0))
(assert (= (+ (* it256 (- 1)) it274 (- 1)) 0))
