...
(assert (let ((a!1 (>= (+ (+ it817 (* it673 (- 1)) (* it1078 (- 1))) (- 3)) 0))
      (a!2 (> (+ (+ it673 it1078)
                 (* (+ it819 (- 1)) it673)
                 (* (+ it819 (- 1)) it1081)
                 1)
              0))
      (a!3 (+ (+ it817 (* it673 (- 1)) (* it1078 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* (+ it819 (- 1)) it1081) (- 1))))
      (a!4 (>= (+ (+ it1080 (* it1078 (- 1))) (- 1)) 0))
      (a!5 (+ it817 (* it1081 (- 1)) (* it673 (- 1)) (* it1078 (- 1))))
      (a!7 (>= (+ (+ it1080 (* it1078 (- 1))) (- 2)) 0))
      (a!8 (> (+ (+ it1080 (* it1078 (- 1))) (- 1)) 0))
      (a!9 (+ (* (* it673 it819) (- 1)) (* (* it1081 it819) (- 1))))
      (a!10 (> (+ it1078 (* (+ it819 (- 1)) it673) (* (+ it819 (- 1)) it1081) 1)
               0))
      (a!11 (>= (+ (+ it817 (* it673 (- 1)) (* it1078 (- 1))) (- 4)) 0))
      (a!12 (>= (+ (+ it817 (* it673 (- 1)) (* it1078 (- 1))) (- 2)) 0))
      (a!13 (<= (+ (+ (* it673 it819) (* it1081 it819)) it909) 0))
      (a!15 (> (+ (+ (* it673 it819) (* it1081 it819)) it1078 1) 0)))
(let ((a!6 (+ a!5
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* (+ it819 (- 1)) it1081) (- 1))))
      (a!14 (> (+ (+ (+ a!9 it817) (* it1078 (- 1))) (- 1)) 0)))
  (and (> it102 0)
       a!1
       (>= (+ it1077 (* it102 (- 1))) 0)
       a!2
       ...
       a!7
       (>= (+ a!3 (- 4)) 0)
       (> (+ it817 (* it673 (- 1)) (* it1078 (- 1))) 0)
       a!8
       (>= (+ (* it1075 (- 1)) 6) 0)
       (>= (+ a!5 (- 1)) 0)
       (<= (+ it1076 (* it102 (- 1))) 0)
       (= (+ it1080 (* it817 (- 1))) 0)
       (> (+ (+ a!9 it817) (* it909 (- 1)) (* it1078 (- 1))) 0)
       (> (+ (+ it673 it1078) 1) 0)
       (= 0 0)
       (>= (+ it1077 (- 1)) 0)
       a!10
