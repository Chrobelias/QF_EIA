...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) (* it1615 (- 1)))
              it1617
              (* (* it1045 it909) (- 1))))
      (a!2 (+ (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) (- 1)))
      (a!3 (>= (+ (+ (* it1615 (- 1)) it1617) (- 2)) 0))
      (a!4 (+ (* it1615 (- 1))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      ...
      (a!7 (+ (* (* it1045 it359) (- 1))
              (* it803 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!8 (> (+ (+ (* it1615 (- 1)) it1617) (* it359 (- 1))) 0))
      (a!9 (>= (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!10 (+ (+ (* (* it1045 it359) (- 1)) (* it1615 (- 1)))
               (* it803 (- 1))
               (* (* it1045 it909) (- 1))
               it127))
      (a!11 (> (+ (+ (* it1615 (- 1)) it1617) (- 1)) 0))
      (a!13 (> (+ it1615
                  (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  1)
               0)))
(let ((a!5 (>= (+ (+ (+ a!4 it1617) (* it359 (- 1))) (- 1)) 0))
      (a!12 (> (+ (+ (+ a!4 it1617) (* it359 (- 1))) (- 1)) 0)))
  (and (> (+ it127 1) 0)
       (>= (+ a!1 (- 2)) 0)
       (> (+ it127 (- 1)) 0)
       (>= (+ it359 (- 1)) 0)
       (> (+ it1615 1) 0)
       (> (+ (* it1045 it359) it1615 (* it1045 it909) 1) 0)
       (>= a!2 0)
       (>= (+ it803 (- 1)) 0)
       (>= (+ a!1 (- 1)) 0)
       a!3
       ...
       (>= (+ it1614 (- 1)) 0)
       (<= (+ (* it1619 (- 1)) it1616) 0)
       (> (+ a!4 (* it909 (- 1)) it1617 (* it359 (- 1))) 0)
       (> it1614 0)
       (> it1616 0)
       (> it1619 0)
       (> (+ (+ a!4 it1617) (* it359 (- 1))) 0)
       (>= (+ it1612 (- 6)) 0)
       (> (+ it1617 (- 1)) 0)
       (>= (+ a!10 (- 2)) 0)
       (>= (+ (* it1612 (- 1)) 6) 0)))))
