...
(assert (let ((a!1 (+ (+ it999 (* it803 (- 1))) (* it673 (- 1)) (* it997 (- 1))))
      (a!3 (* (+ (* it803 it819) (* it673 it819)) (+ it1605 (- 1))))
      (a!5 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0))
      (a!6 (> (+ (+ it673 it997)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
      ...
      (a!12 (+ (+ it999 (* it673 (- 1)) (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!15 (> (+ (+ it999 (* it997 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (+ it999 (* it997 (- 1))) (- 2)) 0))
      (a!21 (> (+ it997 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!24 (>= (+ (+ it999 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!25 (> (+ (+ (* it803 it819) (* it673 it819)) it997 1) 0))
      (a!30 (>= (+ (+ it999 (* it997 (- 1))) (- 1)) 0)))
(let ((a!2 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!4 (+ (* (+ it1605 (- 1)) it803 it819)
              (* a!3 (- 1))
      ...
      (a!13 (+ (+ a!7 it999)
               ...
               (* (* (+ it1605 (- 1)) it673 it819) (- 1))
               (* it997 (- 1))))
      (a!16 (>= (+ (+ (+ a!7 it999) (* it997 (- 1))) (- 2)) 0))
      (a!17 (> (+ (+ (+ a!7 it999) (* it997 (- 1))) (- 1)) 0))
      (a!22 (> (+ (+ (* it803 it819) (* it673 it819))
                  ...
                  1)
               0)))
(let ((a!11 (>= (+ (+ a!10 (* it673 (- 1)) (* it997 (- 1))) (- 3)) 0))
      (a!18 (> (+ (+ a!4 it673 it997)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!19 (> (+ (+ a!4 it997)
                  ...
                  1)
               0))
      (a!23 (>= (+ (+ a!10 (* it673 (- 1)) (* it997 (- 1))) (- 2)) 0))
      (a!26 (+ a!8
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!27 (>= (+ (+ a!10 (* it997 (- 1))) (- 1)) 0))
      (a!28 (+ (+ a!10 (* it673 (- 1)) (* it997 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!29 (>= (+ (+ a!10 (* it673 (- 1)) (* it997 (- 1))) (- 4)) 0)))
  (and (> it107 0)
       (>= (+ it996 (* it107 (- 1))) 0)
       (> it995 0)
       (>= (+ a!2 (- 2)) 0)
