...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!3 (+ (+ (* it1479 (- 1)) it817) (* it803 (- 1)) (* it673 (- 1))))
      (a!5 (>= (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!6 (+ (* (* it803 it819) (- 1))
              (* (* it673 it819) (- 1))
              (* it1479 (- 1))
              it817))
      (a!8 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 3)))
      (a!10 (> (+ (+ (* it803 it819) (* it673 it819) it1479) 1) 0))
      (a!11 (>= (+ (+ (* it1479 (- 1)) it1481) (- 2)) 0))
      (a!13 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* it909 (- 1))
      ...
      (a!14 (> (+ (* it803 it819)
                  ...
                  1)
               0))
      (a!15 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!19 (+ (+ (* it803 it819) (* it673 it819) it1479) it909))
      (a!21 (> (+ (+ (* it1479 (- 1)) it1481) (- 1)) 0))
      (a!23 (> (+ (+ it1479 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!24 (> (+ it1479 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!25 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 4)))
      (a!26 (+ (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) (- 2)))
      (a!27 (> (+ (+ (* it1479 (- 1)) it817) (* it673 (- 1))) 0)))
(let ((a!2 (> (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!4 (+ a!3
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!7 (> (+ (+ a!6 (* it909 (- 1))) (* it359 (- 1))) 0))
      (a!9 (>= (+ (+ a!6 (* it909 (- 1))) (- 1)) 0))
      (a!12 (+ (+ (+ a!6 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!16 (+ (+ (+ a!1 (* it909 (- 1))) (* it359 (- 1))) (- 1)))
      (a!17 (>= (+ (+ a!6 (* it909 (- 1))) (- 2)) 0))
      (a!18 (>= (+ (+ a!1 (* it909 (- 1))) (- 2)) 0))
      (a!20 (> (+ (+ a!1 (* it909 (- 1))) (- 1)) 0))
      (a!22 (> (+ (+ a!6 (* it909 (- 1))) (- 1)) 0)))
  (and a!2
       (>= (+ a!4 (- 3)) 0)
       a!5
       (> it817 0)
       ...
       (>= (+ it1476 (- 6)) 0)
       a!7
       (> (+ a!6 (* it1137 (- 1)) (* it909 (- 1)) (* it359 (- 1))) 0)
       (> (+ a!1 (* it1137 (- 1)) (* it909 (- 1)) (* it359 (- 1))) 0)
       (>= a!8 0)
       a!9
       (>= (+ (* it1138 (- 1)) it1478) 0)
       (>= (+ it1478 (- 1)) 0)
