...
(assert (and (> it140 0)
     ...
     (> (+ it1317 (- 1)) 0)))
(assert (= (+ it1319 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it1320) 0))
(assert (= (+ (* it1314 (- 1)) it1321) 0))
(assert (= (+ (* it1315 (- 1)) it1322 (- 1)) 0))
(assert (= (+ it1323 (* it1315 (- 1)) (- 1)) 0))
(assert (= (+ (* it1317 (- 1)) it1324) 0))
(assert (let ((a!1 (> (+ (+ (* it292 (- 1)) it1324 (* it1322 (- 1))) 1) 0))
      (a!2 (> (+ (+ (* it292 (- 1)) (* it310 (- 1))) it127 (* it1322 (- 1)) 1)
              0)))
  (and (> (+ it127 1) 0)
       (>= (+ it1319 (- 10)) 0)
       (> (+ it1324 1) 0)
       ...
       (= (+ (* it292 (- 1)) (* it310 (- 1))) 0)
       (>= (+ it310 (- 1)) 0)
       (> (+ (* it292 (- 1)) it127 (* it1322 (- 1))) 0)
       (<= (+ it1320 (* it322 (- 1))) 0)
       (>= (+ (* it1319 (- 1)) 10) 0)
       a!1
       (<= (+ it1324 (* it127 (- 1))) 0)
       (> (+ it1324 (- 1)) 0)
       (> (+ (* it292 (- 1)) it1324 (* it1322 (- 1))) 0)
       a!2
       (> (+ (* it1321 (- 1)) it127) 0)
       (>= (+ (* it1323 (- 1)) it1322) 0)
       (= 0 0)
