...
(assert (let ((a!1 (+ it817
      ...
      (a!4 (> (+ (* it1090 (+ it819 (- 1)))
                 ...
                 1)
              0))
      (a!5 (+ (+ it817 (* it1090 (- 1)) (* it1087 (- 1))) (* it909 (- 1))))
      (a!6 (+ (+ it817 (* it1090 (- 1)) (* it1087 (- 1)))
              (* it1081 (- 1))
              (* it909 (- 1))))
      (a!7 (> (+ (* it1090 (+ it819 (- 1)))
                 it1087
                 ...
                 1)
              0))
      (a!8 (+ (+ (+ it1089 (* it1087 (- 1))) (* it909 (- 1))) (- 2)))
      (a!9 (+ (+ (+ it1089 (* it1087 (- 1))) (* it909 (- 1))) (- 1)))
      (a!10 (+ (* (* it1081 it819) (- 1))
               (* it909 (- 1))
               (* (* it1090 it819) (- 1))))
      (a!11 (> (+ (+ it1089 (* it1087 (- 1))) (* it909 (- 1))) 0))
      (a!12 (> (+ (+ it1089 (* it1087 (- 1))) (- 1)) 0)))
(let ((a!2 (+ a!1
              (* it1081 (- 1))
              (* it909 (- 1))
              (* (* (+ it819 (- 1)) it1081) (- 1))))
      (a!3 (+ a!1 (* it909 (- 1)) (* (* (+ it819 (- 1)) it1081) (- 1)))))
  (and (>= (+ a!2 (- 3)) 0)
       (>= (+ a!3 (- 3)) 0)
       (>= (+ it818 (- 1)) 0)
       (> it817 0)
       ...
       (> a!3 0)
       a!7
       (> (+ it1090 it1087 it909 1) 0)
       (> (+ it1089 (* it1087 (- 1))) 0)
       (> (+ it1087 1) 0)
       (>= a!8 0)
       (<= (+ (* it1081 it819) it909 (* it1090 it819)) 0)
       (= (+ it1089 (* it817 (- 1))) 0)
       (>= (+ a!2 (- 2)) 0)
       (>= (+ a!3 (- 2)) 0)
       (> it1086 0)
