...
(assert (let ((a!1 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 2)))
      (a!2 (>= (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!3 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1))))
      (a!4 (+ (+ it817 (* it1563 (- 1))) (* it803 (- 1)) (* it673 (- 1))))
      (a!6 (> (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) 0))
      (a!7 (>= (+ (+ (* it1563 (- 1)) it1565) (- 2)) 0))
      (a!8 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 4)))
      (a!9 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!10 (> (+ it1563 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!11 (<= (+ (+ (* it803 it819) (* it673 it819)) it909) 0))
      (a!12 (> (+ (+ it1563 it673)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!13 (> (+ (+ (* it1563 (- 1)) it1565) (- 1)) 0))
      (a!16 (+ (+ (+ it817 (* it1563 (- 1))) (* it673 (- 1))) (- 3)))
      (a!17 (> (+ (+ (* it803 it819) (* it673 it819)) it1563 1) 0)))
(let ((a!5 (+ a!4
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!14 (> (+ (+ a!3 it817 (* it1563 (- 1))) (- 1)) 0))
      (a!15 (> (+ (+ a!3 it817 (* it1563 (- 1))) (* it909 (- 1))) 0)))
  (and (> it102 0)
       (>= (+ it1561 (- 1)) 0)
       (> it1561 0)
       (<= (+ it1561 (* it102 (- 1))) 0)
