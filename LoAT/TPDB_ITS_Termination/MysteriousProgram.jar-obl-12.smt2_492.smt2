...
(assert (let ((a!1 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!2 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 4)) 0))
      (a!3 (> (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0))
      (a!5 (> (+ (+ it1398 it673)
                 (* (+ it819 (- 1)) it673)
                 (* it803 (+ it819 (- 1)))
                 1)
      ...
      (a!6 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!8 (>= (+ (+ it1400 (* it1398 (- 1))) (- 2)) 0))
      (a!9 (+ (* (* it803 it819) (- 1))
              (* (* it1045 it359) (- 1))
              (* (* it673 it819) (- 1))
              (* it909 (- 1))
              (* (* it1137 it1045) (- 1))))
      (a!10 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 2)) 0))
      (a!12 (+ it817 (* it803 (- 1)) (* it1398 (- 1)) (* it673 (- 1))))
      (a!14 (> (+ (+ (* it803 it819) (* it673 it819)) it1398 1) 0))
      (a!16 (>= (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1))) (- 3)) 0))
      (a!17 (+ (+ it817 (* it1398 (- 1)) (* it673 (- 1)))
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!19 (> (+ it1398 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
               0))
      (a!20 (> (+ (* it803 it819)
                  (* (+ it1045 (- 1)) it1137)
                  (* it673 it819)
                  ...
                  1)
               0))
      (a!21 (+ (+ (* it803 it819) (* it673 it819)) it909 it1398))
      (a!24 (>= (+ (+ it1400 (* it1398 (- 1))) (- 1)) 0)))
(let ((a!4 (+ (+ a!1 (* it909 (- 1)) (* it1398 (- 1))) (* it359 (- 1))))
      (a!7 (> (+ (+ a!6 (* it909 (- 1)) (* it1398 (- 1))) (- 1)) 0))
      (a!11 (+ (+ a!1 (* it909 (- 1)) (* it1398 (- 1))) (- 1)))
      (a!13 (+ a!12
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!15 (+ (+ a!6 (* it909 (- 1)) (* it1398 (- 1))) (* it359 (- 1))))
      (a!18 (>= (+ (+ a!6 (* it909 (- 1)) (* it1398 (- 1))) (- 2)) 0))
      (a!22 (> (+ (+ a!1 (* it1398 (- 1))) (- 1)) 0))
      (a!23 (>= (+ (+ a!1 (* it909 (- 1)) (* it1398 (- 1))) (- 2)) 0)))
  (and (> it817 0)
       (> (+ it817 1) 0)
       (>= (+ it1138 (- 1)) 0)
       (>= (+ it1137 (- 1)) 0)
