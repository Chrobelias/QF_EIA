...
(assert (let ((a!1 (>= (+ (+ (* it1589 (- 1)) it127) (- 3)) 0))
      (a!2 (+ (+ (+ (* it1589 (- 1)) (* it1555 (- 1))) it127) (- 1)))
      (a!3 (+ (+ (* it1589 (- 1)) (* it1555 (- 1))) (* it359 (- 1)) it127))
      (a!4 (+ (+ (* it1589 (- 1)) (* it1555 (- 1)))
              (* (* (+ it1045 (- 1)) it359) (- 1))
              (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!6 (+ (+ (+ (* it1589 (- 1)) (* it1555 (- 1))) it127) (- 2)))
      (a!7 (>= (+ (+ (* it1589 (- 1)) it127) (- 1)) 0))
      (a!8 (> (+ (+ (* it1589 (- 1)) (* it1555 (- 1)))
                 (* it909 (- 1))
                 (* it359 (- 1))
                 it127)
              0))
      (a!9 (> (+ (+ it1589 it1555)
                 ...
                 1)
              0))
      (a!10 (>= (+ (+ (* it1589 (- 1)) it127) (- 2)) 0))
      (a!11 (+ (* (* it1045 it359) (- 1))
               (* it1555 (- 1))
               (* (* it1045 it909) (- 1))))
      (a!13 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!14 (> (+ (+ (* it1589 (- 1)) (* it1555 (- 1))) it127) 0)))
(let ((a!5 (> (+ (+ a!4 (* it359 (- 1)) it127) (- 1)) 0))
      (a!12 (>= (+ (+ a!4 (* it359 (- 1)) it127) (- 1)) 0)))
  (and (> it102 0)
       (> (+ it127 1) 0)
       (> (+ it1589 1) 0)
       a!1
       ...
       (>= (+ it1590 (- 1)) 0)
       a!12
       (> (+ a!4 (* it909 (- 1)) (* it359 (- 1)) it127) 0)
       (> (+ (+ it1589 it1555) it359 1) 0)
       (<= (+ it1590 (* it102 (- 1))) 0)
       (> it1591 0)
       (> (+ (+ it1589 it1555) 1) 0)
       a!13
