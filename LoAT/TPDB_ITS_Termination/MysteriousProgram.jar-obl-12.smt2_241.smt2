...
(assert (let ((a!1 (+ (+ (+ it1124 (* it1122 (- 1))) (* it359 (- 1))) (- 1)))
      ...
      (a!3 (+ (* (* it1045 it359) (- 1))
              ...
              (* it1122 (- 1))
              (* (* it1045 it1125) (- 1))))
      (a!4 (> (+ (+ it1124 (* it1122 (- 1))) (* it359 (- 1))) 0))
      (a!5 (>= (+ (+ it1124 (* it1122 (- 1))) (- 2)) 0))
      (a!6 (>= (+ (+ it1124 (* it1122 (- 1))) (- 1)) 0))
      (a!7 (+ (* (* it1045 it359) (- 1))
              (* it1122 (- 1))
              (* (* it1045 it1125) (- 1))
              it127))
      (a!8 (+ (* (* (+ it1045 (- 1)) it359) (- 1)) it1124))
      ...
      (a!13 (> (+ (* (+ it1045 (- 1)) it359)
                  ...
                  1)
               0))
      (a!14 (+ (+ (* (* it1045 it359) (- 1)) (* it1117 (- 1)))
               (* (* it1045 it1125) (- 1)))))
(let ((a!9 (+ (+ a!8 (* it1122 (- 1)))
              (* it359 (- 1))
              (* (* (+ it1045 (- 1)) it1125) (- 1))))
      (a!11 (+ (+ a!8 (* it1122 (- 1))) (* (* (+ it1045 (- 1)) it1125) (- 1))))
      (a!12 (+ a!8
               (* it1125 (- 1))
               (* it1122 (- 1))
               (* it359 (- 1))
  ...
  (and (> it107 0)
       ...
       (= (+ it1124 (* it127 (- 1))) 0)
       (>= (+ a!3 (- 2)) 0)
       (<= (+ (* it1045 it359) it1117 (* it1045 it1125)) 0)
       (<= (+ it1124 (* it127 (- 1))) 0)
       (> a!12 0)
       a!13
       (> (+ it1124 1) 0)
       (<= (+ (* it107 (- 1)) it1120) 0)
       (>= (+ a!7 (- 4)) 0)
       (> (+ (* it1045 it359) it1122 (* it1045 it1125) 1) 0)
       (>= (+ a!3 (- 1)) 0)
       (> it127 0)
       (>= (+ a!2 (- 1)) 0)
       (> it1124 0)
