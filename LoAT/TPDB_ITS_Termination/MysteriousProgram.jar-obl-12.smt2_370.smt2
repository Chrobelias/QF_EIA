...
(assert (let ((a!1 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1))) (* it1263 (- 1))))
      (a!2 (+ (+ it817 (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1263 (- 1))))
      (a!3 (> (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) 0))
      (a!4 (>= (+ (+ it1265 (* it1263 (- 1))) (- 1)) 0))
      (a!5 (+ (+ it817 (* it803 (- 1)) (* it673 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))
              (* it1263 (- 1))))
      (a!6 (> (+ it673
      ...
      (a!8 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 4)))
      (a!9 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 2)))
      (a!10 (>= (+ (+ it1265 (* it1263 (- 1))) (- 2)) 0))
      (a!11 (> (+ (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) it1263 1)
               0))
      (a!12 (+ (+ (+ it817 (* it673 (- 1))) (* it1263 (- 1))) (- 3))))
  (and (>= (+ (* it818 (- 1)) it1262) 0)
       (>= (+ it1264 (- 1)) 0)
       (>= (+ a!1 (- 2)) 0)
       (>= (+ a!1 (- 1)) 0)
       (> (+ it673 it1263 1) 0)
