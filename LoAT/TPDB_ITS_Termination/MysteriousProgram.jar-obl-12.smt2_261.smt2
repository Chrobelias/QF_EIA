...
(assert (let ((a!1 (+ it817 (* it803 (- 1)) (* it673 (- 1)) (* it1103 (- 1))))
      (a!2 (+ (* (* it803 it819) (- 1)) (* (* it673 it819) (- 1)) it817))
      (a!4 (> (+ it1103 (* (+ it819 (- 1)) it673) (* it803 (+ it819 (- 1))) 1)
              0))
      (a!5 (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1)))
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!6 (> (+ (* it803 it819)
                 (* (+ it1045 (- 1)) it1137)
      ...
      (a!7 (+ (* (* it803 it819) (- 1))
              ...
              (* (* (+ it1045 (- 1)) it359) (- 1))
              it817))
      (a!9 (>= (+ (+ it1105 (* it1103 (- 1))) (- 2)) 0))
      (a!12 (+ (+ (* it803 it819) (* it673 it819) it1103) it1106))
      (a!13 (> (+ (+ it673 it1103)
                  (* (+ it819 (- 1)) it673)
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!15 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 3)) 0))
      (a!16 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* it1106 (- 1))
               (* (* it1137 it1045) (- 1))))
      (a!18 (>= (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 4)) 0))
      (a!22 (> (+ (+ it1105 (* it1103 (- 1))) (- 1)) 0))
      (a!24 (>= (+ (+ it817 (* it673 (- 1)) (* it1103 (- 1))) (- 2)) 0))
      (a!25 (> (+ (+ (* it803 it819) (* it673 it819) it1103) 1) 0)))
(let ((a!3 (> (+ (+ a!2 (* it1103 (- 1))) (* it1106 (- 1))) 0))
      (a!8 (+ (+ a!7 (* it1103 (- 1)) (* it1106 (- 1))) (* it359 (- 1))))
      (a!10 (+ (+ (+ a!2 (* it1103 (- 1))) (* it1106 (- 1))) (- 1)))
      (a!11 (+ (+ (+ a!2 (* it1103 (- 1))) (* it1106 (- 1))) (* it359 (- 1))))
      (a!14 (> (+ (+ a!7 (* it1103 (- 1)) (* it1106 (- 1))) (- 1)) 0))
      (a!17 (>= (+ (+ a!7 (* it1103 (- 1)) (* it1106 (- 1))) (- 2)) 0))
      (a!19 (+ (+ (+ a!2 (* it1103 (- 1))) (* it1106 (- 1))) (- 2)))
      (a!21 (+ a!1
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!23 (> (+ (+ a!2 (* it1103 (- 1))) (- 1)) 0)))
  (and (> it1104 0)
       (> (+ (+ it673 it1103) 1) 0)
       (> it1101 0)
       (>= (+ a!1 (- 3)) 0)
