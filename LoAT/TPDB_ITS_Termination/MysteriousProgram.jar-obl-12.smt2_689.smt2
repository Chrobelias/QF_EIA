...
(assert (let ((a!1 (>= (+ (+ it1501 (* it117 (- 1))) (- 2)) 0))
      (a!2 (>= (+ (+ it117 (* it1591 (- 1))) (- 2)) 0))
      (a!3 (> (+ (+ it117 (* it1591 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ it1501 (* it117 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it117 (* it1591 (- 1))) (- 1)) 0))
      (a!6 (> (+ (+ (* it1589 (- 1)) it1591) (- 1)) 0))
      (a!7 (> (+ (+ it1501 (* it117 (- 1))) 1) 0))
      (a!8 (>= (+ (+ (* it1589 (- 1)) it1591) (- 2)) 0))
      (a!9 (> (+ (+ it117 (* it1591 (- 1))) 1) 0)))
  (and (> (+ it117 1) 0)
       (> it105 0)
       (> it104 0)
       (> it102 0)
       ...
       (> it1590 0)
       (>= (+ (* it1503 (- 1)) it102) 0)
       (<= (+ (* it1501 (- 1)) (* it1589 (- 1)) it117 it1591) 0)
       (>= (+ it1586 (- 6)) 0)
       (>= (+ it1588 (* it105 (- 1))) 0)
       (> it1504 0)
       (>= (+ it104 (- 1)) 0)
