...
(assert (let ((a!1 (+ (+ (* (* it1045 it359) (- 1)) it817)
      ...
      (a!4 (+ (+ (* (* it1045 it359) (- 1)) it817)
              (* it673 (- 1))
              (* (* it1045 it909) (- 1))))
      (a!7 (> (+ (+ (* it1045 it359) (* it1045 it909))
                 (* (+ it819 (- 1)) it673)
                 it1337
                 (* it803 (+ it819 (- 1)))
                 1)
              0))
      (a!8 (+ (+ it1339 (* it359 (- 1)) (* it1337 (- 1))) (- 1)))
      (a!12 (+ (* (* (+ it1045 (- 1)) it359) (- 1))
               it1339
               (* (* (+ it1045 (- 1)) it909) (- 1))))
      (a!14 (> (+ (* (+ it1045 (- 1)) it359)
                  (* (+ it1045 (- 1)) it909)
                  ...
                  1)
               0))
      (a!15 (> (+ (+ (* it1045 it359) it673 (* it1045 it909)) it1337 1) 0))
      (a!17 (+ (* (* it803 it819) (- 1))
               (* (* it1045 it359) (- 1))
               (* (* it673 it819) (- 1))
               (* (* it1045 it909) (- 1))))
      (a!18 (> (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!20 (>= (+ (+ it1339 (* it1337 (- 1))) (- 2)) 0))
      (a!21 (>= (+ (+ it1339 (* it1337 (- 1))) (- 1)) 0))
      (a!24 (> (+ (+ (* it1045 it359) it673 (* it1045 it909))
                  (* (+ it819 (- 1)) it673)
                  it1337
                  (* it803 (+ it819 (- 1)))
                  1)
               0))
      (a!25 (> (+ (+ (* it1045 it359) (* it1045 it909)) it1337 1) 0)))
(let ((a!2 (>= (+ (+ a!1 (* it1337 (- 1))) (- 3)) 0))
      (a!5 (>= (+ (+ a!4 (* it1337 (- 1))) (- 3)) 0))
      (a!6 (+ a!1
              (* (* (+ it819 (- 1)) it673) (- 1))
              (* it1337 (- 1))
              (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!9 (>= (+ (+ a!1 (* it1337 (- 1))) (- 1)) 0))
      (a!10 (+ a!4
               (* (* (+ it819 (- 1)) it673) (- 1))
               (* it1337 (- 1))
               (* (* it803 (+ it819 (- 1))) (- 1))))
      (a!11 (>= (+ (+ a!4 (* it1337 (- 1))) (- 2)) 0))
      (a!13 (> (+ (+ a!12 (* it1337 (- 1))) (- 1)) 0))
      (a!16 (>= (+ (+ a!1 (* it1337 (- 1))) (- 2)) 0))
      (a!19 (+ (+ a!12 (* it359 (- 1)) (* it1337 (- 1))) (- 1)))
      (a!22 (>= (+ (+ a!12 (* it1337 (- 1))) (- 2)) 0))
      (a!23 (>= (+ (+ a!4 (* it1337 (- 1))) (- 4)) 0)))
  (and a!2
       (>= (+ a!3 (- 2)) 0)
       (<= (+ (* it818 (- 1)) it1335) 0)
       a!5
       ...
       a!16
       (>= (+ it1045 (- 1)) 0)
       (> (+ it1339 (* it359 (- 1)) (* it1337 (- 1))) 0)
       (> a!8 0)
       (> (+ a!12 (* it359 (- 1)) (* it1337 (- 1))) 0)
       (>= (+ a!6 (- 1)) 0)
       (> it1335 0)
       (= 0 0)
       ...
       (>= (+ a!3 (- 1)) 0)
       (= a!17 0)
       (> (+ a!12 (* it909 (- 1)) (* it359 (- 1)) (* it1337 (- 1))) 0)
       (>= (+ (* it818 (- 1)) it1335) 0)
       (>= (+ it1335 (- 1)) 0)
       (> a!19 0)
       (> it1339 0)
       (> (+ it1339 (* it1337 (- 1))) 0)
       (>= (+ it909 (- 1)) 0)
       (> (+ it1339 (* it909 (- 1)) (* it359 (- 1)) (* it1337 (- 1))) 0)
       a!20
       (>= (+ a!6 (- 3)) 0)
       (>= a!19 0)
       (>= (+ it1336 (- 1)) 0)
