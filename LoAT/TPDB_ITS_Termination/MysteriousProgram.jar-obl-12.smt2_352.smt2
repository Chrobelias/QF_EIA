...
(assert (let ((a!1 (+ (* (* it673 it819) (- 1))
      ...
      (a!2 (+ (* it1273 (- 1))
              ...
              (* it673 (- 1))
              (* (* (+ it819 (- 1)) it673) (- 1))))
      (a!4 (+ (+ (* it1273 (- 1)) (* (* it673 it819) (- 1))) (* it1267 (- 1))))
      (a!6 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 4)) 0))
      (a!7 (+ (+ it1273 (* (+ it819 (- 1)) it1276)) (* (+ it819 (- 1)) it673) 1))
      (a!8 (+ (+ (* it1273 (- 1)) (* (* it673 it819) (- 1)))
              it817
              (* (* it819 it1276) (- 1))))
      (a!12 (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (* it1276 (- 1))))
      (a!13 (>= (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!14 (+ (+ (+ it1273 (* it673 it819)) it1267) it1268 (* it819 it1276) 1))
      (a!15 (> (+ (+ (* it1273 (- 1)) it1275) (- 1)) 0))
      (a!16 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 3)) 0))
      (a!17 (> (+ (+ it1273 (* it673 it819)) (* it819 it1276) 1) 0))
      (a!20 (+ (+ it1273 (* (+ it819 (- 1)) it1276))
               it673
               (* (+ it819 (- 1)) it673)
               1))
      (a!23 (>= (+ (+ (* it1273 (- 1)) it1275) (- 2)) 0))
      (a!24 (+ (+ (+ it1273 (* it673 it819)) it1267) (* it819 it1276) 1))
      (a!26 (>= (+ (+ (* it1273 (- 1)) it817 (* it673 (- 1))) (- 2)) 0))
      (a!28 (+ (+ (+ it1273 (* it673 it819)) it1267)
               (* it1137 (+ it1266 (- 1)))
               (* it1268 (+ it1266 (- 1)))
               (* it819 it1276)
               1)))
(let ((a!3 (>= (+ (+ a!2 (* it1276 (- 1))) (- 2)) 0))
      (a!5 (> (+ (+ a!4 it817)
                 (* it1137 (- 1))
                 (* it1268 (- 1))
                 (* (* it819 it1276) (- 1)))
              0))
      (a!9 (+ a!4 (* (* it1137 (+ it1266 (- 1))) (- 1)) it817))
      (a!11 (+ (+ a!4 it817) (* it1268 (- 1)) (* (* it819 it1276) (- 1))))
      (a!18 (+ (+ (+ a!4 it817) (* (* it819 it1276) (- 1))) (- 1)))
      (a!21 (> (+ (+ a!4 it817) (* (* it819 it1276) (- 1))) 0))
      (a!25 (>= (+ (+ a!2 (* it1276 (- 1))) (- 3)) 0))
      (a!27 (>= (+ (+ a!2 (* it1276 (- 1))) (- 1)) 0))
      (a!29 (+ (+ (+ a!4 it817) (* (* it819 it1276) (- 1))) (- 2))))
(let ((a!10 (+ a!9
               (* (* it1268 (+ it1266 (- 1))) (- 1))
               (* (* it819 it1276) (- 1))))
      (a!19 (+ a!9
