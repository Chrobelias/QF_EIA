...
(assert (or (not bt703)
    ...
    (<= it646 0)
    bt738
    (distinct (+ (* it615 (- 1)) it647) 0)
    (distinct (+ it644 (- 2)) 0)
    (distinct (+ (* it613 (- 1)) it645) 0)
    (not bt740)
    bt741
    bt739
    (distinct (+ (* it614 (- 1)) it646) 0)))
(assert (let ((a!1 (and (= (+ it614 (- 10)) 0)
                bt704
                bt703
                (not bt705)
                (not bt702)
                (= (+ (* it615 (- 1)) it647) 0)
                (= (+ (* it613 (- 1)) it645) 0)))
      (a!2 (and (= (+ (* it614 (- 1)) it646) 0) bt705))
      (a!5 (and (= (+ (* it614 (- 1)) it646) 0) bt704))
      (a!8 (and (= (+ (* it614 (- 1)) it646) 0) bt702))
      (a!10 (= (+ (+ (* it614 (- 1)) it646) (- 1)) 0))
      (a!16 (and (= (+ (* it614 (- 1)) it646) 0)
                 (not bt705)
                 (not bt704)
                 (not bt702)
                 (= (+ (* it615 (- 1)) it647) 0)
...
(let ((a!3 (and a!2
      ...
      (a!15 (and a!2
                 ...
                 (not bt703)
                 (= (+ (* it613 (- 1)) it645) 0)))
      (a!18 (and (and a!5 bt705)
                 (not bt702)
                 (= (+ (* it615 (- 1)) it647) 0)
                 (not bt703)
                 (= (+ (* it613 (- 1)) it645) 0)))
      (a!21 (or (or (or (not bt739) bt740) bt738) bt741 a!20)))
(let ((a!4 (or (or (not bt739) bt740)
               (> (+ it647 (* it645 (- 1))) 0)
               a!3
               bt741
               (not bt738)))
      (a!13 (or (or (not bt739) bt740)
                (<= (+ it647 (* it645 (- 1))) 0)
                a!12
                bt741
                (not bt738)))
      (a!19 (or (or (or (not bt739) bt740) bt738) (not bt741) (<= it645 0) a!18)))
  (and (or bt740 a!1 bt741 (not bt738) bt739)
       a!4
       (or a!6 bt740 (not bt741) (not bt738) bt739)
       (or bt740 a!7 bt738 (not bt741) bt739)
       (or (<= it646 0) a!9 (not bt740) bt738 bt741 bt739)
       (or (or (not bt739) (not bt740)) bt738 a!11 bt741)
       a!13
       (or (not bt740) a!14 bt738 (not bt741) bt739)
       (or (or (not bt739) bt740) (> it645 0) a!14 bt738 (not bt741))
       (= (+ it644 (- 2)) 0)
       (or (not bt740) (> it646 0) bt738 a!15 bt741 bt739)
       (or (or (not bt739) (not bt740)) a!12 bt741 (not bt738))
       (or (or (not bt739) bt740) a!16 (not bt741) (not bt738))
       (or (not bt740) a!17 bt741 (not bt738) bt739)
       (or bt740 a!16 bt738 bt741 bt739)
       a!19
       a!21)))))
(check-sat)
