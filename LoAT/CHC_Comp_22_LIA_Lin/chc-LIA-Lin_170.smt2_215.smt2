...
(declare-fun bt1025 () Bool)
(declare-fun bt1026 () Bool)
(declare-fun bt1027 () Bool)
(declare-fun bt1028 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it732 (- 2)) 0))
...
(assert (and (not bt996)
     ...
     (= (+ (* it893 (- 1)) it890) 0)))
(assert (= (+ it917 (- 2)) 0))
(assert (= (+ (* it892 (- 1)) it918) 0))
(assert (= (+ it919 (* it893 (- 1))) 0))
(assert (= (+ (* it894 (- 1)) it920) 0))
(assert (or (and (not bt1025) (not bt994)) (and bt1025 bt994)))
(assert (or (and bt993 bt1026) (and (not bt1026) (not bt993))))
(assert (or (and (not bt1027) (not bt995)) (and bt1027 bt995)))
(assert (or (and (not bt996) (not bt1028)) (and bt1028 bt996)))
(assert (and (= (+ it917 (- 2)) 0) bt1028 (not bt1027) bt1026 bt1025))
(check-sat)
