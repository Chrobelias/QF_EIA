...
(assert (= (+ (* (exp 16 it87) (+ 0 it98) (+ 0 (- 1))) (+ 0 it113))
   (+ 0 0)))
(assert (let ((a!1 (* (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) (+ 0 2)))
      (a!2 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 2)))
      (a!3 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 (- 1))))
      (a!5 (* (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) (+ 0 (- 4))))
      (a!6 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 4))))
(let ((a!4 (+ (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) a!3 (+ 0 5))))
  (and (> (+ (* it112 (- 16)) 5) 0)
       (> (+ (* it113 2) 5) 0)
       (>= (+ it110 (- 2)) 0)
       (= (+ (* it110 (- 1)) 2) 0)
