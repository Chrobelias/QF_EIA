...
(assert (or (distinct (+ (* it1316 (- 1)) it1313) 0)
    (not bt1425)
    (not bt1430)
    (distinct (+ it1312 (- 2)) 0)
    (distinct (+ (* it1318 (- 1)) it1315) 0)
    (not bt1426)
    (not bt1431)
    (distinct (+ (* it1317 (- 1)) it1314) 0)
    bt1429
    (> it1314 0)
    bt1428
    bt1427
    bt1432))
(assert (let ((a!1 (and (= (+ (* it1316 (- 1)) it1313) 0)
                (not bt1429)
                (not bt1431)
                (not bt1430)
                (= (+ (* it1318 (- 1)) it1315) 0)
                (= (+ (* it1317 (- 1)) it1314) 0)
                bt1432))
      (a!3 (and (= (+ (* it1316 (- 1)) it1313) 0) (not bt1432)))
      (a!5 (and (= (+ (* it1316 (- 1)) it1313) 0) bt1430))
      (a!7 (and (= (+ it1316 (- 1)) 0)
                (not bt1432)
                bt1430
                (not bt1429)
...
(let ((a!2 (or bt1426
               ...
               bt1427
               a!1))
      (a!4 (and (and (and a!3 bt1430) (not bt1429))
                (= (+ (* it1318 (- 1)) it1315) 0)
                (= (+ (* it1317 (- 1)) it1314) 0)
                bt1431))
      (a!6 (and a!5
                ...
                bt1429
                bt1432))
      (a!8 (and (and a!3 (not bt1429))
                (not bt1430)
                (= (+ (* it1318 (- 1)) it1315) 0)
                (= (+ (* it1317 (- 1)) it1314) 0)
                bt1431))
      (a!9 (and (and (and a!3 bt1430) (not bt1429))
                (not bt1431)
                (= (+ (* it1318 (- 1)) it1315) 0)
                (= (+ (* it1317 (- 1)) it1314) 0)))
      (a!10 (and (and a!3 (not bt1429))
                 (not bt1431)
                 (not bt1430)
                 (= (+ (* it1318 (- 1)) it1315) 0)
                 (= (+ (* it1317 (- 1)) it1314) 0)))
...
(let ((a!17 (or bt1426
                ...
                a!16)))
  (and a!2
       (or a!4 (not bt1426) (not bt1425) (> it1314 0) bt1428 bt1427)
       (or (not bt1426) (not bt1428) a!6 (not bt1425) bt1427)
       (or a!7 (not bt1426) bt1425 bt1428 bt1427)
       (or (not bt1426) (<= it1314 0) (not bt1425) a!8 bt1428 bt1427)
       (or (or (not bt1427) (not bt1426)) a!9 bt1425 bt1428)
       (or (or bt1426 a!10) bt1425 bt1428 bt1427)
       (or bt1426 a!11 (not bt1428) (<= it1313 0) bt1425 bt1427)
       (or (or (not bt1427) bt1426) bt1425 bt1428 a!12)
       (or (or bt1426 a!10) (not bt1428) (not bt1425) bt1427)
       (or a!13 (not bt1426) (not bt1428) bt1425 bt1427)
       (or bt1426 (> it1313 0) (not bt1428) a!6 bt1425 bt1427)
       (= (+ it1312 (- 2)) 0)
       (or (or (not bt1427) (not bt1426)) a!14 (not bt1425) bt1428)
       (or (or (not bt1427) bt1426) a!15 (not bt1425) bt1428)
       a!17)))))
(check-sat)
