...
(declare-fun bt1129 () Bool)
(declare-fun bt1130 () Bool)
(declare-fun bt1131 () Bool)
(declare-fun bt1132 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it732 (- 2)) 0))
...
(assert (and (= (+ it979 (- 2)) 0)
     ...
     (not bt1097)))
(assert (= (+ it1009 (- 2)) 0))
(assert (= (+ (* it983 (- 1)) it1010) 0))
(assert (= (+ it1011 (* it984 (- 1))) 0))
(assert (= (+ (* it985 (- 1)) it1012) 0))
(assert (or (and bt1129 bt1098) (and (not bt1098) (not bt1129))))
(assert (or (and bt1130 bt1097) (and (not bt1130) (not bt1097))))
(assert (or (and (not bt1099) (not bt1131)) (and bt1131 bt1099)))
(assert (or (and (not bt1132) (not bt1100)) (and bt1132 bt1100)))
(assert (and bt1129 (not bt1131) (= (+ it1009 (- 2)) 0) bt1130 bt1132))
(check-sat)
