...
(declare-fun bt1241 () Bool)
(declare-fun bt1242 () Bool)
(declare-fun bt1243 () Bool)
(declare-fun bt1244 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1028 (- 2)) 0))
...
(assert (and (not bt1240)
     ...
     (= (+ it1120 (- 2)) 0)))
(assert (= (+ it1129 (- 2)) 0))
(assert (= (+ it1130 (* it1124 (- 1))) 0))
(assert (= (+ it1131 (* it1125 (- 1))) 0))
(assert (= (+ it1132 (* it1126 (- 1))) 0))
(assert (or (and (not bt1238) (not bt1241)) (and bt1241 bt1238)))
(assert (or (and bt1237 bt1242) (and (not bt1237) (not bt1242))))
(assert (or (and (not bt1239) (not bt1243)) (and bt1243 bt1239)))
(assert (or (and (not bt1240) (not bt1244)) (and bt1244 bt1240)))
(assert (and bt1241 bt1244 (not bt1243) (= (+ it1129 (- 2)) 0) bt1242))
(check-sat)
