...
(assert (let ((a!1 (and (not bt983)
      ...
      (a!3 (and (not bt983)
                ...
                (= (+ it853 (* it856 (- 1))) 0)
                bt984))
      (a!4 (and (and (not bt983) bt985)
                (not bt982)
                (= (+ it852 (* it855 (- 1))) 0)
                (= (+ (* it857 (- 1)) it854) 0)
                (= (+ it853 (* it856 (- 1))) 0)))
      (a!5 (and (and (not bt983) bt985)
                (= (+ it852 (* it855 (- 1))) 0)
                (= (+ (* it857 (- 1)) it854) 0)
                (= (+ it853 (* it856 (- 1))) 0)
                (not bt984)
      ...
      (a!14 (and (not bt982)
                 ...
                 bt983
                 bt984)))
(let ((a!8 (or (> (+ (* it852 (- 1)) it854) 0)
               bt980
               (and a!7 (not bt984) bt983)
               (not bt978)
               (not bt979)
               bt981))
      (a!11 (or (<= (+ (* it852 (- 1)) it854) 0)
                bt980
                a!1
                (not bt978)
                (not bt979)
      ...
      (a!13 (and (not bt983)
                 ...
                 bt982
                 bt984)))
  (and (or a!1 (not bt978) (not bt979) bt981 (not bt980))
       (or a!2 bt979 bt980 bt981 bt978)
       (or bt980 a!3 (not bt979) bt981 bt978)
       (or (> it853 0) bt979 (and a!4 (not bt984)) bt981 bt978 (not bt980))
       (or a!5 bt980 (> it852 0) (not bt981) (not bt979) bt978)
       (or (or bt979 bt980) a!6 (not bt978) bt981)
       (or bt980 (and a!4 bt984) (not bt981) (<= it852 0) (not bt979) bt978)
       a!8
       (or bt979 (<= it853 0) a!9 bt981 bt978 (not bt980))
       (or bt979 a!10 (not bt978) bt981 (not bt980))
       a!11
       (or a!5 bt979 (not bt981) bt978 (not bt980))
       (or a!2 bt980 (not bt981) (not bt978) (not bt979))
       (or a!13 (not bt979) bt981 bt978 (not bt980))
       (= (+ it851 (- 2)) 0)
       (or (or bt979 bt980) (and a!7 bt983 bt984) (not bt981) (not bt978))
       (or (or bt979 bt980) (not bt981) bt978 a!14)))))
(check-sat)
