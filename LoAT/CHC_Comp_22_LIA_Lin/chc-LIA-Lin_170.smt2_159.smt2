...
(assert (or (not bt496)
    (distinct (+ (* it443 (- 1)) it440) 0)
    (not bt494)
    bt497
    bt499
    (distinct (+ (* it444 (- 1)) it441) 0)
    (not bt498)
    (distinct (+ it439 (- 2)) 0)
    (distinct (+ it442 (* it445 (- 1))) 0)
    (not bt500)
    bt493))
(assert (let ((a!1 (and (= (+ it442 (* it445 (- 1))) 0) (not bt499)))
      (a!4 (and (= (+ it442 (* it445 (- 1))) 0) bt497 bt499))
      (a!6 (and (= (+ it442 (* it445 (- 1))) 0)
                bt499
                (= (+ (* it444 (- 1)) it441) 0)
                (not bt500))))
(let ((a!2 (and (and a!1 bt500) bt497 (= (+ (* it444 (- 1)) it441) 0)))
      (a!5 (and a!4
                (= (+ (* it443 (- 1)) (* it440 3)) 0)
                (= (+ (* it444 (- 1)) it441) 0)
                (not bt500)
                bt498))
      (a!7 (and a!6 bt498 (= (+ (* it443 (- 1)) it440) 0) (not bt497)))
      (a!8 (and a!1
                bt497
                (= (+ (* it444 (- 1)) it441) 0)
                (not bt500)
                bt498
                (= (+ (* it443 (- 1)) it440) 0)))
      (a!10 (and a!6 (= (+ (* it443 (- 1)) it440) 0) (not bt497) (not bt498)))
      (a!13 (and a!4
                 (= (+ (* it443 (- 1)) (* it440 2)) 0)
                 (= (+ (* it444 (- 1)) it441) 0)
                 (not bt500)
                 (not bt498)))
      (a!14 (and a!1 (= (+ (* it444 (- 1)) it441) 0) (not bt500)))
      (a!16 (and (and a!1 bt500) (= (+ (* it444 (- 1)) it441) 0)))
      (a!19 (and a!4
                 (= (+ (* it444 (- 1)) it441) 0)
                 (not bt500)
                 (= (+ (* it443 (- 1)) it440) 0)
      ...
      (a!22 (and a!1
                 ...
                 bt498
                 (not bt497))))
(let ((a!3 (and a!2 bt498 (= (+ (* it443 (- 1)) it440) 0)))
      (a!9 (or (or bt494 bt495 bt496)
               (<= (+ it442 (* it440 (- 1))) 0)
               (not bt493)
               a!8))
      (a!11 (or (or (or (not bt494) bt495) bt496) (<= it441 0) (not bt493) a!10))
      (a!12 (and a!2 (= (+ (* it443 (- 1)) it440) 0) (not bt498)))
      (a!15 (and a!14 bt498 (= (+ (* it443 (- 1)) it440) 0) (not bt497)))
      (a!17 (and a!16 (= (+ (* it443 (- 1)) it440) 0) (not bt497) (not bt498)))
      (a!20 (and a!14 (= (+ (* it443 (- 1)) it440) 0) (not bt497) (not bt498)))
      (a!21 (and a!16 bt498 (= (+ (* it443 (- 1)) it440) 0) (not bt497)))
      (a!23 (or (or (or (not bt494) bt495) bt496) a!22 bt493)))
(let ((a!18 (or (> (+ it442 (* it440 (- 1))) 0)
                bt494
                bt495
                bt496
                a!17
                (not bt493))))
  (and (or (or (not bt496) bt494 bt495) (> it440 0) a!3 bt493)
       (or (or bt494 bt496 (not bt495)) (not bt493) a!5)
       (or (or (not bt494) bt495) a!7 bt496 (not bt493) (> it441 0))
       (or (or (not bt494) (not bt496) bt495) a!3 (not bt493))
       (= (+ it439 (- 2)) 0)
       a!9
       a!11
       (or (or (not bt496) bt494 bt495) (<= it440 0) a!12 bt493)
       (or (or bt494 bt496 (not bt495)) a!13 bt493)
       (or (or (not bt494) bt496) a!15 (not bt495) bt493)
       a!18
       (or (or (not bt494) bt496) a!19 (not bt495) (not bt493))
       (or (or bt494 bt495 bt496) a!20 bt493)
       (or (or (not bt496) bt494 bt495) a!20 (not bt493))
       (or (or (not bt494) (not bt496) bt495) a!21 bt493)
       a!23))))))
(check-sat)
