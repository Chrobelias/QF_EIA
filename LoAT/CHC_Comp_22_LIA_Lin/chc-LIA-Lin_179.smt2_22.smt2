...
(assert (let ((a!1 (and (= (+ (* it353 (- 1)) (* it350 2)) 0)
                bt402
                (= (+ (* it355 (- 1)) it352) 0)
                (= (+ (* it354 (- 1)) it351) 0)
                bt404
                (not bt405)
                bt403))
      (a!2 (and (and (and (not bt403) bt405) (not bt402))
                (= (+ (* it353 (- 1)) it350) 0)
                (= (+ (* it355 (- 1)) it352) 0)
                (= (+ (* it354 (- 1)) it351) 0)
                bt404))
      ...
      (a!5 (and (not bt403)
                ...
                (= (+ (* it354 (- 1)) it351) 0)
                (not bt405)))
      (a!6 (and (and bt405 (not bt402))
                (= (+ (* it353 (- 1)) it350) 0)
                (= (+ (* it355 (- 1)) it352) 0)
                (= (+ (* it354 (- 1)) it351) 0)
                bt404
                bt403))
      (a!7 (and (and (and (not bt403) bt405) (not bt402))
                (not bt404)
                (= (+ (* it353 (- 1)) it350) 0)
                (= (+ (* it355 (- 1)) it352) 0)
                (= (+ (* it354 (- 1)) it351) 0)))
      (a!8 (and (not bt403)
                ...
                bt404
                (not bt405)))
      (a!10 (= (+ (+ (* it354 (- 1)) it351) (- 1)) 0))
      (a!12 (and (not bt402)
                 (= (+ (* it353 (- 1)) it350) 0)
                 (= (+ (* it355 (- 1)) it352) 0)))
      (a!14 (and (and bt405 (not bt402))
                 (not bt404)
                 (= (+ (* it353 (- 1)) it350) 0)
                 (= (+ (* it355 (- 1)) it352) 0)
                 (= (+ (* it354 (- 1)) it351) 0)
      ...
      (a!16 (and (not bt403)
                 ...
                 (= (+ (* it354 (- 1)) it351) 0)
                 (not bt405))))
(let ((a!9 (or (or (or bt400 (not bt399)) bt401) bt398 a!8))
      (a!11 (and (not bt403)
                 a!10
                 bt402
                 (= (+ (* it353 (- 1)) it350) 0)
                 ...
                 bt404
                 (not bt405)))
      (a!13 (and a!12 (= (+ (* it354 (- 1)) it351) 0) bt404 (not bt405) bt403))
      (a!15 (or (or bt400 (not bt399))
                (> (+ it352 (* it350 (- 1))) 0)
                bt401
                a!14
                (not bt398)))
      (a!17 (or (or (or bt400 (not bt399)) bt401)
                (<= (+ it352 (* it350 (- 1))) 0)
                a!16
                (not bt398)))
      (a!18 (or (or (or bt400 bt399) bt401)
                (not bt398)
                (and a!12 bt404 (not bt405) (= (+ it354 (- 10)) 0) bt403))))
  (and (= (+ it349 (- 2)) 0)
       (or a!1 bt399 bt401 (not bt400) (not bt398))
       (or (or bt400 (not bt399)) (<= it350 0) bt398 a!2 (not bt401))
       (or (or bt399 bt401) bt398 (not bt400) a!3 (<= it351 0))
       (or (or bt400 (not bt399)) a!4 bt398 (not bt401) (> it350 0))
       (or (or bt400 (not bt399)) (not bt401) (not bt398) a!5)
       (or a!4 bt399 bt398 (not bt400) (not bt401))
       (or (or (or bt400 bt399) bt401) bt398 a!5)
       (or (or bt400 bt399) a!6 (not bt401) (not bt398))
       (or (or bt399 bt401) (> it351 0) bt398 a!7 (not bt400))
       a!9
       (or (or (not bt399) bt401) bt398 (not bt400) a!11)
       (or (or bt400 bt399) bt398 a!13 (not bt401))
       a!15
       a!17
       (or (or (not bt399) bt401) a!16 (not bt400) (not bt398))
       a!18))))
(check-sat)
