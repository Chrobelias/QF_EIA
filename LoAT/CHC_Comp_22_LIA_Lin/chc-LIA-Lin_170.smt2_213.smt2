...
(assert (let ((a!1 (and (= (+ (* it893 (- 1)) it890) 0) (not bt994)))
      (a!4 (and (= (+ (* it893 (- 1)) it890) 0)
                bt995
                (= (+ (* it892 (- 1)) it889) 0)
                bt994
                (not bt996)
                (not bt993)
                (= (+ (* it894 (- 1)) it891) 0)))
      (a!6 (and (= (+ (* it893 (- 1)) it890) 0)
                (= (+ (* it892 (- 1)) it889) 0)
                (not bt995)))
      (a!18 (and (= (+ (* it893 (- 1)) it890) 0)
                 (not bt995)
                 bt994
                 (not bt996)
                 (not bt993)
      ...
      (a!19 (and (= (+ (* it893 (- 1)) it890) 0)
                 ...
                 (not bt996)
                 (= (+ (* it894 (- 1)) it891) 0))))
(let ((a!2 (and (and a!1 bt995) (= (+ (* it892 (- 1)) it889) 0)))
      (a!5 (and (and a!1 bt995)
                bt993
                (= (+ (* it892 (- 1)) (* it889 2)) 0)
                (not bt996)
                (= (+ (* it894 (- 1)) it891) 0)))
      (a!7 (and (and a!6 bt993 bt994)
                (not bt996)
                (= (+ (* it894 (- 1)) it891) 0)))
      (a!9 (and (and a!6 bt993 bt994) bt996 (= (+ (* it894 (- 1)) it891) 0)))
      (a!10 (and a!1 (= (+ (* it892 (- 1)) it889) 0) (not bt995)))
      (a!12 (and (and a!6 bt994)
                 (not bt993)
                 bt996
                 (= (+ (* it894 (- 1)) it891) 0)))
      (a!15 (and (and a!6 bt994)
                 (not bt996)
                 (not bt993)
                 (= (+ (* it894 (- 1)) it891) 0))))
(let ((a!3 (and a!2 (not bt996) (not bt993) (= (+ (* it894 (- 1)) it891) 0)))
      (a!8 (or (<= (+ it891 (* it889 (- 1))) 0)
               bt992
               a!7
               bt991
               (not bt989)
               bt990))
      (a!11 (and a!10 (not bt996) (not bt993) (= (+ (* it894 (- 1)) it891) 0)))
      (a!13 (and a!2 bt993 (not bt996) (= (+ (* it894 (- 1)) it891) 0)))
      (a!14 (and a!10 bt993 bt996 (= (+ (* it894 (- 1)) it891) 0)))
      (a!16 (and a!10 (not bt993) bt996 (= (+ (* it894 (- 1)) it891) 0))))
(let ((a!17 (or bt992
                (> (+ it891 (* it889 (- 1))) 0)
                bt991
                a!16
                (not bt989)
                bt990)))
  (and (or a!3 bt992 (not bt990) bt991 (not bt989) (<= it890 0))
       (or (> it890 0) a!4 bt992 (not bt990) bt991 (not bt989))
       (or (or bt992 bt989) a!5 bt990 (not bt991))
       a!8
       (or (not bt990) bt991 (not bt992) (not bt989) a!9)
       (or bt992 a!11 bt989 bt991 bt990)
       (or bt989 (not bt990) bt991 (not bt992) a!12)
       (or (or bt989 bt991) (not bt992) a!9 bt990 (> it889 0))
       (or bt992 (not bt990) (not bt989) a!13 (not bt991))
       (or (or bt989 bt991) a!14 (not bt992) (<= it889 0) bt990)
       (or (or (or bt992 bt989) (not bt990)) a!15 (not bt991))
       (= (+ it888 (- 2)) 0)
       a!17
       (or a!11 bt991 (not bt992) (not bt989) bt990)
       (or (or (or bt992 bt989) (not bt990)) bt991 a!18)
       (or a!19 bt992 (not bt989) bt990 (not bt991))))))))
(check-sat)
