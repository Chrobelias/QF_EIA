...
(assert (let ((a!1 (and bt269
      ...
      (a!3 (and bt272
                ...
                (not bt270)
                (= (+ (* it246 (- 1)) it243) 0)))
      (a!5 (and bt270 (not bt271) (= (+ (* it247 (- 1)) it244) 0)))
      (a!7 (and bt270
                bt271
                (= (+ (* it247 (- 1)) it244) 0)
                (= (+ (* it245 (- 1)) it242) 0)
      ...
      (a!8 (and bt271
                ...
                (= (+ (* it246 (- 1)) it243) 0)
                (not bt272)))
      (a!9 (and (and bt269 bt271)
                (= (+ (* it245 (- 1)) (* it242 2)) 0)
                (= (+ (* it247 (- 1)) it244) 0)
                (not bt270)
                (= (+ (* it246 (- 1)) it243) 0)
                (not bt272)))
      (a!10 (and (and bt269 bt271)
                 (= (+ (* it247 (- 1)) it244) 0)
                 (= (+ (* it245 (- 1)) it242) 0)
                 (not bt270)
                 (= (+ (* it246 (- 1)) it243) 0)
      ...
      (a!13 (and bt270
                 ...
                 (not bt269)
                 (= (+ (* it246 (- 1)) it243) 0)))
      (a!15 (and (and bt269 bt270)
                 (not bt271)
                 (= (+ (* it247 (- 1)) it244) 0)
                 (= (+ (* it245 (- 1)) it242) 0)
                 (= (+ (* it246 (- 1)) it243) 0)
                 (not bt272))))
(let ((a!4 (or (or bt266 bt267)
               a!3
               bt268
               (not bt265)
               (> (+ (* it242 (- 1)) it244) 0)))
      ...
      (a!14 (and a!5
                 ...
                 (not bt272)
                 (= (+ it245 (- 1)) 0)))
      (a!16 (or (or bt266 bt267)
                a!15
                bt268
                (not bt265)
                (<= (+ (* it242 (- 1)) it244) 0))))
  (and (or bt266 a!1 bt268 (not bt265) (not bt267))
       (or (or bt266 bt267) a!2 (> it242 0) bt265 (not bt268))
       a!4
       (= (+ it241 (- 2)) 0)
       (or (not bt266) a!6 bt268 bt265 (not bt267))
       (or (not bt266) (> it243 0) a!7 bt267 bt268 (not bt265))
       (or (or (not bt266) bt267) a!8 bt268 (<= it243 0) (not bt265))
       (or (or (not bt266) bt267) a!2 (not bt265) (not bt268))
       (or bt266 a!9 bt268 bt265 (not bt267))
       (or (not bt266) a!10 bt268 (not bt265) (not bt267))
       (or (or (or bt266 bt267) a!11) (not bt265) (not bt268))
       (or (or (or bt266 bt267) a!11) bt268 bt265)
       (or (or bt266 bt267) bt265 a!12 (<= it242 0) (not bt268))
       (or (or (not bt266) bt267) a!13 bt265 (not bt268))
       (or a!14 (not bt266) bt267 bt268 bt265)
       a!16))))
(check-sat)
