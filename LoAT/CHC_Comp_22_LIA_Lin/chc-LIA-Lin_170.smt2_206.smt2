...
(assert (let ((a!1 (and bt965 (= (+ (* it869 (- 1)) it866) 0)))
      (a!3 (and (and (not bt967) bt968)
                bt965
                (= (+ (* it869 (- 1)) it866) 0)
                (not bt966)
                (= (+ (* it870 (- 1)) it867) 0)
                (= (+ (* it868 (- 1)) it865) 0)))
      (a!4 (and (and (and (not bt967) bt966) bt968)
                (= (+ (* it869 (- 1)) it866) 0)
                (= (+ (* it870 (- 1)) it867) 0)
                (not bt965)
                (= (+ (* it868 (- 1)) it865) 0)))
      (a!5 (and (and (not bt967) bt966)
                (= (+ (* it869 (- 1)) it866) 0)
                (= (+ (* it870 (- 1)) it867) 0)
                (not bt968)
                (not bt965)))
      ...
      (a!10 (and bt966
                 ...
                 (not bt965)
                 (= (+ (* it868 (- 1)) it865) 0)))
      (a!11 (and (and (not bt967) bt968)
                 (= (+ (* it869 (- 1)) it866) 0)
                 (not bt966)
                 (= (+ (* it870 (- 1)) it867) 0)
                 (not bt965)
                 (= (+ (* it868 (- 1)) it865) 0)))
      (a!13 (and (and (and (not bt967) bt966) bt968)
                 bt965
                 (= (+ (* it869 (- 1)) it866) 0)
                 (= (+ (* it870 (- 1)) it867) 0)
                 (= (+ (* it868 (- 1)) it865) 0)))
      (a!14 (and (= (+ (* it868 (- 1)) (* it865 3)) 0)
                 bt966
                 bt965
                 (= (+ (* it869 (- 1)) it866) 0)
                 (= (+ (* it870 (- 1)) it867) 0)
...
(let ((a!2 (and a!1
                ...
                (not bt968)
                bt967))
      (a!6 (or bt961 (and a!5 (= (+ it868 (- 1)) 0)) bt964 (not bt962) bt963))
      (a!9 (or a!8
               bt962
               bt964
               bt963
      ...
      (a!15 (and a!1
                 ...
                 bt967
                 (= (+ (* it868 (- 1)) it865) 0)))
      (a!17 (and a!5 (= (+ (* it868 (- 1)) it865) 0))))
  (and (or (or (or bt961 bt962) bt964) a!2 (not bt963))
       (or (or bt961 bt962) a!3 (<= it865 0) (not bt964) bt963)
       (= (+ it864 (- 2)) 0)
       (or bt961 (not bt964) (not bt962) bt963 a!4)
       a!6
       (or (or (or bt961 bt962) bt964) bt963 a!7)
       a!9
       (or bt962 (not bt964) bt963 a!7 (not bt961))
       (or (> it866 0) bt964 a!10 (not bt962) bt963 (not bt961))
       a!12
       (or a!13 (not bt964) (not bt962) bt963 (not bt961))
       (or bt961 (> it865 0) a!13 bt962 (not bt964) bt963)
       (or (or bt962 bt964) a!14 (not bt961) (not bt963))
       (or a!15 bt964 (not bt962) (not bt961) (not bt963))
       (or (<= it866 0) bt964 (not bt962) a!16 bt963 (not bt961))
       (or bt961 bt964 (not bt962) a!17 (not bt963))))))
(check-sat)
