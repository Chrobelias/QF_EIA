...
(assert (or (not bt748)
    (distinct (+ it650 (- 2)) 0)
    (distinct (+ (* it655 (- 1)) it652 (- 1)) 0)
    (distinct (+ (* it654 (- 1)) it651) 0)
    (not bt743)
    bt742
    (not bt744)
    bt749
    bt747
    (distinct (+ (* it656 (- 1)) it653) 0)
    (not bt746)))
(assert (let ((a!1 (and (= (+ it654 (- 1)) 0)
                (not bt747)
                (= (+ (* it655 (- 1)) it652) 0)
                (= (+ (* it656 (- 1)) it653) 0)
                bt748
      ...
      (a!12 (and (not bt747)
                 ...
                 (not bt746)
                 (= (+ (* it654 (- 1)) it651) 0)))
      (a!20 (= (+ (+ (* it655 (- 1)) it652) (- 1)) 0)))
(let ((a!3 (and (and a!2 bt749) (not bt746) (= (+ (* it654 (- 1)) it651) 0)))
      (a!5 (and a!4 bt746 bt747 (= (+ (* it654 (- 1)) it651) 0) (not bt749)))
      (a!7 (and a!6 bt749 bt747 (not bt746) (= (+ (* it654 (- 1)) it651) 0)))
      (a!8 (and a!4 bt749 bt747 (not bt746) (= (+ (* it654 (- 1)) it651) 0)))
      (a!10 (and a!6
                 bt746
                 bt747
                 (= (+ (* it654 (- 1)) (* it651 2)) 0)
                 (not bt749)))
      (a!13 (or (or (or (not bt745) bt742) bt744 (not bt743)) a!12 (<= it651 0)))
      (a!14 (and a!2 (not bt746) (= (+ (* it654 (- 1)) it651) 0) (not bt749)))
      (a!15 (and (and a!2 bt749) bt746 (= (+ (* it654 (- 1)) it651) 0)))
      (a!17 (and a!2 bt746 (= (+ (* it654 (- 1)) it651) 0) (not bt749)))
      (a!21 (and (not bt747)
                 (= (+ (* it656 (- 1)) it653) 0)
                 bt748
                 bt746
      ...
      (a!22 (and a!6
                 ...
                 (= (+ (* it654 (- 1)) it651) 0)
                 (not bt749))))
(let ((a!9 (or (> (+ it653 (* it651 (- 1))) 0)
               (not bt742)
               bt744
               bt745
               a!8
               (not bt743)))
      (a!16 (or (or (or (not bt745) bt742) bt744 (not bt743)) (> it651 0) a!15))
      (a!18 (or (not bt742)
                bt744
                bt745
                a!17
                (not bt743)
                (<= (+ it653 (* it651 (- 1))) 0)))
      (a!19 (or (or (or (not bt745) bt742) bt743) (not bt744) a!15))
      (a!23 (or (or (or (not bt745) bt742) bt743) bt744 a!22)))
  (and (or bt742 bt744 bt745 (not bt743) a!1)
       (or (or bt742 bt743) bt745 a!3 (not bt744) (> it652 0))
       (or (<= it652 0) bt742 bt743 bt745 a!5 (not bt744))
       (or (not bt745) bt743 a!7 (not bt742) bt744)
       a!9
       (or (or bt743 (not bt742)) bt745 a!10 (not bt744))
       (or (or bt743 (not bt742)) bt744 bt745 a!11)
       a!13
       (or (or bt742 bt743) bt744 bt745 a!14)
       (= (+ it650 (- 2)) 0)
       a!16
       a!18
       (or (not bt745) (not bt742) bt744 (not bt743) a!14)
       a!19
       (or (not bt742) bt745 a!17 (not bt743) (not bt744))
       (or bt742 a!21 bt745 (not bt743) (not bt744))
       a!23)))))
(check-sat)
