...
(assert (or (distinct (+ it1374 (* it1377 (- 1))) 0)
    bt1488
    (distinct (+ (* it1376 (- 1)) it1373) 0)
    (not bt1481)
    (distinct (+ it1371 (- 2)) 0)
    (distinct (+ (* it1375 (- 1)) it1372) 0)
    bt1487
    bt1486
    (not bt1484)
    bt1482
    bt1485))
(assert (let ((a!1 (and (= (+ (* it1376 (- 1)) it1373) 0)
                bt1488
                (= (+ it1374 (* it1377 (- 1))) 0)))
      (a!3 (and (= (+ (* it1376 (- 1)) it1373) 0)
                (= (+ it1374 (* it1377 (- 1))) 0)))
      (a!17 (and (= (+ (* it1376 (- 1)) it1373) 0)
                 (= (+ it1375 (- 1)) 0)
                 (= (+ it1374 (* it1377 (- 1))) 0)
                 (not bt1485)
                 bt1486
...
(let ((a!2 (and a!1
      ...
      (a!5 (and a!1
                ...
                (not bt1487)
                bt1485))
      (a!6 (and (and a!1 (not bt1485))
                bt1486
                (= (+ (* it1375 (- 1)) it1372) 0)
                (not bt1487)))
      (a!7 (and (and a!3 bt1487)
                (not bt1486)
                (not bt1488)
                (= (+ (* it1375 (- 1)) it1372) 0)
                bt1485))
      (a!8 (and (and a!3 (not bt1485))
                bt1486
                (not bt1488)
                (= (+ (* it1375 (- 1)) it1372) 0)
                (not bt1487)))
      (a!9 (and a!3
                ...
                (not bt1488)
                bt1485))
      (a!10 (and (and (and a!3 bt1487) (not bt1485))
                 bt1486
                 (not bt1488)
                 (= (+ (* it1375 (- 1)) it1372) 0)))
      (a!11 (and a!3
                 ...
                 (not bt1488)
                 bt1485))
      (a!12 (and (and a!1 (not bt1485))
                 (not bt1486)
                 (= (+ (* it1375 (- 1)) it1372) 0)
                 (not bt1487)))
      (a!14 (and (and (and a!3 bt1487) (not bt1485))
                 (not bt1486)
                 (not bt1488)
                 (= (+ (* it1375 (- 1)) it1372) 0)))
      (a!15 (and a!3
...
(let ((a!13 (or (not bt1481)
      ...
      (a!16 (or (not bt1481)
                ...
                bt1482)))
  (and (= (+ it1371 (- 2)) 0)
       (or (or (not bt1484) (not bt1481)) a!2 bt1483 (not bt1482))
       (or (or bt1481 bt1483) bt1484 bt1482 a!4)
       (or (not bt1484) a!5 (<= it1372 0) bt1481 bt1483 bt1482)
       (or (not bt1484) bt1481 bt1483 a!6 (not bt1482))
       (or (not bt1483) a!7 (not bt1481) bt1484 (not bt1482))
       (or (or (not bt1484) (not bt1481)) bt1483 bt1482 a!4)
       (or (or (not bt1483) bt1481) a!8 bt1484 (not bt1482))
       (or (or (not bt1483) bt1481) bt1484 a!9 bt1482)
       (or (not bt1481) (> it1373 0) a!10 bt1483 bt1484 (not bt1482))
       (or (not bt1483) (not bt1481) a!11 bt1484 bt1482)
       a!13
       (or (not bt1481) a!14 bt1483 (<= it1373 0) bt1484 (not bt1482))
       a!16
       (or (not bt1484) a!2 bt1481 bt1483 bt1482 (> it1372 0))
       (or (or bt1481 bt1483) a!17 bt1484 (not bt1482)))))))
(check-sat)
