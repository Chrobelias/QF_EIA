...
(assert (or (distinct (+ (* it468 (- 1)) it500) 0)
    bt570
    (distinct (+ (* it466 (- 1)) it498) 0)
    bt573
    bt536
    bt537
    bt571
    (not bt534)
    (distinct (+ it497 (- 2)) 0)
    (distinct (+ (* it467 (- 1)) it499) 0)
    (not bt535)
    (<= it499 0)
    (not bt572)))
(assert (let ((a!1 (and (and (not bt534) (not bt537))
                (not bt536)
                (not bt535)
                (= (+ (* it466 (- 1)) it498) 0)
                (= (+ (* it468 (- 1)) it500) 0)
      ...
      (a!2 (and (not bt537)
                ...
                (= (+ (* it468 (- 1)) it500) 0)
                (= (+ (* it467 (- 1)) it499) 0)))
      (a!3 (and (and (not bt534) (not bt537))
                (= (+ it466 (- 1)) 0)
                bt536
                (not bt535)
                (= (+ (* it468 (- 1)) it500) 0)
      ...
      (a!4 (and bt537
                ...
                (= (+ (* it468 (- 1)) it500) 0)
                (= (+ (* it467 (- 1)) it499) 0)))
      (a!6 (and (and (not bt534) bt535)
                bt537
                (not bt536)
                (= (+ (* it466 (- 1)) it498) 0)
                (= (+ (* it468 (- 1)) it500) 0)
                (= (+ (* it467 (- 1)) it499) 0)))
      (a!8 (and (and (not bt534) (not bt537))
                bt535
                bt536
                (= (+ (* it466 (- 1)) it498) 0)
                (= (+ (* it468 (- 1)) it500) 0)
      ...
      (a!14 (and (not bt534)
                 ...
                 (= (+ (* it466 (- 1)) it498) 0)
                 (= (+ (* it468 (- 1)) it500) 0)))
      (a!15 (= (+ (+ (* it467 (- 1)) it499) (- 1)) 0))
      (a!17 (and (and (not bt537) bt535)
                 bt536
                 bt534
                 (= (+ (* it468 (- 1)) it500) 0)
                 (= (+ (* it466 (- 1)) (* it498 2)) 0)
                 (= (+ (* it467 (- 1)) it499) 0)))
      (a!18 (and (and (not bt537) bt535)
                 bt534
                 (not bt536)
                 (= (+ (* it466 (- 1)) it498) 0)
                 (= (+ (* it468 (- 1)) it500) 0)
                 (= (+ (* it467 (- 1)) it499) 0))))
(let ((a!5 (or (or (or (not bt573) bt572) bt570) a!4 (not bt571) (> it498 0)))
      (a!7 (or (or (or bt572 bt573) (not bt571) (not bt570))
               (> (+ it500 (* it498 (- 1))) 0)
               a!6))
      (a!9 (or (or (or (not bt573) bt572) bt570) bt571 a!8))
      (a!11 (or (or (or bt572 bt573) (not bt571) (not bt570))
                a!2
                (<= (+ it500 (* it498 (- 1))) 0)))
      (a!16 (and (not bt537)
                 bt536
                 ...
                 a!15
                 (= (+ (* it468 (- 1)) it500) 0))))
  (and (or bt572 bt570 bt573 bt571 a!1)
       (or (or (not bt572) bt573) (not bt571) (not bt570) a!2)
       (or a!3 bt572 bt570 bt573 (not bt571))
       a!5
       a!7
       (= (+ it497 (- 2)) 0)
       a!9
       (or a!10 (not bt573) bt572 bt570 (not bt571) (<= it498 0))
       a!11
       (or bt570 a!12 (not bt572) bt573 bt571 (> it499 0))
       (or (or (not bt573) bt572) (not bt570) bt571 a!13)
       (or (or bt572 bt573) (not bt570) bt571 a!14)
       (or (or (not bt573) bt572) (not bt571) (not bt570) a!1)
       (or bt570 (not bt572) bt573 (not bt571) a!16)
       (or (or (not bt572) bt573) (not bt570) bt571 a!17)
       (or (not bt573) bt570 (not bt572) a!4 bt571)
       (or (<= it499 0) bt570 (not bt572) bt573 bt571 a!18)))))
(check-sat)
