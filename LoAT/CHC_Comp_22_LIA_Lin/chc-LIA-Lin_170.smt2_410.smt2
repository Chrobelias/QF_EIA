...
(assert (let ((a!1 (and (= (+ (* it1359 (- 1)) it1356) 0)
                (= (+ it1358 (* it1361 (- 1))) 0)
                (= (+ (* it1360 (- 1)) it1357) 0)))
      (a!4 (and (= (+ it1358 (* it1361 (- 1))) 0)
                (= (+ (* it1360 (- 1)) it1357) 0)
                bt1470
                (not bt1469)
                (not bt1471)
      ...
      (a!7 (and bt1471
                (= (+ it1358 (* it1361 (- 1))) 0)
                (= (+ (* it1360 (- 1)) it1357) 0)))
      (a!10 (and (= (+ (* it1359 (- 1)) it1356) 0)
                 bt1471
                 (= (+ it1358 (* it1361 (- 1))) 0)
                 (= (+ (* it1360 (- 1)) it1357) 0))))
(let ((a!2 (or (> (+ (* it1356 (- 1)) it1358) 0)
               (not bt1465)
               bt1468
               (and (and a!1 (not bt1469) (not bt1471) (not bt1470)) bt1472)
               bt1467
               bt1466))
      (a!3 (and (and a!1 (not bt1469) (not bt1471) (not bt1470)) (not bt1472)))
      (a!5 (or (and (and (and a!1 bt1470) bt1469 (not bt1471)) (not bt1472))
               (<= (+ (* it1356 (- 1)) it1358) 0)
               (not bt1465)
               bt1468
               bt1467
               bt1466))
      (a!6 (or (and (and (and a!1 bt1470) (not bt1469) (not bt1471))
                    (not bt1472))
               bt1465
               (not bt1467)
               bt1468
      ...
      (a!8 (and a!7
                ...
                (= (+ (* it1359 (- 1)) (* it1356 2)) 0)))
      (a!9 (or (not bt1468)
               (and (and (and a!1 bt1470) bt1469 (not bt1471)) bt1472)
               (not bt1465)
               bt1467
               (not bt1466)))
      (a!11 (and a!7
                 ...
                 (= (+ (* it1359 (- 1)) (* it1356 3)) 0)
                 (not bt1472)))
      (a!12 (or (or (not bt1468) bt1465)
                (> it1356 0)
                (and (and (and a!1 bt1470) bt1469 (not bt1471)) bt1472)
                bt1467
                bt1466))
      (a!13 (or (or (not bt1468) bt1465)
                (and (and (and a!1 bt1470) (not bt1469) (not bt1471)) bt1472)
                bt1467
                (not bt1466))))
  (and a!2
       (or (not bt1468) (not bt1465) bt1467 bt1466 a!3)
       (or (or bt1465 bt1468) a!4 bt1467 (not bt1466))
       (= (+ it1355 (- 2)) 0)
       (or (not bt1468)
           (<= it1356 0)
           bt1465
           (and a!1 bt1469 (not bt1471) (not bt1470) bt1472)
           bt1467
           bt1466)
       a!5
       a!6
       (or bt1465 (not bt1467) bt1468 a!8 bt1466)
       a!9
       (or (<= it1357 0)
           (not bt1465)
           bt1468
           bt1467
           (and a!10 (not bt1469) (not bt1470) (not bt1472))
           (not bt1466))
       (or (not bt1467) a!11 (not bt1465) bt1468 bt1466)
       (or (or bt1465 bt1468) bt1467 bt1466 a!3)
       (or (not bt1467)
           (and a!10 bt1469 (not bt1470) (not bt1472))
           (not bt1465)
           bt1468
           (not bt1466))
       a!12
       ...
       (or (> it1357 0)
           (not bt1465)
           bt1468
           (and a!10 bt1470 (not bt1469) (not bt1472))
           bt1467
           (not bt1466))))))
(check-sat)
