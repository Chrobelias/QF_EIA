...
(assert (and (not bt757)
     ...
     (= (+ it659 (* it662 (- 1))) 0)))
(assert (= (+ it664 (- 2)) 0))
(assert (= (+ it665 (* it661 (- 1))) 0))
(assert (= (+ (* it662 (- 1)) it666) 0))
(assert (= (+ (* it663 (- 1)) it667) 0))
(assert (or (and (not bt756) (not bt758)) (and bt758 bt756)))
(assert (or (and (not bt755) (not bt759)) (and bt759 bt755)))
(assert (or (and (not bt760) (not bt754)) (and bt760 bt754)))
(assert (or (and (not bt757) (not bt761)) (and bt757 bt761)))
(assert (let ((a!1 (and (= (+ (* it669 (- 1)) it666) 0) bt763))
      (a!4 (and (= (+ (* it669 (- 1)) it666) 0)
                bt765
                (= (+ (* it670 (- 1)) it667) 0)))
      (a!6 (and (= (+ (* it669 (- 1)) it666) 0) bt764))
      (a!10 (and bt763
                 bt764
                 (= (+ (* it670 (- 1)) it667) 0)
                 (not bt762)
                 ...
                 (= (+ it669 (- 10)) 0)
                 (not bt765)))
      (a!12 (and (= (+ (* it669 (- 1)) it666) 0)
                 (= (+ (* it670 (- 1)) it667) 0)))
      (a!22 (= (+ (+ (* it669 (- 1)) it666) (- 1)) 0)))
(let ((a!2 (and a!1
                bt765
                (= (+ (* it670 (- 1)) it667) 0)
                (not bt762)
      ...
      (a!7 (and a!6
                ...
                (= (+ it668 (- 1)) 0)
                (not bt765)))
      (a!8 (and (and a!1 bt764)
                bt765
                (= (+ (* it670 (- 1)) it667) 0)
                (not bt762)
                (= (+ (* it668 (- 1)) it665) 0)))
      (a!11 (or (or (or bt760 (not bt758)) bt759) a!10 bt761))
      (a!13 (and a!12
                 (not bt763)
                 bt762
                 (not bt764)
      ...
      (a!15 (and a!1
                 ...
                 (= (+ (* it668 (- 1)) it665) 0)
                 (not bt765)))
      (a!16 (and (and a!1 bt764) (= (+ (* it670 (- 1)) it667) 0)))
      (a!18 (and a!4
                 (not bt763)
                 bt762
                 (not bt764)
      ...
      (a!24 (and a!6
                 ...
                 (not bt763)
                 (= (+ (* it668 (- 1)) it665) 0))))
(let ((a!3 (or (or bt760 (not bt758))
               (> (+ (* it665 (- 1)) it667) 0)
               (not bt759)
               bt761
               a!2))
      (a!9 (or (or (or bt760 (not bt758)) bt759) (not bt761) a!8))
      (a!17 (and a!16 bt762 (= (+ (* it668 (- 1)) (* it665 2)) 0) (not bt765)))
      (a!19 (or (or (or (or bt760 bt758) (not bt759)) (not bt761))
                a!18
                (> it665 0)))
      (a!20 (or (or (or bt760 (not bt758)) (not bt759))
                a!13
                (<= (+ (* it665 (- 1)) it667) 0)
                bt761))
      (a!21 (or (or (or bt760 (not bt758)) (not bt759)) (not bt761) a!14))
      (a!25 (or (or (or (or bt760 bt758) (not bt759)) (not bt761))
                (<= it665 0)
                a!24))
      (a!26 (and a!16 (not bt762) (= (+ (* it668 (- 1)) it665) 0) (not bt765))))
  (and a!3
       (= (+ it664 (- 2)) 0)
       (or (or bt758 bt759 (not bt760)) a!5 (> it666 0) bt761)
       (or (or (or bt760 bt758) (not bt759)) a!7 bt761)
       a!9
       a!11
       (or (not bt758) (not bt760) (not bt759) a!13 bt761)
       (or (or (or bt760 bt758) bt759) a!14 bt761)
       (or (or bt758 bt759 (not bt760)) (<= it666 0) a!15 bt761)
       (or (not bt758) bt759 (not bt760) bt761 a!17)
       a!19
       a!20
       (or (or bt758 bt759 (not bt760)) (not bt761) a!18)
       a!21
       (or bt758 (not bt760) (not bt759) a!23 bt761)
       a!25
       (or (or (or bt760 bt758) bt759) (not bt761) a!26))))))
(check-sat)
