...
(assert (= (+ it147 (- 3)) 0))
(assert (= (+ it148 (- 1)) 0))
(assert (= (+ (* it108 (- 1)) it149) 0))
(assert (= (+ it150 (- 1)) 0))
(assert (= (+ it151 (- 1)) 0))
(assert (= (+ (* it108 (- 1)) it152) 0))
(assert (= (+ it153 (- 1)) 0))
(assert (and (>= (+ it152 (* it206 (- 1)) (* it151 (- 1)) 1) 0)
     (>= (+ it147 (- 3)) 0)
     (>= (+ it149 (* it206 (- 1)) (* it148 (- 1)) 1) 0)
     (>= (+ it206 (- 1)) 0)
     (>= (+ (* it147 (- 1)) 3) 0)))
(assert (= (+ (* it147 (- 1)) it207) 0))
(assert (= (+ it208 (* it206 (- 1)) (* it148 (- 1))) 0))
(assert (= (+ (* it149 (- 1)) it209) 0))
(assert (= (+ (* it150 (- 1)) it210) 0))
(assert (= (+ it211 (* it206 (- 1)) (* it151 (- 1))) 0))
(assert (= (+ (* it152 (- 1)) it212) 0))
(assert (= (+ (* it153 (- 1)) it213) 0))
(assert (and (< (+ (* it211 (- 1)) it212) 0)
     (= (+ it207 (- 3)) 0)
     (< (+ (* it208 (- 1)) it209) 0)))
(assert (= (+ it215 (- 2)) 0))
(assert (= it216 0))
(assert (= (+ (* it209 (- 1)) it217) 0))
(assert (= (+ it218 (* it210 (- 1))) 0))
(assert (= (+ it219 (- 1)) 0))
(assert (= (+ (* it212 (- 1)) it220) 0))
(assert (= (+ it221 (* it213 (- 1))) 0))
(assert (and (>= (+ it215 (- 2)) 0)
     (>= (+ (* it216 (- 1)) (* it229 (- 1)) it217 1) 0)
     (>= (+ (* it215 (- 1)) 2) 0)
     (>= (+ (* it219 (- 1)) (* it229 (- 1)) it220 1) 0)
     (>= (+ it229 (- 1)) 0)))
(assert (= (+ (* it215 (- 1)) it230) 0))
(assert (= (+ it231 (* it216 (- 1)) (* it229 (- 1))) 0))
...
(assert (= (+ (+ 0 (* it218 (- 1)))
      ...
      (* (+ 0 it229) (/ 1.0 2.0)))
   (+ 0 0)))
(assert (= (+ (* it219 (- 1)) (* it229 (- 1)) it234) 0))
...
(assert (= (+ (+ 0 (* it221 (- 1)))
      ...
      (* (+ 0 it229) (/ 1.0 2.0)))
   (+ 0 0)))
(assert (and (> (+ (* it235 (- 1)) it234) 0)
     (>= (+ (* it231 (- 1)) it232 (* it176 (- 1)) 1) 0)
     (>= (+ (* it230 (- 1)) 2) 0)
     (>= (+ it230 (- 2)) 0)
     (>= (+ it176 (- 1)) 0)))
(assert (= (+ it245 (* it230 (- 1))) 0))
(assert (= (+ (* it231 (- 1)) it246 (* it176 (- 1))) 0))
(assert (= (+ it247 (* it232 (- 1))) 0))
(assert (= (+ (+ 0 it248)
      (* (exp it176 2) (- (/ 1.0 2.0)))
      (+ 0 (* it233 (- 1)))
      (* (+ 0 it176) (/ 1.0 2.0))
...
(assert (= (+ it250 (* it235 (- 1))) 0))
(assert (= (+ it251 (* it236 (- 1))) 0))
(assert (and (= (+ it245 (- 2)) 0)
     (< (+ it247 (* it246 (- 1))) 0)
     (< (+ it250 (* it249 (- 1))) 0)))
(assert (= (+ it253 (- 4)) 0))
(assert (= (+ it254 (- 1)) 0))
(assert (= (+ (* it247 (- 1)) it255) 0))
(assert (= (+ (* it248 (- 1)) it256) 0))
(assert (= (+ it257 (- 1)) 0))
(assert (= (+ (* it250 (- 1)) it258) 0))
(assert (= (+ (* it251 (- 1)) it259) 0))
(assert (and (>= (+ (* it254 (- 1)) (* it267 (- 1)) it255 1) 0)
     (>= (+ (* it257 (- 1)) (* it267 (- 1)) it258 1) 0)
     (>= (+ it267 (- 1)) 0)
     (>= (+ it253 (- 4)) 0)
     (>= (+ (* it253 (- 1)) 4) 0)))
(assert (= (+ it268 (* it253 (- 1))) 0))
(assert (= (+ (* it254 (- 1)) (* it267 (- 1)) it269) 0))
(assert (= (+ it270 (* it255 (- 1))) 0))
(assert (= (+ (+ 0 it271) (* (exp 2 it267) (+ 0 it256) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* it257 (- 1)) (* it267 (- 1)) it272) 0))
(assert (= (+ it273 (* it258 (- 1))) 0))
(assert (= (+ (+ 0 it274) (* (exp 2 it267) (+ 0 it259) (+ 0 (- 1))))
   (+ 0 0)))
(assert (and (>= (+ it270 (* it269 (- 1))) 0)
     (= (+ it268 (- 4)) 0)
     (< (+ it273 (* it272 (- 1))) 0)))
(check-sat)
