...
(declare-fun bt1458 () Bool)
(declare-fun bt1459 () Bool)
(declare-fun bt1460 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1028 (- 2)) 0))
...
(assert (and (not bt1456)
     ...
     (not bt1455)))
(assert (= (+ it1342 (- 2)) 0))
(assert (= (+ (* it1337 (- 1)) it1343) 0))
(assert (= (+ it1344 (* it1338 (- 1))) 0))
(assert (= (+ it1345 (* it1339 (- 1))) 0))
(assert (or (and (not bt1457) (not bt1454)) (and bt1454 bt1457)))
(assert (or (and bt1458 bt1453) (and (not bt1458) (not bt1453))))
(assert (or (and bt1459 bt1455) (and (not bt1459) (not bt1455))))
(assert (or (and bt1456 bt1460) (and (not bt1460) (not bt1456))))
(assert (and (not bt1459) bt1460 bt1457 bt1458 (= (+ it1342 (- 2)) 0)))
(check-sat)
