...
(assert (or bt507
    ...
    (distinct (+ it447 (- 2)) 0)
    bt502
    (distinct (+ (* it452 (- 1)) it449) 0)
    (distinct (+ (* it451 (- 1)) it448) 0)
    (not bt504)
    bt506
    (not bt501)
    (distinct (+ (* it453 (- 1)) it450) 0)))
(assert (let ((a!1 (and bt505 (= (+ (* it453 (- 1)) it450) 0)))
      (a!4 (and (= (+ (* it453 (- 1)) it450) 0)
                (= (+ (* it451 (- 1)) it448) 0)
                (not bt508)))
      (a!7 (and (= (+ (* it453 (- 1)) it450) 0)
                (not bt508)
                (not bt507)
                (= (+ it451 (- 1)) 0)
                (not bt505)
      ...
      (a!11 (and bt507
                 ...
                 (= (+ (* it451 (- 1)) it448) 0)
                 (not bt508)))
      (a!13 (and (= (+ (* it453 (- 1)) it450) 0)
                 bt508
                 (= (+ (* it451 (- 1)) it448) 0)))
      (a!18 (and bt507 bt505 (= (+ (* it453 (- 1)) it450) 0)))
      (a!20 (and (= (+ (* it451 (- 1)) (* it448 3)) 0)
                 bt507
                 bt505
                 (= (+ (* it453 (- 1)) it450) 0)
                 (not bt508)
                 bt506
                 (= (+ (* it452 (- 1)) it449) 0))))
(let ((a!2 (and a!1 bt508 (= (+ (* it451 (- 1)) it448) 0)))
      (a!5 (and a!4
                (not bt506)
                (not bt507)
                (not bt505)
      ...
      (a!10 (and a!4
                 ...
                 bt506
                 (= (+ (* it452 (- 1)) it449) 0)))
      (a!12 (and a!11 (not bt505) bt506 (= (+ (* it452 (- 1)) it449) 0)))
      (a!14 (and a!13
                 (not bt507)
                 (not bt505)
                 bt506
      ...
      (a!15 (and a!13
                 ...
                 (not bt505)
                 (= (+ (* it452 (- 1)) it449) 0)))
      (a!17 (and a!11 (not bt506) (not bt505) (= (+ (* it452 (- 1)) it449) 0)))
      (a!19 (and a!18
                 (not bt508)
                 (not bt506)
                 (= (+ (* it452 (- 1)) it449) 0)
      ...
      (a!21 (and a!18
                 ...
                 (not bt506)
                 (= (+ (* it452 (- 1)) it449) 0))))
(let ((a!3 (and a!2 (not bt507) bt506 (= (+ (* it452 (- 1)) it449) 0)))
      (a!6 (and a!2 (not bt506) (not bt507) (= (+ (* it452 (- 1)) it449) 0)))
      (a!9 (or (<= (+ it450 (* it448 (- 1))) 0)
               bt502
               (not bt501)
               a!8
               bt504
               bt503))
      (a!16 (or (or bt502 (not bt501))
                bt504
                bt503
                a!15
                (> (+ it450 (* it448 (- 1))) 0))))
  (and (or a!3 (not bt501) (not bt504) bt503 (not bt502))
       (or (or bt502 (not bt501)) (not bt504) a!5 bt503)
       (or (or bt501 bt502) (<= it448 0) (not bt504) bt503 a!6)
       (or bt501 a!3 bt502 (> it448 0) (not bt504) bt503)
       (or bt501 bt504 bt503 (not bt502) a!7)
       a!9
       (or (or bt501 (not bt503)) bt504 a!10 (not bt502))
       (or (not bt501) a!12 bt504 bt503 (not bt502) (> it449 0))
       (or (or bt501 bt502) a!5 bt504 bt503)
       (or bt501 (not bt504) bt503 (not bt502) a!14)
       a!16
       (or (not bt501) (<= it449 0) a!17 bt504 bt503 (not bt502))
       (or (or bt501 (not bt503)) bt502 a!19 bt504)
       (= (+ it447 (- 2)) 0)
       (or (not bt503) a!20 bt502 (not bt501) bt504)
       (or (not bt503) a!21 (not bt501) bt504 (not bt502)))))))
(check-sat)
