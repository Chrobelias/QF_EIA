...
(assert (or bt510
    ...
    bt509
    (distinct (+ it455 (- 2)) 0)
    (distinct (+ it458 (* it461 (- 1))) 0)
    (distinct (+ it456 (* it459 (- 1))) 0)
    (distinct (+ (* it460 (- 1)) it457) 0)
    bt512
    bt513
    bt515
    bt516
    bt514))
(assert (let ((a!1 (and (= (+ it456 (* it459 (- 1))) 0)
                (not bt515)
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!4 (and (= (+ it456 (* it459 (- 1))) 0) (not bt513)))
      (a!7 (and (= (+ it456 (* it459 (- 1))) 0)
                (= (+ (* it460 (- 1)) it457) 0)
                (not bt516)
                bt513
                (= (+ it458 (* it461 (- 1))) 0)
      ...
      (a!14 (and (= (+ (* it460 (- 1)) it457) 0)
                 ...
                 bt515
                 (not bt514))))
(let ((a!2 (and a!1 bt513 (= (+ it458 (* it461 (- 1))) 0) bt516))
      (a!5 (and a!4 (not bt515) (= (+ (* it460 (- 1)) it457) 0)))
      (a!8 (and a!1 (not bt516) bt513 (= (+ it458 (* it461 (- 1))) 0) bt514))
      (a!10 (and a!4
                 (= (+ (* it460 (- 1)) it457) 0)
                 (not bt516)
                 (= (+ it458 (* it461 (- 1))) 0)
                 bt515)))
(let ((a!3 (or (or (or (or bt510 bt511) bt509) (not bt512))
               (and a!2 (not bt514))
               (<= it456 0)))
      (a!6 (and a!5 (not bt516) (= (+ it458 (* it461 (- 1))) 0)))
      (a!9 (or (or bt510 bt511)
               a!8
               (<= (+ (* it456 (- 1)) it458) 0)
               (not bt509)
               bt512))
      (a!13 (and a!5 (= (+ it458 (* it461 (- 1))) 0) bt516))
      (a!16 (or (or (or (or bt510 bt511) bt509) (not bt512))
                (and a!2 bt514)
                (> it456 0))))
(let ((a!15 (or (or bt510 bt511)
                (not bt509)
                bt512
                (> (+ (* it456 (- 1)) it458) 0)
                (and a!13 (not bt514)))))
  (and a!3
       (or (and a!6 bt514) bt509 (not bt510) (not bt511) bt512)
       (or (or (or bt510 bt511) bt509) bt512 (and a!6 (not bt514)))
       (or (not bt510) (not bt511) (not bt509) bt512 a!7)
       (or (or bt510 bt511) (not bt512) (not bt509) (and a!6 (not bt514)))
       (or (or bt511 (not bt510)) (not bt512) (not bt509) (and a!2 bt514))
       a!9
       (or (or bt511 (not bt510))
           (<= it457 0)
           (and a!10 (not bt514))
           (not bt509)
           bt512)
       (or bt510 (not bt511) (not bt509) a!11 bt512)
       (or (or bt511 bt509 (not bt510)) bt512 a!12)
       (or (or bt511 bt509 (not bt510)) (not bt512) (and a!13 bt514))
       (or bt511 (and a!10 bt514) (not bt510) (> it457 0) (not bt509) bt512)
       (or bt510 bt509 (not bt511) bt512 a!14)
       a!15
       (= (+ it455 (- 2)) 0)
       a!16))))))
(check-sat)
