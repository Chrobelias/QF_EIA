...
(assert (let ((a!1 (and bt1439 (= (+ (* it1325 (- 1)) it1322) 0)))
      (a!4 (and (= (+ (* it1325 (- 1)) it1322) 0)
                (not bt1439)
                (= (+ it1321 (* it1324 (- 1))) 0)))
      (a!8 (and (= (+ (* it1325 (- 1)) it1322) 0)
                (not bt1438)
                (not bt1439)
                (= (+ it1321 (* it1324 (- 1))) 0))))
(let ((a!2 (and a!1 (not bt1438) (= (+ it1321 (* it1324 (- 1))) 0)))
      (a!5 (or bt1433
               (and a!4 (= (+ it1323 (- 1)) 0) bt1438 (not bt1437) (not bt1440))
               (not bt1434)
               bt1435
               bt1436))
      (a!6 (and (and a!4 bt1438)
                bt1440
                (not bt1437)
                (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!7 (and (and a!4 bt1437 bt1438)
                bt1440
                (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!9 (and a!8 (not bt1437) (not bt1440) (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!10 (and a!1
                 (= (+ it1321 (* it1324 (- 1))) 0)
                 bt1438
                 (not bt1437)
                 (not bt1440)
                 (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!11 (and a!8 bt1440 (not bt1437) (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!13 (and a!8 bt1437 bt1440 (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!14 (and (and a!4 bt1437 bt1438)
                 (not bt1440)
                 (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!17 (and a!1
                 (= (+ (* it1323 (- 1)) (* it1320 3)) 0)
                 ...
                 bt1438
                 (not bt1440)))
      (a!18 (and (and a!4 bt1438)
                 (not bt1437)
                 (not bt1440)
                 (= (+ (* it1323 (- 1)) it1320) 0))))
(let ((a!3 (and (and a!2 bt1437 (not bt1440)) (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!12 (or a!11
                (> (+ it1322 (* it1320 (- 1))) 0)
                (not bt1433)
                bt1435
      ...
      (a!16 (and a!2
                 ...
                 (not bt1440)
                 (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!19 (and (and a!2 bt1437 (not bt1440))
                 (= (+ (* it1323 (- 1)) (* it1320 2)) 0))))
  (and (or a!3 (not bt1433) (not bt1435) (not bt1434) bt1436)
       a!5
       (or (or bt1433 (not bt1436)) a!6 (not bt1434) bt1435)
       (or (or bt1433 (not bt1436)) (> it1320 0) bt1435 bt1434 a!7)
       (or (or (not bt1436) (not bt1433)) a!9 bt1435 bt1434)
       (or (> it1321 0) (not bt1433) (not bt1434) bt1435 a!10 bt1436)
       (or bt1433 a!9 bt1435 bt1434 bt1436)
       a!12
       (or (or bt1433 (not bt1436)) (<= it1320 0) a!13 bt1435 bt1434)
       a!15
       (or (not bt1433) (not bt1434) bt1435 bt1436 (<= it1321 0) a!16)
       (or (not bt1433) a!17 (not bt1435) bt1434 bt1436)
       (= (+ it1319 (- 2)) 0)
       (or (or (not bt1436) (not bt1433)) (not bt1434) bt1435 a!7)
       (or bt1433 a!18 (not bt1435) (not bt1434) bt1436)
       (or bt1433 a!19 (not bt1435) bt1434 bt1436))))))
(check-sat)
