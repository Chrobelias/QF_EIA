...
(assert (and (not bt517)
     ...
     (not bt518)))
(assert (= (+ it526 (- 2)) 0))
(assert (= (+ (* it466 (- 1)) it527) 0))
(assert (= (+ (* it467 (- 1)) it528) 0))
(assert (= (+ it529 (* it468 (- 1))) 0))
(assert (or (and bt601 bt522) (and (not bt522) (not bt601))))
(assert (or (and (not bt521) (not bt602)) (and bt602 bt521)))
(assert (or (and bt603 bt523) (and (not bt603) (not bt523))))
(assert (or (and (not bt524) (not bt604)) (and bt524 bt604)))
(assert (and bt602 (not bt603) bt604 bt601 (= (+ it526 (- 2)) 0)))
(check-sat)
