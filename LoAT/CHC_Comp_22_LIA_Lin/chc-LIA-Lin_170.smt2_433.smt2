...
(assert (or (distinct (+ it1387 (* it1390 (- 1))) 0)
    bt1497
    bt1501
    bt1503
    bt1499
    (distinct (+ (* it1389 (- 1)) it1386) 0)
    bt1498
    bt1500
    (distinct (+ it1385 (- 2)) 0)
    (distinct (+ (* it1391 (- 1)) it1388) 0)
    bt1504
    bt1502))
(assert (let ((a!1 (and (not bt1503) (= (+ (* it1389 (- 1)) it1386) 0)))
      (a!4 (and (not bt1502) (not bt1503) (= (+ (* it1389 (- 1)) it1386) 0)))
      (a!8 (and bt1501 (not bt1503) (= (+ (* it1389 (- 1)) it1386) 0)))
      (a!11 (and (= (+ (* it1389 (- 1)) (* it1386 3)) 0)
                 bt1501
                 bt1503
                 (not bt1504)
                 (= (+ (* it1391 (- 1)) it1388) 0)
...
(let ((a!2 (and a!1
      ...
      (a!12 (and a!8
                 ...
                 bt1504
                 bt1502)))
(let ((a!7 (or (> (+ it1388 (* it1386 (- 1))) 0)
               a!6
               bt1499
               bt1498
               bt1500
               (not bt1497)))
      (a!10 (or (<= (+ it1388 (* it1386 (- 1))) 0)
                a!9
                bt1499
                bt1498
                bt1500
                (not bt1497))))
  (and (or bt1497 a!2 (not bt1500) bt1499 (not bt1498))
       (or bt1497 a!3 (not bt1499) (not bt1498) bt1500)
       (or a!5 (not bt1500) bt1499 bt1498 (not bt1497))
       a!7
       a!10
       (or a!11 (not bt1499) bt1498 bt1500 (not bt1497))
       (or bt1497 a!5 bt1499 bt1498 bt1500)
       (or bt1497 a!12 (not bt1500) bt1499 (> it1386 0) bt1498)
       (or (not bt1499) (not bt1498) bt1500 a!13 (not bt1497))
       (= (+ it1385 (- 2)) 0)
       (or bt1497 (not bt1499) a!14 bt1498 bt1500)
       (or a!15 bt1499 (not bt1498) bt1500 (not bt1497) (> it1387 0))
       (or a!12 (not bt1500) bt1499 (not bt1498) (not bt1497))
       (or bt1497 (not bt1500) bt1499 (<= it1386 0) a!16 bt1498)
       (or (<= it1387 0) bt1499 (not bt1498) a!17 bt1500 (not bt1497))
       (or bt1497 bt1499 a!18 (not bt1498) bt1500))))))
(check-sat)
