...
(assert (let ((a!1 (and (= (+ it1327 (* it1330 (- 1))) 0)
                (= (+ (* it1332 (- 1)) it1329) 0)
                (= (+ it1328 (* it1331 (- 1))) 0)))
      (a!5 (and (= (+ (* it1332 (- 1)) it1329) 0)
                (= (+ it1328 (* it1331 (- 1))) 0)))
      (a!10 (and (= (+ (* it1332 (- 1)) it1329) 0)
                 (= (+ (* it1327 3) (* it1330 (- 1))) 0)
                 (= (+ it1328 (* it1331 (- 1))) 0)
                 bt1447
                 bt1446
                 (not bt1448)
                 bt1445)))
(let ((a!2 (and (and (and a!1 bt1448 (not bt1447)) (not bt1446)) (not bt1445)))
      (a!4 (and (and (and a!1 bt1448 (not bt1447)) (not bt1446)) bt1445))
      (a!6 (or (and a!5
                    (not bt1447)
                    bt1446
                    (= (+ it1330 (- 1)) 0)
      ...
      (a!7 (and a!5
                ...
                (not bt1448)
                bt1445))
      (a!8 (and (and a!1 (not bt1447)) (not bt1446) (not bt1445) (not bt1448)))
      (a!9 (and (and (and a!1 bt1448 (not bt1447)) bt1446) (not bt1445)))
      (a!11 (or (<= it1328 0)
                (not bt1442)
                (not bt1441)
                (and (and (and a!1 bt1447) (not bt1446))
                     (not bt1445)
                     (not bt1448))
                bt1443
                bt1444))
      (a!12 (and (and (and a!1 (not bt1447)) bt1446) (not bt1445) (not bt1448)))
      (a!13 (and (and (and a!1 bt1448 (not bt1447)) bt1446) bt1445))
      (a!14 (or (and (and (and a!1 bt1447) (not bt1446)) (not bt1448) bt1445)
                (not bt1443)
                (not bt1442)
                (not bt1441)
                bt1444))
      (a!15 (and (and (and a!1 (not bt1447)) bt1446) (not bt1448) bt1445)))
(let ((a!3 (or a!2
               (> (+ it1329 (* it1327 (- 1))) 0)
               (not bt1441)
               bt1442
      ...
      (a!16 (or a!15
                ...
                (<= (+ it1329 (* it1327 (- 1))) 0))))
  (and a!3
       (or (<= it1327 0) (not bt1444) bt1441 bt1442 a!4 bt1443)
       (or (and (and a!1 bt1447) bt1446 (not bt1445) (not bt1448))
           (not bt1442)
           (not bt1441)
           (> it1328 0)
           bt1443
           bt1444)
       a!6
       (or (not bt1443) bt1441 a!7 bt1442 bt1444)
       (or a!8 (not bt1444) (not bt1441) bt1442 bt1443)
       (or (or (not bt1444) (not bt1442)) bt1441 bt1443 a!9)
       (or (not bt1443) a!10 (not bt1441) bt1442 bt1444)
       a!11
       (or (not bt1443) (not bt1442) bt1441 a!12 bt1444)
       (or (not bt1444) a!13 bt1441 bt1442 bt1443 (> it1327 0))
       a!14
       a!16
       (or a!8 bt1441 bt1442 bt1443 bt1444)
       (= (+ it1326 (- 2)) 0)
       (or (or (not bt1444) (not bt1442)) a!13 (not bt1441) bt1443))))))
(check-sat)
