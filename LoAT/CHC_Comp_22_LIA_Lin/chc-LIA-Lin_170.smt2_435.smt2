...
(assert (or bt1495
    bt1489
    bt1496
    (distinct (+ (* it1383 (- 1)) it1380) 0)
    (distinct (+ it1378 (- 2)) 0)
    bt1491
    (distinct (+ (* it1384 (- 1)) it1381) 0)
    bt1494
    bt1493
    (distinct (+ (* it1382 (- 1)) it1379) 0)
    bt1490
    bt1492))
(assert (let ((a!1 (and (= (+ (* it1384 (- 1)) it1381) 0)
                (not bt1494)
                (not bt1496)
                (= (+ (* it1383 (- 1)) it1380) 0)
                (not bt1493)
                (= (+ (* it1382 (- 1)) it1379) 0)
                (not bt1495)))
      (a!2 (and bt1496 (= (+ (* it1384 (- 1)) it1381) 0)))
      (a!5 (and bt1495 (= (+ (* it1384 (- 1)) it1381) 0)))
      (a!14 (and (= (+ (* it1384 (- 1)) it1381) 0)
                 (not bt1496)
                 (= (+ (* it1383 (- 1)) it1380) 0)
                 bt1494))
      (a!18 (and bt1495
                 ...
                 (= (+ (* it1383 (- 1)) it1380) 0)
                 bt1493)))
(let ((a!3 (and a!2 (= (+ (* it1383 (- 1)) it1380) 0) bt1494))
      (a!6 (and a!5 (not bt1494) (not bt1496) (= (+ (* it1383 (- 1)) it1380) 0)))
      (a!8 (and a!2 (not bt1494) (= (+ (* it1383 (- 1)) it1380) 0)))
      (a!13 (and (and a!5 (not bt1496))
                 (= (+ (* it1383 (- 1)) it1380) 0)
                 bt1494
                 (not bt1493)
                 (= (+ (* it1382 (- 1)) it1379) 0)))
      (a!15 (and (and a!14 (not bt1493))
                 (= (+ (* it1382 (- 1)) it1379) 0)
                 (not bt1495)))
      (a!16 (or bt1489
                (not bt1490)
                bt1491
                (and (and a!14 (not bt1493))
                     (= (+ it1382 (- 1)) 0)
                     (not bt1495))
                bt1492))
      (a!17 (and (and a!5 (not bt1496))
                 (= (+ (* it1382 (- 1)) (* it1379 3)) 0)
                 (= (+ (* it1383 (- 1)) it1380) 0)
                 bt1494
                 bt1493))
      (a!19 (and a!14 bt1493 (= (+ (* it1382 (- 1)) it1379) 0) (not bt1495))))
(let ((a!4 (and a!3 bt1493 (= (+ (* it1382 (- 1)) it1379) 0) (not bt1495)))
      (a!7 (and a!6 bt1493 (= (+ (* it1382 (- 1)) it1379) 0)))
      (a!9 (and a!8 (not bt1493) (= (+ (* it1382 (- 1)) it1379) 0) (not bt1495)))
      (a!11 (and a!6 (not bt1493) (= (+ (* it1382 (- 1)) it1379) 0)))
      (a!12 (and a!8 bt1493 (= (+ (* it1382 (- 1)) it1379) 0) (not bt1495)))
      (a!20 (or (or (not bt1489) bt1491)
                (<= (+ it1381 (* it1379 (- 1))) 0)
                a!19
                bt1490
                bt1492))
      (a!21 (and a!3
                 ...
                 (= (+ (* it1382 (- 1)) it1379) 0)
                 (not bt1495))))
(let ((a!10 (or (or (not bt1489) bt1491)
                (> (+ it1381 (* it1379 (- 1))) 0)
                bt1490
                bt1492
                a!9)))
  (and (or (or (not bt1489) (not bt1492)) bt1491 a!1 bt1490)
       (or (or (not bt1489) (not bt1492)) (not bt1490) a!4 bt1491)
       (or (or bt1489 (not bt1492)) a!4 bt1491 (> it1379 0) bt1490)
       (or bt1489 bt1491 a!1 bt1490 bt1492)
       (or a!7 (not bt1491) (not bt1489) (not bt1490) bt1492)
       a!10
       (or (<= it1380 0) (not bt1489) (not bt1490) bt1491 a!11 bt1492)
       (or (or bt1489 (not bt1492)) (<= it1379 0) bt1491 a!12 bt1490)
       (= (+ it1378 (- 2)) 0)
       (or (> it1380 0) (not bt1489) (not bt1490) bt1491 a!13 bt1492)
       (or (not bt1491) bt1489 a!15 (not bt1490) bt1492)
       a!16
       (or (not bt1491) (not bt1489) a!17 bt1490 bt1492)
       (or (not bt1491) a!18 bt1489 bt1490 bt1492)
       a!20
       (or (or bt1489 (not bt1492)) (not bt1490) bt1491 a!21)))))))
(check-sat)
