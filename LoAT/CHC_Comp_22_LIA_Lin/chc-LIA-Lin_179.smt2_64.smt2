...
(assert (let ((a!1 (and (not bt749)
      ...
      (a!3 (and (not bt749)
                ...
                bt747
                (not bt746)))
      (a!4 (and (= (+ (* it654 (- 1)) it651) 0) (= (+ (* it656 (- 1)) it653) 0)))
      (a!7 (and (not bt749) (= (+ (* it656 (- 1)) it653) 0)))
      (a!17 (= (+ (+ (* it655 (- 1)) it652) (- 1)) 0)))
(let ((a!2 (and (and a!1 bt748)
                bt747
                (= (+ (* it655 (- 1)) it652) 0)
                (not bt746)))
      (a!5 (and (and a!4 bt749)
                bt747
                (= (+ (* it655 (- 1)) it652) 0)
                (not bt748)
                (not bt746)))
      (a!8 (and a!7
                ...
                (= (+ (* it655 (- 1)) it652) 0)
                (= (+ (* it654 (- 1)) (* it651 2)) 0)))
      (a!9 (and (and a!4 bt749)
                bt746
                (= (+ (* it655 (- 1)) it652) 0)
                (not bt748)
                (not bt747)))
      (a!10 (and (and a!4 bt748 bt749)
                 bt747
                 (= (+ (* it655 (- 1)) it652) 0)
                 (not bt746)))
      (a!11 (and a!1
                 ...
                 (not bt746)
                 (not bt747)))
      (a!12 (and (and a!1 bt746)
                 (= (+ (* it655 (- 1)) it652) 0)
                 (not bt748)
                 (not bt747)))
      (a!13 (and (and a!1 bt746)
                 bt747
                 (= (+ (* it655 (- 1)) it652) 0)
                 (not bt748)))
      (a!14 (and a!7
                 ...
                 (not bt746)
                 (not bt747)))
      (a!15 (and (and a!4 bt749)
                 (= (+ (* it655 (- 1)) it652) 0)
                 (not bt748)
                 (not bt746)
                 (not bt747)))
      (a!18 (and (and a!4 bt748 bt749)
                 (= (+ (* it655 (- 1)) it652) 0)
                 (not bt746)
                 (not bt747))))
(let ((a!6 (or (or bt744 bt745 (not bt742))
               a!5
               (not bt743)
               (> (+ it653 (* it651 (- 1))) 0)))
      (a!16 (or (or bt744 bt745 (not bt742))
                (not bt743)
                (<= (+ it653 (* it651 (- 1))) 0)
                a!12)))
  (and (or (or (or bt742 bt743) bt744) (not bt745) a!2)
       (or (or bt743 bt744) bt745 (not bt742) a!3)
       a!6
       (or bt743 bt745 (not bt742) (not bt744) a!8)
       (or (or (or bt742 bt744) (not bt745)) a!9 (not bt743) (> it651 0))
       (or (or bt743 bt744) (not bt742) (not bt745) a!10)
       (or bt744 (not bt742) (not bt745) (not bt743) a!11)
       (or bt745 (not bt742) (not bt743) (not bt744) a!12)
       (or (or (or bt742 bt743) bt744) bt745 a!11)
       (or (or bt742 bt743) bt745 (<= it652 0) (not bt744) a!13)
       (or (or bt742 bt744) bt745 (not bt743) a!14)
       (or (> it652 0) bt742 bt743 bt745 a!15 (not bt744))
       (= (+ it650 (- 2)) 0)
       a!16
       (or bt742
           bt745
           (not bt743)
           (not bt744)
           (and (and a!1 bt748) bt746 (not bt747) a!17))
       (or (or bt742 bt743) (not bt745) a!9 (not bt744))
       (or (or (or bt742 bt744) (not bt745)) (<= it651 0) (not bt743) a!18))))))
(check-sat)
