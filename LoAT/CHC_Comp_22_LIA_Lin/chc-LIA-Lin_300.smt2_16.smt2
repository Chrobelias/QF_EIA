...
(assert (and (>= (+ (* it162 (- 1)) (* it172 (- 1)) it163 1) 0)
...
(assert (let ((a!1 (+ (+ 0 (+ (* it164 (- 1)) (* it162 it172 (- 1)) it179))
              ...
              (* (exp it172 2) (- (/ 1.0 2.0))))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ (* it125 (- 1)) (* it174 (- 1)) it175 1) 0)
     (>= (+ it173 (- 2)) 0)
     (>= (+ it125 (- 1)) 0)
     (> (+ it177 (* it178 (- 1))) 0)
     (>= (+ (* it173 (- 1)) 2) 0)))
(assert (= (+ (* it173 (- 1)) it181) 0))
(assert (= (+ it182 (* it125 (- 1)) (* it174 (- 1))) 0))
(assert (= (+ it183 (* it175 (- 1))) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it176 (- 1)) (* it125 it174 (- 1))))
              (* (+ 0 it125) (/ 1.0 2.0))
              (* (exp it125 2) (- (/ 1.0 2.0)))
              (+ 0 it184))))
  (= a!1 (+ 0 0))))
(assert (= (+ it185 (* it177 (- 1))) 0))
(assert (= (+ it186 (* it178 (- 1))) 0))
(assert (= (+ (* it179 (- 1)) it187) 0))
(assert (let ((a!1 (or (< (+ (* it187 (- 1)) it184) 0) (> (+ (* it187 (- 1)) it184) 0))))
  (and (= (+ it181 (- 2)) 0)
       (< (+ (* it185 (- 1)) it186) 0)
       (< (+ (* it182 (- 1)) it183) 0)
       a!1)))
