...
(assert (or (distinct (+ it1045 (- 2)) 0)
    ...
    bt1166
    (not bt1165)))
(assert (let ((a!1 (and (= (+ it1048 (* it1042 (- 1))) 0) bt1162))
      (a!3 (and (= (+ it1048 (* it1042 (- 1))) 0)
                (= (+ it1047 (* it1041 (- 1))) 0)
                (not bt1163)
                (not bt1161)
                (= (+ it1046 (* it1040 (- 1))) 0)
                (not bt1162)
                (not bt1164)))
      (a!4 (and (= (+ it1048 (* it1042 (- 1))) 0) bt1163))
      (a!6 (and (= (+ it1048 (* it1042 (- 1))) 0) bt1164))
      (a!9 (and (= (+ (* it1046 2) (* it1040 (- 1))) 0)
                (= (+ it1048 (* it1042 (- 1))) 0)
                bt1163
                bt1161
                (= (+ it1047 (* it1041 (- 1))) 0)
...
(let ((a!8 (or (or bt1167 bt1168)
               ...
               bt1166
               a!7))
      (a!11 (or (<= (+ (* it1046 (- 1)) it1048) 0)
                bt1167
                bt1168
                a!10
                (not bt1165)
                bt1166)))
  (and (or (> it1047 0) bt1167 bt1168 a!2 (not bt1166) (not bt1165))
       (or (or (or bt1165 bt1167) bt1168) a!3 bt1166)
       (or (or bt1167 bt1168) (not bt1166) (not bt1165) (<= it1047 0) a!5)
       a!8
       (or (or bt1165 bt1168 (not bt1167)) a!9 bt1166)
       a!11
       (or (or bt1165 bt1167) a!12 (not bt1168) (not bt1166))
       (or (or (or bt1165 bt1167) bt1168) a!13 (not bt1166))
       (or bt1167 a!3 (not bt1168) (not bt1165) bt1166)
       (or (or bt1168 (not bt1167)) a!14 (not bt1166) (not bt1165))
       (or bt1167 a!15 (not bt1168) (not bt1166) (not bt1165))
       (= (+ it1045 (- 2)) 0)
       (or (or bt1165 bt1168 (not bt1167)) a!16 (not bt1166))
       (or (or bt1168 (not bt1167)) a!17 (not bt1165) bt1166)
       (or (or bt1165 bt1167) a!18 (not bt1168) bt1166 (<= it1046 0))
       (or (or bt1165 bt1167) a!15 (not bt1168) bt1166 (> it1046 0)))))))
(check-sat)
