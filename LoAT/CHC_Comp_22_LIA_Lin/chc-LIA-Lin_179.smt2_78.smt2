...
(assert (or (not bt760)
    (distinct (+ (* it670 (- 1)) it667) 0)
    (not bt758)
    bt763
    bt764
    bt765
    (distinct (+ (* it669 (- 1)) it666) 0)
    (distinct (+ it664 (- 2)) 0)
    (not bt762)
    (not bt759)
    (distinct (+ (* it668 (- 1)) it665) 0)))
(assert (let ((a!1 (and (and (and (not bt762) bt763) bt764)
                (not bt765)
                (= (+ (* it670 (- 1)) it667) 0)
                (= (+ (* it668 (- 1)) it665) 0)))
      (a!3 (and bt762
      ...
      (a!5 (and bt765
                ...
                (not bt763)
                (= (+ (* it669 (- 1)) it666) 0)))
      (a!7 (and (and (not bt762) bt764)
                bt765
                (= (+ (* it670 (- 1)) it667) 0)
                (= (+ (* it668 (- 1)) it665) 0)
                (not bt763)
                (= (+ (* it669 (- 1)) it666) 0)))
      (a!8 (and (and (not bt762) bt763)
                bt765
                (not bt764)
                (= (+ (* it670 (- 1)) it667) 0)
                (= (+ (* it668 (- 1)) it665) 0)
      ...
      (a!12 (and bt763
                 ...
                 (= (+ (* it668 (- 1)) it665) 0)
                 (= (+ (* it669 (- 1)) it666) 0)))
      (a!13 (= (+ (+ (* it669 (- 1)) it666) (- 1)) 0))
      (a!15 (and (and (and (not bt762) bt763) bt764)
                 bt765
                 (= (+ (* it670 (- 1)) it667) 0)
                 (= (+ (* it668 (- 1)) it665) 0)
                 (= (+ (* it669 (- 1)) it666) 0)))
      (a!17 (and (and (not bt762) bt764)
                 (not bt765)
                 (= (+ (* it670 (- 1)) it667) 0)
                 (not bt763)
                 (= (+ (* it669 (- 1)) it666) 0)
      ...
      (a!19 (and bt763
                 ...
                 (= (+ (* it670 (- 1)) it667) 0)
                 (= (+ (* it669 (- 1)) it666) 0))))
(let ((a!2 (and a!1 (= (+ (* it669 (- 1)) it666) 0)))
      (a!4 (or (or bt760 (not bt758))
               a!3
               (not bt759)
               (<= (+ (* it665 (- 1)) it667) 0)
               bt761))
      (a!6 (or (or (or bt760 (not bt758)) bt759)
               bt761
               (and a!1 (= (+ it669 (- 10)) 0))))
      (a!9 (or (or (or bt760 (not bt758)) (not bt759))
               (> (+ (* it665 (- 1)) it667) 0)
               a!8
               bt761))
      (a!11 (or (or (or bt760 (not bt758)) (not bt759)) (not bt761) a!10))
      (a!14 (and bt764
                 bt762
                 (not bt765)
                 a!13
                 ...
                 (= (+ (* it668 (- 1)) it665) 0)
                 (not bt763)))
      (a!16 (or (or (or bt760 (not bt758)) bt759) a!15 (not bt761))))
  (and (or (or (or bt760 bt758) bt759) (not bt761) a!2)
       a!4
       (or (or (or bt760 bt758) (not bt759)) (not bt761) (> it665 0) a!5)
       a!6
       (= (+ it664 (- 2)) 0)
       (or (or (or bt760 bt758) (not bt759)) a!7 (not bt761) (<= it665 0))
       a!9
       (or (or (or bt760 bt758) bt759) a!10 bt761)
       (or (or bt758 bt759 (not bt760)) (not bt761) a!5)
       a!11
       (or (or bt758 bt759 (not bt760)) (<= it666 0) bt761 a!12)
       (or (not bt758) a!3 (not bt759) (not bt760) bt761)
       (or bt758 (not bt759) (not bt760) bt761 a!14)
       a!16
       (or (or (or bt760 bt758) (not bt759)) bt761 a!17)
       (or (or bt758 bt759 (not bt760)) (> it666 0) bt761 a!18)
       (or (not bt758) bt759 (not bt760) a!19 bt761)))))
(check-sat)
