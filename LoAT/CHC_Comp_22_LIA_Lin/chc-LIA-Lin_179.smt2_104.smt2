...
(assert (or (not bt988)
    (distinct (+ (* it863 (- 1)) it860) 0)
    bt991
    (not bt990)
    (not bt986)
    (not bt987)
    (distinct (+ it858 (- 2)) 0)
    (distinct (+ (* it864 (- 1)) it861) 0)
    bt992
    bt993
    (distinct (+ (* it862 (- 1)) it859) 0)))
(assert (let ((a!1 (and (= (+ (* it862 (- 1)) it859) 0) (= (+ (* it864 (- 1)) it861) 0)))
      (a!3 (and (= (+ it863 (- 10)) 0)
                (not bt993)
                (= (+ (* it862 (- 1)) it859) 0)
                (= (+ (* it864 (- 1)) it861) 0)
...
(let ((a!2 (and a!1
      ...
      (a!6 (and a!5
                ...
                (not bt992)
                (not bt990)))
      (a!7 (and a!5 bt991 bt992 (= (+ (* it863 (- 1)) it860) 0) (not bt990)))
      (a!8 (and (and a!5 bt990)
                (not bt991)
                (= (+ (* it863 (- 1)) it860) 0)
                (not bt992)))
      (a!11 (and (and a!1 bt991)
                 bt992
                 bt993
                 (= (+ (* it863 (- 1)) it860) 0)
                 (not bt990)))
      (a!12 (and (and a!1 (not bt991))
                 bt993
                 (= (+ (* it863 (- 1)) it860) 0)
                 (not bt992)
                 (not bt990)))
      (a!14 (and (and a!5 bt990)
                 bt991
                 (= (+ (* it863 (- 1)) it860) 0)
                 (not bt992)))
      (a!15 (and (and a!1 bt991)
                 bt993
                 (= (+ (* it863 (- 1)) it860) 0)
                 (not bt992)
                 (not bt990)))
      (a!17 (and (and a!1 (not bt991))
                 bt992
                 bt993
                 (= (+ (* it863 (- 1)) it860) 0)
                 (not bt990))))
(let ((a!10 (or (or bt988 bt989)
                (<= (+ it861 (* it859 (- 1))) 0)
                (not bt987)
                (not bt986)
                a!8))
      (a!16 (or (or (or bt988 bt989) (not bt987))
                (> (+ it861 (* it859 (- 1))) 0)
                a!15
                (not bt986))))
  (and (or bt987 a!2 (not bt988) (not bt989) bt986)
       (or (or (or bt988 bt989) bt987) (not bt986) a!3)
       (or (or (or bt988 bt989) (not bt987)) bt986 a!4)
       (or (or (or bt988 bt989) bt987) a!6 bt986)
       (or (or bt988 bt987 (not bt989)) bt986 a!7)
       (or (or bt989 (not bt988) (not bt987)) (not bt986) a!8)
       (or bt988 a!6 (not bt989) (not bt987) (not bt986))
       (or (or bt989 bt987) a!9 (not bt988) (not bt986))
       a!10
       (or (or bt988 bt987 (not bt989)) a!11 (not bt986))
       (or (or bt989 bt987) (not bt988) (> it860 0) bt986 a!12)
       (or bt988 a!2 (not bt989) (not bt987) bt986 (> it859 0))
       (or (or bt989 (not bt988) (not bt987))
           bt986
           (and (and a!5 bt990) a!13 (not bt991) bt992))
       (or (or bt989 bt987) (<= it860 0) a!14 (not bt988) bt986)
       (= (+ it858 (- 2)) 0)
       a!16
       (or bt988 (not bt989) (not bt987) (<= it859 0) bt986 a!17))))))
(check-sat)
