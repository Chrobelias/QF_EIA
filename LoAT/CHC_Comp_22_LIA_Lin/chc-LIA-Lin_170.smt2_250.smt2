...
(assert (let ((a!1 (and (and (not bt1069) (not bt1070))
                (not bt1072)
                (= (+ (* it960 (- 1)) it957) 0)))
      (a!3 (and (and (and bt1070 (not bt1069)) (not bt1072))
                (not bt1071)
                (= (+ it959 (* it962 (- 1))) 0)
                (= (+ it958 (* it961 (- 1))) 0)
                (= (+ it960 (- 1)) 0)))
      (a!5 (and (not bt1070)
                ...
                (= (+ it959 (* it962 (- 1))) 0)
                (= (+ it958 (* it961 (- 1))) 0)))
      (a!6 (and (and (and bt1070 (not bt1069)) (not bt1072))
                (= (+ (* it960 (- 1)) it957) 0)))
      (a!9 (and (and bt1070 (not bt1069))
                (= (+ (* it960 (- 1)) it957) 0)
                bt1072
                (not bt1071)
                (= (+ it959 (* it962 (- 1))) 0)
      ...
      (a!10 (and bt1070
                 ...
                 (= (+ it959 (* it962 (- 1))) 0)
                 (= (+ it958 (* it961 (- 1))) 0)))
      (a!11 (and (and bt1070 (not bt1072))
                 (= (+ (* it960 (- 1)) it957) 0)
                 (not bt1071)
                 bt1069
                 (= (+ it959 (* it962 (- 1))) 0)
      ...
      (a!13 (and (not bt1070)
                 ...
                 (= (+ it959 (* it962 (- 1))) 0)
                 (= (+ it958 (* it961 (- 1))) 0)))
      (a!14 (and (and (not bt1069) (not bt1070))
                 (= (+ (* it960 (- 1)) it957) 0)
                 bt1072
                 (not bt1071)
                 (= (+ it959 (* it962 (- 1))) 0)
                 (= (+ it958 (* it961 (- 1))) 0)))
      (a!16 (and (and bt1070 (not bt1072))
                 (= (+ (* it960 (- 1)) (* it957 3)) 0)
                 bt1071
                 bt1069
                 (= (+ it959 (* it962 (- 1))) 0)
                 (= (+ it958 (* it961 (- 1))) 0)))
      (a!17 (and (= (+ (* it960 (- 1)) (* it957 2)) 0)
                 (not bt1070)
                 (not bt1072)
                 bt1071
                 bt1069
...
(let ((a!2 (and a!1
      ...
      (a!15 (or bt1066
                ...
                bt1068
                (> (+ (* it957 (- 1)) it959) 0))))
  (and (or (<= it958 0) (not bt1066) bt1067 (not bt1065) a!2 bt1068)
       (or (or bt1065 (not bt1066) bt1067) a!3 bt1068)
       (or a!4 bt1065 bt1066 bt1067 bt1068)
       (or (not bt1066) (not bt1065) a!5 (not bt1067) bt1068)
       (or a!7 bt1065 (not bt1066) (not bt1067) bt1068)
       (or (or (not bt1066) bt1067) (> it958 0) a!8 (not bt1065) bt1068)
       (or (or bt1065 (not bt1066) bt1067) (not bt1068) a!9)
       (or (or bt1065 bt1066) (> it957 0) bt1067 (not bt1068) a!10)
       a!12
       (or (or bt1065 bt1066) a!13 bt1067 (not bt1068) (<= it957 0))
       a!15
       (or bt1066 (not bt1065) a!16 (not bt1067) bt1068)
       (or a!17 bt1065 bt1066 (not bt1067) bt1068)
       (= (+ it956 (- 2)) 0)
       (or (or (not bt1066) bt1067) (not bt1065) (not bt1068) a!10)
       (or a!4 bt1066 bt1067 (not bt1065) (not bt1068))))))
(check-sat)
