...
(assert (= (+ (+ 0 it98) (* (exp 16 it93) (+ 0 it86) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) (+ 0 2)))
      (a!2 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 2)))
      (a!3 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 4)))
      (a!4 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) (+ 0 (- 4))))
      (a!5 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 (- 1)))))
(let ((a!6 (+ (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) a!5 (+ 0 5))))
  (and (>= (+ (* it96 (- 1)) 1) 0)
       (>= (+ it96 (- 1)) 0)
       (> (+ (* it98 2) 5) 0)
       (> (+ (* it97 (- 1)) it98 5) 0)
