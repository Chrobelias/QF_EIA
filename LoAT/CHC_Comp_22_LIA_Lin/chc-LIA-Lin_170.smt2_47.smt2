...
(assert (or (distinct (+ (* it237 (- 1)) (* it234 2)) 0)
    (not bt263)
    bt262
    bt264
    bt257
    (distinct (+ it233 (- 2)) 0)
    bt258
    (distinct (+ (* it239 (- 1)) it236) 0)
    (not bt259)
    (not bt261)
    (distinct (+ (* it238 (- 1)) it235) 0)))
(assert (let ((a!1 (and bt262
                bt264
                bt261
                (= (+ (* it237 (- 1)) it234) 0)
                (not bt263)
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!2 (and (and (not bt264) (not bt262))
                bt263
                bt261
                (= (+ (* it237 (- 1)) it234) 0)
                (= (+ (* it239 (- 1)) it236) 0)
      ...
      (a!3 (and (not bt261)
                ...
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!5 (and (and (not bt264) bt262)
                bt263
                bt261
                (= (+ (* it237 (- 1)) (* it234 3)) 0)
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!6 (and (and (not bt264) (not bt262))
                (= (+ (* it237 (- 1)) (* it234 2)) 0)
                bt263
                bt261
                (= (+ (* it239 (- 1)) it236) 0)
      ...
      (a!7 (and (not bt261)
                ...
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!8 (and (and (and (not bt264) (not bt261)) (not bt262))
                bt263
                (= (+ (* it237 (- 1)) it234) 0)
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!9 (and (and (and (not bt264) (not bt261)) bt262)
                (= (+ (* it237 (- 1)) it234) 0)
                (not bt263)
                (= (+ (* it239 (- 1)) it236) 0)
                (= (+ (* it238 (- 1)) it235) 0)))
      (a!10 (and (and (and (not bt264) (not bt261)) (not bt262))
                 (= (+ (* it237 (- 1)) it234) 0)
                 (not bt263)
                 (= (+ (* it239 (- 1)) it236) 0)
                 (= (+ (* it238 (- 1)) it235) 0)))
      (a!11 (and (and (and (not bt264) (not bt261)) bt262)
                 bt263
                 (= (+ (* it237 (- 1)) it234) 0)
                 (= (+ (* it239 (- 1)) it236) 0)
                 (= (+ (* it238 (- 1)) it235) 0)))
      (a!12 (and (and (and (not bt264) (not bt261)) bt262)
                 (= (+ it237 (- 1)) 0)
                 (not bt263)
                 (= (+ (* it239 (- 1)) it236) 0)
                 (= (+ (* it238 (- 1)) it235) 0)))
      (a!13 (and (not bt262)
                 ...
                 (= (+ (* it239 (- 1)) it236) 0)
                 (= (+ (* it238 (- 1)) it235) 0)))
      (a!14 (and (and (not bt264) bt262)
                 bt261
                 (= (+ (* it237 (- 1)) it234) 0)
                 (not bt263)
                 (= (+ (* it239 (- 1)) it236) 0)
                 (= (+ (* it238 (- 1)) it235) 0))))
(let ((a!4 (or (> (+ it236 (* it234 (- 1))) 0)
               bt260
               bt258
               bt259
               (not bt257)
               a!3))
      (a!15 (or (<= (+ it236 (* it234 (- 1))) 0)
                a!14
                bt260
                bt258
                bt259
                (not bt257))))
  (and (or (not bt260) bt259 (not bt257) a!1 (not bt258))
       (or bt260 a!2 (not bt257) (not bt258) (not bt259))
       a!4
       (or bt260 a!5 bt258 (not bt257) (not bt259))
       (or (> it234 0) bt257 (not bt260) bt258 bt259 a!1)
       (or bt257 a!6 bt260 bt258 (not bt259))
       (or (or bt257 (not bt260)) bt259 a!7 (not bt258))
       (or a!8 bt260 bt259 (not bt257) (not bt258) (<= it235 0))
       (or a!9 bt257 bt260 (not bt258) (not bt259))
       (or a!10 (not bt260) bt258 bt259 (not bt257))
       (= (+ it233 (- 2)) 0)
       (or bt260 bt259 (not bt257) (> it235 0) a!11 (not bt258))
       (or a!12 bt257 bt260 bt259 (not bt258))
       (or (or bt257 (not bt260)) bt258 bt259 a!13 (<= it234 0))
       (or a!10 bt257 bt260 bt258 bt259)
       a!15))))
(check-sat)
