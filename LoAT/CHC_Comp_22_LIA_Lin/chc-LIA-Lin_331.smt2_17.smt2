...
(let ((a!4 (+ (* (exp 16 (+ it93 (- 1))) (+ 0 it86)) a!3 (+ 0 5))))
  (and (> (+ (* it85 (- 8)) (* it86 (- 8)) 5) 0)
       ...
       (> (+ a!5 a!6 (+ 0 5)) (+ 0 0))
       (> (+ a!6 (+ 0 5)) (+ 0 0))))))
(assert (= (+ it95 (* it83 (- 1))) 0))
(assert (= (+ it96 (- 1)) 0))
(assert (= (+ (+ 0 it97) (* (exp 16 it93) (+ 0 it85) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 it98) (* (exp 16 it93) (+ 0 it86) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 (- 1))))
      (a!3 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) (+ 0 (- 4))))
      (a!4 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 4)))
      (a!5 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) (+ 0 2)))
      (a!6 (* (* (exp 16 (+ it87 (- 1))) (+ 0 it97)) (+ 0 2))))
(let ((a!2 (+ (* (exp 16 (+ it87 (- 1))) (+ 0 it98)) a!1 (+ 0 5))))
  (and (> (+ (* it97 (- 1)) it98 5) 0)
       (> a!2 (+ 0 0))
       (> (+ (* it97 4) 5) 0)
       (> (+ a!3 a!4 (+ 0 5)) (+ 0 0))
       ...
       (> (+ (* it98 (- 8)) 5) 0)
       (> (+ a!4 (+ 0 5)) (+ 0 0))))))
(assert (= (+ it110 (* it95 (- 1))) 0))
(assert (= (+ it111 (- 1)) 0))
(assert (= (+ (* (exp 16 it87) (+ 0 it97) (+ 0 (- 1))) (+ 0 it112))
   (+ 0 0)))
(assert (= (+ (* (exp 16 it87) (+ 0 it98) (+ 0 (- 1))) (+ 0 it113))
   (+ 0 0)))
(assert (let ((a!1 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 4)))
      (a!2 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) (+ 0 (- 4))))
      (a!5 (* (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) (+ 0 2)))
      (a!6 (* (* (+ 0 it112) (exp 16 (+ it99 (- 1)))) (+ 0 2))))
(let ((a!3 (+ (* (+ 0 it113) (exp 16 (+ it99 (- 1)))) a!2 (+ 0 5))))
  (and (> (+ (* it113 2) (* it112 2) 5) 0)
       (> (+ (* it113 (- 4)) (* it112 4) 5) 0)
       (> (+ a!1 (+ 0 5)) (+ 0 0))
       (> a!3 (+ 0 0))
       (> (+ (* it113 (- 8)) (* it112 (- 8)) 5) 0)
