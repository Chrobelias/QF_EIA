...
(assert (let ((a!1 (and (and bt587 bt588) (= (+ (* it515 (- 1)) it512) 0)))
      (a!3 (and (and bt587 bt588)
                (= (+ (* it514 (- 1)) it511) 0)
                (= (+ (* it516 (- 1)) it513) 0)
                (not bt586)
                (not bt589)
                (= (+ it515 (- 10)) 0)))
      (a!4 (and bt588 (= (+ (* it515 (- 1)) it512) 0)))
      (a!7 (and bt587
                (= (+ (* it515 (- 1)) it512) 0)
                (= (+ (* it514 (- 1)) it511) 0)
                (= (+ (* it516 (- 1)) it513) 0)))
      (a!8 (and (= (+ (* it515 (- 1)) it512) 0)
                (= (+ (* it514 (- 1)) it511) 0)
                (= (+ (* it516 (- 1)) it513) 0)))
      (a!12 (= (+ (+ (* it515 (- 1)) it512) (- 1)) 0)))
(let ((a!2 (and a!1
                (= (+ (* it514 (- 1)) it511) 0)
                (= (+ (* it516 (- 1)) it513) 0)
                (not bt586)))
      ...
      (a!9 (or bt585
               (> it512 0)
               (and (and a!8 (not bt586)) bt589 (not bt588) (not bt587))
               bt583
               (not bt584)
               bt582))
      (a!10 (or (not bt583)
                ...
                bt585
                (not bt582)
                (and a!7 (not bt586) bt589 (not bt588))))
      (a!11 (and (and a!8 (not bt586)) (not bt589) (not bt588) (not bt587)))
      (a!13 (and bt588
                 (= (+ (* it514 (- 1)) it511) 0)
                 (= (+ (* it516 (- 1)) it513) 0)
                 (not bt589)
      ...
      (a!15 (and a!1
                 ...
                 bt586
                 (= (+ (* it514 (- 1)) (* it511 2)) 0)))
      (a!16 (or (or (or (not bt583) bt584) bt585)
                (not bt582)
                (<= (+ it513 (* it511 (- 1))) 0)
                (and a!8 (not bt589) (not bt588) (not bt587) bt586))))
(let ((a!6 (or (or (or (not bt583) bt584) bt585) a!5 bt582)))
  (and (or bt584 bt583 (and a!2 (not bt589)) (not bt585) bt582)
       (or (or bt584 bt585 bt583) (not bt582) a!3)
       a!6
       (or (or bt585 bt583)
           (not bt584)
           (and a!7 (not bt589) (not bt588) bt586)
           (<= it512 0)
           bt582)
       a!9
       a!10
       (or (or (not bt583) bt585)
           (not bt582)
           (not bt584)
           (and a!8 (not bt589) (not bt588) (not bt587) bt586))
       (or (or bt584 bt585 bt583) a!11 bt582)
       (or (or (not bt583) bt585) a!13 (not bt584) bt582)
       (or (or (not bt583) bt584) (<= it511 0) (not bt585) a!14 bt582)
       (or bt584 (and a!2 bt589) bt583 (not bt582) (not bt585))
       (= (+ it510 (- 2)) 0)
       (or bt583
           (not bt584)
           (not bt585)
           bt582
           (and a!8 bt589 (not bt588) (not bt587) bt586))
       (or (or (not bt583) bt584) (not bt582) (not bt585) a!11)
       (or (or (not bt583) bt584)
           (> it511 0)
           (not bt585)
           bt582
           (and a!8 bt589 (not bt588) (not bt587) bt586))
       (or (or bt585 bt583) (not bt582) (not bt584) a!15)
       a!16)))))
(check-sat)
