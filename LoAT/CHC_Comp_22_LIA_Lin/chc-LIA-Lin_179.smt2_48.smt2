...
(declare-fun bt590 () Bool)
(declare-fun bt591 () Bool)
(declare-fun bt592 () Bool)
(declare-fun bt593 () Bool)
(declare-fun bt597 () Bool)
(declare-fun it521 () Int)
(declare-fun bt596 () Bool)
(declare-fun bt595 () Bool)
(declare-fun bt594 () Bool)
...
(assert (and bt587
     ...
     bt582))
(assert (= (+ it517 (- 2)) 0))
(assert (= (+ (* it514 (- 1)) it518) 0))
(assert (= (+ it519 (* it515 (- 1))) 0))
(assert (= (+ (* it516 (- 1)) it520) 0))
(assert (or (and bt588 bt590) (and (not bt590) (not bt588))))
(assert (or (and bt587 bt591) (and (not bt591) (not bt587))))
(assert (or (and bt592 bt586) (and (not bt592) (not bt586))))
(assert (or (and bt593 bt589) (and (not bt589) (not bt593))))
(assert (or (distinct (+ (* it522 (- 1)) it519) 0)
    ...
    bt597
    (distinct (+ it517 (- 2)) 0)))
(assert (let ((a!1 (and (= (+ (* it522 (- 1)) it519) 0)
                bt596
                (= (+ (* it521 (- 1)) it518) 0)
                (not bt594)
                (not bt595)
                bt597
                (= (+ (* it523 (- 1)) it520) 0)))
      (a!2 (and (= (+ (* it522 (- 1)) it519) 0) (not bt596)))
      (a!4 (and (= (+ (* it522 (- 1)) it519) 0) (not bt597)))
      (a!6 (and (not bt597)
                bt595
                bt596
                (= (+ it522 (- 10)) 0)
                ...
                (not bt594)
                (= (+ (* it523 (- 1)) it520) 0)))
      (a!16 (= (+ (+ (* it522 (- 1)) it519) (- 1)) 0))
      (a!20 (and (= (+ (* it522 (- 1)) it519) 0)
                 bt595
                 bt596
                 (= (+ (* it521 (- 1)) it518) 0)
                 (not bt594)
                 bt597
                 (= (+ (* it523 (- 1)) it520) 0))))
(let ((a!3 (and (and a!2 (not bt597))
                bt595
                (= (+ (* it521 (- 1)) it518) 0)
                bt594
                (= (+ (* it523 (- 1)) it520) 0)))
      (a!5 (and (and a!4 bt595 bt596)
                (= (+ (* it521 (- 1)) (* it518 2)) 0)
                bt594
                (= (+ (* it523 (- 1)) it520) 0)))
      (a!7 (and (and a!4 bt595 bt596)
                (= (+ (* it521 (- 1)) it518) 0)
                (not bt594)
                (= (+ (* it523 (- 1)) it520) 0)))
      (a!8 (and a!2 (= (+ (* it521 (- 1)) it518) 0)))
      (a!10 (and (and a!2 (not bt597)) (= (+ (* it521 (- 1)) it518) 0)))
      (a!13 (and a!2
                 bt595
                 (= (+ (* it521 (- 1)) it518) 0)
                 (not bt594)
      ...
      (a!17 (and (not bt597)
                 ...
                 a!16
                 (= (+ (* it523 (- 1)) it520) 0))))
(let ((a!9 (and a!8 bt594 (not bt595) bt597 (= (+ (* it523 (- 1)) it520) 0)))
      (a!11 (and a!10 bt594 (not bt595) (= (+ (* it523 (- 1)) it520) 0)))
      (a!12 (and a!10 (not bt594) (not bt595) (= (+ (* it523 (- 1)) it520) 0)))
      (a!14 (or (> (+ it520 (* it518 (- 1))) 0)
                (not bt591)
                (not bt590)
                bt592
                bt593
...
(let ((a!19 (or a!11
                ...
                bt593
                (<= (+ it520 (* it518 (- 1))) 0))))
  (and (or a!1 (not bt591) bt592 (not bt593) (<= it518 0) bt590)
       (= (+ it517 (- 2)) 0)
       (or (not bt592) a!3 bt593 (<= it519 0) bt591 bt590)
       (or (not bt592) (not bt590) a!5 bt593 bt591)
       (or a!6 (not bt590) bt592 bt593 bt591)
       (or bt592 (not bt593) bt591 a!7 bt590)
       (or (not bt592) (not bt593) a!9 bt591 bt590)
       (or (or (not bt591) bt592) (not bt593) (> it518 0) a!9 bt590)
       (or (not bt592) a!11 (not bt591) (not bt590) bt593)
       (or bt592 bt593 bt591 a!12 bt590)
       a!14
       (or (or (not bt591) bt592) bt593 a!15 bt590)
       (or (not bt592) (not bt591) bt593 a!17 bt590)
       (or (not bt592) (> it519 0) a!18 bt593 bt591 bt590)
       a!19
       (or (not bt590) bt592 (not bt593) a!20 bt591)
       (or (not bt591) (not bt590) bt592 (not bt593) a!12)))))))
(check-sat)
