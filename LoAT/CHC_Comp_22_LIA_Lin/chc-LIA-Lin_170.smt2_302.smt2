...
(assert (let ((a!1 (and (not bt1205) (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!4 (and (= (+ (* it1087 2) (* it1090 (- 1))) 0)
                bt1205
                (= (+ (* it1092 (- 1)) it1089) 0)
                (not bt1206)
                bt1207
      ...
      (a!5 (and (= (+ (* it1087 3) (* it1090 (- 1))) 0)
                ...
                bt1206
                (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!6 (and bt1205 (= (+ (* it1092 (- 1)) it1089) 0))))
(let ((a!2 (and (and a!1 (not bt1208))
                (= (+ it1087 (* it1090 (- 1))) 0)
                bt1206
                (not bt1207)
                (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!3 (and (and a!1 (not bt1206))
                (not bt1208)
                (= (+ it1087 (* it1090 (- 1))) 0)
                (not bt1207)
                (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!7 (and (and a!6 (not bt1206))
                bt1207
                (not bt1208)
                (= (+ it1087 (* it1090 (- 1))) 0)
                (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!8 (and (and a!1 (not bt1208))
                bt1206
                (not bt1207)
                (= (+ it1090 (- 1)) 0)
                (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!9 (and (and a!1 (not bt1206))
                bt1207
                (not bt1208)
                (= (+ it1087 (* it1090 (- 1))) 0)
                (= (+ it1088 (* it1091 (- 1))) 0)))
      ...
      (a!15 (and a!1
                 ...
                 bt1206
                 (= (+ it1088 (* it1091 (- 1))) 0)))
      (a!16 (and (and a!1 (not bt1206))
                 bt1208
                 (= (+ it1087 (* it1090 (- 1))) 0)
                 (not bt1207)
                 (= (+ it1088 (* it1091 (- 1))) 0))))
(let ((a!13 (or (or bt1202 (not bt1201) bt1204)
                (<= (+ (* it1087 (- 1)) it1089) 0)
                a!12
                bt1203))
      (a!17 (or bt1202
                ...
                a!16
                bt1203)))
  (and (or a!2 bt1204 bt1201 (not bt1203) (not bt1202))
       (or (or bt1202 bt1204 bt1201) a!3 bt1203)
       (or (or bt1202 bt1204 bt1201) (not bt1203) a!4)
       (or (or bt1202 (not bt1201) bt1204) a!5 (not bt1203))
       (or (or (not bt1201) bt1204) a!7 (not bt1203) (not bt1202))
       (or bt1204 bt1201 a!8 bt1203 (not bt1202))
       (or (or (not bt1201) bt1204) a!9 bt1203 (<= it1088 0) (not bt1202))
       (or (> it1087 0) (not bt1204) bt1202 bt1201 a!10 bt1203)
       (or (not bt1204) bt1201 a!11 bt1203 (not bt1202))
       a!13
       (or (not bt1204) (not bt1201) a!10 bt1203 (not bt1202))
       (or (or (not bt1204) bt1202) (<= it1087 0) bt1201 a!14 bt1203)
       (or (or (not bt1204) bt1202) (not bt1201) a!3 bt1203)
       (or (> it1088 0) (not bt1201) bt1204 bt1203 a!15 (not bt1202))
       (= (+ it1086 (- 2)) 0)
       a!17)))))
(check-sat)
