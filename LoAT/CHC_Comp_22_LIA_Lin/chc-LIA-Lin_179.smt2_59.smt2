...
(assert (let ((a!1 (and (not bt705)
                (= (+ (* it613 (- 1)) it645) 0)
                (= (+ (* it615 (- 1)) it647) 0)))
      (a!3 (and (= (+ (* it613 (- 1)) it645) 0) (= (+ (* it615 (- 1)) it647) 0)))
      (a!5 (= (+ (+ (* it614 (- 1)) it646) (- 1)) 0))
      (a!6 (and (not bt705) (= (+ (* it615 (- 1)) it647) 0) bt704)))
(let ((a!2 (and (and (and a!1 bt704) bt703)
                (= (+ (* it614 (- 1)) it646) 0)
                (not bt702)))
      (a!4 (and (and a!3 bt704 bt705)
                (not bt703)
                (= (+ (* it614 (- 1)) it646) 0)
                (not bt702)))
      (a!7 (and a!6
                ...
                (= (+ (* it614 (- 1)) it646) 0)
                (not bt702)))
      (a!8 (and (and a!3 bt704 bt705)
                bt703
                (= (+ (* it614 (- 1)) it646) 0)
                (not bt702)))
      (a!9 (and (and a!3 (not bt704) bt705)
                bt703
                (= (+ (* it614 (- 1)) it646) 0)
                (not bt702)))
      (a!11 (and (and a!3 (not bt704) bt705)
                 (not bt703)
                 (= (+ (* it614 (- 1)) it646) 0)
                 (not bt702)))
      (a!12 (and (and a!3 (not bt704) bt705)
                 bt702
                 (not bt703)
                 (= (+ (* it614 (- 1)) it646) 0)))
      (a!13 (and (and a!1 (not bt704))
                 (not bt703)
                 (= (+ (* it614 (- 1)) it646) 0)
                 (not bt702)))
      (a!14 (and a!6
                 ...
                 (= (+ (* it614 (- 1)) it646) 0)
                 (= (+ (* it613 (- 1)) (* it645 2)) 0)))
      (a!15 (and (and (and a!1 (not bt704)) bt702)
                 (not bt703)
                 (= (+ (* it614 (- 1)) it646) 0)))
      (a!17 (or bt740
                (and (and (and a!1 bt704) bt703)
                     (= (+ it614 (- 10)) 0)
                     (not bt702))
                bt741
                (not bt738)
                bt739))
      (a!18 (and (and (and a!1 (not bt704)) bt702)
                 bt703
                 (= (+ (* it614 (- 1)) it646) 0))))
(let ((a!10 (or bt740
                a!9
      ...
      (a!16 (or bt740
                ...
                a!15
                (not bt738))))
  (and (or (or bt740 (not bt741)) a!2 bt738 bt739)
       (or (or bt740 (not bt741)) (<= it645 0) a!4 bt738 (not bt739))
       (= (+ it644 (- 2)) 0)
       (or (and (and a!1 bt704) bt702 (not bt703) a!5)
           bt738
           (not bt739)
           bt741
           (not bt740))
       (or (or bt740 bt738) a!7 (not bt739) bt741)
       (or (or bt740 (not bt741)) a!8 (not bt738) bt739)
       a!10
       (or a!11 bt738 (> it646 0) bt741 (not bt740) bt739)
       (or (or bt740 (not bt741)) bt738 a!12 (> it645 0) (not bt739))
       (or (or bt740 bt738) a!13 bt741 bt739)
       (or a!14 bt741 (not bt738) (not bt740) bt739)
       a!16
       a!17
       (or (not bt741) bt738 a!12 (not bt740) bt739)
       (or bt738 (<= it646 0) bt741 a!18 (not bt740) bt739)
       (or (not bt739) bt741 a!15 (not bt738) (not bt740))
       (or (or bt740 (not bt741)) a!13 (not bt739) (not bt738)))))))
(check-sat)
