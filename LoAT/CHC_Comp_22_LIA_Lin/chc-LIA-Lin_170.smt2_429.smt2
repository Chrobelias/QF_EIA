...
(assert (let ((a!1 (and (and (and (not bt1504) bt1501) bt1503)
                (= (+ (* it1389 (- 1)) it1386) 0)
                (= (+ it1387 (* it1390 (- 1))) 0)
                (= (+ (* it1391 (- 1)) it1388) 0)
                (not bt1502)))
      (a!2 (and bt1501
                ...
                (not bt1503)
                (= (+ (* it1391 (- 1)) it1388) 0)))
      (a!3 (and (and (not bt1501) (not bt1504))
                (= (+ (* it1389 (- 1)) it1386) 0)
                (= (+ it1387 (* it1390 (- 1))) 0)
                (not bt1503)
                (= (+ (* it1391 (- 1)) it1388) 0)))
      (a!4 (and (not bt1501)
                ...
                (not bt1503)
                (= (+ (* it1391 (- 1)) it1388) 0)))
      (a!6 (and (and (not bt1501) (not bt1504))
                bt1503
                (= (+ (* it1389 (- 1)) it1386) 0)
                (= (+ it1387 (* it1390 (- 1))) 0)
                (= (+ (* it1391 (- 1)) it1388) 0)))
      (a!7 (and (= (+ (* it1389 (- 1)) (* it1386 3)) 0)
                (not bt1504)
                bt1501
                bt1503
                (= (+ it1387 (* it1390 (- 1))) 0)
                (= (+ (* it1391 (- 1)) it1388) 0)
                bt1502))
      (a!8 (and (and (and (not bt1504) bt1501) bt1503)
                (= (+ it1387 (* it1390 (- 1))) 0)
                (= (+ (* it1391 (- 1)) it1388) 0)
                (not bt1502)
                (= (+ (* it1389 (- 1)) (* it1386 2)) 0)))
      (a!9 (and (and (not bt1504) bt1501)
                (= (+ (* it1389 (- 1)) it1386) 0)
                (= (+ it1387 (* it1390 (- 1))) 0)
                (not bt1503)
                (= (+ (* it1391 (- 1)) it1388) 0)
                bt1502))
      (a!11 (and (and (not bt1501) (not bt1504))
                 (= (+ it1389 (- 1)) 0)
                 (= (+ it1387 (* it1390 (- 1))) 0)
                 (not bt1503)
                 (= (+ (* it1391 (- 1)) it1388) 0)
                 bt1502)))
(let ((a!5 (or (or (not bt1497) bt1499)
               bt1498
               bt1500
               (and a!4 (not bt1502) bt1504)
               (> (+ it1388 (* it1386 (- 1))) 0)))
      (a!10 (or (or (not bt1497) bt1499)
                (<= (+ it1388 (* it1386 (- 1))) 0)
                a!9
                bt1498
                bt1500)))
  (and (or (or (not bt1497) (not bt1499)) bt1500 a!1 (not bt1498))
       (or bt1497
           (and a!2 bt1504 bt1502)
           (> it1386 0)
           bt1499
           (not bt1500)
           bt1498)
       (or bt1497
           ...
           (not bt1500)
           bt1498
           (and a!2 (not bt1502) bt1504))
       (or bt1497 (and a!3 (not bt1502)) bt1499 bt1498 bt1500)
       a!5
       (or (<= it1387 0)
           (not bt1497)
           bt1499
           ...
           (not bt1498)
           (and a!6 (not bt1502)))
       (or (or (not bt1497) (not bt1499)) bt1498 bt1500 a!7)
       (or bt1497 (and a!3 bt1502) (not bt1499) bt1500 (not bt1498))
       (or bt1497 (not bt1499) a!8 bt1498 bt1500)
       (or (or bt1497 bt1499) (not bt1500) (and a!4 bt1504 bt1502) (not bt1498))
       a!10
       (or (or bt1497 bt1499) bt1500 a!11 (not bt1498))
       (or (not bt1497)
           (and a!6 bt1502)
           bt1499
           (> it1387 0)
           ...
           (not bt1498))
       (= (+ it1385 (- 2)) 0)
       (or (and a!2 bt1504 bt1502)
           (not bt1497)
           bt1499
           (not bt1500)
           (not bt1498))
       (or (not bt1497) (and a!3 (not bt1502)) bt1499 (not bt1500) bt1498)))))
(check-sat)
