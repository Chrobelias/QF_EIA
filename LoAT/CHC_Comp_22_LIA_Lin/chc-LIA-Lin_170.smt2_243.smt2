...
(assert (let ((a!1 (and (= (+ (* it943 (- 1)) it940) 0) bt1052))
      (a!5 (and (= (+ (* it943 (- 1)) it940) 0) (not bt1052)))
      (a!19 (and (= (+ (* it942 (- 1)) (* it939 2)) 0)
                 (= (+ (* it943 (- 1)) it940) 0)
                 (not bt1052)
                 bt1049
                 (not bt1050)
                 (= (+ (* it944 (- 1)) it941) 0)
                 bt1051)))
(let ((a!2 (and a!1 (= (+ (* it942 (- 1)) it939) 0) (not bt1051)))
      (a!6 (and a!5
                (= (+ it942 (- 1)) 0)
                (not bt1051)
                bt1050
                (= (+ (* it944 (- 1)) it941) 0)
                (not bt1049)))
      (a!7 (and a!1 bt1049 (= (+ (* it942 (- 1)) it939) 0) (not bt1051)))
      (a!10 (and a!5 (= (+ (* it942 (- 1)) it939) 0)))
      (a!12 (and (and a!5 bt1049)
                 (= (+ (* it942 (- 1)) (* it939 3)) 0)
                 bt1050
                 (= (+ (* it944 (- 1)) it941) 0)
                 bt1051))
      (a!16 (and (and a!5 bt1049) (= (+ (* it942 (- 1)) it939) 0))))
(let ((a!3 (and a!2 (not bt1050) (= (+ (* it944 (- 1)) it941) 0) (not bt1049)))
      (a!8 (and a!7 bt1050 (= (+ (* it944 (- 1)) it941) 0)))
      (a!9 (and a!2 bt1050 (= (+ (* it944 (- 1)) it941) 0) (not bt1049)))
      (a!11 (and a!10
                 bt1050
                 (= (+ (* it944 (- 1)) it941) 0)
                 bt1051
                 (not bt1049)))
      (a!13 (and (and a!10 (not bt1051))
                 (not bt1050)
                 (= (+ (* it944 (- 1)) it941) 0)
                 (not bt1049)))
      (a!14 (and (and a!10 (not bt1051))
                 bt1050
                 (= (+ (* it944 (- 1)) it941) 0)
                 (not bt1049)))
      (a!15 (and a!10
                 ...
                 bt1051
                 (not bt1049)))
      (a!17 (and a!16 (not bt1051) bt1050 (= (+ (* it944 (- 1)) it941) 0)))
      (a!20 (and a!16 (not bt1050) (= (+ (* it944 (- 1)) it941) 0) bt1051))
      (a!21 (and a!7 (not bt1050) (= (+ (* it944 (- 1)) it941) 0))))
(let ((a!4 (or (or (or bt1046 bt1048) bt1047)
               a!3
               (not bt1045)
               (> (+ it941 (* it939 (- 1))) 0)))
      (a!18 (or (or (or bt1046 bt1048) bt1047)
                (not bt1045)
                (<= (+ it941 (* it939 (- 1))) 0)
                a!17)))
  (and a!4
       (or (or (not bt1046) bt1048) bt1047 bt1045 a!6)
       (or (not bt1046) (not bt1048) bt1047 a!8 (not bt1045))
       (or a!9 (not bt1046) (not bt1048) bt1047 bt1045)
       (or (not bt1046) (> it940 0) bt1048 bt1047 (not bt1045) a!11)
       (or (or (or bt1046 bt1048) (not bt1047)) (not bt1045) a!12)
       (or (or bt1046 (not bt1048)) a!13 bt1047 (not bt1045))
       (or (or (not bt1046) bt1048) (not bt1047) bt1045 a!14)
       (or (<= it940 0) (not bt1046) a!15 bt1048 bt1047 (not bt1045))
       a!18
       (or (or (or bt1046 bt1048) (not bt1047)) bt1045 a!19)
       (or a!20 (not bt1046) bt1048 (not bt1047) (not bt1045))
       (or bt1046 a!13 bt1048 bt1047 bt1045)
       (= (+ it938 (- 2)) 0)
       (or (or bt1046 (not bt1048)) a!21 bt1047 bt1045 (<= it939 0))
       (or bt1046 (> it939 0) (not bt1048) bt1047 a!8 bt1045)))))))
(check-sat)
