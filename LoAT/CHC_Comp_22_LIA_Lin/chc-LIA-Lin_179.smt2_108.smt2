...
(assert (or (distinct (+ (* it852 2) (* it855 (- 1))) 0)
    (not bt982)
    (distinct (+ (* it857 (- 1)) it854) 0)
    (not bt983)
    (distinct (+ it853 (* it856 (- 1))) 0)
    bt979
    bt985
    (distinct (+ it851 (- 2)) 0)
    (not bt980)
    (not bt978)
    (not bt984)))
(assert (let ((a!1 (and (= (+ it853 (* it856 (- 1))) 0) (= (+ it852 (* it855 (- 1))) 0)))
      (a!3 (and (= (+ it852 (* it855 (- 1))) 0)
                (not bt982)
                (= (+ (* it857 (- 1)) it854) 0)
                (= (+ it856 (- 10)) 0)
                (not bt985)
                bt983
                bt984))
      (a!10 (= (+ (+ it853 (* it856 (- 1))) (- 1)) 0))
      (a!12 (and (= (+ it853 (* it856 (- 1))) 0)
                 (= (+ it855 (- 1)) 0)
                 (not bt982)
                 (= (+ (* it857 (- 1)) it854) 0)
                 (not bt985)
      ...
      (a!14 (and (= (+ it853 (* it856 (- 1))) 0)
                 ...
                 bt983
                 bt984)))
(let ((a!2 (and a!1 (not bt982) (= (+ (* it857 (- 1)) it854) 0) (not bt985)))
      (a!5 (and (and a!1 bt985)
                (= (+ (* it857 (- 1)) it854) 0)
                bt982
                (not bt984)
                (not bt983)))
      (a!6 (and a!1
                ...
                (not bt985)
                (not bt984)))
      (a!8 (and (and a!1 bt985) (not bt982) (= (+ (* it857 (- 1)) it854) 0)))
      (a!11 (and (= (+ it852 (* it855 (- 1))) 0)
                 a!10
                 (= (+ (* it857 (- 1)) it854) 0)
                 bt982
                 (not bt985)
                 bt984
                 (not bt983))))
(let ((a!4 (or (or (or (not bt979) (not bt978)) bt980)
               (not bt981)
               (and a!2 (not bt984) (not bt983))))
      (a!7 (or (or (or (not bt979) (not bt978)) bt980)
               (and a!6 (not bt983))
               (<= (+ (* it852 (- 1)) it854) 0)
               bt981))
      (a!9 (or (or (or (not bt979) (not bt978)) bt980)
               (> (+ (* it852 (- 1)) it854) 0)
               (and (and a!8 (not bt984)) bt983)
               bt981))
      (a!13 (or bt979
                (not bt980)
                (and (and a!8 (not bt984)) (not bt983))
                (> it853 0)
                bt981
                bt978)))
  (and (or (and a!2 bt983 bt984) bt979 bt980 bt978 (not bt981))
       (or bt979 bt980 bt981 bt978 (and a!2 (not bt984) (not bt983)))
       (or (or (not bt978) bt979) bt980 a!3 bt981)
       a!4
       (or (not bt979) (> it852 0) bt980 a!5 bt978 (not bt981))
       a!7
       (= (+ it851 (- 2)) 0)
       a!9
       (or (not bt979) a!11 (not bt980) bt981 bt978)
       (or (or (not bt979) bt980)
           (and a!8 bt984 (not bt983))
           (<= it852 0)
           bt978
           (not bt981))
       (or (or (not bt979) bt980) a!12 bt981 bt978)
       a!13
       (or (and a!8 bt983 bt984) (not bt978) bt979 bt980 (not bt981))
       (or (<= it853 0) bt979 (not bt980) (and a!6 bt983) bt981 bt978)
       (or bt979 a!5 (not bt980) bt978 (not bt981))
       (or (or (not bt978) bt979) (not bt980) a!14 bt981)
       (or (or (not bt979) (not bt978)) (not bt980) (and a!6 (not bt983)) bt981))))))
(check-sat)
