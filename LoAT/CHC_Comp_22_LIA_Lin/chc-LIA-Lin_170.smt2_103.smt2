...
(assert (let ((a!1 (and bt468 bt465 (not bt467) (= (+ it410 (* it413 (- 1))) 0)))
      (a!3 (and bt468 (not bt467) (= (+ it410 (* it413 (- 1))) 0)))
      (a!6 (and (not bt467)
                bt466
                (= (+ it413 (- 1)) 0)
                (not bt468)
      ...
      (a!11 (and bt465
                 ...
                 (= (+ it412 (* it415 (- 1))) 0)
                 (= (+ it411 (* it414 (- 1))) 0)))
      (a!12 (or (or (or (not bt462) bt463) bt464) (not bt461)))
      (a!13 (and (= (+ it410 (* it413 (- 1))) 0)
                 bt466
                 bt467
                 (not bt468)
                 (not bt465)
                 (= (+ it412 (* it415 (- 1))) 0)
                 (= (+ it411 (* it414 (- 1))) 0)))
      (a!14 (and (not bt467) (= (+ it410 (* it413 (- 1))) 0)))
      (a!17 (and bt465
                 bt467
                 (not bt468)
                 (= (+ (* it410 2) (* it413 (- 1))) 0)
...
(let ((a!2 (and a!1
      ...
      (a!4 (and a!3
                ...
                (= (+ it412 (* it415 (- 1))) 0)
                (= (+ it411 (* it414 (- 1))) 0)))
      (a!7 (or (or (or (not bt462) bt463) bt464) a!6 bt461))
      (a!9 (or (or (or bt462 bt463) bt464)
               (not bt461)
               a!8
               (<= (+ it412 (* it410 (- 1))) 0)))
      (a!10 (and a!3
...
(let ((a!5 (or bt462
               ...
               (not bt461)
               (> (+ it412 (* it410 (- 1))) 0))))
  (and (or bt462 a!2 bt463 (not bt464) (<= it410 0) bt461)
       a!5
       a!7
       a!9
       (or (or (not bt462) bt463) (not bt464) a!10 bt461)
       (or (or (not bt462) bt464) (not bt461) (not bt463) a!11)
       (= (+ it409 (- 2)) 0)
       (or a!12 a!13 (> it411 0))
       (or (or bt462 bt463) (not bt461) (not bt464) a!15)
       (or (or bt462 bt463) (not bt464) a!16 (> it410 0) bt461)
       (or (or bt462 bt464) (not bt463) a!17 bt461)
       (or (or (or bt462 bt463) bt464) a!15 bt461)
       (or (or (not bt462) bt463) (not bt461) (not bt464) a!16)
       (or (or bt462 bt464) (not bt461) (not bt463) a!18)
       (or (or (not bt462) bt464) (not bt463) a!19 bt461)
       (or a!12 (<= it411 0) a!20))))))
(check-sat)
