...
(assert (let ((a!1 (and (and (not bt1455) (not bt1454))
                bt1456
                (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!3 (and (= (+ (* it1337 (- 1)) (* it1334 3)) 0)
                bt1454
                (= (+ (* it1339 (- 1)) it1336) 0)
                (= (+ (* it1338 (- 1)) it1335) 0)
                bt1455
                (not bt1456)
                bt1453))
      (a!4 (and (and bt1454 (not bt1455))
                bt1456
                (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!6 (and (and bt1454 (not bt1455))
                (= (+ it1337 (- 1)) 0)
                (= (+ (* it1339 (- 1)) it1336) 0)
                (not bt1453)
                (= (+ (* it1338 (- 1)) it1335) 0)
                (not bt1456)))
      (a!7 (and (not bt1454) (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!10 (and (and (not bt1455) (not bt1454))
                 (= (+ (* it1339 (- 1)) it1336) 0)
                 (not bt1453)
                 (= (+ (* it1338 (- 1)) it1335) 0)
                 (not bt1456)
                 (= (+ (* it1337 (- 1)) it1334) 0)))
      (a!14 (and (and bt1454 (not bt1455)) (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!16 (and bt1454
                 (= (+ (* it1339 (- 1)) it1336) 0)
                 (not bt1453)
                 (= (+ (* it1338 (- 1)) it1335) 0)
...
(let ((a!2 (and a!1
      ...
      (a!18 (and a!14
                 ...
                 bt1453
                 (= (+ (* it1337 (- 1)) it1334) 0))))
(let ((a!13 (or (not bt1449)
                bt1450
                bt1451
                bt1452
                a!12
                (> (+ (* it1334 (- 1)) it1336) 0)))
      (a!19 (or (<= (+ (* it1334 (- 1)) it1336) 0)
                (not bt1449)
                a!18
                bt1450
                bt1451
                bt1452)))
  (and (or a!2 bt1450 bt1451 (not bt1452) (<= it1334 0) bt1449)
       (or (not bt1449) a!3 bt1450 bt1452 (not bt1451))
       (or a!5 bt1451 (not bt1452) bt1449 (not bt1450))
       (or bt1451 bt1449 (not bt1450) a!6 bt1452)
       (or bt1450 bt1449 bt1452 a!8 (not bt1451))
       (or bt1450 (> it1334 0) a!9 bt1451 (not bt1452) bt1449)
       (or (not bt1449) a!10 bt1450 bt1451 (not bt1452))
       (or (not bt1449) a!11 bt1451 (not bt1450) bt1452 (<= it1335 0))
       (= (+ it1333 (- 2)) 0)
       a!13
       (or a!10 bt1450 bt1451 bt1449 bt1452)
       (or bt1449 (not bt1450) bt1452 a!15 (not bt1451))
       (or (not bt1449) a!9 bt1451 (not bt1452) (not bt1450))
       (or (not bt1449) bt1451 (not bt1450) bt1452 (> it1335 0) a!16)
       (or (not bt1449) a!17 (not bt1450) bt1452 (not bt1451))
       a!19)))))
(check-sat)
