...
(assert (or bt995
    (distinct (+ (* it894 (- 1)) it891) 0)
    bt989
    (not bt991)
    (distinct (+ (* it893 (- 1)) it890) 0)
    bt993
    (not bt990)
    (distinct (+ (* it892 (- 1)) it889) 0)
    bt996
    (not bt994)
    (distinct (+ it888 (- 2)) 0)))
(assert (let ((a!1 (and (not bt994) (= (+ (* it892 (- 1)) it889) 0)))
      (a!3 (and (= (+ (* it892 (- 1)) it889) 0) bt994))
      (a!6 (and bt993 (= (+ (* it892 (- 1)) it889) 0) bt994))
      (a!9 (and (= (+ it892 (- 1)) 0)
                bt994
                (not bt996)
                (= (+ (* it894 (- 1)) it891) 0)
                ...
                (not bt993)
                (not bt995)))
      (a!11 (and (and (and bt995 (not bt994)) bt993)
                 (= (+ (* it892 (- 1)) it889) 0)
                 (not bt996)
                 (= (+ (* it894 (- 1)) it891) 0)
                 (= (+ (* it893 (- 1)) it890) 0)))
      ...
      (a!16 (and (not bt994)
                 ...
                 (= (+ (* it893 (- 1)) it890) 0)
                 (not bt995)))
      (a!17 (and (and (and bt995 (not bt994)) bt993)
                 (= (+ (* it892 (- 1)) (* it889 2)) 0)
                 (not bt996)
                 (= (+ (* it894 (- 1)) it891) 0)
                 (= (+ (* it893 (- 1)) it890) 0)))
...
(let ((a!2 (and a!1
      ...
      (a!13 (and a!1
                 ...
                 (not bt993)
                 (not bt995))))
(let ((a!8 (or (<= (+ it891 (* it889 (- 1))) 0)
               bt992
               (not bt989)
               bt991
               a!7
               bt990))
      (a!14 (or (or bt992 (not bt989))
                bt991
                (> (+ it891 (* it889 (- 1))) 0)
                a!13
                bt990)))
  (and (or (or (not bt992) (not bt989)) a!2 bt991 bt990)
       (or a!4 bt989 (not bt992) bt991 (not bt990))
       (or (or bt992 bt989) (not bt990) (not bt991) a!5)
       a!8
       (or bt992 a!9 bt989 bt991 (not bt990))
       (or (or (not bt992) (not bt989)) bt991 (not bt990) a!10)
       (or (or bt992 (not bt989)) a!11 (not bt990) (not bt991))
       (or (or bt992 (not bt989)) (not bt991) a!12 bt990)
       a!14
       (= (+ it888 (- 2)) 0)
       (or bt992 (<= it890 0) (not bt989) bt991 (not bt990) a!15)
       (or bt989 (not bt992) bt991 a!10 (> it889 0) bt990)
       (or (<= it889 0) bt989 (not bt992) a!16 bt991 bt990)
       (or (or bt992 bt989) (not bt991) a!17 bt990)
       (or (or bt992 bt989) a!2 bt991 bt990)
       (or (or bt992 (not bt989)) a!18 bt991 (not bt990) (> it890 0)))))))
(check-sat)
