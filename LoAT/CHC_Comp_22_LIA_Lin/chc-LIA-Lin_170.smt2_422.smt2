...
(assert (let ((a!1 (and (= (+ (* it1384 (- 1)) it1381) 0) (not bt1494)))
      (a!4 (and (= (+ (* it1384 (- 1)) it1381) 0) bt1495))
      (a!7 (and (= (+ (* it1384 (- 1)) it1381) 0)
                (= (+ (* it1383 (- 1)) it1380) 0)
                (= (+ it1382 (- 1)) 0)
                (not bt1493)
                (not bt1496)
...
(let ((a!2 (and a!1
      ...
      (a!6 (and a!4
                ...
                bt1494
                bt1493))
      (a!8 (and (and a!1 bt1495)
                (= (+ (* it1382 (- 1)) it1379) 0)
                (= (+ (* it1383 (- 1)) it1380) 0)))
      (a!10 (or (<= (+ it1381 (* it1379 (- 1))) 0)
                bt1491
                (and a!9 (not bt1496) bt1494 bt1493 (not bt1495))
                bt1490
                bt1492
                (not bt1489)))
      (a!11 (and (and a!1 bt1495)
                 (= (+ (* it1383 (- 1)) it1380) 0)
                 (= (+ (* it1382 (- 1)) (* it1379 2)) 0)
                 (not bt1496)
                 bt1493)))
(let ((a!3 (or (and (and a!2 bt1496) (not bt1493) (not bt1495))
               (> (+ it1381 (* it1379 (- 1))) 0)
               bt1491
               bt1490
               bt1492
               (not bt1489))))
  (and a!3
       (or (and a!2 (not bt1493) (not bt1496) (not bt1495))
           bt1491
           (not bt1492)
           bt1490
           (not bt1489))
       (or a!5 (not bt1490) bt1491 bt1492 (> it1380 0) (not bt1489))
       (or (<= it1379 0)
           bt1489
           bt1491
           (not bt1492)
           bt1490
           (and (and a!2 bt1496) bt1493 (not bt1495)))
       (or a!6 bt1490 bt1492 (not bt1491) (not bt1489))
       (= (+ it1378 (- 2)) 0)
       (or bt1489 a!7 (not bt1490) bt1491 bt1492)
       (or (not bt1490)
           bt1492
           (not bt1491)
           (and a!8 (not bt1496) bt1493)
           (not bt1489))
       (or (<= it1380 0)
           (not bt1490)
           bt1491
           (and a!8 (not bt1493) (not bt1496))
           bt1492
           (not bt1489))
       a!10
       (or bt1489
           (and a!2 (not bt1493) (not bt1496) (not bt1495))
           bt1491
           bt1490
           bt1492)
       (or (or bt1489 (not bt1490))
           (and a!9 (not bt1493) (not bt1496) bt1494 (not bt1495))
           bt1492
           (not bt1491))
       (or bt1489 a!11 bt1490 bt1492 (not bt1491))
       (or (not bt1490)
           bt1491
           (not bt1492)
           (and (and a!9 bt1496) bt1494 bt1493 (not bt1495))
           (not bt1489))
       (or (> it1379 0)
           bt1489
           bt1491
       ...
       (or (or bt1489 (not bt1490))
           bt1491
           (and (and a!9 bt1496) (not bt1493) bt1494 (not bt1495))
           (not bt1492)))))))
(check-sat)
