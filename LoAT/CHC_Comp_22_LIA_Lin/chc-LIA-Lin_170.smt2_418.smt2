...
(assert (let ((a!1 (and (= (+ (* it1376 (- 1)) it1373) 0) (not bt1485)))
      (a!4 (and (= (+ (* it1376 (- 1)) it1373) 0)
                (not bt1487)
                (not bt1488)
                bt1486
                (= (+ it1374 (* it1377 (- 1))) 0)
                (= (+ (* it1375 (- 1)) it1372) 0)
                bt1485))
      (a!6 (and (not bt1486) (= (+ (* it1376 (- 1)) it1373) 0)))
      (a!10 (and (= (+ (* it1376 (- 1)) it1373) 0)
                 (= (+ (* it1375 (- 1)) (* it1372 3)) 0)
                 bt1487
                 (not bt1488)
                 bt1486
...
(let ((a!2 (and a!1
      ...
      (a!11 (and a!6
                 ...
                 (= (+ (* it1375 (- 1)) it1372) 0)
                 bt1485))
      (a!12 (and (and a!6 (not bt1485))
                 (not bt1487)
                 (not bt1488)
                 (= (+ it1374 (* it1377 (- 1))) 0)
                 (= (+ (* it1375 (- 1)) it1372) 0)))
      (a!13 (and (and a!6 (not bt1485))
                 bt1488
                 (not bt1487)
                 (= (+ it1374 (* it1377 (- 1))) 0)
                 (= (+ (* it1375 (- 1)) it1372) 0)))
      ...
      (a!17 (and a!6
                 ...
                 (= (+ it1374 (* it1377 (- 1))) 0)
                 bt1485)))
(let ((a!14 (or (> (+ (* it1372 (- 1)) it1374) 0)
                bt1483
                (not bt1481)
                bt1484
                a!13
                bt1482)))
  (and (or (> it1373 0) bt1483 (not bt1481) bt1484 a!2 (not bt1482))
       (or a!3 bt1481 bt1483 (not bt1484) (not bt1482))
       a!5
       (or a!7 (not bt1481) bt1484 (not bt1482) (not bt1483))
       (or bt1481 a!8 bt1483 bt1484 (not bt1482))
       (or a!9 bt1483 (not bt1481) bt1484 (<= it1373 0) (not bt1482))
       (or (not bt1481) bt1484 a!10 bt1482 (not bt1483))
       (or a!11 bt1481 bt1483 (not bt1484) bt1482 (<= it1372 0))
       (or bt1483 (not bt1484) (not bt1481) a!12 bt1482)
       (or bt1481 bt1483 a!12 bt1484 bt1482)
       (= (+ it1371 (- 2)) 0)
       a!14
       (or a!15 bt1481 bt1484 (not bt1482) (not bt1483))
       (or (> it1372 0) a!16 bt1481 bt1483 (not bt1484) bt1482)
       (or a!17 bt1481 bt1484 bt1482 (not bt1483))
       (or a!16 bt1483 (not bt1484) (not bt1481) (not bt1482)))))))
(check-sat)
