...
(assert (or (not bt965)
    ...
    bt968
    (not bt963)
    (distinct (+ (* it869 (- 1)) it866) 0)
    (distinct (+ (* it868 (- 1)) it865) 0)
    (distinct (+ (* it870 (- 1)) it867) 0)
    (distinct (+ it864 (- 2)) 0)
    (not bt961)))
(assert (let ((a!1 (and (= (+ (* it870 (- 1)) it867) 0)
                (= (+ (* it869 (- 1)) it866) 0)
                (= (+ (* it868 (- 1)) it865) 0)))
      (a!4 (and (= (+ (* it870 (- 1)) it867) 0)
                bt966
                (= (+ (* it869 (- 1)) it866) 0)))
      (a!11 (and (= (+ (* it870 (- 1)) it867) 0)
                 (= (+ (* it868 (- 1)) (* it865 2)) 0)
                 (= (+ (* it869 (- 1)) it866) 0)
                 bt965
                 (not bt968)
                 (not bt966)
                 bt967)))
(let ((a!2 (and (and a!1 (not bt965) (not bt968) (not bt966)) (not bt967)))
      (a!3 (or bt962
               (and (and a!1 bt968) (not bt965) (not bt966) (not bt967))
               bt964
               (not bt961)
               (> (+ (* it865 (- 1)) it867) 0)
               bt963))
      (a!5 (and a!4
                ...
                (= (+ (* it868 (- 1)) (* it865 3)) 0)
                bt967))
      (a!6 (and a!4 (= (+ (* it868 (- 1)) it865) 0)))
      (a!7 (or (or bt961 (not bt962))
               (and a!4
                    (= (+ it868 (- 1)) 0)
                    (not bt965)
                    (not bt968)
               ...
               bt964
               bt963))
      (a!10 (or (or (not bt962) bt964)
                (and (and a!1 (not bt965) (not bt968) (not bt966)) bt967)
                (not bt961)
                bt963
                (<= it866 0))))
(let ((a!8 (or (or bt961 (not bt962))
               bt964
               (not bt963)
               (and (and a!6 (not bt965) (not bt968)) (not bt967))))
      (a!9 (or (or bt962 bt964 (not bt961))
               bt963
               (and a!6 bt965 (not bt968) (not bt967))
               (<= (+ (* it865 (- 1)) it867) 0)))
      (a!12 (or (and (and a!6 (not bt965) (not bt968)) bt967)
                (not bt962)
                bt964
                (not bt961)
                bt963
                (> it866 0))))
  (and (or (or (or bt961 bt962) bt964) bt963 a!2)
       a!3
       (or (or (not bt962) bt964)
           (and a!1 bt965 (not bt968) (not bt966) bt967)
           (not bt961)
           (not bt963))
       (or (or bt962 bt964 (not bt961)) (not bt963) a!5)
       (or (or bt961 bt962)
           (and (and a!6 bt968) bt965 (not bt967))
           bt963
           (not bt964)
           (> it865 0))
       (= (+ it864 (- 2)) 0)
       a!7
       (or (or bt961 bt962)
           (and (and a!1 bt968) bt965 (not bt966) (not bt967))
           (<= it865 0)
           bt963
           (not bt964))
       (or (or bt961 (not bt962))
           (and (and a!6 bt968) (not bt965) (not bt967))
           bt963
           (not bt964))
       (or bt962 (not bt961) bt963 (not bt964) a!2)
       a!8
       a!9
       a!10
       (or (or (or bt961 bt962) bt964) a!11 (not bt963))
       (or (not bt962)
           (not bt961)
           (and (and a!6 bt968) bt965 (not bt967))
           bt963
