...
(assert (let ((a!1 (and (= (+ (* it523 (- 1)) it520) 0)
                (= (+ (* it521 (- 1)) it518) 0)
                bt594
                (= (+ (* it522 (- 1)) it519) 0)
                (not bt596)))
      (a!2 (and (= (+ (* it523 (- 1)) it520) 0) (not bt594)))
      (a!10 (= (+ (+ (* it522 (- 1)) it519) (- 1)) 0))
      (a!13 (and (= (+ (* it523 (- 1)) it520) 0) bt595)))
(let ((a!3 (and a!2
                (= (+ (* it521 (- 1)) it518) 0)
                (= (+ (* it522 (- 1)) it519) 0)
                (not bt596)))
      (a!4 (and (and a!2 bt595) bt596 (= (+ (* it521 (- 1)) it518) 0)))
      (a!6 (and (and a!2 bt595)
                (= (+ (* it521 (- 1)) it518) 0)
                (= (+ (* it522 (- 1)) it519) 0)
                (not bt596)
                bt597))
      (a!11 (and (= (+ (* it523 (- 1)) it520) 0)
                 bt596
                 (= (+ (* it521 (- 1)) it518) 0)
                 bt594
                 (not bt597)
      ...
      (a!14 (and a!13
                 ...
                 (not bt597)
                 (= (+ (* it521 (- 1)) (* it518 2)) 0)))
      (a!15 (or (or bt592 bt593)
                (not bt591)
                (not bt590)
                (and a!1 (not bt597) (not bt595))
                (<= (+ it520 (* it518 (- 1))) 0)))
      (a!16 (or (or (or (not bt593) bt592) (not bt591))
                (and a!1 bt597 (not bt595))
                (> it518 0)
                bt590))
      (a!17 (and a!13
                 (= (+ (* it521 (- 1)) it518) 0)
                 ...
                 (not bt596)
                 (not bt597)))
      (a!18 (and (and a!2 bt596)
                 (= (+ (* it522 (- 1)) it519) 0)
                 (not bt597)
                 (not bt595)
                 (= (+ it521 (- 1)) 0))))
(let ((a!5 (or (or bt592 bt593)
               (and a!4 (not bt597) (= (+ it522 (- 10)) 0))
               (not bt590)
               bt591))
      (a!7 (or a!6
               bt592
               ...
               (> (+ it520 (* it518 (- 1))) 0)
               (not bt590)))
      (a!8 (and a!4 (= (+ (* it522 (- 1)) it519) 0)))
      (a!9 (or (or (or (not bt593) bt592) (not bt591))
               (and a!3 (not bt597) (not bt595))
               (not bt590))))
  (and (= (+ it517 (- 2)) 0)
       (or bt593
           (not bt591)
           ...
           (not bt590)
           (and a!1 (not bt597) (not bt595)))
       (or (or bt592 bt593) (and a!3 (not bt597) (not bt595)) bt591 bt590)
       a!5
       a!7
       (or (or (not bt593) bt592) (and a!8 bt597) (not bt590) bt591)
       (or (or (not bt593) bt592) (and a!8 (not bt597)) bt591 bt590)
       (or (not bt593) (and a!1 bt597 (not bt595)) (not bt592) bt591 bt590)
       a!9
       (or a!11 bt593 (not bt591) (not bt592) bt590)
       (or (not bt593) (<= it518 0) bt592 (not bt591) a!12 bt590)
       (or (or bt593 (not bt592))
           (> it519 0)
           (and a!3 bt597 (not bt595))
           bt591
           bt590)
       (or a!14 bt593 (not bt592) (not bt590) bt591)
       a!15
       a!16
       (or (or bt593 (not bt592)) (<= it519 0) a!17 bt591 bt590)
       (or a!18 bt592 bt593 (not bt591) bt590))))))
(check-sat)
