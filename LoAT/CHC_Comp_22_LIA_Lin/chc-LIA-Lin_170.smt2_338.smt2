...
(assert (or bt1202
    ...
    bt1201
    bt1207
    (distinct (+ (* it1092 (- 1)) it1089) 0)
    (distinct (+ it1087 (* it1090 (- 1))) 0)
    bt1206
    (<= it1087 0)
    (distinct (+ it1088 (* it1091 (- 1))) 0)
    (distinct (+ it1086 (- 2)) 0)
    (not bt1204)))
(assert (let ((a!1 (and bt1205
                (= (+ it1088 (* it1091 (- 1))) 0)
                (not bt1207)
                bt1208
                bt1206
      ...
      (a!2 (and (not bt1206)
                ...
                (= (+ it1087 (* it1090 (- 1))) 0)
                (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!4 (and (and (not bt1208) (not bt1206))
                (= (+ it1088 (* it1091 (- 1))) 0)
                (not bt1207)
                (not bt1205)
                (= (+ it1087 (* it1090 (- 1))) 0)
      ...
      (a!9 (and (not bt1208)
                ...
                (= (+ it1087 (* it1090 (- 1))) 0)
                (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!10 (and (and (not bt1208) (not bt1206))
                 bt1207
                 (= (+ it1088 (* it1091 (- 1))) 0)
                 (not bt1205)
                 (= (+ it1087 (* it1090 (- 1))) 0)
      ...
      (a!13 (and (= (+ it1088 (* it1091 (- 1))) 0)
                 ...
                 (= (+ it1087 (* it1090 (- 1))) 0)
                 (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!15 (and (and (not bt1208) bt1205)
                 (= (+ it1088 (* it1091 (- 1))) 0)
                 (not bt1207)
                 bt1206
                 (= (+ it1087 (* it1090 (- 1))) 0)
                 (= (+ (* it1092 (- 1)) it1089) 0))))
(let ((a!3 (or (or bt1202 (not bt1201) bt1204)
               a!2
               (> (+ (* it1087 (- 1)) it1089) 0)
               bt1203))
      (a!7 (and a!6
                (= (+ it1087 (* it1090 (- 1))) 0)
                (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!14 (and a!6 (= (+ it1090 (- 1)) 0) (= (+ (* it1092 (- 1)) it1089) 0)))
      (a!16 (or a!15
                bt1202
                (not bt1201)
                bt1204
                (<= (+ (* it1087 (- 1)) it1089) 0)
                bt1203)))
  (and (or bt1202 (> it1087 0) bt1201 a!1 bt1203 (not bt1204))
       a!3
       (or (or bt1202 a!4) bt1204 bt1201 bt1203)
       (or (or bt1202 (not bt1201) bt1204) (not bt1203) a!5)
       (or (or bt1204 bt1201) (not bt1203) (not bt1202) a!7)
       (or a!8 (not bt1201) bt1204 (not bt1203) (not bt1202))
       (or a!9 (not bt1201) bt1204 (not bt1202) bt1203 (> it1088 0))
       (or (not bt1201) bt1204 a!10 (<= it1088 0) (not bt1202) bt1203)
       (or bt1202 bt1201 a!11 bt1203 (not bt1204) (<= it1087 0))
       (or bt1202 bt1204 bt1201 (not bt1203) a!12)
       (or (not bt1201) a!1 (not bt1202) bt1203 (not bt1204))
       (or bt1201 a!13 (not bt1202) bt1203 (not bt1204))
       (or (or bt1204 bt1201) (not bt1202) bt1203 a!14)
       (or (or bt1202 a!4) (not bt1201) bt1203 (not bt1204))
       a!16
       (= (+ it1086 (- 2)) 0)))))
(check-sat)
