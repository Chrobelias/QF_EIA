...
(assert (let ((a!1 (and (= (+ (* it466 (- 1)) it498) 0) (= (+ (* it468 (- 1)) it500) 0)))
      (a!9 (and (= (+ (* it468 (- 1)) it500) 0)
                bt535
                bt536
                (= (+ (* it467 (- 1)) it499) 0)
                (not bt537)
...
(let ((a!2 (and a!1
      ...
      (a!4 (and a!1
                ...
                bt534
                (not bt535)))
      (a!5 (and (and (and a!1 (not bt534)) bt535)
                bt537
                (= (+ (* it467 (- 1)) it499) 0)
                (not bt536)))
      (a!7 (and (and (and a!1 (not bt534)) bt535) bt536))
      (a!12 (and (and a!1 (not bt534))
                 bt537
                 (= (+ (* it467 (- 1)) it499) 0)
                 (not bt536)
                 (not bt535)))
      ...
      (a!17 (and a!1
                 ...
                 (not bt537)
                 bt534))
      (a!18 (and (and a!1 (not bt534))
                 bt536
                 bt537
                 (= (+ (* it467 (- 1)) it499) 0)
                 (not bt535))))
(let ((a!6 (or (or (or (not bt570) (not bt571)) bt572)
               bt573
               (> (+ it500 (* it498 (- 1))) 0)
               a!5))
      (a!8 (and a!7 (= (+ (* it467 (- 1)) it499) 0) (not bt537)))
      (a!10 (or (or (or (not bt570) (not bt571)) bt572)
                a!2
                bt573
                (<= (+ it500 (* it498 (- 1))) 0)))
      (a!13 (or (or (or (not bt570) (not bt571)) bt572) (not bt573) a!3))
      (a!19 (and a!7 bt537 (= (+ (* it467 (- 1)) it499) 0))))
  (and (or (or (not bt570) (not bt571)) a!2 bt573 (not bt572))
       (or (or bt572 bt570) bt573 a!3 bt571)
       (or (> it498 0) (not bt571) bt572 bt570 (not bt573) a!4)
       a!6
       (or (or bt572 bt570) (not bt573) bt571 a!8)
       (or (not bt570) a!9 bt573 (not bt572) bt571)
       a!10
       (or (or (not bt571) bt572 bt570) bt573 a!11)
       (or bt570 a!12 bt573 (> it499 0) (not bt572) bt571)
       (or bt570 (not bt573) (not bt572) bt571 a!4)
       a!13
       (= (+ it497 (- 2)) 0)
       (or (not bt571) bt570 bt573 (not bt572) a!15)
       (or a!16 (not bt570) bt572 bt573 bt571)
       (or bt570 bt573 (not bt572) bt571 (<= it499 0) a!17)
       (or (or (not bt571) bt572 bt570) (<= it498 0) (not bt573) a!18)
       (or (not bt570) bt572 (not bt573) bt571 a!19))))))
(check-sat)
