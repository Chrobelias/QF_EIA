...
(assert (and bt988
     ...
     (= (+ (* it863 (- 1)) it860) 0)))
(assert (= (+ it865 (- 2)) 0))
(assert (= (+ (* it862 (- 1)) it866) 0))
(assert (= (+ (* it863 (- 1)) it867) 0))
(assert (= (+ (* it864 (- 1)) it868) 0))
(assert (or (and (not bt992) (not bt994)) (and bt994 bt992)))
(assert (or (and bt995 bt991) (and (not bt991) (not bt995))))
(assert (or (and (not bt990) (not bt996)) (and bt996 bt990)))
(assert (or (and (not bt997) (not bt993)) (and bt997 bt993)))
(assert (and (= (+ it865 (- 2)) 0) (not bt994) bt996 bt997 (not bt995)))
(check-sat)
