...
(assert (let ((a!1 (and (= (+ it397 (* it391 (- 1))) 0)
                bt447
                (not bt445)
                (= (+ it398 (* it392 (- 1))) 0)
                (= (+ it396 (* it390 (- 1))) 0)
                (not bt448)
                (not bt446)))
      (a!2 (and (= (+ it397 (* it391 (- 1))) 0) bt446))
      (a!4 (and bt445 (= (+ it397 (* it391 (- 1))) 0)))
      (a!7 (and (= (+ it397 (* it391 (- 1))) 0)
                (not bt445)
                (= (+ it398 (* it392 (- 1))) 0)
                (not bt447)
                (= (+ it396 (* it390 (- 1))) 0)
...
(let ((a!3 (and a!2
                ...
                (not bt447)
                (not bt448)))
      (a!5 (and (and a!4 bt447)
                (= (+ (* it396 2) (* it390 (- 1))) 0)
                (= (+ it398 (* it392 (- 1))) 0)
                (not bt448)
                (not bt446)))
      (a!6 (and (and a!4 bt446)
                bt448
                (= (+ it398 (* it392 (- 1))) 0)
                (not bt447)
                (= (+ it396 (* it390 (- 1))) 0)))
      ...
      (a!11 (and a!2
                 ...
                 (not bt447)
                 (= (+ it396 (* it390 (- 1))) 0)))
      (a!12 (and (and a!4 bt447)
                 (= (+ it398 (* it392 (- 1))) 0)
                 (= (+ it396 (* it390 (- 1))) 0)
                 (not bt448)
                 (not bt446)))
      (a!13 (and (and a!4 bt446)
                 bt447
                 (= (+ it398 (* it392 (- 1))) 0)
                 (not bt448)
                 (= (+ (* it396 3) (* it390 (- 1))) 0)))
...
(let ((a!10 (or bt450
                ...
                a!9)))
  (and (= (+ it395 (- 2)) 0)
       (or a!1 (not bt450) bt451 bt452 (not bt449) (<= it397 0))
       (or a!3 (not bt450) bt449 bt451 bt452)
       (or a!5 bt449 bt450 bt452 (not bt451))
       (or a!6 (not bt450) bt451 (not bt452) (not bt449))
       (or a!7 bt449 bt450 bt451 bt452)
       (or a!7 bt450 bt451 (not bt452) (not bt449))
       (or a!6 bt449 bt450 bt451 (not bt452) (> it396 0))
       (or (<= it396 0) bt449 bt450 bt451 (not bt452) a!8)
       a!10
       (or (or (not bt450) bt449) bt451 (not bt452) a!11)
       (or (not bt450) bt452 (not bt449) (not bt451) a!12)
       (or bt450 bt452 (not bt449) (not bt451) a!13)
       (or (or (not bt450) bt449) bt452 (not bt451) a!14)
       (or (not bt450) (> it397 0) bt451 bt452 a!15 (not bt449))
       a!17)))))
(check-sat)
