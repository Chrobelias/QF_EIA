...
(assert (and (not bt1182)
     ...
     (= (+ (* it1063 (- 1)) (* it1060 2)) 0)))
(assert (= (+ it1068 (- 2)) 0))
(assert (= (+ it1069 (* it1063 (- 1))) 0))
(assert (= (+ it1070 (* it1064 (- 1))) 0))
(assert (= (+ it1071 (* it1065 (- 1))) 0))
(assert (or (and bt1182 bt1185) (and (not bt1182) (not bt1185))))
(assert (or (and bt1186 bt1181) (and (not bt1186) (not bt1181))))
(assert (or (and bt1187 bt1183) (and (not bt1183) (not bt1187))))
(assert (or (and bt1188 bt1184) (and (not bt1188) (not bt1184))))
(assert (or (not bt1186)
    bt1191
    bt1192
    bt1189
    (not bt1190)
    bt1185
    (distinct (+ (* it1072 (- 1)) it1069) 0)
    (not bt1187)
    (distinct (+ it1068 (- 2)) 0)
    (distinct (+ it1070 (* it1073 (- 1))) 0)
    (distinct (+ it1071 (* it1074 (- 1))) 0)))
(assert (let ((a!1 (and (= (+ it1071 (* it1074 (- 1))) 0)
                (= (+ it1070 (* it1073 (- 1))) 0)))
      (a!6 (or (or (or (not bt1186) (not bt1185)) bt1187) bt1188))
      (a!12 (and (= (+ (* it1072 (- 1)) (* it1069 3)) 0)
                 (= (+ it1071 (* it1074 (- 1))) 0)
                 (= (+ it1070 (* it1073 (- 1))) 0)
                 bt1190
                 bt1191
                 (not bt1192)
                 bt1189)))
(let ((a!2 (and (and (and a!1 bt1190) (not bt1192))
                (not bt1191)
                (not bt1189)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!3 (and (and a!1 bt1192 (not bt1190))
                bt1189
                (not bt1191)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!4 (and (and a!1 bt1192 (not bt1190))
                (not bt1191)
                (not bt1189)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!7 (and (and a!1 bt1191 (not bt1190) (not bt1192))
                (not bt1189)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!8 (and a!1
                (not bt1190)
                ...
                (not bt1189)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!9 (and (and (and a!1 bt1190) bt1192)
                bt1189
                (not bt1191)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!10 (and (and a!1 bt1190)
                 bt1191
                 (not bt1192)
                 (not bt1189)
                 (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!11 (and (and a!1 bt1191 (not bt1190) (not bt1192))
                 bt1189
                 (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!14 (or (or (not bt1186) bt1187)
                bt1188
                bt1185
                (and (and a!1 bt1190)
                     (= (+ it1072 (- 1)) 0)
                     ...
                     (not bt1191)
                     (not bt1189))))
      (a!15 (and (and (and a!1 bt1190) (not bt1192))
                 bt1189
                 (not bt1191)
                 (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!17 (and (and a!1 bt1191 (not bt1190) (not bt1192))
                 (= (+ (* it1072 (- 1)) (* it1069 2)) 0)
                 bt1189))
      (a!18 (and (and (and a!1 bt1190) bt1192)
                 (not bt1191)
                 (not bt1189)
                 (= (+ (* it1072 (- 1)) it1069) 0))))
(let ((a!5 (or (not bt1185)
               a!4
               bt1187
               bt1188
               (> (+ it1071 (* it1069 (- 1))) 0)
               bt1186))
      (a!13 (or (or (or (not bt1186) (not bt1185)) bt1187) (not bt1188) a!9))
      (a!16 (or (or (not bt1185) bt1187)
                bt1188
                a!15
                bt1186
                (<= (+ it1071 (* it1069 (- 1))) 0))))
  (and (or (not bt1186) bt1188 bt1185 a!2 (not bt1187))
       (or (or bt1187 bt1186) (<= it1069 0) bt1185 a!3 (not bt1188))
       a!5
       (or a!6 a!7 (<= it1070 0))
       (or (or (not bt1185) bt1187) a!8 bt1186 (not bt1188))
       (or (or bt1187 bt1186) bt1185 (> it1069 0) (not bt1188) a!9)
       (or a!6 a!10 (> it1070 0))
       (or (or (not bt1186) (not bt1185)) bt1188 a!11 (not bt1187))
       (or a!12 (not bt1185) bt1188 bt1186 (not bt1187))
       (or bt1187 bt1188 a!8 bt1186 bt1185)
       a!13
       a!14
       a!16
       (or bt1188 bt1186 bt1185 a!17 (not bt1187))
       (= (+ it1068 (- 2)) 0)
       (or (or (not bt1186) bt1187) bt1185 (not bt1188) a!18))))))
(check-sat)
