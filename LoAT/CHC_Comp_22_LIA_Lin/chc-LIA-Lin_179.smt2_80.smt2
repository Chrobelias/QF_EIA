...
(assert (or (distinct (+ (* it658 2) (* it661 (- 1))) 0)
    (not bt755)
    bt757
    (not bt752)
    (distinct (+ it660 (* it663 (- 1))) 0)
    bt751
    (distinct (+ it657 (- 2)) 0)
    (not bt754)
    (not bt750)
    (distinct (+ it659 (* it662 (- 1))) 0)
    (not bt756)))
(assert (let ((a!1 (and (= (+ it660 (* it663 (- 1))) 0)
                (not bt756)
                (= (+ it658 (* it661 (- 1))) 0)))
      (a!5 (and (= (+ it660 (* it663 (- 1))) 0) (= (+ it658 (* it661 (- 1))) 0)))
      (a!15 (and (= (+ it660 (* it663 (- 1))) 0)
                 bt754
                 (= (+ it659 (* it662 (- 1))) 0)
                 bt755
                 bt756
      ...
      (a!17 (and (= (+ it660 (* it663 (- 1))) 0)
                 ...
                 (not bt757)
                 (= (+ it661 (- 1)) 0)))
      (a!18 (= (+ (+ it659 (* it662 (- 1))) (- 1)) 0)))
(let ((a!2 (and (and a!1 bt757) (= (+ it659 (* it662 (- 1))) 0)))
      (a!4 (and (and a!1 bt757)
                bt754
                (= (+ it659 (* it662 (- 1))) 0)
                (not bt755)))
      (a!6 (and a!5
                ...
                bt756
                (not bt757)))
      (a!7 (and a!5 bt757 (= (+ it659 (* it662 (- 1))) 0)))
      (a!8 (and a!1 bt754 (= (+ it659 (* it662 (- 1))) 0)))
      (a!10 (or bt753
                (and a!5
                     (not bt754)
                     (= (+ it662 (- 10)) 0)
      ...
      (a!11 (and a!1
                 ...
                 (not bt754)
                 (not bt757)))
      (a!16 (or (or (or (not bt752) bt753) (not bt750)) bt751 a!15)))
(let ((a!3 (or (or bt753 (not bt750) bt752)
               (and a!2 (not bt754) bt755)
               (> (+ (* it658 (- 1)) it660) 0)
               (not bt751)))
      (a!9 (or (or (or (not bt752) bt753) bt751 bt750)
               (<= it659 0)
               (and a!8 bt755 (not bt757))))
      (a!12 (or (or (or (not bt752) bt753) (not bt750))
                (not bt751)
                (and a!8 (not bt755) (not bt757))))
      (a!13 (or (or (or (not bt752) bt753) bt751 bt750)
                (> it659 0)
                (and a!2 (not bt755) (not bt754))))
      (a!14 (or (or bt753 (not bt750) bt752)
                (not bt751)
                (<= (+ (* it658 (- 1)) it660) 0)
                (and a!8 (not bt755) (not bt757)))))
  (and a!3
       (= (+ it657 (- 2)) 0)
       (or (not bt752) (not bt753) bt751 bt750 a!4)
       (or (not bt753) bt751 bt752 bt750 a!6)
       (or (or (not bt753) (not bt750))
           bt751
           bt752
           (and a!7 (not bt754) bt755 bt756))
       (or (or (not bt753) bt752 bt750 (not bt751)) (> it658 0) a!4)
       a!9
       a!10
       (or bt753 bt751 bt752 bt750 a!11)
       a!12
       a!13
       (or (or (not bt753) bt752 bt750 (not bt751))
           (and a!7 (not bt755) (not bt754) bt756)
           (<= it658 0))
       a!14
       a!16
       (or bt753 bt752 a!17 bt750 (not bt751))
       (or (or (not bt752) bt753)
           bt750
           (not bt751)
           (and a!5 bt754 (not bt755) bt756 (not bt757) a!18))
       (or (or (not bt753) (not bt750)) bt752 (not bt751) a!11))))))
(check-sat)
