...
(assert (let ((a!1 (and (= (+ (* it807 (- 1)) it839) 0)
                (= (+ (* it809 (- 1)) it841) 0)
                (= (+ (* it808 (- 1)) it840) 0)
                bt931))
      (a!2 (and (not bt933)
                (= (+ (* it807 (- 1)) it839) 0)
                (= (+ (* it809 (- 1)) it841) 0)))
      (a!5 (and (and (not bt931) (not bt933))
                (= (+ (* it807 (- 1)) it839) 0)
                (= (+ (* it809 (- 1)) it841) 0)))
      (a!8 (and (not bt933)
                (= (+ (* it809 (- 1)) it841) 0)
      ...
      (a!12 (and (= (+ it808 (- 10)) 0)
                 ...
                 bt932
                 (not bt930)))
      (a!18 (and (and (not bt931) (not bt933))
                 (= (+ (* it809 (- 1)) it841) 0)
                 (= (+ (* it808 (- 1)) it840) 0)
                 bt932
                 (not bt930)
                 (= (+ it807 (- 1)) 0))))
(let ((a!3 (and a!2 (= (+ (* it808 (- 1)) it840) 0) bt931 bt932 (not bt930)))
      (a!4 (or (or (or (not bt966) (not bt967)) bt969)
               (> (+ (* it839 (- 1)) it841) 0)
               bt968
               (and a!1 bt933 (not bt930) (not bt932))))
      (a!6 (and (and a!5 bt930) (= (+ (* it808 (- 1)) it840) 0) (not bt932)))
      (a!11 (and a!10 (= (+ (* it808 (- 1)) it840) 0)))
      (a!13 (and a!10 bt930 (= (+ (* it808 (- 1)) it840) 0) bt933 (not bt932)))
      (a!14 (and a!5 (= (+ (* it808 (- 1)) it840) 0) (not bt930) (not bt932)))
      (a!15 (and a!2 bt930 (= (+ (* it808 (- 1)) it840) 0) bt931 (not bt932))))
(let ((a!7 (or (or (or (not bt966) (not bt967)) bt969)
               a!6
               bt968
               (<= (+ (* it839 (- 1)) it841) 0)))
      (a!16 (or (or (or bt966 (not bt968)) bt969) (<= it840 0) a!15 bt967))
      (a!17 (or (or (or bt966 (not bt968)) bt969)
                (and a!11 bt933 (not bt930) (not bt932))
                (> it840 0)
                bt967)))
  (and (or (not bt966)
           (and a!1 bt932 bt933 (not bt930))
           (not bt969)
           bt967
           bt968)
       (or bt966 a!3 (not bt969) bt967 bt968)
       a!4
       a!7
       (or (or (not bt968) (not bt966)) bt969 a!8 bt967)
       (or (or bt966 (not bt968))
           (not bt967)
           bt969
           (and (and a!5 bt930) bt932 a!9))
       (or (<= it839 0)
           bt966
           (and a!11 bt932 bt933 (not bt930))
           (not bt967)
           (not bt969)
           bt968)
       (or (not bt966) bt969 a!12 bt967 bt968)
       (or (or bt966 (not bt968)) (not bt969) a!13 bt967)
       (or (or (not bt966) (not bt967)) a!14 (not bt969) bt968)
       a!16
       (or (or (not bt968) (not bt966)) (not bt967) bt969 a!6)
       (or bt966 bt969 a!14 bt967 bt968)
       a!17
       (or a!18 bt966 (not bt967) bt969 bt968)
       (or bt966 (not bt967) (not bt969) a!13 (> it839 0) bt968)
       (= (+ it838 (- 2)) 0))))))
(check-sat)
