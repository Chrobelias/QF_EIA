...
(assert (let ((a!1 (and (= (+ (* it456 3) (* it459 (- 1))) 0)
                (= (+ it458 (* it461 (- 1))) 0)
                (not bt516)
                bt513
                bt515
                bt514
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!2 (and (not bt514) (= (+ it458 (* it461 (- 1))) 0)))
      (a!6 (and (= (+ it458 (* it461 (- 1))) 0) (= (+ it456 (* it459 (- 1))) 0)))
      (a!12 (and (= (+ it459 (- 1)) 0)
                 (= (+ it458 (* it461 (- 1))) 0)
                 (not bt513)
                 (not bt516)
                 ...
                 bt514
                 (= (+ (* it460 (- 1)) it457) 0))))
(let ((a!3 (and a!2 (= (+ it456 (* it459 (- 1))) 0)))
      (a!7 (and a!6
                (not bt515)
                bt513
                bt516
                bt514
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!8 (and (and (and a!6 (not bt513)) (not bt516))
                bt515
                bt514
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!11 (and (and (and a!6 (not bt513)) (not bt516))
                 (not bt515)
                 bt514
                 (= (+ (* it460 (- 1)) it457) 0)))
      (a!15 (and (and a!6 (not bt513))
                 (not bt515)
                 bt516
                 bt514
                 (= (+ (* it460 (- 1)) it457) 0)))
      ...
      (a!18 (and a!2
                 ...
                 (= (+ (* it460 (- 1)) it457) 0)
                 (= (+ (* it456 2) (* it459 (- 1))) 0))))
(let ((a!4 (and a!3 (not bt515) bt513 bt516 (= (+ (* it460 (- 1)) it457) 0)))
      (a!5 (and (and (and a!3 (not bt513)) (not bt516))
                (not bt515)
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!9 (and (and a!3 (not bt513))
                (not bt515)
                bt516
                (= (+ (* it460 (- 1)) it457) 0)))
      (a!13 (and (and (and a!3 (not bt513)) (not bt516))
                 bt515
                 (= (+ (* it460 (- 1)) it457) 0)))
      (a!14 (and a!3 (not bt516) bt513 bt515 (= (+ (* it460 (- 1)) it457) 0)))
      (a!17 (or (or bt510 bt511)
                (<= (+ (* it456 (- 1)) it458) 0)
                (not bt509)
                bt512
                a!16)))
(let ((a!10 (or (or (or bt510 bt511) (not bt509))
                a!9
                bt512
                (> (+ (* it456 (- 1)) it458) 0))))
  (and (or bt510 (not bt509) a!1 bt512 (not bt511))
       (or (or (or bt510 bt511) bt509) (not bt512) (<= it456 0) a!4)
       (or (or (or bt510 bt511) (not bt509)) a!5 (not bt512))
       (or (or (or bt510 bt511) bt509) a!7 (not bt512) (> it456 0))
       (or (or bt511 (not bt509)) a!8 (> it457 0) bt512 (not bt510))
       a!10
       (or bt509 a!11 bt512 (not bt511) (not bt510))
       (or bt511 a!12 bt509 bt512 (not bt510))
       (or (or bt511 (not bt509)) (<= it457 0) a!13 bt512 (not bt510))
       (or (or bt511 (not bt509)) a!7 (not bt512) (not bt510))
       (or (or (or bt510 bt511) bt509) a!5 bt512)
       (or a!14 (not bt509) bt512 (not bt511) (not bt510))
       (or bt511 bt509 (not bt512) a!15 (not bt510))
       a!17
       (= (+ it455 (- 2)) 0)
       (or bt510 bt509 bt512 (not bt511) a!18)))))))
(check-sat)
