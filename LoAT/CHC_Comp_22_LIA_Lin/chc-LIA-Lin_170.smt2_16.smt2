...
(declare-fun bt201 () Bool)
(declare-fun bt203 () Bool)
(declare-fun it177 () Int)
(declare-fun bt204 () Bool)
(declare-fun it179 () Int)
(declare-fun bt202 () Bool)
...
(assert (let ((a!1 (and (= (+ (* it178 (- 1)) it175) 0)
                (not bt202)
                (= (+ (* it179 (- 1)) it176) 0)))
      (a!7 (and (= (+ (* it178 (- 1)) it175) 0) (= (+ (* it179 (- 1)) it176) 0))))
(let ((a!2 (and a!1 (= (+ (* it177 (- 1)) it174) 0)))
      (a!8 (and a!7 (= (+ (* it177 (- 1)) it174) 0)))
      (a!11 (and (and a!7 (not bt204))
                 bt202
                 (= (+ (* it177 (- 1)) (* it174 3)) 0)
                 bt203
                 bt201))
      (a!13 (or (and (and a!7 (not bt204))
                     (not bt201)
                     bt202
                     (not bt203)
                     (= (+ it177 (- 1)) 0))
      ...
      (a!17 (and a!1
                 ...
                 bt203
                 bt201)))
(let ((a!3 (or (or (or bt200 (not bt197)) (not bt199))
               (not bt198)
               (and (and a!2 (not bt204)) bt203 bt201)))
      (a!4 (and (and (and a!2 (not bt204)) (not bt201)) (not bt203)))
      (a!5 (or (> (+ it176 (* it174 (- 1))) 0)
               bt200
               (not bt197)
               (and (and a!2 bt204) (not bt201) (not bt203))
               bt198
               bt199))
      (a!6 (or (or (or (not bt200) bt197) bt198)
               (<= it174 0)
               bt199
               (and (and a!2 bt204) bt201 (not bt203))))
      (a!9 (or (<= (+ it176 (* it174 (- 1))) 0)
               bt200
               (not bt197)
               (and (and a!8 (not bt204)) bt202 bt201 (not bt203))
               bt198
               bt199))
      (a!10 (and (and (and a!8 (not bt204)) (not bt201) bt202) bt203))
      (a!12 (or (or (or bt200 (not bt197)) (not bt199)) a!11 bt198))
      (a!14 (or (or (or (not bt200) bt197) bt198)
                bt199
                (> it174 0)
                (and (and a!8 bt204) bt202 bt201 (not bt203))))
      (a!15 (and (and (and a!8 (not bt204)) (not bt201) bt202) (not bt203)))
      (a!16 (and (and (and a!2 (not bt204)) (not bt201)) bt203)))
  (and a!3
       (or (or bt200 bt197) bt198 bt199 a!4)
       a!5
       (= (+ it173 (- 2)) 0)
       a!6
       (or (or (not bt200) bt197)
           (not bt198)
           bt199
           (and (and a!8 bt204) (not bt201) bt202 (not bt203)))
       a!9
       (or (or bt200 (not bt197)) a!10 (> it175 0) (not bt198) bt199)
       a!12
       a!13
       a!14
       (or (or bt200 bt197) (not bt199) (not bt198) a!15)
       (or (or (not bt197) (not bt200)) bt198 bt199 a!4)
       (or (or (not bt197) (not bt200))
           (not bt198)
           bt199
           (and (and a!8 bt204) bt202 bt201 (not bt203)))
       (or (<= it175 0) bt200 (not bt197) (not bt198) a!16 bt199)
       (or a!17 bt200 bt197 (not bt199) bt198))))))
(check-sat)
