...
(declare-fun bt598 () Bool)
(declare-fun bt599 () Bool)
(declare-fun bt600 () Bool)
...
(assert (and (not bt595)
     ...
     bt590))
(assert (= (+ it524 (- 2)) 0))
(assert (= (+ (* it521 (- 1)) it525) 0))
(assert (= (+ (* it522 (- 1)) it526) 0))
(assert (= (+ (* it523 (- 1)) it527) 0))
(assert (or (and bt596 bt598) (and (not bt598) (not bt596))))
(assert (or (and (not bt595) (not bt599)) (and bt595 bt599)))
(assert (or (and (not bt594) (not bt600)) (and bt594 bt600)))
(assert (or (and bt601 bt597) (and (not bt597) (not bt601))))
(assert (and (not bt598) bt600 bt601 (not bt599) (= (+ it524 (- 2)) 0)))
(check-sat)
