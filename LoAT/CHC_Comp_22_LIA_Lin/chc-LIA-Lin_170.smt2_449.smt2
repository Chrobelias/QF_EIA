...
(assert (or bt1422
    ...
    (not bt1421)
    (> (+ (* it1306 (- 1)) it1308) 0)))
(assert (or (distinct (+ it1307 (* it1041 (- 1))) 0)
    bt1422
    bt1424
    bt1423
    (distinct (+ (* it1040 (- 1)) it1306) 0)
    ...
    (not bt1421)
    (not bt1162)))
(assert (let ((a!1 (and (= (+ (* it1040 (- 1)) it1306) 0) (not bt1163)))
      (a!3 (and (not bt1164)
                bt1162
                bt1163
                (= (+ (* it1040 (- 1)) (* it1306 3)) 0)
                ...
                (= (+ it1307 (* it1041 (- 1))) 0)
                (= (+ it1308 (* it1042 (- 1))) 0)))
      (a!4 (and (not bt1164) (= (+ (* it1040 (- 1)) it1306) 0)))
      (a!15 (and (= (+ (* it1040 (- 1)) (* it1306 2)) 0)
                 (not bt1164)
                 (not bt1162)
                 bt1163
                 bt1161
      ...
      (a!16 (and (= (+ it1040 (- 1)) 0)
                 ...
                 (= (+ it1308 (* it1042 (- 1))) 0)
                 (not bt1161))))
(let ((a!2 (and (and a!1 bt1162 bt1164)
                (= (+ it1307 (* it1041 (- 1))) 0)
                (= (+ it1308 (* it1042 (- 1))) 0)
                (not bt1161)))
      (a!5 (and a!4
                ...
                (= (+ it1308 (* it1042 (- 1))) 0)
                (not bt1161)))
      (a!7 (and (and a!1 (not bt1162) bt1164)
                (= (+ it1307 (* it1041 (- 1))) 0)
                (= (+ it1308 (* it1042 (- 1))) 0)
                (not bt1161)))
      (a!9 (and (and (and a!4 (not bt1163)) bt1162)
                (= (+ it1307 (* it1041 (- 1))) 0)
                (= (+ it1308 (* it1042 (- 1))) 0)
                (not bt1161)))
      (a!10 (and (and (and a!4 (not bt1163)) bt1162)
                 bt1161
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0)))
      (a!12 (and (and a!1 bt1162 bt1164)
                 bt1161
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0)))
      (a!13 (and (and a!4 (not bt1162) bt1163)
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0)
                 (not bt1161)))
      (a!17 (or (or (or (not bt1422) bt1424) bt1423) bt1421 a!16))
      (a!18 (and (and a!1 (not bt1162) bt1164)
                 bt1161
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0)))
      (a!19 (and (and a!4 (not bt1163))
                 (not bt1162)
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0)
                 (not bt1161)))
      (a!20 (and (and a!4 (not bt1162) bt1163)
                 bt1161
                 (= (+ it1307 (* it1041 (- 1))) 0)
                 (= (+ it1308 (* it1042 (- 1))) 0))))
(let ((a!6 (or (or (or (not bt1422) bt1424) bt1423)
               (> it1307 0)
               a!5
               (not bt1421)))
      (a!8 (or (or (or bt1422 bt1424) bt1423)
               (> (+ (* it1306 (- 1)) it1308) 0)
               a!7
               (not bt1421)))
      (a!11 (or (or (or bt1422 bt1424) bt1423)
                (<= (+ (* it1306 (- 1)) it1308) 0)
                a!10
                (not bt1421)))
      (a!14 (or (or (or (not bt1422) bt1424) bt1423)
                (<= it1307 0)
                a!13
                (not bt1421))))
  (and (or (or (not bt1422) bt1423) bt1421 (not bt1424) a!2)
       (or (or bt1422 bt1424) a!3 (not bt1423) (not bt1421))
       a!6
       (= (+ it1305 (- 2)) 0)
       a!8
       (or (or (not bt1422) bt1424) bt1421 (not bt1423) a!9)
       a!11
       (or (or (or bt1422 bt1423) bt1421 (not bt1424)) a!12 (> it1306 0))
       a!14
       (or (or bt1422 bt1424) bt1421 a!15 (not bt1423))
       a!17
       (or (or (or bt1422 bt1423) bt1421 (not bt1424)) a!18 (<= it1306 0))
       (or (or (or bt1422 bt1424) bt1423) bt1421 a!19)
       (or (or (not bt1422) bt1423) (not bt1424) a!12 (not bt1421))
       (or (or (not bt1422) bt1424) a!20 (not bt1423) (not bt1421))
       (or (or bt1422 bt1423) a!19 (not bt1424) (not bt1421)))))))
(check-sat)
