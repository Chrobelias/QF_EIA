...
(assert (or bt1227
    (distinct (+ (* it1117 (- 1)) it1114) 0)
    bt1225
    bt1226
    (distinct (+ (* it1118 (- 1)) it1115) 0)
    bt1228
    bt1229
    bt1230
    (distinct (+ (* it1116 (- 1)) it1113) 0)
    bt1231
    bt1232
    (distinct (+ it1112 (- 2)) 0)))
(assert (let ((a!1 (and (not bt1231)
                (= (+ (* it1117 (- 1)) it1114) 0)
                (= (+ (* it1118 (- 1)) it1115) 0)))
      (a!4 (and (= (+ (* it1117 (- 1)) it1114) 0)
                (= (+ (* it1118 (- 1)) it1115) 0))))
(let ((a!2 (and a!1 (= (+ (* it1116 (- 1)) it1113) 0)))
      (a!5 (and a!4 (= (+ (* it1116 (- 1)) it1113) 0)))
      (a!8 (and a!4
                (= (+ (* it1116 (- 1)) (* it1113 3)) 0)
                bt1229
                bt1230
      ...
      (a!14 (or bt1227
                ...
                bt1228
                (not bt1226))))
(let ((a!3 (or (or (or bt1227 bt1225) bt1226)
               (and (and a!2 (not bt1230)) bt1229 bt1232)
               (not bt1228)
               (<= it1113 0)))
      (a!6 (or (and (and a!5 (not bt1230)) (not bt1229) (not bt1232) bt1231)
               bt1227
               (not bt1225)
               (<= it1114 0)
               bt1228
               (not bt1226)))
      (a!7 (or (and (and a!2 (not bt1229) bt1230) (not bt1232))
               bt1225
               (not bt1227)
               bt1228
               (not bt1226)))
      (a!9 (or (not bt1227)
               (not bt1225)
               bt1228
               (and (and a!5 (not bt1230)) bt1229 (not bt1232) bt1231)
               (not bt1226)))
      (a!10 (and (and (and a!2 (not bt1230)) (not bt1229)) (not bt1232)))
      (a!12 (and (and (and a!2 (not bt1230)) (not bt1229)) bt1232))
      (a!15 (or (or bt1227 bt1225)
                (and (and a!2 (not bt1229) bt1230) bt1232)
                (not bt1226)
                (not bt1228)))
      (a!16 (or bt1227
                (<= (+ (* it1113 (- 1)) it1115) 0)
                ...
                (not bt1225)
                bt1228
                (and (and a!2 bt1229 bt1230) (not bt1232)))))
(let ((a!13 (or (or bt1227 bt1226 (not bt1225))
                bt1228
                a!12
                (> (+ (* it1113 (- 1)) it1115) 0))))
  (and a!3
       ...
       a!7
       (= (+ it1112 (- 2)) 0)
       (or (or bt1227 (not bt1225))
           (and (and a!2 bt1229 bt1230) bt1232)
           (not bt1226)
           (not bt1228))
       (or a!8 bt1226 (not bt1227) (not bt1225) bt1228)
       a!9
       (or (or bt1227 bt1226 (not bt1225)) a!10 (not bt1228))
       (or bt1225 bt1226 a!11 (not bt1227) bt1228)
       a!13
       (or (or (or bt1227 bt1225) bt1226)
           (and (and a!2 bt1229 bt1230) bt1232)
           (> it1113 0)
           (not bt1228))
       a!14
       a!15
       (or (or (or bt1227 bt1225) bt1226) bt1228 a!10)
       a!16
       (or (or bt1227 (not bt1225))
           (and a!5 (not bt1229) bt1230 (not bt1232) bt1231)
           bt1228
           (> it1114 0)
           (not bt1226))))))))
(check-sat)
