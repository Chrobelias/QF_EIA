...
(assert (or bt1218
    ...
    (not bt1217)
    (not bt1220)
    (distinct (+ (* it1108 (- 1)) it1105) 0)
    (distinct (+ it1103 (- 2)) 0)
    bt1222
    bt1223
    (distinct (+ (* it1109 (- 1)) it1106) 0)
    (distinct (+ it1104 (* it1107 (- 1))) 0)))
(assert (let ((a!1 (and (= (+ (* it1108 (- 1)) it1105) 0) (not bt1224)))
      (a!3 (and (= (+ (* it1108 (- 1)) it1105) 0)
                bt1224
                (= (+ it1104 (* it1107 (- 1))) 0)
                (not bt1221)
                (= (+ (* it1109 (- 1)) it1106) 0)))
      (a!5 (and (= (+ (* it1108 (- 1)) it1105) 0)
                bt1221
                bt1224
                (= (+ it1104 (* it1107 (- 1))) 0)
                (= (+ (* it1109 (- 1)) it1106) 0))))
(let ((a!2 (and a!1
                ...
                bt1222
                (not bt1223)))
      (a!4 (and (and a!1 bt1221)
                (= (+ it1104 (* it1107 (- 1))) 0)
                (= (+ (* it1109 (- 1)) it1106) 0)))
      (a!6 (or (or (or bt1219 (not bt1220) bt1218) bt1217)
               (and a!5 (not bt1222) (not bt1223))
               (<= it1104 0)))
      (a!7 (and (and a!1 bt1221) (= (+ (* it1109 (- 1)) it1106) 0)))
      (a!9 (or (or (or bt1219 bt1220) bt1218)
               (not bt1217)
               (> (+ it1106 (* it1104 (- 1))) 0)
               (and a!3 (not bt1222) (not bt1223))))
      (a!10 (or (or (or bt1219 (not bt1220) bt1218) bt1217)
                (> it1104 0)
                (and a!5 bt1222 (not bt1223))))
      (a!11 (and a!1
                 (= (+ it1104 (* it1107 (- 1))) 0)
                 (not bt1221)
                 (= (+ (* it1109 (- 1)) it1106) 0))))
(let ((a!8 (and a!7 bt1222 bt1223 (= (+ (* it1104 3) (* it1107 (- 1))) 0)))
      (a!12 (and a!7
                 bt1223
                 (= (+ (* it1104 2) (* it1107 (- 1))) 0)
                 (not bt1222)))
      (a!13 (or (or (or bt1219 bt1220) bt1218)
                (and a!4 bt1222 (not bt1223))
                (not bt1217)
                (<= (+ it1106 (* it1104 (- 1))) 0))))
  (and (or (or (or bt1219 bt1220) (not bt1218)) bt1217 a!2)
       (or (or bt1219 (not bt1218) (not bt1220))
           bt1217
           (and a!3 bt1222 (not bt1223)))
       (or (or bt1220 (not bt1218))
           (and a!4 bt1223 (not bt1222))
           (not bt1219)
           (not bt1217))
       a!6
       (or (or bt1220 bt1218 (not bt1219)) (not bt1217) a!8)
       a!9
       a!10
       (or (or (or bt1219 bt1220) (not bt1218))
           (and (and a!11 bt1222) bt1223)
           (not bt1217)
           (> it1105 0))
       (or (or bt1220 bt1218 (not bt1219)) bt1217 a!12)
       (or (or bt1219 (not bt1218) (not bt1220))
           (not bt1217)
           (and a!5 bt1222 (not bt1223)))
       (or (or bt1219 (not bt1220) bt1218)
           (and a!11 (not bt1222) (not bt1223))
           (not bt1217))
       (or (or (or bt1219 bt1220) (not bt1218))
           (<= it1105 0)
           (not bt1217)
           (and a!11 bt1223 (not bt1222)))
       (or (or (or bt1219 bt1220) bt1218)
           (and a!11 (not bt1222) (not bt1223))
           bt1217)
       (= (+ it1103 (- 2)) 0)
       a!13
       (or (or bt1220 (not bt1218))
           (not bt1219)
           bt1217
           (and (and a!11 bt1222) (not bt1223))))))))
(check-sat)
