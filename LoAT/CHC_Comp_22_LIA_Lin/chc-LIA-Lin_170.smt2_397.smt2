...
(assert (or (distinct (+ it1321 (* it1324 (- 1))) 0)
    (distinct (+ (* it1323 (- 1)) (* it1320 3)) 0)
    (not bt1439)
    (not bt1438)
    bt1440
    (not bt1433)
    ...
    bt1434
    (distinct (+ it1319 (- 2)) 0)
    (distinct (+ (* it1325 (- 1)) it1322) 0)
    (not bt1437)))
(assert (let ((a!1 (and (= (+ (* it1323 (- 1)) it1320) 0) (not bt1438)))
      (a!3 (and bt1439 (= (+ (* it1323 (- 1)) it1320) 0)))
      (a!5 (and bt1439
                bt1437
                bt1438
                (not bt1440)
                ...
                (= (+ (* it1323 (- 1)) (* it1320 3)) 0)
                (= (+ (* it1325 (- 1)) it1322) 0)))
      (a!6 (and (= (+ (* it1323 (- 1)) it1320) 0) (not bt1439) bt1438))
      (a!10 (and (= (+ (* it1323 (- 1)) it1320) 0) bt1437 (not bt1439) bt1438))
      (a!12 (and (= (+ it1323 (- 1)) 0)
                 (not bt1439)
                 bt1438
                 (not bt1440)
      ...
      (a!18 (and bt1439
                 ...
                 (= (+ (* it1323 (- 1)) (* it1320 2)) 0)
                 (= (+ (* it1325 (- 1)) it1322) 0))))
(let ((a!2 (and (and a!1 (not bt1439))
                (not bt1440)
                (= (+ it1321 (* it1324 (- 1))) 0)
                (not bt1437)
                (= (+ (* it1325 (- 1)) it1322) 0)))
      (a!4 (and (and a!3 (not bt1438))
                bt1437
                (not bt1440)
                (= (+ it1321 (* it1324 (- 1))) 0)
                (= (+ (* it1325 (- 1)) it1322) 0)))
      ...
      (a!11 (and a!10
                 ...
                 (= (+ it1321 (* it1324 (- 1))) 0)
                 (= (+ (* it1325 (- 1)) it1322) 0)))
      (a!13 (or (or (or (not bt1434) bt1433) bt1435) bt1436 a!12))
      (a!14 (and a!1
                 bt1437
                 (not bt1439)
                 bt1440
      ...
      (a!19 (and a!3
                 ...
                 (not bt1437)
                 (= (+ (* it1325 (- 1)) it1322) 0)))
      (a!20 (and (and a!1 (not bt1439))
                 bt1440
                 (= (+ it1321 (* it1324 (- 1))) 0)
                 (not bt1437)
                 (= (+ (* it1325 (- 1)) it1322) 0))))
(let ((a!9 (or (or (or (not bt1434) bt1433) bt1435) (not bt1436) a!8))
      (a!16 (or (not bt1433)
                (<= (+ it1322 (* it1320 (- 1))) 0)
                bt1435
                bt1434
      ...
      (a!21 (or (not bt1433)
                ...
                bt1434
                bt1436)))
  (and (or bt1433 bt1435 bt1434 bt1436 a!2)
       (or (or (not bt1434) (not bt1433)) bt1436 (not bt1435) a!4)
       (or (not bt1433) a!5 bt1434 bt1436 (not bt1435))
       (or (or (not bt1434) bt1433) a!7 bt1436 (not bt1435))
       a!9
       (or (or (not bt1434) (not bt1433)) a!11 bt1435 (not bt1436))
       (or (not bt1433) bt1435 bt1434 (not bt1436) a!2)
       (or bt1433 a!11 bt1435 bt1434 (> it1320 0) (not bt1436))
       a!13
       (or bt1433 a!14 bt1435 bt1434 (not bt1436) (<= it1320 0))
       (= (+ it1319 (- 2)) 0)
       a!16
       (or (or (not bt1434) (not bt1433)) (<= it1321 0) a!17 bt1435 bt1436)
       (or bt1433 a!18 bt1434 bt1436 (not bt1435))
       (or (or (not bt1434) (not bt1433)) (> it1321 0) bt1435 a!19 bt1436)
       a!21)))))
(check-sat)
