...
(assert (let ((a!1 (and (and bt1174 bt1175 (not bt1176))
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                (= (+ (* it1056 (- 1)) it1053) 0)
                (not bt1173)))
      (a!2 (and (and bt1174 (not bt1176))
                (= (+ it1056 (- 1)) 0)
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                (not bt1175)
                (not bt1173)))
      (a!3 (and (and bt1175 (not bt1174) (not bt1176))
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                (= (+ (* it1056 (- 1)) it1053) 0)))
      (a!4 (and (and bt1174 bt1175 (not bt1176))
                (= (+ (* it1056 (- 1)) (* it1053 3)) 0)
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                bt1173))
      (a!5 (and (and bt1174 (not bt1176))
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                (not bt1175)
                (= (+ (* it1056 (- 1)) it1053) 0)))
      (a!6 (and (and bt1175 (not bt1174) (not bt1176))
                (= (+ (* it1056 (- 1)) (* it1053 2)) 0)
                (= (+ (* it1058 (- 1)) it1055) 0)
                (= (+ it1054 (* it1057 (- 1))) 0)
                bt1173))
      ...
      (a!10 (and bt1176
                 ...
                 (not bt1175)
                 (= (+ (* it1056 (- 1)) it1053) 0))))
(let ((a!9 (or (or bt1170 bt1171)
               (<= (+ (* it1053 (- 1)) it1055) 0)
               (not bt1169)
               (and a!5 bt1173)
               bt1172))
      (a!11 (or (or bt1170 bt1171)
                (and a!10 (not bt1173))
                (not bt1169)
                (> (+ (* it1053 (- 1)) it1055) 0)
                bt1172)))
  (and (or (or (not bt1170) bt1171) (> it1054 0) a!1 (not bt1169) bt1172)
       (or (or (not bt1170) bt1169) bt1171 a!2 bt1172)
       (or (or (not bt1170) bt1171)
           (<= it1054 0)
           (and a!3 (not bt1173))
           (not bt1169)
           bt1172)
       (= (+ it1052 (- 2)) 0)
       (or bt1170 (not bt1169) a!4 (not bt1171) bt1172)
       (or (or (not bt1170) bt1169) (and a!5 (not bt1173)) (not bt1171) bt1172)
       (or (or bt1169 bt1170) a!6 (not bt1171) bt1172)
       (or (or bt1169 bt1170) bt1171 bt1172 a!7)
       (or (not bt1170) (not bt1172) bt1171 (not bt1169) (and a!8 bt1173))
       a!9
       (or (or (not bt1170) bt1169) (not bt1172) bt1171 (and a!8 (not bt1173)))
       (or (not bt1170) (not bt1169) (not bt1171) (and a!3 bt1173) bt1172)
       (or (or bt1169 (not bt1172) bt1170 bt1171)
           (and a!10 bt1173)
           (<= it1053 0))
       a!11
       (or (not bt1172) bt1170 bt1171 (not bt1169) a!7)
       (or (or bt1169 (not bt1172) bt1170 bt1171) (and a!8 bt1173) (> it1053 0))))))
(check-sat)
