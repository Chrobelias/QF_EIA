...
(assert (let ((a!1 (and bt373
      ...
      (a!7 (and (not bt374)
                ...
                (not bt375)
                (not bt373)))
      (a!9 (and (and (and bt373 bt375) (not bt374) (not bt376))
                (= (+ (* it330 (- 1)) it327) 0)
                (= (+ (* it332 (- 1)) it329) 0)
                (= (+ (* it331 (- 1)) it328) 0)))
      (a!10 (and (= (+ it330 (- 1)) 0)
      ...
      (a!11 (and bt375
                 ...
                 (= (+ (* it331 (- 1)) it328) 0)
                 (not bt373)))
      (a!12 (and (and (and bt373 bt375) (not bt374) (not bt376))
                 (= (+ (* it332 (- 1)) it329) 0)
                 (= (+ (* it331 (- 1)) it328) 0)
                 (= (+ (* it330 (- 1)) (* it327 2)) 0)))
      (a!13 (and bt373
                 ...
                 (= (+ (* it331 (- 1)) it328) 0)
                 (not bt375)))
      (a!15 (and (and bt373 bt375)
                 (= (+ (* it330 (- 1)) (* it327 3)) 0)
                 (not bt376)
                 bt374
                 (= (+ (* it332 (- 1)) it329) 0)
                 (= (+ (* it331 (- 1)) it328) 0))))
(let ((a!8 (or (> (+ (* it327 (- 1)) it329) 0)
               a!7
               bt371
               (not bt369)
               bt370
      ...
      (a!14 (or a!13
                ...
                bt370
                bt372)))
  (and (or (or bt371 bt369) bt370 (not bt372) (<= it327 0) a!1)
       (or (> it327 0) bt371 bt369 a!2 bt370 (not bt372))
       (or a!3 bt371 (not bt369) (> it328 0) (not bt370) bt372)
       (or (or bt371 bt369) (not bt372) a!4 (not bt370))
       (or (or bt371 (not bt369)) a!5 bt370 (not bt372))
       (or bt369 (not bt371) (not bt370) bt372 a!6)
       a!8
       (or (not bt369) (not bt371) (not bt370) a!9 bt372)
       (or bt371 a!5 bt369 bt370 bt372)
       (or bt371 a!10 bt369 (not bt370) bt372)
       (or (or bt371 (not bt369)) a!2 (not bt372) (not bt370))
       (or (or bt371 (not bt369)) (<= it328 0) a!11 (not bt370) bt372)
       (= (+ it326 (- 2)) 0)
       (or a!12 bt369 (not bt371) bt370 bt372)
       a!14
       (or (not bt369) a!15 (not bt371) bt370 bt372)))))
(check-sat)
