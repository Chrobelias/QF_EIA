...
(assert (or (distinct (+ it1326 (- 2)) 0)
    (distinct (+ it1328 (* it1331 (- 1))) 0)
    bt1448
    (not bt1441)
    bt1446
    (not bt1442)
    (distinct (+ it1327 (* it1330 (- 1))) 0)
    (not bt1445)
    (not bt1447)
    (not bt1443)
    (distinct (+ (* it1332 (- 1)) it1329) 0)))
(assert (let ((a!1 (and (not bt1447) (= (+ it1328 (* it1331 (- 1))) 0) bt1448))
      (a!5 (and (= (+ (* it1327 2) (* it1330 (- 1))) 0)
                (not bt1448)
                bt1447
                (= (+ it1328 (* it1331 (- 1))) 0)
                (not bt1446)
                (= (+ (* it1332 (- 1)) it1329) 0)
                bt1445))
      (a!6 (and (not bt1447) (not bt1448) (= (+ it1328 (* it1331 (- 1))) 0)))
      (a!10 (and (= (+ (* it1327 3) (* it1330 (- 1))) 0)
                 (not bt1448)
                 bt1447
                 (= (+ it1328 (* it1331 (- 1))) 0)
                 bt1446
                 (= (+ (* it1332 (- 1)) it1329) 0)
                 bt1445))
      (a!11 (and (not bt1448) bt1447 (= (+ it1328 (* it1331 (- 1))) 0)))
      (a!13 (and (not bt1447)
                 (= (+ it1330 (- 1)) 0)
                 (not bt1448)
                 (= (+ it1328 (* it1331 (- 1))) 0)
...
(let ((a!4 (or (and a!3 (not bt1445))
      ...
      (a!9 (or (not bt1441)
               ...
               bt1443
               bt1444)))
  (and (or bt1441 (not bt1444) bt1442 (> it1327 0) (and a!2 bt1445) bt1443)
       a!4
       (or bt1441 a!5 bt1442 bt1444 (not bt1443))
       (= (+ it1326 (- 2)) 0)
       (or (not bt1442) (and a!7 (not bt1445)) bt1441 bt1444 (not bt1443))
       (or (or (not bt1441) (not bt1442)) (not bt1444) (and a!2 bt1445) bt1443)
       (or a!8 bt1441 bt1442 bt1443 bt1444)
       a!9
       (or a!10 (not bt1441) bt1442 bt1444 (not bt1443))
       (or a!12 (not bt1441) (not bt1442) (> it1328 0) bt1443 bt1444)
       (or (not bt1442) (and a!2 (not bt1445)) bt1441 (not bt1444) bt1443)
       (or (not bt1442) a!13 bt1441 bt1443 bt1444)
       (or (or (not bt1441) (not bt1442))
           (and a!14 (not bt1445))
           (<= it1328 0)
           bt1443
           bt1444)
       (or (not bt1441) a!8 (not bt1444) bt1442 bt1443)
       (or (or (not bt1441) (not bt1442)) bt1444 (not bt1443) (and a!14 bt1445))
       (or (<= it1327 0) bt1441 (not bt1444) (and a!3 bt1445) bt1442 bt1443))))))
(check-sat)
