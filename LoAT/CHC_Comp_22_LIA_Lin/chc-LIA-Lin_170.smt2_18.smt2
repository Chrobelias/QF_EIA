...
(assert (and (= (+ (* it178 (- 1)) it175) 0)
     ...
     (= (+ (* it177 (- 1)) (* it174 2)) 0)))
(assert (= (+ it189 (- 2)) 0))
(assert (= (+ it190 (* it177 (- 1))) 0))
(assert (= (+ (* it178 (- 1)) it191) 0))
(assert (= (+ (* it179 (- 1)) it192) 0))
(assert (or (and (not bt202) (not bt217)) (and bt217 bt202)))
(assert (or (and (not bt201) (not bt218)) (and bt218 bt201)))
(assert (or (and bt219 bt203) (and (not bt219) (not bt203))))
(assert (or (and bt204 bt220) (and (not bt204) (not bt220))))
(assert (and (not bt219) bt217 bt218 (= (+ it189 (- 2)) 0) bt220))
(check-sat)
