...
(assert (= (+ it147 (- 3)) 0))
(assert (= (+ it148 (- 1)) 0))
(assert (= (+ (* it111 (- 1)) it149) 0))
(assert (= (+ it150 (- 1)) 0))
(assert (= (+ it151 (- 1)) 0))
(assert (= (+ (* it111 (- 1)) it152) 0))
(assert (= (+ it153 (- 1)) 0))
(assert (and (>= (+ it147 (- 3)) 0)
     (>= (+ (* it147 (- 1)) 3) 0)
     (>= (+ it149 (* it206 (- 1)) (* it148 (- 1)) 1) 0)
     (>= (+ it152 (* it206 (- 1)) (* it151 (- 1)) 1) 0)
     (>= (+ it206 (- 1)) 0)))
...
(assert (and (> (+ (* it235 (- 1)) it234) 0)
     (>= (+ it230 (- 2)) 0)
     (>= (+ it169 (- 1)) 0)
     (>= (+ (* it231 (- 1)) it232 (* it169 (- 1)) 1) 0)
     (>= (+ (* it230 (- 1)) 2) 0)))
(assert (= (+ it245 (* it230 (- 1))) 0))
(assert (= (+ (* it231 (- 1)) (* it169 (- 1)) it246) 0))
