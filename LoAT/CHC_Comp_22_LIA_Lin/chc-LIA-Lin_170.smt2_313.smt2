...
(assert (let ((a!1 (and bt1221
                (= (+ (* it1109 (- 1)) it1106) 0)
                (= (+ (* it1108 (- 1)) it1105) 0)))
      (a!3 (and (and bt1221 bt1224)
                (not bt1222)
                (= (+ (* it1109 (- 1)) it1106) 0)
                (= (+ (* it1108 (- 1)) it1105) 0)
                (not bt1223)
      ...
      (a!11 (and (not bt1222)
                 ...
                 (= (+ (* it1108 (- 1)) it1105) 0)
                 (not bt1221)))
      (a!13 (and (and bt1221 bt1224)
                 (= (+ (* it1109 (- 1)) it1106) 0)
                 (= (+ (* it1108 (- 1)) it1105) 0)
                 bt1222
                 (not bt1223)
                 (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!17 (and (= (+ (* it1109 (- 1)) it1106) 0)
                 (= (+ (* it1108 (- 1)) it1105) 0)
                 (not bt1221)
                 bt1222))
      (a!21 (and bt1224
...
(let ((a!2 (and a!1
                ...
                bt1223
                (not bt1224)))
      (a!4 (or (or (or bt1219 (not bt1220)) bt1218) (<= it1104 0) bt1217 a!3))
      (a!6 (and a!1
                bt1222
                (not bt1224)
                (not bt1223)
                (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!9 (and a!8 (= (+ (* it1104 2) (* it1107 (- 1))) 0) bt1223 (not bt1224)))
      (a!12 (and a!11 bt1223 (not bt1224) (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!14 (and a!11
                 (not bt1224)
                 (not bt1223)
                 (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!16 (or (or (or bt1219 (not bt1220)) bt1218) bt1217 (> it1104 0) a!13))
      (a!18 (and a!17 bt1223 (not bt1224) (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!19 (and a!8 bt1223 (not bt1224) (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!20 (and a!17
                 (not bt1224)
                 (not bt1223)
                 (= (+ it1104 (* it1107 (- 1))) 0)))
      (a!22 (or (or (or (or bt1219 bt1220) bt1218) (not bt1217))
                (> (+ it1106 (* it1104 (- 1))) 0)
                a!21)))
(let ((a!7 (or (or (or (or bt1219 bt1220) bt1218) (not bt1217))
               a!6
               (<= (+ it1106 (* it1104 (- 1))) 0)))
      (a!15 (or (or (or bt1219 (not bt1220)) bt1218) (not bt1217) a!14)))
  (and (or (or bt1220 bt1218) (not bt1217) a!2 (not bt1219))
       a!4
       (or (or bt1219 (not bt1220)) bt1217 a!5 (not bt1218))
       a!7
       (or (or bt1220 bt1218) bt1217 a!9 (not bt1219))
       (or (or bt1219 bt1220) a!10 bt1217 (not bt1218))
       (or (or (or bt1219 bt1220) (not bt1217)) a!12 (<= it1105 0) (not bt1218))
       (or (or bt1219 (not bt1220)) (not bt1217) a!13 (not bt1218))
       (or (or (or bt1219 bt1220) bt1218) bt1217 a!14)
       a!15
       a!16
       (or (or (or bt1219 bt1220) (not bt1217)) a!18 (> it1105 0) (not bt1218))
       (= (+ it1103 (- 2)) 0)
       (or bt1220 (not bt1217) a!19 (not bt1219) (not bt1218))
       (or bt1220 bt1217 a!20 (not bt1219) (not bt1218))
       a!22)))))
(check-sat)
