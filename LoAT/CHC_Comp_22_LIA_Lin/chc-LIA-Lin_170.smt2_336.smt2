...
(assert (or (not bt1212)
    (distinct (+ it1095 (- 2)) 0)
    bt1209
    bt1213
    (distinct (+ (* it1101 (- 1)) it1098) 0)
    bt1215
    (not bt1210)
    (distinct (+ (* it1100 (- 1)) it1097) 0)
    (not bt1216)
    (not bt1214)
    (distinct (+ (* it1099 (- 1)) it1096) 0)))
(assert (let ((a!1 (and (= (+ (* it1099 (- 1)) it1096) 0) (not bt1215) bt1213))
      (a!3 (and (= (+ (* it1099 (- 1)) it1096) 0) (not bt1213)))
      (a!5 (and (= (+ (* it1099 (- 1)) (* it1096 2)) 0)
                (not bt1216)
                bt1213
                (not bt1214)
                bt1215
      ...
      (a!6 (and (= (+ (* it1099 (- 1)) (* it1096 3)) 0)
                ...
                (= (+ (* it1100 (- 1)) it1097) 0)
                (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!7 (and (= (+ (* it1099 (- 1)) it1096) 0) (not bt1216)))
      (a!9 (and (not bt1213)
                (= (+ it1099 (- 1)) 0)
                (not bt1216)
                (not bt1215)
...
(let ((a!2 (and a!1
      ...
      (a!8 (and a!7
                ...
                (= (+ (* it1100 (- 1)) it1097) 0)
                (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!10 (and (and a!3 (not bt1216))
                 (not bt1214)
                 bt1215
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!11 (and (and (and a!3 (not bt1216)) (not bt1215))
                 (not bt1214)
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!12 (and (and a!3 (not bt1215))
                 bt1216
                 bt1214
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!13 (and (and a!3 (not bt1215))
                 (not bt1214)
                 bt1216
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!15 (and a!7
                 ...
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!17 (and (and (and a!3 (not bt1216)) (not bt1215))
                 bt1214
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0)))
      (a!18 (and a!1
                 ...
                 (= (+ (* it1100 (- 1)) it1097) 0)
                 (= (+ (* it1101 (- 1)) it1098) 0))))
(let ((a!14 (or (or bt1210 (not bt1209))
                (> (+ it1098 (* it1096 (- 1))) 0)
                bt1211
                bt1212
                a!13))
      (a!16 (or (or bt1210 (not bt1209))
                (<= (+ it1098 (* it1096 (- 1))) 0)
                bt1211
                bt1212
                a!15)))
  (and (or a!2 (not bt1209) (not bt1212) bt1211 (not bt1210))
       (or (> it1097 0) (not bt1209) bt1211 (not bt1210) bt1212 a!4)
       (or (or bt1210 bt1209) a!5 bt1212 (not bt1211))
       (or (or bt1210 (not bt1209)) a!6 bt1212 (not bt1211))
       (or (not bt1209) (not bt1210) bt1212 (not bt1211) a!8)
       (or bt1209 a!9 bt1211 (not bt1210) bt1212)
       (or (not bt1209) (<= it1097 0) a!10 bt1211 (not bt1210) bt1212)
       (or (or bt1210 (not bt1209)) (not bt1212) bt1211 a!11)
       (or bt1209 (not bt1212) a!12 bt1211 (not bt1210))
       a!14
       a!16
       (or bt1209 a!17 (not bt1210) bt1212 (not bt1211))
       (or (or bt1210 bt1209) (not bt1212) a!18 bt1211 (<= it1096 0))
       (or (or bt1210 bt1209) bt1211 bt1212 a!11)
       (= (+ it1095 (- 2)) 0)
       (or a!2 bt1210 bt1209 (not bt1212) bt1211 (> it1096 0)))))))
(check-sat)
