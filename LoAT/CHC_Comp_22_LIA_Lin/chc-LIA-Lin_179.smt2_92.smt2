...
(assert (let ((a!1 (and bt975
                ...
                (= (+ (* it848 (- 1)) it845) 0)
                (= (+ (* it850 (- 1)) it847) 0)))
      (a!2 (and (= (+ (* it849 (- 1)) it846) 0) (not bt976)))
      (a!4 (and bt974 (= (+ (* it849 (- 1)) it846) 0) (not bt976)))
      (a!8 (and (and bt975 bt976)
                bt974
                (= (+ (* it849 (- 1)) it846) 0)
                (= (+ (* it848 (- 1)) (* it845 2)) 0)
                (not bt977)
      ...
      (a!9 (and bt975
                ...
                (= (+ (* it850 (- 1)) it847) 0)
                (not bt974)))
      (a!11 (and (and bt975 bt976)
                 (= (+ it849 (- 10)) 0)
                 (not bt977)
                 (= (+ (* it848 (- 1)) it845) 0)
                 (= (+ (* it850 (- 1)) it847) 0)
                 (not bt974)))
      (a!13 (and bt976 (= (+ (* it849 (- 1)) it846) 0)))
      (a!15 (and (and bt975 bt976) (= (+ (* it849 (- 1)) it846) 0)))
      (a!18 (= (+ (+ (* it849 (- 1)) it846) (- 1)) 0)))
(let ((a!3 (and a!2
                (not bt977)
                (not bt975)
                (= (+ (* it848 (- 1)) it845) 0)
      ...
      (a!20 (and a!13
                 ...
                 (= (+ (* it850 (- 1)) it847) 0)
                 (not bt974))))
(let ((a!6 (or (or bt973 a!5)
               bt972
               (<= (+ (* it845 (- 1)) it847) 0)
               (not bt970)
               (not bt971))))
  (and (= (+ it844 (- 2)) 0)
       (or (or bt970 bt973) a!1 bt971 (<= it846 0) (not bt972))
       (or a!3 bt972 (not bt973) (not bt970) (not bt971))
       (or (or bt973 a!5) (not bt972) (not bt970) (not bt971))
       (or (or bt970 bt973) a!3 bt971 bt972)
       a!6
       (or (or bt970 bt971) (not bt972) (not bt973) a!7)
       (or bt973 a!8 bt971 (not bt972) (not bt970))
       a!10
       (or bt973 bt971 bt972 a!11 (not bt970))
       (or a!12 bt970 bt973 bt971 (not bt972) (> it846 0))
       (or (or bt970 bt973) bt972 a!14 (not bt971))
       (or bt970 bt972 (not bt973) a!7 (> it845 0) (not bt971))
       (or (or bt970 bt971) bt972 (not bt973) a!16)
       (or bt971 bt972 a!17 (not bt973) (not bt970))
       (or (or bt970 bt973) (not bt972) a!19 (not bt971))
       (or bt970 (<= it845 0) bt972 (not bt973) a!20 (not bt971)))))))
(check-sat)
