...
(assert (let ((a!1 (and (= (+ it1071 (* it1074 (- 1))) 0)
                (= (+ it1070 (* it1073 (- 1))) 0))))
(let ((a!2 (and (and a!1 bt1190 bt1191)
                (= (+ (* it1072 (- 1)) it1069) 0)
                (not bt1189)
                (not bt1192)))
      (a!3 (and (and a!1 bt1191) (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!4 (and (and a!1 bt1191)
                bt1189
                (= (+ (* it1072 (- 1)) (* it1069 2)) 0)
                (not bt1192)
                (not bt1190)))
      (a!5 (and (and a!1 (not bt1191)) bt1192 (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!7 (and (and (and a!1 (not bt1191)) bt1190)
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!8 (and (and (and a!1 (not bt1191)) bt1190)
                bt1192
                (= (+ (* it1072 (- 1)) it1069) 0)))
      (a!9 (and (and a!1 (not bt1191))
                (= (+ (* it1072 (- 1)) it1069) 0)
                (not bt1189)
                (not bt1192)
                (not bt1190)))
      (a!10 (and (and (and a!1 (not bt1191)) bt1190)
                 (not bt1189)
                 (not bt1192)
                 (= (+ it1072 (- 1)) 0)))
      (a!12 (and (and a!1 bt1190 bt1191)
                 bt1189
                 (not bt1192)
                 (= (+ (* it1072 (- 1)) (* it1069 3)) 0))))
(let ((a!6 (or (and a!5 (not bt1189) (not bt1190))
               (not bt1185)
               (> (+ it1071 (* it1069 (- 1))) 0)
               bt1187
               bt1188
               bt1186))
      (a!11 (or (or (not bt1185) bt1187)
                bt1188
                bt1186
                (and a!7 bt1189 (not bt1192))
                (<= (+ it1071 (* it1069 (- 1))) 0))))
  (and (or (> it1070 0) (not bt1185) (not bt1186) bt1187 bt1188 a!2)
       (= (+ it1068 (- 2)) 0)
       (or (and a!3 (not bt1189) (not bt1192) (not bt1190))
           (not bt1185)
           (not bt1186)
           bt1187
           bt1188
           (<= it1070 0))
       (or a!4 bt1188 bt1186 bt1185 (not bt1187))
       (or bt1187
           (<= it1069 0)
           bt1186
           bt1185
           (and a!5 bt1189 (not bt1190))
           (not bt1188))
       a!6
       (or (not bt1186)
           bt1188
           (and a!7 (not bt1189) (not bt1192))
           bt1185
           (not bt1187))
       (or (or (not bt1185) (not bt1186)) bt1187 (and a!8 bt1189) (not bt1188))
       (or bt1187 bt1188 a!9 bt1186 bt1185)
       (or (or (not bt1185) bt1187) a!9 bt1186 (not bt1188))
       (or bt1187 (and a!8 bt1189) bt1186 bt1185 (not bt1188) (> it1069 0))
       (or (or (not bt1185) (not bt1186))
           bt1188
           (and a!3 bt1189 (not bt1192) (not bt1190))
           (not bt1187))
       (or (or (not bt1186) bt1187) bt1185 (not bt1188) (and a!8 (not bt1189)))
       (or (or (not bt1186) bt1187) bt1188 bt1185 a!10)
       a!11
       (or (not bt1185) bt1188 bt1186 (not bt1187) a!12))))))
(check-sat)
