...
(assert (or bt1477
    ...
    bt1479
    (not bt1480)
    (distinct (+ (* it1370 (- 1)) it1367) 0)
    (distinct (+ (* it1369 (- 1)) it1366) 0)
    bt1473
    (not bt1478)))
(assert (let ((a!1 (and (not bt1479)
                (not bt1480)
                bt1477
                (= (+ (* it1369 (- 1)) it1366) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1370 (- 1)) it1367) 0)
                bt1478))
      (a!3 (and (and (not bt1477) (not bt1479))
                bt1480
                (= (+ (* it1369 (- 1)) it1366) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1370 (- 1)) it1367) 0)))
      (a!4 (and (not bt1477)
                ...
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1370 (- 1)) it1367) 0)))
      (a!5 (and (not bt1480) bt1477 bt1479 (= (+ (* it1369 (- 1)) it1366) 0)))
      (a!7 (and (not bt1479)
                bt1477
                bt1480
                (= (+ (* it1369 (- 1)) it1366) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1370 (- 1)) it1367) 0)))
      (a!9 (and (and (and (not bt1477) (not bt1479)) (not bt1480))
                (= (+ (* it1369 (- 1)) it1366) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1370 (- 1)) it1367) 0)))
      (a!11 (and (and (and (not bt1477) (not bt1479)) (not bt1480))
                 (= (+ it1368 (- 1)) 0)
                 (= (+ (* it1369 (- 1)) it1366) 0)
                 (= (+ (* it1370 (- 1)) it1367) 0)
                 bt1478)))
(let ((a!2 (or bt1474
      ...
      (a!12 (and a!5
                 ...
                 (= (+ (* it1368 (- 1)) (* it1365 2)) 0))))
  (and a!2
       (or (and a!3 bt1478) (not bt1474) (not bt1476) bt1473 bt1475)
       (or (not bt1473)
           bt1476
           (> it1366 0)
           (not bt1474)
           (and a!4 bt1478)
           bt1475)
       (or a!6 (not bt1473) (not bt1475) bt1476 (not bt1474))
       (or bt1474 (and a!7 bt1478) (not bt1476) bt1473 bt1475 (> it1365 0))
       (or bt1474
           (<= it1365 0)
           (not bt1476)
           bt1473
       ...
       (or (not bt1473)
           ...
           bt1475)
       a!8
       (or (or bt1474 (not bt1473)) (not bt1476) (and a!9 (not bt1478)) bt1475)
       (or (not bt1473) (not bt1474) (and a!7 bt1478) (not bt1476) bt1475)
       (or (not bt1475) (and a!9 bt1478) bt1476 (not bt1474) bt1473)
       (or (or bt1474 (not bt1473)) (not bt1475) a!10 bt1476)
       (or a!11 bt1476 (not bt1474) bt1473 bt1475)
       (or bt1474 (not bt1475) bt1476 a!12 bt1473)
       (= (+ it1364 (- 2)) 0)
       (or bt1474 bt1476 bt1473 (and a!9 (not bt1478)) bt1475)))))
(check-sat)
