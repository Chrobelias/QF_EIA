...
(assert (or (not bt1450)
    ...
    bt1455
    bt1453))
(assert (let ((a!1 (and (= (+ (* it1338 (- 1)) it1335) 0)
                bt1454
                (= (+ (* it1337 (- 1)) (* it1334 3)) 0)
                bt1455
                bt1453
                (= (+ (* it1339 (- 1)) it1336) 0)
                (not bt1456)))
      (a!2 (and (= (+ (* it1338 (- 1)) it1335) 0)
                (= (+ (* it1337 (- 1)) it1334) 0)))
      (a!4 (and (not bt1455) (= (+ (* it1338 (- 1)) it1335) 0)))
      (a!16 (and (= (+ (* it1338 (- 1)) it1335) 0)
                 (= (+ (* it1337 (- 1)) (* it1334 2)) 0)
                 (not bt1454)
                 bt1455
                 bt1453
...
(let ((a!3 (and a!2
                ...
                (= (+ (* it1339 (- 1)) it1336) 0)
                (not bt1456)))
      (a!5 (and a!4 (= (+ (* it1337 (- 1)) it1334) 0)))
      (a!7 (and (and a!2 (not bt1454))
                bt1455
                bt1453
                (= (+ (* it1339 (- 1)) it1336) 0)
                (not bt1456)))
...
(let ((a!6 (and a!5
                ...
                (= (+ (* it1339 (- 1)) it1336) 0)
                (not bt1456)))
      (a!8 (and (and (and a!5 bt1454) bt1456)
                (not bt1453)
                (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!9 (and (and a!5 bt1456 (not bt1454))
                (not bt1453)
                (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!11 (and (and a!5 bt1456 (not bt1454))
                 bt1453
                 (= (+ (* it1339 (- 1)) it1336) 0)))
      (a!13 (and (and a!5 bt1454)
                 bt1453
                 (= (+ (* it1339 (- 1)) it1336) 0)
                 (not bt1456)))
      (a!15 (and (and a!5 bt1454)
                 (not bt1453)
                 (= (+ (* it1339 (- 1)) it1336) 0)
                 (not bt1456)))
      (a!17 (and (and (and a!5 bt1454) bt1456)
                 bt1453
                 (= (+ (* it1339 (- 1)) it1336) 0))))
(let ((a!10 (or a!9
                bt1450
                ...
                (> (+ (* it1334 (- 1)) it1336) 0)
                bt1452))
      (a!14 (or (<= (+ (* it1334 (- 1)) it1336) 0)
                bt1450
                (not bt1449)
                bt1451
                a!13
                bt1452)))
  (and (or bt1450 (not bt1449) (not bt1451) a!1 bt1452)
       (or (> it1335 0) (not bt1449) bt1451 a!3 (not bt1450) bt1452)
       (or (or a!6 bt1450) (not bt1449) bt1451 (not bt1452))
       (or a!7 (not bt1449) (not bt1450) (not bt1451) bt1452)
       (or a!8 bt1451 bt1449 (not bt1450) (not bt1452))
       a!10
       (or bt1450 bt1451 bt1449 a!11 (not bt1452) (<= it1334 0))
       (= (+ it1333 (- 2)) 0)
       (or bt1451 bt1449 (not bt1450) a!12 bt1452)
       a!14
       (or a!15 bt1449 (not bt1450) (not bt1451) bt1452)
       (or bt1450 a!16 bt1449 (not bt1451) bt1452)
       (or a!17 (> it1334 0) bt1450 bt1451 bt1449 (not bt1452))
       (or (or a!6 bt1450) bt1451 bt1449 bt1452)
       (or a!17 (not bt1449) bt1451 (not bt1450) (not bt1452))
       (or (not bt1449) bt1451 (<= it1335 0) (not bt1450) bt1452 a!18)))))))
(check-sat)
