...
(assert (let ((a!1 (and bt1182
      ...
      (a!10 (and (not bt1181)
                 ...
                 (= (+ (* it1065 (- 1)) it1062) 0)
                 (= (+ (* it1064 (- 1)) it1061) 0))))
(let ((a!2 (and a!1 bt1184 (not bt1183) (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!4 (and a!3
                (not bt1184)
                bt1181
                bt1183
                (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!6 (and (and a!1 (not bt1184))
                (not bt1183)
                (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!9 (and a!8
                bt1181
      ...
      (a!11 (and (and a!10 (not bt1184))
                 (not bt1183)
                 (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!12 (and a!10 bt1184 (not bt1183) (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!14 (and (and a!10 (not bt1184))
                 bt1183
                 (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!15 (or (or bt1179 bt1180)
                bt1177
                (not bt1178)
                (and (and a!1 (not bt1184)) (= (+ it1063 (- 1)) 0) (not bt1183))))
      (a!16 (and a!8
                 (not bt1184)
                 bt1181
                 (not bt1183)
                 (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!18 (and (and a!1 (not bt1184))
                 bt1183
                 (= (+ (* it1063 (- 1)) it1060) 0)))
      (a!19 (and a!3
                 bt1181
                 ...
                 (not bt1183)
                 (= (+ (* it1063 (- 1)) it1060) 0))))
(let ((a!13 (or (or (or bt1179 bt1180) (not bt1177))
                a!12
                (> (+ it1062 (* it1060 (- 1))) 0)
                bt1178))
      (a!17 (or (or (or bt1179 bt1180) (not bt1177))
                a!16
                bt1178
                (<= (+ it1062 (* it1060 (- 1))) 0))))
  (and (or a!2 bt1179 bt1177 (not bt1178) (not bt1180))
       (or a!4 bt1180 (not bt1177) (not bt1179) (not bt1178))
       (or a!5 bt1180 (not bt1177) (not bt1179) bt1178)
       (or a!6 bt1180 (not bt1179) bt1177 (not bt1178))
       (or a!7 bt1180 (not bt1179) bt1177 bt1178)
       (or a!9 bt1179 (not bt1177) (not bt1178) (not bt1180))
       (or (or a!11 bt1179) bt1180 bt1177 bt1178)
       (or (or a!11 bt1179) (not bt1177) bt1178 (not bt1180))
       (or (> it1060 0) a!9 bt1179 bt1177 bt1178 (not bt1180))
       a!13
       (or (or (or bt1179 bt1180) (not bt1177)) (<= it1061 0) a!14 (not bt1178))
       (= (+ it1059 (- 2)) 0)
       a!15
       a!17
       (or (or (or bt1179 bt1180) (not bt1177)) (> it1061 0) a!18 (not bt1178))
       (or bt1179 (<= it1060 0) a!19 bt1177 bt1178 (not bt1180)))))))
(check-sat)
