...
(declare-fun bt1100 () Bool)
(declare-fun it983 () Int)
(declare-fun it984 () Int)
(declare-fun bt1098 () Bool)
(declare-fun bt1099 () Bool)
(declare-fun bt1097 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it732 (- 2)) 0))
...
(assert (let ((a!1 (and bt1099
                ...
                (= (+ (* it984 (- 1)) it981) 0)
                (= (+ (* it985 (- 1)) it982) 0)))
      (a!2 (and (and (and (not bt1097) (not bt1099)) (not bt1100))
                (not bt1098)
                (= (+ (* it984 (- 1)) it981) 0)
                (= (+ (* it983 (- 1)) it980) 0)
                (= (+ (* it985 (- 1)) it982) 0)))
      (a!3 (and (and (not bt1097) bt1099 (not bt1100))
                (not bt1098)
                (= (+ (* it984 (- 1)) it981) 0)
                (= (+ (* it983 (- 1)) it980) 0)
                (= (+ (* it985 (- 1)) it982) 0)))
      (a!4 (and (and (and (not bt1097) (not bt1099)) (not bt1100))
                (= (+ (* it984 (- 1)) it981) 0)))
      (a!6 (and (and (not bt1097) bt1099 (not bt1100))
                (= (+ (* it984 (- 1)) it981) 0)
                (= (+ (* it983 (- 1)) it980) 0)
                bt1098
                (= (+ (* it985 (- 1)) it982) 0)))
      (a!7 (and (and bt1099 (not bt1100))
                (not bt1098)
                bt1097
                (= (+ (* it984 (- 1)) it981) 0)
                (= (+ (* it983 (- 1)) it980) 0)
      ...
      (a!12 (and (not bt1099)
                 ...
                 bt1100
                 (= (+ (* it985 (- 1)) it982) 0)))
      (a!13 (and (and bt1099 (not bt1100))
                 bt1097
                 (= (+ (* it984 (- 1)) it981) 0)
                 (= (+ (* it983 (- 1)) (* it980 3)) 0)
                 bt1098
                 (= (+ (* it985 (- 1)) it982) 0)))
      (a!14 (and (and (not bt1097) (not bt1099))
                 (= (+ (* it984 (- 1)) it981) 0)
                 (= (+ (* it983 (- 1)) it980) 0)
                 bt1100
                 bt1098
                 (= (+ (* it985 (- 1)) it982) 0)))
      (a!15 (and (and (not bt1097) (not bt1099))
                 (not bt1098)
                 (= (+ (* it984 (- 1)) it981) 0)
                 (= (+ (* it983 (- 1)) it980) 0)
                 bt1100
...
(let ((a!5 (and a!4
      ...
      (a!16 (or bt1094
                ...
                bt1095
                bt1096)))
  (and (or (or bt1093 bt1094) a!1 (not bt1095) bt1096)
       (or (not bt1096) bt1094 (not bt1093) a!2 bt1095)
       (or (<= it981 0) (not bt1093) (not bt1094) a!3 bt1095 bt1096)
       (or bt1093 (not bt1094) bt1095 bt1096 a!5)
       (or (not bt1093) (not bt1094) bt1095 a!6 bt1096 (> it981 0))
       (or a!7 (not bt1093) (not bt1095) (not bt1094) bt1096)
       (or (or bt1093 bt1094) a!2 bt1095 bt1096)
       a!9
       (or (> it980 0) bt1093 (not bt1096) bt1094 a!10 bt1095)
       (or (not bt1096) a!10 (not bt1093) (not bt1094) bt1095)
       (or bt1093 a!11 (not bt1095) (not bt1094) bt1096)
       (or (<= it980 0) bt1093 (not bt1096) a!12 bt1094 bt1095)
       (or a!13 bt1094 (not bt1093) (not bt1095) bt1096)
       (or bt1093 a!14 (not bt1096) (not bt1094) bt1095)
       (= (+ it979 (- 2)) 0)
       a!16))))
(check-sat)
