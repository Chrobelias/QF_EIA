...
(assert (or bt447
    bt448
    (not bt446)
    (distinct (+ it398 (* it392 (- 1))) 0)
    (distinct (+ it396 (* it390 (- 1))) 0)
    (<= (+ (* it396 (- 1)) it398) 0)
    (distinct (+ it397 (* it391 (- 1))) 0)
    (not bt449)
    (distinct (+ it395 (- 2)) 0)
    bt450
    bt451
    bt452
    (not bt445)))
(assert (or (distinct (+ it396 (* it390 (- 1))) 0)
    bt445
    bt446
    bt447
    (not bt449)
    ...
    (distinct (+ it397 (* it391 (- 1))) 0)
    (> (+ (* it396 (- 1)) it398) 0)))
(assert (let ((a!1 (and (and bt445 bt446)
                bt447
                (= (+ (* it396 3) (* it390 (- 1))) 0)
                (not bt448)
                (= (+ it397 (* it391 (- 1))) 0)
                (= (+ it398 (* it392 (- 1))) 0)))
      (a!2 (and (and bt445 bt447)
                (not bt448)
                (not bt446)
                (= (+ (* it396 2) (* it390 (- 1))) 0)
                (= (+ it397 (* it391 (- 1))) 0)
...
(let ((a!11 (or (> (+ (* it396 (- 1)) it398) 0)
      ...
      (a!13 (or a!12
                ...
                (<= (+ (* it396 (- 1)) it398) 0)
                (not bt449))))
  (and (or a!1 bt450 bt452 (not bt451) (not bt449))
       (or (or bt449 bt450) bt452 (not bt451) a!2)
       (or (or bt449 bt450) bt451 a!3 (not bt452) (<= it396 0))
       (= (+ it395 (- 2)) 0)
       (or a!4 bt449 bt450 bt451 bt452)
       (or (not bt450) a!5 bt449 bt451 bt452)
       (or (> it396 0) bt449 bt450 bt451 a!6 (not bt452))
       (or (not bt450) a!7 (> it397 0) bt451 bt452 (not bt449))
       (or (not bt450) bt452 (not bt451) a!8 (not bt449))
       (or a!4 bt450 bt451 (not bt452) (not bt449))
       (or a!9 (not bt450) bt451 bt452 (<= it397 0) (not bt449))
       a!11
       (or (not bt450) bt451 a!6 (not bt452) (not bt449))
       a!13
       (or (not bt450) bt449 bt452 (not bt451) a!14)
       (or (not bt450) a!15 bt449 bt451 (not bt452))))))
(check-sat)
