...
(assert (and (not bt764)
     ...
     (= (+ (* it669 (- 1)) it666) 0)))
(assert (= (+ it671 (- 2)) 0))
(assert (= (+ (* it668 (- 1)) it672) 0))
(assert (= (+ (* it669 (- 1)) it673) 0))
(assert (= (+ it674 (* it670 (- 1))) 0))
(assert (or (and bt764 bt766) (and (not bt764) (not bt766))))
(assert (or (and (not bt763) (not bt767)) (and bt767 bt763)))
(assert (or (and (not bt768) (not bt762)) (and bt768 bt762)))
(assert (or (and bt765 bt769) (and (not bt765) (not bt769))))
(assert (and bt768 (not bt767) bt769 (= (+ it671 (- 2)) 0) (not bt766)))
(check-sat)
