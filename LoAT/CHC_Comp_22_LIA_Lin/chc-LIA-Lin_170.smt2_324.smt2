...
(declare-fun bt1229 () Bool)
(declare-fun it1118 () Int)
(declare-fun bt1232 () Bool)
(declare-fun it1117 () Int)
(declare-fun bt1230 () Bool)
(declare-fun bt1231 () Bool)
...
(assert (and bt1220
     ...
     (= (+ (* it1108 (- 1)) it1105) 0)))
(assert (= (+ it1112 (- 2)) 0))
(assert (= (+ it1113 (* it1107 (- 1))) 0))
(assert (= (+ it1114 (* it1108 (- 1))) 0))
(assert (= (+ (* it1109 (- 1)) it1115) 0))
(assert (or (and bt1225 bt1222) (and (not bt1222) (not bt1225))))
(assert (or (and bt1221 bt1226) (and (not bt1221) (not bt1226))))
(assert (or (and bt1227 bt1223) (and (not bt1223) (not bt1227))))
(assert (or (and bt1224 bt1228) (and (not bt1228) (not bt1224))))
(assert (and (not bt1231)
     (not bt1230)
     (= (+ (* it1117 (- 1)) it1114) 0)
     (not bt1232)
     (= (+ (* it1118 (- 1)) it1115) 0)
     ...
     (not bt1228)))
(assert (= (+ it1120 (- 2)) 0))
(assert (= (+ it1121 (* it1116 (- 1))) 0))
(assert (= (+ it1122 (* it1117 (- 1))) 0))
(assert (= (+ it1123 (* it1118 (- 1))) 0))
(assert (or (and bt1233 bt1230) (and (not bt1230) (not bt1233))))
(assert (or (and bt1229 bt1234) (and (not bt1234) (not bt1229))))
(assert (or (and (not bt1231) (not bt1235)) (and bt1235 bt1231)))
(assert (or (and bt1236 bt1232) (and (not bt1232) (not bt1236))))
(assert (let ((a!1 (and (= (+ (* it1126 (- 1)) it1123) 0)
                (= (+ it1121 (* it1124 (- 1))) 0)
                bt1238
                bt1240
                (= (+ (* it1125 (- 1)) it1122) 0)
                (not bt1239)
                (not bt1237)))
      (a!2 (and (= (+ (* it1126 (- 1)) it1123) 0) (not bt1238)))
      (a!6 (and (= (+ (* it1126 (- 1)) it1123) 0) (not bt1240)))
      (a!11 (and (= (+ (* it1126 (- 1)) it1123) 0)
                 bt1237
                 (= (+ it1121 (* it1124 (- 1))) 0)
                 bt1238
                 bt1240
                 (= (+ (* it1125 (- 1)) it1122) 0)
                 (not bt1239))))
(let ((a!3 (and (and a!2 (not bt1240)) (= (+ it1121 (* it1124 (- 1))) 0)))
      (a!7 (and a!6
                bt1238
                (= (+ it1124 (- 1)) 0)
                (= (+ (* it1125 (- 1)) it1122) 0)
      ...
      (a!8 (and a!2
                ...
                (= (+ (* it1125 (- 1)) it1122) 0)
                (not bt1239)))
      (a!9 (and a!6 (= (+ it1121 (* it1124 (- 1))) 0) bt1238))
      (a!12 (and (and (and a!2 (not bt1240)) bt1237)
                 (= (+ (* it1121 2) (* it1124 (- 1))) 0)
                 bt1239
                 (= (+ (* it1125 (- 1)) it1122) 0)))
      (a!13 (and (and a!6 bt1237)
                 (= (+ it1121 (* it1124 (- 1))) 0)
                 bt1238
                 (= (+ (* it1125 (- 1)) it1122) 0)
                 (not bt1239)))
      (a!16 (and a!2
                 ...
                 (not bt1239)
                 (not bt1237)))
      (a!18 (and (and (and a!2 (not bt1240)) bt1237)
                 (= (+ it1121 (* it1124 (- 1))) 0)
                 bt1239
                 (= (+ (* it1125 (- 1)) it1122) 0)))
      (a!19 (and (and a!6 bt1237)
                 bt1238
                 bt1239
                 (= (+ (* it1125 (- 1)) it1122) 0)
                 (= (+ (* it1121 3) (* it1124 (- 1))) 0))))
(let ((a!4 (and a!3 bt1239 (= (+ (* it1125 (- 1)) it1122) 0) (not bt1237)))
      (a!5 (and a!3 (= (+ (* it1125 (- 1)) it1122) 0) (not bt1239) (not bt1237)))
      (a!10 (and a!9 bt1239 (= (+ (* it1125 (- 1)) it1122) 0) (not bt1237)))
      (a!14 (or bt1236
                (<= (+ (* it1121 (- 1)) it1123) 0)
                a!13
                (not bt1233)
      ...
      (a!15 (and a!9
                 ...
                 (not bt1239)
                 (not bt1237)))
      (a!17 (or (> (+ (* it1121 (- 1)) it1123) 0)
                bt1236
                a!16
                (not bt1233)
                bt1234
                bt1235)))
  (and (or (not bt1234) (not bt1236) bt1233 bt1235 a!1)
       (or a!4 bt1236 (not bt1234) (<= it1122 0) (not bt1233) bt1235)
       (or a!5 bt1236 bt1233 bt1234 bt1235)
       (or a!7 bt1236 (not bt1234) bt1233 bt1235)
       (or a!8 (not bt1236) bt1233 (<= it1121 0) bt1234 bt1235)
       (or (or bt1236 (not bt1234)) a!10 (not bt1233) bt1235 (> it1122 0))
       (= (+ it1120 (- 2)) 0)
       (or a!11 (not bt1234) (not bt1236) (not bt1233) bt1235)
       (or bt1236 a!12 bt1233 (not bt1235) bt1234)
       a!14
       (or (or bt1236 (not bt1234)) bt1233 (not bt1235) a!15)
       (or a!5 (not bt1236) (not bt1233) bt1234 bt1235)
       (or a!11 (not bt1236) bt1233 bt1234 bt1235 (> it1121 0))
       a!17
       (or (or bt1236 (not bt1234)) (not bt1235) (not bt1233) a!18)
       (or bt1236 (not bt1235) (not bt1233) bt1234 a!19))))))
(check-sat)
