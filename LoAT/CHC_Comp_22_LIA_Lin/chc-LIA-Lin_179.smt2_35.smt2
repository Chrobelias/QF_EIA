...
(assert (let ((a!1 (and (= (+ (* it509 (- 1)) it506) 0) (not bt578)))
      (a!8 (and (= (+ (* it509 (- 1)) it506) 0) bt578))
      (a!9 (= (+ (+ (* it508 (- 1)) it505) (- 1)) 0)))
(let ((a!2 (and a!1 (not bt580) (= (+ (* it508 (- 1)) it505) 0)))
      (a!5 (and a!1 (= (+ (* it508 (- 1)) it505) 0)))
      (a!10 (and a!8
                 (not bt581)
                 (not bt579)
                 bt580
      ...
      (a!11 (and a!1
                 ...
                 (= (+ it508 (- 10)) 0)
                 (= (+ (* it507 (- 1)) it504) 0)))
      (a!14 (and a!8 (not bt580) (= (+ (* it508 (- 1)) it505) 0)))
      (a!21 (and a!8
                 (= (+ (* it508 (- 1)) it505) 0)
                 (not bt581)
                 bt579
                 bt580
                 (= (+ (* it507 (- 1)) (* it504 2)) 0))))
(let ((a!3 (and a!2 bt579 bt581 (= (+ (* it507 (- 1)) it504) 0)))
      (a!6 (and (and a!5 (not bt581))
                bt579
                bt580
                (= (+ (* it507 (- 1)) it504) 0)))
      (a!12 (or (or (or bt576 bt577) bt574)
                (and (and a!5 (not bt581))
                     (not bt579)
                     bt580
                     (= (+ it507 (- 1)) 0))
                (not bt575)))
      (a!13 (and a!2 (not bt579) bt581 (= (+ (* it507 (- 1)) it504) 0)))
      (a!15 (and (and a!14 (not bt581)) bt579 (= (+ (* it507 (- 1)) it504) 0)))
      (a!16 (and a!5 (not bt579) bt580 bt581 (= (+ (* it507 (- 1)) it504) 0)))
      (a!18 (and a!2 (not bt581) (not bt579) (= (+ (* it507 (- 1)) it504) 0)))
      (a!19 (and a!14 (not bt579) bt581 (= (+ (* it507 (- 1)) it504) 0)))
      (a!22 (and (and a!14 (not bt581))
                 (not bt579)
                 (= (+ (* it507 (- 1)) it504) 0)))
      (a!24 (and a!5 bt579 bt580 bt581 (= (+ (* it507 (- 1)) it504) 0))))
(let ((a!4 (or (> (+ (* it504 (- 1)) it506) 0)
               bt576
               bt577
               (not bt575)
               a!3
               (not bt574)))
      (a!7 (or (or (or (not bt577) bt576) bt574) bt575 a!6))
      (a!17 (or (or (or (not bt577) bt576) bt574) (<= it504 0) (not bt575) a!16))
      (a!20 (or (or (or (not bt577) bt576) bt574) (not bt575) (> it504 0) a!19))
      (a!23 (or (or bt576 bt577)
                (not bt575)
                (<= (+ (* it504 (- 1)) it506) 0)
                a!22
                (not bt574))))
  (and a!4
       a!7
       (or bt577 bt574 (not bt575) a!10 (not bt576))
       (or (or bt576 bt577) a!11 bt575 (not bt574))
       a!12
       (or (> it505 0) bt577 bt574 a!13 bt575 (not bt576))
       (= (+ it503 (- 2)) 0)
       (or (<= it505 0) bt577 bt574 a!15 bt575 (not bt576))
       a!17
       (or (or (not bt577) bt576) (not bt575) a!18 (not bt574))
       a!20
       (or bt577 bt575 (not bt576) (not bt574) a!21)
       a!23
       (or (not bt577) bt574 bt575 (not bt576) a!19)
       (or bt577 (not bt575) (not bt576) a!22 (not bt574))
       (or (not bt577) a!24 bt576 bt575 (not bt574))
       (or (or (or bt576 bt577) bt574) bt575 a!18)))))))
(check-sat)
