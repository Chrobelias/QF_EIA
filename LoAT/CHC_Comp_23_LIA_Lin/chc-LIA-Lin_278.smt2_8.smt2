...
(assert (and (= (+ it378 (- 2)) 0) (> it381 0) (>= it379 0)))
(assert (= (+ it387 (- 2)) 0))
(assert (= (+ it388 (* it379 (- 1)) 1) 0))
(assert (= (+ (* it379 (- 1)) it389 (* it380 (- 1))) 0))
(assert (= (+ (* it381 (- 1)) it390 1) 0))
(assert (= (+ (* it381 (- 1)) it391 (* it382 (- 1))) 0))
(assert (= (+ (* it177 (- 1)) it392) 0))
(assert (= (+ (* it178 (- 1)) it393) 0))
(assert (let ((a!1 (or (> (+ (* it391 (- 1)) it389) 0) (< (+ (* it391 (- 1)) it389) 0))))
  (and (<= it390 0) (= (+ it387 (- 2)) 0) a!1 (< it388 0))))
(check-sat)
