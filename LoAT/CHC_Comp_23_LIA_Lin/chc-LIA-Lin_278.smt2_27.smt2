...
(assert (and (>= it379 0) (> it381 0) (= (+ it378 (- 2)) 0)))
(assert (= (+ it428 (- 2)) 0))
(assert (= (+ it429 (* it379 (- 1)) 1) 0))
(assert (= (+ it430 (* it379 (- 1)) (* it380 (- 1))) 0))
(assert (= (+ (* it381 (- 1)) it431 1) 0))
(assert (= (+ (* it381 (- 1)) it432 (* it382 (- 1))) 0))
(assert (= (+ (* it177 (- 1)) it433) 0))
(assert (= (+ (* it178 (- 1)) it434) 0))
(assert (let ((a!1 (or (> (+ (* it432 (- 1)) it430) 0) (< (+ (* it432 (- 1)) it430) 0))))
  (and (< it429 0) a!1 (<= it431 0) (= (+ it428 (- 2)) 0))))
(check-sat)
