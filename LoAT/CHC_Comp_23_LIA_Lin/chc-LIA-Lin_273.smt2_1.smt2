...
(assert (let ((a!1 (+ (* (exp 2 (+ it33 (- 1))) (+ 0 it28) (+ 0 (- 1)))
              (* (exp 2 (+ it33 (- 1))) (+ 0 (- 4)))
              (+ 0 6)))
      (a!2 (+ (* (exp 2 (+ it33 (- 1))) (+ 0 (- 4)))
              (* (exp 2 (+ it33 (- 1))) (+ 0 it29) (+ 0 (- 1)))
              (+ 0 6))))
  (and (>= (+ (* it27 (- 1)) 2) 0)
       (>= (+ it27 (- 2)) 0)
       (>= a!1 (+ 0 0))
...
(assert (= (+ (* (exp 2 it33) (+ 0 (- 4)))
      (+ 0 it37)
      (* (exp 2 it33) (+ 0 it29) (+ 0 (- 1)))
      (+ 0 4))
   (+ 0 0)))
(assert (let ((a!1 (or (< (+ (* it36 4) (* it37 (- 4))) 0)
               (> (+ (* it36 4) (* it37 (- 4))) 0))))
  (and (= (+ it35 (- 2)) 0) (> (+ it36 (- 2)) 0) (> (+ it37 (- 2)) 0) a!1)))
(check-sat)
