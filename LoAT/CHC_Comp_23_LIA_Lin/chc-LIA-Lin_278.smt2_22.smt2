...
(assert (and (<= it402 0) (>= it400 0) (= (+ it399 (- 2)) 0)))
(assert (= (+ it419 (- 2)) 0))
(assert (= (+ it420 (* it400 (- 1)) 1) 0))
(assert (= (+ (* it401 (- 1)) it421 (* it400 (- 1))) 0))
(assert (= (+ (* it402 (- 1)) it422) 0))
(assert (= (+ it423 (* it403 (- 1))) 0))
(assert (= (+ (* it181 (- 1)) it424) 0))
(assert (= (+ (* it182 (- 1)) it425) 0))
(assert (let ((a!1 (or (< (+ (* it423 (- 1)) it421) 0) (> (+ (* it423 (- 1)) it421) 0))))
  (and a!1 (< it420 0) (= (+ it419 (- 2)) 0) (<= it422 0))))
(check-sat)
