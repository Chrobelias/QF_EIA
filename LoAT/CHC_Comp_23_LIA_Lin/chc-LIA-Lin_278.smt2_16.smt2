...
(assert (= (+ it410 it255 (* it400 (- 1))) 0))
(assert (= (+ (* (exp it255 2) (/ 1.0 2.0))
      (+ 0 (* it401 (- 1)))
      (+ 0 it411)
      (* (+ 0 it255) (- (/ 1.0 2.0)))
      (+ 0 (* it255 it400 (- 1))))
   (+ 0 0)))
(assert (= (+ (* it402 (- 1)) it412) 0))
(assert (= (+ (* it403 (- 1)) it413) 0))
(assert (= (+ (* it181 (- 1)) it414) 0))
(assert (= (+ it415 (* it182 (- 1))) 0))
(assert (let ((a!1 (or (< (+ it411 (* it413 (- 1))) 0) (> (+ it411 (* it413 (- 1))) 0))))
  (and (< it410 0) (<= it412 0) (= (+ it409 (- 2)) 0) a!1)))
(check-sat)
